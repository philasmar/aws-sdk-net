...
{
    /// <summary>
    /// Response Unmarshaller for ApproveSkill operation
    /// </summary>  
    public class ApproveSkillResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ApproveSkillResponse response = new ApproveSkillResponse();
        ...
        private static ApproveSkillResponseUnmarshaller _instance = new ApproveSkillResponseUnmarshaller();        

        internal static ApproveSkillResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ApproveSkillResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
