...
{
    /// <summary>
    /// UpdateConferenceProvider Request Marshaller
    /// </summary>       
    public class UpdateConferenceProviderRequestMarshaller : IMarshaller<IRequest, UpdateConferenceProviderRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateConferenceProviderRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateConferenceProviderRequest publicRequest)
        {
        ...
        private static UpdateConferenceProviderRequestMarshaller _instance = new UpdateConferenceProviderRequestMarshaller();        

        internal static UpdateConferenceProviderRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConferenceProviderRequestMarshaller Instance
        {
            get
            {
                return _instance;
