...
{
    /// <summary>
    /// Response Unmarshaller for DeleteNetworkProfile operation
    /// </summary>  
    public class DeleteNetworkProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteNetworkProfileResponse response = new DeleteNetworkProfileResponse();
        ...
        private static DeleteNetworkProfileResponseUnmarshaller _instance = new DeleteNetworkProfileResponseUnmarshaller();        

        internal static DeleteNetworkProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteNetworkProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
