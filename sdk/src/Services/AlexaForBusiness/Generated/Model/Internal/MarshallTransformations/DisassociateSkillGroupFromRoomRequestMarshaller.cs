...
{
    /// <summary>
    /// DisassociateSkillGroupFromRoom Request Marshaller
    /// </summary>       
    public class DisassociateSkillGroupFromRoomRequestMarshaller : IMarshaller<IRequest, DisassociateSkillGroupFromRoomRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateSkillGroupFromRoomRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateSkillGroupFromRoomRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.AlexaForBusiness");
            string target = "AlexaForBusiness.DisassociateSkillGroupFromRoom";
