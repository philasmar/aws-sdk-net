...
{
    /// <summary>
    /// AssociateDeviceWithRoom Request Marshaller
    /// </summary>       
    public class AssociateDeviceWithRoomRequestMarshaller : IMarshaller<IRequest, AssociateDeviceWithRoomRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateDeviceWithRoomRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateDeviceWithRoomRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.AlexaForBusiness");
            string target = "AlexaForBusiness.AssociateDeviceWithRoom";
