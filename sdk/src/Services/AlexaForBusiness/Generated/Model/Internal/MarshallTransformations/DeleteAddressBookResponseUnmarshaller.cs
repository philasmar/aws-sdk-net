...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAddressBook operation
    /// </summary>  
    public class DeleteAddressBookResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAddressBookResponse response = new DeleteAddressBookResponse();
        ...
        private static DeleteAddressBookResponseUnmarshaller _instance = new DeleteAddressBookResponseUnmarshaller();        

        internal static DeleteAddressBookResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAddressBookResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
