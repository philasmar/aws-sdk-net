...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSkillGroup operation
    /// </summary>  
    public class DeleteSkillGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSkillGroupResponse response = new DeleteSkillGroupResponse();
        ...
        private static DeleteSkillGroupResponseUnmarshaller _instance = new DeleteSkillGroupResponseUnmarshaller();        

        internal static DeleteSkillGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSkillGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
