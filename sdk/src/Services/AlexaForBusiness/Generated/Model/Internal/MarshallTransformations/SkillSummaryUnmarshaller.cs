...
{
    /// <summary>
    /// Response Unmarshaller for SkillSummary Object
    /// </summary>  
    public class SkillSummaryUnmarshaller : IUnmarshaller<SkillSummary, XmlUnmarshallerContext>, IUnmarshaller<SkillSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SkillSummary IUnmarshaller<SkillSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public SkillSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            SkillSummary unmarshalledObject = new SkillSummary();
        ...
        private static SkillSummaryUnmarshaller _instance = new SkillSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SkillSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
