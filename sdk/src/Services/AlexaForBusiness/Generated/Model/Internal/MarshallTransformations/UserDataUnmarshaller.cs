    ...
    public class UserDataUnmarshaller : IUnmarshaller<UserData, XmlUnmarshallerContext>, IUnmarshaller<UserData, JsonUnmarshallerContext>
    {
        ...
        public UserData Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("EnrollmentId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EnrollmentId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("EnrollmentStatus", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.EnrollmentStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
