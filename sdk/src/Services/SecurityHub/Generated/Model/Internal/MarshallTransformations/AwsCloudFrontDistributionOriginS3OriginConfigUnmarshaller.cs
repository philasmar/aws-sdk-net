...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsCloudFrontDistributionOriginS3OriginConfigUnmarshaller : IUnmarshaller<AwsCloudFrontDistributionOriginS3OriginConfig, XmlUnmarshallerContext>, IUnmarshaller<AwsCloudFrontDistributionOriginS3OriginConfig, JsonUnmarshallerContext>
    {
        ...
        private static AwsCloudFrontDistributionOriginS3OriginConfigUnmarshaller _instance = new AwsCloudFrontDistributionOriginS3OriginConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AwsCloudFrontDistributionOriginS3OriginConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
