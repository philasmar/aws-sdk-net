...
{
    /// <summary>
    /// Response Unmarshaller for DeleteActionTarget operation
    /// </summary>  
    public class DeleteActionTargetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteActionTargetResponse response = new DeleteActionTargetResponse();
        ...
        private static DeleteActionTargetResponseUnmarshaller _instance = new DeleteActionTargetResponseUnmarshaller();        

        internal static DeleteActionTargetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteActionTargetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
