...
{
    /// <summary>
    /// Response Unmarshaller for DescribeStandards operation
    /// </summary>  
    public class DescribeStandardsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeStandardsResponse response = new DescribeStandardsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Standard, StandardUnmarshaller>(StandardUnmarshaller.Instance);
                    response.Standards = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeStandardsResponseUnmarshaller _instance = new DescribeStandardsResponseUnmarshaller();        

        internal static DescribeStandardsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeStandardsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
