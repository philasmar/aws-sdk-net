...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateStandardsControlResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateStandardsControlResponse response = new UpdateStandardsControlResponse();
        ...
        internal static UpdateStandardsControlResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateStandardsControlResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
