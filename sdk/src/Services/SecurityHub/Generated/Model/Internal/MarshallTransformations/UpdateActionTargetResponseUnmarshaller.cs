...
{
    /// <summary>
    /// Response Unmarshaller for UpdateActionTarget operation
    /// </summary>  
    public class UpdateActionTargetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateActionTargetResponse response = new UpdateActionTargetResponse();
        ...
        private static UpdateActionTargetResponseUnmarshaller _instance = new UpdateActionTargetResponseUnmarshaller();        

        internal static UpdateActionTargetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateActionTargetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
