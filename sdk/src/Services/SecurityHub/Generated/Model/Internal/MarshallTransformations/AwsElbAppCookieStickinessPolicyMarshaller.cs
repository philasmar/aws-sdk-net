...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsElbAppCookieStickinessPolicyMarshaller : IRequestMarshaller<AwsElbAppCookieStickinessPolicy, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(AwsElbAppCookieStickinessPolicy requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetCookieName())
            {
                context.Writer.WritePropertyName("CookieName");
                context.Writer.Write(requestObject.CookieName);
            }
