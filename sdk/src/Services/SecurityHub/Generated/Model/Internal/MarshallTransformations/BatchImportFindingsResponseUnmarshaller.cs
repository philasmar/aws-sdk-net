...
{
    /// <summary>
    /// Response Unmarshaller for BatchImportFindings operation
    /// </summary>  
    public class BatchImportFindingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchImportFindingsResponse response = new BatchImportFindingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ImportFindingsError, ImportFindingsErrorUnmarshaller>(ImportFindingsErrorUnmarshaller.Instance);
        ...
        private static BatchImportFindingsResponseUnmarshaller _instance = new BatchImportFindingsResponseUnmarshaller();        

        internal static BatchImportFindingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchImportFindingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
