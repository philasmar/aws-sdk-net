...
{
    /// <summary>
    /// Response Unmarshaller for CreateActionTarget operation
    /// </summary>  
    public class CreateActionTargetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateActionTargetResponse response = new CreateActionTargetResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ActionTargetArn", targetDepth))
                {
                    ...
                    response.ActionTargetArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateActionTargetResponseUnmarshaller _instance = new CreateActionTargetResponseUnmarshaller();        

        internal static CreateActionTargetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateActionTargetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
