...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetInsightsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetInsightsResponse response = new GetInsightsResponse();
        ...
        internal static GetInsightsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInsightsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
