...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsRdsDbClusterOptionGroupMembershipMarshaller : IRequestMarshaller<AwsRdsDbClusterOptionGroupMembership, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(AwsRdsDbClusterOptionGroupMembership requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetDbClusterOptionGroupName())
            {
                context.Writer.WritePropertyName("DbClusterOptionGroupName");
                context.Writer.Write(requestObject.DbClusterOptionGroupName);
            }
