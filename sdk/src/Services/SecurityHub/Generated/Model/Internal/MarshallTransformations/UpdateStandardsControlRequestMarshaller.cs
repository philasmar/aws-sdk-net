...
{
    /// <summary>
    /// UpdateStandardsControl Request Marshaller
    /// </summary>       
    public class UpdateStandardsControlRequestMarshaller : IMarshaller<IRequest, UpdateStandardsControlRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateStandardsControlRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateStandardsControlRequest publicRequest)
        {
            ...
            if (!publicRequest.IsSetStandardsControlArn())
        ...
        private static UpdateStandardsControlRequestMarshaller _instance = new UpdateStandardsControlRequestMarshaller();        

        internal static UpdateStandardsControlRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateStandardsControlRequestMarshaller Instance
        {
            get
            {
                return _instance;
