...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsLambdaFunctionCodeUnmarshaller : IUnmarshaller<AwsLambdaFunctionCode, XmlUnmarshallerContext>, IUnmarshaller<AwsLambdaFunctionCode, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AwsLambdaFunctionCode IUnmarshaller<AwsLambdaFunctionCode, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AwsLambdaFunctionCode Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ZipFile = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
