...
{
    /// <summary>
    /// Response Unmarshaller for EnableSecurityHub operation
    /// </summary>  
    public class EnableSecurityHubResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnableSecurityHubResponse response = new EnableSecurityHubResponse();
        ...
        private static EnableSecurityHubResponseUnmarshaller _instance = new EnableSecurityHubResponseUnmarshaller();        

        internal static EnableSecurityHubResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableSecurityHubResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
