...
{
    /// <summary>
    /// Response Unmarshaller for DisableImportFindingsForProduct operation
    /// </summary>  
    public class DisableImportFindingsForProductResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisableImportFindingsForProductResponse response = new DisableImportFindingsForProductResponse();
        ...
        private static DisableImportFindingsForProductResponseUnmarshaller _instance = new DisableImportFindingsForProductResponseUnmarshaller();        

        internal static DisableImportFindingsForProductResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableImportFindingsForProductResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
