...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetInsightResultsRequestMarshaller : IMarshaller<IRequest, GetInsightResultsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetInsightResultsRequestMarshaller _instance = new GetInsightResultsRequestMarshaller();        

        internal static GetInsightResultsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInsightResultsRequestMarshaller Instance
        {
            get
            {
                return _instance;
