...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AwsAutoScalingAutoScalingGroupDetailsUnmarshaller : IUnmarshaller<AwsAutoScalingAutoScalingGroupDetails, XmlUnmarshallerContext>, IUnmarshaller<AwsAutoScalingAutoScalingGroupDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AwsAutoScalingAutoScalingGroupDetails IUnmarshaller<AwsAutoScalingAutoScalingGroupDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AwsAutoScalingAutoScalingGroupDetails Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
