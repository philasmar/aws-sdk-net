...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EnableImportFindingsForProductResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnableImportFindingsForProductResponse response = new EnableImportFindingsForProductResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ProductSubscriptionArn", targetDepth))
                {
                    ...
                    response.ProductSubscriptionArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        internal static EnableImportFindingsForProductResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableImportFindingsForProductResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
