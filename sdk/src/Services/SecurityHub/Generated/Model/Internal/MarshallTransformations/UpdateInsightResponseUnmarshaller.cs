...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateInsightResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateInsightResponse response = new UpdateInsightResponse();
        ...
        internal static UpdateInsightResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateInsightResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
