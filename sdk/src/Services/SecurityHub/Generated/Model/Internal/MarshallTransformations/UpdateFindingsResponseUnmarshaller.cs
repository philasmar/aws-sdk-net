...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateFindingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFindingsResponse response = new UpdateFindingsResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFindingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
