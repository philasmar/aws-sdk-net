...
namespace Amazon.SecurityHub.Model.Internal.MarshallTransformations
{
    ...
    public class AwsCloudFrontDistributionOriginGroupFailoverMarshaller : IRequestMarshaller<AwsCloudFrontDistributionOriginGroupFailover, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(AwsCloudFrontDistributionOriginGroupFailover requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetStatusCodes())
            {
                ...
                var marshaller = AwsCloudFrontDistributionOriginGroupFailoverStatusCodesMarshaller.Instance;
                marshaller.Marshall(requestObject.StatusCodes, context);
