...
{
    /// <summary>
    /// Response Unmarshaller for RulesConfigurationType Object
    /// </summary>  
    public class RulesConfigurationTypeUnmarshaller : IUnmarshaller<RulesConfigurationType, XmlUnmarshallerContext>, IUnmarshaller<RulesConfigurationType, JsonUnmarshallerContext>
    {
        ...
        public RulesConfigurationType Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            RulesConfigurationType unmarshalledObject = new RulesConfigurationType();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<MappingRule, MappingRuleUnmarshaller>(MappingRuleUnmarshaller.Instance);
