...
namespace Amazon.SimpleSystemsManagement.Model
{
    ...
    /// </summary>
    public partial class SessionManagerOutputUrl
    {
        private string _cloudWatchOutputUrl;
        private string _s3OutputUrl;

        /// <summary>
        /// Gets and sets the property CloudWatchOutputUrl. 
        /// <para>
        /// Reserved for future use.
        /// </para>
        /// </summary>
        ...
        public string CloudWatchOutputUrl
        {
            ...
            set { this._cloudWatchOutputUrl = value; }
        }

        // Check to see if CloudWatchOutputUrl property is set
        internal bool IsSetCloudWatchOutputUrl()
        {
            return this._cloudWatchOutputUrl != null;
        }
