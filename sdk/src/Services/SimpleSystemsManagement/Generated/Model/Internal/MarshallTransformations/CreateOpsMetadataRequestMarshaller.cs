...
{
    /// <summary>
    /// CreateOpsMetadata Request Marshaller
    /// </summary>       
    public class CreateOpsMetadataRequestMarshaller : IMarshaller<IRequest, CreateOpsMetadataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateOpsMetadataRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateOpsMetadataRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SimpleSystemsManagement");
            string target = "AmazonSSM.CreateOpsMetadata";
        ...
        private static CreateOpsMetadataRequestMarshaller _instance = new CreateOpsMetadataRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOpsMetadataRequestMarshaller Instance
        {
            get
            {
                return _instance;
