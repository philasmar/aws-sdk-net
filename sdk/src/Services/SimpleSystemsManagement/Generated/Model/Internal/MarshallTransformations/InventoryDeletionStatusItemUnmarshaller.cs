...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InventoryDeletionStatusItemUnmarshaller : IUnmarshaller<InventoryDeletionStatusItem, XmlUnmarshallerContext>, IUnmarshaller<InventoryDeletionStatusItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        InventoryDeletionStatusItem IUnmarshaller<InventoryDeletionStatusItem, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public InventoryDeletionStatusItem Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DeletionId", targetDepth))
                {
                    ...
                    unmarshalledObject.DeletionId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DeletionStartTime", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    unmarshalledObject.DeletionStartTime = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DeletionSummary", targetDepth))
                {
                    var unmarshaller = InventoryDeletionSummaryUnmarshaller.Instance;
                    unmarshalledObject.DeletionSummary = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.LastStatusMessage = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("LastStatusUpdateTime", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    unmarshalledObject.LastStatusUpdateTime = unmarshaller.Unmarshall(context);
                    continue;
                }
