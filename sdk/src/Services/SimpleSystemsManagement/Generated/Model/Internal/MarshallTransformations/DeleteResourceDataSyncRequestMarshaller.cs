...
{
    /// <summary>
    /// DeleteResourceDataSync Request Marshaller
    /// </summary>       
    public class DeleteResourceDataSyncRequestMarshaller : IMarshaller<IRequest, DeleteResourceDataSyncRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteResourceDataSyncRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteResourceDataSyncRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SimpleSystemsManagement");
            string target = "AmazonSSM.DeleteResourceDataSync";
