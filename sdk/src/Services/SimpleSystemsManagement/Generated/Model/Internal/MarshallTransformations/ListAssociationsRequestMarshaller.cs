    ...
    public class ListAssociationsRequestMarshaller : IMarshaller<IRequest, ListAssociationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListAssociationsRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetAssociationFilterList())
                {
                    context.Writer.WritePropertyName("AssociationFilterList");
                    context.Writer.WriteArrayStart();
                    foreach(var publicRequestAssociationFilterListListValue in publicRequest.AssociationFilterList)
                    {
                        context.Writer.WriteObjectStart();

                        var marshaller = AssociationFilterMarshaller.Instance;
                        marshaller.Marshall(publicRequestAssociationFilterListListValue, context);
