...
{
    /// <summary>
    /// DeleteInventory Request Marshaller
    /// </summary>       
    public class DeleteInventoryRequestMarshaller : IMarshaller<IRequest, DeleteInventoryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteInventoryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteInventoryRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SimpleSystemsManagement");
            string target = "AmazonSSM.DeleteInventory";
        ...
        private static DeleteInventoryRequestMarshaller _instance = new DeleteInventoryRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteInventoryRequestMarshaller Instance
        {
            get
            {
                return _instance;
