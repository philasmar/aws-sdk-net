...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    public class DocumentReviewsMarshaller : IRequestMarshaller<DocumentReviews, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(DocumentReviews requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetComment())
            {
                ...
                foreach(var requestObjectCommentListValue in requestObject.Comment)
                {
                    context.Writer.WriteObjectStart();

                    var marshaller = DocumentReviewCommentSourceMarshaller.Instance;
                    marshaller.Marshall(requestObjectCommentListValue, context);
