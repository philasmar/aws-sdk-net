...
{
    /// <summary>
    /// Response Unmarshaller for CreateMaintenanceWindow operation
    /// </summary>  
    public class CreateMaintenanceWindowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMaintenanceWindowResponse response = new CreateMaintenanceWindowResponse();
        ...
        private static CreateMaintenanceWindowResponseUnmarshaller _instance = new CreateMaintenanceWindowResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMaintenanceWindowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
