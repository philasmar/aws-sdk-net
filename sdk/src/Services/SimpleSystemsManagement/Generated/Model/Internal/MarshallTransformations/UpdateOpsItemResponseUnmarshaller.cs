...
{
    /// <summary>
    /// Response Unmarshaller for UpdateOpsItem operation
    /// </summary>  
    public class UpdateOpsItemResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateOpsItemResponse response = new UpdateOpsItemResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return OpsItemAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static UpdateOpsItemResponseUnmarshaller _instance = new UpdateOpsItemResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateOpsItemResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
