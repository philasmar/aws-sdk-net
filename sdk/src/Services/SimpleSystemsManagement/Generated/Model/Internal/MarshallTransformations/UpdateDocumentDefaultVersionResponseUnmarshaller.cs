...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDocumentDefaultVersion operation
    /// </summary>  
    public class UpdateDocumentDefaultVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDocumentDefaultVersionResponse response = new UpdateDocumentDefaultVersionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = DocumentDefaultVersionDescriptionUnmarshaller.Instance;
        ...
        private static UpdateDocumentDefaultVersionResponseUnmarshaller _instance = new UpdateDocumentDefaultVersionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDocumentDefaultVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
