...
{
    /// <summary>
    /// ListComplianceItems Request Marshaller
    /// </summary>       
    public class ListComplianceItemsRequestMarshaller : IMarshaller<IRequest, ListComplianceItemsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListComplianceItemsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListComplianceItemsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SimpleSystemsManagement");
            string target = "AmazonSSM.ListComplianceItems";
        ...
        private static ListComplianceItemsRequestMarshaller _instance = new ListComplianceItemsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListComplianceItemsRequestMarshaller Instance
        {
            get
            {
                return _instance;
