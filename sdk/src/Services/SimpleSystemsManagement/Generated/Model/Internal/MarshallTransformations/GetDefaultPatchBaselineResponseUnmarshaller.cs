...
{
    /// <summary>
    /// Response Unmarshaller for GetDefaultPatchBaseline operation
    /// </summary>  
    public class GetDefaultPatchBaselineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDefaultPatchBaselineResponse response = new GetDefaultPatchBaselineResponse();
        ...
        private static GetDefaultPatchBaselineResponseUnmarshaller _instance = new GetDefaultPatchBaselineResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDefaultPatchBaselineResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
