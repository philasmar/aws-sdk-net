...
{
    /// <summary>
    /// GetParameters Request Marshaller
    /// </summary>       
    public class GetParametersRequestMarshaller : IMarshaller<IRequest, GetParametersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetParametersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetParametersRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SimpleSystemsManagement");
            string target = "AmazonSSM.GetParameters";
        ...
        private static GetParametersRequestMarshaller _instance = new GetParametersRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetParametersRequestMarshaller Instance
        {
            get
            {
                return _instance;
