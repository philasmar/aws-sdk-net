...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDocument operation
    /// </summary>  
    public class DescribeDocumentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDocumentResponse response = new DescribeDocumentResponse();
        ...
        private static DescribeDocumentResponseUnmarshaller _instance = new DescribeDocumentResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDocumentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
