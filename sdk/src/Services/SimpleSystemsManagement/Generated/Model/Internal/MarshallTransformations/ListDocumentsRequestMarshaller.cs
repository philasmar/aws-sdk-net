    ...
    public class ListDocumentsRequestMarshaller : IMarshaller<IRequest, ListDocumentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListDocumentsRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetDocumentFilterList())
                {
                    context.Writer.WritePropertyName("DocumentFilterList");
                    context.Writer.WriteArrayStart();
                    foreach(var publicRequestDocumentFilterListListValue in publicRequest.DocumentFilterList)
                    {
                        context.Writer.WriteObjectStart();

                        var marshaller = DocumentFilterMarshaller.Instance;
                        marshaller.Marshall(publicRequestDocumentFilterListListValue, context);
                ...
                if(publicRequest.IsSetFilters())
                {
                    ...
                    foreach(var publicRequestFiltersListValue in publicRequest.Filters)
                    {
                        ...
                        var marshaller = DocumentKeyValuesFilterMarshaller.Instance;
