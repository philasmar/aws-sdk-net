...
{
    /// <summary>
    /// StopAutomationExecution Request Marshaller
    /// </summary>       
    public class StopAutomationExecutionRequestMarshaller : IMarshaller<IRequest, StopAutomationExecutionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StopAutomationExecutionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StopAutomationExecutionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SimpleSystemsManagement");
            string target = "AmazonSSM.StopAutomationExecution";
