...
{
    /// <summary>
    /// Response Unmarshaller for UpdateManagedInstanceRole operation
    /// </summary>  
    public class UpdateManagedInstanceRoleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateManagedInstanceRoleResponse response = new UpdateManagedInstanceRoleResponse();
        ...
        private static UpdateManagedInstanceRoleResponseUnmarshaller _instance = new UpdateManagedInstanceRoleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateManagedInstanceRoleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
