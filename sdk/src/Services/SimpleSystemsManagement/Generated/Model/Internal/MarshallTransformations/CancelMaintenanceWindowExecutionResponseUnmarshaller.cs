...
{
    /// <summary>
    /// Response Unmarshaller for CancelMaintenanceWindowExecution operation
    /// </summary>  
    public class CancelMaintenanceWindowExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelMaintenanceWindowExecutionResponse response = new CancelMaintenanceWindowExecutionResponse();
        ...
        private static CancelMaintenanceWindowExecutionResponseUnmarshaller _instance = new CancelMaintenanceWindowExecutionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelMaintenanceWindowExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
