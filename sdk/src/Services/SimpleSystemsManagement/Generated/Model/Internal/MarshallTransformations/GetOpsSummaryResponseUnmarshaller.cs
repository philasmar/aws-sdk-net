...
{
    /// <summary>
    /// Response Unmarshaller for GetOpsSummary operation
    /// </summary>  
    public class GetOpsSummaryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetOpsSummaryResponse response = new GetOpsSummaryResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<OpsEntity, OpsEntityUnmarshaller>(OpsEntityUnmarshaller.Instance);
        ...
        private static GetOpsSummaryResponseUnmarshaller _instance = new GetOpsSummaryResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOpsSummaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
