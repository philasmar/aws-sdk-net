...
{
    /// <summary>
    /// Response Unmarshaller for DeregisterManagedInstance operation
    /// </summary>  
    public class DeregisterManagedInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterManagedInstanceResponse response = new DeregisterManagedInstanceResponse();
        ...
        private static DeregisterManagedInstanceResponseUnmarshaller _instance = new DeregisterManagedInstanceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterManagedInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
