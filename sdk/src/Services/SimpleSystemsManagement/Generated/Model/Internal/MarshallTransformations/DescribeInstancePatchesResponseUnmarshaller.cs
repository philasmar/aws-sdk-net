...
{
    /// <summary>
    /// Response Unmarshaller for DescribeInstancePatches operation
    /// </summary>  
    public class DescribeInstancePatchesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeInstancePatchesResponse response = new DescribeInstancePatchesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PatchComplianceData, PatchComplianceDataUnmarshaller>(PatchComplianceDataUnmarshaller.Instance);
        ...
        private static DescribeInstancePatchesResponseUnmarshaller _instance = new DescribeInstancePatchesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInstancePatchesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
