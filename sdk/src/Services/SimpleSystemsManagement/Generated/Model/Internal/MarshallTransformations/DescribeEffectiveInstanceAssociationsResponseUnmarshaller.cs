...
{
    /// <summary>
    /// Response Unmarshaller for DescribeEffectiveInstanceAssociations operation
    /// </summary>  
    public class DescribeEffectiveInstanceAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeEffectiveInstanceAssociationsResponse response = new DescribeEffectiveInstanceAssociationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<InstanceAssociation, InstanceAssociationUnmarshaller>(InstanceAssociationUnmarshaller.Instance);
        ...
        private static DescribeEffectiveInstanceAssociationsResponseUnmarshaller _instance = new DescribeEffectiveInstanceAssociationsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEffectiveInstanceAssociationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
