...
{
    /// <summary>
    /// GetInventorySchema Request Marshaller
    /// </summary>       
    public class GetInventorySchemaRequestMarshaller : IMarshaller<IRequest, GetInventorySchemaRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetInventorySchemaRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetInventorySchemaRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SimpleSystemsManagement");
            string target = "AmazonSSM.GetInventorySchema";
        ...
        private static GetInventorySchemaRequestMarshaller _instance = new GetInventorySchemaRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInventorySchemaRequestMarshaller Instance
        {
            get
            {
                return _instance;
