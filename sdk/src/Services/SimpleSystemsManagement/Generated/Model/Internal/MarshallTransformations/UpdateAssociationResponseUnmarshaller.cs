...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAssociation operation
    /// </summary>  
    public class UpdateAssociationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAssociationResponse response = new UpdateAssociationResponse();
        ...
        private static UpdateAssociationResponseUnmarshaller _instance = new UpdateAssociationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAssociationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
