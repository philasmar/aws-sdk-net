...
{
    /// <summary>
    /// Response Unmarshaller for GetInventory operation
    /// </summary>  
    public class GetInventoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<InventoryResultEntity, InventoryResultEntityUnmarshaller>(InventoryResultEntityUnmarshaller.Instance);
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return InvalidAggregatorExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidInventoryGroupException"))
                {
                    return InvalidInventoryGroupExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidResultAttributeException"))
                {
                    return InvalidResultAttributeExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static GetInventoryResponseUnmarshaller _instance = new GetInventoryResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInventoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
