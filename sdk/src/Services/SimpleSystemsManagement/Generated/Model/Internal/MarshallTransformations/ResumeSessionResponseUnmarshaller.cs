...
{
    /// <summary>
    /// Response Unmarshaller for ResumeSession operation
    /// </summary>  
    public class ResumeSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ResumeSessionResponse response = new ResumeSessionResponse();
        ...
        private static ResumeSessionResponseUnmarshaller _instance = new ResumeSessionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResumeSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
