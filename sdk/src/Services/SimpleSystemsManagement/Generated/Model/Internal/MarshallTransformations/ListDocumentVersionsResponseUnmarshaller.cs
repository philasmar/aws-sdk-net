...
{
    /// <summary>
    /// Response Unmarshaller for ListDocumentVersions operation
    /// </summary>  
    public class ListDocumentVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDocumentVersionsResponse response = new ListDocumentVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DocumentVersionInfo, DocumentVersionInfoUnmarshaller>(DocumentVersionInfoUnmarshaller.Instance);
        ...
        private static ListDocumentVersionsResponseUnmarshaller _instance = new ListDocumentVersionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDocumentVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
