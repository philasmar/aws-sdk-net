...
{
    /// <summary>
    /// DeleteMaintenanceWindow Request Marshaller
    /// </summary>       
    public class DeleteMaintenanceWindowRequestMarshaller : IMarshaller<IRequest, DeleteMaintenanceWindowRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteMaintenanceWindowRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteMaintenanceWindowRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SimpleSystemsManagement");
            string target = "AmazonSSM.DeleteMaintenanceWindow";
