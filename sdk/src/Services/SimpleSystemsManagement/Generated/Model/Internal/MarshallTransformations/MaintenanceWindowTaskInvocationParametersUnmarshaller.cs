...
namespace Amazon.SimpleSystemsManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MaintenanceWindowTaskInvocationParametersUnmarshaller : IUnmarshaller<MaintenanceWindowTaskInvocationParameters, XmlUnmarshallerContext>, IUnmarshaller<MaintenanceWindowTaskInvocationParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        MaintenanceWindowTaskInvocationParameters IUnmarshaller<MaintenanceWindowTaskInvocationParameters, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public MaintenanceWindowTaskInvocationParameters Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("RunCommand", targetDepth))
                {
                    ...
                    unmarshalledObject.RunCommand = unmarshaller.Unmarshall(context);
                    continue;
                }
