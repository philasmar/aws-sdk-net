...
{
    /// <summary>
    /// DeleteRevision Request Marshaller
    /// </summary>       
    public class DeleteRevisionRequestMarshaller : IMarshaller<IRequest, DeleteRevisionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteRevisionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteRevisionRequest publicRequest)
        {
        ...
        private static DeleteRevisionRequestMarshaller _instance = new DeleteRevisionRequestMarshaller();        

        internal static DeleteRevisionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRevisionRequestMarshaller Instance
        {
            get
            {
                return _instance;
