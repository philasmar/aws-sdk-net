...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAsset operation
    /// </summary>  
    public class UpdateAssetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateAssetResponseUnmarshaller _instance = new UpdateAssetResponseUnmarshaller();        

        internal static UpdateAssetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAssetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
