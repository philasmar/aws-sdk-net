...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSystemInstance operation
    /// </summary>  
    public class DeleteSystemInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSystemInstanceResponse response = new DeleteSystemInstanceResponse();
        ...
        private static DeleteSystemInstanceResponseUnmarshaller _instance = new DeleteSystemInstanceResponseUnmarshaller();        

        internal static DeleteSystemInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSystemInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
