...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSystemTemplate operation
    /// </summary>  
    public class UpdateSystemTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSystemTemplateResponse response = new UpdateSystemTemplateResponse();
        ...
        private static UpdateSystemTemplateResponseUnmarshaller _instance = new UpdateSystemTemplateResponseUnmarshaller();        

        internal static UpdateSystemTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSystemTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
