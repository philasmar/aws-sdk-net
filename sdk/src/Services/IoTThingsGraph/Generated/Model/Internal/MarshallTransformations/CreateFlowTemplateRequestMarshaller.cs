...
{
    /// <summary>
    /// CreateFlowTemplate Request Marshaller
    /// </summary>       
    public class CreateFlowTemplateRequestMarshaller : IMarshaller<IRequest, CreateFlowTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateFlowTemplateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateFlowTemplateRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.IoTThingsGraph");
            string target = "IotThingsGraphFrontEndService.CreateFlowTemplate";
        ...
        private static CreateFlowTemplateRequestMarshaller _instance = new CreateFlowTemplateRequestMarshaller();        

        internal static CreateFlowTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFlowTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
