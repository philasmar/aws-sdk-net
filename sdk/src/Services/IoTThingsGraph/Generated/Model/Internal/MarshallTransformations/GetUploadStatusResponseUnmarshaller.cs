...
{
    /// <summary>
    /// Response Unmarshaller for GetUploadStatus operation
    /// </summary>  
    public class GetUploadStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetUploadStatusResponse response = new GetUploadStatusResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.UploadStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetUploadStatusResponseUnmarshaller _instance = new GetUploadStatusResponseUnmarshaller();        

        internal static GetUploadStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUploadStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
