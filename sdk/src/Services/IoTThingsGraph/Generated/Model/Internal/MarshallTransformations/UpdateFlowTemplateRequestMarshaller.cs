...
{
    /// <summary>
    /// UpdateFlowTemplate Request Marshaller
    /// </summary>       
    public class UpdateFlowTemplateRequestMarshaller : IMarshaller<IRequest, UpdateFlowTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateFlowTemplateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateFlowTemplateRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.IoTThingsGraph");
            string target = "IotThingsGraphFrontEndService.UpdateFlowTemplate";
        ...
        private static UpdateFlowTemplateRequestMarshaller _instance = new UpdateFlowTemplateRequestMarshaller();        

        internal static UpdateFlowTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFlowTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
