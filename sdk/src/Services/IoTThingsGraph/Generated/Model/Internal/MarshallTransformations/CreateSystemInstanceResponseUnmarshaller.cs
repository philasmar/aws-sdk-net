...
{
    /// <summary>
    /// Response Unmarshaller for CreateSystemInstance operation
    /// </summary>  
    public class CreateSystemInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSystemInstanceResponse response = new CreateSystemInstanceResponse();
        ...
        private static CreateSystemInstanceResponseUnmarshaller _instance = new CreateSystemInstanceResponseUnmarshaller();        

        internal static CreateSystemInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSystemInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
