...
{
    /// <summary>
    /// Response Unmarshaller for DescribeNamespace operation
    /// </summary>  
    public class DescribeNamespaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TrackingNamespaceName = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeNamespaceResponseUnmarshaller _instance = new DescribeNamespaceResponseUnmarshaller();        

        internal static DescribeNamespaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeNamespaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
