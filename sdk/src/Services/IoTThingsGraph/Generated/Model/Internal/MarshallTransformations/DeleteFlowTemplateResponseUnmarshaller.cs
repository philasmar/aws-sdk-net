...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFlowTemplate operation
    /// </summary>  
    public class DeleteFlowTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteFlowTemplateResponse response = new DeleteFlowTemplateResponse();
        ...
        private static DeleteFlowTemplateResponseUnmarshaller _instance = new DeleteFlowTemplateResponseUnmarshaller();        

        internal static DeleteFlowTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFlowTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
