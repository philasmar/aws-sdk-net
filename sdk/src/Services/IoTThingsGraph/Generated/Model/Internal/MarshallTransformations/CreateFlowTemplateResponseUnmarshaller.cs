...
{
    /// <summary>
    /// Response Unmarshaller for CreateFlowTemplate operation
    /// </summary>  
    public class CreateFlowTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateFlowTemplateResponse response = new CreateFlowTemplateResponse();
        ...
        private static CreateFlowTemplateResponseUnmarshaller _instance = new CreateFlowTemplateResponseUnmarshaller();        

        internal static CreateFlowTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFlowTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
