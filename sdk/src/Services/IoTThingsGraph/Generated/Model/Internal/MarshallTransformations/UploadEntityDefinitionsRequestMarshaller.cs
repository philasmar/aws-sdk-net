...
{
    /// <summary>
    /// UploadEntityDefinitions Request Marshaller
    /// </summary>       
    public class UploadEntityDefinitionsRequestMarshaller : IMarshaller<IRequest, UploadEntityDefinitionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UploadEntityDefinitionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UploadEntityDefinitionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.IoTThingsGraph");
            string target = "IotThingsGraphFrontEndService.UploadEntityDefinitions";
        ...
        private static UploadEntityDefinitionsRequestMarshaller _instance = new UploadEntityDefinitionsRequestMarshaller();        

        internal static UploadEntityDefinitionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UploadEntityDefinitionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
