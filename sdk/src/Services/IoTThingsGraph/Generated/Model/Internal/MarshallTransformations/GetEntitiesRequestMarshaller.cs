...
{
    /// <summary>
    /// GetEntities Request Marshaller
    /// </summary>       
    public class GetEntitiesRequestMarshaller : IMarshaller<IRequest, GetEntitiesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetEntitiesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetEntitiesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.IoTThingsGraph");
            string target = "IotThingsGraphFrontEndService.GetEntities";
        ...
        private static GetEntitiesRequestMarshaller _instance = new GetEntitiesRequestMarshaller();        

        internal static GetEntitiesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEntitiesRequestMarshaller Instance
        {
            get
            {
                return _instance;
