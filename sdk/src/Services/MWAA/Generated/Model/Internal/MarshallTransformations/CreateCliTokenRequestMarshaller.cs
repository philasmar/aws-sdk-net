...
namespace Amazon.MWAA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateCliTokenRequestMarshaller : IMarshaller<IRequest, CreateCliTokenRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateCliTokenRequestMarshaller _instance = new CreateCliTokenRequestMarshaller();        

        internal static CreateCliTokenRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCliTokenRequestMarshaller Instance
        {
            get
            {
                return _instance;
