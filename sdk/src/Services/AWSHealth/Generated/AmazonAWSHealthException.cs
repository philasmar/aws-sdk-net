...
namespace Amazon.AWSHealth
{
    ...
    public partial class AmazonAWSHealthException : AmazonServiceException
    {
        ...
        public AmazonAWSHealthException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonAWSHealthException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
