...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAffectedAccountsForOrganization operation
    /// </summary>  
    public class DescribeAffectedAccountsForOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAffectedAccountsForOrganizationResponse response = new DescribeAffectedAccountsForOrganizationResponse();
        ...
        internal static DescribeAffectedAccountsForOrganizationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAffectedAccountsForOrganizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
