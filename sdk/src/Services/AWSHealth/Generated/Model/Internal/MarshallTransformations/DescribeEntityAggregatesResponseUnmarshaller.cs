...
{
    /// <summary>
    /// Response Unmarshaller for DescribeEntityAggregates operation
    /// </summary>  
    public class DescribeEntityAggregatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeEntityAggregatesResponseUnmarshaller _instance = new DescribeEntityAggregatesResponseUnmarshaller();        

        internal static DescribeEntityAggregatesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEntityAggregatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
