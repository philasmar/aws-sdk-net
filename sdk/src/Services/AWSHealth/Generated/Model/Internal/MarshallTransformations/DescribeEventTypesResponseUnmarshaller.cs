...
{
    /// <summary>
    /// Response Unmarshaller for DescribeEventTypes operation
    /// </summary>  
    public class DescribeEventTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeEventTypesResponse response = new DescribeEventTypesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<EventType, EventTypeUnmarshaller>(EventTypeUnmarshaller.Instance);
        ...
        private static DescribeEventTypesResponseUnmarshaller _instance = new DescribeEventTypesResponseUnmarshaller();        

        internal static DescribeEventTypesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEventTypesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
