...
{
    /// <summary>
    /// Response Unmarshaller for RegisterTargets operation
    /// </summary>  
    public class RegisterTargetsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterTargetsResponse response = new RegisterTargetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("RegisterTargetsResult", 2))
                    {
        ...
        private static RegisterTargetsResponseUnmarshaller _instance = new RegisterTargetsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterTargetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
