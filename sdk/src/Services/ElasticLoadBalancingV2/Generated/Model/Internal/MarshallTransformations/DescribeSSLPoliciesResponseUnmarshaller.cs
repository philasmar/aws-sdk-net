...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSSLPolicies operation
    /// </summary>  
    public class DescribeSSLPoliciesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSSLPoliciesResponse response = new DescribeSSLPoliciesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeSSLPoliciesResult", 2))
                    {
        ...
        private static DescribeSSLPoliciesResponseUnmarshaller _instance = new DescribeSSLPoliciesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSSLPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
