...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTargetGroup operation
    /// </summary>  
    public class DeleteTargetGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTargetGroupResponse response = new DeleteTargetGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteTargetGroupResult", 2))
                    {
        ...
        private static DeleteTargetGroupResponseUnmarshaller _instance = new DeleteTargetGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTargetGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
