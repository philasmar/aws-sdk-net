...
namespace Amazon.ElasticLoadBalancingV2.Model.Internal.MarshallTransformations
{
    ...
    public class OperationNotPermittedExceptionUnmarshaller : IErrorResponseUnmarshaller<OperationNotPermittedException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public OperationNotPermittedException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public OperationNotPermittedException Unmarshall(XmlUnmarshallerContext context, ErrorResponse errorResponse)
        {
            OperationNotPermittedException response = new OperationNotPermittedException(errorResponse.Message, errorResponse.InnerException, 
