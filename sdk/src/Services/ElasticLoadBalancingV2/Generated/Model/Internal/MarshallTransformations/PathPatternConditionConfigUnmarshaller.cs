...
namespace Amazon.ElasticLoadBalancingV2.Model.Internal.MarshallTransformations
{
    ...
    public class PathPatternConditionConfigUnmarshaller : IUnmarshaller<PathPatternConditionConfig, XmlUnmarshallerContext>, IUnmarshaller<PathPatternConditionConfig, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public PathPatternConditionConfig Unmarshall(XmlUnmarshallerContext context)
        {
            PathPatternConditionConfig unmarshalledObject = new PathPatternConditionConfig();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PathPatternConditionConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
