...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTargetGroups operation
    /// </summary>  
    public class DescribeTargetGroupsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTargetGroupsResponse response = new DescribeTargetGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeTargetGroupsResult", 2))
                    {
        ...
        private static DescribeTargetGroupsResponseUnmarshaller _instance = new DescribeTargetGroupsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTargetGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
