...
{
    /// <summary>
    /// Response Unmarshaller for ModifyTargetGroupAttributes operation
    /// </summary>  
    public class ModifyTargetGroupAttributesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyTargetGroupAttributesResponse response = new ModifyTargetGroupAttributesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyTargetGroupAttributesResult", 2))
                    {
        ...
        private static ModifyTargetGroupAttributesResponseUnmarshaller _instance = new ModifyTargetGroupAttributesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyTargetGroupAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
