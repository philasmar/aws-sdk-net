...
{
    /// <summary>
    /// Response Unmarshaller for SetRulePriorities operation
    /// </summary>  
    public class SetRulePrioritiesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetRulePrioritiesResponse response = new SetRulePrioritiesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("SetRulePrioritiesResult", 2))
                    {
        ...
        private static SetRulePrioritiesResponseUnmarshaller _instance = new SetRulePrioritiesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetRulePrioritiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
