...
namespace Amazon.ElasticLoadBalancingV2.Model.Internal.MarshallTransformations
{
    ...
    public class HttpRequestMethodConditionConfigUnmarshaller : IUnmarshaller<HttpRequestMethodConditionConfig, XmlUnmarshallerContext>, IUnmarshaller<HttpRequestMethodConditionConfig, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public HttpRequestMethodConditionConfig Unmarshall(XmlUnmarshallerContext context)
        {
            HttpRequestMethodConditionConfig unmarshalledObject = new HttpRequestMethodConditionConfig();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static HttpRequestMethodConditionConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
