...
{
    /// <summary>
    /// Response Unmarshaller for CreateTargetGroup operation
    /// </summary>  
    public class CreateTargetGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTargetGroupResponse response = new CreateTargetGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateTargetGroupResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("DuplicateTargetGroupName"))
                {
                    return DuplicateTargetGroupNameExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CreateTargetGroupResponseUnmarshaller _instance = new CreateTargetGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTargetGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
