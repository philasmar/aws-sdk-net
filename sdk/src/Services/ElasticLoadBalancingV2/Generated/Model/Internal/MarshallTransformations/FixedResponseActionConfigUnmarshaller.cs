...
namespace Amazon.ElasticLoadBalancingV2.Model.Internal.MarshallTransformations
{
    ...
    public class FixedResponseActionConfigUnmarshaller : IUnmarshaller<FixedResponseActionConfig, XmlUnmarshallerContext>, IUnmarshaller<FixedResponseActionConfig, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public FixedResponseActionConfig Unmarshall(XmlUnmarshallerContext context)
        {
            FixedResponseActionConfig unmarshalledObject = new FixedResponseActionConfig();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.MessageBody = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static FixedResponseActionConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
