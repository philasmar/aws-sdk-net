...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTargetGroupAttributes operation
    /// </summary>  
    public class DescribeTargetGroupAttributesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTargetGroupAttributesResponse response = new DescribeTargetGroupAttributesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeTargetGroupAttributesResult", 2))
                    {
        ...
        private static DescribeTargetGroupAttributesResponseUnmarshaller _instance = new DescribeTargetGroupAttributesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTargetGroupAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
