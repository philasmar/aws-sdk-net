...
{
    /// <summary>
    /// Response Unmarshaller for ModifyTargetGroup operation
    /// </summary>  
    public class ModifyTargetGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyTargetGroupResponse response = new ModifyTargetGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyTargetGroupResult", 2))
                    {
        ...
        private static ModifyTargetGroupResponseUnmarshaller _instance = new ModifyTargetGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyTargetGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
