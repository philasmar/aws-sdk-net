...
namespace Amazon.ElasticLoadBalancingV2.Model.Internal.MarshallTransformations
{
    ...
    public class TargetGroupStickinessConfigUnmarshaller : IUnmarshaller<TargetGroupStickinessConfig, XmlUnmarshallerContext>, IUnmarshaller<TargetGroupStickinessConfig, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public TargetGroupStickinessConfig Unmarshall(XmlUnmarshallerContext context)
        {
            TargetGroupStickinessConfig unmarshalledObject = new TargetGroupStickinessConfig();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TargetGroupStickinessConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
