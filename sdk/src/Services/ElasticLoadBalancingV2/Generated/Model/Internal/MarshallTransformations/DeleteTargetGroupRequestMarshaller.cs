...
{
    /// <summary>
    /// DeleteTargetGroup Request Marshaller
    /// </summary>       
    public class DeleteTargetGroupRequestMarshaller : IMarshaller<IRequest, DeleteTargetGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteTargetGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteTargetGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ElasticLoadBalancingV2");
            request.Parameters.Add("Action", "DeleteTargetGroup");
