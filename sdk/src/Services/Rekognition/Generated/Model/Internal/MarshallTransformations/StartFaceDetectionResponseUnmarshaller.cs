...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartFaceDetectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartFaceDetectionResponse response = new StartFaceDetectionResponse();
        ...
        private static StartFaceDetectionResponseUnmarshaller _instance = new StartFaceDetectionResponseUnmarshaller();        

        internal static StartFaceDetectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartFaceDetectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
