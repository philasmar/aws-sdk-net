...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DetectLabelsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DetectLabelsResponseUnmarshaller _instance = new DetectLabelsResponseUnmarshaller();        

        internal static DetectLabelsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectLabelsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
