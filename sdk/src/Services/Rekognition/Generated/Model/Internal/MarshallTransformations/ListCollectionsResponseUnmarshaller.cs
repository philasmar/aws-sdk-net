...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListCollectionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListCollectionsResponseUnmarshaller _instance = new ListCollectionsResponseUnmarshaller();        

        internal static ListCollectionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCollectionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
