...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DetectModerationLabelsRequestMarshaller : IMarshaller<IRequest, DetectModerationLabelsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DetectModerationLabelsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DetectModerationLabelsRequest publicRequest)
        {
        ...
        private static DetectModerationLabelsRequestMarshaller _instance = new DetectModerationLabelsRequestMarshaller();        

        internal static DetectModerationLabelsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectModerationLabelsRequestMarshaller Instance
        {
            get
            {
                return _instance;
