...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetFaceSearchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFaceSearchResponse response = new GetFaceSearchResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PersonMatch, PersonMatchUnmarshaller>(PersonMatchUnmarshaller.Instance);
        ...
        private static GetFaceSearchResponseUnmarshaller _instance = new GetFaceSearchResponseUnmarshaller();        

        internal static GetFaceSearchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFaceSearchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
