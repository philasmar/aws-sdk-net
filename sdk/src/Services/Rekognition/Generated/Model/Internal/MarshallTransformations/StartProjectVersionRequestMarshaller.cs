...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StartProjectVersionRequestMarshaller : IMarshaller<IRequest, StartProjectVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartProjectVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartProjectVersionRequest publicRequest)
        {
        ...
        private static StartProjectVersionRequestMarshaller _instance = new StartProjectVersionRequestMarshaller();        

        internal static StartProjectVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartProjectVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
