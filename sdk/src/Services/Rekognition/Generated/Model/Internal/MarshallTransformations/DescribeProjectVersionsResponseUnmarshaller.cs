...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeProjectVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeProjectVersionsResponse response = new DescribeProjectVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ProjectVersionDescription, ProjectVersionDescriptionUnmarshaller>(ProjectVersionDescriptionUnmarshaller.Instance);
                    response.ProjectVersionDescriptions = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeProjectVersionsResponseUnmarshaller _instance = new DescribeProjectVersionsResponseUnmarshaller();        

        internal static DescribeProjectVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeProjectVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
