...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DetectCustomLabelsRequestMarshaller : IMarshaller<IRequest, DetectCustomLabelsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DetectCustomLabelsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DetectCustomLabelsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Rekognition");
            string target = "RekognitionService.DetectCustomLabels";
        ...
        private static DetectCustomLabelsRequestMarshaller _instance = new DetectCustomLabelsRequestMarshaller();        

        internal static DetectCustomLabelsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectCustomLabelsRequestMarshaller Instance
        {
            get
            {
                return _instance;
