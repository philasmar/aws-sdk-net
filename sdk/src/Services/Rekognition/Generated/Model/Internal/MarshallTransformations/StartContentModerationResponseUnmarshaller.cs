...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartContentModerationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static StartContentModerationResponseUnmarshaller _instance = new StartContentModerationResponseUnmarshaller();        

        internal static StartContentModerationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartContentModerationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
