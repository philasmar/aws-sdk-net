...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteProjectVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteProjectVersionResponse response = new DeleteProjectVersionResponse();
        ...
        private static DeleteProjectVersionResponseUnmarshaller _instance = new DeleteProjectVersionResponseUnmarshaller();        

        internal static DeleteProjectVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteProjectVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
