...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StopStreamProcessorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopStreamProcessorResponse response = new StopStreamProcessorResponse();
        ...
        private static StopStreamProcessorResponseUnmarshaller _instance = new StopStreamProcessorResponseUnmarshaller();        

        internal static StopStreamProcessorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopStreamProcessorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
