...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RecognizeCelebritiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static RecognizeCelebritiesResponseUnmarshaller _instance = new RecognizeCelebritiesResponseUnmarshaller();        

        internal static RecognizeCelebritiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RecognizeCelebritiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
