...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeProjectsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeProjectsResponseUnmarshaller _instance = new DescribeProjectsResponseUnmarshaller();        

        internal static DescribeProjectsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeProjectsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
