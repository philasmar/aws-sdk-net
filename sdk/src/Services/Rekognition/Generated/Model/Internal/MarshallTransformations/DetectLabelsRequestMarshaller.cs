...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DetectLabelsRequestMarshaller : IMarshaller<IRequest, DetectLabelsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DetectLabelsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DetectLabelsRequest publicRequest)
        {
        ...
        private static DetectLabelsRequestMarshaller _instance = new DetectLabelsRequestMarshaller();        

        internal static DetectLabelsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectLabelsRequestMarshaller Instance
        {
            get
            {
                return _instance;
