...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetCelebrityInfoResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCelebrityInfoResponse response = new GetCelebrityInfoResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("Urls", targetDepth))
                {
                    ...
                    response.Urls = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetCelebrityInfoResponseUnmarshaller _instance = new GetCelebrityInfoResponseUnmarshaller();        

        internal static GetCelebrityInfoResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCelebrityInfoResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
