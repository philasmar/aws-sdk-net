...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetPersonTrackingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetPersonTrackingResponseUnmarshaller _instance = new GetPersonTrackingResponseUnmarshaller();        

        internal static GetPersonTrackingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPersonTrackingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
