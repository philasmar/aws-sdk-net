...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteStreamProcessorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteStreamProcessorResponse response = new DeleteStreamProcessorResponse();
        ...
        private static DeleteStreamProcessorResponseUnmarshaller _instance = new DeleteStreamProcessorResponseUnmarshaller();        

        internal static DeleteStreamProcessorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteStreamProcessorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
