...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartProjectVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartProjectVersionResponse response = new StartProjectVersionResponse();
        ...
        private static StartProjectVersionResponseUnmarshaller _instance = new StartProjectVersionResponseUnmarshaller();        

        internal static StartProjectVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartProjectVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
