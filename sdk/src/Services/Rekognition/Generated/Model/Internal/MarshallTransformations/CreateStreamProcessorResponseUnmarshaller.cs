...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateStreamProcessorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateStreamProcessorResponse response = new CreateStreamProcessorResponse();
        ...
        private static CreateStreamProcessorResponseUnmarshaller _instance = new CreateStreamProcessorResponseUnmarshaller();        

        internal static CreateStreamProcessorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateStreamProcessorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
