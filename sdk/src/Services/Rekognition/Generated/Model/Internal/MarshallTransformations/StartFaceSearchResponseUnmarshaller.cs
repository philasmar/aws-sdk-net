...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartFaceSearchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartFaceSearchResponse response = new StartFaceSearchResponse();
        ...
        private static StartFaceSearchResponseUnmarshaller _instance = new StartFaceSearchResponseUnmarshaller();        

        internal static StartFaceSearchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartFaceSearchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
