...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteCollectionRequestMarshaller : IMarshaller<IRequest, DeleteCollectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteCollectionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteCollectionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Rekognition");
            string target = "RekognitionService.DeleteCollection";
