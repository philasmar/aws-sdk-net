...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetLabelDetectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLabelDetectionResponse response = new GetLabelDetectionResponse();
        ...
        private static GetLabelDetectionResponseUnmarshaller _instance = new GetLabelDetectionResponseUnmarshaller();        

        internal static GetLabelDetectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLabelDetectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
