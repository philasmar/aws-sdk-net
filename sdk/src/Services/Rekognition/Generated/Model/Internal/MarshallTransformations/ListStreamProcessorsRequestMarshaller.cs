...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListStreamProcessorsRequestMarshaller : IMarshaller<IRequest, ListStreamProcessorsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListStreamProcessorsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListStreamProcessorsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Rekognition");
            string target = "RekognitionService.ListStreamProcessors";
