...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StartPersonTrackingRequestMarshaller : IMarshaller<IRequest, StartPersonTrackingRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartPersonTrackingRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartPersonTrackingRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Rekognition");
            string target = "RekognitionService.StartPersonTracking";
