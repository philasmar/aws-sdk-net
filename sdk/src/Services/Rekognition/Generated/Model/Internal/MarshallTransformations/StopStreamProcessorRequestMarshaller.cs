...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StopStreamProcessorRequestMarshaller : IMarshaller<IRequest, StopStreamProcessorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StopStreamProcessorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StopStreamProcessorRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Rekognition");
            string target = "RekognitionService.StopStreamProcessor";
