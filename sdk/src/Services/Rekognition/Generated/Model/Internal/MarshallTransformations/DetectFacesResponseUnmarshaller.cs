...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DetectFacesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DetectFacesResponseUnmarshaller _instance = new DetectFacesResponseUnmarshaller();        

        internal static DetectFacesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectFacesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
