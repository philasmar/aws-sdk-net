...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartLabelDetectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static StartLabelDetectionResponseUnmarshaller _instance = new StartLabelDetectionResponseUnmarshaller();        

        internal static StartLabelDetectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartLabelDetectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
