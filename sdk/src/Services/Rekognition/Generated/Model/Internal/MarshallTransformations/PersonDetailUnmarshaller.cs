...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PersonDetailUnmarshaller : IUnmarshaller<PersonDetail, XmlUnmarshallerContext>, IUnmarshaller<PersonDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PersonDetail IUnmarshaller<PersonDetail, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static PersonDetailUnmarshaller _instance = new PersonDetailUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PersonDetailUnmarshaller Instance
        {
            get
            {
                return _instance;
