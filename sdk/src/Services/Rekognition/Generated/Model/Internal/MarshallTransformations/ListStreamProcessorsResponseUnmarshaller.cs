...
namespace Amazon.Rekognition.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListStreamProcessorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListStreamProcessorsResponseUnmarshaller _instance = new ListStreamProcessorsResponseUnmarshaller();        

        internal static ListStreamProcessorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListStreamProcessorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
