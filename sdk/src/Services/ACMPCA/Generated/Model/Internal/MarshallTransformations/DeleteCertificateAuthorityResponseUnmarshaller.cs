...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteCertificateAuthorityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DeleteCertificateAuthorityResponseUnmarshaller _instance = new DeleteCertificateAuthorityResponseUnmarshaller();        

        internal static DeleteCertificateAuthorityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCertificateAuthorityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
