...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetCertificateAuthorityCsrResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCertificateAuthorityCsrResponse response = new GetCertificateAuthorityCsrResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("Csr", targetDepth))
                {
                    ...
                    response.Csr = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetCertificateAuthorityCsrResponseUnmarshaller _instance = new GetCertificateAuthorityCsrResponseUnmarshaller();        

        internal static GetCertificateAuthorityCsrResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCertificateAuthorityCsrResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
