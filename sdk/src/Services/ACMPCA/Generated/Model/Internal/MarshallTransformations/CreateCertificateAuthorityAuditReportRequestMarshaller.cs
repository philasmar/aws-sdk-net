...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    public class CreateCertificateAuthorityAuditReportRequestMarshaller : IMarshaller<IRequest, CreateCertificateAuthorityAuditReportRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateCertificateAuthorityAuditReportRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ACMPCA");
            string target = "ACMPrivateCA.CreateCertificateAuthorityAuditReport";
        ...
        private static CreateCertificateAuthorityAuditReportRequestMarshaller _instance = new CreateCertificateAuthorityAuditReportRequestMarshaller();        

        internal static CreateCertificateAuthorityAuditReportRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCertificateAuthorityAuditReportRequestMarshaller Instance
        {
            get
            {
                return _instance;
