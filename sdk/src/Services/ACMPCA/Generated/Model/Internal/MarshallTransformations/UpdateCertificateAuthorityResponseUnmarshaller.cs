...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateCertificateAuthorityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateCertificateAuthorityResponse response = new UpdateCertificateAuthorityResponse();
        ...
        private static UpdateCertificateAuthorityResponseUnmarshaller _instance = new UpdateCertificateAuthorityResponseUnmarshaller();        

        internal static UpdateCertificateAuthorityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCertificateAuthorityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
