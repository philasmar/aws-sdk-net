...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    public class CreateCertificateAuthorityRequestMarshaller : IMarshaller<IRequest, CreateCertificateAuthorityRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateCertificateAuthorityRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ACMPCA");
            string target = "ACMPrivateCA.CreateCertificateAuthority";
        ...
        private static CreateCertificateAuthorityRequestMarshaller _instance = new CreateCertificateAuthorityRequestMarshaller();        

        internal static CreateCertificateAuthorityRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCertificateAuthorityRequestMarshaller Instance
        {
            get
            {
                return _instance;
