...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateCertificateAuthorityRequestMarshaller : IMarshaller<IRequest, UpdateCertificateAuthorityRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateCertificateAuthorityRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateCertificateAuthorityRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ACMPCA");
            string target = "ACMPrivateCA.UpdateCertificateAuthority";
        ...
        private static UpdateCertificateAuthorityRequestMarshaller _instance = new UpdateCertificateAuthorityRequestMarshaller();        

        internal static UpdateCertificateAuthorityRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCertificateAuthorityRequestMarshaller Instance
        {
            get
            {
                return _instance;
