...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ImportCertificateAuthorityCertificateRequestMarshaller : IMarshaller<IRequest, ImportCertificateAuthorityCertificateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ImportCertificateAuthorityCertificateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ImportCertificateAuthorityCertificateRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ACMPCA");
            string target = "ACMPrivateCA.ImportCertificateAuthorityCertificate";
        ...
        private static ImportCertificateAuthorityCertificateRequestMarshaller _instance = new ImportCertificateAuthorityCertificateRequestMarshaller();        

        internal static ImportCertificateAuthorityCertificateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportCertificateAuthorityCertificateRequestMarshaller Instance
        {
            get
            {
                return _instance;
