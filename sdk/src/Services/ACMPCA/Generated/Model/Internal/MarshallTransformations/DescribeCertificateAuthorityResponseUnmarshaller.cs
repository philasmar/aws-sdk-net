...
namespace Amazon.ACMPCA.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeCertificateAuthorityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeCertificateAuthorityResponse response = new DescribeCertificateAuthorityResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CertificateAuthority", targetDepth))
                {
                    ...
                    response.CertificateAuthority = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeCertificateAuthorityResponseUnmarshaller _instance = new DescribeCertificateAuthorityResponseUnmarshaller();        

        internal static DescribeCertificateAuthorityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCertificateAuthorityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
