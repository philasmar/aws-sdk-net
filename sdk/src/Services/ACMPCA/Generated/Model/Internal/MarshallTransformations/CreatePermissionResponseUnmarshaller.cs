    ...
    public class CreatePermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("PermissionAlreadyExistsException"))
                {
                    return PermissionAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CreatePermissionResponseUnmarshaller _instance = new CreatePermissionResponseUnmarshaller();        

        internal static CreatePermissionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
