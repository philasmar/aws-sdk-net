...
{
    /// <summary>
    /// Response Unmarshaller for ResolveAlias operation
    /// </summary>  
    public class ResolveAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ResolveAliasResponseUnmarshaller _instance = new ResolveAliasResponseUnmarshaller();        

        internal static ResolveAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResolveAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
