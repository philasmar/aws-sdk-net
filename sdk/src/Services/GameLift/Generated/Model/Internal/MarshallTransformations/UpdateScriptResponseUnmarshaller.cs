...
{
    /// <summary>
    /// Response Unmarshaller for UpdateScript operation
    /// </summary>  
    public class UpdateScriptResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateScriptResponseUnmarshaller _instance = new UpdateScriptResponseUnmarshaller();        

        internal static UpdateScriptResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateScriptResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
