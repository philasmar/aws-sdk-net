...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBuild operation
    /// </summary>  
    public class DescribeBuildResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBuildResponse response = new DescribeBuildResponse();
        ...
        private static DescribeBuildResponseUnmarshaller _instance = new DescribeBuildResponseUnmarshaller();        

        internal static DescribeBuildResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBuildResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
