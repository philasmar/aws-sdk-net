...
{
    /// <summary>
    /// Response Unmarshaller for SearchGameSessions operation
    /// </summary>  
    public class SearchGameSessionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchGameSessionsResponse response = new SearchGameSessionsResponse();
        ...
        private static SearchGameSessionsResponseUnmarshaller _instance = new SearchGameSessionsResponseUnmarshaller();        

        internal static SearchGameSessionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchGameSessionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
