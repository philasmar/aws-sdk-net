...
{
    /// <summary>
    /// Response Unmarshaller for UpdateGameSession operation
    /// </summary>  
    public class UpdateGameSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateGameSessionResponseUnmarshaller _instance = new UpdateGameSessionResponseUnmarshaller();        

        internal static UpdateGameSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGameSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
