...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAlias operation
    /// </summary>  
    public class DescribeAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAliasResponse response = new DescribeAliasResponse();
        ...
        private static DescribeAliasResponseUnmarshaller _instance = new DescribeAliasResponseUnmarshaller();        

        internal static DescribeAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
