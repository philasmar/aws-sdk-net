...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBuild operation
    /// </summary>  
    public class UpdateBuildResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBuildResponse response = new UpdateBuildResponse();
        ...
        private static UpdateBuildResponseUnmarshaller _instance = new UpdateBuildResponseUnmarshaller();        

        internal static UpdateBuildResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBuildResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
