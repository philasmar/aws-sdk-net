...
{
    /// <summary>
    /// Response Unmarshaller for DescribeGameSessions operation
    /// </summary>  
    public class DescribeGameSessionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeGameSessionsResponseUnmarshaller _instance = new DescribeGameSessionsResponseUnmarshaller();        

        internal static DescribeGameSessionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeGameSessionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
