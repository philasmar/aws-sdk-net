...
{
    /// <summary>
    /// Response Unmarshaller for GetGameSessionLogUrl operation
    /// </summary>  
    public class GetGameSessionLogUrlResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGameSessionLogUrlResponse response = new GetGameSessionLogUrlResponse();
        ...
        private static GetGameSessionLogUrlResponseUnmarshaller _instance = new GetGameSessionLogUrlResponseUnmarshaller();        

        internal static GetGameSessionLogUrlResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGameSessionLogUrlResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
