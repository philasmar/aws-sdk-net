...
{
    /// <summary>
    /// Response Unmarshaller for UpdateGameServer operation
    /// </summary>  
    public class UpdateGameServerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateGameServerResponse response = new UpdateGameServerResponse();
        ...
        private static UpdateGameServerResponseUnmarshaller _instance = new UpdateGameServerResponseUnmarshaller();        

        internal static UpdateGameServerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGameServerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
