...
{
    /// <summary>
    /// StartMatchBackfill Request Marshaller
    /// </summary>       
    public class StartMatchBackfillRequestMarshaller : IMarshaller<IRequest, StartMatchBackfillRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartMatchBackfillRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartMatchBackfillRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.GameLift");
            string target = "GameLift.StartMatchBackfill";
