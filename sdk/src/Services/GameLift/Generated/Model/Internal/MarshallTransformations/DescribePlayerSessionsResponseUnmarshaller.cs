...
{
    /// <summary>
    /// Response Unmarshaller for DescribePlayerSessions operation
    /// </summary>  
    public class DescribePlayerSessionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribePlayerSessionsResponseUnmarshaller _instance = new DescribePlayerSessionsResponseUnmarshaller();        

        internal static DescribePlayerSessionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePlayerSessionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
