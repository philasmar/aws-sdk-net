...
{
    /// <summary>
    /// Response Unmarshaller for StartMatchBackfill operation
    /// </summary>  
    public class StartMatchBackfillResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartMatchBackfillResponse response = new StartMatchBackfillResponse();
        ...
        private static StartMatchBackfillResponseUnmarshaller _instance = new StartMatchBackfillResponseUnmarshaller();        

        internal static StartMatchBackfillResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMatchBackfillResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
