...
{
    /// <summary>
    /// Response Unmarshaller for RequestUploadCredentials operation
    /// </summary>  
    public class RequestUploadCredentialsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RequestUploadCredentialsResponse response = new RequestUploadCredentialsResponse();
        ...
        private static RequestUploadCredentialsResponseUnmarshaller _instance = new RequestUploadCredentialsResponseUnmarshaller();        

        internal static RequestUploadCredentialsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RequestUploadCredentialsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
