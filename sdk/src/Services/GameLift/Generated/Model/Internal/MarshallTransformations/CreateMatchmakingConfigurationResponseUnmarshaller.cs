...
{
    /// <summary>
    /// Response Unmarshaller for CreateMatchmakingConfiguration operation
    /// </summary>  
    public class CreateMatchmakingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMatchmakingConfigurationResponse response = new CreateMatchmakingConfigurationResponse();
        ...
        private static CreateMatchmakingConfigurationResponseUnmarshaller _instance = new CreateMatchmakingConfigurationResponseUnmarshaller();        

        internal static CreateMatchmakingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMatchmakingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
