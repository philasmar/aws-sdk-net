...
{
    /// <summary>
    /// Response Unmarshaller for StopMatchmaking operation
    /// </summary>  
    public class StopMatchmakingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopMatchmakingResponse response = new StopMatchmakingResponse();
        ...
        private static StopMatchmakingResponseUnmarshaller _instance = new StopMatchmakingResponseUnmarshaller();        

        internal static StopMatchmakingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopMatchmakingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
