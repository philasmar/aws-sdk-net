...
{
    /// <summary>
    /// UpdateGameSessionQueue Request Marshaller
    /// </summary>       
    public class UpdateGameSessionQueueRequestMarshaller : IMarshaller<IRequest, UpdateGameSessionQueueRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateGameSessionQueueRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateGameSessionQueueRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.GameLift");
            string target = "GameLift.UpdateGameSessionQueue";
        ...
        private static UpdateGameSessionQueueRequestMarshaller _instance = new UpdateGameSessionQueueRequestMarshaller();        

        internal static UpdateGameSessionQueueRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGameSessionQueueRequestMarshaller Instance
        {
            get
            {
                return _instance;
