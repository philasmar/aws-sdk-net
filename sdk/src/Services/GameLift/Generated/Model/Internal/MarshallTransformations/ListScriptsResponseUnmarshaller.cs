...
{
    /// <summary>
    /// Response Unmarshaller for ListScripts operation
    /// </summary>  
    public class ListScriptsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListScriptsResponseUnmarshaller _instance = new ListScriptsResponseUnmarshaller();        

        internal static ListScriptsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListScriptsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
