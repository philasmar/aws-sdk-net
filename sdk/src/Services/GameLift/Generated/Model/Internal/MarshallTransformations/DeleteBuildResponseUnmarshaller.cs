...
{
    /// <summary>
    /// Response Unmarshaller for DeleteBuild operation
    /// </summary>  
    public class DeleteBuildResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteBuildResponse response = new DeleteBuildResponse();
        ...
        private static DeleteBuildResponseUnmarshaller _instance = new DeleteBuildResponseUnmarshaller();        

        internal static DeleteBuildResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBuildResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
