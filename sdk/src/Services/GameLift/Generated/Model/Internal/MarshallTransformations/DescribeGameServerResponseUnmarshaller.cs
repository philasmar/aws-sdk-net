...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeGameServerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static DescribeGameServerResponseUnmarshaller _instance = new DescribeGameServerResponseUnmarshaller();        

        internal static DescribeGameServerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeGameServerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
