...
{
    /// <summary>
    /// Response Unmarshaller for DeleteGameSessionQueue operation
    /// </summary>  
    public class DeleteGameSessionQueueResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteGameSessionQueueResponse response = new DeleteGameSessionQueueResponse();
        ...
        private static DeleteGameSessionQueueResponseUnmarshaller _instance = new DeleteGameSessionQueueResponseUnmarshaller();        

        internal static DeleteGameSessionQueueResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGameSessionQueueResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
