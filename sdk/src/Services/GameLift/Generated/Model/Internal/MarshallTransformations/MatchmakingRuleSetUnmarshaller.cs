...
namespace Amazon.GameLift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MatchmakingRuleSetUnmarshaller : IUnmarshaller<MatchmakingRuleSet, XmlUnmarshallerContext>, IUnmarshaller<MatchmakingRuleSet, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        MatchmakingRuleSet IUnmarshaller<MatchmakingRuleSet, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public MatchmakingRuleSet Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
