...
{
    /// <summary>
    /// GetInstanceAccess Request Marshaller
    /// </summary>       
    public class GetInstanceAccessRequestMarshaller : IMarshaller<IRequest, GetInstanceAccessRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetInstanceAccessRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetInstanceAccessRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.GameLift");
            string target = "GameLift.GetInstanceAccess";
