...
{
    /// <summary>
    /// Response Unmarshaller for StartMatchmaking operation
    /// </summary>  
    public class StartMatchmakingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static StartMatchmakingResponseUnmarshaller _instance = new StartMatchmakingResponseUnmarshaller();        

        internal static StartMatchmakingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMatchmakingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
