...
{
    /// <summary>
    /// Response Unmarshaller for RegisterGameServer operation
    /// </summary>  
    public class RegisterGameServerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static RegisterGameServerResponseUnmarshaller _instance = new RegisterGameServerResponseUnmarshaller();        

        internal static RegisterGameServerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterGameServerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
