...
{
    /// <summary>
    /// Response Unmarshaller for DeleteMatchmakingConfiguration operation
    /// </summary>  
    public class DeleteMatchmakingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMatchmakingConfigurationResponse response = new DeleteMatchmakingConfigurationResponse();
        ...
        private static DeleteMatchmakingConfigurationResponseUnmarshaller _instance = new DeleteMatchmakingConfigurationResponseUnmarshaller();        

        internal static DeleteMatchmakingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMatchmakingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
