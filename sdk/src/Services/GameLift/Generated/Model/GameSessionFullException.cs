...
namespace Amazon.GameLift.Model
{
    ...
    public partial class GameSessionFullException : AmazonGameLiftException
    {
        ...
        public GameSessionFullException(string message, Exception innerException) 
        ...
        public GameSessionFullException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected GameSessionFullException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
