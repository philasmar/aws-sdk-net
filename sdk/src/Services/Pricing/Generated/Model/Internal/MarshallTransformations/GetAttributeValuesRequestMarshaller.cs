...
{
    /// <summary>
    /// GetAttributeValues Request Marshaller
    /// </summary>       
    public class GetAttributeValuesRequestMarshaller : IMarshaller<IRequest, GetAttributeValuesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAttributeValuesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAttributeValuesRequest publicRequest)
        {
        ...
        private static GetAttributeValuesRequestMarshaller _instance = new GetAttributeValuesRequestMarshaller();        

        internal static GetAttributeValuesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAttributeValuesRequestMarshaller Instance
        {
            get
            {
                return _instance;
