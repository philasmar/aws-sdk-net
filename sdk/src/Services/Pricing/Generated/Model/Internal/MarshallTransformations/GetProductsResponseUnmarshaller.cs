...
{
    /// <summary>
    /// Response Unmarshaller for GetProducts operation
    /// </summary>  
    public class GetProductsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetProductsResponseUnmarshaller _instance = new GetProductsResponseUnmarshaller();        

        internal static GetProductsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetProductsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
