    ...
    public class InputDataConfigUnmarshaller : IUnmarshaller<InputDataConfig, XmlUnmarshallerContext>, IUnmarshaller<InputDataConfig, JsonUnmarshallerContext>
    {
        ...
        public InputDataConfig Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SupplementaryFeature, SupplementaryFeatureUnmarshaller>(SupplementaryFeatureUnmarshaller.Instance);
                    unmarshalledObject.SupplementaryFeatures = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
