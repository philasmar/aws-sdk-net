...
{
    /// <summary>
    /// Response Unmarshaller for DescribeForecast operation
    /// </summary>  
    public class DescribeForecastResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeForecastResponse response = new DescribeForecastResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ForecastName = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeForecastResponseUnmarshaller _instance = new DescribeForecastResponseUnmarshaller();        

        internal static DescribeForecastResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeForecastResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
