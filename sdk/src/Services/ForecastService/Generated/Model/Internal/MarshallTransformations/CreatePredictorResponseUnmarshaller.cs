...
{
    /// <summary>
    /// Response Unmarshaller for CreatePredictor operation
    /// </summary>  
    public class CreatePredictorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePredictorResponse response = new CreatePredictorResponse();
        ...
        private static CreatePredictorResponseUnmarshaller _instance = new CreatePredictorResponseUnmarshaller();        

        internal static CreatePredictorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePredictorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
