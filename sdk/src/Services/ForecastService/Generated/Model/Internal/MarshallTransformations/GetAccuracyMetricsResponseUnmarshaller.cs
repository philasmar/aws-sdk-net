...
{
    /// <summary>
    /// Response Unmarshaller for GetAccuracyMetrics operation
    /// </summary>  
    public class GetAccuracyMetricsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAccuracyMetricsResponse response = new GetAccuracyMetricsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("PredictorEvaluationResults", targetDepth))
                {
                    ...
                    response.PredictorEvaluationResults = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetAccuracyMetricsResponseUnmarshaller _instance = new GetAccuracyMetricsResponseUnmarshaller();        

        internal static GetAccuracyMetricsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccuracyMetricsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
