...
{
    /// <summary>
    /// Response Unmarshaller for CreateForecastExportJob operation
    /// </summary>  
    public class CreateForecastExportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateForecastExportJobResponse response = new CreateForecastExportJobResponse();
        ...
        private static CreateForecastExportJobResponseUnmarshaller _instance = new CreateForecastExportJobResponseUnmarshaller();        

        internal static CreateForecastExportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateForecastExportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
