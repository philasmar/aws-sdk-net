...
{
    /// <summary>
    /// Response Unmarshaller for DescribeForecastExportJob operation
    /// </summary>  
    public class DescribeForecastExportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeForecastExportJobResponse response = new DescribeForecastExportJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ForecastExportJobArn = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeForecastExportJobResponseUnmarshaller _instance = new DescribeForecastExportJobResponseUnmarshaller();        

        internal static DescribeForecastExportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeForecastExportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
