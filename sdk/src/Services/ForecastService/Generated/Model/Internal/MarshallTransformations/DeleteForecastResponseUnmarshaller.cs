...
{
    /// <summary>
    /// Response Unmarshaller for DeleteForecast operation
    /// </summary>  
    public class DeleteForecastResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteForecastResponse response = new DeleteForecastResponse();
        ...
        private static DeleteForecastResponseUnmarshaller _instance = new DeleteForecastResponseUnmarshaller();        

        internal static DeleteForecastResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteForecastResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
