...
{
    /// <summary>
    /// Container for the parameters to the ListPredictorBacktestExportJobs operation.
    ...
    /// </para>
    /// </summary>
    public partial class ListPredictorBacktestExportJobsRequest : AmazonForecastServiceRequest
    {
        ...
        /// jobs, specify <code>IS_NOT</code>.
        /// </para>
        ///  </li> <li> 
        /// <para>
        ///  <code>Key</code> - The name of the parameter to filter on. Valid values are <code>PredictorBacktestExportJobArn</code>
