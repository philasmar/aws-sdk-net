...
{
    /// <summary>
    /// Response Unmarshaller for DeclineHandshake operation
    /// </summary>  
    public class DeclineHandshakeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeclineHandshakeResponse response = new DeclineHandshakeResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return HandshakeAlreadyInStateExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidHandshakeTransitionException"))
                {
                    return InvalidHandshakeTransitionExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static DeclineHandshakeResponseUnmarshaller _instance = new DeclineHandshakeResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeclineHandshakeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
