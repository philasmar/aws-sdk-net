...
{
    /// <summary>
    /// Response Unmarshaller for DelegatedAdministrator Object
    /// </summary>  
    public class DelegatedAdministratorUnmarshaller : IUnmarshaller<DelegatedAdministrator, XmlUnmarshallerContext>, IUnmarshaller<DelegatedAdministrator, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DelegatedAdministrator IUnmarshaller<DelegatedAdministrator, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DelegatedAdministrator Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.JoinedMethod = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DelegatedAdministratorUnmarshaller _instance = new DelegatedAdministratorUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DelegatedAdministratorUnmarshaller Instance
        {
            get
            {
                return _instance;
