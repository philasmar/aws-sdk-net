...
{
    /// <summary>
    /// CreateAccount Request Marshaller
    /// </summary>       
    public class CreateAccountRequestMarshaller : IMarshaller<IRequest, CreateAccountRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAccountRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAccountRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Organizations");
            string target = "AWSOrganizationsV20161128.CreateAccount";
        ...
        private static CreateAccountRequestMarshaller _instance = new CreateAccountRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccountRequestMarshaller Instance
        {
            get
            {
                return _instance;
