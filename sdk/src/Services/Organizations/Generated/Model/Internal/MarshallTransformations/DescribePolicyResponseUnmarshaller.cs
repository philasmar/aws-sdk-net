...
{
    /// <summary>
    /// Response Unmarshaller for DescribePolicy operation
    /// </summary>  
    public class DescribePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribePolicyResponse response = new DescribePolicyResponse();
        ...
        private static DescribePolicyResponseUnmarshaller _instance = new DescribePolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
