...
{
    /// <summary>
    /// Response Unmarshaller for ListDelegatedAdministrators operation
    /// </summary>  
    public class ListDelegatedAdministratorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDelegatedAdministratorsResponse response = new ListDelegatedAdministratorsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DelegatedAdministrator, DelegatedAdministratorUnmarshaller>(DelegatedAdministratorUnmarshaller.Instance);
                    response.DelegatedAdministrators = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListDelegatedAdministratorsResponseUnmarshaller _instance = new ListDelegatedAdministratorsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDelegatedAdministratorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
