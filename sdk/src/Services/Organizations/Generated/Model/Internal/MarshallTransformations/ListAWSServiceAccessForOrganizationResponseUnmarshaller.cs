...
{
    /// <summary>
    /// Response Unmarshaller for ListAWSServiceAccessForOrganization operation
    /// </summary>  
    public class ListAWSServiceAccessForOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAWSServiceAccessForOrganizationResponse response = new ListAWSServiceAccessForOrganizationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<EnabledServicePrincipal, EnabledServicePrincipalUnmarshaller>(EnabledServicePrincipalUnmarshaller.Instance);
                    response.EnabledServicePrincipals = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListAWSServiceAccessForOrganizationResponseUnmarshaller _instance = new ListAWSServiceAccessForOrganizationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAWSServiceAccessForOrganizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
