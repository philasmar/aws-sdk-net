...
{
    /// <summary>
    /// EnablePolicyType Request Marshaller
    /// </summary>       
    public class EnablePolicyTypeRequestMarshaller : IMarshaller<IRequest, EnablePolicyTypeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((EnablePolicyTypeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(EnablePolicyTypeRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Organizations");
            string target = "AWSOrganizationsV20161128.EnablePolicyType";
