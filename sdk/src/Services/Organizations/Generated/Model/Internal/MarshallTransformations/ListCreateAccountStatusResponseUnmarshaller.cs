...
{
    /// <summary>
    /// Response Unmarshaller for ListCreateAccountStatus operation
    /// </summary>  
    public class ListCreateAccountStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCreateAccountStatusResponse response = new ListCreateAccountStatusResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CreateAccountStatus, CreateAccountStatusUnmarshaller>(CreateAccountStatusUnmarshaller.Instance);
                    response.CreateAccountStatuses = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListCreateAccountStatusResponseUnmarshaller _instance = new ListCreateAccountStatusResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCreateAccountStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
