...
{
    /// <summary>
    /// ListCreateAccountStatus Request Marshaller
    /// </summary>       
    public class ListCreateAccountStatusRequestMarshaller : IMarshaller<IRequest, ListCreateAccountStatusRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListCreateAccountStatusRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListCreateAccountStatusRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Organizations");
            string target = "AWSOrganizationsV20161128.ListCreateAccountStatus";
