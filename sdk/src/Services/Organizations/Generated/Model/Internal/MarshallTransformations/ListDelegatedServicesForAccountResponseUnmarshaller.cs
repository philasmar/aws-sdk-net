...
{
    /// <summary>
    /// Response Unmarshaller for ListDelegatedServicesForAccount operation
    /// </summary>  
    public class ListDelegatedServicesForAccountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDelegatedServicesForAccountResponse response = new ListDelegatedServicesForAccountResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DelegatedService, DelegatedServiceUnmarshaller>(DelegatedServiceUnmarshaller.Instance);
                    response.DelegatedServices = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListDelegatedServicesForAccountResponseUnmarshaller _instance = new ListDelegatedServicesForAccountResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDelegatedServicesForAccountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
