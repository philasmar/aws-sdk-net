...
{
    /// <summary>
    /// InviteAccountToOrganization Request Marshaller
    /// </summary>       
    public class InviteAccountToOrganizationRequestMarshaller : IMarshaller<IRequest, InviteAccountToOrganizationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((InviteAccountToOrganizationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(InviteAccountToOrganizationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Organizations");
            string target = "AWSOrganizationsV20161128.InviteAccountToOrganization";
