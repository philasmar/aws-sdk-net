...
{
    /// <summary>
    /// Response Unmarshaller for ListHandshakesForOrganization operation
    /// </summary>  
    public class ListHandshakesForOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListHandshakesForOrganizationResponse response = new ListHandshakesForOrganizationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Handshake, HandshakeUnmarshaller>(HandshakeUnmarshaller.Instance);
                    response.Handshakes = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListHandshakesForOrganizationResponseUnmarshaller _instance = new ListHandshakesForOrganizationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListHandshakesForOrganizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
