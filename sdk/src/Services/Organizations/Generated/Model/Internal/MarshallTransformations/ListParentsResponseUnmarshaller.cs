...
{
    /// <summary>
    /// Response Unmarshaller for ListParents operation
    /// </summary>  
    public class ListParentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListParentsResponse response = new ListParentsResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ChildNotFoundException"))
                {
                    return ChildNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static ListParentsResponseUnmarshaller _instance = new ListParentsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListParentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
