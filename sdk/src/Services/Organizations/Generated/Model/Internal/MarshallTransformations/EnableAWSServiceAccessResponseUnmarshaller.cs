...
{
    /// <summary>
    /// Response Unmarshaller for EnableAWSServiceAccess operation
    /// </summary>  
    public class EnableAWSServiceAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnableAWSServiceAccessResponse response = new EnableAWSServiceAccessResponse();
        ...
        private static EnableAWSServiceAccessResponseUnmarshaller _instance = new EnableAWSServiceAccessResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableAWSServiceAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
