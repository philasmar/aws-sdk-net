...
{
    /// <summary>
    /// Response Unmarshaller for UpdateOrganizationalUnit operation
    /// </summary>  
    public class UpdateOrganizationalUnitResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateOrganizationalUnitResponse response = new UpdateOrganizationalUnitResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("DuplicateOrganizationalUnitException"))
                {
                    return DuplicateOrganizationalUnitExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static UpdateOrganizationalUnitResponseUnmarshaller _instance = new UpdateOrganizationalUnitResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateOrganizationalUnitResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
