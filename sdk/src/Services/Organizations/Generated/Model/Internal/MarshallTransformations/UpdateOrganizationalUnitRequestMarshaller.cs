...
{
    /// <summary>
    /// UpdateOrganizationalUnit Request Marshaller
    /// </summary>       
    public class UpdateOrganizationalUnitRequestMarshaller : IMarshaller<IRequest, UpdateOrganizationalUnitRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateOrganizationalUnitRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateOrganizationalUnitRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Organizations");
            string target = "AWSOrganizationsV20161128.UpdateOrganizationalUnit";
