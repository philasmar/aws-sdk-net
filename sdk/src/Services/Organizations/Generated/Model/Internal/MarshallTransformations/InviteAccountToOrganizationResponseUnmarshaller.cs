...
{
    /// <summary>
    /// Response Unmarshaller for InviteAccountToOrganization operation
    /// </summary>  
    public class InviteAccountToOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            InviteAccountToOrganizationResponse response = new InviteAccountToOrganizationResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("AccountOwnerNotVerifiedException"))
                {
                    return AccountOwnerNotVerifiedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static InviteAccountToOrganizationResponseUnmarshaller _instance = new InviteAccountToOrganizationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InviteAccountToOrganizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
