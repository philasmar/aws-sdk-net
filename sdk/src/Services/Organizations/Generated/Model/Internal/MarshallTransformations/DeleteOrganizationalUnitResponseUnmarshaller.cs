...
{
    /// <summary>
    /// Response Unmarshaller for DeleteOrganizationalUnit operation
    /// </summary>  
    public class DeleteOrganizationalUnitResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteOrganizationalUnitResponse response = new DeleteOrganizationalUnitResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("OrganizationalUnitNotEmptyException"))
                {
                    return OrganizationalUnitNotEmptyExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static DeleteOrganizationalUnitResponseUnmarshaller _instance = new DeleteOrganizationalUnitResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteOrganizationalUnitResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
