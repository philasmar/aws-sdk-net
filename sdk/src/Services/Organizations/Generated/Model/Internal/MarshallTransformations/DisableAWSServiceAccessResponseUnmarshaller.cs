...
{
    /// <summary>
    /// Response Unmarshaller for DisableAWSServiceAccess operation
    /// </summary>  
    public class DisableAWSServiceAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisableAWSServiceAccessResponse response = new DisableAWSServiceAccessResponse();
        ...
        private static DisableAWSServiceAccessResponseUnmarshaller _instance = new DisableAWSServiceAccessResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableAWSServiceAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
