...
namespace Amazon.LexRuntimeV2.Model.Internal.MarshallTransformations
{
    ...
    /// Value Marshaller
    /// </summary>       
    public class ValueMarshaller : IRequestMarshaller<Value, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(Value requestObject, JsonMarshallerContext context)
        {
        ...
        /// </summary>  
        public readonly static ValueMarshaller Instance = new ValueMarshaller();
