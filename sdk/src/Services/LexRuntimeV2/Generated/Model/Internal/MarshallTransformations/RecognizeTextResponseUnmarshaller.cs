...
namespace Amazon.LexRuntimeV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RecognizeTextResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("requestAttributes", targetDepth))
                {
                    ...
                    response.RequestAttributes = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static RecognizeTextResponseUnmarshaller _instance = new RecognizeTextResponseUnmarshaller();        

        internal static RecognizeTextResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RecognizeTextResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
