...
namespace Amazon.GlobalAccelerator.Model.Internal.MarshallTransformations
{
    ...
    public class ProvisionByoipCidrRequestMarshaller : IMarshaller<IRequest, ProvisionByoipCidrRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ProvisionByoipCidrRequest publicRequest)
        {
            ...
            string target = "GlobalAccelerator_V20180706.ProvisionByoipCidr";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                {
                    context.Writer.WritePropertyName("CidrAuthorizationContext");
                    context.Writer.WriteObjectStart();

                    var marshaller = CidrAuthorizationContextMarshaller.Instance;
                    marshaller.Marshall(publicRequest.CidrAuthorizationContext, context);
