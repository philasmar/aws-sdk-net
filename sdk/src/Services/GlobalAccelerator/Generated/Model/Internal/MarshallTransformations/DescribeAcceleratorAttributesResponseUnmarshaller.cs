...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAcceleratorAttributes operation
    /// </summary>  
    public class DescribeAcceleratorAttributesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAcceleratorAttributesResponse response = new DescribeAcceleratorAttributesResponse();
        ...
        private static DescribeAcceleratorAttributesResponseUnmarshaller _instance = new DescribeAcceleratorAttributesResponseUnmarshaller();        

        internal static DescribeAcceleratorAttributesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAcceleratorAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
