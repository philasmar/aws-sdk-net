...
{
    /// <summary>
    /// Response Unmarshaller for AddCustomRoutingEndpoints operation
    /// </summary>  
    public class AddCustomRoutingEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddCustomRoutingEndpointsResponse response = new AddCustomRoutingEndpointsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("EndpointDescriptions", targetDepth))
                {
                    ...
                    response.EndpointDescriptions = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("EndpointGroupArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.EndpointGroupArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("EndpointAlreadyExistsException"))
                {
        ...
        private static AddCustomRoutingEndpointsResponseUnmarshaller _instance = new AddCustomRoutingEndpointsResponseUnmarshaller();        

        internal static AddCustomRoutingEndpointsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddCustomRoutingEndpointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
