...
{
    /// <summary>
    /// Response Unmarshaller for ListCustomRoutingEndpointGroups operation
    /// </summary>  
    public class ListCustomRoutingEndpointGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCustomRoutingEndpointGroupsResponse response = new ListCustomRoutingEndpointGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CustomRoutingEndpointGroup, CustomRoutingEndpointGroupUnmarshaller>(CustomRoutingEndpointGroupUnmarshaller.Instance);
        ...
        private static ListCustomRoutingEndpointGroupsResponseUnmarshaller _instance = new ListCustomRoutingEndpointGroupsResponseUnmarshaller();        

        internal static ListCustomRoutingEndpointGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCustomRoutingEndpointGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
