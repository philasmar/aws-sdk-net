...
{
    /// <summary>
    /// Response Unmarshaller for AllowCustomRoutingTraffic operation
    /// </summary>  
    public class AllowCustomRoutingTrafficResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AllowCustomRoutingTrafficResponse response = new AllowCustomRoutingTrafficResponse();
        ...
        private static AllowCustomRoutingTrafficResponseUnmarshaller _instance = new AllowCustomRoutingTrafficResponseUnmarshaller();        

        internal static AllowCustomRoutingTrafficResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AllowCustomRoutingTrafficResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
