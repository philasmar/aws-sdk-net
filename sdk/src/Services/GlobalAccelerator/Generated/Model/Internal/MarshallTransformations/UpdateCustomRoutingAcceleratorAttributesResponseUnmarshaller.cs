...
{
    /// <summary>
    /// Response Unmarshaller for UpdateCustomRoutingAcceleratorAttributes operation
    /// </summary>  
    public class UpdateCustomRoutingAcceleratorAttributesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateCustomRoutingAcceleratorAttributesResponse response = new UpdateCustomRoutingAcceleratorAttributesResponse();
        ...
        private static UpdateCustomRoutingAcceleratorAttributesResponseUnmarshaller _instance = new UpdateCustomRoutingAcceleratorAttributesResponseUnmarshaller();        

        internal static UpdateCustomRoutingAcceleratorAttributesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCustomRoutingAcceleratorAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
