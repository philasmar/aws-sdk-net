...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAccelerator operation
    /// </summary>  
    public class DescribeAcceleratorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAcceleratorResponse response = new DescribeAcceleratorResponse();
        ...
        private static DescribeAcceleratorResponseUnmarshaller _instance = new DescribeAcceleratorResponseUnmarshaller();        

        internal static DescribeAcceleratorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAcceleratorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
