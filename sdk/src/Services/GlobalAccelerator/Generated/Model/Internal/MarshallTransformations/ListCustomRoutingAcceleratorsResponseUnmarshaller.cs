...
{
    /// <summary>
    /// Response Unmarshaller for ListCustomRoutingAccelerators operation
    /// </summary>  
    public class ListCustomRoutingAcceleratorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCustomRoutingAcceleratorsResponse response = new ListCustomRoutingAcceleratorsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CustomRoutingAccelerator, CustomRoutingAcceleratorUnmarshaller>(CustomRoutingAcceleratorUnmarshaller.Instance);
        ...
        private static ListCustomRoutingAcceleratorsResponseUnmarshaller _instance = new ListCustomRoutingAcceleratorsResponseUnmarshaller();        

        internal static ListCustomRoutingAcceleratorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCustomRoutingAcceleratorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
