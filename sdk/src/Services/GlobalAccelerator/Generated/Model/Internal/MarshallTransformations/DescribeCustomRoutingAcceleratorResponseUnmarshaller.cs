...
{
    /// <summary>
    /// Response Unmarshaller for DescribeCustomRoutingAccelerator operation
    /// </summary>  
    public class DescribeCustomRoutingAcceleratorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeCustomRoutingAcceleratorResponse response = new DescribeCustomRoutingAcceleratorResponse();
        ...
        private static DescribeCustomRoutingAcceleratorResponseUnmarshaller _instance = new DescribeCustomRoutingAcceleratorResponseUnmarshaller();        

        internal static DescribeCustomRoutingAcceleratorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCustomRoutingAcceleratorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
