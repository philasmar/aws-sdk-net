...
{
    /// <summary>
    /// Response Unmarshaller for CreateCustomRoutingListener operation
    /// </summary>  
    public class CreateCustomRoutingListenerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCustomRoutingListenerResponse response = new CreateCustomRoutingListenerResponse();
        ...
        private static CreateCustomRoutingListenerResponseUnmarshaller _instance = new CreateCustomRoutingListenerResponseUnmarshaller();        

        internal static CreateCustomRoutingListenerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCustomRoutingListenerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
