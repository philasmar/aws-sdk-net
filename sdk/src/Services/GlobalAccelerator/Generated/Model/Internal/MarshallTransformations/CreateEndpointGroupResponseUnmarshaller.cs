...
{
    /// <summary>
    /// Response Unmarshaller for CreateEndpointGroup operation
    /// </summary>  
    public class CreateEndpointGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEndpointGroupResponse response = new CreateEndpointGroupResponse();
        ...
        private static CreateEndpointGroupResponseUnmarshaller _instance = new CreateEndpointGroupResponseUnmarshaller();        

        internal static CreateEndpointGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEndpointGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
