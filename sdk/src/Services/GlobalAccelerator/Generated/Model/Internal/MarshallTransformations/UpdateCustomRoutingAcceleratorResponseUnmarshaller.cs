...
{
    /// <summary>
    /// Response Unmarshaller for UpdateCustomRoutingAccelerator operation
    /// </summary>  
    public class UpdateCustomRoutingAcceleratorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateCustomRoutingAcceleratorResponse response = new UpdateCustomRoutingAcceleratorResponse();
        ...
        private static UpdateCustomRoutingAcceleratorResponseUnmarshaller _instance = new UpdateCustomRoutingAcceleratorResponseUnmarshaller();        

        internal static UpdateCustomRoutingAcceleratorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCustomRoutingAcceleratorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
