...
namespace Amazon.GlobalAccelerator.Model.Internal.MarshallTransformations
{
    ...
    public class CreateListenerRequestMarshaller : IMarshaller<IRequest, CreateListenerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateListenerRequest publicRequest)
        {
            ...
            string target = "GlobalAccelerator_V20180706.CreateListener";
        ...
        private static CreateListenerRequestMarshaller _instance = new CreateListenerRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateListenerRequestMarshaller Instance
        {
            get
            {
                return _instance;
