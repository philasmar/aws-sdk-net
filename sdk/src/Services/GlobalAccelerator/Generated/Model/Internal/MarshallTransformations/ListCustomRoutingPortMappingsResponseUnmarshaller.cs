...
{
    /// <summary>
    /// Response Unmarshaller for ListCustomRoutingPortMappings operation
    /// </summary>  
    public class ListCustomRoutingPortMappingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCustomRoutingPortMappingsResponse response = new ListCustomRoutingPortMappingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("PortMappings", targetDepth))
                {
                    ...
                    response.PortMappings = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListCustomRoutingPortMappingsResponseUnmarshaller _instance = new ListCustomRoutingPortMappingsResponseUnmarshaller();        

        internal static ListCustomRoutingPortMappingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCustomRoutingPortMappingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
