...
{
    /// <summary>
    /// Response Unmarshaller for UpdateListener operation
    /// </summary>  
    public class UpdateListenerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateListenerResponse response = new UpdateListenerResponse();
        ...
        private static UpdateListenerResponseUnmarshaller _instance = new UpdateListenerResponseUnmarshaller();        

        internal static UpdateListenerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateListenerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
