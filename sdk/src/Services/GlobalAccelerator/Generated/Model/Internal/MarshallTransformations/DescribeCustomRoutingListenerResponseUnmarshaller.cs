...
{
    /// <summary>
    /// Response Unmarshaller for DescribeCustomRoutingListener operation
    /// </summary>  
    public class DescribeCustomRoutingListenerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeCustomRoutingListenerResponse response = new DescribeCustomRoutingListenerResponse();
        ...
        private static DescribeCustomRoutingListenerResponseUnmarshaller _instance = new DescribeCustomRoutingListenerResponseUnmarshaller();        

        internal static DescribeCustomRoutingListenerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCustomRoutingListenerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
