...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAccelerator operation
    /// </summary>  
    public class UpdateAcceleratorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAcceleratorResponse response = new UpdateAcceleratorResponse();
        ...
        private static UpdateAcceleratorResponseUnmarshaller _instance = new UpdateAcceleratorResponseUnmarshaller();        

        internal static UpdateAcceleratorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAcceleratorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
