...
{
    /// <summary>
    /// Response Unmarshaller for DescribeCustomRoutingAcceleratorAttributes operation
    /// </summary>  
    public class DescribeCustomRoutingAcceleratorAttributesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeCustomRoutingAcceleratorAttributesResponse response = new DescribeCustomRoutingAcceleratorAttributesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = CustomRoutingAcceleratorAttributesUnmarshaller.Instance;
        ...
        private static DescribeCustomRoutingAcceleratorAttributesResponseUnmarshaller _instance = new DescribeCustomRoutingAcceleratorAttributesResponseUnmarshaller();        

        internal static DescribeCustomRoutingAcceleratorAttributesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCustomRoutingAcceleratorAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
