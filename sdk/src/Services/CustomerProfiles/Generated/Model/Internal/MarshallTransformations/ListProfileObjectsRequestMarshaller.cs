...
{
    /// <summary>
    /// ListProfileObjects Request Marshaller
    /// </summary>       
    public class ListProfileObjectsRequestMarshaller : IMarshaller<IRequest, ListProfileObjectsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListProfileObjectsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListProfileObjectsRequest publicRequest)
        {
        ...
        private static ListProfileObjectsRequestMarshaller _instance = new ListProfileObjectsRequestMarshaller();        

        internal static ListProfileObjectsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListProfileObjectsRequestMarshaller Instance
        {
            get
            {
                return _instance;
