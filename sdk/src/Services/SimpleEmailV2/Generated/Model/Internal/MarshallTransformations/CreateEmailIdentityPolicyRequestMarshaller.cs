...
{
    /// <summary>
    /// CreateEmailIdentityPolicy Request Marshaller
    /// </summary>       
    public class CreateEmailIdentityPolicyRequestMarshaller : IMarshaller<IRequest, CreateEmailIdentityPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateEmailIdentityPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateEmailIdentityPolicyRequest publicRequest)
        {
        ...
        private static CreateEmailIdentityPolicyRequestMarshaller _instance = new CreateEmailIdentityPolicyRequestMarshaller();        

        internal static CreateEmailIdentityPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEmailIdentityPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
