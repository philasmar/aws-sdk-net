...
namespace Amazon.SimpleEmailV2.Model.Internal.MarshallTransformations
{
    ...
    public class SuppressionListDestinationUnmarshaller : IUnmarshaller<SuppressionListDestination, XmlUnmarshallerContext>, IUnmarshaller<SuppressionListDestination, JsonUnmarshallerContext>
    {
        ...
        private static SuppressionListDestinationUnmarshaller _instance = new SuppressionListDestinationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SuppressionListDestinationUnmarshaller Instance
        {
            get
            {
                return _instance;
