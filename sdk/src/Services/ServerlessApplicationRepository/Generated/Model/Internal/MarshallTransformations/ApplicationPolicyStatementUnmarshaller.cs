...
{
    /// <summary>
    /// Response Unmarshaller for ApplicationPolicyStatement Object
    /// </summary>  
    public class ApplicationPolicyStatementUnmarshaller : IUnmarshaller<ApplicationPolicyStatement, XmlUnmarshallerContext>, IUnmarshaller<ApplicationPolicyStatement, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ApplicationPolicyStatement IUnmarshaller<ApplicationPolicyStatement, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static ApplicationPolicyStatementUnmarshaller _instance = new ApplicationPolicyStatementUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ApplicationPolicyStatementUnmarshaller Instance
        {
            get
            {
                return _instance;
