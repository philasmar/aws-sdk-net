...
namespace Amazon.ServerlessApplicationRepository.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListApplicationVersionsRequestMarshaller : IMarshaller<IRequest, ListApplicationVersionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListApplicationVersionsRequestMarshaller _instance = new ListApplicationVersionsRequestMarshaller();        

        internal static ListApplicationVersionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListApplicationVersionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
