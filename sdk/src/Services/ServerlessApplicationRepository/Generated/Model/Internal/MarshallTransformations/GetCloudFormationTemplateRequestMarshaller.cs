...
namespace Amazon.ServerlessApplicationRepository.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetCloudFormationTemplateRequestMarshaller : IMarshaller<IRequest, GetCloudFormationTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetCloudFormationTemplateRequestMarshaller _instance = new GetCloudFormationTemplateRequestMarshaller();        

        internal static GetCloudFormationTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCloudFormationTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
