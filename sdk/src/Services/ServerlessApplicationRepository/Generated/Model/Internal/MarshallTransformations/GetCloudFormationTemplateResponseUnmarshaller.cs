...
{
    /// <summary>
    /// Response Unmarshaller for GetCloudFormationTemplate operation
    /// </summary>  
    public class GetCloudFormationTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCloudFormationTemplateResponse response = new GetCloudFormationTemplateResponse();
        ...
        private static GetCloudFormationTemplateResponseUnmarshaller _instance = new GetCloudFormationTemplateResponseUnmarshaller();        

        internal static GetCloudFormationTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCloudFormationTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
