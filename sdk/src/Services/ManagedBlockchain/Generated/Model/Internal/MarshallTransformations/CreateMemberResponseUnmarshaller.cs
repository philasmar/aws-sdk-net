...
namespace Amazon.ManagedBlockchain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateMemberResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        internal static CreateMemberResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMemberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
