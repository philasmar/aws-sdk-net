...
{
    /// <summary>
    /// GetNetwork Request Marshaller
    /// </summary>       
    public class GetNetworkRequestMarshaller : IMarshaller<IRequest, GetNetworkRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetNetworkRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetNetworkRequest publicRequest)
        {
        ...
        private static GetNetworkRequestMarshaller _instance = new GetNetworkRequestMarshaller();        

        internal static GetNetworkRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetNetworkRequestMarshaller Instance
        {
            get
            {
                return _instance;
