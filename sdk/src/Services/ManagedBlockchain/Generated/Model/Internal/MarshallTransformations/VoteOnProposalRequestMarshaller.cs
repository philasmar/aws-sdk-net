...
namespace Amazon.ManagedBlockchain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class VoteOnProposalRequestMarshaller : IMarshaller<IRequest, VoteOnProposalRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static VoteOnProposalRequestMarshaller _instance = new VoteOnProposalRequestMarshaller();        

        internal static VoteOnProposalRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VoteOnProposalRequestMarshaller Instance
        {
            get
            {
                return _instance;
