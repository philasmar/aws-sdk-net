...
{
    /// <summary>
    /// DeleteNode Request Marshaller
    /// </summary>       
    public class DeleteNodeRequestMarshaller : IMarshaller<IRequest, DeleteNodeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteNodeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteNodeRequest publicRequest)
        {
        ...
        private static DeleteNodeRequestMarshaller _instance = new DeleteNodeRequestMarshaller();        

        internal static DeleteNodeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteNodeRequestMarshaller Instance
        {
            get
            {
                return _instance;
