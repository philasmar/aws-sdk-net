...
namespace Amazon.ManagedBlockchain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetProposalRequestMarshaller : IMarshaller<IRequest, GetProposalRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetProposalRequestMarshaller _instance = new GetProposalRequestMarshaller();        

        internal static GetProposalRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetProposalRequestMarshaller Instance
        {
            get
            {
                return _instance;
