...
{
    /// <summary>
    /// Response Unmarshaller for ListNetworks operation
    /// </summary>  
    public class ListNetworksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListNetworksResponseUnmarshaller _instance = new ListNetworksResponseUnmarshaller();        

        internal static ListNetworksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListNetworksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
