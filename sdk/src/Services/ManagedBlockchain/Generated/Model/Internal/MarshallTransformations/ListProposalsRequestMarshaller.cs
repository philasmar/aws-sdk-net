...
{
    /// <summary>
    /// ListProposals Request Marshaller
    /// </summary>       
    public class ListProposalsRequestMarshaller : IMarshaller<IRequest, ListProposalsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListProposalsRequest)input);
        }
        ...
        private static ListProposalsRequestMarshaller _instance = new ListProposalsRequestMarshaller();        

        internal static ListProposalsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListProposalsRequestMarshaller Instance
        {
            get
            {
                return _instance;
