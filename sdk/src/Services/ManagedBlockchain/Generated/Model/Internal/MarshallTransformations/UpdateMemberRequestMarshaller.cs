...
{
    /// <summary>
    /// UpdateMember Request Marshaller
    /// </summary>       
    public class UpdateMemberRequestMarshaller : IMarshaller<IRequest, UpdateMemberRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateMemberRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateMemberRequest publicRequest)
        {
        ...
        private static UpdateMemberRequestMarshaller _instance = new UpdateMemberRequestMarshaller();        

        internal static UpdateMemberRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMemberRequestMarshaller Instance
        {
            get
            {
                return _instance;
