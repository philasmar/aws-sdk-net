...
namespace Amazon.ManagedBlockchain.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VotingPolicyUnmarshaller : IUnmarshaller<VotingPolicy, XmlUnmarshallerContext>, IUnmarshaller<VotingPolicy, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        VotingPolicy IUnmarshaller<VotingPolicy, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public VotingPolicy Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ApprovalThresholdPolicy", targetDepth))
                {
                    ...
                    unmarshalledObject.ApprovalThresholdPolicy = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
