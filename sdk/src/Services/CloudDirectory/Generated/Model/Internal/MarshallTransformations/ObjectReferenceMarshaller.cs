...
namespace Amazon.CloudDirectory.Model.Internal.MarshallTransformations
{
    ...
    public class ObjectReferenceMarshaller : IRequestMarshaller<ObjectReference, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(ObjectReference requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetSelector())
            {
                context.Writer.WritePropertyName("Selector");
                context.Writer.Write(requestObject.Selector);
            }
