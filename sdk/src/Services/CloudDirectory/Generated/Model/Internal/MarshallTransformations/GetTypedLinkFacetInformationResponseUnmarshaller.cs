...
{
    /// <summary>
    /// Response Unmarshaller for GetTypedLinkFacetInformation operation
    /// </summary>  
    public class GetTypedLinkFacetInformationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTypedLinkFacetInformationResponse response = new GetTypedLinkFacetInformationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("IdentityAttributeOrder", targetDepth))
                {
                    ...
                    response.IdentityAttributeOrder = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetTypedLinkFacetInformationResponseUnmarshaller _instance = new GetTypedLinkFacetInformationResponseUnmarshaller();        

        internal static GetTypedLinkFacetInformationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTypedLinkFacetInformationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
