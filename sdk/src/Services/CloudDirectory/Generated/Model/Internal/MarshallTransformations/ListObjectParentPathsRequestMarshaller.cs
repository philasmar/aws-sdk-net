...
{
    /// <summary>
    /// ListObjectParentPaths Request Marshaller
    /// </summary>       
    public class ListObjectParentPathsRequestMarshaller : IMarshaller<IRequest, ListObjectParentPathsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListObjectParentPathsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListObjectParentPathsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/amazonclouddirectory/2017-01-11/object/parentpaths";
