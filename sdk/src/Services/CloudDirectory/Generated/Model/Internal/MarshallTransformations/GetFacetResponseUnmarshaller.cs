...
{
    /// <summary>
    /// Response Unmarshaller for GetFacet operation
    /// </summary>  
    public class GetFacetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetFacetResponse response = new GetFacetResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = FacetUnmarshaller.Instance;
                    response.Facet = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetFacetResponseUnmarshaller _instance = new GetFacetResponseUnmarshaller();        

        internal static GetFacetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFacetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
