...
{
    /// <summary>
    /// Response Unmarshaller for ListPublishedSchemaArns operation
    /// </summary>  
    public class ListPublishedSchemaArnsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPublishedSchemaArnsResponse response = new ListPublishedSchemaArnsResponse();
        ...
        private static ListPublishedSchemaArnsResponseUnmarshaller _instance = new ListPublishedSchemaArnsResponseUnmarshaller();        

        internal static ListPublishedSchemaArnsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPublishedSchemaArnsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
