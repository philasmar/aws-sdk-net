...
{
    /// <summary>
    /// Response Unmarshaller for PublishSchema operation
    /// </summary>  
    public class PublishSchemaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PublishSchemaResponse response = new PublishSchemaResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("PublishedSchemaArn", targetDepth))
                {
                    ...
                    response.PublishedSchemaArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("SchemaAlreadyPublishedException"))
                {
                    return SchemaAlreadyPublishedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static PublishSchemaResponseUnmarshaller _instance = new PublishSchemaResponseUnmarshaller();        

        internal static PublishSchemaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PublishSchemaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
