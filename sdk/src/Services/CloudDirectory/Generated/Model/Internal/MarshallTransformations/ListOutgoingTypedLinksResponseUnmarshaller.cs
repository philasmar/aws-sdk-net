...
{
    /// <summary>
    /// Response Unmarshaller for ListOutgoingTypedLinks operation
    /// </summary>  
    public class ListOutgoingTypedLinksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListOutgoingTypedLinksResponse response = new ListOutgoingTypedLinksResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("TypedLinkSpecifiers", targetDepth))
                {
                    ...
                    response.TypedLinkSpecifiers = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListOutgoingTypedLinksResponseUnmarshaller _instance = new ListOutgoingTypedLinksResponseUnmarshaller();        

        internal static ListOutgoingTypedLinksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOutgoingTypedLinksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
