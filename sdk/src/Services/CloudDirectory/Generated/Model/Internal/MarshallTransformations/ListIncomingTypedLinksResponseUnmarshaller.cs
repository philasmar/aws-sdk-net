...
{
    /// <summary>
    /// Response Unmarshaller for ListIncomingTypedLinks operation
    /// </summary>  
    public class ListIncomingTypedLinksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListIncomingTypedLinksResponse response = new ListIncomingTypedLinksResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("LinkSpecifiers", targetDepth))
                {
                    ...
                    response.LinkSpecifiers = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListIncomingTypedLinksResponseUnmarshaller _instance = new ListIncomingTypedLinksResponseUnmarshaller();        

        internal static ListIncomingTypedLinksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIncomingTypedLinksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
