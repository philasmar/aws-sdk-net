...
{
    /// <summary>
    /// Response Unmarshaller for GetDirectory operation
    /// </summary>  
    public class GetDirectoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetDirectoryResponseUnmarshaller _instance = new GetDirectoryResponseUnmarshaller();        

        internal static GetDirectoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDirectoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
