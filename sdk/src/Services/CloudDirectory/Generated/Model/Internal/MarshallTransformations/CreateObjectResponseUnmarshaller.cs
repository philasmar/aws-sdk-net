...
{
    /// <summary>
    /// Response Unmarshaller for CreateObject operation
    /// </summary>  
    public class CreateObjectResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateObjectResponseUnmarshaller _instance = new CreateObjectResponseUnmarshaller();        

        internal static CreateObjectResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateObjectResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
