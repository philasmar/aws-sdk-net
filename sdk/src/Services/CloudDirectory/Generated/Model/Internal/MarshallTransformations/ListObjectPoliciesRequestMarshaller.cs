...
{
    /// <summary>
    /// ListObjectPolicies Request Marshaller
    /// </summary>       
    public class ListObjectPoliciesRequestMarshaller : IMarshaller<IRequest, ListObjectPoliciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListObjectPoliciesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListObjectPoliciesRequest publicRequest)
        {
        ...
        private static ListObjectPoliciesRequestMarshaller _instance = new ListObjectPoliciesRequestMarshaller();        

        internal static ListObjectPoliciesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListObjectPoliciesRequestMarshaller Instance
        {
            get
            {
                return _instance;
