    ...
    public class BatchReadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BatchReadOperationResponse, BatchReadOperationResponseUnmarshaller>(BatchReadOperationResponseUnmarshaller.Instance);
        ...
        private static BatchReadResponseUnmarshaller _instance = new BatchReadResponseUnmarshaller();        

        internal static BatchReadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchReadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
