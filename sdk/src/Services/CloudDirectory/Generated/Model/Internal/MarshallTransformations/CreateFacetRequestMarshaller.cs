...
namespace Amazon.CloudDirectory.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateFacetRequestMarshaller : IMarshaller<IRequest, CreateFacetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateFacetRequestMarshaller _instance = new CreateFacetRequestMarshaller();        

        internal static CreateFacetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFacetRequestMarshaller Instance
        {
            get
            {
                return _instance;
