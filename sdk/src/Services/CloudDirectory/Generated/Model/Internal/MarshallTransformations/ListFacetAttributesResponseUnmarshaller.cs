...
{
    /// <summary>
    /// Response Unmarshaller for ListFacetAttributes operation
    /// </summary>  
    public class ListFacetAttributesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFacetAttributesResponse response = new ListFacetAttributesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<FacetAttribute, FacetAttributeUnmarshaller>(FacetAttributeUnmarshaller.Instance);
        ...
        private static ListFacetAttributesResponseUnmarshaller _instance = new ListFacetAttributesResponseUnmarshaller();        

        internal static ListFacetAttributesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFacetAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
