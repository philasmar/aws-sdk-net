...
{
    /// <summary>
    /// DetachFromIndex Request Marshaller
    /// </summary>       
    public class DetachFromIndexRequestMarshaller : IMarshaller<IRequest, DetachFromIndexRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DetachFromIndexRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DetachFromIndexRequest publicRequest)
        {
        ...
        private static DetachFromIndexRequestMarshaller _instance = new DetachFromIndexRequestMarshaller();        

        internal static DetachFromIndexRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachFromIndexRequestMarshaller Instance
        {
            get
            {
                return _instance;
