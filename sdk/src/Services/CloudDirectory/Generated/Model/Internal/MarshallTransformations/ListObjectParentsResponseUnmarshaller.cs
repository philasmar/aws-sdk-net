...
{
    /// <summary>
    /// Response Unmarshaller for ListObjectParents operation
    /// </summary>  
    public class ListObjectParentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListObjectParentsResponse response = new ListObjectParentsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("Parents", targetDepth))
                {
                    ...
                    response.Parents = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("CannotListParentOfRootException"))
                {
                    return CannotListParentOfRootExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static ListObjectParentsResponseUnmarshaller _instance = new ListObjectParentsResponseUnmarshaller();        

        internal static ListObjectParentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListObjectParentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
