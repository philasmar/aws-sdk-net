...
{
    /// <summary>
    /// Response Unmarshaller for CreateFacet operation
    /// </summary>  
    public class CreateFacetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateFacetResponse response = new CreateFacetResponse();
        ...
        private static CreateFacetResponseUnmarshaller _instance = new CreateFacetResponseUnmarshaller();        

        internal static CreateFacetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFacetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
