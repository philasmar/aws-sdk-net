...
{
    /// <summary>
    /// Response Unmarshaller for DetachObject operation
    /// </summary>  
    public class DetachObjectResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetachObjectResponse response = new DetachObjectResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("NotNodeException"))
                {
                    return NotNodeExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static DetachObjectResponseUnmarshaller _instance = new DetachObjectResponseUnmarshaller();        

        internal static DetachObjectResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachObjectResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
