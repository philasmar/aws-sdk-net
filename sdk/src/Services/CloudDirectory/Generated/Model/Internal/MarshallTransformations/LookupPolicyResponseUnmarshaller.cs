...
{
    /// <summary>
    /// Response Unmarshaller for LookupPolicy operation
    /// </summary>  
    public class LookupPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            LookupPolicyResponse response = new LookupPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("PolicyToPathList", targetDepth))
                {
                    ...
                    response.PolicyToPathList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static LookupPolicyResponseUnmarshaller _instance = new LookupPolicyResponseUnmarshaller();        

        internal static LookupPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static LookupPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
