...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSchema operation
    /// </summary>  
    public class DeleteSchemaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSchemaResponse response = new DeleteSchemaResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("StillContainsLinksException"))
                {
                    return StillContainsLinksExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static DeleteSchemaResponseUnmarshaller _instance = new DeleteSchemaResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSchemaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
