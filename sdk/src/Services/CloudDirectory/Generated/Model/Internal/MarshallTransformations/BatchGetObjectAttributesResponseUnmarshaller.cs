...
namespace Amazon.CloudDirectory.Model.Internal.MarshallTransformations
{
    ...
    public class BatchGetObjectAttributesResponseUnmarshaller : IUnmarshaller<BatchGetObjectAttributesResponse, XmlUnmarshallerContext>, IUnmarshaller<BatchGetObjectAttributesResponse, JsonUnmarshallerContext>
    {
        ...
        private static BatchGetObjectAttributesResponseUnmarshaller _instance = new BatchGetObjectAttributesResponseUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetObjectAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
