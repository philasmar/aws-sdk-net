...
namespace Amazon.CloudDirectory.Model.Internal.MarshallTransformations
{
    ...
    public class FacetAttributeReferenceMarshaller : IRequestMarshaller<FacetAttributeReference, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(FacetAttributeReference requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetTargetFacetName())
            {
                context.Writer.WritePropertyName("TargetFacetName");
                context.Writer.Write(requestObject.TargetFacetName);
            }
