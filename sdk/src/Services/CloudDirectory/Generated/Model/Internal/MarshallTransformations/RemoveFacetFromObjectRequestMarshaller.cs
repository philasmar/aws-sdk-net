...
{
    /// <summary>
    /// RemoveFacetFromObject Request Marshaller
    /// </summary>       
    public class RemoveFacetFromObjectRequestMarshaller : IMarshaller<IRequest, RemoveFacetFromObjectRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RemoveFacetFromObjectRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RemoveFacetFromObjectRequest publicRequest)
        {
            ...
            request.ResourcePath = "/amazonclouddirectory/2017-01-11/object/facets/delete";
