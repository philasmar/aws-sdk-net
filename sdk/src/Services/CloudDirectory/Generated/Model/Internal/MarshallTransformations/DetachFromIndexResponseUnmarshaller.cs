...
{
    /// <summary>
    /// Response Unmarshaller for DetachFromIndex operation
    /// </summary>  
    public class DetachFromIndexResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetachFromIndexResponse response = new DetachFromIndexResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DetachedObjectIdentifier", targetDepth))
                {
                    ...
                    response.DetachedObjectIdentifier = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ObjectAlreadyDetachedException"))
                {
                    return ObjectAlreadyDetachedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static DetachFromIndexResponseUnmarshaller _instance = new DetachFromIndexResponseUnmarshaller();        

        internal static DetachFromIndexResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachFromIndexResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
