...
{
    /// <summary>
    /// Response Unmarshaller for UpgradePublishedSchema operation
    /// </summary>  
    public class UpgradePublishedSchemaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpgradePublishedSchemaResponse response = new UpgradePublishedSchemaResponse();
        ...
        private static UpgradePublishedSchemaResponseUnmarshaller _instance = new UpgradePublishedSchemaResponseUnmarshaller();        

        internal static UpgradePublishedSchemaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpgradePublishedSchemaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
