...
{
    /// <summary>
    /// Response Unmarshaller for EnableDirectory operation
    /// </summary>  
    public class EnableDirectoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnableDirectoryResponse response = new EnableDirectoryResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return DirectoryDeletedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static EnableDirectoryResponseUnmarshaller _instance = new EnableDirectoryResponseUnmarshaller();        

        internal static EnableDirectoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableDirectoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
