...
{
    /// <summary>
    /// Response Unmarshaller for ListPolicyAttachments operation
    /// </summary>  
    public class ListPolicyAttachmentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPolicyAttachmentsResponse response = new ListPolicyAttachmentsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("ObjectIdentifiers", targetDepth))
                {
                    ...
                    response.ObjectIdentifiers = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListPolicyAttachmentsResponseUnmarshaller _instance = new ListPolicyAttachmentsResponseUnmarshaller();        

        internal static ListPolicyAttachmentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPolicyAttachmentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
