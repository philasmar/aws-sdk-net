...
{
    /// <summary>
    /// Response Unmarshaller for ListIndex operation
    /// </summary>  
    public class ListIndexResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListIndexResponseUnmarshaller _instance = new ListIndexResponseUnmarshaller();        

        internal static ListIndexResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIndexResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
