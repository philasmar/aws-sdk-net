...
{
    /// <summary>
    /// Response Unmarshaller for ListObjectAttributes operation
    /// </summary>  
    public class ListObjectAttributesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListObjectAttributesResponse response = new ListObjectAttributesResponse();
        ...
        private static ListObjectAttributesResponseUnmarshaller _instance = new ListObjectAttributesResponseUnmarshaller();        

        internal static ListObjectAttributesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListObjectAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
