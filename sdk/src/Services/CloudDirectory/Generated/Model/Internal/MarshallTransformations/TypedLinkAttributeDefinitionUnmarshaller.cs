...
namespace Amazon.CloudDirectory.Model.Internal.MarshallTransformations
{
    ...
    public class TypedLinkAttributeDefinitionUnmarshaller : IUnmarshaller<TypedLinkAttributeDefinition, XmlUnmarshallerContext>, IUnmarshaller<TypedLinkAttributeDefinition, JsonUnmarshallerContext>
    {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public TypedLinkAttributeDefinition Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            TypedLinkAttributeDefinition unmarshalledObject = new TypedLinkAttributeDefinition();
        ...
        private static TypedLinkAttributeDefinitionUnmarshaller _instance = new TypedLinkAttributeDefinitionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TypedLinkAttributeDefinitionUnmarshaller Instance
        {
            get
            {
                return _instance;
