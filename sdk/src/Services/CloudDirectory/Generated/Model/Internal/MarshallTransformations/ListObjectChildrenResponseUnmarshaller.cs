...
{
    /// <summary>
    /// Response Unmarshaller for ListObjectChildren operation
    /// </summary>  
    public class ListObjectChildrenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListObjectChildrenResponse response = new ListObjectChildrenResponse();
        ...
        private static ListObjectChildrenResponseUnmarshaller _instance = new ListObjectChildrenResponseUnmarshaller();        

        internal static ListObjectChildrenResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListObjectChildrenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
