...
{
    /// <summary>
    /// Response Unmarshaller for ListAttachedIndices operation
    /// </summary>  
    public class ListAttachedIndicesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAttachedIndicesResponse response = new ListAttachedIndicesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("IndexAttachments", targetDepth))
                {
                    ...
                    response.IndexAttachments = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListAttachedIndicesResponseUnmarshaller _instance = new ListAttachedIndicesResponseUnmarshaller();        

        internal static ListAttachedIndicesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAttachedIndicesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
