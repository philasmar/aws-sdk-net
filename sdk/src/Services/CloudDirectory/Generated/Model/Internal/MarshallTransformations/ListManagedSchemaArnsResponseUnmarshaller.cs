...
{
    /// <summary>
    /// Response Unmarshaller for ListManagedSchemaArns operation
    /// </summary>  
    public class ListManagedSchemaArnsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListManagedSchemaArnsResponse response = new ListManagedSchemaArnsResponse();
        ...
        private static ListManagedSchemaArnsResponseUnmarshaller _instance = new ListManagedSchemaArnsResponseUnmarshaller();        

        internal static ListManagedSchemaArnsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListManagedSchemaArnsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
