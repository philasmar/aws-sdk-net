...
namespace Amazon.CloudDirectory.Model
{
    ...
    /// </summary>
    public partial class BatchWriteResponse : AmazonWebServiceResponse
    {
        private List<BatchWriteOperationResponse> _responses = new List<BatchWriteOperationResponse>();
