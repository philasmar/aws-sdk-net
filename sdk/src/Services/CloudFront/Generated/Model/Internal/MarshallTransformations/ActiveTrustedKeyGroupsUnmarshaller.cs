...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class ActiveTrustedKeyGroupsUnmarshaller : IUnmarshaller<ActiveTrustedKeyGroups, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ActiveTrustedKeyGroups Unmarshall(XmlUnmarshallerContext context)
        {
            ActiveTrustedKeyGroups unmarshalledObject = new ActiveTrustedKeyGroups();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ActiveTrustedKeyGroupsUnmarshaller Instance
        {
            get
            {
                return _instance;
