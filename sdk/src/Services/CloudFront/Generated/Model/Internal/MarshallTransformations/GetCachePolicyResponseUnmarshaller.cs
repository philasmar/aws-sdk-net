...
{
    /// <summary>
    /// Response Unmarshaller for GetCachePolicy operation
    /// </summary>  
    public class GetCachePolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCachePolicyResponse response = new GetCachePolicyResponse();
        ...
        private static GetCachePolicyResponseUnmarshaller _instance = new GetCachePolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCachePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
