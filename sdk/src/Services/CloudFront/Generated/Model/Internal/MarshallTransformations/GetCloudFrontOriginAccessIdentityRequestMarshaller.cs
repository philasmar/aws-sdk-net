...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class GetCloudFrontOriginAccessIdentityRequestMarshaller : IMarshaller<IRequest, GetCloudFrontOriginAccessIdentityRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        private static GetCloudFrontOriginAccessIdentityRequestMarshaller _instance = new GetCloudFrontOriginAccessIdentityRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCloudFrontOriginAccessIdentityRequestMarshaller Instance
        {
            get
            {
                return _instance;
