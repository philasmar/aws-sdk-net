...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class ListCachePoliciesRequestMarshaller : IMarshaller<IRequest, ListCachePoliciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((ListCachePoliciesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListCachePoliciesRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCachePoliciesRequestMarshaller Instance
        {
            get
            {
                return _instance;
