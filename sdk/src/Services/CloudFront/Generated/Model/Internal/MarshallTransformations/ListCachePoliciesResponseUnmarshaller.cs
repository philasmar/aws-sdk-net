...
{
    /// <summary>
    /// Response Unmarshaller for ListCachePolicies operation
    /// </summary>  
    public class ListCachePoliciesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCachePoliciesResponse response = new ListCachePoliciesResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ListCachePoliciesResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = CachePolicyListUnmarshaller.Instance;
                        response.CachePolicyList = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        private static ListCachePoliciesResponseUnmarshaller _instance = new ListCachePoliciesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCachePoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
