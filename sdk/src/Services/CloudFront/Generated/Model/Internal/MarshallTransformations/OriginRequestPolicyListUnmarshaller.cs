...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class OriginRequestPolicyListUnmarshaller : IUnmarshaller<OriginRequestPolicyList, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public OriginRequestPolicyList Unmarshall(XmlUnmarshallerContext context)
        {
            OriginRequestPolicyList unmarshalledObject = new OriginRequestPolicyList();
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("Items/OriginRequestPolicySummary", targetDepth))
                    {
                        var unmarshaller = OriginRequestPolicySummaryUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static OriginRequestPolicyListUnmarshaller Instance
        {
            get
            {
                return _instance;
