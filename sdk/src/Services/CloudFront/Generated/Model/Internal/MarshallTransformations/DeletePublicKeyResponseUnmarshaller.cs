...
{
    /// <summary>
    /// Response Unmarshaller for DeletePublicKey operation
    /// </summary>  
    public class DeletePublicKeyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("PublicKeyInUse"))
                {
                    return PublicKeyInUseExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
            return new AmazonCloudFrontException(errorResponse.Message, innerException, errorResponse.Type, errorResponse.Code, errorResponse.RequestId, statusCode);
        }

        private static DeletePublicKeyResponseUnmarshaller _instance = new DeletePublicKeyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePublicKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
