...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class AccessDeniedExceptionUnmarshaller : IErrorResponseUnmarshaller<AccessDeniedException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public AccessDeniedException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public AccessDeniedException Unmarshall(XmlUnmarshallerContext context, ErrorResponse errorResponse)
        {
            AccessDeniedException response = new AccessDeniedException(errorResponse.Message, errorResponse.InnerException, 
