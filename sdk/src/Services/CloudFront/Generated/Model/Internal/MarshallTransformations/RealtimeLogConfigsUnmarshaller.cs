...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class RealtimeLogConfigsUnmarshaller : IUnmarshaller<RealtimeLogConfigs, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public RealtimeLogConfigs Unmarshall(XmlUnmarshallerContext context)
        {
            RealtimeLogConfigs unmarshalledObject = new RealtimeLogConfigs();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RealtimeLogConfigsUnmarshaller Instance
        {
            get
            {
                return _instance;
