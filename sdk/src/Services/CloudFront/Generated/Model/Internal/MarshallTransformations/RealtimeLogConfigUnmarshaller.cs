...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class RealtimeLogConfigUnmarshaller : IUnmarshaller<RealtimeLogConfig, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public RealtimeLogConfig Unmarshall(XmlUnmarshallerContext context)
        {
            RealtimeLogConfig unmarshalledObject = new RealtimeLogConfig();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RealtimeLogConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
