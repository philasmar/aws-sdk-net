...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class GetOriginRequestPolicyConfigRequestMarshaller : IMarshaller<IRequest, GetOriginRequestPolicyConfigRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((GetOriginRequestPolicyConfigRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetOriginRequestPolicyConfigRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOriginRequestPolicyConfigRequestMarshaller Instance
        {
            get
            {
                return _instance;
