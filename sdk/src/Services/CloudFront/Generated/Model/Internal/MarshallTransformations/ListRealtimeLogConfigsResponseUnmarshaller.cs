...
{
    /// <summary>
    /// Response Unmarshaller for ListRealtimeLogConfigs operation
    /// </summary>  
    public class ListRealtimeLogConfigsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRealtimeLogConfigsResponse response = new ListRealtimeLogConfigsResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ListRealtimeLogConfigsResponse response)
        {
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("RealtimeLogConfigs", targetDepth))
                    {
                        var unmarshaller = RealtimeLogConfigsUnmarshaller.Instance;
                        response.RealtimeLogConfigs = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        private static ListRealtimeLogConfigsResponseUnmarshaller _instance = new ListRealtimeLogConfigsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRealtimeLogConfigsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
