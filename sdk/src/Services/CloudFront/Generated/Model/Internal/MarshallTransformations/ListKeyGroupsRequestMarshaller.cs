...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class ListKeyGroupsRequestMarshaller : IMarshaller<IRequest, ListKeyGroupsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((ListKeyGroupsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListKeyGroupsRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListKeyGroupsRequestMarshaller Instance
        {
            get
            {
                return _instance;
