...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class LambdaFunctionAssociationsUnmarshaller : IUnmarshaller<LambdaFunctionAssociations, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public LambdaFunctionAssociations Unmarshall(XmlUnmarshallerContext context)
        {
            LambdaFunctionAssociations unmarshalledObject = new LambdaFunctionAssociations();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = LambdaFunctionAssociationUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static LambdaFunctionAssociationsUnmarshaller Instance
        {
            get
            {
                return _instance;
