...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePublicKey operation
    /// </summary>  
    public class UpdatePublicKeyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePublicKeyResponse response = new UpdatePublicKeyResponse();
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("CannotChangeImmutablePublicKeyFields"))
                {
                    return CannotChangeImmutablePublicKeyFieldsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static UpdatePublicKeyResponseUnmarshaller _instance = new UpdatePublicKeyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePublicKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
