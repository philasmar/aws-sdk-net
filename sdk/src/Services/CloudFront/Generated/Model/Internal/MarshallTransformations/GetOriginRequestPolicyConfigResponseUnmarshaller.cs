...
{
    /// <summary>
    /// Response Unmarshaller for GetOriginRequestPolicyConfig operation
    /// </summary>  
    public class GetOriginRequestPolicyConfigResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetOriginRequestPolicyConfigResponse response = new GetOriginRequestPolicyConfigResponse();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("OriginRequestPolicyConfig", targetDepth))
                    {
                        ...
                        response.OriginRequestPolicyConfig = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        private static GetOriginRequestPolicyConfigResponseUnmarshaller _instance = new GetOriginRequestPolicyConfigResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOriginRequestPolicyConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
