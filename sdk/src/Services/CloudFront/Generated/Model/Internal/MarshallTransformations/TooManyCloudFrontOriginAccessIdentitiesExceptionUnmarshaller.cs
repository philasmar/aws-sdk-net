...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class TooManyCloudFrontOriginAccessIdentitiesExceptionUnmarshaller : IErrorResponseUnmarshaller<TooManyCloudFrontOriginAccessIdentitiesException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public TooManyCloudFrontOriginAccessIdentitiesException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static TooManyCloudFrontOriginAccessIdentitiesExceptionUnmarshaller _instance = new TooManyCloudFrontOriginAccessIdentitiesExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TooManyCloudFrontOriginAccessIdentitiesExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
