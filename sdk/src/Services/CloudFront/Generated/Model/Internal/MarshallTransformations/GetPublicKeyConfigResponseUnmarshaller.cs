...
{
    /// <summary>
    /// Response Unmarshaller for GetPublicKeyConfig operation
    /// </summary>  
    public class GetPublicKeyConfigResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPublicKeyConfigResponse response = new GetPublicKeyConfigResponse();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("PublicKeyConfig", targetDepth))
                    {
                        ...
                        response.PublicKeyConfig = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        private static GetPublicKeyConfigResponseUnmarshaller _instance = new GetPublicKeyConfigResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPublicKeyConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
