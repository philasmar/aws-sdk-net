...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class PublicKeyConfigUnmarshaller : IUnmarshaller<PublicKeyConfig, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public PublicKeyConfig Unmarshall(XmlUnmarshallerContext context)
        {
            PublicKeyConfig unmarshalledObject = new PublicKeyConfig();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PublicKeyConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
