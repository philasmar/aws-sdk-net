...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class ListRealtimeLogConfigsRequestMarshaller : IMarshaller<IRequest, ListRealtimeLogConfigsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((ListRealtimeLogConfigsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListRealtimeLogConfigsRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRealtimeLogConfigsRequestMarshaller Instance
        {
            get
            {
                return _instance;
