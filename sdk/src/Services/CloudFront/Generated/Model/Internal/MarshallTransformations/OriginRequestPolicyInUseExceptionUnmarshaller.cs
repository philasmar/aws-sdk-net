...
namespace Amazon.CloudFront.Model.Internal.MarshallTransformations
{
    ...
    public class OriginRequestPolicyInUseExceptionUnmarshaller : IErrorResponseUnmarshaller<OriginRequestPolicyInUseException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public OriginRequestPolicyInUseException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static OriginRequestPolicyInUseExceptionUnmarshaller _instance = new OriginRequestPolicyInUseExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static OriginRequestPolicyInUseExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
