...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAssetModel operation
    /// </summary>  
    public class UpdateAssetModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAssetModelResponse response = new UpdateAssetModelResponse();
        ...
        private static UpdateAssetModelResponseUnmarshaller _instance = new UpdateAssetModelResponseUnmarshaller();        

        internal static UpdateAssetModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAssetModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
