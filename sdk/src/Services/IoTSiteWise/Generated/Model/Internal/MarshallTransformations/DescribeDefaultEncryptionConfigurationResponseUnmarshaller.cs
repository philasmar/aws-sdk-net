...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDefaultEncryptionConfiguration operation
    /// </summary>  
    public class DescribeDefaultEncryptionConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDefaultEncryptionConfigurationResponse response = new DescribeDefaultEncryptionConfigurationResponse();
        ...
        private static DescribeDefaultEncryptionConfigurationResponseUnmarshaller _instance = new DescribeDefaultEncryptionConfigurationResponseUnmarshaller();        

        internal static DescribeDefaultEncryptionConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDefaultEncryptionConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
