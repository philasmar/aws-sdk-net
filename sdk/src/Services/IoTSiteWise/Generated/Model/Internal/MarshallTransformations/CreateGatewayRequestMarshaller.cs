    ...
    public class CreateGatewayRequestMarshaller : IMarshaller<IRequest, CreateGatewayRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateGatewayRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetGatewayPlatform())
                {
                    context.Writer.WritePropertyName("gatewayPlatform");
                    context.Writer.WriteObjectStart();

                    var marshaller = GatewayPlatformMarshaller.Instance;
                    marshaller.Marshall(publicRequest.GatewayPlatform, context);
