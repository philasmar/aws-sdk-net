...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    public class BatchPutAssetPropertyErrorEntryUnmarshaller : IUnmarshaller<BatchPutAssetPropertyErrorEntry, XmlUnmarshallerContext>, IUnmarshaller<BatchPutAssetPropertyErrorEntry, JsonUnmarshallerContext>
    {
        ...
        private static BatchPutAssetPropertyErrorEntryUnmarshaller _instance = new BatchPutAssetPropertyErrorEntryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BatchPutAssetPropertyErrorEntryUnmarshaller Instance
        {
            get
            {
                return _instance;
