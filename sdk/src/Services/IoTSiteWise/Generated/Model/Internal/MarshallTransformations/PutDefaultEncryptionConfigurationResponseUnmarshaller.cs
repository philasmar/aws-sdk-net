...
{
    /// <summary>
    /// Response Unmarshaller for PutDefaultEncryptionConfiguration operation
    /// </summary>  
    public class PutDefaultEncryptionConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutDefaultEncryptionConfigurationResponse response = new PutDefaultEncryptionConfigurationResponse();
        ...
        private static PutDefaultEncryptionConfigurationResponseUnmarshaller _instance = new PutDefaultEncryptionConfigurationResponseUnmarshaller();        

        internal static PutDefaultEncryptionConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutDefaultEncryptionConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
