...
{
    /// <summary>
    /// Response Unmarshaller for CreateAssetModel operation
    /// </summary>  
    public class CreateAssetModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAssetModelResponse response = new CreateAssetModelResponse();
        ...
        private static CreateAssetModelResponseUnmarshaller _instance = new CreateAssetModelResponseUnmarshaller();        

        internal static CreateAssetModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAssetModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
