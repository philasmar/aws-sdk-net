...
{
    /// <summary>
    /// Response Unmarshaller for AssociateAssets operation
    /// </summary>  
    public class AssociateAssetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateAssetsResponse response = new AssociateAssetsResponse();
        ...
        private static AssociateAssetsResponseUnmarshaller _instance = new AssociateAssetsResponseUnmarshaller();        

        internal static AssociateAssetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateAssetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
