...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateAssets operation
    /// </summary>  
    public class DisassociateAssetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateAssetsResponse response = new DisassociateAssetsResponse();
        ...
        private static DisassociateAssetsResponseUnmarshaller _instance = new DisassociateAssetsResponseUnmarshaller();        

        internal static DisassociateAssetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateAssetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
