...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAssetModel operation
    /// </summary>  
    public class DeleteAssetModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAssetModelResponse response = new DeleteAssetModelResponse();
        ...
        private static DeleteAssetModelResponseUnmarshaller _instance = new DeleteAssetModelResponseUnmarshaller();        

        internal static DeleteAssetModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAssetModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
