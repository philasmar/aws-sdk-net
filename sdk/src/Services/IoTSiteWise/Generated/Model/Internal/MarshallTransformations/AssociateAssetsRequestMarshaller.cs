...
namespace Amazon.IoTSiteWise.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AssociateAssetsRequestMarshaller : IMarshaller<IRequest, AssociateAssetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static AssociateAssetsRequestMarshaller _instance = new AssociateAssetsRequestMarshaller();        

        internal static AssociateAssetsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateAssetsRequestMarshaller Instance
        {
            get
            {
                return _instance;
