...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAssetProperty operation
    /// </summary>  
    public class UpdateAssetPropertyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAssetPropertyResponse response = new UpdateAssetPropertyResponse();
        ...
        private static UpdateAssetPropertyResponseUnmarshaller _instance = new UpdateAssetPropertyResponseUnmarshaller();        

        internal static UpdateAssetPropertyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAssetPropertyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
