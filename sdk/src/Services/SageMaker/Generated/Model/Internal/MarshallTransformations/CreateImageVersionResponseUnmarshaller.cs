...
{
    /// <summary>
    /// Response Unmarshaller for CreateImageVersion operation
    /// </summary>  
    public class CreateImageVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateImageVersionResponse response = new CreateImageVersionResponse();
        ...
        private static CreateImageVersionResponseUnmarshaller _instance = new CreateImageVersionResponseUnmarshaller();        

        internal static CreateImageVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateImageVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
