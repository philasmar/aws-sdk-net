...
{
    /// <summary>
    /// ListContexts Request Marshaller
    /// </summary>       
    public class ListContextsRequestMarshaller : IMarshaller<IRequest, ListContextsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListContextsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListContextsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListContexts";
        ...
        private static ListContextsRequestMarshaller _instance = new ListContextsRequestMarshaller();        

        internal static ListContextsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListContextsRequestMarshaller Instance
        {
            get
            {
                return _instance;
