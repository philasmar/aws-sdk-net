...
{
    /// <summary>
    /// Response Unmarshaller for CreateAction operation
    /// </summary>  
    public class CreateActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateActionResponseUnmarshaller _instance = new CreateActionResponseUnmarshaller();        

        internal static CreateActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
