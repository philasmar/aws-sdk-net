...
{
    /// <summary>
    /// Response Unmarshaller for GetDeviceFleetReport operation
    /// </summary>  
    public class GetDeviceFleetReportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDeviceFleetReportResponse response = new GetDeviceFleetReportResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.DeviceFleetArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("DeviceStats", targetDepth))
                {
                    ...
                    response.DeviceStats = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ModelStats", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<EdgeModelStat, EdgeModelStatUnmarshaller>(EdgeModelStatUnmarshaller.Instance);
                    response.ModelStats = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("ReportGenerated", targetDepth))
                {
                    ...
                    response.ReportGenerated = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetDeviceFleetReportResponseUnmarshaller _instance = new GetDeviceFleetReportResponseUnmarshaller();        

        internal static GetDeviceFleetReportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDeviceFleetReportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
