...
{
    /// <summary>
    /// Response Unmarshaller for CreateHumanTaskUi operation
    /// </summary>  
    public class CreateHumanTaskUiResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateHumanTaskUiResponse response = new CreateHumanTaskUiResponse();
        ...
        private static CreateHumanTaskUiResponseUnmarshaller _instance = new CreateHumanTaskUiResponseUnmarshaller();        

        internal static CreateHumanTaskUiResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHumanTaskUiResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
