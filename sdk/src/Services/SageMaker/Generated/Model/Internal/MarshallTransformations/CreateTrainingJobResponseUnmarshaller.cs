...
{
    /// <summary>
    /// Response Unmarshaller for CreateTrainingJob operation
    /// </summary>  
    public class CreateTrainingJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTrainingJobResponse response = new CreateTrainingJobResponse();
        ...
        private static CreateTrainingJobResponseUnmarshaller _instance = new CreateTrainingJobResponseUnmarshaller();        

        internal static CreateTrainingJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTrainingJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
