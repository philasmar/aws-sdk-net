...
{
    /// <summary>
    /// UpdateAction Request Marshaller
    /// </summary>       
    public class UpdateActionRequestMarshaller : IMarshaller<IRequest, UpdateActionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateActionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateActionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.UpdateAction";
        ...
        private static UpdateActionRequestMarshaller _instance = new UpdateActionRequestMarshaller();        

        internal static UpdateActionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateActionRequestMarshaller Instance
        {
            get
            {
                return _instance;
