...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class ArtifactSourceTypeMarshaller : IRequestMarshaller<ArtifactSourceType, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(ArtifactSourceType requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetSourceIdType())
            {
                context.Writer.WritePropertyName("SourceIdType");
                context.Writer.Write(requestObject.SourceIdType);
            }
