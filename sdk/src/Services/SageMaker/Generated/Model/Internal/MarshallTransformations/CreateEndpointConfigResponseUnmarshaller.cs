...
{
    /// <summary>
    /// Response Unmarshaller for CreateEndpointConfig operation
    /// </summary>  
    public class CreateEndpointConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateEndpointConfigResponse response = new CreateEndpointConfigResponse();
        ...
        private static CreateEndpointConfigResponseUnmarshaller _instance = new CreateEndpointConfigResponseUnmarshaller();        

        internal static CreateEndpointConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEndpointConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
