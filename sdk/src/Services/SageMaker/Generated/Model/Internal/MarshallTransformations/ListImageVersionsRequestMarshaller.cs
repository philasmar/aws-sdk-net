...
{
    /// <summary>
    /// ListImageVersions Request Marshaller
    /// </summary>       
    public class ListImageVersionsRequestMarshaller : IMarshaller<IRequest, ListImageVersionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListImageVersionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListImageVersionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListImageVersions";
        ...
        private static ListImageVersionsRequestMarshaller _instance = new ListImageVersionsRequestMarshaller();        

        internal static ListImageVersionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListImageVersionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
