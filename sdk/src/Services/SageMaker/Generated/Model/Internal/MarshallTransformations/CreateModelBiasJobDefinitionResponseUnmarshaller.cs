...
{
    /// <summary>
    /// Response Unmarshaller for CreateModelBiasJobDefinition operation
    /// </summary>  
    public class CreateModelBiasJobDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateModelBiasJobDefinitionResponse response = new CreateModelBiasJobDefinitionResponse();
        ...
        private static CreateModelBiasJobDefinitionResponseUnmarshaller _instance = new CreateModelBiasJobDefinitionResponseUnmarshaller();        

        internal static CreateModelBiasJobDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateModelBiasJobDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
