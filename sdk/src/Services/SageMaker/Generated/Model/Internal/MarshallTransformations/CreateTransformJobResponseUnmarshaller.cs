...
{
    /// <summary>
    /// Response Unmarshaller for CreateTransformJob operation
    /// </summary>  
    public class CreateTransformJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTransformJobResponse response = new CreateTransformJobResponse();
        ...
        private static CreateTransformJobResponseUnmarshaller _instance = new CreateTransformJobResponseUnmarshaller();        

        internal static CreateTransformJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTransformJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
