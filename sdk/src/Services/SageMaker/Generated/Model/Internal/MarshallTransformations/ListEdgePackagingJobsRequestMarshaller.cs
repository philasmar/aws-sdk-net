...
{
    /// <summary>
    /// ListEdgePackagingJobs Request Marshaller
    /// </summary>       
    public class ListEdgePackagingJobsRequestMarshaller : IMarshaller<IRequest, ListEdgePackagingJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListEdgePackagingJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListEdgePackagingJobsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListEdgePackagingJobs";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetModelNameContains())
                {
                    context.Writer.WritePropertyName("ModelNameContains");
                    context.Writer.Write(publicRequest.ModelNameContains);
                }
        ...
        private static ListEdgePackagingJobsRequestMarshaller _instance = new ListEdgePackagingJobsRequestMarshaller();        

        internal static ListEdgePackagingJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListEdgePackagingJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
