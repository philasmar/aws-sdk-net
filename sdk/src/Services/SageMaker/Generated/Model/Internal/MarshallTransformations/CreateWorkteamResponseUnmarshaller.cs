...
{
    /// <summary>
    /// Response Unmarshaller for CreateWorkteam operation
    /// </summary>  
    public class CreateWorkteamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWorkteamResponse response = new CreateWorkteamResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("WorkteamArn", targetDepth))
                {
                    ...
                    response.WorkteamArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateWorkteamResponseUnmarshaller _instance = new CreateWorkteamResponseUnmarshaller();        

        internal static CreateWorkteamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWorkteamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
