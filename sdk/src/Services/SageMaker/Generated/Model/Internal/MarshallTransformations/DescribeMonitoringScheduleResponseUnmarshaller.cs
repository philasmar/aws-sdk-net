...
{
    /// <summary>
    /// Response Unmarshaller for DescribeMonitoringSchedule operation
    /// </summary>  
    public class DescribeMonitoringScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeMonitoringScheduleResponse response = new DescribeMonitoringScheduleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("LastMonitoringExecutionSummary", targetDepth))
                {
                    ...
                    response.LastMonitoringExecutionSummary = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("MonitoringScheduleConfig", targetDepth))
                {
                    ...
                    response.MonitoringScheduleConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("MonitoringScheduleName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.MonitoringScheduleName = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeMonitoringScheduleResponseUnmarshaller _instance = new DescribeMonitoringScheduleResponseUnmarshaller();        

        internal static DescribeMonitoringScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMonitoringScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
