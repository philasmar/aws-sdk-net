...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDataQualityJobDefinition operation
    /// </summary>  
    public class DescribeDataQualityJobDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDataQualityJobDefinitionResponse response = new DescribeDataQualityJobDefinitionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = DataQualityAppSpecificationUnmarshaller.Instance;
                    response.DataQualityAppSpecification = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DataQualityBaselineConfig", targetDepth))
                {
                    var unmarshaller = DataQualityBaselineConfigUnmarshaller.Instance;
                    response.DataQualityBaselineConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DataQualityJobInput", targetDepth))
                {
                    var unmarshaller = DataQualityJobInputUnmarshaller.Instance;
                    response.DataQualityJobInput = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DataQualityJobOutputConfig", targetDepth))
                {
                    ...
                    response.DataQualityJobOutputConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeDataQualityJobDefinitionResponseUnmarshaller _instance = new DescribeDataQualityJobDefinitionResponseUnmarshaller();        

        internal static DescribeDataQualityJobDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDataQualityJobDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
