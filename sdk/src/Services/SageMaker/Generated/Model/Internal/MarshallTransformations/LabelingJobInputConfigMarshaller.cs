...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class LabelingJobInputConfigMarshaller : IRequestMarshaller<LabelingJobInputConfig, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(LabelingJobInputConfig requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetDataAttributes())
            {
                ...
                var marshaller = LabelingJobDataAttributesMarshaller.Instance;
            ...
            if(requestObject.IsSetDataSource())
            {
                ...
                var marshaller = LabelingJobDataSourceMarshaller.Instance;
