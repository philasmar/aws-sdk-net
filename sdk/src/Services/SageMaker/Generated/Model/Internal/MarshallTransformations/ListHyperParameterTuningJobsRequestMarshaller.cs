...
{
    /// <summary>
    /// ListHyperParameterTuningJobs Request Marshaller
    /// </summary>       
    public class ListHyperParameterTuningJobsRequestMarshaller : IMarshaller<IRequest, ListHyperParameterTuningJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListHyperParameterTuningJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListHyperParameterTuningJobsRequest publicRequest)
        {
        ...
        private static ListHyperParameterTuningJobsRequestMarshaller _instance = new ListHyperParameterTuningJobsRequestMarshaller();        

        internal static ListHyperParameterTuningJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListHyperParameterTuningJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
