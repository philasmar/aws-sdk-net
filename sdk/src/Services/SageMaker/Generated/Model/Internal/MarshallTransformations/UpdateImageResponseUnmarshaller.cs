...
{
    /// <summary>
    /// Response Unmarshaller for UpdateImage operation
    /// </summary>  
    public class UpdateImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateImageResponseUnmarshaller _instance = new UpdateImageResponseUnmarshaller();        

        internal static UpdateImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
