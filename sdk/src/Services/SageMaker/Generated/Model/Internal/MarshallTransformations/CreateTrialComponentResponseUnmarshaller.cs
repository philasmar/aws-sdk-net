...
{
    /// <summary>
    /// Response Unmarshaller for CreateTrialComponent operation
    /// </summary>  
    public class CreateTrialComponentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTrialComponentResponse response = new CreateTrialComponentResponse();
        ...
        private static CreateTrialComponentResponseUnmarshaller _instance = new CreateTrialComponentResponseUnmarshaller();        

        internal static CreateTrialComponentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTrialComponentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
