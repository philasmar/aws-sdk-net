...
{
    /// <summary>
    /// Response Unmarshaller for CreateLabelingJob operation
    /// </summary>  
    public class CreateLabelingJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLabelingJobResponse response = new CreateLabelingJobResponse();
        ...
        private static CreateLabelingJobResponseUnmarshaller _instance = new CreateLabelingJobResponseUnmarshaller();        

        internal static CreateLabelingJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLabelingJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
