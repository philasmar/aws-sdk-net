...
{
    /// <summary>
    /// ListMonitoringSchedules Request Marshaller
    /// </summary>       
    public class ListMonitoringSchedulesRequestMarshaller : IMarshaller<IRequest, ListMonitoringSchedulesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListMonitoringSchedulesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListMonitoringSchedulesRequest publicRequest)
        {
        ...
        private static ListMonitoringSchedulesRequestMarshaller _instance = new ListMonitoringSchedulesRequestMarshaller();        

        internal static ListMonitoringSchedulesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMonitoringSchedulesRequestMarshaller Instance
        {
            get
            {
                return _instance;
