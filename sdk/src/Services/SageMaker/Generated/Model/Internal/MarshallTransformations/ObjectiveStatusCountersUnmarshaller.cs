...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class ObjectiveStatusCountersUnmarshaller : IUnmarshaller<ObjectiveStatusCounters, XmlUnmarshallerContext>, IUnmarshaller<ObjectiveStatusCounters, JsonUnmarshallerContext>
    {
        ...
        private static ObjectiveStatusCountersUnmarshaller _instance = new ObjectiveStatusCountersUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ObjectiveStatusCountersUnmarshaller Instance
        {
            get
            {
                return _instance;
