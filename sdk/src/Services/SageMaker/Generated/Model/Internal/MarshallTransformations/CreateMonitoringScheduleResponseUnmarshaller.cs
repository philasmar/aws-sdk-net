...
{
    /// <summary>
    /// Response Unmarshaller for CreateMonitoringSchedule operation
    /// </summary>  
    public class CreateMonitoringScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMonitoringScheduleResponse response = new CreateMonitoringScheduleResponse();
        ...
        private static CreateMonitoringScheduleResponseUnmarshaller _instance = new CreateMonitoringScheduleResponseUnmarshaller();        

        internal static CreateMonitoringScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMonitoringScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
