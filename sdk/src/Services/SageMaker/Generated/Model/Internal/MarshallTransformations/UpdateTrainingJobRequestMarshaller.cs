...
{
    /// <summary>
    /// UpdateTrainingJob Request Marshaller
    /// </summary>       
    public class UpdateTrainingJobRequestMarshaller : IMarshaller<IRequest, UpdateTrainingJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateTrainingJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateTrainingJobRequest publicRequest)
        {
        ...
        private static UpdateTrainingJobRequestMarshaller _instance = new UpdateTrainingJobRequestMarshaller();        

        internal static UpdateTrainingJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTrainingJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
