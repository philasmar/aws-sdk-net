...
{
    /// <summary>
    /// Response Unmarshaller for DescribeCompilationJob operation
    /// </summary>  
    public class DescribeCompilationJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeCompilationJobResponse response = new DescribeCompilationJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CompilationEndTime", targetDepth))
                {
                    ...
                    response.CompilationEndTime = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("CompilationJobArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CompilationJobArn = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CompilationJobStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("CompilationStartTime", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.CompilationStartTime = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeCompilationJobResponseUnmarshaller _instance = new DescribeCompilationJobResponseUnmarshaller();        

        internal static DescribeCompilationJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCompilationJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
