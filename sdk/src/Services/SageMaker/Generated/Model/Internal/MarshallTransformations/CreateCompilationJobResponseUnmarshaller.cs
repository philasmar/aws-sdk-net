...
{
    /// <summary>
    /// Response Unmarshaller for CreateCompilationJob operation
    /// </summary>  
    public class CreateCompilationJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCompilationJobResponse response = new CreateCompilationJobResponse();
        ...
        private static CreateCompilationJobResponseUnmarshaller _instance = new CreateCompilationJobResponseUnmarshaller();        

        internal static CreateCompilationJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCompilationJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
