...
{
    /// <summary>
    /// Response Unmarshaller for CreateTrial operation
    /// </summary>  
    public class CreateTrialResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateTrialResponseUnmarshaller _instance = new CreateTrialResponseUnmarshaller();        

        internal static CreateTrialResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTrialResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
