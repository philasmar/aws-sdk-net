...
{
    /// <summary>
    /// Response Unmarshaller for DescribeEndpointConfig operation
    /// </summary>  
    public class DescribeEndpointConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeEndpointConfigResponseUnmarshaller _instance = new DescribeEndpointConfigResponseUnmarshaller();        

        internal static DescribeEndpointConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEndpointConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
