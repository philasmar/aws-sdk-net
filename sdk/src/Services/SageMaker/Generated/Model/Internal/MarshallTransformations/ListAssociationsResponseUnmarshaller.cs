...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    public class ListAssociationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("AssociationSummaries", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<AssociationSummary, AssociationSummaryUnmarshaller>(AssociationSummaryUnmarshaller.Instance);
                    response.AssociationSummaries = unmarshaller.Unmarshall(context);
                    continue;
                }
