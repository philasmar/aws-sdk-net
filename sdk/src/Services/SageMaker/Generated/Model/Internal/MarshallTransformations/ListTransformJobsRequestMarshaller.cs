...
{
    /// <summary>
    /// ListTransformJobs Request Marshaller
    /// </summary>       
    public class ListTransformJobsRequestMarshaller : IMarshaller<IRequest, ListTransformJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListTransformJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListTransformJobsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListTransformJobs";
        ...
        private static ListTransformJobsRequestMarshaller _instance = new ListTransformJobsRequestMarshaller();        

        internal static ListTransformJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTransformJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
