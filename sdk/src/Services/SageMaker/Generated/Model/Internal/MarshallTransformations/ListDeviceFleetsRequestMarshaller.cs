...
{
    /// <summary>
    /// ListDeviceFleets Request Marshaller
    /// </summary>       
    public class ListDeviceFleetsRequestMarshaller : IMarshaller<IRequest, ListDeviceFleetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListDeviceFleetsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListDeviceFleetsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListDeviceFleets";
        ...
        private static ListDeviceFleetsRequestMarshaller _instance = new ListDeviceFleetsRequestMarshaller();        

        internal static ListDeviceFleetsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDeviceFleetsRequestMarshaller Instance
        {
            get
            {
                return _instance;
