...
{
    /// <summary>
    /// Response Unmarshaller for CreateDataQualityJobDefinition operation
    /// </summary>  
    public class CreateDataQualityJobDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDataQualityJobDefinitionResponse response = new CreateDataQualityJobDefinitionResponse();
        ...
        private static CreateDataQualityJobDefinitionResponseUnmarshaller _instance = new CreateDataQualityJobDefinitionResponseUnmarshaller();        

        internal static CreateDataQualityJobDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataQualityJobDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
