...
{
    /// <summary>
    /// Response Unmarshaller for DescribeArtifact operation
    /// </summary>  
    public class DescribeArtifactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeArtifactResponse response = new DescribeArtifactResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ArtifactName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ArtifactType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ArtifactType = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeArtifactResponseUnmarshaller _instance = new DescribeArtifactResponseUnmarshaller();        

        internal static DescribeArtifactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeArtifactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
