...
{
    /// <summary>
    /// Response Unmarshaller for CreateFeatureGroup operation
    /// </summary>  
    public class CreateFeatureGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateFeatureGroupResponse response = new CreateFeatureGroupResponse();
        ...
        private static CreateFeatureGroupResponseUnmarshaller _instance = new CreateFeatureGroupResponseUnmarshaller();        

        internal static CreateFeatureGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFeatureGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
