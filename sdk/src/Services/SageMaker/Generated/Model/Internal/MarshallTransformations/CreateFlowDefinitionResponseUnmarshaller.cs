...
{
    /// <summary>
    /// Response Unmarshaller for CreateFlowDefinition operation
    /// </summary>  
    public class CreateFlowDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateFlowDefinitionResponse response = new CreateFlowDefinitionResponse();
        ...
        private static CreateFlowDefinitionResponseUnmarshaller _instance = new CreateFlowDefinitionResponseUnmarshaller();        

        internal static CreateFlowDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFlowDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
