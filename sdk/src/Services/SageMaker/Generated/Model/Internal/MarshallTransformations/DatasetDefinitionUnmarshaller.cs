...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DatasetDefinitionUnmarshaller : IUnmarshaller<DatasetDefinition, XmlUnmarshallerContext>, IUnmarshaller<DatasetDefinition, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DatasetDefinition IUnmarshaller<DatasetDefinition, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public DatasetDefinition Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AthenaDatasetDefinition", targetDepth))
                {
                    ...
                    unmarshalledObject.AthenaDatasetDefinition = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DataDistributionType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.DataDistributionType = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("RedshiftDatasetDefinition", targetDepth))
                {
                    ...
                    unmarshalledObject.RedshiftDatasetDefinition = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
