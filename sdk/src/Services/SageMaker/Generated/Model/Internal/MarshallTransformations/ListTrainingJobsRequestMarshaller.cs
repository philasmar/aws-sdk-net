...
{
    /// <summary>
    /// ListTrainingJobs Request Marshaller
    /// </summary>       
    public class ListTrainingJobsRequestMarshaller : IMarshaller<IRequest, ListTrainingJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListTrainingJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListTrainingJobsRequest publicRequest)
        {
        ...
        private static ListTrainingJobsRequestMarshaller _instance = new ListTrainingJobsRequestMarshaller();        

        internal static ListTrainingJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTrainingJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
