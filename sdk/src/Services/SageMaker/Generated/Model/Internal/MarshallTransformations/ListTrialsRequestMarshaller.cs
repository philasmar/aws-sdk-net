...
{
    /// <summary>
    /// ListTrials Request Marshaller
    /// </summary>       
    public class ListTrialsRequestMarshaller : IMarshaller<IRequest, ListTrialsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListTrialsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListTrialsRequest publicRequest)
        {
        ...
        private static ListTrialsRequestMarshaller _instance = new ListTrialsRequestMarshaller();        

        internal static ListTrialsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTrialsRequestMarshaller Instance
        {
            get
            {
                return _instance;
