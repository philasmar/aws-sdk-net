...
{
    /// <summary>
    /// ListCodeRepositories Request Marshaller
    /// </summary>       
    public class ListCodeRepositoriesRequestMarshaller : IMarshaller<IRequest, ListCodeRepositoriesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListCodeRepositoriesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListCodeRepositoriesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SageMaker");
            string target = "SageMaker.ListCodeRepositories";
        ...
        private static ListCodeRepositoriesRequestMarshaller _instance = new ListCodeRepositoriesRequestMarshaller();        

        internal static ListCodeRepositoriesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCodeRepositoriesRequestMarshaller Instance
        {
            get
            {
                return _instance;
