...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ArtifactSourceUnmarshaller : IUnmarshaller<ArtifactSource, XmlUnmarshallerContext>, IUnmarshaller<ArtifactSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ArtifactSource IUnmarshaller<ArtifactSource, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ArtifactSource Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ArtifactSourceType, ArtifactSourceTypeUnmarshaller>(ArtifactSourceTypeUnmarshaller.Instance);
