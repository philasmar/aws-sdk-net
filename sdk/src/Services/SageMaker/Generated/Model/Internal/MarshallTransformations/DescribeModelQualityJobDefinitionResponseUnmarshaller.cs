...
{
    /// <summary>
    /// Response Unmarshaller for DescribeModelQualityJobDefinition operation
    /// </summary>  
    public class DescribeModelQualityJobDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeModelQualityJobDefinitionResponseUnmarshaller _instance = new DescribeModelQualityJobDefinitionResponseUnmarshaller();        

        internal static DescribeModelQualityJobDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeModelQualityJobDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
