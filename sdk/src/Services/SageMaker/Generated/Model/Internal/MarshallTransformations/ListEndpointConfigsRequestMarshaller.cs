...
{
    /// <summary>
    /// ListEndpointConfigs Request Marshaller
    /// </summary>       
    public class ListEndpointConfigsRequestMarshaller : IMarshaller<IRequest, ListEndpointConfigsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListEndpointConfigsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListEndpointConfigsRequest publicRequest)
        {
        ...
        private static ListEndpointConfigsRequestMarshaller _instance = new ListEndpointConfigsRequestMarshaller();        

        internal static ListEndpointConfigsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListEndpointConfigsRequestMarshaller Instance
        {
            get
            {
                return _instance;
