...
{
    /// <summary>
    /// Response Unmarshaller for CreateHyperParameterTuningJob operation
    /// </summary>  
    public class CreateHyperParameterTuningJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateHyperParameterTuningJobResponse response = new CreateHyperParameterTuningJobResponse();
        ...
        private static CreateHyperParameterTuningJobResponseUnmarshaller _instance = new CreateHyperParameterTuningJobResponseUnmarshaller();        

        internal static CreateHyperParameterTuningJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHyperParameterTuningJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
