...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListExperimentsRequestMarshaller : IMarshaller<IRequest, ListExperimentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(ListExperimentsRequest publicRequest)
        {
            ...
            string target = "SageMaker.ListExperiments";
        ...
        private static ListExperimentsRequestMarshaller _instance = new ListExperimentsRequestMarshaller();        

        internal static ListExperimentsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListExperimentsRequestMarshaller Instance
        {
            get
            {
                return _instance;
