...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTrial operation
    /// </summary>  
    public class DescribeTrialResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTrialResponse response = new DescribeTrialResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.TrialName = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeTrialResponseUnmarshaller _instance = new DescribeTrialResponseUnmarshaller();        

        internal static DescribeTrialResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTrialResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
