...
{
    /// <summary>
    /// Response Unmarshaller for CreateAutoMLJob operation
    /// </summary>  
    public class CreateAutoMLJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAutoMLJobResponse response = new CreateAutoMLJobResponse();
        ...
        private static CreateAutoMLJobResponseUnmarshaller _instance = new CreateAutoMLJobResponseUnmarshaller();        

        internal static CreateAutoMLJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAutoMLJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
