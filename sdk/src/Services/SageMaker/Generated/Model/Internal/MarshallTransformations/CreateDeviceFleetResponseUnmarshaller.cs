...
{
    /// <summary>
    /// Response Unmarshaller for CreateDeviceFleet operation
    /// </summary>  
    public class CreateDeviceFleetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDeviceFleetResponse response = new CreateDeviceFleetResponse();
        ...
        private static CreateDeviceFleetResponseUnmarshaller _instance = new CreateDeviceFleetResponseUnmarshaller();        

        internal static CreateDeviceFleetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDeviceFleetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
