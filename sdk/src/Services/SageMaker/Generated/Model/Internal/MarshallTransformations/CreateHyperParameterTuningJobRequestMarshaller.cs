...
{
    /// <summary>
    /// CreateHyperParameterTuningJob Request Marshaller
    /// </summary>       
    public class CreateHyperParameterTuningJobRequestMarshaller : IMarshaller<IRequest, CreateHyperParameterTuningJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateHyperParameterTuningJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateHyperParameterTuningJobRequest publicRequest)
        {
        ...
        private static CreateHyperParameterTuningJobRequestMarshaller _instance = new CreateHyperParameterTuningJobRequestMarshaller();        

        internal static CreateHyperParameterTuningJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHyperParameterTuningJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
