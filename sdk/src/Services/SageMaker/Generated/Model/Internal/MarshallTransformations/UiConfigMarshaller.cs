...
namespace Amazon.SageMaker.Model.Internal.MarshallTransformations
{
    ...
    /// UiConfig Marshaller
    /// </summary>       
    public class UiConfigMarshaller : IRequestMarshaller<UiConfig, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(UiConfig requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetUiTemplateS3Uri())
            {
                ...
                context.Writer.Write(requestObject.UiTemplateS3Uri);
            }
        ...
        /// </summary>  
        public readonly static UiConfigMarshaller Instance = new UiConfigMarshaller();
