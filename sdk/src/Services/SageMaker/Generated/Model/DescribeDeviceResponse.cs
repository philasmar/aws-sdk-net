...
namespace Amazon.SageMaker.Model
{
    ...
    public partial class DescribeDeviceResponse : AmazonWebServiceResponse
    {
        ...
        private List<EdgeModel> _models = new List<EdgeModel>();
        ...
        // Check to see if MaxModels property is set
        internal bool IsSetMaxModels()
        {
            return this._maxModels.HasValue; 
        }
