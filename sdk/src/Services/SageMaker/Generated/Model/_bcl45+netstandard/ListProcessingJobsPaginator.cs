...
namespace Amazon.SageMaker.Model
{
    ...
    internal sealed partial class ListProcessingJobsPaginator : IPaginator<ListProcessingJobsResponse>, IListProcessingJobsPaginator
    {
        ...
        public IPaginatedEnumerable<ProcessingJobSummary> ProcessingJobSummaries => 
            new PaginatedResultKeyResponse<ListProcessingJobsResponse, ProcessingJobSummary>(this, (i) => i.ProcessingJobSummaries);
        ...
        async IAsyncEnumerable<ListProcessingJobsResponse> IPaginator<ListProcessingJobsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
