...
namespace Amazon.KinesisAnalytics.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateApplicationRequestMarshaller : IMarshaller<IRequest, UpdateApplicationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateApplicationRequest publicRequest)
        {
            ...
            string target = "KinesisAnalytics_20150814.UpdateApplication";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetApplicationUpdate())
                {
                    context.Writer.WritePropertyName("ApplicationUpdate");
                    context.Writer.WriteObjectStart();

                    var marshaller = ApplicationUpdateMarshaller.Instance;
                    marshaller.Marshall(publicRequest.ApplicationUpdate, context);
