...
namespace Amazon.KinesisAnalytics.Model.Internal.MarshallTransformations
{
    ...
    public class S3ReferenceDataSourceUpdateMarshaller : IRequestMarshaller<S3ReferenceDataSourceUpdate, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(S3ReferenceDataSourceUpdate requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetReferenceRoleARNUpdate())
            {
                context.Writer.WritePropertyName("ReferenceRoleARNUpdate");
                context.Writer.Write(requestObject.ReferenceRoleARNUpdate);
            }
