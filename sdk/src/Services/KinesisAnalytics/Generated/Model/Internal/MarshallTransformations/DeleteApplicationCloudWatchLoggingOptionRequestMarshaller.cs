...
{
    /// <summary>
    /// DeleteApplicationCloudWatchLoggingOption Request Marshaller
    /// </summary>       
    public class DeleteApplicationCloudWatchLoggingOptionRequestMarshaller : IMarshaller<IRequest, DeleteApplicationCloudWatchLoggingOptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteApplicationCloudWatchLoggingOptionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteApplicationCloudWatchLoggingOptionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.KinesisAnalytics");
            string target = "KinesisAnalytics_20150814.DeleteApplicationCloudWatchLoggingOption";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetCloudWatchLoggingOptionId())
                {
