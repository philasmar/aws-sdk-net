...
{
    /// <summary>
    /// Response Unmarshaller for AddApplicationInput operation
    /// </summary>  
    public class AddApplicationInputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddApplicationInputResponse response = new AddApplicationInputResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("InputDescriptions", targetDepth))
                {
                    ...
                    response.InputDescriptions = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static AddApplicationInputResponseUnmarshaller _instance = new AddApplicationInputResponseUnmarshaller();        

        internal static AddApplicationInputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddApplicationInputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
