...
{
    /// <summary>
    /// Response Unmarshaller for AddApplicationVpcConfiguration operation
    /// </summary>  
    public class AddApplicationVpcConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddApplicationVpcConfigurationResponse response = new AddApplicationVpcConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("VpcConfigurationDescription", targetDepth))
                {
                    ...
                    response.VpcConfigurationDescription = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static AddApplicationVpcConfigurationResponseUnmarshaller _instance = new AddApplicationVpcConfigurationResponseUnmarshaller();        

        internal static AddApplicationVpcConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddApplicationVpcConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
