...
namespace Amazon.KinesisAnalyticsV2.Model.Internal.MarshallTransformations
{
    ...
    public class SqlRunConfigurationMarshaller : IRequestMarshaller<SqlRunConfiguration, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(SqlRunConfiguration requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetInputStartingPositionConfiguration())
            {
                ...
                marshaller.Marshall(requestObject.InputStartingPositionConfiguration, context);
