...
{
    /// <summary>
    /// Response Unmarshaller for DeleteApplicationVpcConfiguration operation
    /// </summary>  
    public class DeleteApplicationVpcConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteApplicationVpcConfigurationResponse response = new DeleteApplicationVpcConfigurationResponse();
        ...
        private static DeleteApplicationVpcConfigurationResponseUnmarshaller _instance = new DeleteApplicationVpcConfigurationResponseUnmarshaller();        

        internal static DeleteApplicationVpcConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteApplicationVpcConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
