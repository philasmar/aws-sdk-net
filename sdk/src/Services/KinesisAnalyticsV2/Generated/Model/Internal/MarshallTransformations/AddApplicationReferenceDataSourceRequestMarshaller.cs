...
{
    /// <summary>
    /// AddApplicationReferenceDataSource Request Marshaller
    /// </summary>       
    public class AddApplicationReferenceDataSourceRequestMarshaller : IMarshaller<IRequest, AddApplicationReferenceDataSourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AddApplicationReferenceDataSourceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AddApplicationReferenceDataSourceRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.KinesisAnalyticsV2");
            string target = "KinesisAnalytics_20180523.AddApplicationReferenceDataSource";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetReferenceDataSource())
                {
                    context.Writer.WritePropertyName("ReferenceDataSource");
                    context.Writer.WriteObjectStart();

                    var marshaller = ReferenceDataSourceMarshaller.Instance;
                    marshaller.Marshall(publicRequest.ReferenceDataSource, context);
