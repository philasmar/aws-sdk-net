...
{
    /// <summary>
    /// Response Unmarshaller for DeleteApplicationSnapshot operation
    /// </summary>  
    public class DeleteApplicationSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteApplicationSnapshotResponse response = new DeleteApplicationSnapshotResponse();
        ...
        private static DeleteApplicationSnapshotResponseUnmarshaller _instance = new DeleteApplicationSnapshotResponseUnmarshaller();        

        internal static DeleteApplicationSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteApplicationSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
