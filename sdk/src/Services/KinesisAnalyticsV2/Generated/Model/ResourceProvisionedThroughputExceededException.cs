...
namespace Amazon.KinesisAnalyticsV2.Model
{
    ...
    [Serializable]
    #endif
    public partial class ResourceProvisionedThroughputExceededException : AmazonKinesisAnalyticsV2Exception
    {
        ...
        public ResourceProvisionedThroughputExceededException(string message, Exception innerException) 
        ...
        public ResourceProvisionedThroughputExceededException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected ResourceProvisionedThroughputExceededException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
