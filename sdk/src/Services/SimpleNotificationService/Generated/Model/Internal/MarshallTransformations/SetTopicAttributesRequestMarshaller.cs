    ...
    public class SetTopicAttributesRequestMarshaller : IMarshaller<IRequest, SetTopicAttributesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(SetTopicAttributesRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static SetTopicAttributesRequestMarshaller _instance = new SetTopicAttributesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetTopicAttributesRequestMarshaller Instance
        {
            get
            {
                return _instance;
