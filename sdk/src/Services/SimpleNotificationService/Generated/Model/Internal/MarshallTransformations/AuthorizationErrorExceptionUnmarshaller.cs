...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    public class AuthorizationErrorExceptionUnmarshaller : IErrorResponseUnmarshaller<AuthorizationErrorException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public AuthorizationErrorException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public AuthorizationErrorException Unmarshall(XmlUnmarshallerContext context, ErrorResponse errorResponse)
        {
            AuthorizationErrorException response = new AuthorizationErrorException(errorResponse.Message, errorResponse.InnerException, 
