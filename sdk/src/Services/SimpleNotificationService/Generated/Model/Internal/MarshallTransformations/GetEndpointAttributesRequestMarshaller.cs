    ...
    public class GetEndpointAttributesRequestMarshaller : IMarshaller<IRequest, GetEndpointAttributesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(GetEndpointAttributesRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static GetEndpointAttributesRequestMarshaller _instance = new GetEndpointAttributesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEndpointAttributesRequestMarshaller Instance
        {
            get
            {
                return _instance;
