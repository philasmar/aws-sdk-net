    ...
    public class GetSubscriptionAttributesRequestMarshaller : IMarshaller<IRequest, GetSubscriptionAttributesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(GetSubscriptionAttributesRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static GetSubscriptionAttributesRequestMarshaller _instance = new GetSubscriptionAttributesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSubscriptionAttributesRequestMarshaller Instance
        {
            get
            {
                return _instance;
