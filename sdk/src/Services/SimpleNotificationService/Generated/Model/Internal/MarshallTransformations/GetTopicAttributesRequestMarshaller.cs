    ...
    public class GetTopicAttributesRequestMarshaller : IMarshaller<IRequest, GetTopicAttributesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(GetTopicAttributesRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static GetTopicAttributesRequestMarshaller _instance = new GetTopicAttributesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTopicAttributesRequestMarshaller Instance
        {
            get
            {
                return _instance;
