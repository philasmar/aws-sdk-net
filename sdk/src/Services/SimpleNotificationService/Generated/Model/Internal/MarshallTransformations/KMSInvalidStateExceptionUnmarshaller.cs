...
namespace Amazon.SimpleNotificationService.Model.Internal.MarshallTransformations
{
    ...
    public class KMSInvalidStateExceptionUnmarshaller : IErrorResponseUnmarshaller<KMSInvalidStateException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public KMSInvalidStateException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public KMSInvalidStateException Unmarshall(XmlUnmarshallerContext context, ErrorResponse errorResponse)
        {
            KMSInvalidStateException response = new KMSInvalidStateException(errorResponse.Message, errorResponse.InnerException, 
