...
{
    /// <summary>
    /// PutUsers Request Marshaller
    /// </summary>       
    public class PutUsersRequestMarshaller : IMarshaller<IRequest, PutUsersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutUsersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutUsersRequest publicRequest)
        {
        ...
        private static PutUsersRequestMarshaller _instance = new PutUsersRequestMarshaller();        

        internal static PutUsersRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutUsersRequestMarshaller Instance
        {
            get
            {
                return _instance;
