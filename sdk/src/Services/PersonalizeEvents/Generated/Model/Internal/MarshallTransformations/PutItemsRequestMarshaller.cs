...
{
    /// <summary>
    /// PutItems Request Marshaller
    /// </summary>       
    public class PutItemsRequestMarshaller : IMarshaller<IRequest, PutItemsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutItemsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutItemsRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetItems())
                {
                    ...
                    foreach(var publicRequestItemsListValue in publicRequest.Items)
                    {
                        ...
                        var marshaller = ItemMarshaller.Instance;
        ...
        private static PutItemsRequestMarshaller _instance = new PutItemsRequestMarshaller();        

        internal static PutItemsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutItemsRequestMarshaller Instance
        {
            get
            {
                return _instance;
