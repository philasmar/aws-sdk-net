...
namespace Amazon.IoTAnalytics.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FileFormatConfigurationUnmarshaller : IUnmarshaller<FileFormatConfiguration, XmlUnmarshallerContext>, IUnmarshaller<FileFormatConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        FileFormatConfiguration IUnmarshaller<FileFormatConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public FileFormatConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("jsonConfiguration", targetDepth))
                {
                    ...
                    unmarshalledObject.JsonConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("parquetConfiguration", targetDepth))
                {
                    var unmarshaller = ParquetConfigurationUnmarshaller.Instance;
                    unmarshalledObject.ParquetConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
