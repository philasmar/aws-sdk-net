...
{
    /// <summary>
    /// StartPipelineReprocessing Request Marshaller
    /// </summary>       
    public class StartPipelineReprocessingRequestMarshaller : IMarshaller<IRequest, StartPipelineReprocessingRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartPipelineReprocessingRequest)input);
        }
        ...
        private static StartPipelineReprocessingRequestMarshaller _instance = new StartPipelineReprocessingRequestMarshaller();        

        internal static StartPipelineReprocessingRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartPipelineReprocessingRequestMarshaller Instance
        {
            get
            {
                return _instance;
