...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// OtaaV1_1 Marshaller
    /// </summary>       
    public class OtaaV1_1Marshaller : IRequestMarshaller<OtaaV1_1, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(OtaaV1_1 requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetNwkKey())
            {
                context.Writer.WritePropertyName("NwkKey");
                context.Writer.Write(requestObject.NwkKey);
            }
        ...
        /// </summary>  
        public readonly static OtaaV1_1Marshaller Instance = new OtaaV1_1Marshaller();
