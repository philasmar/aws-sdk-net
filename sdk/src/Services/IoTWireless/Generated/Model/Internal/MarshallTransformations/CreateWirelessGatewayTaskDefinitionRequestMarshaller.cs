...
namespace Amazon.IoTWireless.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateWirelessGatewayTaskDefinitionRequestMarshaller : IMarshaller<IRequest, CreateWirelessGatewayTaskDefinitionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateWirelessGatewayTaskDefinitionRequestMarshaller _instance = new CreateWirelessGatewayTaskDefinitionRequestMarshaller();        

        internal static CreateWirelessGatewayTaskDefinitionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWirelessGatewayTaskDefinitionRequestMarshaller Instance
        {
            get
            {
                return _instance;
