...
{
    /// <summary>
    /// Response Unmarshaller for DeactivatePipeline operation
    /// </summary>  
    public class DeactivatePipelineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeactivatePipelineResponse response = new DeactivatePipelineResponse();
        ...
        private static DeactivatePipelineResponseUnmarshaller _instance = new DeactivatePipelineResponseUnmarshaller();        

        internal static DeactivatePipelineResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeactivatePipelineResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
