...
namespace Amazon.DataPipeline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetPipelineDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetPipelineDefinitionResponseUnmarshaller _instance = new GetPipelineDefinitionResponseUnmarshaller();        

        internal static GetPipelineDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPipelineDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
