...
{
    /// <summary>
    /// Response Unmarshaller for EvaluateExpression operation
    /// </summary>  
    public class EvaluateExpressionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("evaluatedExpression", targetDepth))
                {
                    ...
                    response.EvaluatedExpression = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return TaskNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static EvaluateExpressionResponseUnmarshaller _instance = new EvaluateExpressionResponseUnmarshaller();        

        internal static EvaluateExpressionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EvaluateExpressionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
