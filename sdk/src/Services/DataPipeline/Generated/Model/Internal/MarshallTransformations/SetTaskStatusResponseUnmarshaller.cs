...
namespace Amazon.DataPipeline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SetTaskStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static SetTaskStatusResponseUnmarshaller _instance = new SetTaskStatusResponseUnmarshaller();        

        internal static SetTaskStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetTaskStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
