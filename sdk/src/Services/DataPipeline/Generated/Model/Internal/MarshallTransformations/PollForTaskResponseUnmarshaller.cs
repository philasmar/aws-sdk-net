...
namespace Amazon.DataPipeline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PollForTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = TaskObjectUnmarshaller.Instance;
                    response.TaskObject = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static PollForTaskResponseUnmarshaller _instance = new PollForTaskResponseUnmarshaller();        

        internal static PollForTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PollForTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
