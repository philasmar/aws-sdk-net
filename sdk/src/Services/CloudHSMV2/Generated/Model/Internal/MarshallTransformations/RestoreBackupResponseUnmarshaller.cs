...
{
    /// <summary>
    /// Response Unmarshaller for RestoreBackup operation
    /// </summary>  
    public class RestoreBackupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RestoreBackupResponse response = new RestoreBackupResponse();
        ...
        private static RestoreBackupResponseUnmarshaller _instance = new RestoreBackupResponseUnmarshaller();        

        internal static RestoreBackupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestoreBackupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
