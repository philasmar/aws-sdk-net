...
{
    /// <summary>
    /// Response Unmarshaller for InitializeCluster operation
    /// </summary>  
    public class InitializeClusterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            InitializeClusterResponse response = new InitializeClusterResponse();
        ...
        private static InitializeClusterResponseUnmarshaller _instance = new InitializeClusterResponseUnmarshaller();        

        internal static InitializeClusterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InitializeClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
