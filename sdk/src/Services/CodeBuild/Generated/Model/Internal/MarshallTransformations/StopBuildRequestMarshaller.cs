...
{
    /// <summary>
    /// StopBuild Request Marshaller
    /// </summary>       
    public class StopBuildRequestMarshaller : IMarshaller<IRequest, StopBuildRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StopBuildRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StopBuildRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodeBuild");
            string target = "CodeBuild_20161006.StopBuild";
