...
{
    /// <summary>
    /// Response Unmarshaller for StopBuild operation
    /// </summary>  
    public class StopBuildResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopBuildResponse response = new StopBuildResponse();
        ...
        private static StopBuildResponseUnmarshaller _instance = new StopBuildResponseUnmarshaller();        

        internal static StopBuildResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopBuildResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
