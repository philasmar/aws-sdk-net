...
{
    /// <summary>
    /// InvalidateProjectCache Request Marshaller
    /// </summary>       
    public class InvalidateProjectCacheRequestMarshaller : IMarshaller<IRequest, InvalidateProjectCacheRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((InvalidateProjectCacheRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(InvalidateProjectCacheRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodeBuild");
            string target = "CodeBuild_20161006.InvalidateProjectCache";
