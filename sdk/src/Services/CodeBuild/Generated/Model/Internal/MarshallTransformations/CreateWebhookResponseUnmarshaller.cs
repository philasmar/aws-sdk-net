...
namespace Amazon.CodeBuild.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateWebhookResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return OAuthProviderExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        internal static CreateWebhookResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWebhookResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
