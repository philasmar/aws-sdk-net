...
namespace Amazon.CodeBuild.Model.Internal.MarshallTransformations
{
    ...
    public class ProjectBuildBatchConfigUnmarshaller : IUnmarshaller<ProjectBuildBatchConfig, XmlUnmarshallerContext>, IUnmarshaller<ProjectBuildBatchConfig, JsonUnmarshallerContext>
    {
        ...
        private static ProjectBuildBatchConfigUnmarshaller _instance = new ProjectBuildBatchConfigUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ProjectBuildBatchConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
