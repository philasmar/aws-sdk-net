...
{
    /// <summary>
    /// ListPlacements Request Marshaller
    /// </summary>       
    public class ListPlacementsRequestMarshaller : IMarshaller<IRequest, ListPlacementsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListPlacementsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListPlacementsRequest publicRequest)
        {
        ...
        private static ListPlacementsRequestMarshaller _instance = new ListPlacementsRequestMarshaller();        

        internal static ListPlacementsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPlacementsRequestMarshaller Instance
        {
            get
            {
                return _instance;
