...
{
    /// <summary>
    /// UpdatePlacement Request Marshaller
    /// </summary>       
    public class UpdatePlacementRequestMarshaller : IMarshaller<IRequest, UpdatePlacementRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdatePlacementRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdatePlacementRequest publicRequest)
        {
        ...
        private static UpdatePlacementRequestMarshaller _instance = new UpdatePlacementRequestMarshaller();        

        internal static UpdatePlacementRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePlacementRequestMarshaller Instance
        {
            get
            {
                return _instance;
