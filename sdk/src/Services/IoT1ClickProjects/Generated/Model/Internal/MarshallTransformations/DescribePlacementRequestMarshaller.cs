...
{
    /// <summary>
    /// DescribePlacement Request Marshaller
    /// </summary>       
    public class DescribePlacementRequestMarshaller : IMarshaller<IRequest, DescribePlacementRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribePlacementRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribePlacementRequest publicRequest)
        {
        ...
        private static DescribePlacementRequestMarshaller _instance = new DescribePlacementRequestMarshaller();        

        internal static DescribePlacementRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePlacementRequestMarshaller Instance
        {
            get
            {
                return _instance;
