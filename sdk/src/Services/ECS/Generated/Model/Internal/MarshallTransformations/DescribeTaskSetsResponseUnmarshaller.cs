...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeTaskSetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTaskSetsResponse response = new DescribeTaskSetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("taskSets", targetDepth))
                {
                    ...
                    response.TaskSets = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeTaskSetsResponseUnmarshaller _instance = new DescribeTaskSetsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTaskSetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
