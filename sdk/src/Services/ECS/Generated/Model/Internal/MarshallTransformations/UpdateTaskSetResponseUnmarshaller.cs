...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateTaskSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTaskSetResponse response = new UpdateTaskSetResponse();
        ...
        private static UpdateTaskSetResponseUnmarshaller _instance = new UpdateTaskSetResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTaskSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
