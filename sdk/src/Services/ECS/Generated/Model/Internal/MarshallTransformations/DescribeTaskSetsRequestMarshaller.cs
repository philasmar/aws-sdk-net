...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeTaskSetsRequestMarshaller : IMarshaller<IRequest, DescribeTaskSetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeTaskSetsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeTaskSetsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECS");
            string target = "AmazonEC2ContainerServiceV20141113.DescribeTaskSets";
        ...
        private static DescribeTaskSetsRequestMarshaller _instance = new DescribeTaskSetsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTaskSetsRequestMarshaller Instance
        {
            get
            {
                return _instance;
