...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutClusterCapacityProvidersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutClusterCapacityProvidersResponse response = new PutClusterCapacityProvidersResponse();
        ...
        private static PutClusterCapacityProvidersResponseUnmarshaller _instance = new PutClusterCapacityProvidersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutClusterCapacityProvidersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
