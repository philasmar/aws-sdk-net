...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutAccountSettingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAccountSettingResponse response = new PutAccountSettingResponse();
        ...
        private static PutAccountSettingResponseUnmarshaller _instance = new PutAccountSettingResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAccountSettingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
