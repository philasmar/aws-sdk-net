...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateServicePrimaryTaskSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateServicePrimaryTaskSetResponse response = new UpdateServicePrimaryTaskSetResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("TaskSetNotFoundException"))
                {
                    return TaskSetNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static UpdateServicePrimaryTaskSetResponseUnmarshaller _instance = new UpdateServicePrimaryTaskSetResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateServicePrimaryTaskSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
