...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SubmitAttachmentStateChangesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SubmitAttachmentStateChangesResponse response = new SubmitAttachmentStateChangesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("acknowledgment", targetDepth))
                {
                    ...
                    response.Acknowledgment = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static SubmitAttachmentStateChangesResponseUnmarshaller _instance = new SubmitAttachmentStateChangesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SubmitAttachmentStateChangesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
