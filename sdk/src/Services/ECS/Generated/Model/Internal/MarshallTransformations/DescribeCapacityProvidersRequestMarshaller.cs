...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeCapacityProvidersRequestMarshaller : IMarshaller<IRequest, DescribeCapacityProvidersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeCapacityProvidersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeCapacityProvidersRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECS");
            string target = "AmazonEC2ContainerServiceV20141113.DescribeCapacityProviders";
        ...
        private static DescribeCapacityProvidersRequestMarshaller _instance = new DescribeCapacityProvidersRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCapacityProvidersRequestMarshaller Instance
        {
            get
            {
                return _instance;
