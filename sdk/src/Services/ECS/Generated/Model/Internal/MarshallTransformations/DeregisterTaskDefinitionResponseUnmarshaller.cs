...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeregisterTaskDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterTaskDefinitionResponse response = new DeregisterTaskDefinitionResponse();
        ...
        private static DeregisterTaskDefinitionResponseUnmarshaller _instance = new DeregisterTaskDefinitionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterTaskDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
