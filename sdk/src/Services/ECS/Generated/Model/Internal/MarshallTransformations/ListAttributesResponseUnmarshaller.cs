...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAttributesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAttributesResponse response = new ListAttributesResponse();
        ...
        private static ListAttributesResponseUnmarshaller _instance = new ListAttributesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
