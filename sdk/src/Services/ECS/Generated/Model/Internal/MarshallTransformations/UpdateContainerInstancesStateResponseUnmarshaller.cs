...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateContainerInstancesStateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateContainerInstancesStateResponse response = new UpdateContainerInstancesStateResponse();
        ...
        private static UpdateContainerInstancesStateResponseUnmarshaller _instance = new UpdateContainerInstancesStateResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateContainerInstancesStateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
