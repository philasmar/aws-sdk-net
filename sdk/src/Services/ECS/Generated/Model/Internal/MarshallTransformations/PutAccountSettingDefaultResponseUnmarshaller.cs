...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutAccountSettingDefaultResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAccountSettingDefaultResponse response = new PutAccountSettingDefaultResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("setting", targetDepth))
                {
                    ...
                    response.Setting = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static PutAccountSettingDefaultResponseUnmarshaller _instance = new PutAccountSettingDefaultResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAccountSettingDefaultResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
