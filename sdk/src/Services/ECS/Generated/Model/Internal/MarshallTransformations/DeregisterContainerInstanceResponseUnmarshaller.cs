...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeregisterContainerInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterContainerInstanceResponse response = new DeregisterContainerInstanceResponse();
        ...
        private static DeregisterContainerInstanceResponseUnmarshaller _instance = new DeregisterContainerInstanceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterContainerInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
