...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAccountSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAccountSettingsResponse response = new ListAccountSettingsResponse();
        ...
        private static ListAccountSettingsResponseUnmarshaller _instance = new ListAccountSettingsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAccountSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
