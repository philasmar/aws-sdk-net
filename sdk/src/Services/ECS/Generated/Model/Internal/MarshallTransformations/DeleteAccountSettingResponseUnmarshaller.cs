...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteAccountSettingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAccountSettingResponse response = new DeleteAccountSettingResponse();
        ...
        private static DeleteAccountSettingResponseUnmarshaller _instance = new DeleteAccountSettingResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAccountSettingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
