...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class SubmitAttachmentStateChangesRequestMarshaller : IMarshaller<IRequest, SubmitAttachmentStateChangesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SubmitAttachmentStateChangesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SubmitAttachmentStateChangesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECS");
            string target = "AmazonEC2ContainerServiceV20141113.SubmitAttachmentStateChanges";
        ...
        private static SubmitAttachmentStateChangesRequestMarshaller _instance = new SubmitAttachmentStateChangesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SubmitAttachmentStateChangesRequestMarshaller Instance
        {
            get
            {
                return _instance;
