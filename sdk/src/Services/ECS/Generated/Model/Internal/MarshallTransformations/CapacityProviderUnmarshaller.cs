    ...
    public class CapacityProviderUnmarshaller : IUnmarshaller<CapacityProvider, XmlUnmarshallerContext>, IUnmarshaller<CapacityProvider, JsonUnmarshallerContext>
    {
        ...
        public CapacityProvider Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = AutoScalingGroupProviderUnmarshaller.Instance;
                    unmarshalledObject.AutoScalingGroupProvider = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.UpdateStatusReason = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
