...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeTaskDefinitionRequestMarshaller : IMarshaller<IRequest, DescribeTaskDefinitionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeTaskDefinitionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeTaskDefinitionRequest publicRequest)
        {
        ...
        private static DescribeTaskDefinitionRequestMarshaller _instance = new DescribeTaskDefinitionRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTaskDefinitionRequestMarshaller Instance
        {
            get
            {
                return _instance;
