...
namespace Amazon.ECS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeregisterTaskDefinitionRequestMarshaller : IMarshaller<IRequest, DeregisterTaskDefinitionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeregisterTaskDefinitionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeregisterTaskDefinitionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECS");
            string target = "AmazonEC2ContainerServiceV20141113.DeregisterTaskDefinition";
