...
{
    /// <summary>
    /// Response Unmarshaller for CancelChangeSet operation
    /// </summary>  
    public class CancelChangeSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelChangeSetResponse response = new CancelChangeSetResponse();
        ...
        private static CancelChangeSetResponseUnmarshaller _instance = new CancelChangeSetResponseUnmarshaller();        

        internal static CancelChangeSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelChangeSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
