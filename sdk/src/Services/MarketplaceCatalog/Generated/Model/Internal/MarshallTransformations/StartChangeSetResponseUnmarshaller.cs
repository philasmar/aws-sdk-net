...
{
    /// <summary>
    /// Response Unmarshaller for StartChangeSet operation
    /// </summary>  
    public class StartChangeSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartChangeSetResponse response = new StartChangeSetResponse();
        ...
        private static StartChangeSetResponseUnmarshaller _instance = new StartChangeSetResponseUnmarshaller();        

        internal static StartChangeSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartChangeSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
