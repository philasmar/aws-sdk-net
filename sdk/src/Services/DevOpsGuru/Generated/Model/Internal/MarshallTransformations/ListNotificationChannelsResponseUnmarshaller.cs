...
{
    /// <summary>
    /// Response Unmarshaller for ListNotificationChannels operation
    /// </summary>  
    public class ListNotificationChannelsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListNotificationChannelsResponseUnmarshaller _instance = new ListNotificationChannelsResponseUnmarshaller();        

        internal static ListNotificationChannelsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListNotificationChannelsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
