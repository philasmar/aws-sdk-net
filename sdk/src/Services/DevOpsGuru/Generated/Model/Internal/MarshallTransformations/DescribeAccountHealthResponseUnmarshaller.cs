...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAccountHealth operation
    /// </summary>  
    public class DescribeAccountHealthResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAccountHealthResponse response = new DescribeAccountHealthResponse();
        ...
        private static DescribeAccountHealthResponseUnmarshaller _instance = new DescribeAccountHealthResponseUnmarshaller();        

        internal static DescribeAccountHealthResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAccountHealthResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
