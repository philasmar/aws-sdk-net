...
{
    /// <summary>
    /// Response Unmarshaller for ReactiveAnomaly Object
    /// </summary>  
    public class ReactiveAnomalyUnmarshaller : IUnmarshaller<ReactiveAnomaly, XmlUnmarshallerContext>, IUnmarshaller<ReactiveAnomaly, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ReactiveAnomaly IUnmarshaller<ReactiveAnomaly, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ReactiveAnomaly Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            ReactiveAnomaly unmarshalledObject = new ReactiveAnomaly();
        ...
        private static ReactiveAnomalyUnmarshaller _instance = new ReactiveAnomalyUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ReactiveAnomalyUnmarshaller Instance
        {
            get
            {
                return _instance;
