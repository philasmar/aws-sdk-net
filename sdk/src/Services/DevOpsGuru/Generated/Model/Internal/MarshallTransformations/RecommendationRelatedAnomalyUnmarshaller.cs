...
namespace Amazon.DevOpsGuru.Model.Internal.MarshallTransformations
{
    ...
    public class RecommendationRelatedAnomalyUnmarshaller : IUnmarshaller<RecommendationRelatedAnomaly, XmlUnmarshallerContext>, IUnmarshaller<RecommendationRelatedAnomaly, JsonUnmarshallerContext>
    {
        ...
        private static RecommendationRelatedAnomalyUnmarshaller _instance = new RecommendationRelatedAnomalyUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RecommendationRelatedAnomalyUnmarshaller Instance
        {
            get
            {
                return _instance;
