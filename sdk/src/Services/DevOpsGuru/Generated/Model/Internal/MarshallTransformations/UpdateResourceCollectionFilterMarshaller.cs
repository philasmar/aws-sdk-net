...
namespace Amazon.DevOpsGuru.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateResourceCollectionFilterMarshaller : IRequestMarshaller<UpdateResourceCollectionFilter, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(UpdateResourceCollectionFilter requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetCloudFormation())
            {
                ...
                var marshaller = UpdateCloudFormationCollectionFilterMarshaller.Instance;
