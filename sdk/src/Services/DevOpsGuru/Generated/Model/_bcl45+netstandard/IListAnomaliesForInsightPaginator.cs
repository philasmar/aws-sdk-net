...
namespace Amazon.DevOpsGuru.Model
{
    ...
    public interface IListAnomaliesForInsightPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<ListAnomaliesForInsightResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the ReactiveAnomalies
        /// </summary>
        IPaginatedEnumerable<ReactiveAnomalySummary> ReactiveAnomalies { get; }

        /// <summary>
        /// Enumerable containing all of the ProactiveAnomalies
        /// </summary>
        IPaginatedEnumerable<ProactiveAnomalySummary> ProactiveAnomalies { get; }
    }
}
#endif