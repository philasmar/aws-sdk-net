...
{
    /// <summary>
    /// Response Unmarshaller for CreateQuantumTask operation
    /// </summary>  
    public class CreateQuantumTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateQuantumTaskResponse response = new CreateQuantumTaskResponse();
        ...
        private static CreateQuantumTaskResponseUnmarshaller _instance = new CreateQuantumTaskResponseUnmarshaller();        

        internal static CreateQuantumTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateQuantumTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
