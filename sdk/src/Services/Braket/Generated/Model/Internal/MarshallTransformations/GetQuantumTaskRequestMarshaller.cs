...
namespace Amazon.Braket.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetQuantumTaskRequestMarshaller : IMarshaller<IRequest, GetQuantumTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetQuantumTaskRequestMarshaller _instance = new GetQuantumTaskRequestMarshaller();        

        internal static GetQuantumTaskRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetQuantumTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
