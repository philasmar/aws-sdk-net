    ...
    public class SearchQuantumTasksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<QuantumTaskSummary, QuantumTaskSummaryUnmarshaller>(QuantumTaskSummaryUnmarshaller.Instance);
                    response.QuantumTasks = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static SearchQuantumTasksResponseUnmarshaller _instance = new SearchQuantumTasksResponseUnmarshaller();        

        internal static SearchQuantumTasksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchQuantumTasksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
