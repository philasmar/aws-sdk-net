...
{
    /// <summary>
    /// Response Unmarshaller for CancelQuantumTask operation
    /// </summary>  
    public class CancelQuantumTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelQuantumTaskResponse response = new CancelQuantumTaskResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("cancellationStatus", targetDepth))
                {
                    ...
                    response.CancellationStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static CancelQuantumTaskResponseUnmarshaller _instance = new CancelQuantumTaskResponseUnmarshaller();        

        internal static CancelQuantumTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelQuantumTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
