...
{
    /// <summary>
    /// ListDetectors Request Marshaller
    /// </summary>       
    public class ListDetectorsRequestMarshaller : IMarshaller<IRequest, ListDetectorsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListDetectorsRequest)input);
        }
        ...
        public IRequest Marshall(ListDetectorsRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetStateName())
                request.Parameters.Add("stateName", StringUtils.FromString(publicRequest.StateName));
            request.ResourcePath = "/detectors/{detectorModelName}";
            request.MarshallerVersion = 2;
            request.UseQueryString = true;

            return request;
        }
        private static ListDetectorsRequestMarshaller _instance = new ListDetectorsRequestMarshaller();        

        internal static ListDetectorsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDetectorsRequestMarshaller Instance
        {
            get
            {
                return _instance;
