...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    public class UserAuthConfigInfoUnmarshaller : IUnmarshaller<UserAuthConfigInfo, XmlUnmarshallerContext>, IUnmarshaller<UserAuthConfigInfo, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public UserAuthConfigInfo Unmarshall(XmlUnmarshallerContext context)
        {
            UserAuthConfigInfo unmarshalledObject = new UserAuthConfigInfo();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.IAMAuth = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UserAuthConfigInfoUnmarshaller Instance
        {
            get
            {
                return _instance;
