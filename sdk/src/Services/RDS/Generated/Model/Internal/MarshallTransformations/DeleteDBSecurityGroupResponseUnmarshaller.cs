...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteDBSecurityGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteDBSecurityGroupResult", 2))
                    {
        ...
        private static DeleteDBSecurityGroupResponseUnmarshaller _instance = new DeleteDBSecurityGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDBSecurityGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
