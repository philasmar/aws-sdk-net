...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    public class DoubleRangeUnmarshaller : IUnmarshaller<DoubleRange, XmlUnmarshallerContext>, IUnmarshaller<DoubleRange, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public DoubleRange Unmarshall(XmlUnmarshallerContext context)
        {
            DoubleRange unmarshalledObject = new DoubleRange();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DoubleRangeUnmarshaller Instance
        {
            get
            {
                return _instance;
