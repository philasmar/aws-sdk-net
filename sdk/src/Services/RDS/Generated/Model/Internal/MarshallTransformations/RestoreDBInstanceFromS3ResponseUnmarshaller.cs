...
{
    /// <summary>
    /// Response Unmarshaller for RestoreDBInstanceFromS3 operation
    /// </summary>  
    public class RestoreDBInstanceFromS3ResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RestoreDBInstanceFromS3Response response = new RestoreDBInstanceFromS3Response();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("RestoreDBInstanceFromS3Result", 2))
                    {
        ...
        private static RestoreDBInstanceFromS3ResponseUnmarshaller _instance = new RestoreDBInstanceFromS3ResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestoreDBInstanceFromS3ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
