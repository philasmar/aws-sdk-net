...
{
    /// <summary>
    /// Response Unmarshaller for ModifyCurrentDBClusterCapacity operation
    /// </summary>  
    public class ModifyCurrentDBClusterCapacityResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyCurrentDBClusterCapacityResponse response = new ModifyCurrentDBClusterCapacityResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyCurrentDBClusterCapacityResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ModifyCurrentDBClusterCapacityResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        response.TimeoutAction = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidDBClusterCapacityFault"))
                {
                    return InvalidDBClusterCapacityExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static ModifyCurrentDBClusterCapacityResponseUnmarshaller _instance = new ModifyCurrentDBClusterCapacityResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyCurrentDBClusterCapacityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
