...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDBProxyTargets operation
    /// </summary>  
    public class DescribeDBProxyTargetsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDBProxyTargetsResponse response = new DescribeDBProxyTargetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeDBProxyTargetsResult", 2))
                    {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBProxyTargetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
