...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PromoteReadReplicaDBClusterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PromoteReadReplicaDBClusterResponse response = new PromoteReadReplicaDBClusterResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("PromoteReadReplicaDBClusterResult", 2))
                    {
        ...
        private static PromoteReadReplicaDBClusterResponseUnmarshaller _instance = new PromoteReadReplicaDBClusterResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PromoteReadReplicaDBClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
