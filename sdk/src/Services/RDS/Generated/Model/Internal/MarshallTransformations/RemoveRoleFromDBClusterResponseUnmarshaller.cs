...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RemoveRoleFromDBClusterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveRoleFromDBClusterResponse response = new RemoveRoleFromDBClusterResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("RemoveRoleFromDBClusterResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("DBClusterRoleNotFound"))
                {
                    return DBClusterRoleNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static RemoveRoleFromDBClusterResponseUnmarshaller _instance = new RemoveRoleFromDBClusterResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveRoleFromDBClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
