...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModifyDBClusterSnapshotAttributeResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyDBClusterSnapshotAttributeResponse response = new ModifyDBClusterSnapshotAttributeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyDBClusterSnapshotAttributeResult", 2))
                    {
        ...
        private static ModifyDBClusterSnapshotAttributeResponseUnmarshaller _instance = new ModifyDBClusterSnapshotAttributeResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyDBClusterSnapshotAttributeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
