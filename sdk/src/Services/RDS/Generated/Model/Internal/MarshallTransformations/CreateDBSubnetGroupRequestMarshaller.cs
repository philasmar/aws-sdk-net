    ...
    public class CreateDBSubnetGroupRequestMarshaller : IMarshaller<IRequest, CreateDBSubnetGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateDBSubnetGroupRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static CreateDBSubnetGroupRequestMarshaller _instance = new CreateDBSubnetGroupRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDBSubnetGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
