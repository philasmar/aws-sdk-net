...
{
    /// <summary>
    /// Response Unmarshaller for DescribeOptionGroups operation
    /// </summary>  
    public class DescribeOptionGroupsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeOptionGroupsResponse response = new DescribeOptionGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeOptionGroupsResult", 2))
                    {
        ...
        private static DescribeOptionGroupsResponseUnmarshaller _instance = new DescribeOptionGroupsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeOptionGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
