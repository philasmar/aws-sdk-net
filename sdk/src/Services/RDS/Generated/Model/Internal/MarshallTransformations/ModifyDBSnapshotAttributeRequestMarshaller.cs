...
{
    /// <summary>
    /// ModifyDBSnapshotAttribute Request Marshaller
    /// </summary>       
    public class ModifyDBSnapshotAttributeRequestMarshaller : IMarshaller<IRequest, ModifyDBSnapshotAttributeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyDBSnapshotAttributeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyDBSnapshotAttributeRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "ModifyDBSnapshotAttribute");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyDBSnapshotAttributeRequestMarshaller Instance
        {
            get
            {
                return _instance;
