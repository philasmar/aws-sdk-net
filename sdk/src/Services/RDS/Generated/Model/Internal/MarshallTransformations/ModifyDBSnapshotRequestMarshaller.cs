...
{
    /// <summary>
    /// ModifyDBSnapshot Request Marshaller
    /// </summary>       
    public class ModifyDBSnapshotRequestMarshaller : IMarshaller<IRequest, ModifyDBSnapshotRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyDBSnapshotRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyDBSnapshotRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "ModifyDBSnapshot");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyDBSnapshotRequestMarshaller Instance
        {
            get
            {
                return _instance;
