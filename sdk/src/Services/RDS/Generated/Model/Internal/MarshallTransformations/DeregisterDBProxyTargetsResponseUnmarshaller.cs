...
{
    /// <summary>
    /// Response Unmarshaller for DeregisterDBProxyTargets operation
    /// </summary>  
    public class DeregisterDBProxyTargetsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterDBProxyTargetsResponse response = new DeregisterDBProxyTargetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeregisterDBProxyTargetsResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("DBProxyTargetNotFoundFault"))
                {
                    return DBProxyTargetNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static DeregisterDBProxyTargetsResponseUnmarshaller _instance = new DeregisterDBProxyTargetsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterDBProxyTargetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
