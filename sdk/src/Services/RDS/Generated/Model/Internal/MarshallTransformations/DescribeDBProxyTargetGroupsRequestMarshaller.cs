...
{
    /// <summary>
    /// DescribeDBProxyTargetGroups Request Marshaller
    /// </summary>       
    public class DescribeDBProxyTargetGroupsRequestMarshaller : IMarshaller<IRequest, DescribeDBProxyTargetGroupsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeDBProxyTargetGroupsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeDBProxyTargetGroupsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "DescribeDBProxyTargetGroups");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBProxyTargetGroupsRequestMarshaller Instance
        {
            get
            {
                return _instance;
