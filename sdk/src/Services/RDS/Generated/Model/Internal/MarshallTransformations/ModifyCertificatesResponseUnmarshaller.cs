...
{
    /// <summary>
    /// Response Unmarshaller for ModifyCertificates operation
    /// </summary>  
    public class ModifyCertificatesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyCertificatesResponse response = new ModifyCertificatesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyCertificatesResult", 2))
                    {
        ...
        private static ModifyCertificatesResponseUnmarshaller _instance = new ModifyCertificatesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyCertificatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
