...
{
    /// <summary>
    /// DeregisterDBProxyTargets Request Marshaller
    /// </summary>       
    public class DeregisterDBProxyTargetsRequestMarshaller : IMarshaller<IRequest, DeregisterDBProxyTargetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeregisterDBProxyTargetsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeregisterDBProxyTargetsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "DeregisterDBProxyTargets");
            ...
            return request;
                    ...
                    private static DeregisterDBProxyTargetsRequestMarshaller _instance = new DeregisterDBProxyTargetsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterDBProxyTargetsRequestMarshaller Instance
        {
            get
            {
                return _instance;
