...
{
    /// <summary>
    /// Response Unmarshaller for StartDBInstanceAutomatedBackupsReplication operation
    /// </summary>  
    public class StartDBInstanceAutomatedBackupsReplicationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDBInstanceAutomatedBackupsReplicationResponse response = new StartDBInstanceAutomatedBackupsReplicationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("StartDBInstanceAutomatedBackupsReplicationResult", 2))
                    {
        ...
        private static StartDBInstanceAutomatedBackupsReplicationResponseUnmarshaller _instance = new StartDBInstanceAutomatedBackupsReplicationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDBInstanceAutomatedBackupsReplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
