...
{
    /// <summary>
    /// Response Unmarshaller for StopActivityStream operation
    /// </summary>  
    public class StopActivityStreamResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopActivityStreamResponse response = new StopActivityStreamResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("StopActivityStreamResult", 2))
                    {
        ...
        private static StopActivityStreamResponseUnmarshaller _instance = new StopActivityStreamResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopActivityStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
