...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDBProxy operation
    /// </summary>  
    public class DeleteDBProxyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDBProxyResponse response = new DeleteDBProxyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteDBProxyResult", 2))
                    {
        ...
        private static DeleteDBProxyResponseUnmarshaller _instance = new DeleteDBProxyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDBProxyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
