...
{
    /// <summary>
    /// Response Unmarshaller for StopDBInstance operation
    /// </summary>  
    public class StopDBInstanceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopDBInstanceResponse response = new StopDBInstanceResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("StopDBInstanceResult", 2))
                    {
        ...
        private static StopDBInstanceResponseUnmarshaller _instance = new StopDBInstanceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopDBInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
