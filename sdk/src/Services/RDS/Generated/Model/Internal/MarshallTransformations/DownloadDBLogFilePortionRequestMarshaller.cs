...
{
    /// <summary>
    /// DownloadDBLogFilePortion Request Marshaller
    /// </summary>       
    public class DownloadDBLogFilePortionRequestMarshaller : IMarshaller<IRequest, DownloadDBLogFilePortionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DownloadDBLogFilePortionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DownloadDBLogFilePortionRequest publicRequest)
        {
