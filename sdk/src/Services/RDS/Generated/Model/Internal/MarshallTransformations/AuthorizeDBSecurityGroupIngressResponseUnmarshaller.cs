...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AuthorizeDBSecurityGroupIngressResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AuthorizeDBSecurityGroupIngressResponse response = new AuthorizeDBSecurityGroupIngressResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("AuthorizeDBSecurityGroupIngressResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return AuthorizationQuotaExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static AuthorizeDBSecurityGroupIngressResponseUnmarshaller _instance = new AuthorizeDBSecurityGroupIngressResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AuthorizeDBSecurityGroupIngressResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
