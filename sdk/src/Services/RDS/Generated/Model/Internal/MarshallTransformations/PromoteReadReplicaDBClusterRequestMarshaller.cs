...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PromoteReadReplicaDBClusterRequestMarshaller : IMarshaller<IRequest, PromoteReadReplicaDBClusterRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PromoteReadReplicaDBClusterRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PromoteReadReplicaDBClusterRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "PromoteReadReplicaDBCluster");
