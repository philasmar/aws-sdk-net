...
{
    /// <summary>
    /// DescribeDBProxies Request Marshaller
    /// </summary>       
    public class DescribeDBProxiesRequestMarshaller : IMarshaller<IRequest, DescribeDBProxiesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeDBProxiesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeDBProxiesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "DescribeDBProxies");
            ...
            return request;
                    ...
                    private static DescribeDBProxiesRequestMarshaller _instance = new DescribeDBProxiesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBProxiesRequestMarshaller Instance
        {
            get
            {
                return _instance;
