...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModifyGlobalClusterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyGlobalClusterResponse response = new ModifyGlobalClusterResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyGlobalClusterResult", 2))
                    {
        ...
        private static ModifyGlobalClusterResponseUnmarshaller _instance = new ModifyGlobalClusterResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyGlobalClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
