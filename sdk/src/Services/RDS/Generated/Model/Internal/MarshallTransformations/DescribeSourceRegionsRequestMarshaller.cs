...
{
    /// <summary>
    /// DescribeSourceRegions Request Marshaller
    /// </summary>       
    public class DescribeSourceRegionsRequestMarshaller : IMarshaller<IRequest, DescribeSourceRegionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeSourceRegionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeSourceRegionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.RDS");
            request.Parameters.Add("Action", "DescribeSourceRegions");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSourceRegionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
