...
namespace Amazon.RDS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateGlobalClusterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateGlobalClusterResponse response = new CreateGlobalClusterResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateGlobalClusterResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("GlobalClusterQuotaExceededFault"))
                {
                    return GlobalClusterQuotaExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CreateGlobalClusterResponseUnmarshaller _instance = new CreateGlobalClusterResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGlobalClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
