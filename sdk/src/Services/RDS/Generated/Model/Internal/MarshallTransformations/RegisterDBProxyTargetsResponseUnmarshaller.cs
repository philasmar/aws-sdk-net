...
{
    /// <summary>
    /// Response Unmarshaller for RegisterDBProxyTargets operation
    /// </summary>  
    public class RegisterDBProxyTargetsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterDBProxyTargetsResponse response = new RegisterDBProxyTargetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("RegisterDBProxyTargetsResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("DBProxyTargetAlreadyRegisteredFault"))
                {
                    return DBProxyTargetAlreadyRegisteredExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static RegisterDBProxyTargetsResponseUnmarshaller _instance = new RegisterDBProxyTargetsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterDBProxyTargetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
