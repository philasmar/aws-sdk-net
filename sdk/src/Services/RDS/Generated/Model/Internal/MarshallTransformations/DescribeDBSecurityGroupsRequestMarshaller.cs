...
{
    /// <summary>
    /// DescribeDBSecurityGroups Request Marshaller
    /// </summary>       
    public class DescribeDBSecurityGroupsRequestMarshaller : IMarshaller<IRequest, DescribeDBSecurityGroupsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeDBSecurityGroupsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeDBSecurityGroupsRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeDBSecurityGroupsRequestMarshaller _instance = new DescribeDBSecurityGroupsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBSecurityGroupsRequestMarshaller Instance
        {
            get
            {
                return _instance;
