...
{
    /// <summary>
    /// UpdateBackendAuth Request Marshaller
    /// </summary>       
    public class UpdateBackendAuthRequestMarshaller : IMarshaller<IRequest, UpdateBackendAuthRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateBackendAuthRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateBackendAuthRequest publicRequest)
        {
            ...
            request.ResourcePath = "/backend/{appId}/auth/{backendEnvironmentName}";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetResourceConfig())
                {
                    ...
                    var marshaller = UpdateBackendAuthResourceConfigMarshaller.Instance;
        ...
        private static UpdateBackendAuthRequestMarshaller _instance = new UpdateBackendAuthRequestMarshaller();        

        internal static UpdateBackendAuthRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBackendAuthRequestMarshaller Instance
        {
            get
            {
                return _instance;
