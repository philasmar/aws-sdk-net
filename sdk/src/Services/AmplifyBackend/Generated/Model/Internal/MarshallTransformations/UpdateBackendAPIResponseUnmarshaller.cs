...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBackendAPI operation
    /// </summary>  
    public class UpdateBackendAPIResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBackendAPIResponse response = new UpdateBackendAPIResponse();
        ...
        private static UpdateBackendAPIResponseUnmarshaller _instance = new UpdateBackendAPIResponseUnmarshaller();        

        internal static UpdateBackendAPIResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBackendAPIResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
