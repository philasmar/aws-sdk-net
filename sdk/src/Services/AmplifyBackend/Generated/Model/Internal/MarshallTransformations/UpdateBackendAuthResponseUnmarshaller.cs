...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBackendAuth operation
    /// </summary>  
    public class UpdateBackendAuthResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBackendAuthResponse response = new UpdateBackendAuthResponse();
        ...
        private static UpdateBackendAuthResponseUnmarshaller _instance = new UpdateBackendAuthResponseUnmarshaller();        

        internal static UpdateBackendAuthResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBackendAuthResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
