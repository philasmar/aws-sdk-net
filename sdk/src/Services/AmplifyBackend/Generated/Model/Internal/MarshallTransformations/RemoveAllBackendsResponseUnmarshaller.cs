...
{
    /// <summary>
    /// Response Unmarshaller for RemoveAllBackends operation
    /// </summary>  
    public class RemoveAllBackendsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveAllBackendsResponse response = new RemoveAllBackendsResponse();
        ...
        private static RemoveAllBackendsResponseUnmarshaller _instance = new RemoveAllBackendsResponseUnmarshaller();        

        internal static RemoveAllBackendsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveAllBackendsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
