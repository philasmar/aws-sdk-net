...
{
    /// <summary>
    /// Response Unmarshaller for GetModels operation
    /// </summary>  
    public class GetModelsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Model, ModelUnmarshaller>(ModelUnmarshaller.Instance);
        ...
        private static GetModelsResponseUnmarshaller _instance = new GetModelsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetModelsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
