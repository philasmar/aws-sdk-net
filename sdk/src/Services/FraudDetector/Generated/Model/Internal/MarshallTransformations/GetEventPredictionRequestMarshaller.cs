...
{
    /// <summary>
    /// GetEventPrediction Request Marshaller
    /// </summary>       
    public class GetEventPredictionRequestMarshaller : IMarshaller<IRequest, GetEventPredictionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetEventPredictionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetEventPredictionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.FraudDetector");
            string target = "AWSHawksNestServiceFacade.GetEventPrediction";
        ...
        private static GetEventPredictionRequestMarshaller _instance = new GetEventPredictionRequestMarshaller();        

        internal static GetEventPredictionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEventPredictionRequestMarshaller Instance
        {
            get
            {
                return _instance;
