...
{
    /// <summary>
    /// Response Unmarshaller for UpdateModelVersion operation
    /// </summary>  
    public class UpdateModelVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateModelVersionResponse response = new UpdateModelVersionResponse();
        ...
        private static UpdateModelVersionResponseUnmarshaller _instance = new UpdateModelVersionResponseUnmarshaller();        

        internal static UpdateModelVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateModelVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
