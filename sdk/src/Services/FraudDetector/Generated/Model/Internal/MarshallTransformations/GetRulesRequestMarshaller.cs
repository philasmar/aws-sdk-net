...
{
    /// <summary>
    /// GetRules Request Marshaller
    /// </summary>       
    public class GetRulesRequestMarshaller : IMarshaller<IRequest, GetRulesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRulesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRulesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.FraudDetector");
            string target = "AWSHawksNestServiceFacade.GetRules";
        ...
        private static GetRulesRequestMarshaller _instance = new GetRulesRequestMarshaller();        

        internal static GetRulesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRulesRequestMarshaller Instance
        {
            get
            {
                return _instance;
