...
{
    /// <summary>
    /// Response Unmarshaller for GetModelVersion operation
    /// </summary>  
    public class GetModelVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetModelVersionResponseUnmarshaller _instance = new GetModelVersionResponseUnmarshaller();        

        internal static GetModelVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetModelVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
