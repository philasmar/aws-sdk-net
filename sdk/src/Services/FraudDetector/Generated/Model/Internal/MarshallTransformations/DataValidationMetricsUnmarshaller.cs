...
namespace Amazon.FraudDetector.Model.Internal.MarshallTransformations
{
    ...
    public class DataValidationMetricsUnmarshaller : IUnmarshaller<DataValidationMetrics, XmlUnmarshallerContext>, IUnmarshaller<DataValidationMetrics, JsonUnmarshallerContext>
    {
        ...
        private static DataValidationMetricsUnmarshaller _instance = new DataValidationMetricsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DataValidationMetricsUnmarshaller Instance
        {
            get
            {
                return _instance;
