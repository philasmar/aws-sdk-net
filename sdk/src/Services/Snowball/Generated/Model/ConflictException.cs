...
namespace Amazon.Snowball.Model
{
    ...
    [Serializable]
    #endif
    public partial class ConflictException : AmazonSnowballException
    {
        private string _conflictResource;
        ...
        protected ConflictException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
            this.ConflictResource = (string)info.GetValue("ConflictResource", typeof(string));
        }
        ...
        public override void GetObjectData(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
        {
            ...
            info.AddValue("ConflictResource", this.ConflictResource);
        }
#endif
        ...
        public string ConflictResource
        {
            ...
            set { this._conflictResource = value; }
        }

        // Check to see if ConflictResource property is set
        internal bool IsSetConflictResource()
        {
            return this._conflictResource != null;
        }
