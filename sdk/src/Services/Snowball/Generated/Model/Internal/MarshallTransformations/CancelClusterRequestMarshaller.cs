...
{
    /// <summary>
    /// CancelCluster Request Marshaller
    /// </summary>       
    public class CancelClusterRequestMarshaller : IMarshaller<IRequest, CancelClusterRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CancelClusterRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CancelClusterRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Snowball");
            string target = "AWSIESnowballJobManagementService.CancelCluster";
