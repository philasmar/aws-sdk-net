...
{
    /// <summary>
    /// Response Unmarshaller for CancelCluster operation
    /// </summary>  
    public class CancelClusterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelClusterResponse response = new CancelClusterResponse();
        ...
        private static CancelClusterResponseUnmarshaller _instance = new CancelClusterResponseUnmarshaller();        

        internal static CancelClusterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
