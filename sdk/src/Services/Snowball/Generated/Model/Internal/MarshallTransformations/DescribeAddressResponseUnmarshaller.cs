...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAddress operation
    /// </summary>  
    public class DescribeAddressResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAddressResponse response = new DescribeAddressResponse();
        ...
        private static DescribeAddressResponseUnmarshaller _instance = new DescribeAddressResponseUnmarshaller();        

        internal static DescribeAddressResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAddressResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
