...
{
    /// <summary>
    /// Response Unmarshaller for ListClusterJobs operation
    /// </summary>  
    public class ListClusterJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListClusterJobsResponseUnmarshaller _instance = new ListClusterJobsResponseUnmarshaller();        

        internal static ListClusterJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListClusterJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
