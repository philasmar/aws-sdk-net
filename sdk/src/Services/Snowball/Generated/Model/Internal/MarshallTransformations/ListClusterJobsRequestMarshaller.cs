...
{
    /// <summary>
    /// ListClusterJobs Request Marshaller
    /// </summary>       
    public class ListClusterJobsRequestMarshaller : IMarshaller<IRequest, ListClusterJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListClusterJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListClusterJobsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Snowball");
            string target = "AWSIESnowballJobManagementService.ListClusterJobs";
