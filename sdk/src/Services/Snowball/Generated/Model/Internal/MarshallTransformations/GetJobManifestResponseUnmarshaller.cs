...
{
    /// <summary>
    /// Response Unmarshaller for GetJobManifest operation
    /// </summary>  
    public class GetJobManifestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetJobManifestResponse response = new GetJobManifestResponse();

            context.Read();
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ManifestURI", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ManifestURI = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetJobManifestResponseUnmarshaller _instance = new GetJobManifestResponseUnmarshaller();        

        internal static GetJobManifestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetJobManifestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
