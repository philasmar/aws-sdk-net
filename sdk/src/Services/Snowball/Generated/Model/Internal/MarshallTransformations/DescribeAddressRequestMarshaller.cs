...
{
    /// <summary>
    /// DescribeAddress Request Marshaller
    /// </summary>       
    public class DescribeAddressRequestMarshaller : IMarshaller<IRequest, DescribeAddressRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeAddressRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeAddressRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Snowball");
            string target = "AWSIESnowballJobManagementService.DescribeAddress";
