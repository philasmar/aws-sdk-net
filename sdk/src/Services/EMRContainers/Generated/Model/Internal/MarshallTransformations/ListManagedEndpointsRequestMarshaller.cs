...
{
    /// <summary>
    /// ListManagedEndpoints Request Marshaller
    /// </summary>       
    public class ListManagedEndpointsRequestMarshaller : IMarshaller<IRequest, ListManagedEndpointsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListManagedEndpointsRequest)input);
        }
        ...
        private static ListManagedEndpointsRequestMarshaller _instance = new ListManagedEndpointsRequestMarshaller();        

        internal static ListManagedEndpointsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListManagedEndpointsRequestMarshaller Instance
        {
            get
            {
                return _instance;
