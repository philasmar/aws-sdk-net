...
{
    /// <summary>
    /// CreateManagedEndpoint Request Marshaller
    /// </summary>       
    public class CreateManagedEndpointRequestMarshaller : IMarshaller<IRequest, CreateManagedEndpointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateManagedEndpointRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateManagedEndpointRequest publicRequest)
        {
        ...
        private static CreateManagedEndpointRequestMarshaller _instance = new CreateManagedEndpointRequestMarshaller();        

        internal static CreateManagedEndpointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateManagedEndpointRequestMarshaller Instance
        {
            get
            {
                return _instance;
