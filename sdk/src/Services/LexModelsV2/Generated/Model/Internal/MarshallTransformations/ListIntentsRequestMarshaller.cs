...
{
    /// <summary>
    /// ListIntents Request Marshaller
    /// </summary>       
    public class ListIntentsRequestMarshaller : IMarshaller<IRequest, ListIntentsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListIntentsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListIntentsRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetFilters())
                {
                    ...
                    foreach(var publicRequestFiltersListValue in publicRequest.Filters)
                    {
                        ...
                        var marshaller = IntentFilterMarshaller.Instance;
                ...
                if(publicRequest.IsSetSortBy())
                {
                    ...
                    var marshaller = IntentSortByMarshaller.Instance;
        ...
        private static ListIntentsRequestMarshaller _instance = new ListIntentsRequestMarshaller();        

        internal static ListIntentsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIntentsRequestMarshaller Instance
        {
            get
            {
                return _instance;
