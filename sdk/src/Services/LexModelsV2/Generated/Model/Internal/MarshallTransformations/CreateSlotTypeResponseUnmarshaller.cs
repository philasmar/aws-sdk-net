...
{
    /// <summary>
    /// Response Unmarshaller for CreateSlotType operation
    /// </summary>  
    public class CreateSlotTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSlotTypeResponse response = new CreateSlotTypeResponse();
        ...
        private static CreateSlotTypeResponseUnmarshaller _instance = new CreateSlotTypeResponseUnmarshaller();        

        internal static CreateSlotTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSlotTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
