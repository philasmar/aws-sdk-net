    ...
    public class CreateBotVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, BotVersionLocaleDetails, StringUnmarshaller, BotVersionLocaleDetailsUnmarshaller>(StringUnmarshaller.Instance, BotVersionLocaleDetailsUnmarshaller.Instance);
                    response.BotVersionLocaleSpecification = unmarshaller.Unmarshall(context);
                    continue;
                }
