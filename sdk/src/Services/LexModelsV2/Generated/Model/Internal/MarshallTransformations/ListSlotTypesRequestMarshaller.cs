...
{
    /// <summary>
    /// ListSlotTypes Request Marshaller
    /// </summary>       
    public class ListSlotTypesRequestMarshaller : IMarshaller<IRequest, ListSlotTypesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListSlotTypesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListSlotTypesRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetFilters())
                {
                    ...
                    foreach(var publicRequestFiltersListValue in publicRequest.Filters)
                    {
                        ...
                        var marshaller = SlotTypeFilterMarshaller.Instance;
                ...
                if(publicRequest.IsSetSortBy())
                {
                    ...
                    var marshaller = SlotTypeSortByMarshaller.Instance;
        ...
        private static ListSlotTypesRequestMarshaller _instance = new ListSlotTypesRequestMarshaller();        

        internal static ListSlotTypesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSlotTypesRequestMarshaller Instance
        {
            get
            {
                return _instance;
