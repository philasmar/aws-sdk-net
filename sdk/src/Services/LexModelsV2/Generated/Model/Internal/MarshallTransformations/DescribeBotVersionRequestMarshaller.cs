...
{
    /// <summary>
    /// DescribeBotVersion Request Marshaller
    /// </summary>       
    public class DescribeBotVersionRequestMarshaller : IMarshaller<IRequest, DescribeBotVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeBotVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeBotVersionRequest publicRequest)
        {
        ...
        private static DescribeBotVersionRequestMarshaller _instance = new DescribeBotVersionRequestMarshaller();        

        internal static DescribeBotVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBotVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
