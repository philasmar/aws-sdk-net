...
{
    /// <summary>
    /// BuildBotLocale Request Marshaller
    /// </summary>       
    public class BuildBotLocaleRequestMarshaller : IMarshaller<IRequest, BuildBotLocaleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BuildBotLocaleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BuildBotLocaleRequest publicRequest)
        {
        ...
        private static BuildBotLocaleRequestMarshaller _instance = new BuildBotLocaleRequestMarshaller();        

        internal static BuildBotLocaleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BuildBotLocaleRequestMarshaller Instance
        {
            get
            {
                return _instance;
