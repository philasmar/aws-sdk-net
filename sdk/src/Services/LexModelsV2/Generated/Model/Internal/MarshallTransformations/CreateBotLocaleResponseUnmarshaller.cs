...
{
    /// <summary>
    /// Response Unmarshaller for CreateBotLocale operation
    /// </summary>  
    public class CreateBotLocaleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateBotLocaleResponse response = new CreateBotLocaleResponse();
        ...
        private static CreateBotLocaleResponseUnmarshaller _instance = new CreateBotLocaleResponseUnmarshaller();        

        internal static CreateBotLocaleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBotLocaleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
