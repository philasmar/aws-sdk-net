...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSlot operation
    /// </summary>  
    public class DeleteSlotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteSlotResponseUnmarshaller _instance = new DeleteSlotResponseUnmarshaller();        

        internal static DeleteSlotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSlotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
