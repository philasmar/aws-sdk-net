...
{
    /// <summary>
    /// Response Unmarshaller for UpdateIntent operation
    /// </summary>  
    public class UpdateIntentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateIntentResponse response = new UpdateIntentResponse();
        ...
        private static UpdateIntentResponseUnmarshaller _instance = new UpdateIntentResponseUnmarshaller();        

        internal static UpdateIntentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIntentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
