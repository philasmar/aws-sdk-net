...
{
    /// <summary>
    /// DescribeSlot Request Marshaller
    /// </summary>       
    public class DescribeSlotRequestMarshaller : IMarshaller<IRequest, DescribeSlotRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeSlotRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeSlotRequest publicRequest)
        {
        ...
        private static DescribeSlotRequestMarshaller _instance = new DescribeSlotRequestMarshaller();        

        internal static DescribeSlotRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSlotRequestMarshaller Instance
        {
            get
            {
                return _instance;
