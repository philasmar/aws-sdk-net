...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBotAlias operation
    /// </summary>  
    public class UpdateBotAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBotAliasResponse response = new UpdateBotAliasResponse();
        ...
        private static UpdateBotAliasResponseUnmarshaller _instance = new UpdateBotAliasResponseUnmarshaller();        

        internal static UpdateBotAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBotAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
