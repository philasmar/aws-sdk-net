...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSlotType operation
    /// </summary>  
    public class DescribeSlotTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSlotTypeResponse response = new DescribeSlotTypeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SlotTypeName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("slotTypeValues", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<SlotTypeValue, SlotTypeValueUnmarshaller>(SlotTypeValueUnmarshaller.Instance);
                    response.SlotTypeValues = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("valueSelectionSetting", targetDepth))
                {
                    ...
                    response.ValueSelectionSetting = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeSlotTypeResponseUnmarshaller _instance = new DescribeSlotTypeResponseUnmarshaller();        

        internal static DescribeSlotTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSlotTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
