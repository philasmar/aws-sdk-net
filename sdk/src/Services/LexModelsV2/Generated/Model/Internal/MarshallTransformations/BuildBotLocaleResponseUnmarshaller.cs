...
{
    /// <summary>
    /// Response Unmarshaller for BuildBotLocale operation
    /// </summary>  
    public class BuildBotLocaleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BuildBotLocaleResponse response = new BuildBotLocaleResponse();
        ...
        private static BuildBotLocaleResponseUnmarshaller _instance = new BuildBotLocaleResponseUnmarshaller();        

        internal static BuildBotLocaleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BuildBotLocaleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
