...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    public class LambdaCodeHookMarshaller : IRequestMarshaller<LambdaCodeHook, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(LambdaCodeHook requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetCodeHookInterfaceVersion())
            {
                context.Writer.WritePropertyName("codeHookInterfaceVersion");
                context.Writer.Write(requestObject.CodeHookInterfaceVersion);
            }
