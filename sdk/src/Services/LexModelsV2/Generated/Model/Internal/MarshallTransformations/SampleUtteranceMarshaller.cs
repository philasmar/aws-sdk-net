...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    public class SampleUtteranceMarshaller : IRequestMarshaller<SampleUtterance, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(SampleUtterance requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetUtterance())
            {
                context.Writer.WritePropertyName("utterance");
                context.Writer.Write(requestObject.Utterance);
            }
