...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBotLocale operation
    /// </summary>  
    public class UpdateBotLocaleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBotLocaleResponse response = new UpdateBotLocaleResponse();
        ...
        private static UpdateBotLocaleResponseUnmarshaller _instance = new UpdateBotLocaleResponseUnmarshaller();        

        internal static UpdateBotLocaleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBotLocaleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
