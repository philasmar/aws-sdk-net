...
namespace Amazon.LexModelsV2.Model.Internal.MarshallTransformations
{
    ...
    public class IntentConfirmationSettingUnmarshaller : IUnmarshaller<IntentConfirmationSetting, XmlUnmarshallerContext>, IUnmarshaller<IntentConfirmationSetting, JsonUnmarshallerContext>
    {
        ...
        private static IntentConfirmationSettingUnmarshaller _instance = new IntentConfirmationSettingUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static IntentConfirmationSettingUnmarshaller Instance
        {
            get
            {
                return _instance;
