...
{
    /// <summary>
    /// DescribeIntent Request Marshaller
    /// </summary>       
    public class DescribeIntentRequestMarshaller : IMarshaller<IRequest, DescribeIntentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeIntentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeIntentRequest publicRequest)
        {
        ...
        private static DescribeIntentRequestMarshaller _instance = new DescribeIntentRequestMarshaller();        

        internal static DescribeIntentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeIntentRequestMarshaller Instance
        {
            get
            {
                return _instance;
