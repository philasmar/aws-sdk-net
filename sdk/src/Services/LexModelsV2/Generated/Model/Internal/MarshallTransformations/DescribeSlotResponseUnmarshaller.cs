...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSlot operation
    /// </summary>  
    public class DescribeSlotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSlotResponse response = new DescribeSlotResponse();
        ...
        private static DescribeSlotResponseUnmarshaller _instance = new DescribeSlotResponseUnmarshaller();        

        internal static DescribeSlotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSlotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
