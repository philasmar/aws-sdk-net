...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBotLocale operation
    /// </summary>  
    public class DescribeBotLocaleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBotLocaleResponse response = new DescribeBotLocaleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BotLocaleHistoryEvent, BotLocaleHistoryEventUnmarshaller>(BotLocaleHistoryEventUnmarshaller.Instance);
                    response.BotLocaleHistoryEvents = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("intentsCount", targetDepth))
                {
                    ...
                    response.IntentsCount = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LocaleName = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("voiceSettings", targetDepth))
                {
                    ...
                    response.VoiceSettings = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeBotLocaleResponseUnmarshaller _instance = new DescribeBotLocaleResponseUnmarshaller();        

        internal static DescribeBotLocaleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBotLocaleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
