...
{
    /// <summary>
    /// Response Unmarshaller for DescribeIntent operation
    /// </summary>  
    public class DescribeIntentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeIntentResponseUnmarshaller _instance = new DescribeIntentResponseUnmarshaller();        

        internal static DescribeIntentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeIntentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
