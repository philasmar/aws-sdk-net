...
{
    /// <summary>
    /// DescribeSlotType Request Marshaller
    /// </summary>       
    public class DescribeSlotTypeRequestMarshaller : IMarshaller<IRequest, DescribeSlotTypeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeSlotTypeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeSlotTypeRequest publicRequest)
        {
        ...
        private static DescribeSlotTypeRequestMarshaller _instance = new DescribeSlotTypeRequestMarshaller();        

        internal static DescribeSlotTypeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSlotTypeRequestMarshaller Instance
        {
            get
            {
                return _instance;
