...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSlotType operation
    /// </summary>  
    public class UpdateSlotTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSlotTypeResponse response = new UpdateSlotTypeResponse();
        ...
        private static UpdateSlotTypeResponseUnmarshaller _instance = new UpdateSlotTypeResponseUnmarshaller();        

        internal static UpdateSlotTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSlotTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
