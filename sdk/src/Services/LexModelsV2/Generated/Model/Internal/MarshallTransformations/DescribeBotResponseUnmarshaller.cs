...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBot operation
    /// </summary>  
    public class DescribeBotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBotResponse response = new DescribeBotResponse();
        ...
        private static DescribeBotResponseUnmarshaller _instance = new DescribeBotResponseUnmarshaller();        

        internal static DescribeBotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
