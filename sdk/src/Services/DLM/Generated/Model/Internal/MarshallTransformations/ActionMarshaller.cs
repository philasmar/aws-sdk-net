    ...
    public class ActionMarshaller : IRequestMarshaller<Action, JsonMarshallerContext> 
    {
        ...
        public void Marshall(Action requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetCrossRegionCopy())
            {
                ...
                foreach(var requestObjectCrossRegionCopyListValue in requestObject.CrossRegionCopy)
                {
                    context.Writer.WriteObjectStart();

                    var marshaller = CrossRegionCopyActionMarshaller.Instance;
                    marshaller.Marshall(requestObjectCrossRegionCopyListValue, context);
