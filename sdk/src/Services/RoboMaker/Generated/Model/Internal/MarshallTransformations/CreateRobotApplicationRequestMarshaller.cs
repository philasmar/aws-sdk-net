...
{
    /// <summary>
    /// CreateRobotApplication Request Marshaller
    /// </summary>       
    public class CreateRobotApplicationRequestMarshaller : IMarshaller<IRequest, CreateRobotApplicationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateRobotApplicationRequest)input);
        }
        ...
        public IRequest Marshall(CreateRobotApplicationRequest publicRequest)
        {
            ...
            request.ResourcePath = "/createRobotApplication";
        ...
        private static CreateRobotApplicationRequestMarshaller _instance = new CreateRobotApplicationRequestMarshaller();        

        internal static CreateRobotApplicationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRobotApplicationRequestMarshaller Instance
        {
            get
            {
                return _instance;
