...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRobotApplication operation
    /// </summary>  
    public class DescribeRobotApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRobotApplicationResponse response = new DescribeRobotApplicationResponse();
        ...
        private static DescribeRobotApplicationResponseUnmarshaller _instance = new DescribeRobotApplicationResponseUnmarshaller();        

        internal static DescribeRobotApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRobotApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
