...
{
    /// <summary>
    /// Response Unmarshaller for CreateWorldTemplate operation
    /// </summary>  
    public class CreateWorldTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWorldTemplateResponse response = new CreateWorldTemplateResponse();
        ...
        private static CreateWorldTemplateResponseUnmarshaller _instance = new CreateWorldTemplateResponseUnmarshaller();        

        internal static CreateWorldTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWorldTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
