...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSimulationApplication operation
    /// </summary>  
    public class UpdateSimulationApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSimulationApplicationResponse response = new UpdateSimulationApplicationResponse();
        ...
        private static UpdateSimulationApplicationResponseUnmarshaller _instance = new UpdateSimulationApplicationResponseUnmarshaller();        

        internal static UpdateSimulationApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSimulationApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
