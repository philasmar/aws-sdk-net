...
namespace Amazon.RoboMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeploymentJobUnmarshaller : IUnmarshaller<DeploymentJob, XmlUnmarshallerContext>, IUnmarshaller<DeploymentJob, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DeploymentJob IUnmarshaller<DeploymentJob, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public DeploymentJob Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("deploymentApplicationConfigs", targetDepth))
                {
                    ...
                    unmarshalledObject.DeploymentApplicationConfigs = unmarshaller.Unmarshall(context);
                    continue;
                }
