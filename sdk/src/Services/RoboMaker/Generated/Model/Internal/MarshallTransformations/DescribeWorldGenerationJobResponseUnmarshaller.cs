...
{
    /// <summary>
    /// Response Unmarshaller for DescribeWorldGenerationJob operation
    /// </summary>  
    public class DescribeWorldGenerationJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeWorldGenerationJobResponse response = new DescribeWorldGenerationJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = FinishedWorldsSummaryUnmarshaller.Instance;
                    response.FinishedWorldsSummary = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeWorldGenerationJobResponseUnmarshaller _instance = new DescribeWorldGenerationJobResponseUnmarshaller();        

        internal static DescribeWorldGenerationJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeWorldGenerationJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
