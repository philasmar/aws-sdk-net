...
{
    /// <summary>
    /// Response Unmarshaller for StartSimulationJobBatch operation
    /// </summary>  
    public class StartSimulationJobBatchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartSimulationJobBatchResponse response = new StartSimulationJobBatchResponse();
        ...
        private static StartSimulationJobBatchResponseUnmarshaller _instance = new StartSimulationJobBatchResponseUnmarshaller();        

        internal static StartSimulationJobBatchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSimulationJobBatchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
