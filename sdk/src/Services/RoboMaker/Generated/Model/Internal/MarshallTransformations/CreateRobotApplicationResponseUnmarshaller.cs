...
{
    /// <summary>
    /// Response Unmarshaller for CreateRobotApplication operation
    /// </summary>  
    public class CreateRobotApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRobotApplicationResponse response = new CreateRobotApplicationResponse();
        ...
        private static CreateRobotApplicationResponseUnmarshaller _instance = new CreateRobotApplicationResponseUnmarshaller();        

        internal static CreateRobotApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRobotApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
