...
{
    /// <summary>
    /// UpdateSimulationApplication Request Marshaller
    /// </summary>       
    public class UpdateSimulationApplicationRequestMarshaller : IMarshaller<IRequest, UpdateSimulationApplicationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateSimulationApplicationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateSimulationApplicationRequest publicRequest)
        {
        ...
        private static UpdateSimulationApplicationRequestMarshaller _instance = new UpdateSimulationApplicationRequestMarshaller();        

        internal static UpdateSimulationApplicationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSimulationApplicationRequestMarshaller Instance
        {
            get
            {
                return _instance;
