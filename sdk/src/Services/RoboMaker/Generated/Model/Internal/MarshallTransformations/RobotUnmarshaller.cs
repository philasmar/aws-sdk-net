...
namespace Amazon.RoboMaker.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RobotUnmarshaller : IUnmarshaller<Robot, XmlUnmarshallerContext>, IUnmarshaller<Robot, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Robot IUnmarshaller<Robot, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public Robot Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.LastDeploymentJob = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("lastDeploymentTime", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    unmarshalledObject.LastDeploymentTime = unmarshaller.Unmarshall(context);
                    continue;
                }
