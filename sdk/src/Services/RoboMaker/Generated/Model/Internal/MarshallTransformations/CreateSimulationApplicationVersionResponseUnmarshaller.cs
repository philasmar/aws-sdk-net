...
{
    /// <summary>
    /// Response Unmarshaller for CreateSimulationApplicationVersion operation
    /// </summary>  
    public class CreateSimulationApplicationVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSimulationApplicationVersionResponse response = new CreateSimulationApplicationVersionResponse();
        ...
        private static CreateSimulationApplicationVersionResponseUnmarshaller _instance = new CreateSimulationApplicationVersionResponseUnmarshaller();        

        internal static CreateSimulationApplicationVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSimulationApplicationVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
