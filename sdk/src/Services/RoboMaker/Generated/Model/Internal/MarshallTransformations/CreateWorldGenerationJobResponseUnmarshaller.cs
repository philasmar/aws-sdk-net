...
{
    /// <summary>
    /// Response Unmarshaller for CreateWorldGenerationJob operation
    /// </summary>  
    public class CreateWorldGenerationJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateWorldGenerationJobResponse response = new CreateWorldGenerationJobResponse();
        ...
        private static CreateWorldGenerationJobResponseUnmarshaller _instance = new CreateWorldGenerationJobResponseUnmarshaller();        

        internal static CreateWorldGenerationJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWorldGenerationJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
