...
{
    /// <summary>
    /// Response Unmarshaller for ListSimulationApplications operation
    /// </summary>  
    public class ListSimulationApplicationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListSimulationApplicationsResponseUnmarshaller _instance = new ListSimulationApplicationsResponseUnmarshaller();        

        internal static ListSimulationApplicationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSimulationApplicationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
