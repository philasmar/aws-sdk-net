...
{
    /// <summary>
    /// Response Unmarshaller for ListWorldExportJobs operation
    /// </summary>  
    public class ListWorldExportJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListWorldExportJobsResponseUnmarshaller _instance = new ListWorldExportJobsResponseUnmarshaller();        

        internal static ListWorldExportJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWorldExportJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
