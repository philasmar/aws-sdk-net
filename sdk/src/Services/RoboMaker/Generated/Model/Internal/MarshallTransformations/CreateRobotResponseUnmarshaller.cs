...
{
    /// <summary>
    /// Response Unmarshaller for CreateRobot operation
    /// </summary>  
    public class CreateRobotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateRobotResponseUnmarshaller _instance = new CreateRobotResponseUnmarshaller();        

        internal static CreateRobotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRobotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
