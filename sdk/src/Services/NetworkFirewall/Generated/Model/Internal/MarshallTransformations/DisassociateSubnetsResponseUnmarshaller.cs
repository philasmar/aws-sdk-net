...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateSubnets operation
    /// </summary>  
    public class DisassociateSubnetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateSubnetsResponse response = new DisassociateSubnetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("SubnetMappings", targetDepth))
                {
                    ...
                    response.SubnetMappings = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DisassociateSubnetsResponseUnmarshaller _instance = new DisassociateSubnetsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateSubnetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
