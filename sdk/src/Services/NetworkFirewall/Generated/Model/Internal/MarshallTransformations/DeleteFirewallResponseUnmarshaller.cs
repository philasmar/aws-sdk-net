...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFirewall operation
    /// </summary>  
    public class DeleteFirewallResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteFirewallResponse response = new DeleteFirewallResponse();
        ...
        private static DeleteFirewallResponseUnmarshaller _instance = new DeleteFirewallResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFirewallResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
