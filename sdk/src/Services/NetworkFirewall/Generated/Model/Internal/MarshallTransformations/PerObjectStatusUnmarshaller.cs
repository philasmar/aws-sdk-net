...
namespace Amazon.NetworkFirewall.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PerObjectStatusUnmarshaller : IUnmarshaller<PerObjectStatus, XmlUnmarshallerContext>, IUnmarshaller<PerObjectStatus, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PerObjectStatus IUnmarshaller<PerObjectStatus, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public PerObjectStatus Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
