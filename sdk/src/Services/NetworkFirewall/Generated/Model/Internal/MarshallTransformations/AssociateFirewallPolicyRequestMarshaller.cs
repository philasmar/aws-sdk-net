...
{
    /// <summary>
    /// AssociateFirewallPolicy Request Marshaller
    /// </summary>       
    public class AssociateFirewallPolicyRequestMarshaller : IMarshaller<IRequest, AssociateFirewallPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateFirewallPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateFirewallPolicyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.NetworkFirewall");
            string target = "NetworkFirewall_20201112.AssociateFirewallPolicy";
        ...
        private static AssociateFirewallPolicyRequestMarshaller _instance = new AssociateFirewallPolicyRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateFirewallPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
