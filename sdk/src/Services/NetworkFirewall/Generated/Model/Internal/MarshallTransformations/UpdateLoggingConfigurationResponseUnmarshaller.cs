    ...
    public class UpdateLoggingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("LogDestinationPermissionException"))
                {
                    return LogDestinationPermissionExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
