...
{
    /// <summary>
    /// UpdateFirewallDescription Request Marshaller
    /// </summary>       
    public class UpdateFirewallDescriptionRequestMarshaller : IMarshaller<IRequest, UpdateFirewallDescriptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateFirewallDescriptionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateFirewallDescriptionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.NetworkFirewall");
            string target = "NetworkFirewall_20201112.UpdateFirewallDescription";
        ...
        private static UpdateFirewallDescriptionRequestMarshaller _instance = new UpdateFirewallDescriptionRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFirewallDescriptionRequestMarshaller Instance
        {
            get
            {
                return _instance;
