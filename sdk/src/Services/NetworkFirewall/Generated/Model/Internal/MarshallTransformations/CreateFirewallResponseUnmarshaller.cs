...
{
    /// <summary>
    /// Response Unmarshaller for CreateFirewall operation
    /// </summary>  
    public class CreateFirewallResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateFirewallResponse response = new CreateFirewallResponse();
        ...
        private static CreateFirewallResponseUnmarshaller _instance = new CreateFirewallResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFirewallResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
