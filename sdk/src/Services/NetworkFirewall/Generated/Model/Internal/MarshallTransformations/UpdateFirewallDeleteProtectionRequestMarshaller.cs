...
{
    /// <summary>
    /// UpdateFirewallDeleteProtection Request Marshaller
    /// </summary>       
    public class UpdateFirewallDeleteProtectionRequestMarshaller : IMarshaller<IRequest, UpdateFirewallDeleteProtectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateFirewallDeleteProtectionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateFirewallDeleteProtectionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.NetworkFirewall");
            string target = "NetworkFirewall_20201112.UpdateFirewallDeleteProtection";
        ...
        private static UpdateFirewallDeleteProtectionRequestMarshaller _instance = new UpdateFirewallDeleteProtectionRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFirewallDeleteProtectionRequestMarshaller Instance
        {
            get
            {
                return _instance;
