...
{
    /// <summary>
    /// UpdateFirewallPolicyChangeProtection Request Marshaller
    /// </summary>       
    public class UpdateFirewallPolicyChangeProtectionRequestMarshaller : IMarshaller<IRequest, UpdateFirewallPolicyChangeProtectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateFirewallPolicyChangeProtectionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateFirewallPolicyChangeProtectionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.NetworkFirewall");
            string target = "NetworkFirewall_20201112.UpdateFirewallPolicyChangeProtection";
        ...
        private static UpdateFirewallPolicyChangeProtectionRequestMarshaller _instance = new UpdateFirewallPolicyChangeProtectionRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFirewallPolicyChangeProtectionRequestMarshaller Instance
        {
            get
            {
                return _instance;
