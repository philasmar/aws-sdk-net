...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFlowSource operation
    /// </summary>  
    public class UpdateFlowSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFlowSourceResponse response = new UpdateFlowSourceResponse();
        ...
        private static UpdateFlowSourceResponseUnmarshaller _instance = new UpdateFlowSourceResponseUnmarshaller();        

        internal static UpdateFlowSourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFlowSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
