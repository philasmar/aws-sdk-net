...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFlowOutput operation
    /// </summary>  
    public class UpdateFlowOutputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFlowOutputResponse response = new UpdateFlowOutputResponse();
        ...
        private static UpdateFlowOutputResponseUnmarshaller _instance = new UpdateFlowOutputResponseUnmarshaller();        

        internal static UpdateFlowOutputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFlowOutputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
