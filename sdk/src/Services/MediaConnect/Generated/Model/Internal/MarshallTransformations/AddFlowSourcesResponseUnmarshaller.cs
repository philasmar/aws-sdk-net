...
{
    /// <summary>
    /// Response Unmarshaller for AddFlowSources operation
    /// </summary>  
    public class AddFlowSourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddFlowSourcesResponse response = new AddFlowSourcesResponse();
        ...
        private static AddFlowSourcesResponseUnmarshaller _instance = new AddFlowSourcesResponseUnmarshaller();        

        internal static AddFlowSourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddFlowSourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
