...
namespace Amazon.MediaConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateFlowEntitlementResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFlowEntitlementResponse response = new UpdateFlowEntitlementResponse();
        ...
        internal static UpdateFlowEntitlementResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFlowEntitlementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
