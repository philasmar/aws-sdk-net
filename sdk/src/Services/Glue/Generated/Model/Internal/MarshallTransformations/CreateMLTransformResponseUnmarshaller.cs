...
{
    /// <summary>
    /// Response Unmarshaller for CreateMLTransform operation
    /// </summary>  
    public class CreateMLTransformResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMLTransformResponse response = new CreateMLTransformResponse();
        ...
        private static CreateMLTransformResponseUnmarshaller _instance = new CreateMLTransformResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMLTransformResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
