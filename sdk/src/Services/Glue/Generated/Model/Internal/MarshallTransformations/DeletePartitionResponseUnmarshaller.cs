...
{
    /// <summary>
    /// Response Unmarshaller for DeletePartition operation
    /// </summary>  
    public class DeletePartitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePartitionResponse response = new DeletePartitionResponse();
        ...
        private static DeletePartitionResponseUnmarshaller _instance = new DeletePartitionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePartitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
