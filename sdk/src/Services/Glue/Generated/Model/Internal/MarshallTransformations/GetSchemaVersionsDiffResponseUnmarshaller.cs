...
{
    /// <summary>
    /// Response Unmarshaller for GetSchemaVersionsDiff operation
    /// </summary>  
    public class GetSchemaVersionsDiffResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSchemaVersionsDiffResponse response = new GetSchemaVersionsDiffResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("Diff", targetDepth))
                {
                    ...
                    response.Diff = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetSchemaVersionsDiffResponseUnmarshaller _instance = new GetSchemaVersionsDiffResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSchemaVersionsDiffResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
