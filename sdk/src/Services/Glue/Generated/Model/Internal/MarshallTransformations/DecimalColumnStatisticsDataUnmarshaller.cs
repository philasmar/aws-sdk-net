...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    public class DecimalColumnStatisticsDataUnmarshaller : IUnmarshaller<DecimalColumnStatisticsData, XmlUnmarshallerContext>, IUnmarshaller<DecimalColumnStatisticsData, JsonUnmarshallerContext>
    {
        ...
        private static DecimalColumnStatisticsDataUnmarshaller _instance = new DecimalColumnStatisticsDataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DecimalColumnStatisticsDataUnmarshaller Instance
        {
            get
            {
                return _instance;
