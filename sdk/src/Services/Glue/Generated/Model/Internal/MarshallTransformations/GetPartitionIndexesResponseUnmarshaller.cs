...
{
    /// <summary>
    /// Response Unmarshaller for GetPartitionIndexes operation
    /// </summary>  
    public class GetPartitionIndexesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPartitionIndexesResponse response = new GetPartitionIndexesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PartitionIndexDescriptor, PartitionIndexDescriptorUnmarshaller>(PartitionIndexDescriptorUnmarshaller.Instance);
                    response.PartitionIndexDescriptorList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetPartitionIndexesResponseUnmarshaller _instance = new GetPartitionIndexesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPartitionIndexesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
