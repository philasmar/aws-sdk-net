...
{
    /// <summary>
    /// Response Unmarshaller for PutWorkflowRunProperties operation
    /// </summary>  
    public class PutWorkflowRunPropertiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutWorkflowRunPropertiesResponse response = new PutWorkflowRunPropertiesResponse();
        ...
        private static PutWorkflowRunPropertiesResponseUnmarshaller _instance = new PutWorkflowRunPropertiesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutWorkflowRunPropertiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
