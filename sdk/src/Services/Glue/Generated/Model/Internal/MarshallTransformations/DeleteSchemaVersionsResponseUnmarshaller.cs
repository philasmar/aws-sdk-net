...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSchemaVersions operation
    /// </summary>  
    public class DeleteSchemaVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSchemaVersionsResponse response = new DeleteSchemaVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SchemaVersionErrorItem, SchemaVersionErrorItemUnmarshaller>(SchemaVersionErrorItemUnmarshaller.Instance);
                    response.SchemaVersionErrors = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DeleteSchemaVersionsResponseUnmarshaller _instance = new DeleteSchemaVersionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSchemaVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
