...
{
    /// <summary>
    /// Response Unmarshaller for CreateTrigger operation
    /// </summary>  
    public class CreateTriggerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTriggerResponse response = new CreateTriggerResponse();
        ...
        private static CreateTriggerResponseUnmarshaller _instance = new CreateTriggerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTriggerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
