...
{
    /// <summary>
    /// Response Unmarshaller for GetWorkflowRun operation
    /// </summary>  
    public class GetWorkflowRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetWorkflowRunResponse response = new GetWorkflowRunResponse();
        ...
        private static GetWorkflowRunResponseUnmarshaller _instance = new GetWorkflowRunResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWorkflowRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
