...
{
    /// <summary>
    /// Response Unmarshaller for CreateUserDefinedFunction operation
    /// </summary>  
    public class CreateUserDefinedFunctionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateUserDefinedFunctionResponse response = new CreateUserDefinedFunctionResponse();
        ...
        private static CreateUserDefinedFunctionResponseUnmarshaller _instance = new CreateUserDefinedFunctionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateUserDefinedFunctionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
