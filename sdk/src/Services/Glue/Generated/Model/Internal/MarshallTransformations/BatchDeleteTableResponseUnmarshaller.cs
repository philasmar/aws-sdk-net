...
{
    /// <summary>
    /// Response Unmarshaller for BatchDeleteTable operation
    /// </summary>  
    public class BatchDeleteTableResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDeleteTableResponse response = new BatchDeleteTableResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TableError, TableErrorUnmarshaller>(TableErrorUnmarshaller.Instance);
        ...
        private static BatchDeleteTableResponseUnmarshaller _instance = new BatchDeleteTableResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteTableResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
