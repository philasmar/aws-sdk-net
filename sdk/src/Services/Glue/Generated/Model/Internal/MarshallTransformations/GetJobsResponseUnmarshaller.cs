...
{
    /// <summary>
    /// Response Unmarshaller for GetJobs operation
    /// </summary>  
    public class GetJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetJobsResponseUnmarshaller _instance = new GetJobsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
