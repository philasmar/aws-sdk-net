...
{
    /// <summary>
    /// Response Unmarshaller for CreatePartition operation
    /// </summary>  
    public class CreatePartitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreatePartitionResponseUnmarshaller _instance = new CreatePartitionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePartitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
