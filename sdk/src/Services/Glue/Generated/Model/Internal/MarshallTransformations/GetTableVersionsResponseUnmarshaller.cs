...
{
    /// <summary>
    /// Response Unmarshaller for GetTableVersions operation
    /// </summary>  
    public class GetTableVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTableVersionsResponse response = new GetTableVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TableVersion, TableVersionUnmarshaller>(TableVersionUnmarshaller.Instance);
                    response.TableVersions = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetTableVersionsResponseUnmarshaller _instance = new GetTableVersionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTableVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
