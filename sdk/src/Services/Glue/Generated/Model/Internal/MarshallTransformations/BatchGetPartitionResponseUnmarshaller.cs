...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetPartition operation
    /// </summary>  
    public class BatchGetPartitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetPartitionResponse response = new BatchGetPartitionResponse();
        ...
        private static BatchGetPartitionResponseUnmarshaller _instance = new BatchGetPartitionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetPartitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
