...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetWorkflows operation
    /// </summary>  
    public class BatchGetWorkflowsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetWorkflowsResponse response = new BatchGetWorkflowsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("MissingWorkflows", targetDepth))
                {
                    ...
                    response.MissingWorkflows = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static BatchGetWorkflowsResponseUnmarshaller _instance = new BatchGetWorkflowsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetWorkflowsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
