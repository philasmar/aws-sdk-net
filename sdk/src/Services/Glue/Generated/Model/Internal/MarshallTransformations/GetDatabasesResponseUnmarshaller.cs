...
{
    /// <summary>
    /// Response Unmarshaller for GetDatabases operation
    /// </summary>  
    public class GetDatabasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetDatabasesResponseUnmarshaller _instance = new GetDatabasesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDatabasesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
