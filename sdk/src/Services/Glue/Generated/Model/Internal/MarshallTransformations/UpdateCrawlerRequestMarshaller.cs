...
{
    /// <summary>
    /// UpdateCrawler Request Marshaller
    /// </summary>       
    public class UpdateCrawlerRequestMarshaller : IMarshaller<IRequest, UpdateCrawlerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateCrawlerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateCrawlerRequest publicRequest)
        {
        ...
        private static UpdateCrawlerRequestMarshaller _instance = new UpdateCrawlerRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCrawlerRequestMarshaller Instance
        {
            get
            {
                return _instance;
