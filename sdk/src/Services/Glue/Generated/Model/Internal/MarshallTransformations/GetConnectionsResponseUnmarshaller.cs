...
{
    /// <summary>
    /// Response Unmarshaller for GetConnections operation
    /// </summary>  
    public class GetConnectionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ConnectionList", targetDepth))
                {
                    ...
                    response.ConnectionList = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetConnectionsResponseUnmarshaller _instance = new GetConnectionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConnectionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
