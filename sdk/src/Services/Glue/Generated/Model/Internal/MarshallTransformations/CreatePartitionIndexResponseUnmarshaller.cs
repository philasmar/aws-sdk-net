...
{
    /// <summary>
    /// Response Unmarshaller for CreatePartitionIndex operation
    /// </summary>  
    public class CreatePartitionIndexResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePartitionIndexResponse response = new CreatePartitionIndexResponse();
        ...
        private static CreatePartitionIndexResponseUnmarshaller _instance = new CreatePartitionIndexResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePartitionIndexResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
