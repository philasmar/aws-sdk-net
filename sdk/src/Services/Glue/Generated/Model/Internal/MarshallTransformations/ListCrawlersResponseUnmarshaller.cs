...
{
    /// <summary>
    /// Response Unmarshaller for ListCrawlers operation
    /// </summary>  
    public class ListCrawlersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListCrawlersResponse response = new ListCrawlersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CrawlerNames", targetDepth))
                {
                    ...
                    response.CrawlerNames = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListCrawlersResponseUnmarshaller _instance = new ListCrawlersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCrawlersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
