...
{
    /// <summary>
    /// Response Unmarshaller for GetMLTaskRuns operation
    /// </summary>  
    public class GetMLTaskRunsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMLTaskRunsResponse response = new GetMLTaskRunsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TaskRun, TaskRunUnmarshaller>(TaskRunUnmarshaller.Instance);
                    response.TaskRuns = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetMLTaskRunsResponseUnmarshaller _instance = new GetMLTaskRunsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMLTaskRunsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
