...
{
    /// <summary>
    /// Response Unmarshaller for CreateClassifier operation
    /// </summary>  
    public class CreateClassifierResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateClassifierResponse response = new CreateClassifierResponse();
        ...
        private static CreateClassifierResponseUnmarshaller _instance = new CreateClassifierResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateClassifierResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
