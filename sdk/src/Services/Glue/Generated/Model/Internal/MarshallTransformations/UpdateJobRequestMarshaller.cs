...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateJobRequestMarshaller : IMarshaller<IRequest, UpdateJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateJobRequest publicRequest)
        {
            ...
            string target = "AWSGlue.UpdateJob";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetJobUpdate())
                {
                    context.Writer.WritePropertyName("JobUpdate");
                    context.Writer.WriteObjectStart();

                    var marshaller = JobUpdateMarshaller.Instance;
                    marshaller.Marshall(publicRequest.JobUpdate, context);
