...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDevEndpoint operation
    /// </summary>  
    public class DeleteDevEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDevEndpointResponse response = new DeleteDevEndpointResponse();
        ...
        private static DeleteDevEndpointResponseUnmarshaller _instance = new DeleteDevEndpointResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDevEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
