...
{
    /// <summary>
    /// Response Unmarshaller for DeleteColumnStatisticsForTable operation
    /// </summary>  
    public class DeleteColumnStatisticsForTableResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteColumnStatisticsForTableResponse response = new DeleteColumnStatisticsForTableResponse();
        ...
        private static DeleteColumnStatisticsForTableResponseUnmarshaller _instance = new DeleteColumnStatisticsForTableResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteColumnStatisticsForTableResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
