...
{
    /// <summary>
    /// Response Unmarshaller for GetUserDefinedFunction operation
    /// </summary>  
    public class GetUserDefinedFunctionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetUserDefinedFunctionResponse response = new GetUserDefinedFunctionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = UserDefinedFunctionUnmarshaller.Instance;
                    response.UserDefinedFunction = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetUserDefinedFunctionResponseUnmarshaller _instance = new GetUserDefinedFunctionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUserDefinedFunctionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
