...
{
    /// <summary>
    /// Response Unmarshaller for StartTrigger operation
    /// </summary>  
    public class StartTriggerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartTriggerResponse response = new StartTriggerResponse();
        ...
        private static StartTriggerResponseUnmarshaller _instance = new StartTriggerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartTriggerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
