...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetJobs operation
    /// </summary>  
    public class BatchGetJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("JobsNotFound", targetDepth))
                {
                    ...
                    response.JobsNotFound = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static BatchGetJobsResponseUnmarshaller _instance = new BatchGetJobsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
