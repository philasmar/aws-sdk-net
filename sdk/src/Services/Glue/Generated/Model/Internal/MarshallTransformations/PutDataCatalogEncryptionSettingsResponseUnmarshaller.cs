...
{
    /// <summary>
    /// Response Unmarshaller for PutDataCatalogEncryptionSettings operation
    /// </summary>  
    public class PutDataCatalogEncryptionSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutDataCatalogEncryptionSettingsResponse response = new PutDataCatalogEncryptionSettingsResponse();
        ...
        private static PutDataCatalogEncryptionSettingsResponseUnmarshaller _instance = new PutDataCatalogEncryptionSettingsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutDataCatalogEncryptionSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
