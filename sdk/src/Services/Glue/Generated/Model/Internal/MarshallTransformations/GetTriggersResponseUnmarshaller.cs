...
{
    /// <summary>
    /// Response Unmarshaller for GetTriggers operation
    /// </summary>  
    public class GetTriggersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetTriggersResponseUnmarshaller _instance = new GetTriggersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTriggersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
