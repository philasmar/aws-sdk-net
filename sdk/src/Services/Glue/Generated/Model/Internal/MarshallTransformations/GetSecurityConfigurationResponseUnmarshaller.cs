...
{
    /// <summary>
    /// Response Unmarshaller for GetSecurityConfiguration operation
    /// </summary>  
    public class GetSecurityConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSecurityConfigurationResponse response = new GetSecurityConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = SecurityConfigurationUnmarshaller.Instance;
        ...
        private static GetSecurityConfigurationResponseUnmarshaller _instance = new GetSecurityConfigurationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSecurityConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
