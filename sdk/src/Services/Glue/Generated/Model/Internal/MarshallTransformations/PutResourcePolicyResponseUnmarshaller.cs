...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    public class PutResourcePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("ConditionCheckFailureException"))
                {
                    return ConditionCheckFailureExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
