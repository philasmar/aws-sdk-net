...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    public class BinaryColumnStatisticsDataUnmarshaller : IUnmarshaller<BinaryColumnStatisticsData, XmlUnmarshallerContext>, IUnmarshaller<BinaryColumnStatisticsData, JsonUnmarshallerContext>
    {
        ...
        private static BinaryColumnStatisticsDataUnmarshaller _instance = new BinaryColumnStatisticsDataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BinaryColumnStatisticsDataUnmarshaller Instance
        {
            get
            {
                return _instance;
