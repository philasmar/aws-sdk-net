...
{
    /// <summary>
    /// Response Unmarshaller for GetJobBookmark operation
    /// </summary>  
    public class GetJobBookmarkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetJobBookmarkResponse response = new GetJobBookmarkResponse();
        ...
        private static GetJobBookmarkResponseUnmarshaller _instance = new GetJobBookmarkResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetJobBookmarkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
