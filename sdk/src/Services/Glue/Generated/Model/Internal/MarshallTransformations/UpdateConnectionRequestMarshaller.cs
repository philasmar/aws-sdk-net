...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateConnectionRequestMarshaller : IMarshaller<IRequest, UpdateConnectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateConnectionRequest publicRequest)
        {
            ...
            string target = "AWSGlue.UpdateConnection";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetConnectionInput())
                {
                    context.Writer.WritePropertyName("ConnectionInput");
                    context.Writer.WriteObjectStart();

                    var marshaller = ConnectionInputMarshaller.Instance;
                    marshaller.Marshall(publicRequest.ConnectionInput, context);
