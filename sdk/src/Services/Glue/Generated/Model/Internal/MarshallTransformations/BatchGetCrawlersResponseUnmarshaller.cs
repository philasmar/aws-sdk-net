...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetCrawlers operation
    /// </summary>  
    public class BatchGetCrawlersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetCrawlersResponse response = new BatchGetCrawlersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("CrawlersNotFound", targetDepth))
                {
                    ...
                    response.CrawlersNotFound = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static BatchGetCrawlersResponseUnmarshaller _instance = new BatchGetCrawlersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetCrawlersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
