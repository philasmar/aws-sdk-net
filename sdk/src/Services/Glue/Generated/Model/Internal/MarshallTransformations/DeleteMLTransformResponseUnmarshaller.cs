...
{
    /// <summary>
    /// Response Unmarshaller for DeleteMLTransform operation
    /// </summary>  
    public class DeleteMLTransformResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMLTransformResponse response = new DeleteMLTransformResponse();
        ...
        private static DeleteMLTransformResponseUnmarshaller _instance = new DeleteMLTransformResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMLTransformResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
