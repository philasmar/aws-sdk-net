...
{
    /// <summary>
    /// Response Unmarshaller for GetCatalogImportStatus operation
    /// </summary>  
    public class GetCatalogImportStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCatalogImportStatusResponse response = new GetCatalogImportStatusResponse();
        ...
        private static GetCatalogImportStatusResponseUnmarshaller _instance = new GetCatalogImportStatusResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCatalogImportStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
