...
{
    /// <summary>
    /// Response Unmarshaller for GetUserDefinedFunctions operation
    /// </summary>  
    public class GetUserDefinedFunctionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetUserDefinedFunctionsResponse response = new GetUserDefinedFunctionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<UserDefinedFunction, UserDefinedFunctionUnmarshaller>(UserDefinedFunctionUnmarshaller.Instance);
                    response.UserDefinedFunctions = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetUserDefinedFunctionsResponseUnmarshaller _instance = new GetUserDefinedFunctionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUserDefinedFunctionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
