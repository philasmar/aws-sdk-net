...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSecurityConfiguration operation
    /// </summary>  
    public class DeleteSecurityConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSecurityConfigurationResponse response = new DeleteSecurityConfigurationResponse();
        ...
        private static DeleteSecurityConfigurationResponseUnmarshaller _instance = new DeleteSecurityConfigurationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSecurityConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
