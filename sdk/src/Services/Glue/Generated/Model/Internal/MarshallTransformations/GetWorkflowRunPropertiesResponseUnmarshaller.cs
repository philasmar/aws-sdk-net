...
{
    /// <summary>
    /// Response Unmarshaller for GetWorkflowRunProperties operation
    /// </summary>  
    public class GetWorkflowRunPropertiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetWorkflowRunPropertiesResponse response = new GetWorkflowRunPropertiesResponse();

            context.Read();
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("RunProperties", targetDepth))
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, string, StringUnmarshaller, StringUnmarshaller>(StringUnmarshaller.Instance, StringUnmarshaller.Instance);
                    response.RunProperties = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetWorkflowRunPropertiesResponseUnmarshaller _instance = new GetWorkflowRunPropertiesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWorkflowRunPropertiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
