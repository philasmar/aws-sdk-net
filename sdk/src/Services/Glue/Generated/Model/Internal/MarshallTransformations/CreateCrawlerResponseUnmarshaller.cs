...
{
    /// <summary>
    /// Response Unmarshaller for CreateCrawler operation
    /// </summary>  
    public class CreateCrawlerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCrawlerResponse response = new CreateCrawlerResponse();
        ...
        private static CreateCrawlerResponseUnmarshaller _instance = new CreateCrawlerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCrawlerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
