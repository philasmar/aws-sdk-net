...
{
    /// <summary>
    /// Response Unmarshaller for UpdateColumnStatisticsForPartition operation
    /// </summary>  
    public class UpdateColumnStatisticsForPartitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateColumnStatisticsForPartitionResponse response = new UpdateColumnStatisticsForPartitionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ColumnStatisticsError, ColumnStatisticsErrorUnmarshaller>(ColumnStatisticsErrorUnmarshaller.Instance);
        ...
        private static UpdateColumnStatisticsForPartitionResponseUnmarshaller _instance = new UpdateColumnStatisticsForPartitionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateColumnStatisticsForPartitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
