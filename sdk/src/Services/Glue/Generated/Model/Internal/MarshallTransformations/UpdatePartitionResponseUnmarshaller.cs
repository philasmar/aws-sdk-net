...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePartition operation
    /// </summary>  
    public class UpdatePartitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePartitionResponse response = new UpdatePartitionResponse();
        ...
        private static UpdatePartitionResponseUnmarshaller _instance = new UpdatePartitionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePartitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
