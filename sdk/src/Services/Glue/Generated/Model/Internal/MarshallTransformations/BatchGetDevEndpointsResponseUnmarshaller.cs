...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetDevEndpoints operation
    /// </summary>  
    public class BatchGetDevEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetDevEndpointsResponse response = new BatchGetDevEndpointsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DevEndpoint, DevEndpointUnmarshaller>(DevEndpointUnmarshaller.Instance);
                    response.DevEndpoints = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DevEndpointsNotFound", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.DevEndpointsNotFound = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static BatchGetDevEndpointsResponseUnmarshaller _instance = new BatchGetDevEndpointsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetDevEndpointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
