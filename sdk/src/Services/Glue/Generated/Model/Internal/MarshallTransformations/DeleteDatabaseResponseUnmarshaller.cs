...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDatabase operation
    /// </summary>  
    public class DeleteDatabaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteDatabaseResponseUnmarshaller _instance = new DeleteDatabaseResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDatabaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
