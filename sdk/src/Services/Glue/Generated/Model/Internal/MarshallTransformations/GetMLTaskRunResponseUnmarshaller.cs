...
{
    /// <summary>
    /// Response Unmarshaller for GetMLTaskRun operation
    /// </summary>  
    public class GetMLTaskRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMLTaskRunResponse response = new GetMLTaskRunResponse();
        ...
        private static GetMLTaskRunResponseUnmarshaller _instance = new GetMLTaskRunResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMLTaskRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
