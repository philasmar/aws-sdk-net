...
{
    /// <summary>
    /// Response Unmarshaller for BatchDeletePartition operation
    /// </summary>  
    public class BatchDeletePartitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDeletePartitionResponse response = new BatchDeletePartitionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PartitionError, PartitionErrorUnmarshaller>(PartitionErrorUnmarshaller.Instance);
        ...
        private static BatchDeletePartitionResponseUnmarshaller _instance = new BatchDeletePartitionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeletePartitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
