...
{
    /// <summary>
    /// Response Unmarshaller for GetClassifier operation
    /// </summary>  
    public class GetClassifierResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetClassifierResponse response = new GetClassifierResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("Classifier", targetDepth))
                {
                    ...
                    response.Classifier = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetClassifierResponseUnmarshaller _instance = new GetClassifierResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetClassifierResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
