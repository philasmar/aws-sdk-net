...
{
    /// <summary>
    /// Response Unmarshaller for StopTrigger operation
    /// </summary>  
    public class StopTriggerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopTriggerResponse response = new StopTriggerResponse();
        ...
        private static StopTriggerResponseUnmarshaller _instance = new StopTriggerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopTriggerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
