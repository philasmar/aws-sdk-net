...
{
    /// <summary>
    /// Response Unmarshaller for ResetJobBookmark operation
    /// </summary>  
    public class ResetJobBookmarkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ResetJobBookmarkResponse response = new ResetJobBookmarkResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = JobBookmarkEntryUnmarshaller.Instance;
                    response.JobBookmarkEntry = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ResetJobBookmarkResponseUnmarshaller _instance = new ResetJobBookmarkResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResetJobBookmarkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
