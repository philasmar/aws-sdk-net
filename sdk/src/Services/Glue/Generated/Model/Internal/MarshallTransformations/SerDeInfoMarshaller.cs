...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    public class SerDeInfoMarshaller : IRequestMarshaller<SerDeInfo, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(SerDeInfo requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetSerializationLibrary())
            {
                context.Writer.WritePropertyName("SerializationLibrary");
                context.Writer.Write(requestObject.SerializationLibrary);
            }
