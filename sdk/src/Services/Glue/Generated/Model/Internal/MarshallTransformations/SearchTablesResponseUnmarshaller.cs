...
{
    /// <summary>
    /// Response Unmarshaller for SearchTables operation
    /// </summary>  
    public class SearchTablesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SearchTablesResponse response = new SearchTablesResponse();
        ...
        private static SearchTablesResponseUnmarshaller _instance = new SearchTablesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchTablesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
