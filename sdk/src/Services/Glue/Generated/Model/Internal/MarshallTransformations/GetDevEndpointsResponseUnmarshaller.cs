...
{
    /// <summary>
    /// Response Unmarshaller for GetDevEndpoints operation
    /// </summary>  
    public class GetDevEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDevEndpointsResponse response = new GetDevEndpointsResponse();
        ...
        private static GetDevEndpointsResponseUnmarshaller _instance = new GetDevEndpointsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDevEndpointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
