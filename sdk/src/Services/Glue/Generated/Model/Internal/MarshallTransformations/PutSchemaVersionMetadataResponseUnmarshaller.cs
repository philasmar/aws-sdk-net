...
{
    /// <summary>
    /// Response Unmarshaller for PutSchemaVersionMetadata operation
    /// </summary>  
    public class PutSchemaVersionMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutSchemaVersionMetadataResponse response = new PutSchemaVersionMetadataResponse();
        ...
        private static PutSchemaVersionMetadataResponseUnmarshaller _instance = new PutSchemaVersionMetadataResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutSchemaVersionMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
