...
{
    /// <summary>
    /// Response Unmarshaller for ImportCatalogToGlue operation
    /// </summary>  
    public class ImportCatalogToGlueResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportCatalogToGlueResponse response = new ImportCatalogToGlueResponse();
        ...
        private static ImportCatalogToGlueResponseUnmarshaller _instance = new ImportCatalogToGlueResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportCatalogToGlueResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
