...
{
    /// <summary>
    /// Response Unmarshaller for GetWorkflowRuns operation
    /// </summary>  
    public class GetWorkflowRunsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetWorkflowRunsResponse response = new GetWorkflowRunsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<WorkflowRun, WorkflowRunUnmarshaller>(WorkflowRunUnmarshaller.Instance);
        ...
        private static GetWorkflowRunsResponseUnmarshaller _instance = new GetWorkflowRunsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWorkflowRunsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
