...
{
    /// <summary>
    /// Response Unmarshaller for GetSecurityConfigurations operation
    /// </summary>  
    public class GetSecurityConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSecurityConfigurationsResponse response = new GetSecurityConfigurationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SecurityConfiguration, SecurityConfigurationUnmarshaller>(SecurityConfigurationUnmarshaller.Instance);
        ...
        private static GetSecurityConfigurationsResponseUnmarshaller _instance = new GetSecurityConfigurationsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSecurityConfigurationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
