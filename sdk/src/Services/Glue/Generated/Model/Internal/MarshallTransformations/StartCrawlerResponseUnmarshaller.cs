...
{
    /// <summary>
    /// Response Unmarshaller for StartCrawler operation
    /// </summary>  
    public class StartCrawlerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartCrawlerResponse response = new StartCrawlerResponse();
        ...
        private static StartCrawlerResponseUnmarshaller _instance = new StartCrawlerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartCrawlerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
