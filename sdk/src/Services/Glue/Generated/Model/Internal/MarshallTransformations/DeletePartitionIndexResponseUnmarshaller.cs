...
{
    /// <summary>
    /// Response Unmarshaller for DeletePartitionIndex operation
    /// </summary>  
    public class DeletePartitionIndexResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePartitionIndexResponse response = new DeletePartitionIndexResponse();
        ...
        private static DeletePartitionIndexResponseUnmarshaller _instance = new DeletePartitionIndexResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePartitionIndexResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
