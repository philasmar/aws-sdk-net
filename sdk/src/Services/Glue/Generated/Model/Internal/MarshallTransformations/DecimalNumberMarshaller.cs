...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    public class DecimalNumberMarshaller : IRequestMarshaller<DecimalNumber, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(DecimalNumber requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetUnscaledValue())
            {
                ...
                context.Writer.Write(StringUtils.FromMemoryStream(requestObject.UnscaledValue));
            }
