...
{
    /// <summary>
    /// Response Unmarshaller for QuerySchemaVersionMetadata operation
    /// </summary>  
    public class QuerySchemaVersionMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            QuerySchemaVersionMetadataResponse response = new QuerySchemaVersionMetadataResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, MetadataInfo, StringUnmarshaller, MetadataInfoUnmarshaller>(StringUnmarshaller.Instance, MetadataInfoUnmarshaller.Instance);
                    response.MetadataInfoMap = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static QuerySchemaVersionMetadataResponseUnmarshaller _instance = new QuerySchemaVersionMetadataResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static QuerySchemaVersionMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
