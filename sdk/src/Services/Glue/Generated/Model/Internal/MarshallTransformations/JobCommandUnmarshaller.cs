...
namespace Amazon.Glue.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JobCommandUnmarshaller : IUnmarshaller<JobCommand, XmlUnmarshallerContext>, IUnmarshaller<JobCommand, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        JobCommand IUnmarshaller<JobCommand, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public JobCommand Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
