...
{
    /// <summary>
    /// Response Unmarshaller for RegisterSchemaVersion operation
    /// </summary>  
    public class RegisterSchemaVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterSchemaVersionResponse response = new RegisterSchemaVersionResponse();
        ...
        private static RegisterSchemaVersionResponseUnmarshaller _instance = new RegisterSchemaVersionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterSchemaVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
