...
{
    /// <summary>
    /// Response Unmarshaller for BatchGetTriggers operation
    /// </summary>  
    public class BatchGetTriggersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetTriggersResponse response = new BatchGetTriggersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("TriggersNotFound", targetDepth))
                {
                    ...
                    response.TriggersNotFound = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static BatchGetTriggersResponseUnmarshaller _instance = new BatchGetTriggersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetTriggersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
