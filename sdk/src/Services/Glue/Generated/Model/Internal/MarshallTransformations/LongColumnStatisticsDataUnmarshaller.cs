...
{
    /// <summary>
    /// Response Unmarshaller for LongColumnStatisticsData Object
    /// </summary>  
    public class LongColumnStatisticsDataUnmarshaller : IUnmarshaller<LongColumnStatisticsData, XmlUnmarshallerContext>, IUnmarshaller<LongColumnStatisticsData, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        LongColumnStatisticsData IUnmarshaller<LongColumnStatisticsData, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static LongColumnStatisticsDataUnmarshaller _instance = new LongColumnStatisticsDataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static LongColumnStatisticsDataUnmarshaller Instance
        {
            get
            {
                return _instance;
