...
{
    /// <summary>
    /// Response Unmarshaller for BatchCreatePartition operation
    /// </summary>  
    public class BatchCreatePartitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchCreatePartitionResponse response = new BatchCreatePartitionResponse();
        ...
        private static BatchCreatePartitionResponseUnmarshaller _instance = new BatchCreatePartitionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchCreatePartitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
