...
{
    /// <summary>
    /// Response Unmarshaller for GetPartition operation
    /// </summary>  
    public class GetPartitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("Partition", targetDepth))
                {
                    ...
                    response.Partition = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetPartitionResponseUnmarshaller _instance = new GetPartitionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPartitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
