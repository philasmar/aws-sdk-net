...
namespace Amazon.Glue.Model
{
    ...
    /// </summary>
    public partial class GetDevEndpointResponse : AmazonWebServiceResponse
    {
        ...
        {
            get { return this._devEndpoint; }
            set { this._devEndpoint = value; }
        }

        // Check to see if DevEndpoint property is set
        internal bool IsSetDevEndpoint()
        {
            return this._devEndpoint != null;
        }
