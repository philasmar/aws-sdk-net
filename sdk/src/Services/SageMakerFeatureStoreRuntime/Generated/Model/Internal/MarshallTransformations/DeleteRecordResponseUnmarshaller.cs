...
namespace Amazon.SageMakerFeatureStoreRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteRecordResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        internal static DeleteRecordResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRecordResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
