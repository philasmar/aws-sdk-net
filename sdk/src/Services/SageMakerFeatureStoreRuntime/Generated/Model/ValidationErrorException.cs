...
namespace Amazon.SageMakerFeatureStoreRuntime.Model
{
    ...
    [Serializable]
    #endif
    public partial class ValidationErrorException : AmazonSageMakerFeatureStoreRuntimeException
    {
        ...
        /// <summary>
        /// Construct instance of ValidationErrorException
        /// </summary>
        ...
        public ValidationErrorException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ValidationErrorException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
            : base(message, errorType, errorCode, requestId, statusCode) {}


#if !NETSTANDARD
        /// <summary>
        /// Constructs a new instance of the ValidationErrorException class with serialized data.
        /// </summary>
