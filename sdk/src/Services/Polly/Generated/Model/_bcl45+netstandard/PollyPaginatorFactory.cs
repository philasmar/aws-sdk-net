...
namespace Amazon.Polly.Model
{
    ...
    public class PollyPaginatorFactory : IPollyPaginatorFactory
    {
        ...
        ///</summary>
        public IListSpeechSynthesisTasksPaginator ListSpeechSynthesisTasks(ListSpeechSynthesisTasksRequest request) 
        {
            return new ListSpeechSynthesisTasksPaginator(this.client, request);
        }
    }
}
#endif