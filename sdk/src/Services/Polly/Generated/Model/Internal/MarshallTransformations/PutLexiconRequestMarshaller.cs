...
{
    /// <summary>
    /// PutLexicon Request Marshaller
    /// </summary>       
    public class PutLexiconRequestMarshaller : IMarshaller<IRequest, PutLexiconRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutLexiconRequest)input);
        }
        ...
        private static PutLexiconRequestMarshaller _instance = new PutLexiconRequestMarshaller();        

        internal static PutLexiconRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutLexiconRequestMarshaller Instance
        {
            get
            {
                return _instance;
