...
{
    /// <summary>
    /// Response Unmarshaller for DescribeVoices operation
    /// </summary>  
    public class DescribeVoicesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeVoicesResponseUnmarshaller _instance = new DescribeVoicesResponseUnmarshaller();        

        internal static DescribeVoicesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeVoicesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
