...
{
    /// <summary>
    /// Response Unmarshaller for ListLexicons operation
    /// </summary>  
    public class ListLexiconsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListLexiconsResponseUnmarshaller _instance = new ListLexiconsResponseUnmarshaller();        

        internal static ListLexiconsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLexiconsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
