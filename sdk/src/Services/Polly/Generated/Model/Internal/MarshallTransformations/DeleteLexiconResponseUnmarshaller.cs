...
{
    /// <summary>
    /// Response Unmarshaller for DeleteLexicon operation
    /// </summary>  
    public class DeleteLexiconResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteLexiconResponse response = new DeleteLexiconResponse();
        ...
        private static DeleteLexiconResponseUnmarshaller _instance = new DeleteLexiconResponseUnmarshaller();        

        internal static DeleteLexiconResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLexiconResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
