...
{
    /// <summary>
    /// Response Unmarshaller for ListSolutions operation
    /// </summary>  
    public class ListSolutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SolutionSummary, SolutionSummaryUnmarshaller>(SolutionSummaryUnmarshaller.Instance);
                    response.Solutions = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListSolutionsResponseUnmarshaller _instance = new ListSolutionsResponseUnmarshaller();        

        internal static ListSolutionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSolutionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
