...
{
    /// <summary>
    /// Response Unmarshaller for DeleteCampaign operation
    /// </summary>  
    public class DeleteCampaignResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteCampaignResponseUnmarshaller _instance = new DeleteCampaignResponseUnmarshaller();        

        internal static DeleteCampaignResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCampaignResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
