...
{
    /// <summary>
    /// Response Unmarshaller for CreateSolution operation
    /// </summary>  
    public class CreateSolutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSolutionResponse response = new CreateSolutionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("solutionArn", targetDepth))
                {
                    ...
                    response.SolutionArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateSolutionResponseUnmarshaller _instance = new CreateSolutionResponseUnmarshaller();        

        internal static CreateSolutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSolutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
