...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSolution operation
    /// </summary>  
    public class DeleteSolutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteSolutionResponseUnmarshaller _instance = new DeleteSolutionResponseUnmarshaller();        

        internal static DeleteSolutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSolutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
