...
{
    /// <summary>
    /// Response Unmarshaller for CreateFilter operation
    /// </summary>  
    public class CreateFilterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("filterArn", targetDepth))
                {
                    ...
                    response.FilterArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateFilterResponseUnmarshaller _instance = new CreateFilterResponseUnmarshaller();        

        internal static CreateFilterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFilterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
