...
{
    /// <summary>
    /// Response Unmarshaller for CreateBatchInferenceJob operation
    /// </summary>  
    public class CreateBatchInferenceJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateBatchInferenceJobResponse response = new CreateBatchInferenceJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("batchInferenceJobArn", targetDepth))
                {
                    ...
                    response.BatchInferenceJobArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateBatchInferenceJobResponseUnmarshaller _instance = new CreateBatchInferenceJobResponseUnmarshaller();        

        internal static CreateBatchInferenceJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBatchInferenceJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
