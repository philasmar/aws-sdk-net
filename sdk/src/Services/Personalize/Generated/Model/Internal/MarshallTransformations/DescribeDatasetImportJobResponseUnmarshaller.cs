...
namespace Amazon.Personalize.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeDatasetImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("datasetImportJob", targetDepth))
                {
                    var unmarshaller = DatasetImportJobUnmarshaller.Instance;
                    response.DatasetImportJob = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
