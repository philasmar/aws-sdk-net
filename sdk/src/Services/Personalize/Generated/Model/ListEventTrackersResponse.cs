...
{
    /// <summary>
    /// This is the response object from the ListEventTrackers operation.
    /// </summary>
    public partial class ListEventTrackersResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Gets and sets the property EventTrackers. 
        /// <para>
        /// A list of event trackers.
        /// </para>
        /// </summary>
        [AWSProperty(Max=100)]
        public List<EventTrackerSummary> EventTrackers
        {
            get { return this._eventTrackers; }
            set { this._eventTrackers = value; }
        }
