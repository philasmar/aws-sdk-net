...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeprecateWorkflowTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeprecateWorkflowTypeResponseUnmarshaller _instance = new DeprecateWorkflowTypeResponseUnmarshaller();        

        internal static DeprecateWorkflowTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeprecateWorkflowTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
