...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RegisterActivityTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static RegisterActivityTypeResponseUnmarshaller _instance = new RegisterActivityTypeResponseUnmarshaller();        

        internal static RegisterActivityTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterActivityTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
