...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeWorkflowTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeWorkflowTypeResponseUnmarshaller _instance = new DescribeWorkflowTypeResponseUnmarshaller();        

        internal static DescribeWorkflowTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeWorkflowTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
