...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RegisterWorkflowTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static RegisterWorkflowTypeResponseUnmarshaller _instance = new RegisterWorkflowTypeResponseUnmarshaller();        

        internal static RegisterWorkflowTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterWorkflowTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
