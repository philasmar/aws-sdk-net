...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    public class DeprecateDomainRequestMarshaller : IMarshaller<IRequest, DeprecateDomainRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        private static DeprecateDomainRequestMarshaller _instance = new DeprecateDomainRequestMarshaller();        

        internal static DeprecateDomainRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeprecateDomainRequestMarshaller Instance
        {
            get
            {
                return _instance;
