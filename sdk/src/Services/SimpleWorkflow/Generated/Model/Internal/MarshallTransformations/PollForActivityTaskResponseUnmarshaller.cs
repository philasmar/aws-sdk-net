...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PollForActivityTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static PollForActivityTaskResponseUnmarshaller _instance = new PollForActivityTaskResponseUnmarshaller();        

        internal static PollForActivityTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PollForActivityTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
