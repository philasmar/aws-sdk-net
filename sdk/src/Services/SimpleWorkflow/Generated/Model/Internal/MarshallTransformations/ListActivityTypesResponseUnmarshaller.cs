...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListActivityTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListActivityTypesResponseUnmarshaller _instance = new ListActivityTypesResponseUnmarshaller();        

        internal static ListActivityTypesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListActivityTypesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
