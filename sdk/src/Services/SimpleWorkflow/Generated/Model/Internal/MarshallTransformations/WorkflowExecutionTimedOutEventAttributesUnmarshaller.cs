...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    public class WorkflowExecutionTimedOutEventAttributesUnmarshaller : IUnmarshaller<WorkflowExecutionTimedOutEventAttributes, XmlUnmarshallerContext>, IUnmarshaller<WorkflowExecutionTimedOutEventAttributes, JsonUnmarshallerContext>
    {
        ...
        private static WorkflowExecutionTimedOutEventAttributesUnmarshaller _instance = new WorkflowExecutionTimedOutEventAttributesUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static WorkflowExecutionTimedOutEventAttributesUnmarshaller Instance
        {
            get
            {
                return _instance;
