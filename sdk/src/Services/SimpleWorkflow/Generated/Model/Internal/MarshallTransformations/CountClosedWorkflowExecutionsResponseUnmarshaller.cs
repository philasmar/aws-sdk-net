...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CountClosedWorkflowExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CountClosedWorkflowExecutionsResponseUnmarshaller _instance = new CountClosedWorkflowExecutionsResponseUnmarshaller();        

        internal static CountClosedWorkflowExecutionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CountClosedWorkflowExecutionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
