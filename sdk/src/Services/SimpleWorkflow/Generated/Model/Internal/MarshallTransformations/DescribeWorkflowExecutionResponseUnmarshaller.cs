...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeWorkflowExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeWorkflowExecutionResponseUnmarshaller _instance = new DescribeWorkflowExecutionResponseUnmarshaller();        

        internal static DescribeWorkflowExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeWorkflowExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
