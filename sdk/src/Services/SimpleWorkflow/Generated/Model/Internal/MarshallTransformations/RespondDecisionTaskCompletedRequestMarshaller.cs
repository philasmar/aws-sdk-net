...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RespondDecisionTaskCompletedRequestMarshaller : IMarshaller<IRequest, RespondDecisionTaskCompletedRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RespondDecisionTaskCompletedRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RespondDecisionTaskCompletedRequest publicRequest)
        {
        ...
        private static RespondDecisionTaskCompletedRequestMarshaller _instance = new RespondDecisionTaskCompletedRequestMarshaller();        

        internal static RespondDecisionTaskCompletedRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RespondDecisionTaskCompletedRequestMarshaller Instance
        {
            get
            {
                return _instance;
