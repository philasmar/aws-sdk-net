...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListWorkflowTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListWorkflowTypesResponseUnmarshaller _instance = new ListWorkflowTypesResponseUnmarshaller();        

        internal static ListWorkflowTypesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListWorkflowTypesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
