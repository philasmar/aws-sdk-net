...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListOpenWorkflowExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListOpenWorkflowExecutionsResponseUnmarshaller _instance = new ListOpenWorkflowExecutionsResponseUnmarshaller();        

        internal static ListOpenWorkflowExecutionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOpenWorkflowExecutionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
