...
namespace Amazon.SimpleWorkflow.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UndeprecateDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UndeprecateDomainResponse response = new UndeprecateDomainResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("DomainAlreadyExistsFault"))
                {
                    return DomainAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static UndeprecateDomainResponseUnmarshaller _instance = new UndeprecateDomainResponseUnmarshaller();        

        internal static UndeprecateDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UndeprecateDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
