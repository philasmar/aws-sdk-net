...
{
    /// <summary>
    /// Response Unmarshaller for ListSchedules operation
    /// </summary>  
    public class ListSchedulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListSchedulesResponseUnmarshaller _instance = new ListSchedulesResponseUnmarshaller();        

        internal static ListSchedulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSchedulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
