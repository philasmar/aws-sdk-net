...
namespace Amazon.GlueDataBrew.Model.Internal.MarshallTransformations
{
    ...
    public class ConditionExpressionMarshaller : IRequestMarshaller<ConditionExpression, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(ConditionExpression requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetTargetColumn())
            {
                context.Writer.WritePropertyName("TargetColumn");
                context.Writer.Write(requestObject.TargetColumn);
            }
