...
{
    /// <summary>
    /// Response Unmarshaller for RoleCredentials Object
    /// </summary>  
    public class RoleCredentialsUnmarshaller : IUnmarshaller<RoleCredentials, XmlUnmarshallerContext>, IUnmarshaller<RoleCredentials, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RoleCredentials IUnmarshaller<RoleCredentials, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public RoleCredentials Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
        ...
        private static RoleCredentialsUnmarshaller _instance = new RoleCredentialsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RoleCredentialsUnmarshaller Instance
        {
            get
            {
                return _instance;
