...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListReceivedLicensesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListReceivedLicensesResponse response = new ListReceivedLicensesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<GrantedLicense, GrantedLicenseUnmarshaller>(GrantedLicenseUnmarshaller.Instance);
                    response.Licenses = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListReceivedLicensesResponseUnmarshaller _instance = new ListReceivedLicensesResponseUnmarshaller();        

        internal static ListReceivedLicensesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListReceivedLicensesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
