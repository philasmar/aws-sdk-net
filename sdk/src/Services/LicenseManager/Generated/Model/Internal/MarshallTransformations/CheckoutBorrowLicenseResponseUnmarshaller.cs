...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CheckoutBorrowLicenseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CheckoutBorrowLicenseResponse response = new CheckoutBorrowLicenseResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CheckoutMetadata", targetDepth))
                {
                    ...
                    response.CheckoutMetadata = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("EntitlementsAllowed", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<EntitlementData, EntitlementDataUnmarshaller>(EntitlementDataUnmarshaller.Instance);
                    response.EntitlementsAllowed = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SignedToken = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("EntitlementNotAllowedException"))
                {
                    return EntitlementNotAllowedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("UnsupportedDigitalSignatureMethodException"))
                {
                    return UnsupportedDigitalSignatureMethodExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CheckoutBorrowLicenseResponseUnmarshaller _instance = new CheckoutBorrowLicenseResponseUnmarshaller();        

        internal static CheckoutBorrowLicenseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CheckoutBorrowLicenseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
