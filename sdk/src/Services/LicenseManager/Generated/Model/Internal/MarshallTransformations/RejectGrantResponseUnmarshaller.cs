...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RejectGrantResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RejectGrantResponse response = new RejectGrantResponse();
        ...
        private static RejectGrantResponseUnmarshaller _instance = new RejectGrantResponseUnmarshaller();        

        internal static RejectGrantResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RejectGrantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
