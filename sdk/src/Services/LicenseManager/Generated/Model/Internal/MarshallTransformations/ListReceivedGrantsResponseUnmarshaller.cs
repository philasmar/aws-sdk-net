...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListReceivedGrantsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListReceivedGrantsResponse response = new ListReceivedGrantsResponse();
        ...
        private static ListReceivedGrantsResponseUnmarshaller _instance = new ListReceivedGrantsResponseUnmarshaller();        

        internal static ListReceivedGrantsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListReceivedGrantsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
