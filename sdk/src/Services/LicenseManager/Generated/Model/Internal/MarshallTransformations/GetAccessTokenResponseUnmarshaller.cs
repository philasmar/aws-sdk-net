...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetAccessTokenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetAccessTokenResponseUnmarshaller _instance = new GetAccessTokenResponseUnmarshaller();        

        internal static GetAccessTokenResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccessTokenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
