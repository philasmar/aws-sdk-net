...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListResourceInventoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListResourceInventoryResponse response = new ListResourceInventoryResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ResourceInventory, ResourceInventoryUnmarshaller>(ResourceInventoryUnmarshaller.Instance);
                    response.ResourceInventoryList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListResourceInventoryResponseUnmarshaller _instance = new ListResourceInventoryResponseUnmarshaller();        

        internal static ListResourceInventoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListResourceInventoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
