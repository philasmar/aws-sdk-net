...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteLicenseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteLicenseResponseUnmarshaller _instance = new DeleteLicenseResponseUnmarshaller();        

        internal static DeleteLicenseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLicenseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
