...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetLicenseUsageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLicenseUsageResponse response = new GetLicenseUsageResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("LicenseUsage", targetDepth))
                {
                    ...
                    response.LicenseUsage = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetLicenseUsageResponseUnmarshaller _instance = new GetLicenseUsageResponseUnmarshaller();        

        internal static GetLicenseUsageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLicenseUsageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
