...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListLicenseVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLicenseVersionsResponse response = new ListLicenseVersionsResponse();
        ...
        private static ListLicenseVersionsResponseUnmarshaller _instance = new ListLicenseVersionsResponseUnmarshaller();        

        internal static ListLicenseVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLicenseVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
