...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CheckInLicenseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CheckInLicenseResponse response = new CheckInLicenseResponse();
        ...
        private static CheckInLicenseResponseUnmarshaller _instance = new CheckInLicenseResponseUnmarshaller();        

        internal static CheckInLicenseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CheckInLicenseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
