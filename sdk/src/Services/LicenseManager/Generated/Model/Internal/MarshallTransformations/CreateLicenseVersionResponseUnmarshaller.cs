...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateLicenseVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLicenseVersionResponse response = new CreateLicenseVersionResponse();
        ...
        private static CreateLicenseVersionResponseUnmarshaller _instance = new CreateLicenseVersionResponseUnmarshaller();        

        internal static CreateLicenseVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLicenseVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
