...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListUsageForLicenseConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListUsageForLicenseConfigurationResponse response = new ListUsageForLicenseConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<LicenseConfigurationUsage, LicenseConfigurationUsageUnmarshaller>(LicenseConfigurationUsageUnmarshaller.Instance);
                    response.LicenseConfigurationUsageList = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListUsageForLicenseConfigurationResponseUnmarshaller _instance = new ListUsageForLicenseConfigurationResponseUnmarshaller();        

        internal static ListUsageForLicenseConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUsageForLicenseConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
