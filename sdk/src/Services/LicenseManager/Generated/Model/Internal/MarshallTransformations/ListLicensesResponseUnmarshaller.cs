...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListLicensesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLicensesResponse response = new ListLicensesResponse();
        ...
        private static ListLicensesResponseUnmarshaller _instance = new ListLicensesResponseUnmarshaller();        

        internal static ListLicensesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLicensesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
