...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CheckoutLicenseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CheckoutLicenseResponse response = new CheckoutLicenseResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CheckoutType", targetDepth))
                {
                    ...
                    response.CheckoutType = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static CheckoutLicenseResponseUnmarshaller _instance = new CheckoutLicenseResponseUnmarshaller();        

        internal static CheckoutLicenseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CheckoutLicenseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
