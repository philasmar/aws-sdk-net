...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetLicenseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetLicenseResponseUnmarshaller _instance = new GetLicenseResponseUnmarshaller();        

        internal static GetLicenseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLicenseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
