...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteLicenseConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteLicenseConfigurationResponse response = new DeleteLicenseConfigurationResponse();
        ...
        private static DeleteLicenseConfigurationResponseUnmarshaller _instance = new DeleteLicenseConfigurationResponseUnmarshaller();        

        internal static DeleteLicenseConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLicenseConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
