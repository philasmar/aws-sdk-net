...
namespace Amazon.LicenseManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateLicenseSpecificationsForResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLicenseSpecificationsForResourceResponse response = new UpdateLicenseSpecificationsForResourceResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("LicenseUsageException"))
                {
                    return LicenseUsageExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static UpdateLicenseSpecificationsForResourceResponseUnmarshaller _instance = new UpdateLicenseSpecificationsForResourceResponseUnmarshaller();        

        internal static UpdateLicenseSpecificationsForResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLicenseSpecificationsForResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
