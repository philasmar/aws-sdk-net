...
namespace Amazon.AWSMarketplaceMetering.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ResolveCustomerRequestMarshaller : IMarshaller<IRequest, ResolveCustomerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ResolveCustomerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ResolveCustomerRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.AWSMarketplaceMetering");
            string target = "AWSMPMeteringService.ResolveCustomer";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                {
                    context.Writer.WritePropertyName("RegistrationToken");
                    context.Writer.Write(publicRequest.RegistrationToken);
                }
