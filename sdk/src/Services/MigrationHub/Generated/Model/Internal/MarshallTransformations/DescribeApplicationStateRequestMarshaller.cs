...
{
    /// <summary>
    /// DescribeApplicationState Request Marshaller
    /// </summary>       
    public class DescribeApplicationStateRequestMarshaller : IMarshaller<IRequest, DescribeApplicationStateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeApplicationStateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeApplicationStateRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MigrationHub");
            string target = "AWSMigrationHub.DescribeApplicationState";
