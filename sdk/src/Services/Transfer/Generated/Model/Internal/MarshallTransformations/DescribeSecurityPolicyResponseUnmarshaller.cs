...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeSecurityPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSecurityPolicyResponse response = new DescribeSecurityPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = DescribedSecurityPolicyUnmarshaller.Instance;
        ...
        private static DescribeSecurityPolicyResponseUnmarshaller _instance = new DescribeSecurityPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSecurityPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
