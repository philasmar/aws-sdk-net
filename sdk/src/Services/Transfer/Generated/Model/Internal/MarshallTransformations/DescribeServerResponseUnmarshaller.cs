...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeServerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeServerResponse response = new DescribeServerResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = DescribedServerUnmarshaller.Instance;
        ...
        private static DescribeServerResponseUnmarshaller _instance = new DescribeServerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeServerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
