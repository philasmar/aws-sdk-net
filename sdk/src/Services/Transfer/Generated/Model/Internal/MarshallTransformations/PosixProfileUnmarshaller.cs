...
namespace Amazon.Transfer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PosixProfileUnmarshaller : IUnmarshaller<PosixProfile, XmlUnmarshallerContext>, IUnmarshaller<PosixProfile, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PosixProfile IUnmarshaller<PosixProfile, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static PosixProfileUnmarshaller _instance = new PosixProfileUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PosixProfileUnmarshaller Instance
        {
            get
            {
                return _instance;
