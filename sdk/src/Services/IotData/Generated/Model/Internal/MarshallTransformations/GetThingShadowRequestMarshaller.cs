...
{
    /// <summary>
    /// GetThingShadow Request Marshaller
    /// </summary>       
    public class GetThingShadowRequestMarshaller : IMarshaller<IRequest, GetThingShadowRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetThingShadowRequest)input);
        }
        ...
        private static GetThingShadowRequestMarshaller _instance = new GetThingShadowRequestMarshaller();        

        internal static GetThingShadowRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetThingShadowRequestMarshaller Instance
        {
            get
            {
                return _instance;
