...
{
    /// <summary>
    /// Response Unmarshaller for UpdateThingShadow operation
    /// </summary>  
    public class UpdateThingShadowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateThingShadowResponseUnmarshaller _instance = new UpdateThingShadowResponseUnmarshaller();        

        internal static UpdateThingShadowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateThingShadowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
