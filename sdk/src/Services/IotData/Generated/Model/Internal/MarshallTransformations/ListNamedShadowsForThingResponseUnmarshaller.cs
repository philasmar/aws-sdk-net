...
{
    /// <summary>
    /// Response Unmarshaller for ListNamedShadowsForThing operation
    /// </summary>  
    public class ListNamedShadowsForThingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListNamedShadowsForThingResponseUnmarshaller _instance = new ListNamedShadowsForThingResponseUnmarshaller();        

        internal static ListNamedShadowsForThingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListNamedShadowsForThingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
