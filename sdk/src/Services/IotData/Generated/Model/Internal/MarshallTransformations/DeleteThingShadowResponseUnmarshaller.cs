...
{
    /// <summary>
    /// Response Unmarshaller for DeleteThingShadow operation
    /// </summary>  
    public class DeleteThingShadowResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteThingShadowResponseUnmarshaller _instance = new DeleteThingShadowResponseUnmarshaller();        

        internal static DeleteThingShadowResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteThingShadowResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
