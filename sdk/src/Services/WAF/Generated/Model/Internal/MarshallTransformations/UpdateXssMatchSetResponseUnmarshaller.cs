...
{
    /// <summary>
    /// Response Unmarshaller for UpdateXssMatchSet operation
    /// </summary>  
    public class UpdateXssMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateXssMatchSetResponse response = new UpdateXssMatchSetResponse();
        ...
        private static UpdateXssMatchSetResponseUnmarshaller _instance = new UpdateXssMatchSetResponseUnmarshaller();        

        internal static UpdateXssMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateXssMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
