...
{
    /// <summary>
    /// Response Unmarshaller for ListGeoMatchSets operation
    /// </summary>  
    public class ListGeoMatchSetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListGeoMatchSetsResponse response = new ListGeoMatchSetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<GeoMatchSetSummary, GeoMatchSetSummaryUnmarshaller>(GeoMatchSetSummaryUnmarshaller.Instance);
                    response.GeoMatchSets = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListGeoMatchSetsResponseUnmarshaller _instance = new ListGeoMatchSetsResponseUnmarshaller();        

        internal static ListGeoMatchSetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListGeoMatchSetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
