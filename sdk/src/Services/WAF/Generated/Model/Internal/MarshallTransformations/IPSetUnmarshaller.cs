    ...
    public class IPSetUnmarshaller : IUnmarshaller<IPSet, XmlUnmarshallerContext>, IUnmarshaller<IPSet, JsonUnmarshallerContext>
    {
        ...
        public IPSet Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<IPSetDescriptor, IPSetDescriptorUnmarshaller>(IPSetDescriptorUnmarshaller.Instance);
                    unmarshalledObject.IPSetDescriptors = unmarshaller.Unmarshall(context);
                    continue;
                }
