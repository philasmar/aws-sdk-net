...
{
    /// <summary>
    /// Response Unmarshaller for GetChangeTokenStatus operation
    /// </summary>  
    public class GetChangeTokenStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetChangeTokenStatusResponse response = new GetChangeTokenStatusResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ChangeTokenStatus", targetDepth))
                {
                    ...
                    response.ChangeTokenStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetChangeTokenStatusResponseUnmarshaller _instance = new GetChangeTokenStatusResponseUnmarshaller();        

        internal static GetChangeTokenStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetChangeTokenStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
