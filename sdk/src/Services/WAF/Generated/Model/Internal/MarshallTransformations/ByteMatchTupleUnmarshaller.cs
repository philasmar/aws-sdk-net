...
namespace Amazon.WAF.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ByteMatchTupleUnmarshaller : IUnmarshaller<ByteMatchTuple, XmlUnmarshallerContext>, IUnmarshaller<ByteMatchTuple, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ByteMatchTuple IUnmarshaller<ByteMatchTuple, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ByteMatchTuple Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("TargetString", targetDepth))
                {
                    ...
                    unmarshalledObject.TargetStream = unmarshaller.Unmarshall(context);
                    continue;
                }
