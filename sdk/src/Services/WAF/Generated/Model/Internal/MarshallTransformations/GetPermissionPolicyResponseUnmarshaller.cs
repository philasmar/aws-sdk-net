...
{
    /// <summary>
    /// Response Unmarshaller for GetPermissionPolicy operation
    /// </summary>  
    public class GetPermissionPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPermissionPolicyResponse response = new GetPermissionPolicyResponse();
        ...
        private static GetPermissionPolicyResponseUnmarshaller _instance = new GetPermissionPolicyResponseUnmarshaller();        

        internal static GetPermissionPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPermissionPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
