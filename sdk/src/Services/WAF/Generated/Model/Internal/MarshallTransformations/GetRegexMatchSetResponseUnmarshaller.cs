...
{
    /// <summary>
    /// Response Unmarshaller for GetRegexMatchSet operation
    /// </summary>  
    public class GetRegexMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRegexMatchSetResponse response = new GetRegexMatchSetResponse();
        ...
        private static GetRegexMatchSetResponseUnmarshaller _instance = new GetRegexMatchSetResponseUnmarshaller();        

        internal static GetRegexMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRegexMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
