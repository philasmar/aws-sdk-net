...
namespace Amazon.WAF.Model.Internal.MarshallTransformations
{
    ...
    public class GeoMatchSetUpdateMarshaller : IRequestMarshaller<GeoMatchSetUpdate, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(GeoMatchSetUpdate requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetGeoMatchConstraint())
            {
                context.Writer.WritePropertyName("GeoMatchConstraint");
                context.Writer.WriteObjectStart();

                var marshaller = GeoMatchConstraintMarshaller.Instance;
                marshaller.Marshall(requestObject.GeoMatchConstraint, context);
