...
{
    /// <summary>
    /// Response Unmarshaller for DeleteByteMatchSet operation
    /// </summary>  
    public class DeleteByteMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteByteMatchSetResponse response = new DeleteByteMatchSetResponse();
        ...
        private static DeleteByteMatchSetResponseUnmarshaller _instance = new DeleteByteMatchSetResponseUnmarshaller();        

        internal static DeleteByteMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteByteMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
