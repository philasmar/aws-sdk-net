...
{
    /// <summary>
    /// Response Unmarshaller for GetXssMatchSet operation
    /// </summary>  
    public class GetXssMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetXssMatchSetResponse response = new GetXssMatchSetResponse();
        ...
        private static GetXssMatchSetResponseUnmarshaller _instance = new GetXssMatchSetResponseUnmarshaller();        

        internal static GetXssMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetXssMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
