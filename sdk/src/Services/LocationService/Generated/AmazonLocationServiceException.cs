...
namespace Amazon.LocationService
{
    ...
    public partial class AmazonLocationServiceException : AmazonServiceException
    {
        ...
        public AmazonLocationServiceException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonLocationServiceException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
