...
{
    /// <summary>
    /// Response Unmarshaller for PutGeofence operation
    /// </summary>  
    public class PutGeofenceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutGeofenceResponse response = new PutGeofenceResponse();
        ...
        private static PutGeofenceResponseUnmarshaller _instance = new PutGeofenceResponseUnmarshaller();        

        internal static PutGeofenceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutGeofenceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
