...
namespace Amazon.LocationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetGeofenceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("Geometry", targetDepth))
                {
                    ...
                    response.Geometry = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        internal static GetGeofenceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGeofenceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
