...
namespace Amazon.LocationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateTrackerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTrackerResponse response = new CreateTrackerResponse();
        ...
        internal static CreateTrackerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTrackerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
