...
{
    /// <summary>
    /// GetMapGlyphs Request Marshaller
    /// </summary>       
    public class GetMapGlyphsRequestMarshaller : IMarshaller<IRequest, GetMapGlyphsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetMapGlyphsRequest)input);
        }
        ...
        public IRequest Marshall(GetMapGlyphsRequest publicRequest)
        {
            ...
            if (!publicRequest.IsSetFontStack())
                throw new AmazonLocationServiceException("Request object does not have required field FontStack set");
            request.AddPathResource("{FontStack}", StringUtils.FromString(publicRequest.FontStack));
            if (!publicRequest.IsSetFontUnicodeRange())
                throw new AmazonLocationServiceException("Request object does not have required field FontUnicodeRange set");
        ...
        private static GetMapGlyphsRequestMarshaller _instance = new GetMapGlyphsRequestMarshaller();        

        internal static GetMapGlyphsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMapGlyphsRequestMarshaller Instance
        {
            get
            {
                return _instance;
