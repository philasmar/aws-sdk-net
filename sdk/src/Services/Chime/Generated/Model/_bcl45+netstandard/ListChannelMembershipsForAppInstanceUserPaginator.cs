...
namespace Amazon.Chime.Model
{
    ...
    internal sealed partial class ListChannelMembershipsForAppInstanceUserPaginator : IPaginator<ListChannelMembershipsForAppInstanceUserResponse>, IListChannelMembershipsForAppInstanceUserPaginator
    {
...
#if BCL
        IEnumerable<ListChannelMembershipsForAppInstanceUserResponse> IPaginator<ListChannelMembershipsForAppInstanceUserResponse>.Paginate()
        {
            ...
            ListChannelMembershipsForAppInstanceUserResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.ListChannelMembershipsForAppInstanceUser(_request);
        ...
        async IAsyncEnumerable<ListChannelMembershipsForAppInstanceUserResponse> IPaginator<ListChannelMembershipsForAppInstanceUserResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListChannelMembershipsForAppInstanceUserAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
