...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSipRule operation
    /// </summary>  
    public class DeleteSipRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSipRuleResponse response = new DeleteSipRuleResponse();
        ...
        private static DeleteSipRuleResponseUnmarshaller _instance = new DeleteSipRuleResponseUnmarshaller();        

        internal static DeleteSipRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSipRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
