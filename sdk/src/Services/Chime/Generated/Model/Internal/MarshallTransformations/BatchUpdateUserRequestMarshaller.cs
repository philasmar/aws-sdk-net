...
{
    /// <summary>
    /// BatchUpdateUser Request Marshaller
    /// </summary>       
    public class BatchUpdateUserRequestMarshaller : IMarshaller<IRequest, BatchUpdateUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchUpdateUserRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchUpdateUserRequest publicRequest)
        {
        ...
        private static BatchUpdateUserRequestMarshaller _instance = new BatchUpdateUserRequestMarshaller();        

        internal static BatchUpdateUserRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchUpdateUserRequestMarshaller Instance
        {
            get
            {
                return _instance;
