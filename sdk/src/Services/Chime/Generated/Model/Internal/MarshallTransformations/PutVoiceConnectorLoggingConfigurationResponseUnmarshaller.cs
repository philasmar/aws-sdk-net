...
{
    /// <summary>
    /// Response Unmarshaller for PutVoiceConnectorLoggingConfiguration operation
    /// </summary>  
    public class PutVoiceConnectorLoggingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutVoiceConnectorLoggingConfigurationResponse response = new PutVoiceConnectorLoggingConfigurationResponse();
        ...
        private static PutVoiceConnectorLoggingConfigurationResponseUnmarshaller _instance = new PutVoiceConnectorLoggingConfigurationResponseUnmarshaller();        

        internal static PutVoiceConnectorLoggingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutVoiceConnectorLoggingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
