...
{
    /// <summary>
    /// Response Unmarshaller for CreateChannelBan operation
    /// </summary>  
    public class CreateChannelBanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateChannelBanResponse response = new CreateChannelBanResponse();
        ...
        private static CreateChannelBanResponseUnmarshaller _instance = new CreateChannelBanResponseUnmarshaller();        

        internal static CreateChannelBanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateChannelBanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
