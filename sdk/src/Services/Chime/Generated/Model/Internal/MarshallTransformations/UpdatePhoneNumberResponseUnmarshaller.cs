...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdatePhoneNumberResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePhoneNumberResponse response = new UpdatePhoneNumberResponse();
        ...
        internal static UpdatePhoneNumberResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePhoneNumberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
