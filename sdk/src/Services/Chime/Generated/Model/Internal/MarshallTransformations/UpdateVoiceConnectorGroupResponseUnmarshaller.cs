...
{
    /// <summary>
    /// Response Unmarshaller for UpdateVoiceConnectorGroup operation
    /// </summary>  
    public class UpdateVoiceConnectorGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateVoiceConnectorGroupResponse response = new UpdateVoiceConnectorGroupResponse();
        ...
        private static UpdateVoiceConnectorGroupResponseUnmarshaller _instance = new UpdateVoiceConnectorGroupResponseUnmarshaller();        

        internal static UpdateVoiceConnectorGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateVoiceConnectorGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
