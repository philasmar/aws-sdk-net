...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    public class ChannelModeratorSummaryUnmarshaller : IUnmarshaller<ChannelModeratorSummary, XmlUnmarshallerContext>, IUnmarshaller<ChannelModeratorSummary, JsonUnmarshallerContext>
    {
        ...
        private static ChannelModeratorSummaryUnmarshaller _instance = new ChannelModeratorSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ChannelModeratorSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
