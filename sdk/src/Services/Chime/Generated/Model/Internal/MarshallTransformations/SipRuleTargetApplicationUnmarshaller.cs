...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    public class SipRuleTargetApplicationUnmarshaller : IUnmarshaller<SipRuleTargetApplication, XmlUnmarshallerContext>, IUnmarshaller<SipRuleTargetApplication, JsonUnmarshallerContext>
    {
        ...
        private static SipRuleTargetApplicationUnmarshaller _instance = new SipRuleTargetApplicationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SipRuleTargetApplicationUnmarshaller Instance
        {
            get
            {
                return _instance;
