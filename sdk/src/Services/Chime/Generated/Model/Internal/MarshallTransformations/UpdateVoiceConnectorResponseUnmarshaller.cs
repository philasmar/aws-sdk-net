...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateVoiceConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateVoiceConnectorResponse response = new UpdateVoiceConnectorResponse();
        ...
        internal static UpdateVoiceConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateVoiceConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
