...
{
    /// <summary>
    /// Response Unmarshaller for DescribeChannelModerator operation
    /// </summary>  
    public class DescribeChannelModeratorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeChannelModeratorResponse response = new DescribeChannelModeratorResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = ChannelModeratorUnmarshaller.Instance;
        ...
        private static DescribeChannelModeratorResponseUnmarshaller _instance = new DescribeChannelModeratorResponseUnmarshaller();        

        internal static DescribeChannelModeratorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeChannelModeratorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
