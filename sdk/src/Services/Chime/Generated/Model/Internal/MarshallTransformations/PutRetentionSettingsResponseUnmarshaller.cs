...
{
    /// <summary>
    /// Response Unmarshaller for PutRetentionSettings operation
    /// </summary>  
    public class PutRetentionSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutRetentionSettingsResponse response = new PutRetentionSettingsResponse();
        ...
        private static PutRetentionSettingsResponseUnmarshaller _instance = new PutRetentionSettingsResponseUnmarshaller();        

        internal static PutRetentionSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutRetentionSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
