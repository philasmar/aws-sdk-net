...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreatePhoneNumberOrderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePhoneNumberOrderResponse response = new CreatePhoneNumberOrderResponse();
        ...
        internal static CreatePhoneNumberOrderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePhoneNumberOrderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
