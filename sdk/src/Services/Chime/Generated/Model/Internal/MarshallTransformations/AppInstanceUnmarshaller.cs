...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    public class AppInstanceUnmarshaller : IUnmarshaller<AppInstance, XmlUnmarshallerContext>, IUnmarshaller<AppInstance, JsonUnmarshallerContext>
    {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AppInstance Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            AppInstance unmarshalledObject = new AppInstance();
        ...
        private static AppInstanceUnmarshaller _instance = new AppInstanceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AppInstanceUnmarshaller Instance
        {
            get
            {
                return _instance;
