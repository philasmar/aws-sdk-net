...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePhoneNumberSettings operation
    /// </summary>  
    public class UpdatePhoneNumberSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePhoneNumberSettingsResponse response = new UpdatePhoneNumberSettingsResponse();
        ...
        private static UpdatePhoneNumberSettingsResponseUnmarshaller _instance = new UpdatePhoneNumberSettingsResponseUnmarshaller();        

        internal static UpdatePhoneNumberSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePhoneNumberSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
