...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteVoiceConnectorTerminationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVoiceConnectorTerminationResponse response = new DeleteVoiceConnectorTerminationResponse();
        ...
        internal static DeleteVoiceConnectorTerminationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVoiceConnectorTerminationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
