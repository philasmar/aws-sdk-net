...
{
    /// <summary>
    /// Response Unmarshaller for ListChannelsModeratedByAppInstanceUser operation
    /// </summary>  
    public class ListChannelsModeratedByAppInstanceUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListChannelsModeratedByAppInstanceUserResponse response = new ListChannelsModeratedByAppInstanceUserResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ChannelModeratedByAppInstanceUserSummary, ChannelModeratedByAppInstanceUserSummaryUnmarshaller>(ChannelModeratedByAppInstanceUserSummaryUnmarshaller.Instance);
        ...
        private static ListChannelsModeratedByAppInstanceUserResponseUnmarshaller _instance = new ListChannelsModeratedByAppInstanceUserResponseUnmarshaller();        

        internal static ListChannelsModeratedByAppInstanceUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListChannelsModeratedByAppInstanceUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
