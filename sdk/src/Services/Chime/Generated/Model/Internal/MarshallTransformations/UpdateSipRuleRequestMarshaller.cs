...
{
    /// <summary>
    /// UpdateSipRule Request Marshaller
    /// </summary>       
    public class UpdateSipRuleRequestMarshaller : IMarshaller<IRequest, UpdateSipRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateSipRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateSipRuleRequest publicRequest)
        {
        ...
        private static UpdateSipRuleRequestMarshaller _instance = new UpdateSipRuleRequestMarshaller();        

        internal static UpdateSipRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSipRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
