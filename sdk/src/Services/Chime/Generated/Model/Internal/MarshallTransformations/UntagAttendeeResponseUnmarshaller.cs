...
{
    /// <summary>
    /// Response Unmarshaller for UntagAttendee operation
    /// </summary>  
    public class UntagAttendeeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UntagAttendeeResponse response = new UntagAttendeeResponse();
        ...
        private static UntagAttendeeResponseUnmarshaller _instance = new UntagAttendeeResponseUnmarshaller();        

        internal static UntagAttendeeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagAttendeeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
