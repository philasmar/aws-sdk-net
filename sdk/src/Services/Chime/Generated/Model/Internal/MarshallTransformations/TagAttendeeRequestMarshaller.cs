...
{
    /// <summary>
    /// TagAttendee Request Marshaller
    /// </summary>       
    public class TagAttendeeRequestMarshaller : IMarshaller<IRequest, TagAttendeeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((TagAttendeeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(TagAttendeeRequest publicRequest)
        {
        ...
        private static TagAttendeeRequestMarshaller _instance = new TagAttendeeRequestMarshaller();        

        internal static TagAttendeeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagAttendeeRequestMarshaller Instance
        {
            get
            {
                return _instance;
