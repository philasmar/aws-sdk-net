...
{
    /// <summary>
    /// Response Unmarshaller for DisassociatePhoneNumbersFromVoiceConnector operation
    /// </summary>  
    public class DisassociatePhoneNumbersFromVoiceConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociatePhoneNumbersFromVoiceConnectorResponse response = new DisassociatePhoneNumbersFromVoiceConnectorResponse();
        ...
        private static DisassociatePhoneNumbersFromVoiceConnectorResponseUnmarshaller _instance = new DisassociatePhoneNumbersFromVoiceConnectorResponseUnmarshaller();        

        internal static DisassociatePhoneNumbersFromVoiceConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociatePhoneNumbersFromVoiceConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
