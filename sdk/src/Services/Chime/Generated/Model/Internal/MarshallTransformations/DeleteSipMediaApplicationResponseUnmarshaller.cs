...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSipMediaApplication operation
    /// </summary>  
    public class DeleteSipMediaApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSipMediaApplicationResponse response = new DeleteSipMediaApplicationResponse();
        ...
        private static DeleteSipMediaApplicationResponseUnmarshaller _instance = new DeleteSipMediaApplicationResponseUnmarshaller();        

        internal static DeleteSipMediaApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSipMediaApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
