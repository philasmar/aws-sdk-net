...
{
    /// <summary>
    /// Response Unmarshaller for DisassociatePhoneNumberFromUser operation
    /// </summary>  
    public class DisassociatePhoneNumberFromUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociatePhoneNumberFromUserResponse response = new DisassociatePhoneNumberFromUserResponse();
        ...
        private static DisassociatePhoneNumberFromUserResponseUnmarshaller _instance = new DisassociatePhoneNumberFromUserResponseUnmarshaller();        

        internal static DisassociatePhoneNumberFromUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociatePhoneNumberFromUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
