...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    public class AppInstanceUserUnmarshaller : IUnmarshaller<AppInstanceUser, XmlUnmarshallerContext>, IUnmarshaller<AppInstanceUser, JsonUnmarshallerContext>
    {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AppInstanceUser Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            AppInstanceUser unmarshalledObject = new AppInstanceUser();
        ...
        private static AppInstanceUserUnmarshaller _instance = new AppInstanceUserUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AppInstanceUserUnmarshaller Instance
        {
            get
            {
                return _instance;
