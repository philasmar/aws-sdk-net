...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListChannelMembershipsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListChannelMembershipsResponse response = new ListChannelMembershipsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ChannelMembershipSummary, ChannelMembershipSummaryUnmarshaller>(ChannelMembershipSummaryUnmarshaller.Instance);
        ...
        internal static ListChannelMembershipsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListChannelMembershipsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
