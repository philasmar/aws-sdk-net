...
{
    /// <summary>
    /// Response Unmarshaller for ListAttendees operation
    /// </summary>  
    public class ListAttendeesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAttendeesResponse response = new ListAttendeesResponse();
        ...
        private static ListAttendeesResponseUnmarshaller _instance = new ListAttendeesResponseUnmarshaller();        

        internal static ListAttendeesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAttendeesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
