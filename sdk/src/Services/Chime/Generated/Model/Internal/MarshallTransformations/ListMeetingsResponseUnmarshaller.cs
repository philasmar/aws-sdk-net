...
{
    /// <summary>
    /// Response Unmarshaller for ListMeetings operation
    /// </summary>  
    public class ListMeetingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMeetingsResponse response = new ListMeetingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Meeting, MeetingUnmarshaller>(MeetingUnmarshaller.Instance);
                    response.Meetings = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListMeetingsResponseUnmarshaller _instance = new ListMeetingsResponseUnmarshaller();        

        internal static ListMeetingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMeetingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
