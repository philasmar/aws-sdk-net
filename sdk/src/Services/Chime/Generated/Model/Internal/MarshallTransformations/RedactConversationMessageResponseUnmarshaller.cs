...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RedactConversationMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RedactConversationMessageResponse response = new RedactConversationMessageResponse();
        ...
        internal static RedactConversationMessageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RedactConversationMessageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
