...
{
    /// <summary>
    /// Response Unmarshaller for GetChannelMessage operation
    /// </summary>  
    public class GetChannelMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetChannelMessageResponse response = new GetChannelMessageResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = ChannelMessageUnmarshaller.Instance;
                    response.ChannelMessage = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetChannelMessageResponseUnmarshaller _instance = new GetChannelMessageResponseUnmarshaller();        

        internal static GetChannelMessageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetChannelMessageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
