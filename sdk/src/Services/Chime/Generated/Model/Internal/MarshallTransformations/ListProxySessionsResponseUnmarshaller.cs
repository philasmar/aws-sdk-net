...
{
    /// <summary>
    /// Response Unmarshaller for ListProxySessions operation
    /// </summary>  
    public class ListProxySessionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListProxySessionsResponse response = new ListProxySessionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ProxySession, ProxySessionUnmarshaller>(ProxySessionUnmarshaller.Instance);
                    response.ProxySessions = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListProxySessionsResponseUnmarshaller _instance = new ListProxySessionsResponseUnmarshaller();        

        internal static ListProxySessionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListProxySessionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
