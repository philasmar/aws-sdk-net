...
{
    /// <summary>
    /// Response Unmarshaller for RestorePhoneNumber operation
    /// </summary>  
    public class RestorePhoneNumberResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RestorePhoneNumberResponse response = new RestorePhoneNumberResponse();
        ...
        private static RestorePhoneNumberResponseUnmarshaller _instance = new RestorePhoneNumberResponseUnmarshaller();        

        internal static RestorePhoneNumberResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestorePhoneNumberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
