...
{
    /// <summary>
    /// Response Unmarshaller for TagAttendee operation
    /// </summary>  
    public class TagAttendeeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TagAttendeeResponse response = new TagAttendeeResponse();
        ...
        private static TagAttendeeResponseUnmarshaller _instance = new TagAttendeeResponseUnmarshaller();        

        internal static TagAttendeeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagAttendeeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
