...
{
    /// <summary>
    /// Response Unmarshaller for ListPhoneNumbers operation
    /// </summary>  
    public class ListPhoneNumbersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListPhoneNumbersResponseUnmarshaller _instance = new ListPhoneNumbersResponseUnmarshaller();        

        internal static ListPhoneNumbersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPhoneNumbersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
