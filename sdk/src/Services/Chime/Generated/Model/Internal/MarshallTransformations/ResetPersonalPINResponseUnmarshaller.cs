...
{
    /// <summary>
    /// Response Unmarshaller for ResetPersonalPIN operation
    /// </summary>  
    public class ResetPersonalPINResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ResetPersonalPINResponse response = new ResetPersonalPINResponse();
        ...
        private static ResetPersonalPINResponseUnmarshaller _instance = new ResetPersonalPINResponseUnmarshaller();        

        internal static ResetPersonalPINResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResetPersonalPINResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
