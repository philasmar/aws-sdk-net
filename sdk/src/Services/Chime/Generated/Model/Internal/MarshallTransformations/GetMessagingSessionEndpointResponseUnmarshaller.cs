...
{
    /// <summary>
    /// Response Unmarshaller for GetMessagingSessionEndpoint operation
    /// </summary>  
    public class GetMessagingSessionEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMessagingSessionEndpointResponse response = new GetMessagingSessionEndpointResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = MessagingSessionEndpointUnmarshaller.Instance;
        ...
        private static GetMessagingSessionEndpointResponseUnmarshaller _instance = new GetMessagingSessionEndpointResponseUnmarshaller();        

        internal static GetMessagingSessionEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMessagingSessionEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
