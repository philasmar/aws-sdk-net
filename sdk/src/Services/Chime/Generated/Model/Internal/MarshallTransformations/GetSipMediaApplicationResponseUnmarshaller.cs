...
{
    /// <summary>
    /// Response Unmarshaller for GetSipMediaApplication operation
    /// </summary>  
    public class GetSipMediaApplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSipMediaApplicationResponse response = new GetSipMediaApplicationResponse();
        ...
        private static GetSipMediaApplicationResponseUnmarshaller _instance = new GetSipMediaApplicationResponseUnmarshaller();        

        internal static GetSipMediaApplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSipMediaApplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
