...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVoiceConnectorStreamingConfiguration operation
    /// </summary>  
    public class DeleteVoiceConnectorStreamingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVoiceConnectorStreamingConfigurationResponse response = new DeleteVoiceConnectorStreamingConfigurationResponse();
        ...
        private static DeleteVoiceConnectorStreamingConfigurationResponseUnmarshaller _instance = new DeleteVoiceConnectorStreamingConfigurationResponseUnmarshaller();        

        internal static DeleteVoiceConnectorStreamingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVoiceConnectorStreamingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
