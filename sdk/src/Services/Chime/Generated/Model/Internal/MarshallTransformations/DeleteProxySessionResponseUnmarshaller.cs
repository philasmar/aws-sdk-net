...
{
    /// <summary>
    /// Response Unmarshaller for DeleteProxySession operation
    /// </summary>  
    public class DeleteProxySessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteProxySessionResponse response = new DeleteProxySessionResponse();
        ...
        private static DeleteProxySessionResponseUnmarshaller _instance = new DeleteProxySessionResponseUnmarshaller();        

        internal static DeleteProxySessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteProxySessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
