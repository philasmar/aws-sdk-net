...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RedactRoomMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RedactRoomMessageResponse response = new RedactRoomMessageResponse();
        ...
        internal static RedactRoomMessageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RedactRoomMessageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
