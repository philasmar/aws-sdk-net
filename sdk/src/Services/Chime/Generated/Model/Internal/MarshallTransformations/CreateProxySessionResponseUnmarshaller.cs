...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    public class CreateProxySessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateProxySessionResponseUnmarshaller _instance = new CreateProxySessionResponseUnmarshaller();        

        internal static CreateProxySessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProxySessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
