...
{
    /// <summary>
    /// Response Unmarshaller for CreateRoomMembership operation
    /// </summary>  
    public class CreateRoomMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRoomMembershipResponse response = new CreateRoomMembershipResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = RoomMembershipUnmarshaller.Instance;
                    response.RoomMembership = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateRoomMembershipResponseUnmarshaller _instance = new CreateRoomMembershipResponseUnmarshaller();        

        internal static CreateRoomMembershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRoomMembershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
