...
{
    /// <summary>
    /// Response Unmarshaller for CreateChannelMembership operation
    /// </summary>  
    public class CreateChannelMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateChannelMembershipResponse response = new CreateChannelMembershipResponse();
        ...
        private static CreateChannelMembershipResponseUnmarshaller _instance = new CreateChannelMembershipResponseUnmarshaller();        

        internal static CreateChannelMembershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateChannelMembershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
