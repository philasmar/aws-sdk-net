...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRoomMembership operation
    /// </summary>  
    public class UpdateRoomMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRoomMembershipResponse response = new UpdateRoomMembershipResponse();
        ...
        private static UpdateRoomMembershipResponseUnmarshaller _instance = new UpdateRoomMembershipResponseUnmarshaller();        

        internal static UpdateRoomMembershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRoomMembershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
