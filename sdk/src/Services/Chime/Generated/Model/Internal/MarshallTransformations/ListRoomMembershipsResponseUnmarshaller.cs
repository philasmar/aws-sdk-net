...
{
    /// <summary>
    /// Response Unmarshaller for ListRoomMemberships operation
    /// </summary>  
    public class ListRoomMembershipsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRoomMembershipsResponse response = new ListRoomMembershipsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RoomMembership, RoomMembershipUnmarshaller>(RoomMembershipUnmarshaller.Instance);
                    response.RoomMemberships = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListRoomMembershipsResponseUnmarshaller _instance = new ListRoomMembershipsResponseUnmarshaller();        

        internal static ListRoomMembershipsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRoomMembershipsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
