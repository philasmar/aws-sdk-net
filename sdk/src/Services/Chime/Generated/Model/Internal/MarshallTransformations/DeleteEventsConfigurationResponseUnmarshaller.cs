...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteEventsConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteEventsConfigurationResponse response = new DeleteEventsConfigurationResponse();
        ...
        internal static DeleteEventsConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEventsConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
