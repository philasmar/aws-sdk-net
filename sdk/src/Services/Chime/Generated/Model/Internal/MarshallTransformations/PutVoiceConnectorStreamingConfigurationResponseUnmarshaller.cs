...
{
    /// <summary>
    /// Response Unmarshaller for PutVoiceConnectorStreamingConfiguration operation
    /// </summary>  
    public class PutVoiceConnectorStreamingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutVoiceConnectorStreamingConfigurationResponse response = new PutVoiceConnectorStreamingConfigurationResponse();
        ...
        private static PutVoiceConnectorStreamingConfigurationResponseUnmarshaller _instance = new PutVoiceConnectorStreamingConfigurationResponseUnmarshaller();        

        internal static PutVoiceConnectorStreamingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutVoiceConnectorStreamingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
