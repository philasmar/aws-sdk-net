...
{
    /// <summary>
    /// Response Unmarshaller for RegenerateSecurityToken operation
    /// </summary>  
    public class RegenerateSecurityTokenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegenerateSecurityTokenResponse response = new RegenerateSecurityTokenResponse();
        ...
        private static RegenerateSecurityTokenResponseUnmarshaller _instance = new RegenerateSecurityTokenResponseUnmarshaller();        

        internal static RegenerateSecurityTokenResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegenerateSecurityTokenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
