...
{
    /// <summary>
    /// Response Unmarshaller for ListChannelBans operation
    /// </summary>  
    public class ListChannelBansResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListChannelBansResponse response = new ListChannelBansResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ChannelBanSummary, ChannelBanSummaryUnmarshaller>(ChannelBanSummaryUnmarshaller.Instance);
                    response.ChannelBans = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListChannelBansResponseUnmarshaller _instance = new ListChannelBansResponseUnmarshaller();        

        internal static ListChannelBansResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListChannelBansResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
