...
{
    /// <summary>
    /// Response Unmarshaller for GetMeeting operation
    /// </summary>  
    public class GetMeetingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetMeetingResponseUnmarshaller _instance = new GetMeetingResponseUnmarshaller();        

        internal static GetMeetingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMeetingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
