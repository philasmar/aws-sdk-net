...
{
    /// <summary>
    /// Response Unmarshaller for ListMeetingTags operation
    /// </summary>  
    public class ListMeetingTagsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMeetingTagsResponse response = new ListMeetingTagsResponse();
        ...
        private static ListMeetingTagsResponseUnmarshaller _instance = new ListMeetingTagsResponseUnmarshaller();        

        internal static ListMeetingTagsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMeetingTagsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
