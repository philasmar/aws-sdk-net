...
{
    /// <summary>
    /// Response Unmarshaller for DescribeChannelMembershipForAppInstanceUser operation
    /// </summary>  
    public class DescribeChannelMembershipForAppInstanceUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeChannelMembershipForAppInstanceUserResponse response = new DescribeChannelMembershipForAppInstanceUserResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = ChannelMembershipForAppInstanceUserSummaryUnmarshaller.Instance;
        ...
        private static DescribeChannelMembershipForAppInstanceUserResponseUnmarshaller _instance = new DescribeChannelMembershipForAppInstanceUserResponseUnmarshaller();        

        internal static DescribeChannelMembershipForAppInstanceUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeChannelMembershipForAppInstanceUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
