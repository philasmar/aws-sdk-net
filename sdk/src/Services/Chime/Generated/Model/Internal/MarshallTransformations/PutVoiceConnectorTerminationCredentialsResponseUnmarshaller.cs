...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutVoiceConnectorTerminationCredentialsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutVoiceConnectorTerminationCredentialsResponse response = new PutVoiceConnectorTerminationCredentialsResponse();
        ...
        internal static PutVoiceConnectorTerminationCredentialsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutVoiceConnectorTerminationCredentialsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
