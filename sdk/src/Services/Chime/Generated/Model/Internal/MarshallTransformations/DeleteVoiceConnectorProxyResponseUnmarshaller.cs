...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteVoiceConnectorProxyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVoiceConnectorProxyResponse response = new DeleteVoiceConnectorProxyResponse();
        ...
        internal static DeleteVoiceConnectorProxyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVoiceConnectorProxyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
