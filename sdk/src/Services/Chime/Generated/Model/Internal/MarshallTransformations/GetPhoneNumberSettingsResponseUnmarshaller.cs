...
{
    /// <summary>
    /// Response Unmarshaller for GetPhoneNumberSettings operation
    /// </summary>  
    public class GetPhoneNumberSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPhoneNumberSettingsResponse response = new GetPhoneNumberSettingsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CallingName", targetDepth))
                {
                    ...
                    response.CallingName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("CallingNameUpdatedTimestamp", targetDepth))
                {
                    var unmarshaller = DateTimeUnmarshaller.Instance;
                    response.CallingNameUpdatedTimestamp = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetPhoneNumberSettingsResponseUnmarshaller _instance = new GetPhoneNumberSettingsResponseUnmarshaller();        

        internal static GetPhoneNumberSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPhoneNumberSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
