...
{
    /// <summary>
    /// DeleteRoomMembership Request Marshaller
    /// </summary>       
    public class DeleteRoomMembershipRequestMarshaller : IMarshaller<IRequest, DeleteRoomMembershipRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteRoomMembershipRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteRoomMembershipRequest publicRequest)
        {
        ...
        private static DeleteRoomMembershipRequestMarshaller _instance = new DeleteRoomMembershipRequestMarshaller();        

        internal static DeleteRoomMembershipRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRoomMembershipRequestMarshaller Instance
        {
            get
            {
                return _instance;
