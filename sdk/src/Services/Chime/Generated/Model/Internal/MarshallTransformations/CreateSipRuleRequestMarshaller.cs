...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    public class CreateSipRuleRequestMarshaller : IMarshaller<IRequest, CreateSipRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateSipRuleRequest publicRequest)
        {
        ...
        private static CreateSipRuleRequestMarshaller _instance = new CreateSipRuleRequestMarshaller();        

        internal static CreateSipRuleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSipRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
