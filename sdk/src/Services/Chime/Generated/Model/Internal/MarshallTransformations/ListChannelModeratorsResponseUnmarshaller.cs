...
{
    /// <summary>
    /// Response Unmarshaller for ListChannelModerators operation
    /// </summary>  
    public class ListChannelModeratorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListChannelModeratorsResponse response = new ListChannelModeratorsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("ChannelModerators", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<ChannelModeratorSummary, ChannelModeratorSummaryUnmarshaller>(ChannelModeratorSummaryUnmarshaller.Instance);
                    response.ChannelModerators = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListChannelModeratorsResponseUnmarshaller _instance = new ListChannelModeratorsResponseUnmarshaller();        

        internal static ListChannelModeratorsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListChannelModeratorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
