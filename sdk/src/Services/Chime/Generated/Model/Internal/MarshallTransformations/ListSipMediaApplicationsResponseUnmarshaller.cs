...
{
    /// <summary>
    /// Response Unmarshaller for ListSipMediaApplications operation
    /// </summary>  
    public class ListSipMediaApplicationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSipMediaApplicationsResponse response = new ListSipMediaApplicationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("SipMediaApplications", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<SipMediaApplication, SipMediaApplicationUnmarshaller>(SipMediaApplicationUnmarshaller.Instance);
                    response.SipMediaApplications = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListSipMediaApplicationsResponseUnmarshaller _instance = new ListSipMediaApplicationsResponseUnmarshaller();        

        internal static ListSipMediaApplicationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSipMediaApplicationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
