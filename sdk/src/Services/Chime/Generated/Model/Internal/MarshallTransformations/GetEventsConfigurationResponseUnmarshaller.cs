...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetEventsConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEventsConfigurationResponse response = new GetEventsConfigurationResponse();
        ...
        internal static GetEventsConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEventsConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
