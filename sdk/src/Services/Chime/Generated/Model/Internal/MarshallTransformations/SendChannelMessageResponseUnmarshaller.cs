...
{
    /// <summary>
    /// Response Unmarshaller for SendChannelMessage operation
    /// </summary>  
    public class SendChannelMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendChannelMessageResponse response = new SendChannelMessageResponse();
        ...
        private static SendChannelMessageResponseUnmarshaller _instance = new SendChannelMessageResponseUnmarshaller();        

        internal static SendChannelMessageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendChannelMessageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
