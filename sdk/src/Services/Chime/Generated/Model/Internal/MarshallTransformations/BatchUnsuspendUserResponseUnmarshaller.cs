...
{
    /// <summary>
    /// Response Unmarshaller for BatchUnsuspendUser operation
    /// </summary>  
    public class BatchUnsuspendUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchUnsuspendUserResponse response = new BatchUnsuspendUserResponse();
        ...
        private static BatchUnsuspendUserResponseUnmarshaller _instance = new BatchUnsuspendUserResponseUnmarshaller();        

        internal static BatchUnsuspendUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchUnsuspendUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
