...
{
    /// <summary>
    /// Response Unmarshaller for UntagMeeting operation
    /// </summary>  
    public class UntagMeetingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UntagMeetingResponse response = new UntagMeetingResponse();
        ...
        private static UntagMeetingResponseUnmarshaller _instance = new UntagMeetingResponseUnmarshaller();        

        internal static UntagMeetingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagMeetingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
