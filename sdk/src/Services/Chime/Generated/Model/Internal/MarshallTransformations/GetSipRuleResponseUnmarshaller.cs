...
{
    /// <summary>
    /// Response Unmarshaller for GetSipRule operation
    /// </summary>  
    public class GetSipRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSipRuleResponse response = new GetSipRuleResponse();
        ...
        private static GetSipRuleResponseUnmarshaller _instance = new GetSipRuleResponseUnmarshaller();        

        internal static GetSipRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSipRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
