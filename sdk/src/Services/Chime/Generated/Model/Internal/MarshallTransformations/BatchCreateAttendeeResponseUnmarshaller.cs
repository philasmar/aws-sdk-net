...
{
    /// <summary>
    /// Response Unmarshaller for BatchCreateAttendee operation
    /// </summary>  
    public class BatchCreateAttendeeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchCreateAttendeeResponse response = new BatchCreateAttendeeResponse();
        ...
        private static BatchCreateAttendeeResponseUnmarshaller _instance = new BatchCreateAttendeeResponseUnmarshaller();        

        internal static BatchCreateAttendeeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchCreateAttendeeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
