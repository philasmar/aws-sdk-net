...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetVoiceConnectorOriginationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetVoiceConnectorOriginationResponse response = new GetVoiceConnectorOriginationResponse();
        ...
        internal static GetVoiceConnectorOriginationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVoiceConnectorOriginationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
