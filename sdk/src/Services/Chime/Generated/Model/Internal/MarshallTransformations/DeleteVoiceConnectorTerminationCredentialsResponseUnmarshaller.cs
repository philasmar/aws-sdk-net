...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVoiceConnectorTerminationCredentials operation
    /// </summary>  
    public class DeleteVoiceConnectorTerminationCredentialsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVoiceConnectorTerminationCredentialsResponse response = new DeleteVoiceConnectorTerminationCredentialsResponse();
        ...
        private static DeleteVoiceConnectorTerminationCredentialsResponseUnmarshaller _instance = new DeleteVoiceConnectorTerminationCredentialsResponseUnmarshaller();        

        internal static DeleteVoiceConnectorTerminationCredentialsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVoiceConnectorTerminationCredentialsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
