...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeletePhoneNumberResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePhoneNumberResponse response = new DeletePhoneNumberResponse();
        ...
        internal static DeletePhoneNumberResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePhoneNumberResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
