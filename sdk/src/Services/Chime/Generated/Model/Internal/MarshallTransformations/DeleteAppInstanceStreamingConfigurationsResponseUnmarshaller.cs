...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAppInstanceStreamingConfigurations operation
    /// </summary>  
    public class DeleteAppInstanceStreamingConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAppInstanceStreamingConfigurationsResponse response = new DeleteAppInstanceStreamingConfigurationsResponse();
        ...
        private static DeleteAppInstanceStreamingConfigurationsResponseUnmarshaller _instance = new DeleteAppInstanceStreamingConfigurationsResponseUnmarshaller();        

        internal static DeleteAppInstanceStreamingConfigurationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAppInstanceStreamingConfigurationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
