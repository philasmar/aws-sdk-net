...
{
    /// <summary>
    /// Response Unmarshaller for InviteUsers operation
    /// </summary>  
    public class InviteUsersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            InviteUsersResponse response = new InviteUsersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Invite, InviteUnmarshaller>(InviteUnmarshaller.Instance);
                    response.Invites = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static InviteUsersResponseUnmarshaller _instance = new InviteUsersResponseUnmarshaller();        

        internal static InviteUsersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InviteUsersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
