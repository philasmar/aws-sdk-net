...
{
    /// <summary>
    /// Response Unmarshaller for GetVoiceConnector operation
    /// </summary>  
    public class GetVoiceConnectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetVoiceConnectorResponse response = new GetVoiceConnectorResponse();
        ...
        private static GetVoiceConnectorResponseUnmarshaller _instance = new GetVoiceConnectorResponseUnmarshaller();        

        internal static GetVoiceConnectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVoiceConnectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
