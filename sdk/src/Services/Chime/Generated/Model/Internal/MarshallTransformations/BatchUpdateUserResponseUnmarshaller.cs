...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchUpdateUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchUpdateUserResponse response = new BatchUpdateUserResponse();
        ...
        internal static BatchUpdateUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchUpdateUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
