        ...
        public Proxy Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DefaultSessionExpiryMinutes", targetDepth))
                {
                    ...
                    unmarshalledObject.DefaultSessionExpiryMinutes = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("FallBackPhoneNumber", targetDepth))
                {
                    ...
                    unmarshalledObject.FallBackPhoneNumber = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("PhoneNumberCountries", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.PhoneNumberCountries = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
