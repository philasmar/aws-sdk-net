...
{
    /// <summary>
    /// Response Unmarshaller for ListAttendeeTags operation
    /// </summary>  
    public class ListAttendeeTagsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAttendeeTagsResponse response = new ListAttendeeTagsResponse();
        ...
        private static ListAttendeeTagsResponseUnmarshaller _instance = new ListAttendeeTagsResponseUnmarshaller();        

        internal static ListAttendeeTagsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAttendeeTagsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
