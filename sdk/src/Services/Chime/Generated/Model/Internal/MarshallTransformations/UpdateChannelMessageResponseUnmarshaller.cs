...
namespace Amazon.Chime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateChannelMessageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateChannelMessageResponse response = new UpdateChannelMessageResponse();
        ...
        internal static UpdateChannelMessageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateChannelMessageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
