...
{
    /// <summary>
    /// Response Unmarshaller for GetVoiceConnectorLoggingConfiguration operation
    /// </summary>  
    public class GetVoiceConnectorLoggingConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetVoiceConnectorLoggingConfigurationResponse response = new GetVoiceConnectorLoggingConfigurationResponse();
        ...
        private static GetVoiceConnectorLoggingConfigurationResponseUnmarshaller _instance = new GetVoiceConnectorLoggingConfigurationResponseUnmarshaller();        

        internal static GetVoiceConnectorLoggingConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVoiceConnectorLoggingConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
