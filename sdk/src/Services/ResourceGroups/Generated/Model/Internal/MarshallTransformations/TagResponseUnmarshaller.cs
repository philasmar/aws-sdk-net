...
{
    /// <summary>
    /// Response Unmarshaller for Tag operation
    /// </summary>  
    public class TagResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static TagResponseUnmarshaller _instance = new TagResponseUnmarshaller();        

        internal static TagResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
