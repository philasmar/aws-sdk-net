...
{
    /// <summary>
    /// GroupResources Request Marshaller
    /// </summary>       
    public class GroupResourcesRequestMarshaller : IMarshaller<IRequest, GroupResourcesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GroupResourcesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GroupResourcesRequest publicRequest)
        {
        ...
        private static GroupResourcesRequestMarshaller _instance = new GroupResourcesRequestMarshaller();        

        internal static GroupResourcesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GroupResourcesRequestMarshaller Instance
        {
            get
            {
                return _instance;
