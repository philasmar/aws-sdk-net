...
{
    /// <summary>
    /// Response Unmarshaller for UpdateGroupQuery operation
    /// </summary>  
    public class UpdateGroupQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateGroupQueryResponse response = new UpdateGroupQueryResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = GroupQueryUnmarshaller.Instance;
                    response.GroupQuery = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static UpdateGroupQueryResponseUnmarshaller _instance = new UpdateGroupQueryResponseUnmarshaller();        

        internal static UpdateGroupQueryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGroupQueryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
