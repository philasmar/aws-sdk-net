...
{
    /// <summary>
    /// Response Unmarshaller for GetGroupQuery operation
    /// </summary>  
    public class GetGroupQueryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGroupQueryResponse response = new GetGroupQueryResponse();
        ...
        private static GetGroupQueryResponseUnmarshaller _instance = new GetGroupQueryResponseUnmarshaller();        

        internal static GetGroupQueryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGroupQueryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
