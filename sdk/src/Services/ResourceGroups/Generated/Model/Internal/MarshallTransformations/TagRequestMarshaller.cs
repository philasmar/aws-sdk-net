...
{
    /// <summary>
    /// Tag Request Marshaller
    /// </summary>       
    public class TagRequestMarshaller : IMarshaller<IRequest, TagRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((TagRequest)input);
        }
        ...
        private static TagRequestMarshaller _instance = new TagRequestMarshaller();        

        internal static TagRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagRequestMarshaller Instance
        {
            get
            {
                return _instance;
