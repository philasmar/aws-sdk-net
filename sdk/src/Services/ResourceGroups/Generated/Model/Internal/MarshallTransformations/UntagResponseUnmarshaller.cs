...
{
    /// <summary>
    /// Response Unmarshaller for Untag operation
    /// </summary>  
    public class UntagResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UntagResponseUnmarshaller _instance = new UntagResponseUnmarshaller();        

        internal static UntagResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
