...
{
    /// <summary>
    /// Response Unmarshaller for GetTranscript operation
    /// </summary>  
    public class GetTranscriptResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("InitialContactId", targetDepth))
                {
                    ...
                    response.InitialContactId = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("Transcript", targetDepth))
                {
                    ...
                    response.Transcript = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetTranscriptResponseUnmarshaller _instance = new GetTranscriptResponseUnmarshaller();        

        internal static GetTranscriptResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTranscriptResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
