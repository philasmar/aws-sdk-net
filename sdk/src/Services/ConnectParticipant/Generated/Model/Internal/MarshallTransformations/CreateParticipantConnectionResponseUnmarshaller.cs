...
{
    /// <summary>
    /// Response Unmarshaller for CreateParticipantConnection operation
    /// </summary>  
    public class CreateParticipantConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateParticipantConnectionResponse response = new CreateParticipantConnectionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("Websocket", targetDepth))
                {
                    ...
                    response.Websocket = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateParticipantConnectionResponseUnmarshaller _instance = new CreateParticipantConnectionResponseUnmarshaller();        

        internal static CreateParticipantConnectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateParticipantConnectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
