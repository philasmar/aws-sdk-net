...
{
    /// <summary>
    /// Response Unmarshaller for StartAttachmentUpload operation
    /// </summary>  
    public class StartAttachmentUploadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartAttachmentUploadResponse response = new StartAttachmentUploadResponse();
        ...
        private static StartAttachmentUploadResponseUnmarshaller _instance = new StartAttachmentUploadResponseUnmarshaller();        

        internal static StartAttachmentUploadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartAttachmentUploadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
