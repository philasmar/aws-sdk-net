...
{
    /// <summary>
    /// Response Unmarshaller for CreateResolverRule operation
    /// </summary>  
    public class CreateResolverRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateResolverRuleResponse response = new CreateResolverRuleResponse();
        ...
        private static CreateResolverRuleResponseUnmarshaller _instance = new CreateResolverRuleResponseUnmarshaller();        

        internal static CreateResolverRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateResolverRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
