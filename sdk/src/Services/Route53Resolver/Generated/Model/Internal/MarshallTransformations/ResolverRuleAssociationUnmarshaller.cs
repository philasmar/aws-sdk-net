...
namespace Amazon.Route53Resolver.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResolverRuleAssociationUnmarshaller : IUnmarshaller<ResolverRuleAssociation, XmlUnmarshallerContext>, IUnmarshaller<ResolverRuleAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ResolverRuleAssociation IUnmarshaller<ResolverRuleAssociation, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ResolverRuleAssociation Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ResolverRuleId = unmarshaller.Unmarshall(context);
                    continue;
                }
