...
namespace Amazon.Route53Resolver.Model
{
    ...
    internal sealed partial class ListResolverQueryLogConfigsPaginator : IPaginator<ListResolverQueryLogConfigsResponse>, IListResolverQueryLogConfigsPaginator
    {
        ...
        public IPaginatedEnumerable<ResolverQueryLogConfig> ResolverQueryLogConfigs => 
            new PaginatedResultKeyResponse<ListResolverQueryLogConfigsResponse, ResolverQueryLogConfig>(this, (i) => i.ResolverQueryLogConfigs);
        ...
        async IAsyncEnumerable<ListResolverQueryLogConfigsResponse> IPaginator<ListResolverQueryLogConfigsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
