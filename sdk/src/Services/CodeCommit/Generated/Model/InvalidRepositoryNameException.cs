...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class InvalidRepositoryNameException : AmazonCodeCommitException
    {
        ...
        public InvalidRepositoryNameException(string message, Exception innerException) 
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public InvalidRepositoryNameException(Exception innerException) 
            : base(innerException) {}
        ...
        public InvalidRepositoryNameException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected InvalidRepositoryNameException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
