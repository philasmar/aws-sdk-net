...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetApprovalRuleTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetApprovalRuleTemplateResponse response = new GetApprovalRuleTemplateResponse();
        ...
        private static GetApprovalRuleTemplateResponseUnmarshaller _instance = new GetApprovalRuleTemplateResponseUnmarshaller();        

        internal static GetApprovalRuleTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetApprovalRuleTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
