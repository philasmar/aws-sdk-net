...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetMergeCommitResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMergeCommitResponse response = new GetMergeCommitResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.MergedCommitId = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetMergeCommitResponseUnmarshaller _instance = new GetMergeCommitResponseUnmarshaller();        

        internal static GetMergeCommitResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMergeCommitResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
