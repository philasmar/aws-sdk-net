...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeMergeConflictsRequestMarshaller : IMarshaller<IRequest, DescribeMergeConflictsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeMergeConflictsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeMergeConflictsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodeCommit");
            string target = "CodeCommit_20150413.DescribeMergeConflicts";
        ...
        private static DescribeMergeConflictsRequestMarshaller _instance = new DescribeMergeConflictsRequestMarshaller();        

        internal static DescribeMergeConflictsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMergeConflictsRequestMarshaller Instance
        {
            get
            {
                return _instance;
