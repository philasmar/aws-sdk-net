...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeMergeConflictsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeMergeConflictsResponse response = new DescribeMergeConflictsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("conflictMetadata", targetDepth))
                {
                    ...
                    response.ConflictMetadata = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("mergeHunks", targetDepth))
                {
                    ...
                    response.MergeHunks = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeMergeConflictsResponseUnmarshaller _instance = new DescribeMergeConflictsResponseUnmarshaller();        

        internal static DescribeMergeConflictsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMergeConflictsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
