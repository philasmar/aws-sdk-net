...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateUnreferencedMergeCommitRequestMarshaller : IMarshaller<IRequest, CreateUnreferencedMergeCommitRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateUnreferencedMergeCommitRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateUnreferencedMergeCommitRequest publicRequest)
        {
        ...
        private static CreateUnreferencedMergeCommitRequestMarshaller _instance = new CreateUnreferencedMergeCommitRequestMarshaller();        

        internal static CreateUnreferencedMergeCommitRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateUnreferencedMergeCommitRequestMarshaller Instance
        {
            get
            {
                return _instance;
