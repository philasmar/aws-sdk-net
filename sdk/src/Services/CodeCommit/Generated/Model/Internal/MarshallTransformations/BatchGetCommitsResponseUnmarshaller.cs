...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchGetCommitsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetCommitsResponse response = new BatchGetCommitsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Commit, CommitUnmarshaller>(CommitUnmarshaller.Instance);
                    response.Commits = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("errors", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<BatchGetCommitsError, BatchGetCommitsErrorUnmarshaller>(BatchGetCommitsErrorUnmarshaller.Instance);
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("CommitIdsLimitExceededException"))
                {
                    return CommitIdsLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("CommitIdsListRequiredException"))
                {
                    return CommitIdsListRequiredExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static BatchGetCommitsResponseUnmarshaller _instance = new BatchGetCommitsResponseUnmarshaller();        

        internal static BatchGetCommitsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetCommitsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
