...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListPullRequestsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPullRequestsResponse response = new ListPullRequestsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("pullRequestIds", targetDepth))
                {
                    ...
                    response.PullRequestIds = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("AuthorDoesNotExistException"))
                {
                    return AuthorDoesNotExistExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidAuthorArnException"))
                {
                    return InvalidAuthorArnExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static ListPullRequestsResponseUnmarshaller _instance = new ListPullRequestsResponseUnmarshaller();        

        internal static ListPullRequestsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPullRequestsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
