...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PostCommentForComparedCommitRequestMarshaller : IMarshaller<IRequest, PostCommentForComparedCommitRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PostCommentForComparedCommitRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PostCommentForComparedCommitRequest publicRequest)
        {
        ...
        private static PostCommentForComparedCommitRequestMarshaller _instance = new PostCommentForComparedCommitRequestMarshaller();        

        internal static PostCommentForComparedCommitRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PostCommentForComparedCommitRequestMarshaller Instance
        {
            get
            {
                return _instance;
