...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetMergeOptionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMergeOptionsResponse response = new GetMergeOptionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("mergeOptions", targetDepth))
                {
                    ...
                    response.MergeOptions = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetMergeOptionsResponseUnmarshaller _instance = new GetMergeOptionsResponseUnmarshaller();        

        internal static GetMergeOptionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMergeOptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
