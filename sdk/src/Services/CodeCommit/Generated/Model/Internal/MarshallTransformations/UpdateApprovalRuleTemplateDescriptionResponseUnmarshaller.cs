...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateApprovalRuleTemplateDescriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateApprovalRuleTemplateDescriptionResponse response = new UpdateApprovalRuleTemplateDescriptionResponse();
        ...
        private static UpdateApprovalRuleTemplateDescriptionResponseUnmarshaller _instance = new UpdateApprovalRuleTemplateDescriptionResponseUnmarshaller();        

        internal static UpdateApprovalRuleTemplateDescriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateApprovalRuleTemplateDescriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
