...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetPullRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetPullRequestResponseUnmarshaller _instance = new GetPullRequestResponseUnmarshaller();        

        internal static GetPullRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPullRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
