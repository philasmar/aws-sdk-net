...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PullRequestMergedStateChangedEventMetadataUnmarshaller : IUnmarshaller<PullRequestMergedStateChangedEventMetadata, XmlUnmarshallerContext>, IUnmarshaller<PullRequestMergedStateChangedEventMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PullRequestMergedStateChangedEventMetadata IUnmarshaller<PullRequestMergedStateChangedEventMetadata, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static PullRequestMergedStateChangedEventMetadataUnmarshaller _instance = new PullRequestMergedStateChangedEventMetadataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PullRequestMergedStateChangedEventMetadataUnmarshaller Instance
        {
            get
            {
                return _instance;
