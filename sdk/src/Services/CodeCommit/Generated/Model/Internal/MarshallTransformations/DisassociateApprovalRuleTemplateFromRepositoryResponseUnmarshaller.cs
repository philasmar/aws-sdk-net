...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisassociateApprovalRuleTemplateFromRepositoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateApprovalRuleTemplateFromRepositoryResponse response = new DisassociateApprovalRuleTemplateFromRepositoryResponse();
        ...
        private static DisassociateApprovalRuleTemplateFromRepositoryResponseUnmarshaller _instance = new DisassociateApprovalRuleTemplateFromRepositoryResponseUnmarshaller();        

        internal static DisassociateApprovalRuleTemplateFromRepositoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateApprovalRuleTemplateFromRepositoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
