...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDifferencesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDifferencesResponse response = new GetDifferencesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Difference, DifferenceUnmarshaller>(DifferenceUnmarshaller.Instance);
                    response.Differences = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetDifferencesResponseUnmarshaller _instance = new GetDifferencesResponseUnmarshaller();        

        internal static GetDifferencesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDifferencesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
