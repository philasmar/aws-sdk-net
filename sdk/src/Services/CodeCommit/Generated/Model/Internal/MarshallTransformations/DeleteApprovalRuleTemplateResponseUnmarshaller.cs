...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteApprovalRuleTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteApprovalRuleTemplateResponse response = new DeleteApprovalRuleTemplateResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("approvalRuleTemplateId", targetDepth))
                {
                    ...
                    response.ApprovalRuleTemplateId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("ApprovalRuleTemplateInUseException"))
                {
                    return ApprovalRuleTemplateInUseExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static DeleteApprovalRuleTemplateResponseUnmarshaller _instance = new DeleteApprovalRuleTemplateResponseUnmarshaller();        

        internal static DeleteApprovalRuleTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteApprovalRuleTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
