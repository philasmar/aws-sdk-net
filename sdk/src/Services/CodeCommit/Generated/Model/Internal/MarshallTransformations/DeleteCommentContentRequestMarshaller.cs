...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteCommentContentRequestMarshaller : IMarshaller<IRequest, DeleteCommentContentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteCommentContentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteCommentContentRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodeCommit");
            string target = "CodeCommit_20150413.DeleteCommentContent";
