...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class TestRepositoryTriggersRequestMarshaller : IMarshaller<IRequest, TestRepositoryTriggersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((TestRepositoryTriggersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(TestRepositoryTriggersRequest publicRequest)
        {
        ...
        private static TestRepositoryTriggersRequestMarshaller _instance = new TestRepositoryTriggersRequestMarshaller();        

        internal static TestRepositoryTriggersRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TestRepositoryTriggersRequestMarshaller Instance
        {
            get
            {
                return _instance;
