...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAssociatedApprovalRuleTemplatesForRepositoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAssociatedApprovalRuleTemplatesForRepositoryResponse response = new ListAssociatedApprovalRuleTemplatesForRepositoryResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("approvalRuleTemplateNames", targetDepth))
                {
                    ...
                    response.ApprovalRuleTemplateNames = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListAssociatedApprovalRuleTemplatesForRepositoryResponseUnmarshaller _instance = new ListAssociatedApprovalRuleTemplatesForRepositoryResponseUnmarshaller();        

        internal static ListAssociatedApprovalRuleTemplatesForRepositoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAssociatedApprovalRuleTemplatesForRepositoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
