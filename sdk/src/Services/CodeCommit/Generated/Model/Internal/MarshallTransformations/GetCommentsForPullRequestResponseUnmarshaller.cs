...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetCommentsForPullRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCommentsForPullRequestResponse response = new GetCommentsForPullRequestResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CommentsForPullRequest, CommentsForPullRequestUnmarshaller>(CommentsForPullRequestUnmarshaller.Instance);
                    response.CommentsForPullRequestData = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetCommentsForPullRequestResponseUnmarshaller _instance = new GetCommentsForPullRequestResponseUnmarshaller();        

        internal static GetCommentsForPullRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCommentsForPullRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
