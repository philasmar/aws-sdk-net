...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListRepositoriesForApprovalRuleTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRepositoriesForApprovalRuleTemplateResponse response = new ListRepositoriesForApprovalRuleTemplateResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("repositoryNames", targetDepth))
                {
                    ...
                    response.RepositoryNames = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListRepositoriesForApprovalRuleTemplateResponseUnmarshaller _instance = new ListRepositoriesForApprovalRuleTemplateResponseUnmarshaller();        

        internal static ListRepositoriesForApprovalRuleTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRepositoriesForApprovalRuleTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
