...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRepositoryTriggersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRepositoryTriggersResponse response = new GetRepositoryTriggersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RepositoryTrigger, RepositoryTriggerUnmarshaller>(RepositoryTriggerUnmarshaller.Instance);
        ...
        private static GetRepositoryTriggersResponseUnmarshaller _instance = new GetRepositoryTriggersResponseUnmarshaller();        

        internal static GetRepositoryTriggersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRepositoryTriggersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
