...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PostCommentReplyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PostCommentReplyResponse response = new PostCommentReplyResponse();
        ...
        private static PostCommentReplyResponseUnmarshaller _instance = new PostCommentReplyResponseUnmarshaller();        

        internal static PostCommentReplyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PostCommentReplyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
