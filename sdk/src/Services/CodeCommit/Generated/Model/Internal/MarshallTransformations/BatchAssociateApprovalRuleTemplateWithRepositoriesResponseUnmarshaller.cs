...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchAssociateApprovalRuleTemplateWithRepositoriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchAssociateApprovalRuleTemplateWithRepositoriesResponse response = new BatchAssociateApprovalRuleTemplateWithRepositoriesResponse();

            context.Read();
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("associatedRepositoryNames", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    response.AssociatedRepositoryNames = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("errors", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<BatchAssociateApprovalRuleTemplateWithRepositoriesError, BatchAssociateApprovalRuleTemplateWithRepositoriesErrorUnmarshaller>(BatchAssociateApprovalRuleTemplateWithRepositoriesErrorUnmarshaller.Instance);
        ...
        private static BatchAssociateApprovalRuleTemplateWithRepositoriesResponseUnmarshaller _instance = new BatchAssociateApprovalRuleTemplateWithRepositoriesResponseUnmarshaller();        

        internal static BatchAssociateApprovalRuleTemplateWithRepositoriesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchAssociateApprovalRuleTemplateWithRepositoriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
