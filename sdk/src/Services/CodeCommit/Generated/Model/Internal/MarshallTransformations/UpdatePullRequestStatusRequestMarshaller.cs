...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdatePullRequestStatusRequestMarshaller : IMarshaller<IRequest, UpdatePullRequestStatusRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdatePullRequestStatusRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdatePullRequestStatusRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodeCommit");
            string target = "CodeCommit_20150413.UpdatePullRequestStatus";
