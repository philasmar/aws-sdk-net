...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListApprovalRuleTemplatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListApprovalRuleTemplatesResponse response = new ListApprovalRuleTemplatesResponse();
        ...
        private static ListApprovalRuleTemplatesResponseUnmarshaller _instance = new ListApprovalRuleTemplatesResponseUnmarshaller();        

        internal static ListApprovalRuleTemplatesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListApprovalRuleTemplatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
