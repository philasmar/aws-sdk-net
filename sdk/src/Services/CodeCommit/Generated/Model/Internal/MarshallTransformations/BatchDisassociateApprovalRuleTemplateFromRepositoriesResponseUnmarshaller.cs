...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchDisassociateApprovalRuleTemplateFromRepositoriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchDisassociateApprovalRuleTemplateFromRepositoriesResponse response = new BatchDisassociateApprovalRuleTemplateFromRepositoriesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("disassociatedRepositoryNames", targetDepth))
                {
                    ...
                    response.DisassociatedRepositoryNames = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("errors", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<BatchDisassociateApprovalRuleTemplateFromRepositoriesError, BatchDisassociateApprovalRuleTemplateFromRepositoriesErrorUnmarshaller>(BatchDisassociateApprovalRuleTemplateFromRepositoriesErrorUnmarshaller.Instance);
        ...
        private static BatchDisassociateApprovalRuleTemplateFromRepositoriesResponseUnmarshaller _instance = new BatchDisassociateApprovalRuleTemplateFromRepositoriesResponseUnmarshaller();        

        internal static BatchDisassociateApprovalRuleTemplateFromRepositoriesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDisassociateApprovalRuleTemplateFromRepositoriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
