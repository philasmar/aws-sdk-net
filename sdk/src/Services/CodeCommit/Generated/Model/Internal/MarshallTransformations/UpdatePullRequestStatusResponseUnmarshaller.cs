...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdatePullRequestStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePullRequestStatusResponse response = new UpdatePullRequestStatusResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidPullRequestStatusException"))
                {
                    return InvalidPullRequestStatusExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidPullRequestStatusUpdateException"))
                {
                    return InvalidPullRequestStatusUpdateExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("PullRequestStatusRequiredException"))
                {
                    return PullRequestStatusRequiredExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static UpdatePullRequestStatusResponseUnmarshaller _instance = new UpdatePullRequestStatusResponseUnmarshaller();        

        internal static UpdatePullRequestStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePullRequestStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
