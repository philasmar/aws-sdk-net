...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreatePullRequestApprovalRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePullRequestApprovalRuleResponse response = new CreatePullRequestApprovalRuleResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ApprovalRuleNameAlreadyExistsException"))
                {
                    return ApprovalRuleNameAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("NumberOfRulesExceededException"))
                {
                    return NumberOfRulesExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CreatePullRequestApprovalRuleResponseUnmarshaller _instance = new CreatePullRequestApprovalRuleResponseUnmarshaller();        

        internal static CreatePullRequestApprovalRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePullRequestApprovalRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
