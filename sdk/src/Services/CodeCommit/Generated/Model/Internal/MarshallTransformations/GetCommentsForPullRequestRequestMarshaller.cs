...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetCommentsForPullRequestRequestMarshaller : IMarshaller<IRequest, GetCommentsForPullRequestRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCommentsForPullRequestRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCommentsForPullRequestRequest publicRequest)
        {
