...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateDefaultBranchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDefaultBranchResponse response = new UpdateDefaultBranchResponse();
        ...
        private static UpdateDefaultBranchResponseUnmarshaller _instance = new UpdateDefaultBranchResponseUnmarshaller();        

        internal static UpdateDefaultBranchResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDefaultBranchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
