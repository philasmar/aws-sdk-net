...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EvaluatePullRequestApprovalRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EvaluatePullRequestApprovalRulesResponse response = new EvaluatePullRequestApprovalRulesResponse();
        ...
        private static EvaluatePullRequestApprovalRulesResponseUnmarshaller _instance = new EvaluatePullRequestApprovalRulesResponseUnmarshaller();        

        internal static EvaluatePullRequestApprovalRulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EvaluatePullRequestApprovalRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
