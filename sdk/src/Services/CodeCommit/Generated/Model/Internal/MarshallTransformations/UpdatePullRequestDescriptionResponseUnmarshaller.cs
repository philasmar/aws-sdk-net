...
namespace Amazon.CodeCommit.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdatePullRequestDescriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePullRequestDescriptionResponse response = new UpdatePullRequestDescriptionResponse();
        ...
        private static UpdatePullRequestDescriptionResponseUnmarshaller _instance = new UpdatePullRequestDescriptionResponseUnmarshaller();        

        internal static UpdatePullRequestDescriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePullRequestDescriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
