...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class ClientRequestTokenRequiredException : AmazonCodeCommitException
    {
        ...
        public ClientRequestTokenRequiredException(string message, Exception innerException) 
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public ClientRequestTokenRequiredException(Exception innerException) 
            : base(innerException) {}
        ...
        public ClientRequestTokenRequiredException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ClientRequestTokenRequiredException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected ClientRequestTokenRequiredException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
