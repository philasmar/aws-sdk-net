...
namespace Amazon.CodeCommit.Model
{
    ...
    public partial class FolderContentSizeLimitExceededException : AmazonCodeCommitException
    {
        ...
        public FolderContentSizeLimitExceededException(string message, Exception innerException) 
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public FolderContentSizeLimitExceededException(Exception innerException) 
            : base(innerException) {}
        ...
        public FolderContentSizeLimitExceededException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public FolderContentSizeLimitExceededException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected FolderContentSizeLimitExceededException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
