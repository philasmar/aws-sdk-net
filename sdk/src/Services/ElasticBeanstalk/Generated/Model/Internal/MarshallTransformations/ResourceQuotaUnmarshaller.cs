...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    public class ResourceQuotaUnmarshaller : IUnmarshaller<ResourceQuota, XmlUnmarshallerContext>, IUnmarshaller<ResourceQuota, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ResourceQuota Unmarshall(XmlUnmarshallerContext context)
        {
            ResourceQuota unmarshalledObject = new ResourceQuota();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResourceQuotaUnmarshaller Instance
        {
            get
            {
                return _instance;
