...
{
    /// <summary>
    /// Response Unmarshaller for UpdateApplicationResourceLifecycle operation
    /// </summary>  
    public class UpdateApplicationResourceLifecycleResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateApplicationResourceLifecycleResponse response = new UpdateApplicationResourceLifecycleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateApplicationResourceLifecycleResult", 2))
                    {
        ...
        private static UpdateApplicationResourceLifecycleResponseUnmarshaller _instance = new UpdateApplicationResourceLifecycleResponseUnmarshaller();        

        internal static UpdateApplicationResourceLifecycleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateApplicationResourceLifecycleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
