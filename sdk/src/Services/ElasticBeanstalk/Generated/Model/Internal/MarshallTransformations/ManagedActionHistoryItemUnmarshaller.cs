...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    public class ManagedActionHistoryItemUnmarshaller : IUnmarshaller<ManagedActionHistoryItem, XmlUnmarshallerContext>, IUnmarshaller<ManagedActionHistoryItem, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ManagedActionHistoryItem Unmarshall(XmlUnmarshallerContext context)
        {
            ManagedActionHistoryItem unmarshalledObject = new ManagedActionHistoryItem();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ManagedActionHistoryItemUnmarshaller Instance
        {
            get
            {
                return _instance;
