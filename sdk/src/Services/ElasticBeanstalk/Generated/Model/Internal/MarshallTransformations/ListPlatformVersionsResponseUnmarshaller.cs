...
{
    /// <summary>
    /// Response Unmarshaller for ListPlatformVersions operation
    /// </summary>  
    public class ListPlatformVersionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPlatformVersionsResponse response = new ListPlatformVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListPlatformVersionsResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ListPlatformVersionsResponse response)
        {
        ...
        private static ListPlatformVersionsResponseUnmarshaller _instance = new ListPlatformVersionsResponseUnmarshaller();        

        internal static ListPlatformVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPlatformVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
