...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteApplicationVersionRequestMarshaller : IMarshaller<IRequest, DeleteApplicationVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteApplicationVersionRequest)input);
        }
        ...
        public IRequest Marshall(DeleteApplicationVersionRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DeleteApplicationVersionRequestMarshaller _instance = new DeleteApplicationVersionRequestMarshaller();        

        internal static DeleteApplicationVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteApplicationVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
