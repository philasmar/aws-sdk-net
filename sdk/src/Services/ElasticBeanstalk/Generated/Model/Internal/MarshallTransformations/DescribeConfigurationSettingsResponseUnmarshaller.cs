...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeConfigurationSettingsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DescribeConfigurationSettingsResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = ConfigurationSettingsDescriptionUnmarshaller.Instance;
                        var item = unmarshaller.Unmarshall(context);
                        response.ConfigurationSettings.Add(item);
                        continue;
                    }
                } 
           }
        ...
        private static DescribeConfigurationSettingsResponseUnmarshaller _instance = new DescribeConfigurationSettingsResponseUnmarshaller();        

        internal static DescribeConfigurationSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeConfigurationSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
