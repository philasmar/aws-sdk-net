...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeConfigurationSettingsRequestMarshaller : IMarshaller<IRequest, DescribeConfigurationSettingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeConfigurationSettingsRequest)input);
        }
        ...
        public IRequest Marshall(DescribeConfigurationSettingsRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeConfigurationSettingsRequestMarshaller _instance = new DescribeConfigurationSettingsRequestMarshaller();        

        internal static DescribeConfigurationSettingsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeConfigurationSettingsRequestMarshaller Instance
        {
            get
            {
                return _instance;
