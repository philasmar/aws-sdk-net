...
namespace Amazon.ElasticBeanstalk.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeConfigurationOptionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static DescribeConfigurationOptionsResponseUnmarshaller _instance = new DescribeConfigurationOptionsResponseUnmarshaller();        

        internal static DescribeConfigurationOptionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeConfigurationOptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
