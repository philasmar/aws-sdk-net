...
{
    /// <summary>
    /// ListPlatformBranches Request Marshaller
    /// </summary>       
    public class ListPlatformBranchesRequestMarshaller : IMarshaller<IRequest, ListPlatformBranchesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListPlatformBranchesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListPlatformBranchesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ElasticBeanstalk");
            request.Parameters.Add("Action", "ListPlatformBranches");
            ...
            return request;
                    ...
                    private static ListPlatformBranchesRequestMarshaller _instance = new ListPlatformBranchesRequestMarshaller();        

        internal static ListPlatformBranchesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPlatformBranchesRequestMarshaller Instance
        {
            get
            {
                return _instance;
