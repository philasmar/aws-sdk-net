...
namespace Amazon.ElasticBeanstalk.Model
{
    ...
    /// </summary>
    public partial class CreatePlatformVersionResponse : AmazonWebServiceResponse
    {
        private Builder _builder;
        private PlatformSummary _platformSummary;

        /// <summary>
        /// Gets and sets the property Builder. 
        /// <para>
        ...
        // Check to see if Builder property is set
        internal bool IsSetBuilder()
        {
