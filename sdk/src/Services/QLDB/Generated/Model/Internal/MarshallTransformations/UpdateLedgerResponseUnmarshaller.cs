...
{
    /// <summary>
    /// Response Unmarshaller for UpdateLedger operation
    /// </summary>  
    public class UpdateLedgerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateLedgerResponseUnmarshaller _instance = new UpdateLedgerResponseUnmarshaller();        

        internal static UpdateLedgerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLedgerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
