...
{
    /// <summary>
    /// GetBlock Request Marshaller
    /// </summary>       
    public class GetBlockRequestMarshaller : IMarshaller<IRequest, GetBlockRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetBlockRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetBlockRequest publicRequest)
        {
            ...
            request.ResourcePath = "/ledgers/{name}/block";
        ...
        private static GetBlockRequestMarshaller _instance = new GetBlockRequestMarshaller();        

        internal static GetBlockRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBlockRequestMarshaller Instance
        {
            get
            {
                return _instance;
