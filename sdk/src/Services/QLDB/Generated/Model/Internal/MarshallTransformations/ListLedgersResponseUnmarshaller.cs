...
{
    /// <summary>
    /// Response Unmarshaller for ListLedgers operation
    /// </summary>  
    public class ListLedgersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListLedgersResponseUnmarshaller _instance = new ListLedgersResponseUnmarshaller();        

        internal static ListLedgersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLedgersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
