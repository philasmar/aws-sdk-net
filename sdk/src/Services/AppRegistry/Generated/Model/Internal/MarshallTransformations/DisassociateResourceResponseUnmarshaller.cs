...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateResource operation
    /// </summary>  
    public class DisassociateResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateResourceResponse response = new DisassociateResourceResponse();
        ...
        private static DisassociateResourceResponseUnmarshaller _instance = new DisassociateResourceResponseUnmarshaller();        

        internal static DisassociateResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
