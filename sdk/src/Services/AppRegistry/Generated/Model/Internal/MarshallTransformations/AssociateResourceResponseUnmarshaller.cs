...
{
    /// <summary>
    /// Response Unmarshaller for AssociateResource operation
    /// </summary>  
    public class AssociateResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateResourceResponse response = new AssociateResourceResponse();
        ...
        private static AssociateResourceResponseUnmarshaller _instance = new AssociateResourceResponseUnmarshaller();        

        internal static AssociateResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
