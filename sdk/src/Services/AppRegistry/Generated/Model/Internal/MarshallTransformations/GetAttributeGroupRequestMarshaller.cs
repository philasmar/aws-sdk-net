...
{
    /// <summary>
    /// GetAttributeGroup Request Marshaller
    /// </summary>       
    public class GetAttributeGroupRequestMarshaller : IMarshaller<IRequest, GetAttributeGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAttributeGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAttributeGroupRequest publicRequest)
        {
        ...
        private static GetAttributeGroupRequestMarshaller _instance = new GetAttributeGroupRequestMarshaller();        

        internal static GetAttributeGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAttributeGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
