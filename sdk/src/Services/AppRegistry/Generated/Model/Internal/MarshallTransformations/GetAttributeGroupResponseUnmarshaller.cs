...
{
    /// <summary>
    /// Response Unmarshaller for GetAttributeGroup operation
    /// </summary>  
    public class GetAttributeGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAttributeGroupResponse response = new GetAttributeGroupResponse();
        ...
        private static GetAttributeGroupResponseUnmarshaller _instance = new GetAttributeGroupResponseUnmarshaller();        

        internal static GetAttributeGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAttributeGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
