...
{
    /// <summary>
    /// DisassociateAttributeGroup Request Marshaller
    /// </summary>       
    public class DisassociateAttributeGroupRequestMarshaller : IMarshaller<IRequest, DisassociateAttributeGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateAttributeGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateAttributeGroupRequest publicRequest)
        {
        ...
        private static DisassociateAttributeGroupRequestMarshaller _instance = new DisassociateAttributeGroupRequestMarshaller();        

        internal static DisassociateAttributeGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateAttributeGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
