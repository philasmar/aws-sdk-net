...
namespace Amazon.AppRegistry.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateAttributeGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAttributeGroupResponse response = new CreateAttributeGroupResponse();
        ...
        internal static CreateAttributeGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAttributeGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
