...
namespace Amazon.Pinpoint.Model
{
    ...
    {
        private APNSVoipChannelRequest _apnsVoipChannelRequest;
        ...
        public APNSVoipChannelRequest APNSVoipChannelRequest
        {
            ...
            set { this._apnsVoipChannelRequest = value; }
        }

        // Check to see if APNSVoipChannelRequest property is set
        internal bool IsSetAPNSVoipChannelRequest()
        {
            return this._apnsVoipChannelRequest != null;
        }
