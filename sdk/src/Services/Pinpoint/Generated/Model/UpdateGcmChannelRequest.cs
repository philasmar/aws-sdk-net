...
namespace Amazon.Pinpoint.Model
{
    ...
    public partial class UpdateGcmChannelRequest : AmazonPinpointRequest
    {
        ...
        public GCMChannelRequest GCMChannelRequest
        {
            ...
            set { this._gcmChannelRequest = value; }
        }

        // Check to see if GCMChannelRequest property is set
        internal bool IsSetGCMChannelRequest()
        {
            return this._gcmChannelRequest != null;
        }
