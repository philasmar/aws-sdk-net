...
namespace Amazon.Pinpoint.Model
{
    ...
    {
        private EndpointResponse _endpointResponse;
        ...
        public EndpointResponse EndpointResponse
        {
            ...
            set { this._endpointResponse = value; }
        }

        // Check to see if EndpointResponse property is set
        internal bool IsSetEndpointResponse()
        {
            return this._endpointResponse != null;
        }
