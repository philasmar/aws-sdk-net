...
namespace Amazon.Pinpoint.Model
{
    ...
    {
        private APNSVoipSandboxChannelRequest _apnsVoipSandboxChannelRequest;
        private string _applicationId;

        /// <summary>
        /// Gets and sets the property APNSVoipSandboxChannelRequest.
        /// </summary>
        [AWSProperty(Required=true)]
        public APNSVoipSandboxChannelRequest APNSVoipSandboxChannelRequest
        {
            get { return this._apnsVoipSandboxChannelRequest; }
            set { this._apnsVoipSandboxChannelRequest = value; }
        }

        // Check to see if APNSVoipSandboxChannelRequest property is set
        internal bool IsSetAPNSVoipSandboxChannelRequest()
        {
            return this._apnsVoipSandboxChannelRequest != null;
        }
