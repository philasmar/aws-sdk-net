...
namespace Amazon.Pinpoint.Model
{
    ...
    {
        private EventsResponse _eventsResponse;
        ...
        public EventsResponse EventsResponse
        {
            ...
            set { this._eventsResponse = value; }
        }

        // Check to see if EventsResponse property is set
        internal bool IsSetEventsResponse()
        {
            return this._eventsResponse != null;
        }
