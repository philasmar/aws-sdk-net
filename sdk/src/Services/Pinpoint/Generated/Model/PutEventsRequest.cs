...
namespace Amazon.Pinpoint.Model
{
    ...
    public partial class PutEventsRequest : AmazonPinpointRequest
    {
        ...
        /// <summary>
        /// Gets and sets the property EventsRequest.
        /// </summary>
        [AWSProperty(Required=true)]
        public EventsRequest EventsRequest
        {
            get { return this._eventsRequest; }
            set { this._eventsRequest = value; }
        }

        // Check to see if EventsRequest property is set
        internal bool IsSetEventsRequest()
        {
            return this._eventsRequest != null;
        }
