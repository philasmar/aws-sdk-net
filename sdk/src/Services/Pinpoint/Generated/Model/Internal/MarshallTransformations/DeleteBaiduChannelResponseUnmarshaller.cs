...
{
    /// <summary>
    /// Response Unmarshaller for DeleteBaiduChannel operation
    /// </summary>  
    public class DeleteBaiduChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteBaiduChannelResponse response = new DeleteBaiduChannelResponse();

            var unmarshaller = BaiduChannelResponseUnmarshaller.Instance;
            response.BaiduChannelResponse = unmarshaller.Unmarshall(context);
        ...
        private static DeleteBaiduChannelResponseUnmarshaller _instance = new DeleteBaiduChannelResponseUnmarshaller();        

        internal static DeleteBaiduChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBaiduChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
