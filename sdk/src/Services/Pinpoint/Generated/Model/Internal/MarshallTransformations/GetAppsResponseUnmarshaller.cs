...
{
    /// <summary>
    /// Response Unmarshaller for GetApps operation
    /// </summary>  
    public class GetAppsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetAppsResponseUnmarshaller _instance = new GetAppsResponseUnmarshaller();        

        internal static GetAppsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAppsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
