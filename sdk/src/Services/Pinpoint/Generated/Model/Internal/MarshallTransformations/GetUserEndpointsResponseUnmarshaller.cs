...
{
    /// <summary>
    /// Response Unmarshaller for GetUserEndpoints operation
    /// </summary>  
    public class GetUserEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetUserEndpointsResponse response = new GetUserEndpointsResponse();
        ...
        private static GetUserEndpointsResponseUnmarshaller _instance = new GetUserEndpointsResponseUnmarshaller();        

        internal static GetUserEndpointsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUserEndpointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
