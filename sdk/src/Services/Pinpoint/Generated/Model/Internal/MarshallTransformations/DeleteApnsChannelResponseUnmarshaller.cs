...
{
    /// <summary>
    /// Response Unmarshaller for DeleteApnsChannel operation
    /// </summary>  
    public class DeleteApnsChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteApnsChannelResponse response = new DeleteApnsChannelResponse();

            var unmarshaller = APNSChannelResponseUnmarshaller.Instance;
            response.APNSChannelResponse = unmarshaller.Unmarshall(context);
        ...
        private static DeleteApnsChannelResponseUnmarshaller _instance = new DeleteApnsChannelResponseUnmarshaller();        

        internal static DeleteApnsChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteApnsChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
