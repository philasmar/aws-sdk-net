...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSmsChannel operation
    /// </summary>  
    public class DeleteSmsChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSmsChannelResponse response = new DeleteSmsChannelResponse();
        ...
        private static DeleteSmsChannelResponseUnmarshaller _instance = new DeleteSmsChannelResponseUnmarshaller();        

        internal static DeleteSmsChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSmsChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
