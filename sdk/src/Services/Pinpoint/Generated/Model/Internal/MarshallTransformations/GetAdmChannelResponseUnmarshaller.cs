...
{
    /// <summary>
    /// Response Unmarshaller for GetAdmChannel operation
    /// </summary>  
    public class GetAdmChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAdmChannelResponse response = new GetAdmChannelResponse();
        ...
        private static GetAdmChannelResponseUnmarshaller _instance = new GetAdmChannelResponseUnmarshaller();        

        internal static GetAdmChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAdmChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
