...
{
    /// <summary>
    /// Response Unmarshaller for UpdateJourneyState operation
    /// </summary>  
    public class UpdateJourneyStateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateJourneyStateResponseUnmarshaller _instance = new UpdateJourneyStateResponseUnmarshaller();        

        internal static UpdateJourneyStateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateJourneyStateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
