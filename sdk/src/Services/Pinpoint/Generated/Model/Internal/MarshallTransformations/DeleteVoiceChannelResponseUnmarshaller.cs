...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVoiceChannel operation
    /// </summary>  
    public class DeleteVoiceChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVoiceChannelResponse response = new DeleteVoiceChannelResponse();
        ...
        private static DeleteVoiceChannelResponseUnmarshaller _instance = new DeleteVoiceChannelResponseUnmarshaller();        

        internal static DeleteVoiceChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVoiceChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
