...
{
    /// <summary>
    /// GetExportJobs Request Marshaller
    /// </summary>       
    public class GetExportJobsRequestMarshaller : IMarshaller<IRequest, GetExportJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetExportJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetExportJobsRequest publicRequest)
        {
        ...
        private static GetExportJobsRequestMarshaller _instance = new GetExportJobsRequestMarshaller();        

        internal static GetExportJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetExportJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
