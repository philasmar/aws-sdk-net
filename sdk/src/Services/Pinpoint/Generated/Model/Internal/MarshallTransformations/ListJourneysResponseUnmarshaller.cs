...
{
    /// <summary>
    /// Response Unmarshaller for ListJourneys operation
    /// </summary>  
    public class ListJourneysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            var unmarshaller = JourneysResponseUnmarshaller.Instance;
            response.JourneysResponse = unmarshaller.Unmarshall(context);
        ...
        private static ListJourneysResponseUnmarshaller _instance = new ListJourneysResponseUnmarshaller();        

        internal static ListJourneysResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListJourneysResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
