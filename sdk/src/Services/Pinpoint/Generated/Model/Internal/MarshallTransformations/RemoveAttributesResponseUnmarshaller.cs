...
{
    /// <summary>
    /// Response Unmarshaller for RemoveAttributes operation
    /// </summary>  
    public class RemoveAttributesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveAttributesResponse response = new RemoveAttributesResponse();

            var unmarshaller = AttributesResourceUnmarshaller.Instance;
            response.AttributesResource = unmarshaller.Unmarshall(context);
        ...
        private static RemoveAttributesResponseUnmarshaller _instance = new RemoveAttributesResponseUnmarshaller();        

        internal static RemoveAttributesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
