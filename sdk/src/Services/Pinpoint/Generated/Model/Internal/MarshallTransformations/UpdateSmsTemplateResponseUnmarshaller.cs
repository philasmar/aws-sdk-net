...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSmsTemplate operation
    /// </summary>  
    public class UpdateSmsTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSmsTemplateResponse response = new UpdateSmsTemplateResponse();
        ...
        private static UpdateSmsTemplateResponseUnmarshaller _instance = new UpdateSmsTemplateResponseUnmarshaller();        

        internal static UpdateSmsTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSmsTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
