...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAdmChannel operation
    /// </summary>  
    public class UpdateAdmChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAdmChannelResponse response = new UpdateAdmChannelResponse();
        ...
        private static UpdateAdmChannelResponseUnmarshaller _instance = new UpdateAdmChannelResponseUnmarshaller();        

        internal static UpdateAdmChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAdmChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
