...
{
    /// <summary>
    /// Response Unmarshaller for DeleteGcmChannel operation
    /// </summary>  
    public class DeleteGcmChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteGcmChannelResponse response = new DeleteGcmChannelResponse();
        ...
        private static DeleteGcmChannelResponseUnmarshaller _instance = new DeleteGcmChannelResponseUnmarshaller();        

        internal static DeleteGcmChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGcmChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
