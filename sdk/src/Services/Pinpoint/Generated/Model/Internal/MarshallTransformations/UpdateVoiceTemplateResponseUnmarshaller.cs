...
{
    /// <summary>
    /// Response Unmarshaller for UpdateVoiceTemplate operation
    /// </summary>  
    public class UpdateVoiceTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateVoiceTemplateResponseUnmarshaller _instance = new UpdateVoiceTemplateResponseUnmarshaller();        

        internal static UpdateVoiceTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateVoiceTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
