...
{
    /// <summary>
    /// Response Unmarshaller for UpdateCampaign operation
    /// </summary>  
    public class UpdateCampaignResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateCampaignResponseUnmarshaller _instance = new UpdateCampaignResponseUnmarshaller();        

        internal static UpdateCampaignResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateCampaignResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
