...
{
    /// <summary>
    /// Response Unmarshaller for ListTemplateVersions operation
    /// </summary>  
    public class ListTemplateVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListTemplateVersionsResponseUnmarshaller _instance = new ListTemplateVersionsResponseUnmarshaller();        

        internal static ListTemplateVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTemplateVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
