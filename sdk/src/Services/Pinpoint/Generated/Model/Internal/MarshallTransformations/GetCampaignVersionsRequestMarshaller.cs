...
{
    /// <summary>
    /// GetCampaignVersions Request Marshaller
    /// </summary>       
    public class GetCampaignVersionsRequestMarshaller : IMarshaller<IRequest, GetCampaignVersionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCampaignVersionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCampaignVersionsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/apps/{application-id}/campaigns/{campaign-id}/versions";
            request.MarshallerVersion = 2;
            request.UseQueryString = true;

            return request;
        }
        private static GetCampaignVersionsRequestMarshaller _instance = new GetCampaignVersionsRequestMarshaller();        

        internal static GetCampaignVersionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCampaignVersionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
