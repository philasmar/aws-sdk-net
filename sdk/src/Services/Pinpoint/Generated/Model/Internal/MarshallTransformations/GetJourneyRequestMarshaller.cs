...
{
    /// <summary>
    /// GetJourney Request Marshaller
    /// </summary>       
    public class GetJourneyRequestMarshaller : IMarshaller<IRequest, GetJourneyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetJourneyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetJourneyRequest publicRequest)
        {
        ...
        private static GetJourneyRequestMarshaller _instance = new GetJourneyRequestMarshaller();        

        internal static GetJourneyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetJourneyRequestMarshaller Instance
        {
            get
            {
                return _instance;
