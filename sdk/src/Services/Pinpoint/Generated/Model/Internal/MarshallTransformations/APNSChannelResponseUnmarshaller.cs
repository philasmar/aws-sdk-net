...
{
    /// <summary>
    /// Response Unmarshaller for APNSChannelResponse Object
    /// </summary>  
    public class APNSChannelResponseUnmarshaller : IUnmarshaller<APNSChannelResponse, XmlUnmarshallerContext>, IUnmarshaller<APNSChannelResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        APNSChannelResponse IUnmarshaller<APNSChannelResponse, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public APNSChannelResponse Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            APNSChannelResponse unmarshalledObject = new APNSChannelResponse();
        ...
        private static APNSChannelResponseUnmarshaller _instance = new APNSChannelResponseUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static APNSChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
