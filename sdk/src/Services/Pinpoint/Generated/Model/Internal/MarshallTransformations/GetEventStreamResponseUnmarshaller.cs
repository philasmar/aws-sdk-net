...
{
    /// <summary>
    /// Response Unmarshaller for GetEventStream operation
    /// </summary>  
    public class GetEventStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEventStreamResponse response = new GetEventStreamResponse();
        ...
        private static GetEventStreamResponseUnmarshaller _instance = new GetEventStreamResponseUnmarshaller();        

        internal static GetEventStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEventStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
