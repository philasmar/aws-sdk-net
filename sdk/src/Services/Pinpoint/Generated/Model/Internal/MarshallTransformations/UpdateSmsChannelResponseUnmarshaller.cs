...
{
    /// <summary>
    /// Response Unmarshaller for UpdateSmsChannel operation
    /// </summary>  
    public class UpdateSmsChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSmsChannelResponse response = new UpdateSmsChannelResponse();

            var unmarshaller = SMSChannelResponseUnmarshaller.Instance;
            response.SMSChannelResponse = unmarshaller.Unmarshall(context);
        ...
        private static UpdateSmsChannelResponseUnmarshaller _instance = new UpdateSmsChannelResponseUnmarshaller();        

        internal static UpdateSmsChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSmsChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
