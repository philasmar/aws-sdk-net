...
{
    /// <summary>
    /// Response Unmarshaller for ImportJobResponse Object
    /// </summary>  
    public class ImportJobResponseUnmarshaller : IUnmarshaller<ImportJobResponse, XmlUnmarshallerContext>, IUnmarshaller<ImportJobResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ImportJobResponse IUnmarshaller<ImportJobResponse, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ImportJobResponse Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            ImportJobResponse unmarshalledObject = new ImportJobResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = ImportJobResourceUnmarshaller.Instance;
        ...
        private static ImportJobResponseUnmarshaller _instance = new ImportJobResponseUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
