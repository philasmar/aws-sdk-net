...
{
    /// <summary>
    /// Response Unmarshaller for GetGcmChannel operation
    /// </summary>  
    public class GetGcmChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGcmChannelResponse response = new GetGcmChannelResponse();
        ...
        private static GetGcmChannelResponseUnmarshaller _instance = new GetGcmChannelResponseUnmarshaller();        

        internal static GetGcmChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGcmChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
