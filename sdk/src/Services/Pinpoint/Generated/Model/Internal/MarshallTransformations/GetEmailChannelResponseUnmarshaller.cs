...
{
    /// <summary>
    /// Response Unmarshaller for GetEmailChannel operation
    /// </summary>  
    public class GetEmailChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEmailChannelResponse response = new GetEmailChannelResponse();
        ...
        private static GetEmailChannelResponseUnmarshaller _instance = new GetEmailChannelResponseUnmarshaller();        

        internal static GetEmailChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEmailChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
