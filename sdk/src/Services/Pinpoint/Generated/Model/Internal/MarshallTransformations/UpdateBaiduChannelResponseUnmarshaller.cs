...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBaiduChannel operation
    /// </summary>  
    public class UpdateBaiduChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBaiduChannelResponse response = new UpdateBaiduChannelResponse();
        ...
        private static UpdateBaiduChannelResponseUnmarshaller _instance = new UpdateBaiduChannelResponseUnmarshaller();        

        internal static UpdateBaiduChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBaiduChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
