...
{
    /// <summary>
    /// Response Unmarshaller for PutEventStream operation
    /// </summary>  
    public class PutEventStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static PutEventStreamResponseUnmarshaller _instance = new PutEventStreamResponseUnmarshaller();        

        internal static PutEventStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutEventStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
