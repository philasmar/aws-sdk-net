...
{
    /// <summary>
    /// Response Unmarshaller for GetPushTemplate operation
    /// </summary>  
    public class GetPushTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPushTemplateResponse response = new GetPushTemplateResponse();

            var unmarshaller = PushNotificationTemplateResponseUnmarshaller.Instance;
            response.PushNotificationTemplateResponse = unmarshaller.Unmarshall(context);
        ...
        private static GetPushTemplateResponseUnmarshaller _instance = new GetPushTemplateResponseUnmarshaller();        

        internal static GetPushTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPushTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
