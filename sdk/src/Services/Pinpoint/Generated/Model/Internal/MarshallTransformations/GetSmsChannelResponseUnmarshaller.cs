...
{
    /// <summary>
    /// Response Unmarshaller for GetSmsChannel operation
    /// </summary>  
    public class GetSmsChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSmsChannelResponse response = new GetSmsChannelResponse();
        ...
        private static GetSmsChannelResponseUnmarshaller _instance = new GetSmsChannelResponseUnmarshaller();        

        internal static GetSmsChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSmsChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
