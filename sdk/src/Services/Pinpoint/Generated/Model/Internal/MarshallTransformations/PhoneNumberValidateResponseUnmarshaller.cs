...
{
    /// <summary>
    /// Response Unmarshaller for PhoneNumberValidate operation
    /// </summary>  
    public class PhoneNumberValidateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static PhoneNumberValidateResponseUnmarshaller _instance = new PhoneNumberValidateResponseUnmarshaller();        

        internal static PhoneNumberValidateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PhoneNumberValidateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
