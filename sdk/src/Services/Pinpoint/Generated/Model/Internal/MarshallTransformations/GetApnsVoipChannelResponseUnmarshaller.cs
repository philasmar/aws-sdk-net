...
{
    /// <summary>
    /// Response Unmarshaller for GetApnsVoipChannel operation
    /// </summary>  
    public class GetApnsVoipChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetApnsVoipChannelResponse response = new GetApnsVoipChannelResponse();
        ...
        private static GetApnsVoipChannelResponseUnmarshaller _instance = new GetApnsVoipChannelResponseUnmarshaller();        

        internal static GetApnsVoipChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetApnsVoipChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
