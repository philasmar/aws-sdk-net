...
{
    /// <summary>
    /// Response Unmarshaller for GetImportJobs operation
    /// </summary>  
    public class GetImportJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetImportJobsResponse response = new GetImportJobsResponse();
        ...
        private static GetImportJobsResponseUnmarshaller _instance = new GetImportJobsResponseUnmarshaller();        

        internal static GetImportJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetImportJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
