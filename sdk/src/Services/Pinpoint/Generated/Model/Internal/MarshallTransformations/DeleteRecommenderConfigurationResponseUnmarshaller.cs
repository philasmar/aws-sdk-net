...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRecommenderConfiguration operation
    /// </summary>  
    public class DeleteRecommenderConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteRecommenderConfigurationResponseUnmarshaller _instance = new DeleteRecommenderConfigurationResponseUnmarshaller();        

        internal static DeleteRecommenderConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRecommenderConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
