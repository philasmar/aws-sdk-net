...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAdmChannel operation
    /// </summary>  
    public class DeleteAdmChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAdmChannelResponse response = new DeleteAdmChannelResponse();

            var unmarshaller = ADMChannelResponseUnmarshaller.Instance;
            response.ADMChannelResponse = unmarshaller.Unmarshall(context);
        ...
        private static DeleteAdmChannelResponseUnmarshaller _instance = new DeleteAdmChannelResponseUnmarshaller();        

        internal static DeleteAdmChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAdmChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
