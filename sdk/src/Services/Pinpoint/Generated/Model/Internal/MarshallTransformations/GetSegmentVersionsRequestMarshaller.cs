...
{
    /// <summary>
    /// GetSegmentVersions Request Marshaller
    /// </summary>       
    public class GetSegmentVersionsRequestMarshaller : IMarshaller<IRequest, GetSegmentVersionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSegmentVersionsRequest)input);
        }
        ...
        public IRequest Marshall(GetSegmentVersionsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/apps/{application-id}/segments/{segment-id}/versions";
            request.MarshallerVersion = 2;
            request.UseQueryString = true;

            return request;
        }
        private static GetSegmentVersionsRequestMarshaller _instance = new GetSegmentVersionsRequestMarshaller();        

        internal static GetSegmentVersionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSegmentVersionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
