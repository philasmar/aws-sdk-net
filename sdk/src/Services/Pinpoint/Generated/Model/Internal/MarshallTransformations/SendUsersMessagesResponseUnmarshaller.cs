...
{
    /// <summary>
    /// Response Unmarshaller for SendUsersMessages operation
    /// </summary>  
    public class SendUsersMessagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendUsersMessagesResponse response = new SendUsersMessagesResponse();

            var unmarshaller = SendUsersMessageResponseUnmarshaller.Instance;
            response.SendUsersMessageResponse = unmarshaller.Unmarshall(context);
        ...
        private static SendUsersMessagesResponseUnmarshaller _instance = new SendUsersMessagesResponseUnmarshaller();        

        internal static SendUsersMessagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendUsersMessagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
