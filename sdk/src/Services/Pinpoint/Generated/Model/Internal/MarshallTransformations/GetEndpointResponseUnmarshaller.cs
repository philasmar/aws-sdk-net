...
namespace Amazon.Pinpoint.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEndpointResponse response = new GetEndpointResponse();

            var unmarshaller = EndpointResponseUnmarshaller.Instance;
            response.EndpointResponse = unmarshaller.Unmarshall(context);
        ...
        internal static GetEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
