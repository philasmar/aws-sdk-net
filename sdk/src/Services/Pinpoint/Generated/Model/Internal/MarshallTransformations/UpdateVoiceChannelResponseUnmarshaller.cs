...
{
    /// <summary>
    /// Response Unmarshaller for UpdateVoiceChannel operation
    /// </summary>  
    public class UpdateVoiceChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateVoiceChannelResponse response = new UpdateVoiceChannelResponse();
        ...
        private static UpdateVoiceChannelResponseUnmarshaller _instance = new UpdateVoiceChannelResponseUnmarshaller();        

        internal static UpdateVoiceChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateVoiceChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
