...
{
    /// <summary>
    /// Response Unmarshaller for SendMessages operation
    /// </summary>  
    public class SendMessagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static SendMessagesResponseUnmarshaller _instance = new SendMessagesResponseUnmarshaller();        

        internal static SendMessagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendMessagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
