...
{
    /// <summary>
    /// Response Unmarshaller for DeleteUserEndpoints operation
    /// </summary>  
    public class DeleteUserEndpointsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteUserEndpointsResponse response = new DeleteUserEndpointsResponse();

            var unmarshaller = EndpointsResponseUnmarshaller.Instance;
            response.EndpointsResponse = unmarshaller.Unmarshall(context);
        ...
        private static DeleteUserEndpointsResponseUnmarshaller _instance = new DeleteUserEndpointsResponseUnmarshaller();        

        internal static DeleteUserEndpointsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteUserEndpointsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
