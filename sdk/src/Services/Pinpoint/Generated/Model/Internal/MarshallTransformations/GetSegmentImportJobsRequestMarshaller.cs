...
{
    /// <summary>
    /// GetSegmentImportJobs Request Marshaller
    /// </summary>       
    public class GetSegmentImportJobsRequestMarshaller : IMarshaller<IRequest, GetSegmentImportJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSegmentImportJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSegmentImportJobsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/apps/{application-id}/segments/{segment-id}/jobs/import";
            request.MarshallerVersion = 2;
            request.UseQueryString = true;

            return request;
        }
        private static GetSegmentImportJobsRequestMarshaller _instance = new GetSegmentImportJobsRequestMarshaller();        

        internal static GetSegmentImportJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSegmentImportJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
