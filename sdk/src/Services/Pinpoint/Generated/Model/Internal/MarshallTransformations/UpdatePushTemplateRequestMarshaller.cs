...
{
    /// <summary>
    /// UpdatePushTemplate Request Marshaller
    /// </summary>       
    public class UpdatePushTemplateRequestMarshaller : IMarshaller<IRequest, UpdatePushTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdatePushTemplateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdatePushTemplateRequest publicRequest)
        {
        ...
        private static UpdatePushTemplateRequestMarshaller _instance = new UpdatePushTemplateRequestMarshaller();        

        internal static UpdatePushTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePushTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
