...
{
    /// <summary>
    /// Response Unmarshaller for GetSegmentVersions operation
    /// </summary>  
    public class GetSegmentVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetSegmentVersionsResponseUnmarshaller _instance = new GetSegmentVersionsResponseUnmarshaller();        

        internal static GetSegmentVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSegmentVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
