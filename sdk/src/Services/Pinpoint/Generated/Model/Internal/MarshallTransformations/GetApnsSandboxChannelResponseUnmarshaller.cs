...
{
    /// <summary>
    /// Response Unmarshaller for GetApnsSandboxChannel operation
    /// </summary>  
    public class GetApnsSandboxChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetApnsSandboxChannelResponse response = new GetApnsSandboxChannelResponse();
        ...
        private static GetApnsSandboxChannelResponseUnmarshaller _instance = new GetApnsSandboxChannelResponseUnmarshaller();        

        internal static GetApnsSandboxChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetApnsSandboxChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
