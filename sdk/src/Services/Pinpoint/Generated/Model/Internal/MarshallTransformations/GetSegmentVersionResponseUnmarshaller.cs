...
{
    /// <summary>
    /// Response Unmarshaller for GetSegmentVersion operation
    /// </summary>  
    public class GetSegmentVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSegmentVersionResponse response = new GetSegmentVersionResponse();
        ...
        private static GetSegmentVersionResponseUnmarshaller _instance = new GetSegmentVersionResponseUnmarshaller();        

        internal static GetSegmentVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSegmentVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
