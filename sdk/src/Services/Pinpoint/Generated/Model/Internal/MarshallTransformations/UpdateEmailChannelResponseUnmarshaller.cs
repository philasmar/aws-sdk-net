...
{
    /// <summary>
    /// Response Unmarshaller for UpdateEmailChannel operation
    /// </summary>  
    public class UpdateEmailChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateEmailChannelResponseUnmarshaller _instance = new UpdateEmailChannelResponseUnmarshaller();        

        internal static UpdateEmailChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEmailChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
