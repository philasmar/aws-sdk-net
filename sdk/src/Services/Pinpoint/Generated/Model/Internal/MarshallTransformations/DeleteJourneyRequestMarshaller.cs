...
{
    /// <summary>
    /// DeleteJourney Request Marshaller
    /// </summary>       
    public class DeleteJourneyRequestMarshaller : IMarshaller<IRequest, DeleteJourneyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteJourneyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteJourneyRequest publicRequest)
        {
        ...
        private static DeleteJourneyRequestMarshaller _instance = new DeleteJourneyRequestMarshaller();        

        internal static DeleteJourneyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteJourneyRequestMarshaller Instance
        {
            get
            {
                return _instance;
