...
{
    /// <summary>
    /// Response Unmarshaller for GetCampaignVersions operation
    /// </summary>  
    public class GetCampaignVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCampaignVersionsResponse response = new GetCampaignVersionsResponse();
        ...
        private static GetCampaignVersionsResponseUnmarshaller _instance = new GetCampaignVersionsResponseUnmarshaller();        

        internal static GetCampaignVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCampaignVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
