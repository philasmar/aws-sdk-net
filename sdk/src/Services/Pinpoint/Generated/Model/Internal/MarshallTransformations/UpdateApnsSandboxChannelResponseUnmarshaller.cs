...
{
    /// <summary>
    /// Response Unmarshaller for UpdateApnsSandboxChannel operation
    /// </summary>  
    public class UpdateApnsSandboxChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateApnsSandboxChannelResponseUnmarshaller _instance = new UpdateApnsSandboxChannelResponseUnmarshaller();        

        internal static UpdateApnsSandboxChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateApnsSandboxChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
