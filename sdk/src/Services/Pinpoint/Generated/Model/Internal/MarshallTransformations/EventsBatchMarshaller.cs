...
{
    /// <summary>
    /// EventsBatch Marshaller
    /// </summary>       
    public class EventsBatchMarshaller : IRequestMarshaller<EventsBatch, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(EventsBatch requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetEndpoint())
            {
                ...
                var marshaller = PublicEndpointMarshaller.Instance;
        ...
        /// </summary>  
        public readonly static EventsBatchMarshaller Instance = new EventsBatchMarshaller();
