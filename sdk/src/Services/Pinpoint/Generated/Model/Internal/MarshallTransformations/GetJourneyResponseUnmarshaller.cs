...
{
    /// <summary>
    /// Response Unmarshaller for GetJourney operation
    /// </summary>  
    public class GetJourneyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetJourneyResponseUnmarshaller _instance = new GetJourneyResponseUnmarshaller();        

        internal static GetJourneyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetJourneyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
