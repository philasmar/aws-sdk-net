...
{
    /// <summary>
    /// Response Unmarshaller for GetCampaigns operation
    /// </summary>  
    public class GetCampaignsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetCampaignsResponseUnmarshaller _instance = new GetCampaignsResponseUnmarshaller();        

        internal static GetCampaignsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCampaignsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
