...
{
    /// <summary>
    /// GetEmailChannel Request Marshaller
    /// </summary>       
    public class GetEmailChannelRequestMarshaller : IMarshaller<IRequest, GetEmailChannelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetEmailChannelRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetEmailChannelRequest publicRequest)
        {
