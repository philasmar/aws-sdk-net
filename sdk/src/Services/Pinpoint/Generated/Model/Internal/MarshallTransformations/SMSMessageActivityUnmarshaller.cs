...
{
    /// <summary>
    /// Response Unmarshaller for SMSMessageActivity Object
    /// </summary>  
    public class SMSMessageActivityUnmarshaller : IUnmarshaller<SMSMessageActivity, XmlUnmarshallerContext>, IUnmarshaller<SMSMessageActivity, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SMSMessageActivity IUnmarshaller<SMSMessageActivity, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public SMSMessageActivity Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = JourneySMSMessageUnmarshaller.Instance;
        ...
        private static SMSMessageActivityUnmarshaller _instance = new SMSMessageActivityUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SMSMessageActivityUnmarshaller Instance
        {
            get
            {
                return _instance;
