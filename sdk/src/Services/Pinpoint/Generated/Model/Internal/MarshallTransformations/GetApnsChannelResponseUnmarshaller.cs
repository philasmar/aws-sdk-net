...
{
    /// <summary>
    /// Response Unmarshaller for GetApnsChannel operation
    /// </summary>  
    public class GetApnsChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetApnsChannelResponse response = new GetApnsChannelResponse();
        ...
        private static GetApnsChannelResponseUnmarshaller _instance = new GetApnsChannelResponseUnmarshaller();        

        internal static GetApnsChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetApnsChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
