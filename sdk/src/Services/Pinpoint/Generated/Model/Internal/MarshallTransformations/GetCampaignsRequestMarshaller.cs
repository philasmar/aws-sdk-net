...
{
    /// <summary>
    /// GetCampaigns Request Marshaller
    /// </summary>       
    public class GetCampaignsRequestMarshaller : IMarshaller<IRequest, GetCampaignsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCampaignsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCampaignsRequest publicRequest)
        {
        ...
        private static GetCampaignsRequestMarshaller _instance = new GetCampaignsRequestMarshaller();        

        internal static GetCampaignsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCampaignsRequestMarshaller Instance
        {
            get
            {
                return _instance;
