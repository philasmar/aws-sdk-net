...
{
    /// <summary>
    /// Response Unmarshaller for GetBaiduChannel operation
    /// </summary>  
    public class GetBaiduChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetBaiduChannelResponseUnmarshaller _instance = new GetBaiduChannelResponseUnmarshaller();        

        internal static GetBaiduChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBaiduChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
