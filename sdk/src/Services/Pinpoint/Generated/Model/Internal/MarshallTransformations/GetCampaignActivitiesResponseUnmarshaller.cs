...
{
    /// <summary>
    /// Response Unmarshaller for GetCampaignActivities operation
    /// </summary>  
    public class GetCampaignActivitiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCampaignActivitiesResponse response = new GetCampaignActivitiesResponse();

            var unmarshaller = ActivitiesResponseUnmarshaller.Instance;
            response.ActivitiesResponse = unmarshaller.Unmarshall(context);
        ...
        private static GetCampaignActivitiesResponseUnmarshaller _instance = new GetCampaignActivitiesResponseUnmarshaller();        

        internal static GetCampaignActivitiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCampaignActivitiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
