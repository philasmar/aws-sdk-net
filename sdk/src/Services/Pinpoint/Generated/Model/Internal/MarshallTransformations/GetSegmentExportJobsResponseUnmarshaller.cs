...
{
    /// <summary>
    /// Response Unmarshaller for GetSegmentExportJobs operation
    /// </summary>  
    public class GetSegmentExportJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSegmentExportJobsResponse response = new GetSegmentExportJobsResponse();
        ...
        private static GetSegmentExportJobsResponseUnmarshaller _instance = new GetSegmentExportJobsResponseUnmarshaller();        

        internal static GetSegmentExportJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSegmentExportJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
