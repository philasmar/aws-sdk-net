...
{
    /// <summary>
    /// Response Unmarshaller for UpdateApnsChannel operation
    /// </summary>  
    public class UpdateApnsChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateApnsChannelResponseUnmarshaller _instance = new UpdateApnsChannelResponseUnmarshaller();        

        internal static UpdateApnsChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateApnsChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
