...
{
    /// <summary>
    /// GetCampaignActivities Request Marshaller
    /// </summary>       
    public class GetCampaignActivitiesRequestMarshaller : IMarshaller<IRequest, GetCampaignActivitiesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCampaignActivitiesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCampaignActivitiesRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/apps/{application-id}/campaigns/{campaign-id}/activities";
            request.MarshallerVersion = 2;
            request.UseQueryString = true;

            return request;
        }
        private static GetCampaignActivitiesRequestMarshaller _instance = new GetCampaignActivitiesRequestMarshaller();        

        internal static GetCampaignActivitiesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCampaignActivitiesRequestMarshaller Instance
        {
            get
            {
                return _instance;
