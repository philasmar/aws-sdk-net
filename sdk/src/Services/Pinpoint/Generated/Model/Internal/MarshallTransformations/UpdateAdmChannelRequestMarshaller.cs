...
{
    /// <summary>
    /// UpdateAdmChannel Request Marshaller
    /// </summary>       
    public class UpdateAdmChannelRequestMarshaller : IMarshaller<IRequest, UpdateAdmChannelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAdmChannelRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAdmChannelRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                var marshaller = ADMChannelRequestMarshaller.Instance;
                marshaller.Marshall(publicRequest.ADMChannelRequest, context);
