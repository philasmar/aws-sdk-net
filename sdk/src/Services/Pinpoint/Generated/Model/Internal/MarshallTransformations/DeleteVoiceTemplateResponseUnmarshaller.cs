...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVoiceTemplate operation
    /// </summary>  
    public class DeleteVoiceTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVoiceTemplateResponse response = new DeleteVoiceTemplateResponse();
        ...
        private static DeleteVoiceTemplateResponseUnmarshaller _instance = new DeleteVoiceTemplateResponseUnmarshaller();        

        internal static DeleteVoiceTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVoiceTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
