...
{
    /// <summary>
    /// Response Unmarshaller for UpdateGcmChannel operation
    /// </summary>  
    public class UpdateGcmChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateGcmChannelResponseUnmarshaller _instance = new UpdateGcmChannelResponseUnmarshaller();        

        internal static UpdateGcmChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateGcmChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
