...
{
    /// <summary>
    /// Response Unmarshaller for UpdateJourney operation
    /// </summary>  
    public class UpdateJourneyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateJourneyResponse response = new UpdateJourneyResponse();
        ...
        private static UpdateJourneyResponseUnmarshaller _instance = new UpdateJourneyResponseUnmarshaller();        

        internal static UpdateJourneyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateJourneyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
