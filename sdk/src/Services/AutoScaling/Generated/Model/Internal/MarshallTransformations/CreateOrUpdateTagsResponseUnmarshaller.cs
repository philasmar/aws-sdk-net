...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateOrUpdateTagsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateOrUpdateTagsResult", 2))
                    {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOrUpdateTagsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
