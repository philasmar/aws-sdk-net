...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateAutoScalingGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAutoScalingGroupResponse response = new CreateAutoScalingGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateAutoScalingGroupResult", 2))
                    {
        ...
        private static CreateAutoScalingGroupResponseUnmarshaller _instance = new CreateAutoScalingGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAutoScalingGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
