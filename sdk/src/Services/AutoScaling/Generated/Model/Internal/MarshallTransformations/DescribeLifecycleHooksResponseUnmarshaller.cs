...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeLifecycleHooksResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLifecycleHooksResponse response = new DescribeLifecycleHooksResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeLifecycleHooksResult", 2))
                    {
        ...
        private static DescribeLifecycleHooksResponseUnmarshaller _instance = new DescribeLifecycleHooksResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLifecycleHooksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
