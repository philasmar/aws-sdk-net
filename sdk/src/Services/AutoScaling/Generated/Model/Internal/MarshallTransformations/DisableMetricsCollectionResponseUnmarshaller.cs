...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisableMetricsCollectionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisableMetricsCollectionResponse response = new DisableMetricsCollectionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DisableMetricsCollectionResult", 2))
                    {
        ...
        private static DisableMetricsCollectionResponseUnmarshaller _instance = new DisableMetricsCollectionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableMetricsCollectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
