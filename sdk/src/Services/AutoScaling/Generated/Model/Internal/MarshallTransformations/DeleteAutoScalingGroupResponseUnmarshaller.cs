    ...
    public class DeleteAutoScalingGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteAutoScalingGroupResult", 2))
                    {
        ...
        private static DeleteAutoScalingGroupResponseUnmarshaller _instance = new DeleteAutoScalingGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAutoScalingGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
