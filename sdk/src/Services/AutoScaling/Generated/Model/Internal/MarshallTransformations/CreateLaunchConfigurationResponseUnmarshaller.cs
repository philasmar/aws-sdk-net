...
namespace Amazon.AutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateLaunchConfigurationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateLaunchConfigurationResult", 2))
                    {
        ...
        private static CreateLaunchConfigurationResponseUnmarshaller _instance = new CreateLaunchConfigurationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLaunchConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
