...
{
    /// <summary>
    /// UpdateProvisionedProductProperties Request Marshaller
    /// </summary>       
    public class UpdateProvisionedProductPropertiesRequestMarshaller : IMarshaller<IRequest, UpdateProvisionedProductPropertiesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateProvisionedProductPropertiesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateProvisionedProductPropertiesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ServiceCatalog");
            string target = "AWS242ServiceCatalogService.UpdateProvisionedProductProperties";
        ...
        private static UpdateProvisionedProductPropertiesRequestMarshaller _instance = new UpdateProvisionedProductPropertiesRequestMarshaller();        

        internal static UpdateProvisionedProductPropertiesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProvisionedProductPropertiesRequestMarshaller Instance
        {
            get
            {
                return _instance;
