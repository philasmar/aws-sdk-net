...
{
    /// <summary>
    /// Response Unmarshaller for GetProvisionedProductOutputs operation
    /// </summary>  
    public class GetProvisionedProductOutputsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetProvisionedProductOutputsResponse response = new GetProvisionedProductOutputsResponse();
        ...
        private static GetProvisionedProductOutputsResponseUnmarshaller _instance = new GetProvisionedProductOutputsResponseUnmarshaller();        

        internal static GetProvisionedProductOutputsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetProvisionedProductOutputsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
