...
{
    /// <summary>
    /// ListLaunchPaths Request Marshaller
    /// </summary>       
    public class ListLaunchPathsRequestMarshaller : IMarshaller<IRequest, ListLaunchPathsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListLaunchPathsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListLaunchPathsRequest publicRequest)
        {
        ...
        private static ListLaunchPathsRequestMarshaller _instance = new ListLaunchPathsRequestMarshaller();        

        internal static ListLaunchPathsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLaunchPathsRequestMarshaller Instance
        {
            get
            {
                return _instance;
