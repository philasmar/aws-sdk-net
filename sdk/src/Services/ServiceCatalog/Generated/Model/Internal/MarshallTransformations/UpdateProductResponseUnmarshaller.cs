...
{
    /// <summary>
    /// Response Unmarshaller for UpdateProduct operation
    /// </summary>  
    public class UpdateProductResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateProductResponseUnmarshaller _instance = new UpdateProductResponseUnmarshaller();        

        internal static UpdateProductResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProductResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
