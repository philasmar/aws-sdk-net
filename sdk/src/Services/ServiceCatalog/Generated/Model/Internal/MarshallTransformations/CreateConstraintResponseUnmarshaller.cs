...
{
    /// <summary>
    /// Response Unmarshaller for CreateConstraint operation
    /// </summary>  
    public class CreateConstraintResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateConstraintResponseUnmarshaller _instance = new CreateConstraintResponseUnmarshaller();        

        internal static CreateConstraintResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConstraintResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
