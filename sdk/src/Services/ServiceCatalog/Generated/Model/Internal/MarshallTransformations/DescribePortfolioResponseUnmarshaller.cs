...
{
    /// <summary>
    /// Response Unmarshaller for DescribePortfolio operation
    /// </summary>  
    public class DescribePortfolioResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribePortfolioResponse response = new DescribePortfolioResponse();
        ...
        private static DescribePortfolioResponseUnmarshaller _instance = new DescribePortfolioResponseUnmarshaller();        

        internal static DescribePortfolioResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePortfolioResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
