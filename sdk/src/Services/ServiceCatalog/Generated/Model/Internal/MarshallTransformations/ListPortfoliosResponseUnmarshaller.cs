...
{
    /// <summary>
    /// Response Unmarshaller for ListPortfolios operation
    /// </summary>  
    public class ListPortfoliosResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListPortfoliosResponseUnmarshaller _instance = new ListPortfoliosResponseUnmarshaller();        

        internal static ListPortfoliosResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPortfoliosResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
