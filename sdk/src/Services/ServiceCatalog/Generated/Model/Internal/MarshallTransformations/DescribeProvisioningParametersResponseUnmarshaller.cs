    ...
    public class DescribeProvisioningParametersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ProvisioningArtifactOutput, ProvisioningArtifactOutputUnmarshaller>(ProvisioningArtifactOutputUnmarshaller.Instance);
                    response.ProvisioningArtifactOutputs = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("ProvisioningArtifactPreferences", targetDepth))
                {
                    ...
                    response.ProvisioningArtifactPreferences = unmarshaller.Unmarshall(context);
                    continue;
                }
