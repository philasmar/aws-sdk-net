...
{
    /// <summary>
    /// Response Unmarshaller for DeletePortfolio operation
    /// </summary>  
    public class DeletePortfolioResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeletePortfolioResponseUnmarshaller _instance = new DeletePortfolioResponseUnmarshaller();        

        internal static DeletePortfolioResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePortfolioResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
