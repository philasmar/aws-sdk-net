...
{
    /// <summary>
    /// Response Unmarshaller for ListServiceActionsForProvisioningArtifact operation
    /// </summary>  
    public class ListServiceActionsForProvisioningArtifactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListServiceActionsForProvisioningArtifactResponseUnmarshaller _instance = new ListServiceActionsForProvisioningArtifactResponseUnmarshaller();        

        internal static ListServiceActionsForProvisioningArtifactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListServiceActionsForProvisioningArtifactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
