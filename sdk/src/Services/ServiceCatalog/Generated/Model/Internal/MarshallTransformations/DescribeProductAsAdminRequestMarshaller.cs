...
{
    /// <summary>
    /// DescribeProductAsAdmin Request Marshaller
    /// </summary>       
    public class DescribeProductAsAdminRequestMarshaller : IMarshaller<IRequest, DescribeProductAsAdminRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeProductAsAdminRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeProductAsAdminRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ServiceCatalog");
            string target = "AWS242ServiceCatalogService.DescribeProductAsAdmin";
