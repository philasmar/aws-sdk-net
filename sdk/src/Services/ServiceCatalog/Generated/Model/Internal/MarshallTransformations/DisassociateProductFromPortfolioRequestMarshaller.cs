...
{
    /// <summary>
    /// DisassociateProductFromPortfolio Request Marshaller
    /// </summary>       
    public class DisassociateProductFromPortfolioRequestMarshaller : IMarshaller<IRequest, DisassociateProductFromPortfolioRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateProductFromPortfolioRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateProductFromPortfolioRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ServiceCatalog");
            string target = "AWS242ServiceCatalogService.DisassociateProductFromPortfolio";
