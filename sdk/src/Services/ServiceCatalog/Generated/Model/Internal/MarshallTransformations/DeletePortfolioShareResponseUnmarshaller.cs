...
{
    /// <summary>
    /// Response Unmarshaller for DeletePortfolioShare operation
    /// </summary>  
    public class DeletePortfolioShareResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePortfolioShareResponse response = new DeletePortfolioShareResponse();
        ...
        private static DeletePortfolioShareResponseUnmarshaller _instance = new DeletePortfolioShareResponseUnmarshaller();        

        internal static DeletePortfolioShareResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePortfolioShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
