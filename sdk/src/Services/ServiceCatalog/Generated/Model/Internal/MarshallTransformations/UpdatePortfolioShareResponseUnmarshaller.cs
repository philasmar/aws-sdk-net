...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePortfolioShare operation
    /// </summary>  
    public class UpdatePortfolioShareResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePortfolioShareResponse response = new UpdatePortfolioShareResponse();
        ...
        private static UpdatePortfolioShareResponseUnmarshaller _instance = new UpdatePortfolioShareResponseUnmarshaller();        

        internal static UpdatePortfolioShareResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePortfolioShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
