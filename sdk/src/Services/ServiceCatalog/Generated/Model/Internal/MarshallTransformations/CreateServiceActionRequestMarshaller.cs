...
{
    /// <summary>
    /// CreateServiceAction Request Marshaller
    /// </summary>       
    public class CreateServiceActionRequestMarshaller : IMarshaller<IRequest, CreateServiceActionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateServiceActionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateServiceActionRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetDefinitionType())
                {
                    context.Writer.WritePropertyName("DefinitionType");
                    context.Writer.Write(publicRequest.DefinitionType);
                }
        ...
        private static CreateServiceActionRequestMarshaller _instance = new CreateServiceActionRequestMarshaller();        

        internal static CreateServiceActionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateServiceActionRequestMarshaller Instance
        {
            get
            {
                return _instance;
