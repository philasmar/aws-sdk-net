...
{
    /// <summary>
    /// AssociateTagOptionWithResource Request Marshaller
    /// </summary>       
    public class AssociateTagOptionWithResourceRequestMarshaller : IMarshaller<IRequest, AssociateTagOptionWithResourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateTagOptionWithResourceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateTagOptionWithResourceRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ServiceCatalog");
            string target = "AWS242ServiceCatalogService.AssociateTagOptionWithResource";
