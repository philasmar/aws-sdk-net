...
{
    /// <summary>
    /// Response Unmarshaller for ListAcceptedPortfolioShares operation
    /// </summary>  
    public class ListAcceptedPortfolioSharesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListAcceptedPortfolioSharesResponseUnmarshaller _instance = new ListAcceptedPortfolioSharesResponseUnmarshaller();        

        internal static ListAcceptedPortfolioSharesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAcceptedPortfolioSharesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
