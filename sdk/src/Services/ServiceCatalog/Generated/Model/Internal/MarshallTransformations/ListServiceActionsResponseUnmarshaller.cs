...
{
    /// <summary>
    /// Response Unmarshaller for ListServiceActions operation
    /// </summary>  
    public class ListServiceActionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListServiceActionsResponse response = new ListServiceActionsResponse();
        ...
        private static ListServiceActionsResponseUnmarshaller _instance = new ListServiceActionsResponseUnmarshaller();        

        internal static ListServiceActionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListServiceActionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
