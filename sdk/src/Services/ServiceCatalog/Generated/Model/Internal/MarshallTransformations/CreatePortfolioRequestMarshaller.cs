...
{
    /// <summary>
    /// CreatePortfolio Request Marshaller
    /// </summary>       
    public class CreatePortfolioRequestMarshaller : IMarshaller<IRequest, CreatePortfolioRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreatePortfolioRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreatePortfolioRequest publicRequest)
        {
        ...
        private static CreatePortfolioRequestMarshaller _instance = new CreatePortfolioRequestMarshaller();        

        internal static CreatePortfolioRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePortfolioRequestMarshaller Instance
        {
            get
            {
                return _instance;
