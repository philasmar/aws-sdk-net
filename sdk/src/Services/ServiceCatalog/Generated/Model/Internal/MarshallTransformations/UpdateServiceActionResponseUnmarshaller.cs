...
{
    /// <summary>
    /// Response Unmarshaller for UpdateServiceAction operation
    /// </summary>  
    public class UpdateServiceActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateServiceActionResponse response = new UpdateServiceActionResponse();
        ...
        private static UpdateServiceActionResponseUnmarshaller _instance = new UpdateServiceActionResponseUnmarshaller();        

        internal static UpdateServiceActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateServiceActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
