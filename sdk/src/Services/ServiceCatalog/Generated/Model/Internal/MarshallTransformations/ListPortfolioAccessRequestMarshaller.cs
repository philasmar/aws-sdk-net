...
{
    /// <summary>
    /// ListPortfolioAccess Request Marshaller
    /// </summary>       
    public class ListPortfolioAccessRequestMarshaller : IMarshaller<IRequest, ListPortfolioAccessRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListPortfolioAccessRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListPortfolioAccessRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ServiceCatalog");
            string target = "AWS242ServiceCatalogService.ListPortfolioAccess";
        ...
        private static ListPortfolioAccessRequestMarshaller _instance = new ListPortfolioAccessRequestMarshaller();        

        internal static ListPortfolioAccessRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPortfolioAccessRequestMarshaller Instance
        {
            get
            {
                return _instance;
