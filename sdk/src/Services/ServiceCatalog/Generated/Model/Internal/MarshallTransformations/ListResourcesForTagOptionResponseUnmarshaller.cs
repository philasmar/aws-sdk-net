...
{
    /// <summary>
    /// Response Unmarshaller for ListResourcesForTagOption operation
    /// </summary>  
    public class ListResourcesForTagOptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListResourcesForTagOptionResponseUnmarshaller _instance = new ListResourcesForTagOptionResponseUnmarshaller();        

        internal static ListResourcesForTagOptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListResourcesForTagOptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
