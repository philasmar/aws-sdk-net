...
{
    /// <summary>
    /// ListAcceptedPortfolioShares Request Marshaller
    /// </summary>       
    public class ListAcceptedPortfolioSharesRequestMarshaller : IMarshaller<IRequest, ListAcceptedPortfolioSharesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAcceptedPortfolioSharesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAcceptedPortfolioSharesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ServiceCatalog");
            string target = "AWS242ServiceCatalogService.ListAcceptedPortfolioShares";
