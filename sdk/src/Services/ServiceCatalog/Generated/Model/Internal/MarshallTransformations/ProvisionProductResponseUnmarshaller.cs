...
{
    /// <summary>
    /// Response Unmarshaller for ProvisionProduct operation
    /// </summary>  
    public class ProvisionProductResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ProvisionProductResponse response = new ProvisionProductResponse();
        ...
        private static ProvisionProductResponseUnmarshaller _instance = new ProvisionProductResponseUnmarshaller();        

        internal static ProvisionProductResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ProvisionProductResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
