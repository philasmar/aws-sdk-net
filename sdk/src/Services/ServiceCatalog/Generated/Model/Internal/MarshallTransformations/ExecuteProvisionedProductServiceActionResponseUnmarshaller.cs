...
{
    /// <summary>
    /// Response Unmarshaller for ExecuteProvisionedProductServiceAction operation
    /// </summary>  
    public class ExecuteProvisionedProductServiceActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExecuteProvisionedProductServiceActionResponse response = new ExecuteProvisionedProductServiceActionResponse();
        ...
        private static ExecuteProvisionedProductServiceActionResponseUnmarshaller _instance = new ExecuteProvisionedProductServiceActionResponseUnmarshaller();        

        internal static ExecuteProvisionedProductServiceActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExecuteProvisionedProductServiceActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
