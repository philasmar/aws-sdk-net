...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRecord operation
    /// </summary>  
    public class DescribeRecordResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeRecordResponseUnmarshaller _instance = new DescribeRecordResponseUnmarshaller();        

        internal static DescribeRecordResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRecordResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
