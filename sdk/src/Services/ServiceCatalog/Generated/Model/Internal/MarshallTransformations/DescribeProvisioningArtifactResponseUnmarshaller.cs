...
{
    /// <summary>
    /// Response Unmarshaller for DescribeProvisioningArtifact operation
    /// </summary>  
    public class DescribeProvisioningArtifactResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeProvisioningArtifactResponse response = new DescribeProvisioningArtifactResponse();
        ...
        private static DescribeProvisioningArtifactResponseUnmarshaller _instance = new DescribeProvisioningArtifactResponseUnmarshaller();        

        internal static DescribeProvisioningArtifactResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeProvisioningArtifactResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
