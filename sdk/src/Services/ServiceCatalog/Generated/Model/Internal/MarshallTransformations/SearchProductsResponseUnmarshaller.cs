...
{
    /// <summary>
    /// Response Unmarshaller for SearchProducts operation
    /// </summary>  
    public class SearchProductsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static SearchProductsResponseUnmarshaller _instance = new SearchProductsResponseUnmarshaller();        

        internal static SearchProductsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchProductsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
