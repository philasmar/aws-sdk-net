...
{
    /// <summary>
    /// ScanProvisionedProducts Request Marshaller
    /// </summary>       
    public class ScanProvisionedProductsRequestMarshaller : IMarshaller<IRequest, ScanProvisionedProductsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ScanProvisionedProductsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ScanProvisionedProductsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ServiceCatalog");
            string target = "AWS242ServiceCatalogService.ScanProvisionedProducts";
        ...
        private static ScanProvisionedProductsRequestMarshaller _instance = new ScanProvisionedProductsRequestMarshaller();        

        internal static ScanProvisionedProductsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ScanProvisionedProductsRequestMarshaller Instance
        {
            get
            {
                return _instance;
