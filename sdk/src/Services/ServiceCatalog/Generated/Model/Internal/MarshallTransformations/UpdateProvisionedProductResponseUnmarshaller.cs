...
{
    /// <summary>
    /// Response Unmarshaller for UpdateProvisionedProduct operation
    /// </summary>  
    public class UpdateProvisionedProductResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateProvisionedProductResponse response = new UpdateProvisionedProductResponse();
        ...
        private static UpdateProvisionedProductResponseUnmarshaller _instance = new UpdateProvisionedProductResponseUnmarshaller();        

        internal static UpdateProvisionedProductResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateProvisionedProductResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
