...
{
    /// <summary>
    /// Response Unmarshaller for CreateServiceAction operation
    /// </summary>  
    public class CreateServiceActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateServiceActionResponse response = new CreateServiceActionResponse();
        ...
        private static CreateServiceActionResponseUnmarshaller _instance = new CreateServiceActionResponseUnmarshaller();        

        internal static CreateServiceActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateServiceActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
