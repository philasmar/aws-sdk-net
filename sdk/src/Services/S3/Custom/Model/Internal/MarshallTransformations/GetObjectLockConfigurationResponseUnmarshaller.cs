...
namespace Amazon.S3.Model.Internal.MarshallTransformations
{
    ...
    public class GetObjectLockConfigurationResponseUnmarshaller : S3ReponseUnmarshaller
    {
        ...
        {
            GetObjectLockConfigurationResponse response = new GetObjectLockConfigurationResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, GetObjectLockConfigurationResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = ObjectLockConfigurationUnmarshaller.Instance;
                        response.ObjectLockConfiguration = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
