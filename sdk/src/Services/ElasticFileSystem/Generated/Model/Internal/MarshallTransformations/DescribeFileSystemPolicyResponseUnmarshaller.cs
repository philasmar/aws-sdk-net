...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFileSystemPolicy operation
    /// </summary>  
    public class DescribeFileSystemPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFileSystemPolicyResponse response = new DescribeFileSystemPolicyResponse();
        ...
        private static DescribeFileSystemPolicyResponseUnmarshaller _instance = new DescribeFileSystemPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFileSystemPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
