...
namespace Amazon.ElasticFileSystem.Model.Internal.MarshallTransformations
{
    ...
    public class DescribeMountTargetSecurityGroupsRequestMarshaller : IMarshaller<IRequest, DescribeMountTargetSecurityGroupsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        private static DescribeMountTargetSecurityGroupsRequestMarshaller _instance = new DescribeMountTargetSecurityGroupsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMountTargetSecurityGroupsRequestMarshaller Instance
        {
            get
            {
                return _instance;
