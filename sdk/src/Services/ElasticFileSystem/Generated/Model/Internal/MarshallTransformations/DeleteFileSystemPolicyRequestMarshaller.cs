...
{
    /// <summary>
    /// DeleteFileSystemPolicy Request Marshaller
    /// </summary>       
    public class DeleteFileSystemPolicyRequestMarshaller : IMarshaller<IRequest, DeleteFileSystemPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteFileSystemPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteFileSystemPolicyRequest publicRequest)
        {
        ...
        private static DeleteFileSystemPolicyRequestMarshaller _instance = new DeleteFileSystemPolicyRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFileSystemPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
