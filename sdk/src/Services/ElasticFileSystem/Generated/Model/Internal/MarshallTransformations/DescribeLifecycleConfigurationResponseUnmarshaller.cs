...
namespace Amazon.ElasticFileSystem.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeLifecycleConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLifecycleConfigurationResponse response = new DescribeLifecycleConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<LifecyclePolicy, LifecyclePolicyUnmarshaller>(LifecyclePolicyUnmarshaller.Instance);
                    response.LifecyclePolicies = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeLifecycleConfigurationResponseUnmarshaller _instance = new DescribeLifecycleConfigurationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLifecycleConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
