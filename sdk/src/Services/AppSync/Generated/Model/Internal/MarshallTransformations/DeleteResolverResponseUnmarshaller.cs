...
{
    /// <summary>
    /// Response Unmarshaller for DeleteResolver operation
    /// </summary>  
    public class DeleteResolverResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteResolverResponse response = new DeleteResolverResponse();
        ...
        private static DeleteResolverResponseUnmarshaller _instance = new DeleteResolverResponseUnmarshaller();        

        internal static DeleteResolverResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteResolverResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
