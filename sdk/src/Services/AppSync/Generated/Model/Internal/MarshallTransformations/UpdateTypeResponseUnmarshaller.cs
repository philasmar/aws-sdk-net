...
{
    /// <summary>
    /// Response Unmarshaller for UpdateType operation
    /// </summary>  
    public class UpdateTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateTypeResponseUnmarshaller _instance = new UpdateTypeResponseUnmarshaller();        

        internal static UpdateTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
