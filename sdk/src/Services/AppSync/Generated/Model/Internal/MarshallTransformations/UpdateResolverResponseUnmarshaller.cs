...
{
    /// <summary>
    /// Response Unmarshaller for UpdateResolver operation
    /// </summary>  
    public class UpdateResolverResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateResolverResponse response = new UpdateResolverResponse();
        ...
        private static UpdateResolverResponseUnmarshaller _instance = new UpdateResolverResponseUnmarshaller();        

        internal static UpdateResolverResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateResolverResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
