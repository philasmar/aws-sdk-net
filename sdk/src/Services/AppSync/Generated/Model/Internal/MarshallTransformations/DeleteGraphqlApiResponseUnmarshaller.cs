...
{
    /// <summary>
    /// Response Unmarshaller for DeleteGraphqlApi operation
    /// </summary>  
    public class DeleteGraphqlApiResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteGraphqlApiResponse response = new DeleteGraphqlApiResponse();
        ...
        private static DeleteGraphqlApiResponseUnmarshaller _instance = new DeleteGraphqlApiResponseUnmarshaller();        

        internal static DeleteGraphqlApiResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGraphqlApiResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
