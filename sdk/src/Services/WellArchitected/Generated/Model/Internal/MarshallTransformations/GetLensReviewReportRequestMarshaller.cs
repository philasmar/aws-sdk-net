...
namespace Amazon.WellArchitected.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetLensReviewReportRequestMarshaller : IMarshaller<IRequest, GetLensReviewReportRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetLensReviewReportRequestMarshaller _instance = new GetLensReviewReportRequestMarshaller();        

        internal static GetLensReviewReportRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLensReviewReportRequestMarshaller Instance
        {
            get
            {
                return _instance;
