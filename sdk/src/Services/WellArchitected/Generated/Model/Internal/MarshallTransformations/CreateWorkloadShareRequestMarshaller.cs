...
{
    /// <summary>
    /// CreateWorkloadShare Request Marshaller
    /// </summary>       
    public class CreateWorkloadShareRequestMarshaller : IMarshaller<IRequest, CreateWorkloadShareRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateWorkloadShareRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateWorkloadShareRequest publicRequest)
        {
        ...
        private static CreateWorkloadShareRequestMarshaller _instance = new CreateWorkloadShareRequestMarshaller();        

        internal static CreateWorkloadShareRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateWorkloadShareRequestMarshaller Instance
        {
            get
            {
                return _instance;
