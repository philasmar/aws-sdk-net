...
{
    /// <summary>
    /// Response Unmarshaller for GetLensReview operation
    /// </summary>  
    public class GetLensReviewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLensReviewResponse response = new GetLensReviewResponse();
        ...
        private static GetLensReviewResponseUnmarshaller _instance = new GetLensReviewResponseUnmarshaller();        

        internal static GetLensReviewResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLensReviewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
