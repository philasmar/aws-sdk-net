...
{
    /// <summary>
    /// Response Unmarshaller for ListStateMachines operation
    /// </summary>  
    public class ListStateMachinesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListStateMachinesResponseUnmarshaller _instance = new ListStateMachinesResponseUnmarshaller();        

        internal static ListStateMachinesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListStateMachinesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
