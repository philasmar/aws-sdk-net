...
{
    /// <summary>
    /// Response Unmarshaller for GetExecutionHistory operation
    /// </summary>  
    public class GetExecutionHistoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetExecutionHistoryResponseUnmarshaller _instance = new GetExecutionHistoryResponseUnmarshaller();        

        internal static GetExecutionHistoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetExecutionHistoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
