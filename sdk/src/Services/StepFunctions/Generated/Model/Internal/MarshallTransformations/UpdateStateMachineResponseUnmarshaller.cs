...
{
    /// <summary>
    /// Response Unmarshaller for UpdateStateMachine operation
    /// </summary>  
    public class UpdateStateMachineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateStateMachineResponse response = new UpdateStateMachineResponse();
        ...
        private static UpdateStateMachineResponseUnmarshaller _instance = new UpdateStateMachineResponseUnmarshaller();        

        internal static UpdateStateMachineResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateStateMachineResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
