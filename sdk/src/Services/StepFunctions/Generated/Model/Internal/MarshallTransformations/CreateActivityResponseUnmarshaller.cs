...
{
    /// <summary>
    /// Response Unmarshaller for CreateActivity operation
    /// </summary>  
    public class CreateActivityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("ActivityLimitExceeded"))
                {
                    return ActivityLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CreateActivityResponseUnmarshaller _instance = new CreateActivityResponseUnmarshaller();        

        internal static CreateActivityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateActivityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
