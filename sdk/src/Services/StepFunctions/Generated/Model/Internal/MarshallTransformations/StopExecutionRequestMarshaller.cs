...
{
    /// <summary>
    /// StopExecution Request Marshaller
    /// </summary>       
    public class StopExecutionRequestMarshaller : IMarshaller<IRequest, StopExecutionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StopExecutionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StopExecutionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.StepFunctions");
            string target = "AWSStepFunctions.StopExecution";
        ...
        private static StopExecutionRequestMarshaller _instance = new StopExecutionRequestMarshaller();        

        internal static StopExecutionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopExecutionRequestMarshaller Instance
        {
            get
            {
                return _instance;
