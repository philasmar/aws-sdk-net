...
{
    /// <summary>
    /// SendTaskHeartbeat Request Marshaller
    /// </summary>       
    public class SendTaskHeartbeatRequestMarshaller : IMarshaller<IRequest, SendTaskHeartbeatRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SendTaskHeartbeatRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SendTaskHeartbeatRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.StepFunctions");
            string target = "AWSStepFunctions.SendTaskHeartbeat";
