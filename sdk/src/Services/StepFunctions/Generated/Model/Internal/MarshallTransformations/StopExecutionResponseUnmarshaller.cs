...
{
    /// <summary>
    /// Response Unmarshaller for StopExecution operation
    /// </summary>  
    public class StopExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static StopExecutionResponseUnmarshaller _instance = new StopExecutionResponseUnmarshaller();        

        internal static StopExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
