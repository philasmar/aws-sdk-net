...
{
    /// <summary>
    /// DescribeStateMachineForExecution Request Marshaller
    /// </summary>       
    public class DescribeStateMachineForExecutionRequestMarshaller : IMarshaller<IRequest, DescribeStateMachineForExecutionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeStateMachineForExecutionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeStateMachineForExecutionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.StepFunctions");
            string target = "AWSStepFunctions.DescribeStateMachineForExecution";
