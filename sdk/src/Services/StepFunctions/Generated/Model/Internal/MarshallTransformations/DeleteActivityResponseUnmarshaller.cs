...
{
    /// <summary>
    /// Response Unmarshaller for DeleteActivity operation
    /// </summary>  
    public class DeleteActivityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteActivityResponseUnmarshaller _instance = new DeleteActivityResponseUnmarshaller();        

        internal static DeleteActivityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteActivityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
