...
{
    /// <summary>
    /// SendTaskSuccess Request Marshaller
    /// </summary>       
    public class SendTaskSuccessRequestMarshaller : IMarshaller<IRequest, SendTaskSuccessRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SendTaskSuccessRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SendTaskSuccessRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.StepFunctions");
            string target = "AWSStepFunctions.SendTaskSuccess";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetOutput())
                {
                    ...
                    context.Writer.Write(publicRequest.Output);
                }
