...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StopStreamEncryptionRequestMarshaller : IMarshaller<IRequest, StopStreamEncryptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StopStreamEncryptionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StopStreamEncryptionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Kinesis");
            string target = "Kinesis_20131202.StopStreamEncryption";
        ...
        private static StopStreamEncryptionRequestMarshaller _instance = new StopStreamEncryptionRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopStreamEncryptionRequestMarshaller Instance
        {
            get
            {
                return _instance;
