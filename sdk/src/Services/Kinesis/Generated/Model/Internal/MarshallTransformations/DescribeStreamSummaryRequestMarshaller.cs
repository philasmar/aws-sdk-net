...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeStreamSummaryRequestMarshaller : IMarshaller<IRequest, DescribeStreamSummaryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeStreamSummaryRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeStreamSummaryRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Kinesis");
            string target = "Kinesis_20131202.DescribeStreamSummary";
