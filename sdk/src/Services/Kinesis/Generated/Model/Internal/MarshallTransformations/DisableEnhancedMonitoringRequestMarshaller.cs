...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DisableEnhancedMonitoringRequestMarshaller : IMarshaller<IRequest, DisableEnhancedMonitoringRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisableEnhancedMonitoringRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisableEnhancedMonitoringRequest publicRequest)
        {
        ...
        private static DisableEnhancedMonitoringRequestMarshaller _instance = new DisableEnhancedMonitoringRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableEnhancedMonitoringRequestMarshaller Instance
        {
            get
            {
                return _instance;
