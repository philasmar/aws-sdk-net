...
namespace Amazon.Kinesis.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisableEnhancedMonitoringResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisableEnhancedMonitoringResponse response = new DisableEnhancedMonitoringResponse();
        ...
        private static DisableEnhancedMonitoringResponseUnmarshaller _instance = new DisableEnhancedMonitoringResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableEnhancedMonitoringResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
