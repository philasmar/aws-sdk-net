...
{
    /// <summary>
    /// GetFindingStatistics Request Marshaller
    /// </summary>       
    public class GetFindingStatisticsRequestMarshaller : IMarshaller<IRequest, GetFindingStatisticsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetFindingStatisticsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetFindingStatisticsRequest publicRequest)
        {
        ...
        private static GetFindingStatisticsRequestMarshaller _instance = new GetFindingStatisticsRequestMarshaller();        

        internal static GetFindingStatisticsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetFindingStatisticsRequestMarshaller Instance
        {
            get
            {
                return _instance;
