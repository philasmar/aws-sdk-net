...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeBucketsRequestMarshaller : IMarshaller<IRequest, DescribeBucketsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DescribeBucketsRequestMarshaller _instance = new DescribeBucketsRequestMarshaller();        

        internal static DescribeBucketsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBucketsRequestMarshaller Instance
        {
            get
            {
                return _instance;
