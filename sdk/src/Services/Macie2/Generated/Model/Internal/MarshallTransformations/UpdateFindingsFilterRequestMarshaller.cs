...
{
    /// <summary>
    /// UpdateFindingsFilter Request Marshaller
    /// </summary>       
    public class UpdateFindingsFilterRequestMarshaller : IMarshaller<IRequest, UpdateFindingsFilterRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateFindingsFilterRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateFindingsFilterRequest publicRequest)
        {
        ...
        private static UpdateFindingsFilterRequestMarshaller _instance = new UpdateFindingsFilterRequestMarshaller();        

        internal static UpdateFindingsFilterRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFindingsFilterRequestMarshaller Instance
        {
            get
            {
                return _instance;
