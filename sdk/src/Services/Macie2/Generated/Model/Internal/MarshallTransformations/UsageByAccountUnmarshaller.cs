...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UsageByAccountUnmarshaller : IUnmarshaller<UsageByAccount, XmlUnmarshallerContext>, IUnmarshaller<UsageByAccount, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        UsageByAccount IUnmarshaller<UsageByAccount, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public UsageByAccount Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("serviceLimit", targetDepth))
                {
                    ...
                    unmarshalledObject.ServiceLimit = unmarshaller.Unmarshall(context);
                    continue;
                }
