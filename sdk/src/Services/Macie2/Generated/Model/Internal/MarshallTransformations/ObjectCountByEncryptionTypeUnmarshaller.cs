...
namespace Amazon.Macie2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ObjectCountByEncryptionTypeUnmarshaller : IUnmarshaller<ObjectCountByEncryptionType, XmlUnmarshallerContext>, IUnmarshaller<ObjectCountByEncryptionType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ObjectCountByEncryptionType IUnmarshaller<ObjectCountByEncryptionType, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ObjectCountByEncryptionType Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
