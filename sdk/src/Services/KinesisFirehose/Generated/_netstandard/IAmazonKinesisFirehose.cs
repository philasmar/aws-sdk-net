...
namespace Amazon.KinesisFirehose
{
    ...
    public partial interface IAmazonKinesisFirehose : IAmazonService, IDisposable
    {
        ...
        Task<StartDeliveryStreamEncryptionResponse> StartDeliveryStreamEncryptionAsync(StartDeliveryStreamEncryptionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<StopDeliveryStreamEncryptionResponse> StopDeliveryStreamEncryptionAsync(StopDeliveryStreamEncryptionRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
