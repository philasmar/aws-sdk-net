...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutRecordBatchResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutRecordBatchResponse response = new PutRecordBatchResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PutRecordBatchResponseEntry, PutRecordBatchResponseEntryUnmarshaller>(PutRecordBatchResponseEntryUnmarshaller.Instance);
                    response.RequestResponses = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static PutRecordBatchResponseUnmarshaller _instance = new PutRecordBatchResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutRecordBatchResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
