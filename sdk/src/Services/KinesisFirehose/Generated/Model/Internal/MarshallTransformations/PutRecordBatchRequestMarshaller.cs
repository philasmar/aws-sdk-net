...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PutRecordBatchRequestMarshaller : IMarshaller<IRequest, PutRecordBatchRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutRecordBatchRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutRecordBatchRequest publicRequest)
        {
