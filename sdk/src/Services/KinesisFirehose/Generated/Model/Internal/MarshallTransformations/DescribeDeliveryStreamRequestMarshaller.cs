...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeDeliveryStreamRequestMarshaller : IMarshaller<IRequest, DescribeDeliveryStreamRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeDeliveryStreamRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeDeliveryStreamRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.KinesisFirehose");
            string target = "Firehose_20150804.DescribeDeliveryStream";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetExclusiveStartDestinationId())
                {
                    context.Writer.WritePropertyName("ExclusiveStartDestinationId");
                    context.Writer.Write(publicRequest.ExclusiveStartDestinationId);
                }
