...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    public class KinesisStreamSourceConfigurationMarshaller : IRequestMarshaller<KinesisStreamSourceConfiguration, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(KinesisStreamSourceConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetKinesisStreamARN())
            {
                context.Writer.WritePropertyName("KinesisStreamARN");
                context.Writer.Write(requestObject.KinesisStreamARN);
            }
