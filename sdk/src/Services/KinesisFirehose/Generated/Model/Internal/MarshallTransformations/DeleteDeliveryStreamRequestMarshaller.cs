...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteDeliveryStreamRequestMarshaller : IMarshaller<IRequest, DeleteDeliveryStreamRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteDeliveryStreamRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteDeliveryStreamRequest publicRequest)
        {
