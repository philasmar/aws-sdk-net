...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StopDeliveryStreamEncryptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopDeliveryStreamEncryptionResponse response = new StopDeliveryStreamEncryptionResponse();
        ...
        private static StopDeliveryStreamEncryptionResponseUnmarshaller _instance = new StopDeliveryStreamEncryptionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopDeliveryStreamEncryptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
