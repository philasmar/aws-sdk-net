...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListDeliveryStreamsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDeliveryStreamsResponse response = new ListDeliveryStreamsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DeliveryStreamNames", targetDepth))
                {
                    ...
                    response.DeliveryStreamNames = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListDeliveryStreamsResponseUnmarshaller _instance = new ListDeliveryStreamsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDeliveryStreamsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
