...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    public class DataFormatConversionConfigurationUnmarshaller : IUnmarshaller<DataFormatConversionConfiguration, XmlUnmarshallerContext>, IUnmarshaller<DataFormatConversionConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static DataFormatConversionConfigurationUnmarshaller _instance = new DataFormatConversionConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DataFormatConversionConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
