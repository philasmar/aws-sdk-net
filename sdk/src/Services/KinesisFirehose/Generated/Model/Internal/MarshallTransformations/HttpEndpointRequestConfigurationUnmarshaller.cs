...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    public class HttpEndpointRequestConfigurationUnmarshaller : IUnmarshaller<HttpEndpointRequestConfiguration, XmlUnmarshallerContext>, IUnmarshaller<HttpEndpointRequestConfiguration, JsonUnmarshallerContext>
    {
        ...
        private static HttpEndpointRequestConfigurationUnmarshaller _instance = new HttpEndpointRequestConfigurationUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HttpEndpointRequestConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
