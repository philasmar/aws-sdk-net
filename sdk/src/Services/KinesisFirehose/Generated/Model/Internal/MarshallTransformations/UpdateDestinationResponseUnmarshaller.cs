...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateDestinationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDestinationResponse response = new UpdateDestinationResponse();
        ...
        private static UpdateDestinationResponseUnmarshaller _instance = new UpdateDestinationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDestinationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
