...
namespace Amazon.KinesisFirehose.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteDeliveryStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDeliveryStreamResponse response = new DeleteDeliveryStreamResponse();
        ...
        private static DeleteDeliveryStreamResponseUnmarshaller _instance = new DeleteDeliveryStreamResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDeliveryStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
