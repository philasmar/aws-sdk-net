...
namespace Amazon.MediaTailor.Model
{
    ...
    public partial class PutPlaybackConfigurationResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Gets and sets the property ManifestProcessingRules. The configuration for manifest
        /// processing rules. Manifest processing rules enable customization of the personalized
