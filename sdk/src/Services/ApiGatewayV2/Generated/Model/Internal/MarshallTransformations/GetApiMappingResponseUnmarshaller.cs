...
{
    /// <summary>
    /// Response Unmarshaller for GetApiMapping operation
    /// </summary>  
    public class GetApiMappingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetApiMappingResponse response = new GetApiMappingResponse();
        ...
        private static GetApiMappingResponseUnmarshaller _instance = new GetApiMappingResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetApiMappingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
