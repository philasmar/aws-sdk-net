...
{
    /// <summary>
    /// Response Unmarshaller for CreateApi operation
    /// </summary>  
    public class CreateApiResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateApiResponseUnmarshaller _instance = new CreateApiResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateApiResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
