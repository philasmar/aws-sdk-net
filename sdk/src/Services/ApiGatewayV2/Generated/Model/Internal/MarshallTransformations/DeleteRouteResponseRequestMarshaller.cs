...
{
    /// <summary>
    /// DeleteRouteResponse Request Marshaller
    /// </summary>       
    public class DeleteRouteResponseRequestMarshaller : IMarshaller<IRequest, DeleteRouteResponseRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteRouteResponseRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteRouteResponseRequest publicRequest)
        {
        ...
        private static DeleteRouteResponseRequestMarshaller _instance = new DeleteRouteResponseRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRouteResponseRequestMarshaller Instance
        {
            get
            {
                return _instance;
