...
namespace Amazon.IoTJobsDataPlane.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class JobExecutionStateUnmarshaller : IUnmarshaller<JobExecutionState, XmlUnmarshallerContext>, IUnmarshaller<JobExecutionState, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        JobExecutionState IUnmarshaller<JobExecutionState, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public JobExecutionState Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
