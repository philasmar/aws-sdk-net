...
{
    /// <summary>
    /// Response Unmarshaller for PutMethodResponse operation
    /// </summary>  
    public class PutMethodResponseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutMethodResponseResponse response = new PutMethodResponseResponse();
        ...
        private static PutMethodResponseResponseUnmarshaller _instance = new PutMethodResponseResponseUnmarshaller();        

        internal static PutMethodResponseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutMethodResponseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
