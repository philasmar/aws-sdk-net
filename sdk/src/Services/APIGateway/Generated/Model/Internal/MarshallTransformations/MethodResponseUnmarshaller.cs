...
namespace Amazon.APIGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class MethodResponseUnmarshaller : IUnmarshaller<MethodResponse, XmlUnmarshallerContext>, IUnmarshaller<MethodResponse, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        MethodResponse IUnmarshaller<MethodResponse, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public MethodResponse Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
