...
{
    /// <summary>
    /// Response Unmarshaller for PutIntegrationResponse operation
    /// </summary>  
    public class PutIntegrationResponseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutIntegrationResponseResponse response = new PutIntegrationResponseResponse();
        ...
        private static PutIntegrationResponseResponseUnmarshaller _instance = new PutIntegrationResponseResponseUnmarshaller();        

        internal static PutIntegrationResponseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutIntegrationResponseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
