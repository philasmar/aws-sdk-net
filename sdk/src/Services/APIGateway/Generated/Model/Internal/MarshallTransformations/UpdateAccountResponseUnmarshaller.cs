...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAccount operation
    /// </summary>  
    public class UpdateAccountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateAccountResponseUnmarshaller _instance = new UpdateAccountResponseUnmarshaller();        

        internal static UpdateAccountResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAccountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
