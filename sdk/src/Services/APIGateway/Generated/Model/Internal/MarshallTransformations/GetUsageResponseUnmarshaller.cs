...
{
    /// <summary>
    /// Response Unmarshaller for GetUsage operation
    /// </summary>  
    public class GetUsageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetUsageResponseUnmarshaller _instance = new GetUsageResponseUnmarshaller();        

        internal static GetUsageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUsageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
