...
{
    /// <summary>
    /// Response Unmarshaller for CreateRestApi operation
    /// </summary>  
    public class CreateRestApiResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRestApiResponse response = new CreateRestApiResponse();
        ...
        private static CreateRestApiResponseUnmarshaller _instance = new CreateRestApiResponseUnmarshaller();        

        internal static CreateRestApiResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRestApiResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
