...
{
    /// <summary>
    /// Response Unmarshaller for GetRestApi operation
    /// </summary>  
    public class GetRestApiResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRestApiResponse response = new GetRestApiResponse();
        ...
        private static GetRestApiResponseUnmarshaller _instance = new GetRestApiResponseUnmarshaller();        

        internal static GetRestApiResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRestApiResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
