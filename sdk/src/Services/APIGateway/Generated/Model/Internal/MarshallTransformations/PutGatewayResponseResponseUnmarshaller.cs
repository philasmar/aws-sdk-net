...
{
    /// <summary>
    /// Response Unmarshaller for PutGatewayResponse operation
    /// </summary>  
    public class PutGatewayResponseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutGatewayResponseResponse response = new PutGatewayResponseResponse();
        ...
        private static PutGatewayResponseResponseUnmarshaller _instance = new PutGatewayResponseResponseUnmarshaller();        

        internal static PutGatewayResponseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutGatewayResponseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
