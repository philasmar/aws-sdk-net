...
{
    /// <summary>
    /// Response Unmarshaller for ImportApiKeys operation
    /// </summary>  
    public class ImportApiKeysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportApiKeysResponse response = new ImportApiKeysResponse();
        ...
        private static ImportApiKeysResponseUnmarshaller _instance = new ImportApiKeysResponseUnmarshaller();        

        internal static ImportApiKeysResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportApiKeysResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
