...
{
    /// <summary>
    /// Response Unmarshaller for CreateUsagePlan operation
    /// </summary>  
    public class CreateUsagePlanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateUsagePlanResponse response = new CreateUsagePlanResponse();
        ...
        private static CreateUsagePlanResponseUnmarshaller _instance = new CreateUsagePlanResponseUnmarshaller();        

        internal static CreateUsagePlanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateUsagePlanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
