...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFileSystemAliases operation
    /// </summary>  
    public class DescribeFileSystemAliasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFileSystemAliasesResponse response = new DescribeFileSystemAliasesResponse();
        ...
        private static DescribeFileSystemAliasesResponseUnmarshaller _instance = new DescribeFileSystemAliasesResponseUnmarshaller();        

        internal static DescribeFileSystemAliasesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFileSystemAliasesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
