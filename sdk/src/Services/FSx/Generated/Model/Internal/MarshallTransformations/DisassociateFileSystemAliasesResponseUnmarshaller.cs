...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateFileSystemAliases operation
    /// </summary>  
    public class DisassociateFileSystemAliasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateFileSystemAliasesResponse response = new DisassociateFileSystemAliasesResponse();
        ...
        private static DisassociateFileSystemAliasesResponseUnmarshaller _instance = new DisassociateFileSystemAliasesResponseUnmarshaller();        

        internal static DisassociateFileSystemAliasesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateFileSystemAliasesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
