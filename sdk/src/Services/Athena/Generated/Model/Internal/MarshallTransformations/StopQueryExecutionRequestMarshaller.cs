...
{
    /// <summary>
    /// StopQueryExecution Request Marshaller
    /// </summary>       
    public class StopQueryExecutionRequestMarshaller : IMarshaller<IRequest, StopQueryExecutionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StopQueryExecutionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StopQueryExecutionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Athena");
            string target = "AmazonAthena.StopQueryExecution";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                else if(!(publicRequest.IsSetQueryExecutionId()))
                {
                    context.Writer.WritePropertyName("QueryExecutionId");
