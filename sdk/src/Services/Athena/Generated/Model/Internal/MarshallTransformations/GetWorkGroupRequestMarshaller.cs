...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    public class GetWorkGroupRequestMarshaller : IMarshaller<IRequest, GetWorkGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(GetWorkGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Athena");
            string target = "AmazonAthena.GetWorkGroup";
        ...
        private static GetWorkGroupRequestMarshaller _instance = new GetWorkGroupRequestMarshaller();        

        internal static GetWorkGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWorkGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
