...
namespace Amazon.Athena.Model.Internal.MarshallTransformations
{
    ...
    public class GetWorkGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static GetWorkGroupResponseUnmarshaller _instance = new GetWorkGroupResponseUnmarshaller();        

        internal static GetWorkGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWorkGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
