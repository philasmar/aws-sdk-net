...
namespace Amazon.Athena.Model
{
    ...
    {
        private string _athenaErrorCode;
        ...
        protected InvalidRequestException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
            this.AthenaErrorCode = (string)info.GetValue("AthenaErrorCode", typeof(string));
        }
        ...
        public override void GetObjectData(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
        {
            ...
            info.AddValue("AthenaErrorCode", this.AthenaErrorCode);
        }
#endif

        /// <summary>
        /// Gets and sets the property AthenaErrorCode.
        /// </summary>
        [AWSProperty(Min=1, Max=256)]
        public string AthenaErrorCode
        {
            get { return this._athenaErrorCode; }
            set { this._athenaErrorCode = value; }
        }

        // Check to see if AthenaErrorCode property is set
        internal bool IsSetAthenaErrorCode()
        {
            return this._athenaErrorCode != null;
        }
