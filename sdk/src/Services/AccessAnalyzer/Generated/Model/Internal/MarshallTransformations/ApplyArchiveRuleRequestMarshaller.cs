...
{
    /// <summary>
    /// ApplyArchiveRule Request Marshaller
    /// </summary>       
    public class ApplyArchiveRuleRequestMarshaller : IMarshaller<IRequest, ApplyArchiveRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ApplyArchiveRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ApplyArchiveRuleRequest publicRequest)
        {
        ...
        private static ApplyArchiveRuleRequestMarshaller _instance = new ApplyArchiveRuleRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ApplyArchiveRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
