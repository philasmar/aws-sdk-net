...
{
    /// <summary>
    /// Response Unmarshaller for AnalyzedResource Object
    /// </summary>  
    public class AnalyzedResourceUnmarshaller : IUnmarshaller<AnalyzedResource, XmlUnmarshallerContext>, IUnmarshaller<AnalyzedResource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AnalyzedResource IUnmarshaller<AnalyzedResource, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AnalyzedResource Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<string, StringUnmarshaller>(StringUnmarshaller.Instance);
                    unmarshalledObject.SharedVia = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static AnalyzedResourceUnmarshaller _instance = new AnalyzedResourceUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AnalyzedResourceUnmarshaller Instance
        {
            get
            {
                return _instance;
