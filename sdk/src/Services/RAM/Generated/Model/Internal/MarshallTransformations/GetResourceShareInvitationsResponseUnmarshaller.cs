...
{
    /// <summary>
    /// Response Unmarshaller for GetResourceShareInvitations operation
    /// </summary>  
    public class GetResourceShareInvitationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetResourceShareInvitationsResponse response = new GetResourceShareInvitationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ResourceShareInvitation, ResourceShareInvitationUnmarshaller>(ResourceShareInvitationUnmarshaller.Instance);
                    response.ResourceShareInvitations = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetResourceShareInvitationsResponseUnmarshaller _instance = new GetResourceShareInvitationsResponseUnmarshaller();        

        internal static GetResourceShareInvitationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourceShareInvitationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
