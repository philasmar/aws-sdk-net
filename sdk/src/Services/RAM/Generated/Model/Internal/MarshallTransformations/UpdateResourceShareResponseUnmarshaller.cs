...
{
    /// <summary>
    /// Response Unmarshaller for UpdateResourceShare operation
    /// </summary>  
    public class UpdateResourceShareResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateResourceShareResponse response = new UpdateResourceShareResponse();
        ...
        private static UpdateResourceShareResponseUnmarshaller _instance = new UpdateResourceShareResponseUnmarshaller();        

        internal static UpdateResourceShareResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateResourceShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
