...
{
    /// <summary>
    /// Response Unmarshaller for AssociateResourceSharePermission operation
    /// </summary>  
    public class AssociateResourceSharePermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateResourceSharePermissionResponse response = new AssociateResourceSharePermissionResponse();
        ...
        private static AssociateResourceSharePermissionResponseUnmarshaller _instance = new AssociateResourceSharePermissionResponseUnmarshaller();        

        internal static AssociateResourceSharePermissionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateResourceSharePermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
