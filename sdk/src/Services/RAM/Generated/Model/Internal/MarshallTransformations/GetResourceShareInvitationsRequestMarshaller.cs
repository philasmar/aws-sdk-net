...
{
    /// <summary>
    /// GetResourceShareInvitations Request Marshaller
    /// </summary>       
    public class GetResourceShareInvitationsRequestMarshaller : IMarshaller<IRequest, GetResourceShareInvitationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetResourceShareInvitationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetResourceShareInvitationsRequest publicRequest)
        {
        ...
        private static GetResourceShareInvitationsRequestMarshaller _instance = new GetResourceShareInvitationsRequestMarshaller();        

        internal static GetResourceShareInvitationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourceShareInvitationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
