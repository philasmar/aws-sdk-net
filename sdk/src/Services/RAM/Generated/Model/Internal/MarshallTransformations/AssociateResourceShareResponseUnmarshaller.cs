...
{
    /// <summary>
    /// Response Unmarshaller for AssociateResourceShare operation
    /// </summary>  
    public class AssociateResourceShareResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateResourceShareResponse response = new AssociateResourceShareResponse();
        ...
        private static AssociateResourceShareResponseUnmarshaller _instance = new AssociateResourceShareResponseUnmarshaller();        

        internal static AssociateResourceShareResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateResourceShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
