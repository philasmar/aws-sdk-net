...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateResourceSharePermission operation
    /// </summary>  
    public class DisassociateResourceSharePermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateResourceSharePermissionResponse response = new DisassociateResourceSharePermissionResponse();
        ...
        private static DisassociateResourceSharePermissionResponseUnmarshaller _instance = new DisassociateResourceSharePermissionResponseUnmarshaller();        

        internal static DisassociateResourceSharePermissionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateResourceSharePermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
