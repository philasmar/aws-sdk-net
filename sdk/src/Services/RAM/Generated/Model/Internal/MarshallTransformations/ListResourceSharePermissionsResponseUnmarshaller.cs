...
{
    /// <summary>
    /// Response Unmarshaller for ListResourceSharePermissions operation
    /// </summary>  
    public class ListResourceSharePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListResourceSharePermissionsResponse response = new ListResourceSharePermissionsResponse();
        ...
        private static ListResourceSharePermissionsResponseUnmarshaller _instance = new ListResourceSharePermissionsResponseUnmarshaller();        

        internal static ListResourceSharePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListResourceSharePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
