...
{
    /// <summary>
    /// Response Unmarshaller for ListPrincipals operation
    /// </summary>  
    public class ListPrincipalsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPrincipalsResponse response = new ListPrincipalsResponse();
        ...
        private static ListPrincipalsResponseUnmarshaller _instance = new ListPrincipalsResponseUnmarshaller();        

        internal static ListPrincipalsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPrincipalsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
