...
{
    /// <summary>
    /// Response Unmarshaller for EnableSharingWithAwsOrganization operation
    /// </summary>  
    public class EnableSharingWithAwsOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnableSharingWithAwsOrganizationResponse response = new EnableSharingWithAwsOrganizationResponse();
        ...
        private static EnableSharingWithAwsOrganizationResponseUnmarshaller _instance = new EnableSharingWithAwsOrganizationResponseUnmarshaller();        

        internal static EnableSharingWithAwsOrganizationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableSharingWithAwsOrganizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
