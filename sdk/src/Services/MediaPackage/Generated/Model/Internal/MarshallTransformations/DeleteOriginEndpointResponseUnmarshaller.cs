...
{
    /// <summary>
    /// Response Unmarshaller for DeleteOriginEndpoint operation
    /// </summary>  
    public class DeleteOriginEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteOriginEndpointResponse response = new DeleteOriginEndpointResponse();
        ...
        private static DeleteOriginEndpointResponseUnmarshaller _instance = new DeleteOriginEndpointResponseUnmarshaller();        

        internal static DeleteOriginEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteOriginEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
