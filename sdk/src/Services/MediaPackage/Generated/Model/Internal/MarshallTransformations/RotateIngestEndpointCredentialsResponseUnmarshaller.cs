...
{
    /// <summary>
    /// Response Unmarshaller for RotateIngestEndpointCredentials operation
    /// </summary>  
    public class RotateIngestEndpointCredentialsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RotateIngestEndpointCredentialsResponse response = new RotateIngestEndpointCredentialsResponse();
        ...
        private static RotateIngestEndpointCredentialsResponseUnmarshaller _instance = new RotateIngestEndpointCredentialsResponseUnmarshaller();        

        internal static RotateIngestEndpointCredentialsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RotateIngestEndpointCredentialsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
