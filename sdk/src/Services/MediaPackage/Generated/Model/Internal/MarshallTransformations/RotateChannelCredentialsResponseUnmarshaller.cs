...
{
    /// <summary>
    /// Response Unmarshaller for RotateChannelCredentials operation
    /// </summary>  
    public class RotateChannelCredentialsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RotateChannelCredentialsResponse response = new RotateChannelCredentialsResponse();
        ...
        private static RotateChannelCredentialsResponseUnmarshaller _instance = new RotateChannelCredentialsResponseUnmarshaller();        

        internal static RotateChannelCredentialsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RotateChannelCredentialsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
