...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteRepositoryPolicyRequestMarshaller : IMarshaller<IRequest, DeleteRepositoryPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteRepositoryPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteRepositoryPolicyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECR");
            string target = "AmazonEC2ContainerRegistry_V20150921.DeleteRepositoryPolicy";
