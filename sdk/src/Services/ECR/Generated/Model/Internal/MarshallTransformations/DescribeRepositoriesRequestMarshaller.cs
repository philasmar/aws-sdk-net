...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeRepositoriesRequestMarshaller : IMarshaller<IRequest, DescribeRepositoriesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeRepositoriesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeRepositoriesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECR");
            string target = "AmazonEC2ContainerRegistry_V20150921.DescribeRepositories";
