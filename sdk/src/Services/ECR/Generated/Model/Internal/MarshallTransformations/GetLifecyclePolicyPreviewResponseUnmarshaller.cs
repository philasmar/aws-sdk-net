...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetLifecyclePolicyPreviewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLifecyclePolicyPreviewResponse response = new GetLifecyclePolicyPreviewResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<LifecyclePolicyPreviewResult, LifecyclePolicyPreviewResultUnmarshaller>(LifecyclePolicyPreviewResultUnmarshaller.Instance);
                ...
                {
                    var unmarshaller = LifecyclePolicyPreviewSummaryUnmarshaller.Instance;
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("LifecyclePolicyPreviewNotFoundException"))
                {
                    return LifecyclePolicyPreviewNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static GetLifecyclePolicyPreviewResponseUnmarshaller _instance = new GetLifecyclePolicyPreviewResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLifecyclePolicyPreviewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
