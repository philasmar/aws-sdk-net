...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchGetImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGetImageResponse response = new BatchGetImageResponse();
        ...
        private static BatchGetImageResponseUnmarshaller _instance = new BatchGetImageResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
