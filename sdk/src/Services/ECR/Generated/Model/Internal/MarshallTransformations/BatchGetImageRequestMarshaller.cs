...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class BatchGetImageRequestMarshaller : IMarshaller<IRequest, BatchGetImageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchGetImageRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchGetImageRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECR");
            string target = "AmazonEC2ContainerRegistry_V20150921.BatchGetImage";
        ...
        private static BatchGetImageRequestMarshaller _instance = new BatchGetImageRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGetImageRequestMarshaller Instance
        {
            get
            {
                return _instance;
