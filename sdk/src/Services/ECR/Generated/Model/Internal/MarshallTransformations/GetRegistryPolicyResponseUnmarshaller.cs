...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRegistryPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRegistryPolicyResponse response = new GetRegistryPolicyResponse();
        ...
        private static GetRegistryPolicyResponseUnmarshaller _instance = new GetRegistryPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRegistryPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
