...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PutLifecyclePolicyRequestMarshaller : IMarshaller<IRequest, PutLifecyclePolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutLifecyclePolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutLifecyclePolicyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECR");
            string target = "AmazonEC2ContainerRegistry_V20150921.PutLifecyclePolicy";
