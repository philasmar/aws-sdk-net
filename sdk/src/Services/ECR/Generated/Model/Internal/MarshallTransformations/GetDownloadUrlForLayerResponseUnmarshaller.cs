...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDownloadUrlForLayerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDownloadUrlForLayerResponse response = new GetDownloadUrlForLayerResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("LayerInaccessibleException"))
                {
                    return LayerInaccessibleExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static GetDownloadUrlForLayerResponseUnmarshaller _instance = new GetDownloadUrlForLayerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDownloadUrlForLayerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
