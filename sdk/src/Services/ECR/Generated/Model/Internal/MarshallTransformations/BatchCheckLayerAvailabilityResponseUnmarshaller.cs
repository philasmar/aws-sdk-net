...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchCheckLayerAvailabilityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchCheckLayerAvailabilityResponse response = new BatchCheckLayerAvailabilityResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<LayerFailure, LayerFailureUnmarshaller>(LayerFailureUnmarshaller.Instance);
        ...
        private static BatchCheckLayerAvailabilityResponseUnmarshaller _instance = new BatchCheckLayerAvailabilityResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchCheckLayerAvailabilityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
