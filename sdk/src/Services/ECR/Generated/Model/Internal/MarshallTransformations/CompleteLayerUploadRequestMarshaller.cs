...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CompleteLayerUploadRequestMarshaller : IMarshaller<IRequest, CompleteLayerUploadRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CompleteLayerUploadRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CompleteLayerUploadRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ECR");
            string target = "AmazonEC2ContainerRegistry_V20150921.CompleteLayerUpload";
