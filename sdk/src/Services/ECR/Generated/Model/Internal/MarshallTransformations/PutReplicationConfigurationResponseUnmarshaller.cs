...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutReplicationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutReplicationConfigurationResponse response = new PutReplicationConfigurationResponse();
        ...
        private static PutReplicationConfigurationResponseUnmarshaller _instance = new PutReplicationConfigurationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutReplicationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
