...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListImagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListImagesResponseUnmarshaller _instance = new ListImagesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListImagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
