...
namespace Amazon.ECR.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeRepositoriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeRepositoriesResponseUnmarshaller _instance = new DescribeRepositoriesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRepositoriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
