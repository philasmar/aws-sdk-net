...
namespace Amazon.ECR.Model
{
    ...
    /// </summary>
    internal sealed partial class DescribeImageScanFindingsPaginator : IPaginator<DescribeImageScanFindingsResponse>, IDescribeImageScanFindingsPaginator
    {
        ...
        /// </summary>
        public IPaginatedEnumerable<DescribeImageScanFindingsResponse> Responses => new PaginatedResponse<DescribeImageScanFindingsResponse>(this);
...
#if BCL
        IEnumerable<DescribeImageScanFindingsResponse> IPaginator<DescribeImageScanFindingsResponse>.Paginate()
        {
            ...
            DescribeImageScanFindingsResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.DescribeImageScanFindings(_request);
