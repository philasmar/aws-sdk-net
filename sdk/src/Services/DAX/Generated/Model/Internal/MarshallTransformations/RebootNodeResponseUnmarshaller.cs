...
namespace Amazon.DAX.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RebootNodeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RebootNodeResponse response = new RebootNodeResponse();
        ...
        private static RebootNodeResponseUnmarshaller _instance = new RebootNodeResponseUnmarshaller();        

        internal static RebootNodeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RebootNodeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
