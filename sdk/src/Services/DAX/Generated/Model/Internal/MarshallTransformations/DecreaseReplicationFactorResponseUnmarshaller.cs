...
namespace Amazon.DAX.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DecreaseReplicationFactorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DecreaseReplicationFactorResponse response = new DecreaseReplicationFactorResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("NodeNotFoundFault"))
                {
                    return NodeNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static DecreaseReplicationFactorResponseUnmarshaller _instance = new DecreaseReplicationFactorResponseUnmarshaller();        

        internal static DecreaseReplicationFactorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DecreaseReplicationFactorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
