...
namespace Amazon.DAX.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteParameterGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteParameterGroupResponse response = new DeleteParameterGroupResponse();
        ...
        private static DeleteParameterGroupResponseUnmarshaller _instance = new DeleteParameterGroupResponseUnmarshaller();        

        internal static DeleteParameterGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteParameterGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
