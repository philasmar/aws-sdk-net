...
namespace Amazon.DAX.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteSubnetGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSubnetGroupResponse response = new DeleteSubnetGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DeletionMessage", targetDepth))
                {
                    ...
                    response.DeletionMessage = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("SubnetGroupInUseFault"))
                {
                    return SubnetGroupInUseExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static DeleteSubnetGroupResponseUnmarshaller _instance = new DeleteSubnetGroupResponseUnmarshaller();        

        internal static DeleteSubnetGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSubnetGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
