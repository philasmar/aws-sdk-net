...
namespace Amazon.DAX.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IncreaseReplicationFactorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            IncreaseReplicationFactorResponse response = new IncreaseReplicationFactorResponse();
        ...
        private static IncreaseReplicationFactorResponseUnmarshaller _instance = new IncreaseReplicationFactorResponseUnmarshaller();        

        internal static IncreaseReplicationFactorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IncreaseReplicationFactorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
