...
namespace Amazon.DAX.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeSubnetGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSubnetGroupsResponse response = new DescribeSubnetGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SubnetGroup, SubnetGroupUnmarshaller>(SubnetGroupUnmarshaller.Instance);
                    response.SubnetGroups = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeSubnetGroupsResponseUnmarshaller _instance = new DescribeSubnetGroupsResponseUnmarshaller();        

        internal static DescribeSubnetGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSubnetGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
