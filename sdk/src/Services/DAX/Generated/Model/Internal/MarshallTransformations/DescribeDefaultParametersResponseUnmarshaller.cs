...
namespace Amazon.DAX.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeDefaultParametersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDefaultParametersResponse response = new DescribeDefaultParametersResponse();
        ...
        private static DescribeDefaultParametersResponseUnmarshaller _instance = new DescribeDefaultParametersResponseUnmarshaller();        

        internal static DescribeDefaultParametersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDefaultParametersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
