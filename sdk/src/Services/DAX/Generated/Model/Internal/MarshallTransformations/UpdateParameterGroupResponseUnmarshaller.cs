...
namespace Amazon.DAX.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateParameterGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateParameterGroupResponse response = new UpdateParameterGroupResponse();
        ...
        private static UpdateParameterGroupResponseUnmarshaller _instance = new UpdateParameterGroupResponseUnmarshaller();        

        internal static UpdateParameterGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateParameterGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
