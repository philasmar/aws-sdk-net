...
namespace Amazon.DAX.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeParameterGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeParameterGroupsResponseUnmarshaller _instance = new DescribeParameterGroupsResponseUnmarshaller();        

        internal static DescribeParameterGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeParameterGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
