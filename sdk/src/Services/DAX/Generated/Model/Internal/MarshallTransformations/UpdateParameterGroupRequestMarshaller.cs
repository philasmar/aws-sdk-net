...
namespace Amazon.DAX.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateParameterGroupRequestMarshaller : IMarshaller<IRequest, UpdateParameterGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateParameterGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateParameterGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DAX");
            string target = "AmazonDAXV3.UpdateParameterGroup";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                {
                    context.Writer.WritePropertyName("ParameterNameValues");
                    context.Writer.WriteArrayStart();
                    foreach(var publicRequestParameterNameValuesListValue in publicRequest.ParameterNameValues)
                    {
                        context.Writer.WriteObjectStart();

                        var marshaller = ParameterNameValueMarshaller.Instance;
                        marshaller.Marshall(publicRequestParameterNameValuesListValue, context);
