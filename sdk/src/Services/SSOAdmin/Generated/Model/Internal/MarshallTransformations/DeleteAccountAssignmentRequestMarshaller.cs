...
{
    /// <summary>
    /// DeleteAccountAssignment Request Marshaller
    /// </summary>       
    public class DeleteAccountAssignmentRequestMarshaller : IMarshaller<IRequest, DeleteAccountAssignmentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAccountAssignmentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteAccountAssignmentRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SSOAdmin");
            string target = "SWBExternalService.DeleteAccountAssignment";
        ...
        private static DeleteAccountAssignmentRequestMarshaller _instance = new DeleteAccountAssignmentRequestMarshaller();        

        internal static DeleteAccountAssignmentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAccountAssignmentRequestMarshaller Instance
        {
            get
            {
                return _instance;
