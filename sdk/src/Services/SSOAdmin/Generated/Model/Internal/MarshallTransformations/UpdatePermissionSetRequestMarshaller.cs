...
{
    /// <summary>
    /// UpdatePermissionSet Request Marshaller
    /// </summary>       
    public class UpdatePermissionSetRequestMarshaller : IMarshaller<IRequest, UpdatePermissionSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdatePermissionSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdatePermissionSetRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SSOAdmin");
            string target = "SWBExternalService.UpdatePermissionSet";
        ...
        private static UpdatePermissionSetRequestMarshaller _instance = new UpdatePermissionSetRequestMarshaller();        

        internal static UpdatePermissionSetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePermissionSetRequestMarshaller Instance
        {
            get
            {
                return _instance;
