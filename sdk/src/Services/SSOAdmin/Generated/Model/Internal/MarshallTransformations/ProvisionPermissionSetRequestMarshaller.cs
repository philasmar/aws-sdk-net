...
{
    /// <summary>
    /// ProvisionPermissionSet Request Marshaller
    /// </summary>       
    public class ProvisionPermissionSetRequestMarshaller : IMarshaller<IRequest, ProvisionPermissionSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ProvisionPermissionSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ProvisionPermissionSetRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SSOAdmin");
            string target = "SWBExternalService.ProvisionPermissionSet";
        ...
        private static ProvisionPermissionSetRequestMarshaller _instance = new ProvisionPermissionSetRequestMarshaller();        

        internal static ProvisionPermissionSetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ProvisionPermissionSetRequestMarshaller Instance
        {
            get
            {
                return _instance;
