...
{
    /// <summary>
    /// Response Unmarshaller for DeleteFolderContents operation
    /// </summary>  
    public class DeleteFolderContentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteFolderContentsResponse response = new DeleteFolderContentsResponse();
        ...
        private static DeleteFolderContentsResponseUnmarshaller _instance = new DeleteFolderContentsResponseUnmarshaller();        

        internal static DeleteFolderContentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFolderContentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
