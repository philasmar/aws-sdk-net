...
{
    /// <summary>
    /// Response Unmarshaller for DescribeActivities operation
    /// </summary>  
    public class DescribeActivitiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeActivitiesResponse response = new DescribeActivitiesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Activity, ActivityUnmarshaller>(ActivityUnmarshaller.Instance);
                    response.UserActivities = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeActivitiesResponseUnmarshaller _instance = new DescribeActivitiesResponseUnmarshaller();        

        internal static DescribeActivitiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeActivitiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
