...
{
    /// <summary>
    /// AbortDocumentVersionUpload Request Marshaller
    /// </summary>       
    public class AbortDocumentVersionUploadRequestMarshaller : IMarshaller<IRequest, AbortDocumentVersionUploadRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AbortDocumentVersionUploadRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AbortDocumentVersionUploadRequest publicRequest)
        {
