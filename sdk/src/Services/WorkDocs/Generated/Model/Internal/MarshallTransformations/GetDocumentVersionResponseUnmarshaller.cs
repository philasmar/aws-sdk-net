...
{
    /// <summary>
    /// Response Unmarshaller for GetDocumentVersion operation
    /// </summary>  
    public class GetDocumentVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetDocumentVersionResponseUnmarshaller _instance = new GetDocumentVersionResponseUnmarshaller();        

        internal static GetDocumentVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDocumentVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
