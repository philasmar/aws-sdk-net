...
{
    /// <summary>
    /// Response Unmarshaller for AbortDocumentVersionUpload operation
    /// </summary>  
    public class AbortDocumentVersionUploadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AbortDocumentVersionUploadResponse response = new AbortDocumentVersionUploadResponse();
        ...
        private static AbortDocumentVersionUploadResponseUnmarshaller _instance = new AbortDocumentVersionUploadResponseUnmarshaller();        

        internal static AbortDocumentVersionUploadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AbortDocumentVersionUploadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
