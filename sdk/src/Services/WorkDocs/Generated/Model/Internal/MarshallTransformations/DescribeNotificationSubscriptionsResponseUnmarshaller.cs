...
{
    /// <summary>
    /// Response Unmarshaller for DescribeNotificationSubscriptions operation
    /// </summary>  
    public class DescribeNotificationSubscriptionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeNotificationSubscriptionsResponse response = new DescribeNotificationSubscriptionsResponse();
        ...
        private static DescribeNotificationSubscriptionsResponseUnmarshaller _instance = new DescribeNotificationSubscriptionsResponseUnmarshaller();        

        internal static DescribeNotificationSubscriptionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeNotificationSubscriptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
