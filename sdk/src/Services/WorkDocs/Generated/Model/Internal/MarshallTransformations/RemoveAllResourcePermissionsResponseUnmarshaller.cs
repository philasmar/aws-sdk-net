...
{
    /// <summary>
    /// Response Unmarshaller for RemoveAllResourcePermissions operation
    /// </summary>  
    public class RemoveAllResourcePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveAllResourcePermissionsResponse response = new RemoveAllResourcePermissionsResponse();
        ...
        private static RemoveAllResourcePermissionsResponseUnmarshaller _instance = new RemoveAllResourcePermissionsResponseUnmarshaller();        

        internal static RemoveAllResourcePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveAllResourcePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
