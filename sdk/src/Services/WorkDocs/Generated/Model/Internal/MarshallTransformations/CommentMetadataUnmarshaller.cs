...
namespace Amazon.WorkDocs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CommentMetadataUnmarshaller : IUnmarshaller<CommentMetadata, XmlUnmarshallerContext>, IUnmarshaller<CommentMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CommentMetadata IUnmarshaller<CommentMetadata, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public CommentMetadata Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CommentStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
