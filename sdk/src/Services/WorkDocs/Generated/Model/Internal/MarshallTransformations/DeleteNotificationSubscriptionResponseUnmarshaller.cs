...
{
    /// <summary>
    /// Response Unmarshaller for DeleteNotificationSubscription operation
    /// </summary>  
    public class DeleteNotificationSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteNotificationSubscriptionResponse response = new DeleteNotificationSubscriptionResponse();
        ...
        private static DeleteNotificationSubscriptionResponseUnmarshaller _instance = new DeleteNotificationSubscriptionResponseUnmarshaller();        

        internal static DeleteNotificationSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteNotificationSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
