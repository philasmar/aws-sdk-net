...
{
    /// <summary>
    /// Response Unmarshaller for GetDocumentPath operation
    /// </summary>  
    public class GetDocumentPathResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDocumentPathResponse response = new GetDocumentPathResponse();
        ...
        private static GetDocumentPathResponseUnmarshaller _instance = new GetDocumentPathResponseUnmarshaller();        

        internal static GetDocumentPathResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDocumentPathResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
