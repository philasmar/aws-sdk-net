...
{
    /// <summary>
    /// Response Unmarshaller for DeleteCustomMetadata operation
    /// </summary>  
    public class DeleteCustomMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCustomMetadataResponse response = new DeleteCustomMetadataResponse();
        ...
        private static DeleteCustomMetadataResponseUnmarshaller _instance = new DeleteCustomMetadataResponseUnmarshaller();        

        internal static DeleteCustomMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCustomMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
