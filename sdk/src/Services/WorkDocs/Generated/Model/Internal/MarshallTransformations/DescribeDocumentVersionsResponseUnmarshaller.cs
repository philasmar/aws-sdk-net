...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDocumentVersions operation
    /// </summary>  
    public class DescribeDocumentVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDocumentVersionsResponse response = new DescribeDocumentVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DocumentVersionMetadata, DocumentVersionMetadataUnmarshaller>(DocumentVersionMetadataUnmarshaller.Instance);
                    response.DocumentVersions = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeDocumentVersionsResponseUnmarshaller _instance = new DescribeDocumentVersionsResponseUnmarshaller();        

        internal static DescribeDocumentVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDocumentVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
