...
{
    /// <summary>
    /// Response Unmarshaller for GetCurrentUser operation
    /// </summary>  
    public class GetCurrentUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetCurrentUserResponseUnmarshaller _instance = new GetCurrentUserResponseUnmarshaller();        

        internal static GetCurrentUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCurrentUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
