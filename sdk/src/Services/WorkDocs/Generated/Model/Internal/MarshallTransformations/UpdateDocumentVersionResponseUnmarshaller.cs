...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDocumentVersion operation
    /// </summary>  
    public class UpdateDocumentVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDocumentVersionResponse response = new UpdateDocumentVersionResponse();
        ...
        private static UpdateDocumentVersionResponseUnmarshaller _instance = new UpdateDocumentVersionResponseUnmarshaller();        

        internal static UpdateDocumentVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDocumentVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
