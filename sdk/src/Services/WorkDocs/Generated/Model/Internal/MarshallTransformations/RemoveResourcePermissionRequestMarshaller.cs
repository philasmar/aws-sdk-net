...
{
    /// <summary>
    /// RemoveResourcePermission Request Marshaller
    /// </summary>       
    public class RemoveResourcePermissionRequestMarshaller : IMarshaller<IRequest, RemoveResourcePermissionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RemoveResourcePermissionRequest)input);
        }
        ...
        private static RemoveResourcePermissionRequestMarshaller _instance = new RemoveResourcePermissionRequestMarshaller();        

        internal static RemoveResourcePermissionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveResourcePermissionRequestMarshaller Instance
        {
            get
            {
                return _instance;
