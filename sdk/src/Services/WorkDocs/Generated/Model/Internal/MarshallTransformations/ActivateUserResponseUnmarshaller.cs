...
{
    /// <summary>
    /// Response Unmarshaller for ActivateUser operation
    /// </summary>  
    public class ActivateUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ActivateUserResponseUnmarshaller _instance = new ActivateUserResponseUnmarshaller();        

        internal static ActivateUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ActivateUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
