...
{
    /// <summary>
    /// Response Unmarshaller for DescribeUsers operation
    /// </summary>  
    public class DescribeUsersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("TotalNumberOfUsers", targetDepth))
                {
                    ...
                    response.TotalNumberOfUsers = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("RequestedEntityTooLargeException"))
                {
                    return RequestedEntityTooLargeExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static DescribeUsersResponseUnmarshaller _instance = new DescribeUsersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeUsersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
