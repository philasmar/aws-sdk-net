...
{
    /// <summary>
    /// GetDocument Request Marshaller
    /// </summary>       
    public class GetDocumentRequestMarshaller : IMarshaller<IRequest, GetDocumentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetDocumentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetDocumentRequest publicRequest)
        {
        ...
        private static GetDocumentRequestMarshaller _instance = new GetDocumentRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDocumentRequestMarshaller Instance
        {
            get
            {
                return _instance;
