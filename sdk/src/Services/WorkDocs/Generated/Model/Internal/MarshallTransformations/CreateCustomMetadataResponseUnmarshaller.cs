...
{
    /// <summary>
    /// Response Unmarshaller for CreateCustomMetadata operation
    /// </summary>  
    public class CreateCustomMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCustomMetadataResponse response = new CreateCustomMetadataResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("CustomMetadataLimitExceededException"))
                {
                    return CustomMetadataLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CreateCustomMetadataResponseUnmarshaller _instance = new CreateCustomMetadataResponseUnmarshaller();        

        internal static CreateCustomMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCustomMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
