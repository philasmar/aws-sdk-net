...
{
    /// <summary>
    /// Response Unmarshaller for RemoveResourcePermission operation
    /// </summary>  
    public class RemoveResourcePermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveResourcePermissionResponse response = new RemoveResourcePermissionResponse();
        ...
        private static RemoveResourcePermissionResponseUnmarshaller _instance = new RemoveResourcePermissionResponseUnmarshaller();        

        internal static RemoveResourcePermissionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveResourcePermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
