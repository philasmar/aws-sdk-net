...
{
    /// <summary>
    /// GetDocumentPath Request Marshaller
    /// </summary>       
    public class GetDocumentPathRequestMarshaller : IMarshaller<IRequest, GetDocumentPathRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetDocumentPathRequest)input);
        }
        ...
        public IRequest Marshall(GetDocumentPathRequest publicRequest)
        {
            ...
            request.ResourcePath = "/api/v1/documents/{DocumentId}/path";
