...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRootFolders operation
    /// </summary>  
    public class DescribeRootFoldersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRootFoldersResponse response = new DescribeRootFoldersResponse();
        ...
        private static DescribeRootFoldersResponseUnmarshaller _instance = new DescribeRootFoldersResponseUnmarshaller();        

        internal static DescribeRootFoldersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRootFoldersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
