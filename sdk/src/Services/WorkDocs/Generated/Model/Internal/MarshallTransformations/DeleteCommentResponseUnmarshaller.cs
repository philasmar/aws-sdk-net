...
{
    /// <summary>
    /// Response Unmarshaller for DeleteComment operation
    /// </summary>  
    public class DeleteCommentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteCommentResponseUnmarshaller _instance = new DeleteCommentResponseUnmarshaller();        

        internal static DeleteCommentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCommentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
