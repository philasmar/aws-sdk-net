...
{
    /// <summary>
    /// Response Unmarshaller for CreateFolder operation
    /// </summary>  
    public class CreateFolderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateFolderResponseUnmarshaller _instance = new CreateFolderResponseUnmarshaller();        

        internal static CreateFolderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFolderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
