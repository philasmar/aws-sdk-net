...
{
    /// <summary>
    /// DeleteConfig Request Marshaller
    /// </summary>       
    public class DeleteConfigRequestMarshaller : IMarshaller<IRequest, DeleteConfigRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteConfigRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteConfigRequest publicRequest)
        {
        ...
        private static DeleteConfigRequestMarshaller _instance = new DeleteConfigRequestMarshaller();        

        internal static DeleteConfigRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteConfigRequestMarshaller Instance
        {
            get
            {
                return _instance;
