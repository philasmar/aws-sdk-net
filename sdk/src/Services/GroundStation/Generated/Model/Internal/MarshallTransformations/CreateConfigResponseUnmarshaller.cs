...
{
    /// <summary>
    /// Response Unmarshaller for CreateConfig operation
    /// </summary>  
    public class CreateConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateConfigResponseUnmarshaller _instance = new CreateConfigResponseUnmarshaller();        

        internal static CreateConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
