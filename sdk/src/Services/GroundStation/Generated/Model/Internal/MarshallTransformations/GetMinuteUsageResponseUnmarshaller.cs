...
{
    /// <summary>
    /// Response Unmarshaller for GetMinuteUsage operation
    /// </summary>  
    public class GetMinuteUsageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMinuteUsageResponse response = new GetMinuteUsageResponse();
        ...
        private static GetMinuteUsageResponseUnmarshaller _instance = new GetMinuteUsageResponseUnmarshaller();        

        internal static GetMinuteUsageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMinuteUsageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
