...
{
    /// <summary>
    /// ReserveContact Request Marshaller
    /// </summary>       
    public class ReserveContactRequestMarshaller : IMarshaller<IRequest, ReserveContactRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ReserveContactRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ReserveContactRequest publicRequest)
        {
        ...
        private static ReserveContactRequestMarshaller _instance = new ReserveContactRequestMarshaller();        

        internal static ReserveContactRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReserveContactRequestMarshaller Instance
        {
            get
            {
                return _instance;
