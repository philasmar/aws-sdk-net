...
namespace Amazon.GroundStation.Model
{
    ...
    public partial class Source
    {
        ...
        private string _dataflowSourceRegion;
        ...
        {
            get { return this._dataflowSourceRegion; }
            set { this._dataflowSourceRegion = value; }
        }

        // Check to see if DataflowSourceRegion property is set
        internal bool IsSetDataflowSourceRegion()
        {
            return this._dataflowSourceRegion != null;
        }
