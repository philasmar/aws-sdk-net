...
namespace Amazon.GroundStation.Model
{
    ...
    public partial class DependencyException : AmazonGroundStationException
    {
        ...
        public DependencyException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DependencyException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
