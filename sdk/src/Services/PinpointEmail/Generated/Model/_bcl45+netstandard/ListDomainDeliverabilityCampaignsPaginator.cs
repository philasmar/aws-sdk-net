...
namespace Amazon.PinpointEmail.Model
{
    ...
    internal sealed partial class ListDomainDeliverabilityCampaignsPaginator : IPaginator<ListDomainDeliverabilityCampaignsResponse>, IListDomainDeliverabilityCampaignsPaginator
    {
        ...
        async IAsyncEnumerable<ListDomainDeliverabilityCampaignsResponse> IPaginator<ListDomainDeliverabilityCampaignsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
