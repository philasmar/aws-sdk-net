...
namespace Amazon.PinpointEmail.Model
{
    ...
    public partial class IspPlacement
    {
        ...
        private PlacementStatistics _placementStatistics;
        ...
        {
            get { return this._placementStatistics; }
            set { this._placementStatistics = value; }
        }

        // Check to see if PlacementStatistics property is set
        internal bool IsSetPlacementStatistics()
        {
            return this._placementStatistics != null;
        }
