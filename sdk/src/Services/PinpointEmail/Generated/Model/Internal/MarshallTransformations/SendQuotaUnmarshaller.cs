...
{
    /// <summary>
    /// Response Unmarshaller for SendQuota Object
    /// </summary>  
    public class SendQuotaUnmarshaller : IUnmarshaller<SendQuota, XmlUnmarshallerContext>, IUnmarshaller<SendQuota, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SendQuota IUnmarshaller<SendQuota, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static SendQuotaUnmarshaller _instance = new SendQuotaUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static SendQuotaUnmarshaller Instance
        {
            get
            {
                return _instance;
