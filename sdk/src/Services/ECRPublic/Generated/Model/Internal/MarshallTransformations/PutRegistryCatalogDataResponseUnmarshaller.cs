...
namespace Amazon.ECRPublic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutRegistryCatalogDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutRegistryCatalogDataResponse response = new PutRegistryCatalogDataResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("registryCatalogData", targetDepth))
                {
                    ...
                    response.RegistryCatalogData = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static PutRegistryCatalogDataResponseUnmarshaller _instance = new PutRegistryCatalogDataResponseUnmarshaller();        

        internal static PutRegistryCatalogDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutRegistryCatalogDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
