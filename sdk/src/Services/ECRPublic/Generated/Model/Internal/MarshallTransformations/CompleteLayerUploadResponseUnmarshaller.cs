...
namespace Amazon.ECRPublic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CompleteLayerUploadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CompleteLayerUploadResponseUnmarshaller _instance = new CompleteLayerUploadResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CompleteLayerUploadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
