...
namespace Amazon.ECRPublic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InitiateLayerUploadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            InitiateLayerUploadResponse response = new InitiateLayerUploadResponse();
        ...
        private static InitiateLayerUploadResponseUnmarshaller _instance = new InitiateLayerUploadResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InitiateLayerUploadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
