...
namespace Amazon.ECRPublic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRepositoryCatalogDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRepositoryCatalogDataResponse response = new GetRepositoryCatalogDataResponse();
        ...
        private static GetRepositoryCatalogDataResponseUnmarshaller _instance = new GetRepositoryCatalogDataResponseUnmarshaller();        

        internal static GetRepositoryCatalogDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRepositoryCatalogDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
