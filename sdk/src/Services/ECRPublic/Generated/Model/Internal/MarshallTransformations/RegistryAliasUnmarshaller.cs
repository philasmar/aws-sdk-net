...
namespace Amazon.ECRPublic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RegistryAliasUnmarshaller : IUnmarshaller<RegistryAlias, XmlUnmarshallerContext>, IUnmarshaller<RegistryAlias, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RegistryAlias IUnmarshaller<RegistryAlias, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public RegistryAlias Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
