...
namespace Amazon.ECRPublic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeImageTagsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeImageTagsResponse response = new DescribeImageTagsResponse();

            context.Read();
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("imageTagDetails", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<ImageTagDetail, ImageTagDetailUnmarshaller>(ImageTagDetailUnmarshaller.Instance);
                    response.ImageTagDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeImageTagsResponseUnmarshaller _instance = new DescribeImageTagsResponseUnmarshaller();        

        internal static DescribeImageTagsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeImageTagsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
