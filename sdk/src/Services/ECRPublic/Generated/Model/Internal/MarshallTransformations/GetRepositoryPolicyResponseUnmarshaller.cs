...
namespace Amazon.ECRPublic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRepositoryPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRepositoryPolicyResponse response = new GetRepositoryPolicyResponse();
        ...
        private static GetRepositoryPolicyResponseUnmarshaller _instance = new GetRepositoryPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRepositoryPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
