...
namespace Amazon.ECRPublic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeRegistriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRegistriesResponse response = new DescribeRegistriesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Registry, RegistryUnmarshaller>(RegistryUnmarshaller.Instance);
        ...
        private static DescribeRegistriesResponseUnmarshaller _instance = new DescribeRegistriesResponseUnmarshaller();        

        internal static DescribeRegistriesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRegistriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
