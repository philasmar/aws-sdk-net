...
namespace Amazon.ECRPublic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRegistryCatalogDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRegistryCatalogDataResponse response = new GetRegistryCatalogDataResponse();
        ...
        private static GetRegistryCatalogDataResponseUnmarshaller _instance = new GetRegistryCatalogDataResponseUnmarshaller();        

        internal static GetRegistryCatalogDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRegistryCatalogDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
