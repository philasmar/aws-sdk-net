...
namespace Amazon.ECRPublic.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutRepositoryCatalogDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutRepositoryCatalogDataResponse response = new PutRepositoryCatalogDataResponse();
        ...
        private static PutRepositoryCatalogDataResponseUnmarshaller _instance = new PutRepositoryCatalogDataResponseUnmarshaller();        

        internal static PutRepositoryCatalogDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutRepositoryCatalogDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
