...
{
    /// <summary>
    /// Response Unmarshaller for CreateSnapshotCopyGrant operation
    /// </summary>  
    public class CreateSnapshotCopyGrantResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSnapshotCopyGrantResponse response = new CreateSnapshotCopyGrantResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateSnapshotCopyGrantResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("SnapshotCopyGrantAlreadyExistsFault"))
                {
                    return SnapshotCopyGrantAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("SnapshotCopyGrantQuotaExceededFault"))
                {
                    return SnapshotCopyGrantQuotaExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CreateSnapshotCopyGrantResponseUnmarshaller _instance = new CreateSnapshotCopyGrantResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSnapshotCopyGrantResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
