...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateClusterSubnetGroupRequestMarshaller : IMarshaller<IRequest, CreateClusterSubnetGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateClusterSubnetGroupRequest)input);
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateClusterSubnetGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
