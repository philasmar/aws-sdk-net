...
{
    /// <summary>
    /// Response Unmarshaller for DescribeClusterParameters operation
    /// </summary>  
    public class DescribeClusterParametersResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeClusterParametersResponse response = new DescribeClusterParametersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeClusterParametersResult", 2))
                    {
        ...
        private static DescribeClusterParametersResponseUnmarshaller _instance = new DescribeClusterParametersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeClusterParametersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
