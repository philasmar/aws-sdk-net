...
{
    /// <summary>
    /// Response Unmarshaller for DescribeClusterTracks operation
    /// </summary>  
    public class DescribeClusterTracksResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeClusterTracksResponse response = new DescribeClusterTracksResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeClusterTracksResult", 2))
                    {
        ...
        private static DescribeClusterTracksResponseUnmarshaller _instance = new DescribeClusterTracksResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeClusterTracksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
