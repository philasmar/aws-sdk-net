...
{
    /// <summary>
    /// Response Unmarshaller for DeleteClusterSecurityGroup operation
    /// </summary>  
    public class DeleteClusterSecurityGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteClusterSecurityGroupResponse response = new DeleteClusterSecurityGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteClusterSecurityGroupResult", 2))
                    {
        ...
        private static DeleteClusterSecurityGroupResponseUnmarshaller _instance = new DeleteClusterSecurityGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteClusterSecurityGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
