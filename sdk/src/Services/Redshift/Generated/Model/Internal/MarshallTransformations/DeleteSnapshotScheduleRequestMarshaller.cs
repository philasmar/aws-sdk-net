...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteSnapshotScheduleRequestMarshaller : IMarshaller<IRequest, DeleteSnapshotScheduleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DeleteSnapshotScheduleRequest publicRequest)
        {
            ...
            request.Parameters.Add("Action", "DeleteSnapshotSchedule");
            ...
            return request;
                    ...
                    private static DeleteSnapshotScheduleRequestMarshaller _instance = new DeleteSnapshotScheduleRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSnapshotScheduleRequestMarshaller Instance
        {
            get
            {
                return _instance;
