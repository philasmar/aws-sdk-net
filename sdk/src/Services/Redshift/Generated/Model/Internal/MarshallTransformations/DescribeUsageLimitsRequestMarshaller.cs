...
{
    /// <summary>
    /// DescribeUsageLimits Request Marshaller
    /// </summary>       
    public class DescribeUsageLimitsRequestMarshaller : IMarshaller<IRequest, DescribeUsageLimitsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeUsageLimitsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeUsageLimitsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Redshift");
            request.Parameters.Add("Action", "DescribeUsageLimits");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeUsageLimitsRequestMarshaller Instance
        {
            get
            {
                return _instance;
