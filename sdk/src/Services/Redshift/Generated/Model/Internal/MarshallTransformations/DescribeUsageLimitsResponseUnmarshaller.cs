...
{
    /// <summary>
    /// Response Unmarshaller for DescribeUsageLimits operation
    /// </summary>  
    public class DescribeUsageLimitsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeUsageLimitsResponse response = new DescribeUsageLimitsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeUsageLimitsResult", 2))
                    {
        ...
        private static DescribeUsageLimitsResponseUnmarshaller _instance = new DescribeUsageLimitsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeUsageLimitsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
