...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteHsmClientCertificateRequestMarshaller : IMarshaller<IRequest, DeleteHsmClientCertificateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteHsmClientCertificateRequest)input);
        }
        ...
        public IRequest Marshall(DeleteHsmClientCertificateRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DeleteHsmClientCertificateRequestMarshaller _instance = new DeleteHsmClientCertificateRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteHsmClientCertificateRequestMarshaller Instance
        {
            get
            {
                return _instance;
