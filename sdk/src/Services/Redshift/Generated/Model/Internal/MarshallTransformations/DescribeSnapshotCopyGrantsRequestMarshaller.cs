...
{
    /// <summary>
    /// DescribeSnapshotCopyGrants Request Marshaller
    /// </summary>       
    public class DescribeSnapshotCopyGrantsRequestMarshaller : IMarshaller<IRequest, DescribeSnapshotCopyGrantsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeSnapshotCopyGrantsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeSnapshotCopyGrantsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Redshift");
            request.Parameters.Add("Action", "DescribeSnapshotCopyGrants");
            ...
            return request;
                    ...
                    private static DescribeSnapshotCopyGrantsRequestMarshaller _instance = new DescribeSnapshotCopyGrantsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSnapshotCopyGrantsRequestMarshaller Instance
        {
            get
            {
                return _instance;
