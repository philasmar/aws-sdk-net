...
{
    /// <summary>
    /// ModifyScheduledAction Request Marshaller
    /// </summary>       
    public class ModifyScheduledActionRequestMarshaller : IMarshaller<IRequest, ModifyScheduledActionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyScheduledActionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyScheduledActionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Redshift");
            request.Parameters.Add("Action", "ModifyScheduledAction");
            ...
            return request;
                    ...
                    private static ModifyScheduledActionRequestMarshaller _instance = new ModifyScheduledActionRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyScheduledActionRequestMarshaller Instance
        {
            get
            {
                return _instance;
