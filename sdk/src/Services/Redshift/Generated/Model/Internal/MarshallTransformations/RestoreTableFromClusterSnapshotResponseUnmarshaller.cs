...
{
    /// <summary>
    /// Response Unmarshaller for RestoreTableFromClusterSnapshot operation
    /// </summary>  
    public class RestoreTableFromClusterSnapshotResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RestoreTableFromClusterSnapshotResponse response = new RestoreTableFromClusterSnapshotResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("RestoreTableFromClusterSnapshotResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InProgressTableRestoreQuotaExceededFault"))
                {
                    return InProgressTableRestoreQuotaExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidTableRestoreArgument"))
                {
                    return InvalidTableRestoreArgumentExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static RestoreTableFromClusterSnapshotResponseUnmarshaller _instance = new RestoreTableFromClusterSnapshotResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestoreTableFromClusterSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
