...
{
    /// <summary>
    /// Response Unmarshaller for DescribeClusterSecurityGroups operation
    /// </summary>  
    public class DescribeClusterSecurityGroupsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeClusterSecurityGroupsResponse response = new DescribeClusterSecurityGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeClusterSecurityGroupsResult", 2))
                    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("ClusterSecurityGroups/ClusterSecurityGroup", targetDepth))
                    {
                        ...
                        response.ClusterSecurityGroups.Add(item);
                        continue;
                    }
        ...
        private static DescribeClusterSecurityGroupsResponseUnmarshaller _instance = new DescribeClusterSecurityGroupsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeClusterSecurityGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
