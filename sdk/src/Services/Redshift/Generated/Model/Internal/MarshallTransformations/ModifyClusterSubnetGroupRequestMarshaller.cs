...
{
    /// <summary>
    /// ModifyClusterSubnetGroup Request Marshaller
    /// </summary>       
    public class ModifyClusterSubnetGroupRequestMarshaller : IMarshaller<IRequest, ModifyClusterSubnetGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyClusterSubnetGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyClusterSubnetGroupRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyClusterSubnetGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
