...
namespace Amazon.Redshift.Model.Internal.MarshallTransformations
{
    ...
    public class ModifyEventSubscriptionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidSubscriptionStateFault"))
                {
                    return InvalidSubscriptionStateExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
