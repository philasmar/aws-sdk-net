    ...
    public class DisableSnapshotCopyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return SnapshotCopyAlreadyDisabledExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static DisableSnapshotCopyResponseUnmarshaller _instance = new DisableSnapshotCopyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableSnapshotCopyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
