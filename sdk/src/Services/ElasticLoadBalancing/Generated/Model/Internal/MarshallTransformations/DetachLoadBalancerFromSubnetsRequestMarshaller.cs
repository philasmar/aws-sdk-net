    ...
    public class DetachLoadBalancerFromSubnetsRequestMarshaller : IMarshaller<IRequest, DetachLoadBalancerFromSubnetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DetachLoadBalancerFromSubnetsRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DetachLoadBalancerFromSubnetsRequestMarshaller _instance = new DetachLoadBalancerFromSubnetsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachLoadBalancerFromSubnetsRequestMarshaller Instance
        {
            get
            {
                return _instance;
