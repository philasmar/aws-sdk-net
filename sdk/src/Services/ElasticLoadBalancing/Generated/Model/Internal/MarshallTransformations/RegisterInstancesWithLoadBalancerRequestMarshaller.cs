...
namespace Amazon.ElasticLoadBalancing.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RegisterInstancesWithLoadBalancerRequestMarshaller : IMarshaller<IRequest, RegisterInstancesWithLoadBalancerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RegisterInstancesWithLoadBalancerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RegisterInstancesWithLoadBalancerRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static RegisterInstancesWithLoadBalancerRequestMarshaller _instance = new RegisterInstancesWithLoadBalancerRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterInstancesWithLoadBalancerRequestMarshaller Instance
        {
            get
            {
                return _instance;
