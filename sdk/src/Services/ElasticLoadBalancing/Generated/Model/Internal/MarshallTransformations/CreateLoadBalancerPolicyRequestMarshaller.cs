...
namespace Amazon.ElasticLoadBalancing.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateLoadBalancerPolicyRequestMarshaller : IMarshaller<IRequest, CreateLoadBalancerPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateLoadBalancerPolicyRequest)input);
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLoadBalancerPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
