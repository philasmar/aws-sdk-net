    ...
    public class DescribeInstanceHealthRequestMarshaller : IMarshaller<IRequest, DescribeInstanceHealthRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeInstanceHealthRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeInstanceHealthRequestMarshaller _instance = new DescribeInstanceHealthRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInstanceHealthRequestMarshaller Instance
        {
            get
            {
                return _instance;
