    ...
    public class DescribeLoadBalancersResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("DependencyThrottle"))
                {
                    return DependencyThrottleExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
