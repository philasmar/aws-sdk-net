    ...
    public class CreateLoadBalancerListenersRequestMarshaller : IMarshaller<IRequest, CreateLoadBalancerListenersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateLoadBalancerListenersRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static CreateLoadBalancerListenersRequestMarshaller _instance = new CreateLoadBalancerListenersRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLoadBalancerListenersRequestMarshaller Instance
        {
            get
            {
                return _instance;
