...
namespace Amazon.ElasticLoadBalancing.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateAppCookieStickinessPolicyRequestMarshaller : IMarshaller<IRequest, CreateAppCookieStickinessPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateAppCookieStickinessPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateAppCookieStickinessPolicyRequest publicRequest)
        {
            ...
            {
                if(publicRequest.IsSetCookieName())
                {
