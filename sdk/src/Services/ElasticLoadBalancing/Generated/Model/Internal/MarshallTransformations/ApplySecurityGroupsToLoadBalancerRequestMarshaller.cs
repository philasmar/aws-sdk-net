...
namespace Amazon.ElasticLoadBalancing.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ApplySecurityGroupsToLoadBalancerRequestMarshaller : IMarshaller<IRequest, ApplySecurityGroupsToLoadBalancerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ApplySecurityGroupsToLoadBalancerRequest)input);
        }
        ...
        public IRequest Marshall(ApplySecurityGroupsToLoadBalancerRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static ApplySecurityGroupsToLoadBalancerRequestMarshaller _instance = new ApplySecurityGroupsToLoadBalancerRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ApplySecurityGroupsToLoadBalancerRequestMarshaller Instance
        {
            get
            {
                return _instance;
