...
namespace Amazon.CostExplorer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CoverageByTimeUnmarshaller : IUnmarshaller<CoverageByTime, XmlUnmarshallerContext>, IUnmarshaller<CoverageByTime, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CoverageByTime IUnmarshaller<CoverageByTime, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public CoverageByTime Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ReservationCoverageGroup, ReservationCoverageGroupUnmarshaller>(ReservationCoverageGroupUnmarshaller.Instance);
