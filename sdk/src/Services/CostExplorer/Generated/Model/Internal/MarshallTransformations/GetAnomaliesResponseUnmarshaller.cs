...
{
    /// <summary>
    /// Response Unmarshaller for GetAnomalies operation
    /// </summary>  
    public class GetAnomaliesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAnomaliesResponse response = new GetAnomaliesResponse();
        ...
        private static GetAnomaliesResponseUnmarshaller _instance = new GetAnomaliesResponseUnmarshaller();        

        internal static GetAnomaliesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAnomaliesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
