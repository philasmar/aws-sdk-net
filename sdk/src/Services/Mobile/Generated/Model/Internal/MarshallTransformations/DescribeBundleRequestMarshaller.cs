...
{
    /// <summary>
    /// DescribeBundle Request Marshaller
    /// </summary>       
    public class DescribeBundleRequestMarshaller : IMarshaller<IRequest, DescribeBundleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeBundleRequest)input);
        }
        ...
        private static DescribeBundleRequestMarshaller _instance = new DescribeBundleRequestMarshaller();        

        internal static DescribeBundleRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBundleRequestMarshaller Instance
        {
            get
            {
                return _instance;
