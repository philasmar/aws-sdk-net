...
{
    /// <summary>
    /// Response Unmarshaller for DeleteLink operation
    /// </summary>  
    public class DeleteLinkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteLinkResponseUnmarshaller _instance = new DeleteLinkResponseUnmarshaller();        

        internal static DeleteLinkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLinkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
