...
{
    /// <summary>
    /// GetLinkAssociations Request Marshaller
    /// </summary>       
    public class GetLinkAssociationsRequestMarshaller : IMarshaller<IRequest, GetLinkAssociationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetLinkAssociationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetLinkAssociationsRequest publicRequest)
        {
        ...
        private static GetLinkAssociationsRequestMarshaller _instance = new GetLinkAssociationsRequestMarshaller();        

        internal static GetLinkAssociationsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLinkAssociationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
