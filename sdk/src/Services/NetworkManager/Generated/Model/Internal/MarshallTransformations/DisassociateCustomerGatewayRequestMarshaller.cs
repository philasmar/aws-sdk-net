...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DisassociateCustomerGatewayRequestMarshaller : IMarshaller<IRequest, DisassociateCustomerGatewayRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DisassociateCustomerGatewayRequestMarshaller _instance = new DisassociateCustomerGatewayRequestMarshaller();        

        internal static DisassociateCustomerGatewayRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateCustomerGatewayRequestMarshaller Instance
        {
            get
            {
                return _instance;
