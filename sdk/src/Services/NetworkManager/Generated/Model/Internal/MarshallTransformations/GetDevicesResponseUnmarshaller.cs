...
{
    /// <summary>
    /// Response Unmarshaller for GetDevices operation
    /// </summary>  
    public class GetDevicesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetDevicesResponseUnmarshaller _instance = new GetDevicesResponseUnmarshaller();        

        internal static GetDevicesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDevicesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
