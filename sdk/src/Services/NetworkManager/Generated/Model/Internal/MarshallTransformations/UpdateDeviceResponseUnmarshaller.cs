...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDevice operation
    /// </summary>  
    public class UpdateDeviceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateDeviceResponseUnmarshaller _instance = new UpdateDeviceResponseUnmarshaller();        

        internal static UpdateDeviceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
