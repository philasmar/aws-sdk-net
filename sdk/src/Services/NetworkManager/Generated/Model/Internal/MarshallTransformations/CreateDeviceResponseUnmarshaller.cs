...
{
    /// <summary>
    /// Response Unmarshaller for CreateDevice operation
    /// </summary>  
    public class CreateDeviceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateDeviceResponseUnmarshaller _instance = new CreateDeviceResponseUnmarshaller();        

        internal static CreateDeviceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
