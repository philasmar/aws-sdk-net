...
namespace Amazon.NetworkManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeregisterTransitGatewayRequestMarshaller : IMarshaller<IRequest, DeregisterTransitGatewayRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeregisterTransitGatewayRequestMarshaller _instance = new DeregisterTransitGatewayRequestMarshaller();        

        internal static DeregisterTransitGatewayRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterTransitGatewayRequestMarshaller Instance
        {
            get
            {
                return _instance;
