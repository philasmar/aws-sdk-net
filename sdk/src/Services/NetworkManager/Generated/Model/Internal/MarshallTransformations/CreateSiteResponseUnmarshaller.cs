...
{
    /// <summary>
    /// Response Unmarshaller for CreateSite operation
    /// </summary>  
    public class CreateSiteResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateSiteResponseUnmarshaller _instance = new CreateSiteResponseUnmarshaller();        

        internal static CreateSiteResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSiteResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
