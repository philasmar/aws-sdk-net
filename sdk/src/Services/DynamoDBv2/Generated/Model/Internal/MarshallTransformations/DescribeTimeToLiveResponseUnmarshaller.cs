...
namespace Amazon.DynamoDBv2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeTimeToLiveResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTimeToLiveResponse response = new DescribeTimeToLiveResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("TimeToLiveDescription", targetDepth))
                {
                    ...
                    response.TimeToLiveDescription = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeTimeToLiveResponseUnmarshaller _instance = new DescribeTimeToLiveResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTimeToLiveResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
