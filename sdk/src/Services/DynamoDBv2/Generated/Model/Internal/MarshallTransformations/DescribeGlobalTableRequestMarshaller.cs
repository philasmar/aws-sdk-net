...
namespace Amazon.DynamoDBv2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeGlobalTableRequestMarshaller : IMarshaller<IRequest, DescribeGlobalTableRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeGlobalTableRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeGlobalTableRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DynamoDBv2");
            string target = "DynamoDB_20120810.DescribeGlobalTable";
