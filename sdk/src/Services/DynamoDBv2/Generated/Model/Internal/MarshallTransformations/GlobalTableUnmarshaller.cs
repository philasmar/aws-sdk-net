...
namespace Amazon.DynamoDBv2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GlobalTableUnmarshaller : IUnmarshaller<GlobalTable, XmlUnmarshallerContext>, IUnmarshaller<GlobalTable, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        GlobalTable IUnmarshaller<GlobalTable, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public GlobalTable Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Replica, ReplicaUnmarshaller>(ReplicaUnmarshaller.Instance);
