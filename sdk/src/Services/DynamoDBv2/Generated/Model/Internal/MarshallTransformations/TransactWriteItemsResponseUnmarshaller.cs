...
{
    /// <summary>
    /// Response Unmarshaller for TransactWriteItems operation
    /// </summary>  
    public class TransactWriteItemsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TransactWriteItemsResponse response = new TransactWriteItemsResponse();
        ...
        private static TransactWriteItemsResponseUnmarshaller _instance = new TransactWriteItemsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TransactWriteItemsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
