...
{
    /// <summary>
    /// Response Unmarshaller for DescribeExport operation
    /// </summary>  
    public class DescribeExportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("ExportNotFoundException"))
                {
                    return ExportNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static DescribeExportResponseUnmarshaller _instance = new DescribeExportResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeExportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
