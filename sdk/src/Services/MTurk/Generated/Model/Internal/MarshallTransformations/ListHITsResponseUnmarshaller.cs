...
{
    /// <summary>
    /// Response Unmarshaller for ListHITs operation
    /// </summary>  
    public class ListHITsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListHITsResponse response = new ListHITsResponse();
        ...
        private static ListHITsResponseUnmarshaller _instance = new ListHITsResponseUnmarshaller();        

        internal static ListHITsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListHITsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
