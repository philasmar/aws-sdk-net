...
{
    /// <summary>
    /// Response Unmarshaller for UpdateExpirationForHIT operation
    /// </summary>  
    public class UpdateExpirationForHITResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateExpirationForHITResponse response = new UpdateExpirationForHITResponse();
        ...
        private static UpdateExpirationForHITResponseUnmarshaller _instance = new UpdateExpirationForHITResponseUnmarshaller();        

        internal static UpdateExpirationForHITResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateExpirationForHITResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
