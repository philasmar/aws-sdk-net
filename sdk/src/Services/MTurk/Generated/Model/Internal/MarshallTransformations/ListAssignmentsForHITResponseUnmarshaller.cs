...
{
    /// <summary>
    /// Response Unmarshaller for ListAssignmentsForHIT operation
    /// </summary>  
    public class ListAssignmentsForHITResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAssignmentsForHITResponse response = new ListAssignmentsForHITResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Assignment, AssignmentUnmarshaller>(AssignmentUnmarshaller.Instance);
                    response.Assignments = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListAssignmentsForHITResponseUnmarshaller _instance = new ListAssignmentsForHITResponseUnmarshaller();        

        internal static ListAssignmentsForHITResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAssignmentsForHITResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
