...
{
    /// <summary>
    /// Response Unmarshaller for SendTestEventNotification operation
    /// </summary>  
    public class SendTestEventNotificationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendTestEventNotificationResponse response = new SendTestEventNotificationResponse();
        ...
        private static SendTestEventNotificationResponseUnmarshaller _instance = new SendTestEventNotificationResponseUnmarshaller();        

        internal static SendTestEventNotificationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendTestEventNotificationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
