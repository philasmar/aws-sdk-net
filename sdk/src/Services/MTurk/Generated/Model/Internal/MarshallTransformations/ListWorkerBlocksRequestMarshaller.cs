...
{
    /// <summary>
    /// ListWorkerBlocks Request Marshaller
    /// </summary>       
    public class ListWorkerBlocksRequestMarshaller : IMarshaller<IRequest, ListWorkerBlocksRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListWorkerBlocksRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListWorkerBlocksRequest publicRequest)
        {
