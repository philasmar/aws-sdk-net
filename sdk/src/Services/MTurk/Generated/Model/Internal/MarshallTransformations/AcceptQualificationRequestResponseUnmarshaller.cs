...
{
    /// <summary>
    /// Response Unmarshaller for AcceptQualificationRequest operation
    /// </summary>  
    public class AcceptQualificationRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptQualificationRequestResponse response = new AcceptQualificationRequestResponse();
        ...
        private static AcceptQualificationRequestResponseUnmarshaller _instance = new AcceptQualificationRequestResponseUnmarshaller();        

        internal static AcceptQualificationRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptQualificationRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
