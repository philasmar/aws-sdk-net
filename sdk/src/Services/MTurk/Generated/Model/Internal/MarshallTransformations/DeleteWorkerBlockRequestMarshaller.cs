...
{
    /// <summary>
    /// DeleteWorkerBlock Request Marshaller
    /// </summary>       
    public class DeleteWorkerBlockRequestMarshaller : IMarshaller<IRequest, DeleteWorkerBlockRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteWorkerBlockRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteWorkerBlockRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MTurk");
            string target = "MTurkRequesterServiceV20170117.DeleteWorkerBlock";
