...
{
    /// <summary>
    /// UpdateExpirationForHIT Request Marshaller
    /// </summary>       
    public class UpdateExpirationForHITRequestMarshaller : IMarshaller<IRequest, UpdateExpirationForHITRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateExpirationForHITRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateExpirationForHITRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MTurk");
            string target = "MTurkRequesterServiceV20170117.UpdateExpirationForHIT";
