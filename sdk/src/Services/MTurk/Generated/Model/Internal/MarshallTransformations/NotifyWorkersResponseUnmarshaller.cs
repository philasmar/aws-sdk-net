...
{
    /// <summary>
    /// Response Unmarshaller for NotifyWorkers operation
    /// </summary>  
    public class NotifyWorkersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<NotifyWorkersFailureStatus, NotifyWorkersFailureStatusUnmarshaller>(NotifyWorkersFailureStatusUnmarshaller.Instance);
                    response.NotifyWorkersFailureStatuses = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static NotifyWorkersResponseUnmarshaller _instance = new NotifyWorkersResponseUnmarshaller();        

        internal static NotifyWorkersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static NotifyWorkersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
