...
{
    /// <summary>
    /// NotifyWorkers Request Marshaller
    /// </summary>       
    public class NotifyWorkersRequestMarshaller : IMarshaller<IRequest, NotifyWorkersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((NotifyWorkersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(NotifyWorkersRequest publicRequest)
        {
