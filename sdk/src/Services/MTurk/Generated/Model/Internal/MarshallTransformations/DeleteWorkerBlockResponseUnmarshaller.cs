...
{
    /// <summary>
    /// Response Unmarshaller for DeleteWorkerBlock operation
    /// </summary>  
    public class DeleteWorkerBlockResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteWorkerBlockResponse response = new DeleteWorkerBlockResponse();
        ...
        private static DeleteWorkerBlockResponseUnmarshaller _instance = new DeleteWorkerBlockResponseUnmarshaller();        

        internal static DeleteWorkerBlockResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteWorkerBlockResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
