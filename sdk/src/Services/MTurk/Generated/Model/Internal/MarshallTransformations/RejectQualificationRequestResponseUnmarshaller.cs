...
{
    /// <summary>
    /// Response Unmarshaller for RejectQualificationRequest operation
    /// </summary>  
    public class RejectQualificationRequestResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RejectQualificationRequestResponse response = new RejectQualificationRequestResponse();
        ...
        private static RejectQualificationRequestResponseUnmarshaller _instance = new RejectQualificationRequestResponseUnmarshaller();        

        internal static RejectQualificationRequestResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RejectQualificationRequestResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
