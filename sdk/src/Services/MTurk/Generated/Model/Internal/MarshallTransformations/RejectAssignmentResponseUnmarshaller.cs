...
{
    /// <summary>
    /// Response Unmarshaller for RejectAssignment operation
    /// </summary>  
    public class RejectAssignmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RejectAssignmentResponse response = new RejectAssignmentResponse();
        ...
        private static RejectAssignmentResponseUnmarshaller _instance = new RejectAssignmentResponseUnmarshaller();        

        internal static RejectAssignmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RejectAssignmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
