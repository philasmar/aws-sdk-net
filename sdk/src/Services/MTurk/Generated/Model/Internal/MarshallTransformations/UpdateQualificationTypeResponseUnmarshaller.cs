...
{
    /// <summary>
    /// Response Unmarshaller for UpdateQualificationType operation
    /// </summary>  
    public class UpdateQualificationTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateQualificationTypeResponse response = new UpdateQualificationTypeResponse();
        ...
        private static UpdateQualificationTypeResponseUnmarshaller _instance = new UpdateQualificationTypeResponseUnmarshaller();        

        internal static UpdateQualificationTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateQualificationTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
