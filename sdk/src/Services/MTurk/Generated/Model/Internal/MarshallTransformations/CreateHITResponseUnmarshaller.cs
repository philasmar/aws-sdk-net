...
{
    /// <summary>
    /// Response Unmarshaller for CreateHIT operation
    /// </summary>  
    public class CreateHITResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateHITResponseUnmarshaller _instance = new CreateHITResponseUnmarshaller();        

        internal static CreateHITResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHITResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
