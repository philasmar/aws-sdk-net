...
{
    /// <summary>
    /// Response Unmarshaller for GetAccountBalance operation
    /// </summary>  
    public class GetAccountBalanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetAccountBalanceResponseUnmarshaller _instance = new GetAccountBalanceResponseUnmarshaller();        

        internal static GetAccountBalanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccountBalanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
