...
{
    /// <summary>
    /// SendTestEventNotification Request Marshaller
    /// </summary>       
    public class SendTestEventNotificationRequestMarshaller : IMarshaller<IRequest, SendTestEventNotificationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SendTestEventNotificationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SendTestEventNotificationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MTurk");
            string target = "MTurkRequesterServiceV20170117.SendTestEventNotification";
