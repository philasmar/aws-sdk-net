...
{
    /// <summary>
    /// Response Unmarshaller for QualificationRequest Object
    /// </summary>  
    public class QualificationRequestUnmarshaller : IUnmarshaller<QualificationRequest, XmlUnmarshallerContext>, IUnmarshaller<QualificationRequest, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        QualificationRequest IUnmarshaller<QualificationRequest, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public QualificationRequest Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.QualificationRequestId = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static QualificationRequestUnmarshaller _instance = new QualificationRequestUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static QualificationRequestUnmarshaller Instance
        {
            get
            {
                return _instance;
