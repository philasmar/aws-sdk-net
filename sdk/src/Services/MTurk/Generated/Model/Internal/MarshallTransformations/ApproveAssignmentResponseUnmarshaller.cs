...
{
    /// <summary>
    /// Response Unmarshaller for ApproveAssignment operation
    /// </summary>  
    public class ApproveAssignmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ApproveAssignmentResponse response = new ApproveAssignmentResponse();
        ...
        private static ApproveAssignmentResponseUnmarshaller _instance = new ApproveAssignmentResponseUnmarshaller();        

        internal static ApproveAssignmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ApproveAssignmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
