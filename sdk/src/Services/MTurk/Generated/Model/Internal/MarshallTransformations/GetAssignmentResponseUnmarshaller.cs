...
{
    /// <summary>
    /// Response Unmarshaller for GetAssignment operation
    /// </summary>  
    public class GetAssignmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetAssignmentResponseUnmarshaller _instance = new GetAssignmentResponseUnmarshaller();        

        internal static GetAssignmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAssignmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
