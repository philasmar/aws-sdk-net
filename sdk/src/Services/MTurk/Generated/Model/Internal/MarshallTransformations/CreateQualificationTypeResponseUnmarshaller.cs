...
{
    /// <summary>
    /// Response Unmarshaller for CreateQualificationType operation
    /// </summary>  
    public class CreateQualificationTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateQualificationTypeResponse response = new CreateQualificationTypeResponse();
        ...
        private static CreateQualificationTypeResponseUnmarshaller _instance = new CreateQualificationTypeResponseUnmarshaller();        

        internal static CreateQualificationTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateQualificationTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
