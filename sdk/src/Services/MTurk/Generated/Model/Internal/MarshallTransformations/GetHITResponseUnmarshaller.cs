...
{
    /// <summary>
    /// Response Unmarshaller for GetHIT operation
    /// </summary>  
    public class GetHITResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetHITResponse response = new GetHITResponse();
        ...
        private static GetHITResponseUnmarshaller _instance = new GetHITResponseUnmarshaller();        

        internal static GetHITResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetHITResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
