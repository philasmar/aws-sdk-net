...
{
    /// <summary>
    /// ListHITsForQualificationType Request Marshaller
    /// </summary>       
    public class ListHITsForQualificationTypeRequestMarshaller : IMarshaller<IRequest, ListHITsForQualificationTypeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListHITsForQualificationTypeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListHITsForQualificationTypeRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MTurk");
            string target = "MTurkRequesterServiceV20170117.ListHITsForQualificationType";
