...
{
    /// <summary>
    /// RejectQualificationRequest Request Marshaller
    /// </summary>       
    public class RejectQualificationRequestRequestMarshaller : IMarshaller<IRequest, RejectQualificationRequestRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RejectQualificationRequestRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RejectQualificationRequestRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MTurk");
            string target = "MTurkRequesterServiceV20170117.RejectQualificationRequest";
