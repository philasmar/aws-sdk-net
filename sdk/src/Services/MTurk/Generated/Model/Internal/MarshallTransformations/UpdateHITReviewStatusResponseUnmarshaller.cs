...
{
    /// <summary>
    /// Response Unmarshaller for UpdateHITReviewStatus operation
    /// </summary>  
    public class UpdateHITReviewStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateHITReviewStatusResponse response = new UpdateHITReviewStatusResponse();
        ...
        private static UpdateHITReviewStatusResponseUnmarshaller _instance = new UpdateHITReviewStatusResponseUnmarshaller();        

        internal static UpdateHITReviewStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateHITReviewStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
