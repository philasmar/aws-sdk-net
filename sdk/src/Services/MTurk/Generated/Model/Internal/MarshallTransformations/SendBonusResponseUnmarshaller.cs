...
{
    /// <summary>
    /// Response Unmarshaller for SendBonus operation
    /// </summary>  
    public class SendBonusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendBonusResponse response = new SendBonusResponse();
        ...
        private static SendBonusResponseUnmarshaller _instance = new SendBonusResponseUnmarshaller();        

        internal static SendBonusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendBonusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
