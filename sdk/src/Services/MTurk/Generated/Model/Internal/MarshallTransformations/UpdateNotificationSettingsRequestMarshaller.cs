...
{
    /// <summary>
    /// UpdateNotificationSettings Request Marshaller
    /// </summary>       
    public class UpdateNotificationSettingsRequestMarshaller : IMarshaller<IRequest, UpdateNotificationSettingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateNotificationSettingsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateNotificationSettingsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MTurk");
            string target = "MTurkRequesterServiceV20170117.UpdateNotificationSettings";
