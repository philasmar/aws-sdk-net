...
namespace Amazon.MTurk.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReviewActionDetailUnmarshaller : IUnmarshaller<ReviewActionDetail, XmlUnmarshallerContext>, IUnmarshaller<ReviewActionDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ReviewActionDetail IUnmarshaller<ReviewActionDetail, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ReviewActionDetail Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
