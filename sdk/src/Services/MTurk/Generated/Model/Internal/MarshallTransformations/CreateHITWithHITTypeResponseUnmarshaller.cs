...
{
    /// <summary>
    /// Response Unmarshaller for CreateHITWithHITType operation
    /// </summary>  
    public class CreateHITWithHITTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateHITWithHITTypeResponse response = new CreateHITWithHITTypeResponse();
        ...
        private static CreateHITWithHITTypeResponseUnmarshaller _instance = new CreateHITWithHITTypeResponseUnmarshaller();        

        internal static CreateHITWithHITTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHITWithHITTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
