...
{
    /// <summary>
    /// DeleteQualificationType Request Marshaller
    /// </summary>       
    public class DeleteQualificationTypeRequestMarshaller : IMarshaller<IRequest, DeleteQualificationTypeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteQualificationTypeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteQualificationTypeRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MTurk");
            string target = "MTurkRequesterServiceV20170117.DeleteQualificationType";
