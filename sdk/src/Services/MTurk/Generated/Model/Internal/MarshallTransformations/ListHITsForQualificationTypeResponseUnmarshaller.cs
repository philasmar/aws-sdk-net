...
{
    /// <summary>
    /// Response Unmarshaller for ListHITsForQualificationType operation
    /// </summary>  
    public class ListHITsForQualificationTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListHITsForQualificationTypeResponse response = new ListHITsForQualificationTypeResponse();
        ...
        private static ListHITsForQualificationTypeResponseUnmarshaller _instance = new ListHITsForQualificationTypeResponseUnmarshaller();        

        internal static ListHITsForQualificationTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListHITsForQualificationTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
