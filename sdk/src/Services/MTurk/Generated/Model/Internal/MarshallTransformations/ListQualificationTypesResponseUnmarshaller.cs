...
{
    /// <summary>
    /// Response Unmarshaller for ListQualificationTypes operation
    /// </summary>  
    public class ListQualificationTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListQualificationTypesResponse response = new ListQualificationTypesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<QualificationType, QualificationTypeUnmarshaller>(QualificationTypeUnmarshaller.Instance);
                    response.QualificationTypes = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListQualificationTypesResponseUnmarshaller _instance = new ListQualificationTypesResponseUnmarshaller();        

        internal static ListQualificationTypesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListQualificationTypesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
