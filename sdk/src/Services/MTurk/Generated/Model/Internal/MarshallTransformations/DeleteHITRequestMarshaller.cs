...
{
    /// <summary>
    /// DeleteHIT Request Marshaller
    /// </summary>       
    public class DeleteHITRequestMarshaller : IMarshaller<IRequest, DeleteHITRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteHITRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteHITRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MTurk");
            string target = "MTurkRequesterServiceV20170117.DeleteHIT";
