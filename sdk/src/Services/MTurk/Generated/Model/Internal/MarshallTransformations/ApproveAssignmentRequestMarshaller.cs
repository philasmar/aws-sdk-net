...
{
    /// <summary>
    /// ApproveAssignment Request Marshaller
    /// </summary>       
    public class ApproveAssignmentRequestMarshaller : IMarshaller<IRequest, ApproveAssignmentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ApproveAssignmentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ApproveAssignmentRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MTurk");
            string target = "MTurkRequesterServiceV20170117.ApproveAssignment";
