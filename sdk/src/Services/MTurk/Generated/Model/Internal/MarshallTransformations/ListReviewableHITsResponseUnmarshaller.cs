...
{
    /// <summary>
    /// Response Unmarshaller for ListReviewableHITs operation
    /// </summary>  
    public class ListReviewableHITsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListReviewableHITsResponse response = new ListReviewableHITsResponse();
        ...
        private static ListReviewableHITsResponseUnmarshaller _instance = new ListReviewableHITsResponseUnmarshaller();        

        internal static ListReviewableHITsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListReviewableHITsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
