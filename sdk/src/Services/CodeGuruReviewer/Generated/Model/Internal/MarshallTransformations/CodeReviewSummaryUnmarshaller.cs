...
namespace Amazon.CodeGuruReviewer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CodeReviewSummaryUnmarshaller : IUnmarshaller<CodeReviewSummary, XmlUnmarshallerContext>, IUnmarshaller<CodeReviewSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CodeReviewSummary IUnmarshaller<CodeReviewSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public CodeReviewSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("MetricsSummary", targetDepth))
                {
                    ...
                    unmarshalledObject.MetricsSummary = unmarshaller.Unmarshall(context);
                    continue;
                }
