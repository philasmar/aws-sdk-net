...
namespace Amazon.Neptune.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ModifyDBClusterParameterGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyDBClusterParameterGroupResponse response = new ModifyDBClusterParameterGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyDBClusterParameterGroupResult", 2))
                    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("DBClusterParameterGroupName", targetDepth))
                    {
                        ...
                        response.DBClusterParameterGroupName = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static ModifyDBClusterParameterGroupResponseUnmarshaller _instance = new ModifyDBClusterParameterGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyDBClusterParameterGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
