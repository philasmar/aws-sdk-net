...
namespace Amazon.Neptune.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeDBParameterGroupsRequestMarshaller : IMarshaller<IRequest, DescribeDBParameterGroupsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeDBParameterGroupsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeDBParameterGroupsRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeDBParameterGroupsRequestMarshaller _instance = new DescribeDBParameterGroupsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBParameterGroupsRequestMarshaller Instance
        {
            get
            {
                return _instance;
