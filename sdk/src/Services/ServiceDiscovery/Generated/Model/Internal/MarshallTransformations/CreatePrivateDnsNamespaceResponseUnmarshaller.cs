...
{
    /// <summary>
    /// Response Unmarshaller for CreatePrivateDnsNamespace operation
    /// </summary>  
    public class CreatePrivateDnsNamespaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePrivateDnsNamespaceResponse response = new CreatePrivateDnsNamespaceResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("NamespaceAlreadyExists"))
                {
        ...
        private static CreatePrivateDnsNamespaceResponseUnmarshaller _instance = new CreatePrivateDnsNamespaceResponseUnmarshaller();        

        internal static CreatePrivateDnsNamespaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePrivateDnsNamespaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
