...
{
    /// <summary>
    /// Response Unmarshaller for CreatePublicDnsNamespace operation
    /// </summary>  
    public class CreatePublicDnsNamespaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreatePublicDnsNamespaceResponse response = new CreatePublicDnsNamespaceResponse();
        ...
        private static CreatePublicDnsNamespaceResponseUnmarshaller _instance = new CreatePublicDnsNamespaceResponseUnmarshaller();        

        internal static CreatePublicDnsNamespaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreatePublicDnsNamespaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
