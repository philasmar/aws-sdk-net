...
namespace Amazon.ServiceDiscovery.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateServiceRequestMarshaller : IMarshaller<IRequest, UpdateServiceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateServiceRequest publicRequest)
        {
            ...
            string target = "Route53AutoNaming_v20170314.UpdateService";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetService())
                {
                    ...
                    var marshaller = ServiceChangeMarshaller.Instance;
                    marshaller.Marshall(publicRequest.Service, context);
