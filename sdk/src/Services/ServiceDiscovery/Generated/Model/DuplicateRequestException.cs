...
namespace Amazon.ServiceDiscovery.Model
{
    ...
    [Serializable]
    #endif
    public partial class DuplicateRequestException : AmazonServiceDiscoveryException
    {
        ...
        protected DuplicateRequestException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
            this.DuplicateOperationId = (string)info.GetValue("DuplicateOperationId", typeof(string));
        }
        ...
        /// <summary>
        /// Gets and sets the property DuplicateOperationId. 
        /// <para>
        ...
        public string DuplicateOperationId
        {
            ...
            set { this._duplicateOperationId = value; }
        }

        // Check to see if DuplicateOperationId property is set
        internal bool IsSetDuplicateOperationId()
        {
            return this._duplicateOperationId != null;
        }
