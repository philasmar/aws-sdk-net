...
namespace Amazon.CertificateManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AddTagsToCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddTagsToCertificateResponse response = new AddTagsToCertificateResponse();
        ...
        private static AddTagsToCertificateResponseUnmarshaller _instance = new AddTagsToCertificateResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddTagsToCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
