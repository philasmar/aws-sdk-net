...
namespace Amazon.CertificateManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetCertificateRequestMarshaller : IMarshaller<IRequest, GetCertificateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCertificateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCertificateRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CertificateManager");
            string target = "CertificateManager.GetCertificate";
        ...
        private static GetCertificateRequestMarshaller _instance = new GetCertificateRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCertificateRequestMarshaller Instance
        {
            get
            {
                return _instance;
