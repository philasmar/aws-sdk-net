...
namespace Amazon.CertificateManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResendValidationEmailResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ResendValidationEmailResponse response = new ResendValidationEmailResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return InvalidDomainValidationOptionsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static ResendValidationEmailResponseUnmarshaller _instance = new ResendValidationEmailResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResendValidationEmailResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
