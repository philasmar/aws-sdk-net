...
namespace Amazon.CertificateManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ExportCertificateRequestMarshaller : IMarshaller<IRequest, ExportCertificateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ExportCertificateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ExportCertificateRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CertificateManager");
            string target = "CertificateManager.ExportCertificate";
        ...
        private static ExportCertificateRequestMarshaller _instance = new ExportCertificateRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportCertificateRequestMarshaller Instance
        {
            get
            {
                return _instance;
