...
namespace Amazon.CertificateManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RemoveTagsFromCertificateRequestMarshaller : IMarshaller<IRequest, RemoveTagsFromCertificateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RemoveTagsFromCertificateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RemoveTagsFromCertificateRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CertificateManager");
            string target = "CertificateManager.RemoveTagsFromCertificate";
