...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TestUnmarshaller : IUnmarshaller<Test, XmlUnmarshallerContext>, IUnmarshaller<Test, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Test IUnmarshaller<Test, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public Test Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            Test unmarshalledObject = new Test();
        ...
        private static TestUnmarshaller _instance = new TestUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TestUnmarshaller Instance
        {
            get
            {
                return _instance;
