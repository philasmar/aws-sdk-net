...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListSuitesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSuitesResponse response = new ListSuitesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Suite, SuiteUnmarshaller>(SuiteUnmarshaller.Instance);
                    response.Suites = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListSuitesResponseUnmarshaller _instance = new ListSuitesResponseUnmarshaller();        

        internal static ListSuitesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSuitesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
