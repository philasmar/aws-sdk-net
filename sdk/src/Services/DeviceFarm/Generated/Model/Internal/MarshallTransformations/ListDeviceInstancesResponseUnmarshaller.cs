...
{
    /// <summary>
    /// Response Unmarshaller for ListDeviceInstances operation
    /// </summary>  
    public class ListDeviceInstancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDeviceInstancesResponse response = new ListDeviceInstancesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("deviceInstances", targetDepth))
                {
                    ...
                    response.DeviceInstances = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListDeviceInstancesResponseUnmarshaller _instance = new ListDeviceInstancesResponseUnmarshaller();        

        internal static ListDeviceInstancesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDeviceInstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
