...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRemoteAccessSession operation
    /// </summary>  
    public class DeleteRemoteAccessSessionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRemoteAccessSessionResponse response = new DeleteRemoteAccessSessionResponse();
        ...
        private static DeleteRemoteAccessSessionResponseUnmarshaller _instance = new DeleteRemoteAccessSessionResponseUnmarshaller();        

        internal static DeleteRemoteAccessSessionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRemoteAccessSessionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
