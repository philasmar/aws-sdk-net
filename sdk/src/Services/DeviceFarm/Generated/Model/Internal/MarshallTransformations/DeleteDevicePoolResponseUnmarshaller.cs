...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteDevicePoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDevicePoolResponse response = new DeleteDevicePoolResponse();
        ...
        private static DeleteDevicePoolResponseUnmarshaller _instance = new DeleteDevicePoolResponseUnmarshaller();        

        internal static DeleteDevicePoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDevicePoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
