...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteRunRequestMarshaller : IMarshaller<IRequest, DeleteRunRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteRunRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteRunRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DeviceFarm");
            string target = "DeviceFarm_20150623.DeleteRun";
