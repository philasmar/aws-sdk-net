...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListDevicePoolsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDevicePoolsResponse response = new ListDevicePoolsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DevicePool, DevicePoolUnmarshaller>(DevicePoolUnmarshaller.Instance);
                    response.DevicePools = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListDevicePoolsResponseUnmarshaller _instance = new ListDevicePoolsResponseUnmarshaller();        

        internal static ListDevicePoolsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDevicePoolsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
