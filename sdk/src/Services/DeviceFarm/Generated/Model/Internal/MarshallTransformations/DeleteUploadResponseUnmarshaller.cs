...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteUploadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteUploadResponse response = new DeleteUploadResponse();
        ...
        private static DeleteUploadResponseUnmarshaller _instance = new DeleteUploadResponseUnmarshaller();        

        internal static DeleteUploadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteUploadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
