...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateDevicePoolRequestMarshaller : IMarshaller<IRequest, CreateDevicePoolRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateDevicePoolRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateDevicePoolRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DeviceFarm");
            string target = "DeviceFarm_20150623.CreateDevicePool";
        ...
        private static CreateDevicePoolRequestMarshaller _instance = new CreateDevicePoolRequestMarshaller();        

        internal static CreateDevicePoolRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDevicePoolRequestMarshaller Instance
        {
            get
            {
                return _instance;
