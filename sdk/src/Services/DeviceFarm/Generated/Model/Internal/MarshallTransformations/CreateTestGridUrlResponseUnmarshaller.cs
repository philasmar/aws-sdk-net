...
{
    /// <summary>
    /// Response Unmarshaller for CreateTestGridUrl operation
    /// </summary>  
    public class CreateTestGridUrlResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTestGridUrlResponse response = new CreateTestGridUrlResponse();
        ...
        private static CreateTestGridUrlResponseUnmarshaller _instance = new CreateTestGridUrlResponseUnmarshaller();        

        internal static CreateTestGridUrlResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTestGridUrlResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
