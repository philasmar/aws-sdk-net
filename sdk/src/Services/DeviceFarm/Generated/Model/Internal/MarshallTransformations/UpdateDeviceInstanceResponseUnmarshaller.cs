...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDeviceInstance operation
    /// </summary>  
    public class UpdateDeviceInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDeviceInstanceResponse response = new UpdateDeviceInstanceResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("deviceInstance", targetDepth))
                {
                    ...
                    response.DeviceInstance = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static UpdateDeviceInstanceResponseUnmarshaller _instance = new UpdateDeviceInstanceResponseUnmarshaller();        

        internal static UpdateDeviceInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDeviceInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
