...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDevicePoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDevicePoolResponse response = new GetDevicePoolResponse();
        ...
        private static GetDevicePoolResponseUnmarshaller _instance = new GetDevicePoolResponseUnmarshaller();        

        internal static GetDevicePoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDevicePoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
