...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListTestsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTestsResponse response = new ListTestsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Test, TestUnmarshaller>(TestUnmarshaller.Instance);
                    response.Tests = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListTestsResponseUnmarshaller _instance = new ListTestsResponseUnmarshaller();        

        internal static ListTestsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTestsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
