...
{
    /// <summary>
    /// Response Unmarshaller for GetDeviceInstance operation
    /// </summary>  
    public class GetDeviceInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDeviceInstanceResponse response = new GetDeviceInstanceResponse();
        ...
        private static GetDeviceInstanceResponseUnmarshaller _instance = new GetDeviceInstanceResponseUnmarshaller();        

        internal static GetDeviceInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDeviceInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
