...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StopRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopRunResponse response = new StopRunResponse();
        ...
        private static StopRunResponseUnmarshaller _instance = new StopRunResponseUnmarshaller();        

        internal static StopRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
