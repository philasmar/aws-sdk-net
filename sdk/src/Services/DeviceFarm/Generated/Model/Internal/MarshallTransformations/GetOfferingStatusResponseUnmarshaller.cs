...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetOfferingStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetOfferingStatusResponseUnmarshaller _instance = new GetOfferingStatusResponseUnmarshaller();        

        internal static GetOfferingStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOfferingStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
