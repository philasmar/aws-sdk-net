...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateUploadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateUploadResponse response = new CreateUploadResponse();
        ...
        private static CreateUploadResponseUnmarshaller _instance = new CreateUploadResponseUnmarshaller();        

        internal static CreateUploadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateUploadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
