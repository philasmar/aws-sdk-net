...
{
    /// <summary>
    /// Response Unmarshaller for UpdateUpload operation
    /// </summary>  
    public class UpdateUploadResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateUploadResponseUnmarshaller _instance = new UpdateUploadResponseUnmarshaller();        

        internal static UpdateUploadResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateUploadResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
