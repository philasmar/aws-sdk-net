...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListSuitesRequestMarshaller : IMarshaller<IRequest, ListSuitesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListSuitesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListSuitesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DeviceFarm");
            string target = "DeviceFarm_20150623.ListSuites";
