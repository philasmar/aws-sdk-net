...
namespace Amazon.DeviceFarm.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateDevicePoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDevicePoolResponse response = new CreateDevicePoolResponse();
        ...
        private static CreateDevicePoolResponseUnmarshaller _instance = new CreateDevicePoolResponseUnmarshaller();        

        internal static CreateDevicePoolResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDevicePoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
