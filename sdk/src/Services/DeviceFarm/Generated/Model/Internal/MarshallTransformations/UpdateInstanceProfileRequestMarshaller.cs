...
{
    /// <summary>
    /// UpdateInstanceProfile Request Marshaller
    /// </summary>       
    public class UpdateInstanceProfileRequestMarshaller : IMarshaller<IRequest, UpdateInstanceProfileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateInstanceProfileRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateInstanceProfileRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DeviceFarm");
            string target = "DeviceFarm_20150623.UpdateInstanceProfile";
        ...
        private static UpdateInstanceProfileRequestMarshaller _instance = new UpdateInstanceProfileRequestMarshaller();        

        internal static UpdateInstanceProfileRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateInstanceProfileRequestMarshaller Instance
        {
            get
            {
                return _instance;
