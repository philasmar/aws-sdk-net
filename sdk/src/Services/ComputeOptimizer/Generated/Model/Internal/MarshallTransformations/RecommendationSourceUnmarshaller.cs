...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RecommendationSourceUnmarshaller : IUnmarshaller<RecommendationSource, XmlUnmarshallerContext>, IUnmarshaller<RecommendationSource, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RecommendationSource IUnmarshaller<RecommendationSource, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public RecommendationSource Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
