...
namespace Amazon.ComputeOptimizer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AutoScalingGroupConfigurationUnmarshaller : IUnmarshaller<AutoScalingGroupConfiguration, XmlUnmarshallerContext>, IUnmarshaller<AutoScalingGroupConfiguration, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        AutoScalingGroupConfiguration IUnmarshaller<AutoScalingGroupConfiguration, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AutoScalingGroupConfiguration Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
