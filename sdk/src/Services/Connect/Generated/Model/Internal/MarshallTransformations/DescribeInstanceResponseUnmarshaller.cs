...
{
    /// <summary>
    /// Response Unmarshaller for DescribeInstance operation
    /// </summary>  
    public class DescribeInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeInstanceResponseUnmarshaller _instance = new DescribeInstanceResponseUnmarshaller();        

        internal static DescribeInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
