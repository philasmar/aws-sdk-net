...
{
    /// <summary>
    /// Response Unmarshaller for AssociateLexBot operation
    /// </summary>  
    public class AssociateLexBotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateLexBotResponse response = new AssociateLexBotResponse();
        ...
        private static AssociateLexBotResponseUnmarshaller _instance = new AssociateLexBotResponseUnmarshaller();        

        internal static AssociateLexBotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateLexBotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
