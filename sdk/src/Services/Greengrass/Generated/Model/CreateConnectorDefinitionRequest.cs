...
{
    /// <summary>
    /// Container for the parameters to the CreateConnectorDefinition operation.
    ...
    /// </summary>
    public partial class CreateConnectorDefinitionRequest : AmazonGreengrassRequest
    {
        private string _amznClientToken;
        private ConnectorDefinitionVersion _initialVersion;
        ...
        /// <summary>
        /// Gets and sets the property Name. The name of the connector definition.
        /// </summary>
        public string Name
        {
