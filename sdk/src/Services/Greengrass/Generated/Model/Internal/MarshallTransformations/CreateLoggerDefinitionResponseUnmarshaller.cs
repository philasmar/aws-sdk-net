...
{
    /// <summary>
    /// Response Unmarshaller for CreateLoggerDefinition operation
    /// </summary>  
    public class CreateLoggerDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLoggerDefinitionResponse response = new CreateLoggerDefinitionResponse();
        ...
        private static CreateLoggerDefinitionResponseUnmarshaller _instance = new CreateLoggerDefinitionResponseUnmarshaller();        

        internal static CreateLoggerDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLoggerDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
