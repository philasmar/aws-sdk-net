...
{
    /// <summary>
    /// Response Unmarshaller for GetCoreDefinition operation
    /// </summary>  
    public class GetCoreDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCoreDefinitionResponse response = new GetCoreDefinitionResponse();
        ...
        private static GetCoreDefinitionResponseUnmarshaller _instance = new GetCoreDefinitionResponseUnmarshaller();        

        internal static GetCoreDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCoreDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
