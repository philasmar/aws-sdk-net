...
{
    /// <summary>
    /// Response Unmarshaller for CreateFunctionDefinition operation
    /// </summary>  
    public class CreateFunctionDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateFunctionDefinitionResponse response = new CreateFunctionDefinitionResponse();
        ...
        private static CreateFunctionDefinitionResponseUnmarshaller _instance = new CreateFunctionDefinitionResponseUnmarshaller();        

        internal static CreateFunctionDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateFunctionDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
