...
{
    /// <summary>
    /// Response Unmarshaller for GetResourceDefinition operation
    /// </summary>  
    public class GetResourceDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetResourceDefinitionResponse response = new GetResourceDefinitionResponse();
        ...
        private static GetResourceDefinitionResponseUnmarshaller _instance = new GetResourceDefinitionResponseUnmarshaller();        

        internal static GetResourceDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetResourceDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
