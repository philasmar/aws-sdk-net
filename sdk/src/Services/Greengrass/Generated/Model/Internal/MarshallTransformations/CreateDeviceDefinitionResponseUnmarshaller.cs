...
{
    /// <summary>
    /// Response Unmarshaller for CreateDeviceDefinition operation
    /// </summary>  
    public class CreateDeviceDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDeviceDefinitionResponse response = new CreateDeviceDefinitionResponse();
        ...
        private static CreateDeviceDefinitionResponseUnmarshaller _instance = new CreateDeviceDefinitionResponseUnmarshaller();        

        internal static CreateDeviceDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDeviceDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
