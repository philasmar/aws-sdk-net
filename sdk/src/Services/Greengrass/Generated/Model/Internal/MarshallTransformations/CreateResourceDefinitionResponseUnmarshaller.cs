...
{
    /// <summary>
    /// Response Unmarshaller for CreateResourceDefinition operation
    /// </summary>  
    public class CreateResourceDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateResourceDefinitionResponse response = new CreateResourceDefinitionResponse();
        ...
        private static CreateResourceDefinitionResponseUnmarshaller _instance = new CreateResourceDefinitionResponseUnmarshaller();        

        internal static CreateResourceDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateResourceDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
