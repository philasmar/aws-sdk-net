    ...
    public class ResourceUnmarshaller : IUnmarshaller<Resource, XmlUnmarshallerContext>, IUnmarshaller<Resource, JsonUnmarshallerContext>
    {
        ...
        public Resource Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("ResourceDataContainer", targetDepth))
                {
                    var unmarshaller = ResourceDataContainerUnmarshaller.Instance;
                    unmarshalledObject.ResourceDataContainer = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
