...
{
    /// <summary>
    /// Response Unmarshaller for CreateSubscriptionDefinition operation
    /// </summary>  
    public class CreateSubscriptionDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSubscriptionDefinitionResponse response = new CreateSubscriptionDefinitionResponse();
        ...
        private static CreateSubscriptionDefinitionResponseUnmarshaller _instance = new CreateSubscriptionDefinitionResponseUnmarshaller();        

        internal static CreateSubscriptionDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSubscriptionDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
