...
namespace Amazon.Greengrass.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetConnectorDefinitionRequestMarshaller : IMarshaller<IRequest, GetConnectorDefinitionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetConnectorDefinitionRequestMarshaller _instance = new GetConnectorDefinitionRequestMarshaller();        

        internal static GetConnectorDefinitionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConnectorDefinitionRequestMarshaller Instance
        {
            get
            {
                return _instance;
