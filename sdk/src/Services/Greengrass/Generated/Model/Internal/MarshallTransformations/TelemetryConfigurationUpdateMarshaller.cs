...
namespace Amazon.Greengrass.Model.Internal.MarshallTransformations
{
    ...
    public class TelemetryConfigurationUpdateMarshaller : IRequestMarshaller<TelemetryConfigurationUpdate, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(TelemetryConfigurationUpdate requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetTelemetry())
            {
                context.Writer.WritePropertyName("Telemetry");
                context.Writer.Write(requestObject.Telemetry);
            }
