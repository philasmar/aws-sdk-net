...
{
    /// <summary>
    /// Container for the parameters to the GetCoreDefinitionVersion operation.
    /// Retrieves information about a core definition version.
    /// </summary>
    public partial class GetCoreDefinitionVersionRequest : AmazonGreengrassRequest
    {
        private string _coreDefinitionId;
        private string _coreDefinitionVersionId;
        ...
        public string CoreDefinitionVersionId
        {
            ...
            set { this._coreDefinitionVersionId = value; }
        }

        // Check to see if CoreDefinitionVersionId property is set
        internal bool IsSetCoreDefinitionVersionId()
        {
            return this._coreDefinitionVersionId != null;
        }
