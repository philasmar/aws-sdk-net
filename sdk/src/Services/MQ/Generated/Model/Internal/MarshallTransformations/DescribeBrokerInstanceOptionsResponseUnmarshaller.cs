...
namespace Amazon.MQ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeBrokerInstanceOptionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBrokerInstanceOptionsResponse response = new DescribeBrokerInstanceOptionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BrokerInstanceOption, BrokerInstanceOptionUnmarshaller>(BrokerInstanceOptionUnmarshaller.Instance);
                    response.BrokerInstanceOptions = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeBrokerInstanceOptionsResponseUnmarshaller _instance = new DescribeBrokerInstanceOptionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBrokerInstanceOptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
