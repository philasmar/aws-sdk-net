...
namespace Amazon.MQ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeBrokerEngineTypesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBrokerEngineTypesResponse response = new DescribeBrokerEngineTypesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BrokerEngineType, BrokerEngineTypeUnmarshaller>(BrokerEngineTypeUnmarshaller.Instance);
                    response.BrokerEngineTypes = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeBrokerEngineTypesResponseUnmarshaller _instance = new DescribeBrokerEngineTypesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBrokerEngineTypesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
