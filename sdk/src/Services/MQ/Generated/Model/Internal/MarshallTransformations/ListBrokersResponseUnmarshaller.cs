...
namespace Amazon.MQ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListBrokersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListBrokersResponse response = new ListBrokersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BrokerSummary, BrokerSummaryUnmarshaller>(BrokerSummaryUnmarshaller.Instance);
                    response.BrokerSummaries = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListBrokersResponseUnmarshaller _instance = new ListBrokersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBrokersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
