...
namespace Amazon.MQ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteBrokerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteBrokerResponse response = new DeleteBrokerResponse();
        ...
        private static DeleteBrokerResponseUnmarshaller _instance = new DeleteBrokerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBrokerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
