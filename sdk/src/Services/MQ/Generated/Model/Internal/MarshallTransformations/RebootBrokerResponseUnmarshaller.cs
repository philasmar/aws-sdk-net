...
namespace Amazon.MQ.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RebootBrokerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RebootBrokerResponse response = new RebootBrokerResponse();
        ...
        private static RebootBrokerResponseUnmarshaller _instance = new RebootBrokerResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RebootBrokerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
