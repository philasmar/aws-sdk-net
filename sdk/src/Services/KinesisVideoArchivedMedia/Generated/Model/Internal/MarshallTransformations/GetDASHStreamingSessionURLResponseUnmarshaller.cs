...
namespace Amazon.KinesisVideoArchivedMedia.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDASHStreamingSessionURLResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDASHStreamingSessionURLResponse response = new GetDASHStreamingSessionURLResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DASHStreamingSessionURL", targetDepth))
                {
                    ...
                    response.DASHStreamingSessionURL = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetDASHStreamingSessionURLResponseUnmarshaller _instance = new GetDASHStreamingSessionURLResponseUnmarshaller();        

        internal static GetDASHStreamingSessionURLResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDASHStreamingSessionURLResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
