...
namespace Amazon.KinesisVideoArchivedMedia.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListFragmentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListFragmentsResponse response = new ListFragmentsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Fragment, FragmentUnmarshaller>(FragmentUnmarshaller.Instance);
                    response.Fragments = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListFragmentsResponseUnmarshaller _instance = new ListFragmentsResponseUnmarshaller();        

        internal static ListFragmentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFragmentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
