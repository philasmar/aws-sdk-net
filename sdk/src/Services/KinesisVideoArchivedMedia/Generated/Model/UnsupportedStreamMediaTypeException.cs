...
namespace Amazon.KinesisVideoArchivedMedia.Model
{
    ...
    public partial class UnsupportedStreamMediaTypeException : AmazonKinesisVideoArchivedMediaException
    {
        ...
        public UnsupportedStreamMediaTypeException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnsupportedStreamMediaTypeException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected UnsupportedStreamMediaTypeException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
