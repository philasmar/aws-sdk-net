...
namespace Amazon.KinesisVideoArchivedMedia
{
    ...
    public partial class AmazonKinesisVideoArchivedMediaClient : AmazonServiceClient, IAmazonKinesisVideoArchivedMedia
    {
        ...
        /// <summary>
        /// Initiates the asynchronous execution of the GetClip operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the GetClip operation on AmazonKinesisVideoArchivedMediaClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndGetClip
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/kinesis-video-archived-media-2017-09-30/GetClip">REST API Reference for GetClip Operation</seealso>
        public virtual IAsyncResult BeginGetClip(GetClipRequest request, AsyncCallback callback, object state)
        {
            var options = new InvokeOptions();
            options.RequestMarshaller = GetClipRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetClipResponseUnmarshaller.Instance;
        ...
        /// <summary>
        /// Finishes the asynchronous execution of the  GetClip operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginGetClip.</param>
        /// 
        /// <returns>Returns a  GetClipResult from KinesisVideoArchivedMedia.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/kinesis-video-archived-media-2017-09-30/GetClip">REST API Reference for GetClip Operation</seealso>
        public virtual GetClipResponse EndGetClip(IAsyncResult asyncResult)
        {
            return EndInvoke<GetClipResponse>(asyncResult);
        }
        ...
        /// <summary>
        /// Initiates the asynchronous execution of the GetDASHStreamingSessionURL operation.
        /// </summary>
        /// 
        /// <param name="request">Container for the necessary parameters to execute the GetDASHStreamingSessionURL operation on AmazonKinesisVideoArchivedMediaClient.</param>
        /// <param name="callback">An AsyncCallback delegate that is invoked when the operation completes.</param>
        /// <param name="state">A user-defined state object that is passed to the callback procedure. Retrieve this object from within the callback
        ///          procedure using the AsyncState property.</param>
        /// 
        /// <returns>An IAsyncResult that can be used to poll or wait for results, or both; this value is also needed when invoking EndGetDASHStreamingSessionURL
        ///         operation.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/kinesis-video-archived-media-2017-09-30/GetDASHStreamingSessionURL">REST API Reference for GetDASHStreamingSessionURL Operation</seealso>
        public virtual IAsyncResult BeginGetDASHStreamingSessionURL(GetDASHStreamingSessionURLRequest request, AsyncCallback callback, object state)
        {
            var options = new InvokeOptions();
            options.RequestMarshaller = GetDASHStreamingSessionURLRequestMarshaller.Instance;
            options.ResponseUnmarshaller = GetDASHStreamingSessionURLResponseUnmarshaller.Instance;
        ...
        /// <summary>
        /// Finishes the asynchronous execution of the  GetDASHStreamingSessionURL operation.
        /// </summary>
        /// 
        /// <param name="asyncResult">The IAsyncResult returned by the call to BeginGetDASHStreamingSessionURL.</param>
        /// 
        /// <returns>Returns a  GetDASHStreamingSessionURLResult from KinesisVideoArchivedMedia.</returns>
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/kinesis-video-archived-media-2017-09-30/GetDASHStreamingSessionURL">REST API Reference for GetDASHStreamingSessionURL Operation</seealso>
        public virtual GetDASHStreamingSessionURLResponse EndGetDASHStreamingSessionURL(IAsyncResult asyncResult)
        {
            return EndInvoke<GetDASHStreamingSessionURLResponse>(asyncResult);
        }
        ...
        /// <seealso href="http://docs.aws.amazon.com/goto/WebAPI/kinesis-video-archived-media-2017-09-30/GetHLSStreamingSessionURL">REST API Reference for GetHLSStreamingSessionURL Operation</seealso>
        public virtual GetHLSStreamingSessionURLResponse EndGetHLSStreamingSessionURL(IAsyncResult asyncResult)
        {
            return EndInvoke<GetHLSStreamingSessionURLResponse>(asyncResult);
        }
