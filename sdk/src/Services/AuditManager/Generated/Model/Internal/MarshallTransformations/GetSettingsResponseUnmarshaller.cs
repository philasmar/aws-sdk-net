...
{
    /// <summary>
    /// Response Unmarshaller for GetSettings operation
    /// </summary>  
    public class GetSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetSettingsResponseUnmarshaller _instance = new GetSettingsResponseUnmarshaller();        

        internal static GetSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
