...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    public class CreateControlResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateControlResponseUnmarshaller _instance = new CreateControlResponseUnmarshaller();        

        internal static CreateControlResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateControlResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
