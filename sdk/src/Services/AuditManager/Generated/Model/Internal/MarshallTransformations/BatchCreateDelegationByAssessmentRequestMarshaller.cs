...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class BatchCreateDelegationByAssessmentRequestMarshaller : IMarshaller<IRequest, BatchCreateDelegationByAssessmentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static BatchCreateDelegationByAssessmentRequestMarshaller _instance = new BatchCreateDelegationByAssessmentRequestMarshaller();        

        internal static BatchCreateDelegationByAssessmentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchCreateDelegationByAssessmentRequestMarshaller Instance
        {
            get
            {
                return _instance;
