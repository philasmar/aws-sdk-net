...
namespace Amazon.AuditManager.Model.Internal.MarshallTransformations
{
    ...
    public class CreateAssessmentFrameworkResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateAssessmentFrameworkResponseUnmarshaller _instance = new CreateAssessmentFrameworkResponseUnmarshaller();        

        internal static CreateAssessmentFrameworkResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAssessmentFrameworkResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
