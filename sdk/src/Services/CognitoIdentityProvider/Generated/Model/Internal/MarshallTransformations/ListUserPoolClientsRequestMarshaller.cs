...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListUserPoolClientsRequestMarshaller : IMarshaller<IRequest, ListUserPoolClientsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListUserPoolClientsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListUserPoolClientsRequest publicRequest)
        {
        ...
        private static ListUserPoolClientsRequestMarshaller _instance = new ListUserPoolClientsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUserPoolClientsRequestMarshaller Instance
        {
            get
            {
                return _instance;
