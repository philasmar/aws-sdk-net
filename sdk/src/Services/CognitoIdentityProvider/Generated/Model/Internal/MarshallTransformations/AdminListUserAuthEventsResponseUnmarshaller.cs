...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminListUserAuthEventsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminListUserAuthEventsResponse response = new AdminListUserAuthEventsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AuthEventType, AuthEventTypeUnmarshaller>(AuthEventTypeUnmarshaller.Instance);
                    response.AuthEvents = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static AdminListUserAuthEventsResponseUnmarshaller _instance = new AdminListUserAuthEventsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminListUserAuthEventsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
