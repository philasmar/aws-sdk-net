...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListUserImportJobsRequestMarshaller : IMarshaller<IRequest, ListUserImportJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListUserImportJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListUserImportJobsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CognitoIdentityProvider");
            string target = "AWSCognitoIdentityProviderService.ListUserImportJobs";
        ...
        private static ListUserImportJobsRequestMarshaller _instance = new ListUserImportJobsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUserImportJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
