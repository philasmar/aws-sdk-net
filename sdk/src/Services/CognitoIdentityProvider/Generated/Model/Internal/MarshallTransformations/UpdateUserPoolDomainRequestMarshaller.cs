...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateUserPoolDomainRequestMarshaller : IMarshaller<IRequest, UpdateUserPoolDomainRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateUserPoolDomainRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateUserPoolDomainRequest publicRequest)
        {
        ...
        private static UpdateUserPoolDomainRequestMarshaller _instance = new UpdateUserPoolDomainRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateUserPoolDomainRequestMarshaller Instance
        {
            get
            {
                return _instance;
