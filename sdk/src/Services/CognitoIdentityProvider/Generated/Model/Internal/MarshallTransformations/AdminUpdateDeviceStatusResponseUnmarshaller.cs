...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminUpdateDeviceStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminUpdateDeviceStatusResponse response = new AdminUpdateDeviceStatusResponse();
        ...
        private static AdminUpdateDeviceStatusResponseUnmarshaller _instance = new AdminUpdateDeviceStatusResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminUpdateDeviceStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
