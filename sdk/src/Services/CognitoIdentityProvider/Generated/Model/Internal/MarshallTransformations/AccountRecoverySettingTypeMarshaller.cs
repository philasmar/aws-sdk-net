    ...
    public class AccountRecoverySettingTypeMarshaller : IRequestMarshaller<AccountRecoverySettingType, JsonMarshallerContext> 
    {
        ...
        public void Marshall(AccountRecoverySettingType requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetRecoveryMechanisms())
            {
                ...
                foreach(var requestObjectRecoveryMechanismsListValue in requestObject.RecoveryMechanisms)
                {
                    context.Writer.WriteObjectStart();

                    var marshaller = RecoveryOptionTypeMarshaller.Instance;
                    marshaller.Marshall(requestObjectRecoveryMechanismsListValue, context);
