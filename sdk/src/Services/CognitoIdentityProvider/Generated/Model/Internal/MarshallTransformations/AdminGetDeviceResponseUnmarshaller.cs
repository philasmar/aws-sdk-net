...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminGetDeviceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminGetDeviceResponse response = new AdminGetDeviceResponse();
        ...
        private static AdminGetDeviceResponseUnmarshaller _instance = new AdminGetDeviceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminGetDeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
