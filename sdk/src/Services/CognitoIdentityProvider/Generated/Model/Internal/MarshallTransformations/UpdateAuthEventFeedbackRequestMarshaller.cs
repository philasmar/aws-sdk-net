...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateAuthEventFeedbackRequestMarshaller : IMarshaller<IRequest, UpdateAuthEventFeedbackRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAuthEventFeedbackRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAuthEventFeedbackRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CognitoIdentityProvider");
            string target = "AWSCognitoIdentityProviderService.UpdateAuthEventFeedback";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetFeedbackToken())
                {
                    context.Writer.WritePropertyName("FeedbackToken");
                    context.Writer.Write(publicRequest.FeedbackToken);
                }
