...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetUserAttributeVerificationCodeRequestMarshaller : IMarshaller<IRequest, GetUserAttributeVerificationCodeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetUserAttributeVerificationCodeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetUserAttributeVerificationCodeRequest publicRequest)
        {
