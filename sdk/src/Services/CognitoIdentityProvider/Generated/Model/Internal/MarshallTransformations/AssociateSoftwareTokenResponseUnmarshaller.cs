...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociateSoftwareTokenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateSoftwareTokenResponse response = new AssociateSoftwareTokenResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("SecretCode", targetDepth))
                {
                    ...
                    response.SecretCode = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static AssociateSoftwareTokenResponseUnmarshaller _instance = new AssociateSoftwareTokenResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateSoftwareTokenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
