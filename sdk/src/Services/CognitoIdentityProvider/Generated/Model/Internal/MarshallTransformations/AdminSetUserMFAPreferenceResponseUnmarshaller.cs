...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminSetUserMFAPreferenceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminSetUserMFAPreferenceResponse response = new AdminSetUserMFAPreferenceResponse();
        ...
        private static AdminSetUserMFAPreferenceResponseUnmarshaller _instance = new AdminSetUserMFAPreferenceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminSetUserMFAPreferenceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
