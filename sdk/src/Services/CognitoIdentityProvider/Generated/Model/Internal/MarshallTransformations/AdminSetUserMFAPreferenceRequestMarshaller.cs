...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AdminSetUserMFAPreferenceRequestMarshaller : IMarshaller<IRequest, AdminSetUserMFAPreferenceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AdminSetUserMFAPreferenceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AdminSetUserMFAPreferenceRequest publicRequest)
        {
        ...
        private static AdminSetUserMFAPreferenceRequestMarshaller _instance = new AdminSetUserMFAPreferenceRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminSetUserMFAPreferenceRequestMarshaller Instance
        {
            get
            {
                return _instance;
