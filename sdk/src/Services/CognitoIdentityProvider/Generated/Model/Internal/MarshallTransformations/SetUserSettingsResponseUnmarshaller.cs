...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SetUserSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetUserSettingsResponse response = new SetUserSettingsResponse();
        ...
        private static SetUserSettingsResponseUnmarshaller _instance = new SetUserSettingsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetUserSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
