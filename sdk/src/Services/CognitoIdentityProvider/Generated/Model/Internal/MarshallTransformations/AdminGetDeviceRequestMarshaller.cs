...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AdminGetDeviceRequestMarshaller : IMarshaller<IRequest, AdminGetDeviceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AdminGetDeviceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AdminGetDeviceRequest publicRequest)
        {
        ...
        private static AdminGetDeviceRequestMarshaller _instance = new AdminGetDeviceRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminGetDeviceRequestMarshaller Instance
        {
            get
            {
                return _instance;
