...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class SetUICustomizationRequestMarshaller : IMarshaller<IRequest, SetUICustomizationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SetUICustomizationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SetUICustomizationRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetCSS())
                {
                    context.Writer.WritePropertyName("CSS");
                    context.Writer.Write(publicRequest.CSS);
                }

                if(publicRequest.IsSetImageFile())
                {
                    context.Writer.WritePropertyName("ImageFile");
                    context.Writer.Write(StringUtils.FromMemoryStream(publicRequest.ImageFile));
                }
