...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StartUserImportJobRequestMarshaller : IMarshaller<IRequest, StartUserImportJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartUserImportJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartUserImportJobRequest publicRequest)
        {
        ...
        private static StartUserImportJobRequestMarshaller _instance = new StartUserImportJobRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartUserImportJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
