...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetUICustomizationRequestMarshaller : IMarshaller<IRequest, GetUICustomizationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetUICustomizationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetUICustomizationRequest publicRequest)
        {
        ...
        private static GetUICustomizationRequestMarshaller _instance = new GetUICustomizationRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUICustomizationRequestMarshaller Instance
        {
            get
            {
                return _instance;
