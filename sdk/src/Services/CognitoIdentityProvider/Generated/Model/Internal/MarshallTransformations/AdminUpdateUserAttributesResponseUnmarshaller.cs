...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    public class AdminUpdateUserAttributesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        {
            AdminUpdateUserAttributesResponse response = new AdminUpdateUserAttributesResponse();
        ...
        private static AdminUpdateUserAttributesResponseUnmarshaller _instance = new AdminUpdateUserAttributesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminUpdateUserAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
