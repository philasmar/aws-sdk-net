...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateUserPoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateUserPoolResponse response = new CreateUserPoolResponse();
        ...
        private static CreateUserPoolResponseUnmarshaller _instance = new CreateUserPoolResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateUserPoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
