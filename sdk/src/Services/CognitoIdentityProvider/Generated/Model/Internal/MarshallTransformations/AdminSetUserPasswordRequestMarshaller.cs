...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AdminSetUserPasswordRequestMarshaller : IMarshaller<IRequest, AdminSetUserPasswordRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AdminSetUserPasswordRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AdminSetUserPasswordRequest publicRequest)
        {
        ...
        private static AdminSetUserPasswordRequestMarshaller _instance = new AdminSetUserPasswordRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminSetUserPasswordRequestMarshaller Instance
        {
            get
            {
                return _instance;
