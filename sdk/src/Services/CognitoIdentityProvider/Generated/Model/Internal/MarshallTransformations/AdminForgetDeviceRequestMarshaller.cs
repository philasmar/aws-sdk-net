...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AdminForgetDeviceRequestMarshaller : IMarshaller<IRequest, AdminForgetDeviceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AdminForgetDeviceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AdminForgetDeviceRequest publicRequest)
        {
        ...
        private static AdminForgetDeviceRequestMarshaller _instance = new AdminForgetDeviceRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminForgetDeviceRequestMarshaller Instance
        {
            get
            {
                return _instance;
