...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AdminDisableProviderForUserRequestMarshaller : IMarshaller<IRequest, AdminDisableProviderForUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AdminDisableProviderForUserRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AdminDisableProviderForUserRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetUser())
                {
                    ...
                    marshaller.Marshall(publicRequest.User, context);
        ...
        private static AdminDisableProviderForUserRequestMarshaller _instance = new AdminDisableProviderForUserRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminDisableProviderForUserRequestMarshaller Instance
        {
            get
            {
                return _instance;
