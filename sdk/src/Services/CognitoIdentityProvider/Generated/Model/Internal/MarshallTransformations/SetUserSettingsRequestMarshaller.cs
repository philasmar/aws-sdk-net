...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class SetUserSettingsRequestMarshaller : IMarshaller<IRequest, SetUserSettingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SetUserSettingsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SetUserSettingsRequest publicRequest)
        {
        ...
        private static SetUserSettingsRequestMarshaller _instance = new SetUserSettingsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetUserSettingsRequestMarshaller Instance
        {
            get
            {
                return _instance;
