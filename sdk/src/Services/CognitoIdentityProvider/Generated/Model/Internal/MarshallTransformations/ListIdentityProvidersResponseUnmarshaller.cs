...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListIdentityProvidersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListIdentityProvidersResponse response = new ListIdentityProvidersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ProviderDescription, ProviderDescriptionUnmarshaller>(ProviderDescriptionUnmarshaller.Instance);
                    response.Providers = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIdentityProvidersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
