...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateResourceServerRequestMarshaller : IMarshaller<IRequest, UpdateResourceServerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateResourceServerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateResourceServerRequest publicRequest)
        {
        ...
        private static UpdateResourceServerRequestMarshaller _instance = new UpdateResourceServerRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateResourceServerRequestMarshaller Instance
        {
            get
            {
                return _instance;
