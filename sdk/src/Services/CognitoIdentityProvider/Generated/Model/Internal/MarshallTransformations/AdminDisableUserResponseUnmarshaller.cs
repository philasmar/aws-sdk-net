...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminDisableUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminDisableUserResponse response = new AdminDisableUserResponse();
        ...
        private static AdminDisableUserResponseUnmarshaller _instance = new AdminDisableUserResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminDisableUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
