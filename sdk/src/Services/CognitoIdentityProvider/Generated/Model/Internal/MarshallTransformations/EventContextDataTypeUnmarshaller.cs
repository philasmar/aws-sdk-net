...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EventContextDataTypeUnmarshaller : IUnmarshaller<EventContextDataType, XmlUnmarshallerContext>, IUnmarshaller<EventContextDataType, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        EventContextDataType IUnmarshaller<EventContextDataType, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public EventContextDataType Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
