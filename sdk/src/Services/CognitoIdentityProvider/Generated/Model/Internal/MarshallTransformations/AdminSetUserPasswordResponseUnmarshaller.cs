...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminSetUserPasswordResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminSetUserPasswordResponse response = new AdminSetUserPasswordResponse();
        ...
        private static AdminSetUserPasswordResponseUnmarshaller _instance = new AdminSetUserPasswordResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminSetUserPasswordResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
