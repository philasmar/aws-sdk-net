...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteUserPoolDomainRequestMarshaller : IMarshaller<IRequest, DeleteUserPoolDomainRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteUserPoolDomainRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteUserPoolDomainRequest publicRequest)
        {
        ...
        private static DeleteUserPoolDomainRequestMarshaller _instance = new DeleteUserPoolDomainRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteUserPoolDomainRequestMarshaller Instance
        {
            get
            {
                return _instance;
