...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListResourceServersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListResourceServersResponse response = new ListResourceServersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ResourceServerType, ResourceServerTypeUnmarshaller>(ResourceServerTypeUnmarshaller.Instance);
                    response.ResourceServers = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListResourceServersResponseUnmarshaller _instance = new ListResourceServersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListResourceServersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
