...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ForgetDeviceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ForgetDeviceResponse response = new ForgetDeviceResponse();
        ...
        private static ForgetDeviceResponseUnmarshaller _instance = new ForgetDeviceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ForgetDeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
