...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SetUserMFAPreferenceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetUserMFAPreferenceResponse response = new SetUserMFAPreferenceResponse();
        ...
        private static SetUserMFAPreferenceResponseUnmarshaller _instance = new SetUserMFAPreferenceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetUserMFAPreferenceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
