...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    public class VerificationMessageTemplateTypeUnmarshaller : IUnmarshaller<VerificationMessageTemplateType, XmlUnmarshallerContext>, IUnmarshaller<VerificationMessageTemplateType, JsonUnmarshallerContext>
    {
        ...
        private static VerificationMessageTemplateTypeUnmarshaller _instance = new VerificationMessageTemplateTypeUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static VerificationMessageTemplateTypeUnmarshaller Instance
        {
            get
            {
                return _instance;
