...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminDisableProviderForUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminDisableProviderForUserResponse response = new AdminDisableProviderForUserResponse();
        ...
        private static AdminDisableProviderForUserResponseUnmarshaller _instance = new AdminDisableProviderForUserResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminDisableProviderForUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
