...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeUserPoolDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeUserPoolDomainResponse response = new DescribeUserPoolDomainResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("DomainDescription", targetDepth))
                {
                    ...
                    response.DomainDescription = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeUserPoolDomainResponseUnmarshaller _instance = new DescribeUserPoolDomainResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeUserPoolDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
