...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateUserAttributesRequestMarshaller : IMarshaller<IRequest, UpdateUserAttributesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateUserAttributesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateUserAttributesRequest publicRequest)
        {
        ...
        private static UpdateUserAttributesRequestMarshaller _instance = new UpdateUserAttributesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateUserAttributesRequestMarshaller Instance
        {
            get
            {
                return _instance;
