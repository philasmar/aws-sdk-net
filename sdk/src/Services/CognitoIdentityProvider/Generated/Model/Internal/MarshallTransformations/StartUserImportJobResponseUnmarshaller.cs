...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartUserImportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartUserImportJobResponse response = new StartUserImportJobResponse();
        ...
        private static StartUserImportJobResponseUnmarshaller _instance = new StartUserImportJobResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartUserImportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
