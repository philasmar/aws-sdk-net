...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetCSVHeaderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCSVHeaderResponse response = new GetCSVHeaderResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("CSVHeader", targetDepth))
                {
                    ...
                    response.CSVHeader = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("UserPoolId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.UserPoolId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetCSVHeaderResponseUnmarshaller _instance = new GetCSVHeaderResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCSVHeaderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
