...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminListDevicesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminListDevicesResponse response = new AdminListDevicesResponse();
        ...
        private static AdminListDevicesResponseUnmarshaller _instance = new AdminListDevicesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminListDevicesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
