...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class SetRiskConfigurationRequestMarshaller : IMarshaller<IRequest, SetRiskConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SetRiskConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SetRiskConfigurationRequest publicRequest)
        {
