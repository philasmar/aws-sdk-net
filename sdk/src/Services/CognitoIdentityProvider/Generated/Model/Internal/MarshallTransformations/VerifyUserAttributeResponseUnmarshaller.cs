...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VerifyUserAttributeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            VerifyUserAttributeResponse response = new VerifyUserAttributeResponse();
        ...
        private static VerifyUserAttributeResponseUnmarshaller _instance = new VerifyUserAttributeResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifyUserAttributeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
