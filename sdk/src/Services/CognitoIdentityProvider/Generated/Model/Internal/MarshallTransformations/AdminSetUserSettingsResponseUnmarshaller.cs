...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AdminSetUserSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AdminSetUserSettingsResponse response = new AdminSetUserSettingsResponse();
        ...
        private static AdminSetUserSettingsResponseUnmarshaller _instance = new AdminSetUserSettingsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AdminSetUserSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
