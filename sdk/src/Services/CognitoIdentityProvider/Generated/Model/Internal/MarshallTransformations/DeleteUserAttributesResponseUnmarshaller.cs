...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteUserAttributesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteUserAttributesResponse response = new DeleteUserAttributesResponse();
        ...
        private static DeleteUserAttributesResponseUnmarshaller _instance = new DeleteUserAttributesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteUserAttributesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
