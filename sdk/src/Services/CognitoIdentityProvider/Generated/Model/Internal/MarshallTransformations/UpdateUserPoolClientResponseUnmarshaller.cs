...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateUserPoolClientResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateUserPoolClientResponse response = new UpdateUserPoolClientResponse();
        ...
        private static UpdateUserPoolClientResponseUnmarshaller _instance = new UpdateUserPoolClientResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateUserPoolClientResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
