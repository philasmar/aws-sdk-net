...
namespace Amazon.CognitoIdentityProvider.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class VerifySoftwareTokenRequestMarshaller : IMarshaller<IRequest, VerifySoftwareTokenRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((VerifySoftwareTokenRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(VerifySoftwareTokenRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetFriendlyDeviceName())
                {
                    context.Writer.WritePropertyName("FriendlyDeviceName");
                    context.Writer.Write(publicRequest.FriendlyDeviceName);
                }
