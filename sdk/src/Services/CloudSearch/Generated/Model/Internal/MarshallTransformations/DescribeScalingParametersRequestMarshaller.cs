    ...
    public class DescribeScalingParametersRequestMarshaller : IMarshaller<IRequest, DescribeScalingParametersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeScalingParametersRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeScalingParametersRequestMarshaller _instance = new DescribeScalingParametersRequestMarshaller();        

        internal static DescribeScalingParametersRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeScalingParametersRequestMarshaller Instance
        {
            get
            {
                return _instance;
