...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    public class ValidationExceptionUnmarshaller : IErrorResponseUnmarshaller<ValidationException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ValidationException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public ValidationException Unmarshall(XmlUnmarshallerContext context, ErrorResponse errorResponse)
        {
            ValidationException response = new ValidationException(errorResponse.Message, errorResponse.InnerException, 
