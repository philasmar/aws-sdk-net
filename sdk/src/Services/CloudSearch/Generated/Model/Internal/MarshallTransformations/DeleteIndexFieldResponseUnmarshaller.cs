...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteIndexFieldResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteIndexFieldResponseUnmarshaller _instance = new DeleteIndexFieldResponseUnmarshaller();        

        internal static DeleteIndexFieldResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteIndexFieldResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
