...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    public class SuggesterUnmarshaller : IUnmarshaller<Suggester, XmlUnmarshallerContext>, IUnmarshaller<Suggester, JsonUnmarshallerContext>
    {
        ...
        {
            Suggester unmarshalledObject = new Suggester();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = DocumentSuggesterOptionsUnmarshaller.Instance;
                        unmarshalledObject.DocumentSuggesterOptions = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("SuggesterName", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.SuggesterName = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SuggesterUnmarshaller Instance
        {
            get
            {
                return _instance;
