    ...
    public class DefineExpressionRequestMarshaller : IMarshaller<IRequest, DefineExpressionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DefineExpressionRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DefineExpressionRequestMarshaller _instance = new DefineExpressionRequestMarshaller();        

        internal static DefineExpressionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DefineExpressionRequestMarshaller Instance
        {
            get
            {
                return _instance;
