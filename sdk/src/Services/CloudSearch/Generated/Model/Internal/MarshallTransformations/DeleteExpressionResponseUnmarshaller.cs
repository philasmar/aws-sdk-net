...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteExpressionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteExpressionResponseUnmarshaller _instance = new DeleteExpressionResponseUnmarshaller();        

        internal static DeleteExpressionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteExpressionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
