...
namespace Amazon.CloudSearch.Model.Internal.MarshallTransformations
{
    ...
    public class DisabledOperationExceptionUnmarshaller : IErrorResponseUnmarshaller<DisabledOperationException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public DisabledOperationException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public DisabledOperationException Unmarshall(XmlUnmarshallerContext context, ErrorResponse errorResponse)
        {
            DisabledOperationException response = new DisabledOperationException(errorResponse.Message, errorResponse.InnerException, 
