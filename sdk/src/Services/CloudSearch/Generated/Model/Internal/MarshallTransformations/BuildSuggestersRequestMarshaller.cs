    ...
    public class BuildSuggestersRequestMarshaller : IMarshaller<IRequest, BuildSuggestersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(BuildSuggestersRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static BuildSuggestersRequestMarshaller _instance = new BuildSuggestersRequestMarshaller();        

        internal static BuildSuggestersRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BuildSuggestersRequestMarshaller Instance
        {
            get
            {
                return _instance;
