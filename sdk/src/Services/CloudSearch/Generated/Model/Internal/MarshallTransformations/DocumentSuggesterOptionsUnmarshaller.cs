...
{
    /// <summary>
    /// Response Unmarshaller for DocumentSuggesterOptions Object
    /// </summary>  
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("FuzzyMatching", targetDepth))
                    {
                        ...
                        unmarshalledObject.FuzzyMatching = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("SortExpression", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.SortExpression = unmarshaller.Unmarshall(context);
                        continue;
                    }
