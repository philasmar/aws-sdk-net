    ...
    public class DescribeSuggestersRequestMarshaller : IMarshaller<IRequest, DescribeSuggestersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeSuggestersRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeSuggestersRequestMarshaller _instance = new DescribeSuggestersRequestMarshaller();        

        internal static DescribeSuggestersRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSuggestersRequestMarshaller Instance
        {
            get
            {
                return _instance;
