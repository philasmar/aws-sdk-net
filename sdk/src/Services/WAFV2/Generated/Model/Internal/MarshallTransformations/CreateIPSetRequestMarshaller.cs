...
namespace Amazon.WAFV2.Model.Internal.MarshallTransformations
{
    ...
    public class CreateIPSetRequestMarshaller : IMarshaller<IRequest, CreateIPSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateIPSetRequest publicRequest)
        {
            ...
            string target = "AWSWAF_20190729.CreateIPSet";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetAddresses())
                {
                    ...
                    {
                            context.Writer.Write(publicRequestAddressesListValue);
                    }
                ...
                if(publicRequest.IsSetIPAddressVersion())
                {
                    context.Writer.WritePropertyName("IPAddressVersion");
                    context.Writer.Write(publicRequest.IPAddressVersion);
                }
