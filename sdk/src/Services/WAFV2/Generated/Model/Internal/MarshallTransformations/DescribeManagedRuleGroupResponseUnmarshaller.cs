...
{
    /// <summary>
    /// Response Unmarshaller for DescribeManagedRuleGroup operation
    /// </summary>  
    public class DescribeManagedRuleGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeManagedRuleGroupResponseUnmarshaller _instance = new DescribeManagedRuleGroupResponseUnmarshaller();        

        internal static DescribeManagedRuleGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeManagedRuleGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
