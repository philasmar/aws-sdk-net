...
namespace Amazon.WAFV2.Model.Internal.MarshallTransformations
{
    ...
    public class GeoMatchStatementMarshaller : IRequestMarshaller<GeoMatchStatement, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(GeoMatchStatement requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetCountryCodes())
            {
                context.Writer.WritePropertyName("CountryCodes");
                context.Writer.WriteArrayStart();
                foreach(var requestObjectCountryCodesListValue in requestObject.CountryCodes)
                {
                        context.Writer.Write(requestObjectCountryCodesListValue);
                }
