...
{
    /// <summary>
    /// Response Unmarshaller for CheckCapacity operation
    /// </summary>  
    public class CheckCapacityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CheckCapacityResponse response = new CheckCapacityResponse();
        ...
        private static CheckCapacityResponseUnmarshaller _instance = new CheckCapacityResponseUnmarshaller();        

        internal static CheckCapacityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CheckCapacityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
