...
namespace Amazon.WAFV2.Model.Internal.MarshallTransformations
{
    ...
    public class ByteMatchStatementMarshaller : IRequestMarshaller<ByteMatchStatement, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(ByteMatchStatement requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetSearchString())
            {
                ...
                context.Writer.Write(StringUtils.FromMemoryStream(requestObject.SearchString));
            }
