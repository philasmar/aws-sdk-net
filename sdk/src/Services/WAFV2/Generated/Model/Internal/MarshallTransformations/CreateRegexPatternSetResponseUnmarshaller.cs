...
{
    /// <summary>
    /// Response Unmarshaller for CreateRegexPatternSet operation
    /// </summary>  
    public class CreateRegexPatternSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRegexPatternSetResponse response = new CreateRegexPatternSetResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = RegexPatternSetSummaryUnmarshaller.Instance;
        ...
        private static CreateRegexPatternSetResponseUnmarshaller _instance = new CreateRegexPatternSetResponseUnmarshaller();        

        internal static CreateRegexPatternSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRegexPatternSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
