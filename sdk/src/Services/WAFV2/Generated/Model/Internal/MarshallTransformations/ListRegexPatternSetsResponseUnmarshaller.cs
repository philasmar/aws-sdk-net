...
{
    /// <summary>
    /// Response Unmarshaller for ListRegexPatternSets operation
    /// </summary>  
    public class ListRegexPatternSetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRegexPatternSetsResponse response = new ListRegexPatternSetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RegexPatternSetSummary, RegexPatternSetSummaryUnmarshaller>(RegexPatternSetSummaryUnmarshaller.Instance);
                    response.RegexPatternSets = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListRegexPatternSetsResponseUnmarshaller _instance = new ListRegexPatternSetsResponseUnmarshaller();        

        internal static ListRegexPatternSetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRegexPatternSetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
