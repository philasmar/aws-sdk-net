...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRegexPatternSet operation
    /// </summary>  
    public class DeleteRegexPatternSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRegexPatternSetResponse response = new DeleteRegexPatternSetResponse();
        ...
        private static DeleteRegexPatternSetResponseUnmarshaller _instance = new DeleteRegexPatternSetResponseUnmarshaller();        

        internal static DeleteRegexPatternSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRegexPatternSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
