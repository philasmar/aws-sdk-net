...
{
    /// <summary>
    /// Response Unmarshaller for GetRateBasedStatementManagedKeys operation
    /// </summary>  
    public class GetRateBasedStatementManagedKeysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRateBasedStatementManagedKeysResponse response = new GetRateBasedStatementManagedKeysResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ManagedKeysIPV4", targetDepth))
                {
                    ...
                    response.ManagedKeysIPV4 = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ManagedKeysIPV6", targetDepth))
                {
                    var unmarshaller = RateBasedStatementManagedKeysIPSetUnmarshaller.Instance;
                    response.ManagedKeysIPV6 = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetRateBasedStatementManagedKeysResponseUnmarshaller _instance = new GetRateBasedStatementManagedKeysResponseUnmarshaller();        

        internal static GetRateBasedStatementManagedKeysResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRateBasedStatementManagedKeysResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
