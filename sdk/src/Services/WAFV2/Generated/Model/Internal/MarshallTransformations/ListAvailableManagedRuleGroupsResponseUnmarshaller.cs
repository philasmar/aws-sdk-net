...
{
    /// <summary>
    /// Response Unmarshaller for ListAvailableManagedRuleGroups operation
    /// </summary>  
    public class ListAvailableManagedRuleGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAvailableManagedRuleGroupsResponse response = new ListAvailableManagedRuleGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ManagedRuleGroupSummary, ManagedRuleGroupSummaryUnmarshaller>(ManagedRuleGroupSummaryUnmarshaller.Instance);
                    response.ManagedRuleGroups = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListAvailableManagedRuleGroupsResponseUnmarshaller _instance = new ListAvailableManagedRuleGroupsResponseUnmarshaller();        

        internal static ListAvailableManagedRuleGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAvailableManagedRuleGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
