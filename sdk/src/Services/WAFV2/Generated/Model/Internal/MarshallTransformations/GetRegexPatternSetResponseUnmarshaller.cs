...
{
    /// <summary>
    /// Response Unmarshaller for GetRegexPatternSet operation
    /// </summary>  
    public class GetRegexPatternSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRegexPatternSetResponse response = new GetRegexPatternSetResponse();
        ...
        private static GetRegexPatternSetResponseUnmarshaller _instance = new GetRegexPatternSetResponseUnmarshaller();        

        internal static GetRegexPatternSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRegexPatternSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
