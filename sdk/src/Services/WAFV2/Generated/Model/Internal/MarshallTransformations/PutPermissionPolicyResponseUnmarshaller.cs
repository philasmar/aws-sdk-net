...
{
    /// <summary>
    /// Response Unmarshaller for PutPermissionPolicy operation
    /// </summary>  
    public class PutPermissionPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutPermissionPolicyResponse response = new PutPermissionPolicyResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("WAFInvalidPermissionPolicyException"))
                {
                    return WAFInvalidPermissionPolicyExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static PutPermissionPolicyResponseUnmarshaller _instance = new PutPermissionPolicyResponseUnmarshaller();        

        internal static PutPermissionPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutPermissionPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
