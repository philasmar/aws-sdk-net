...
namespace Amazon.ApiGatewayManagementApi.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PostToConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PostToConnectionResponse response = new PostToConnectionResponse();
        ...
        internal static PostToConnectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PostToConnectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
