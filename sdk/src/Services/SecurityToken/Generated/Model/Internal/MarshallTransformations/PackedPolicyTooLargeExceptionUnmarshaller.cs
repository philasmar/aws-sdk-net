...
namespace Amazon.SecurityToken.Model.Internal.MarshallTransformations
{
    ...
    public class PackedPolicyTooLargeExceptionUnmarshaller : IErrorResponseUnmarshaller<PackedPolicyTooLargeException, XmlUnmarshallerContext>
    {
        ...
        private static PackedPolicyTooLargeExceptionUnmarshaller _instance = new PackedPolicyTooLargeExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PackedPolicyTooLargeExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
