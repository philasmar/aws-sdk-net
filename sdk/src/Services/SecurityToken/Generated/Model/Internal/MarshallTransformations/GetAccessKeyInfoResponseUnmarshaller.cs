...
namespace Amazon.SecurityToken.Model.Internal.MarshallTransformations
{
    ...
    public class GetAccessKeyInfoResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        {
            GetAccessKeyInfoResponse response = new GetAccessKeyInfoResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GetAccessKeyInfoResult", 2))
                    {
        ...
        private static GetAccessKeyInfoResponseUnmarshaller _instance = new GetAccessKeyInfoResponseUnmarshaller();        
