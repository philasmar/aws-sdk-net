...
namespace Amazon.SecurityToken.Model.Internal.MarshallTransformations
{
    ...
    public class RegionDisabledExceptionUnmarshaller : IErrorResponseUnmarshaller<RegionDisabledException, XmlUnmarshallerContext>
    {
        ...
        private static RegionDisabledExceptionUnmarshaller _instance = new RegionDisabledExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RegionDisabledExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
