...
namespace Amazon.SecurityToken.Model.Internal.MarshallTransformations
{
    ...
    public class ExpiredTokenExceptionUnmarshaller : IErrorResponseUnmarshaller<ExpiredTokenException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ExpiredTokenException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public ExpiredTokenException Unmarshall(XmlUnmarshallerContext context, ErrorResponse errorResponse)
        {
            ExpiredTokenException response = new ExpiredTokenException(errorResponse.Message, errorResponse.InnerException, 
