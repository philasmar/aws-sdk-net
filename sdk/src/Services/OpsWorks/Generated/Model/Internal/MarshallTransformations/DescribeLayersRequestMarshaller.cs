...
namespace Amazon.OpsWorks.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeLayersRequestMarshaller : IMarshaller<IRequest, DescribeLayersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeLayersRequest)input);
        }
        ...
        private static DescribeLayersRequestMarshaller _instance = new DescribeLayersRequestMarshaller();        

        internal static DescribeLayersRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLayersRequestMarshaller Instance
        {
            get
            {
                return _instance;
