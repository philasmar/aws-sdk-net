...
{
    /// <summary>
    /// Response Unmarshaller for AssociateWebACL operation
    /// </summary>  
    public class AssociateWebACLResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateWebACLResponse response = new AssociateWebACLResponse();
        ...
        private static AssociateWebACLResponseUnmarshaller _instance = new AssociateWebACLResponseUnmarshaller();        

        internal static AssociateWebACLResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateWebACLResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
