...
namespace Amazon.WAFRegional.Model.Internal.MarshallTransformations
{
    ...
    public class IPSetUpdateMarshaller : IRequestMarshaller<IPSetUpdate, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(IPSetUpdate requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetIPSetDescriptor())
            {
                context.Writer.WritePropertyName("IPSetDescriptor");
                context.Writer.WriteObjectStart();

                var marshaller = IPSetDescriptorMarshaller.Instance;
                marshaller.Marshall(requestObject.IPSetDescriptor, context);
