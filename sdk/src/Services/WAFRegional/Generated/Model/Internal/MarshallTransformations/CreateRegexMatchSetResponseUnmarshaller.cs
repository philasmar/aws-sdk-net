...
{
    /// <summary>
    /// Response Unmarshaller for CreateRegexMatchSet operation
    /// </summary>  
    public class CreateRegexMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRegexMatchSetResponse response = new CreateRegexMatchSetResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("RegexMatchSet", targetDepth))
                {
                    ...
                    response.RegexMatchSet = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateRegexMatchSetResponseUnmarshaller _instance = new CreateRegexMatchSetResponseUnmarshaller();        

        internal static CreateRegexMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRegexMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
