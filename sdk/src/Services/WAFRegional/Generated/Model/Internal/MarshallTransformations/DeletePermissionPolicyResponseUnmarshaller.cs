...
{
    /// <summary>
    /// Response Unmarshaller for DeletePermissionPolicy operation
    /// </summary>  
    public class DeletePermissionPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePermissionPolicyResponse response = new DeletePermissionPolicyResponse();
        ...
        private static DeletePermissionPolicyResponseUnmarshaller _instance = new DeletePermissionPolicyResponseUnmarshaller();        

        internal static DeletePermissionPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePermissionPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
