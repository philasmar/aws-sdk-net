...
{
    /// <summary>
    /// Response Unmarshaller for GetWebACLForResource operation
    /// </summary>  
    public class GetWebACLForResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetWebACLForResourceResponse response = new GetWebACLForResourceResponse();

            context.Read();
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("WebACLSummary", targetDepth))
                {
                    var unmarshaller = WebACLSummaryUnmarshaller.Instance;
                    response.WebACLSummary = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetWebACLForResourceResponseUnmarshaller _instance = new GetWebACLForResourceResponseUnmarshaller();        

        internal static GetWebACLForResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetWebACLForResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
