...
{
    /// <summary>
    /// Response Unmarshaller for UpdateByteMatchSet operation
    /// </summary>  
    public class UpdateByteMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateByteMatchSetResponse response = new UpdateByteMatchSetResponse();
        ...
        private static UpdateByteMatchSetResponseUnmarshaller _instance = new UpdateByteMatchSetResponseUnmarshaller();        

        internal static UpdateByteMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateByteMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
