...
{
    /// <summary>
    /// Response Unmarshaller for GetChangeToken operation
    /// </summary>  
    public class GetChangeTokenResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetChangeTokenResponse response = new GetChangeTokenResponse();
        ...
        private static GetChangeTokenResponseUnmarshaller _instance = new GetChangeTokenResponseUnmarshaller();        

        internal static GetChangeTokenResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetChangeTokenResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
