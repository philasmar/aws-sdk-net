...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRateBasedRule operation
    /// </summary>  
    public class UpdateRateBasedRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRateBasedRuleResponse response = new UpdateRateBasedRuleResponse();
        ...
        private static UpdateRateBasedRuleResponseUnmarshaller _instance = new UpdateRateBasedRuleResponseUnmarshaller();        

        internal static UpdateRateBasedRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRateBasedRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
