...
{
    /// <summary>
    /// DeleteRegexPatternSet Request Marshaller
    /// </summary>       
    public class DeleteRegexPatternSetRequestMarshaller : IMarshaller<IRequest, DeleteRegexPatternSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteRegexPatternSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteRegexPatternSetRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WAFRegional");
            string target = "AWSWAF_Regional_20161128.DeleteRegexPatternSet";
