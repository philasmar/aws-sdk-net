...
namespace Amazon.WAFRegional.Model.Internal.MarshallTransformations
{
    ...
    public class XssMatchSetUpdateMarshaller : IRequestMarshaller<XssMatchSetUpdate, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(XssMatchSetUpdate requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetXssMatchTuple())
            {
                context.Writer.WritePropertyName("XssMatchTuple");
                context.Writer.WriteObjectStart();

                var marshaller = XssMatchTupleMarshaller.Instance;
                marshaller.Marshall(requestObject.XssMatchTuple, context);
