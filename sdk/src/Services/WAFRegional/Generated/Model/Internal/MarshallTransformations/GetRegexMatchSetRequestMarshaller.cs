...
{
    /// <summary>
    /// GetRegexMatchSet Request Marshaller
    /// </summary>       
    public class GetRegexMatchSetRequestMarshaller : IMarshaller<IRequest, GetRegexMatchSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRegexMatchSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRegexMatchSetRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WAFRegional");
            string target = "AWSWAF_Regional_20161128.GetRegexMatchSet";
