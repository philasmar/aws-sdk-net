...
{
    /// <summary>
    /// DeleteByteMatchSet Request Marshaller
    /// </summary>       
    public class DeleteByteMatchSetRequestMarshaller : IMarshaller<IRequest, DeleteByteMatchSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteByteMatchSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteByteMatchSetRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WAFRegional");
            string target = "AWSWAF_Regional_20161128.DeleteByteMatchSet";
