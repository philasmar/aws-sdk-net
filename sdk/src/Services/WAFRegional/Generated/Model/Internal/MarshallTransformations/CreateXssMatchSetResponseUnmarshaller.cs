...
{
    /// <summary>
    /// Response Unmarshaller for CreateXssMatchSet operation
    /// </summary>  
    public class CreateXssMatchSetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateXssMatchSetResponse response = new CreateXssMatchSetResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("XssMatchSet", targetDepth))
                {
                    ...
                    response.XssMatchSet = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateXssMatchSetResponseUnmarshaller _instance = new CreateXssMatchSetResponseUnmarshaller();        

        internal static CreateXssMatchSetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateXssMatchSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
