...
{
    /// <summary>
    /// ListActivatedRulesInRuleGroup Request Marshaller
    /// </summary>       
    public class ListActivatedRulesInRuleGroupRequestMarshaller : IMarshaller<IRequest, ListActivatedRulesInRuleGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListActivatedRulesInRuleGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListActivatedRulesInRuleGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WAFRegional");
            string target = "AWSWAF_Regional_20161128.ListActivatedRulesInRuleGroup";
