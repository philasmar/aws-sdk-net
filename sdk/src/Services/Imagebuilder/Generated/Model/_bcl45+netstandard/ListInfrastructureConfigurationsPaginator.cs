...
{
    /// <summary>
    /// Base class for ListInfrastructureConfigurations paginators.
    /// </summary>
    internal sealed partial class ListInfrastructureConfigurationsPaginator : IPaginator<ListInfrastructureConfigurationsResponse>, IListInfrastructureConfigurationsPaginator
    {
        private readonly IAmazonImagebuilder _client;
        private readonly ListInfrastructureConfigurationsRequest _request;
...
#if BCL
        IEnumerable<ListInfrastructureConfigurationsResponse> IPaginator<ListInfrastructureConfigurationsResponse>.Paginate()
        {
            ...
            ListInfrastructureConfigurationsResponse response;
            do
            {
                _request.NextToken = nextToken;
                response = _client.ListInfrastructureConfigurations(_request);
        ...
        async IAsyncEnumerable<ListInfrastructureConfigurationsResponse> IPaginator<ListInfrastructureConfigurationsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                _request.NextToken = nextToken;
                response = await _client.ListInfrastructureConfigurationsAsync(_request, cancellationToken).ConfigureAwait(false);
                nextToken = response.NextToken;
