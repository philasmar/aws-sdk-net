...
{
    /// <summary>
    /// Response Unmarshaller for ListDistributionConfigurations operation
    /// </summary>  
    public class ListDistributionConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDistributionConfigurationsResponse response = new ListDistributionConfigurationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DistributionConfigurationSummary, DistributionConfigurationSummaryUnmarshaller>(DistributionConfigurationSummaryUnmarshaller.Instance);
                    response.DistributionConfigurationSummaryList = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListDistributionConfigurationsResponseUnmarshaller _instance = new ListDistributionConfigurationsResponseUnmarshaller();        

        internal static ListDistributionConfigurationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDistributionConfigurationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
