...
{
    /// <summary>
    /// Response Unmarshaller for UpdateInfrastructureConfiguration operation
    /// </summary>  
    public class UpdateInfrastructureConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateInfrastructureConfigurationResponse response = new UpdateInfrastructureConfigurationResponse();
        ...
        private static UpdateInfrastructureConfigurationResponseUnmarshaller _instance = new UpdateInfrastructureConfigurationResponseUnmarshaller();        

        internal static UpdateInfrastructureConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateInfrastructureConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
