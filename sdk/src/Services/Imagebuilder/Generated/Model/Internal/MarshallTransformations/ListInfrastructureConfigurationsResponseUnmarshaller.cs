...
{
    /// <summary>
    /// Response Unmarshaller for ListInfrastructureConfigurations operation
    /// </summary>  
    public class ListInfrastructureConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListInfrastructureConfigurationsResponse response = new ListInfrastructureConfigurationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<InfrastructureConfigurationSummary, InfrastructureConfigurationSummaryUnmarshaller>(InfrastructureConfigurationSummaryUnmarshaller.Instance);
                    response.InfrastructureConfigurationSummaryList = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListInfrastructureConfigurationsResponseUnmarshaller _instance = new ListInfrastructureConfigurationsResponseUnmarshaller();        

        internal static ListInfrastructureConfigurationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListInfrastructureConfigurationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
