...
{
    /// <summary>
    /// Response Unmarshaller for CreateInfrastructureConfiguration operation
    /// </summary>  
    public class CreateInfrastructureConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInfrastructureConfigurationResponse response = new CreateInfrastructureConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.InfrastructureConfigurationArn = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static CreateInfrastructureConfigurationResponseUnmarshaller _instance = new CreateInfrastructureConfigurationResponseUnmarshaller();        

        internal static CreateInfrastructureConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInfrastructureConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
