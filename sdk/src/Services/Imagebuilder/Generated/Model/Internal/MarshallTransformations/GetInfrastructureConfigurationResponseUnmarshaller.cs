...
{
    /// <summary>
    /// Response Unmarshaller for GetInfrastructureConfiguration operation
    /// </summary>  
    public class GetInfrastructureConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetInfrastructureConfigurationResponse response = new GetInfrastructureConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("infrastructureConfiguration", targetDepth))
                {
                    ...
                    response.InfrastructureConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetInfrastructureConfigurationResponseUnmarshaller _instance = new GetInfrastructureConfigurationResponseUnmarshaller();        

        internal static GetInfrastructureConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInfrastructureConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
