    ...
    public class ListComponentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ComponentVersion, ComponentVersionUnmarshaller>(ComponentVersionUnmarshaller.Instance);
                    response.ComponentVersionList = unmarshaller.Unmarshall(context);
                    continue;
                }
