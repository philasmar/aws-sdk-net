...
{
    /// <summary>
    /// Response Unmarshaller for UpdateImagePipeline operation
    /// </summary>  
    public class UpdateImagePipelineResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateImagePipelineResponse response = new UpdateImagePipelineResponse();
        ...
        private static UpdateImagePipelineResponseUnmarshaller _instance = new UpdateImagePipelineResponseUnmarshaller();        

        internal static UpdateImagePipelineResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateImagePipelineResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
