...
{
    /// <summary>
    /// Response Unmarshaller for CreateDistributionConfiguration operation
    /// </summary>  
    public class CreateDistributionConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDistributionConfigurationResponse response = new CreateDistributionConfigurationResponse();
        ...
        private static CreateDistributionConfigurationResponseUnmarshaller _instance = new CreateDistributionConfigurationResponseUnmarshaller();        

        internal static CreateDistributionConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDistributionConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
