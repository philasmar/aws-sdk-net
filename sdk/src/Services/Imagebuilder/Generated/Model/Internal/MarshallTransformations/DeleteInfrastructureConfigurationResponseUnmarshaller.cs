...
{
    /// <summary>
    /// Response Unmarshaller for DeleteInfrastructureConfiguration operation
    /// </summary>  
    public class DeleteInfrastructureConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteInfrastructureConfigurationResponse response = new DeleteInfrastructureConfigurationResponse();
        ...
        private static DeleteInfrastructureConfigurationResponseUnmarshaller _instance = new DeleteInfrastructureConfigurationResponseUnmarshaller();        

        internal static DeleteInfrastructureConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteInfrastructureConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
