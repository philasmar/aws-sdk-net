...
{
    /// <summary>
    /// Response Unmarshaller for PutContainerRecipePolicy operation
    /// </summary>  
    public class PutContainerRecipePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutContainerRecipePolicyResponse response = new PutContainerRecipePolicyResponse();
        ...
        private static PutContainerRecipePolicyResponseUnmarshaller _instance = new PutContainerRecipePolicyResponseUnmarshaller();        

        internal static PutContainerRecipePolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutContainerRecipePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
