...
{
    /// <summary>
    /// Response Unmarshaller for GetContainerRecipe operation
    /// </summary>  
    public class GetContainerRecipeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetContainerRecipeResponse response = new GetContainerRecipeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("containerRecipe", targetDepth))
                {
                    ...
                    response.ContainerRecipe = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetContainerRecipeResponseUnmarshaller _instance = new GetContainerRecipeResponseUnmarshaller();        

        internal static GetContainerRecipeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetContainerRecipeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
