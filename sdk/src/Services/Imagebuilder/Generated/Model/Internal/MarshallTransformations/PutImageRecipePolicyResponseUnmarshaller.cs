...
{
    /// <summary>
    /// Response Unmarshaller for PutImageRecipePolicy operation
    /// </summary>  
    public class PutImageRecipePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutImageRecipePolicyResponse response = new PutImageRecipePolicyResponse();
        ...
        private static PutImageRecipePolicyResponseUnmarshaller _instance = new PutImageRecipePolicyResponseUnmarshaller();        

        internal static PutImageRecipePolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutImageRecipePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
