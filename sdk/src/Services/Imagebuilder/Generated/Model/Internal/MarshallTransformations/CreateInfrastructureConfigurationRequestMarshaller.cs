...
{
    /// <summary>
    /// CreateInfrastructureConfiguration Request Marshaller
    /// </summary>       
    public class CreateInfrastructureConfigurationRequestMarshaller : IMarshaller<IRequest, CreateInfrastructureConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateInfrastructureConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateInfrastructureConfigurationRequest publicRequest)
        {
            ...
            request.ResourcePath = "/CreateInfrastructureConfiguration";
        ...
        private static CreateInfrastructureConfigurationRequestMarshaller _instance = new CreateInfrastructureConfigurationRequestMarshaller();        

        internal static CreateInfrastructureConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInfrastructureConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
