...
{
    /// <summary>
    /// Response Unmarshaller for GetComponentPolicy operation
    /// </summary>  
    public class GetComponentPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetComponentPolicyResponse response = new GetComponentPolicyResponse();
        ...
        private static GetComponentPolicyResponseUnmarshaller _instance = new GetComponentPolicyResponseUnmarshaller();        

        internal static GetComponentPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetComponentPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
