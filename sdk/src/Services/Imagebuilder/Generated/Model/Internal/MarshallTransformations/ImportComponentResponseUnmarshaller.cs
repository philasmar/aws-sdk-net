...
{
    /// <summary>
    /// Response Unmarshaller for ImportComponent operation
    /// </summary>  
    public class ImportComponentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportComponentResponse response = new ImportComponentResponse();
        ...
        private static ImportComponentResponseUnmarshaller _instance = new ImportComponentResponseUnmarshaller();        

        internal static ImportComponentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportComponentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
