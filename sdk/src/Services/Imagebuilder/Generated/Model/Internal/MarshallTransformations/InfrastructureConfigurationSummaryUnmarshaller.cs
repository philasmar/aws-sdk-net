...
namespace Amazon.Imagebuilder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class InfrastructureConfigurationSummaryUnmarshaller : IUnmarshaller<InfrastructureConfigurationSummary, XmlUnmarshallerContext>, IUnmarshaller<InfrastructureConfigurationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        InfrastructureConfigurationSummary IUnmarshaller<InfrastructureConfigurationSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public InfrastructureConfigurationSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
