...
{
    /// <summary>
    /// Response Unmarshaller for GetImageRecipePolicy operation
    /// </summary>  
    public class GetImageRecipePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetImageRecipePolicyResponse response = new GetImageRecipePolicyResponse();
        ...
        private static GetImageRecipePolicyResponseUnmarshaller _instance = new GetImageRecipePolicyResponseUnmarshaller();        

        internal static GetImageRecipePolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetImageRecipePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
