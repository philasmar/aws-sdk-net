...
{
    /// <summary>
    /// Response Unmarshaller for ListImageBuildVersions operation
    /// </summary>  
    public class ListImageBuildVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListImageBuildVersionsResponse response = new ListImageBuildVersionsResponse();
        ...
        private static ListImageBuildVersionsResponseUnmarshaller _instance = new ListImageBuildVersionsResponseUnmarshaller();        

        internal static ListImageBuildVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListImageBuildVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
