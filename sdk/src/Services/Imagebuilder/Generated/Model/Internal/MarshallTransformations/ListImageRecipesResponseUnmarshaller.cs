...
{
    /// <summary>
    /// Response Unmarshaller for ListImageRecipes operation
    /// </summary>  
    public class ListImageRecipesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListImageRecipesResponse response = new ListImageRecipesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ImageRecipeSummary, ImageRecipeSummaryUnmarshaller>(ImageRecipeSummaryUnmarshaller.Instance);
                    response.ImageRecipeSummaryList = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListImageRecipesResponseUnmarshaller _instance = new ListImageRecipesResponseUnmarshaller();        

        internal static ListImageRecipesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListImageRecipesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
