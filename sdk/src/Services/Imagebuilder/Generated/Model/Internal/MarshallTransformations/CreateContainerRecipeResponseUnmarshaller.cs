...
{
    /// <summary>
    /// Response Unmarshaller for CreateContainerRecipe operation
    /// </summary>  
    public class CreateContainerRecipeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateContainerRecipeResponse response = new CreateContainerRecipeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ContainerRecipeArn = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return InvalidVersionNumberExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CreateContainerRecipeResponseUnmarshaller _instance = new CreateContainerRecipeResponseUnmarshaller();        

        internal static CreateContainerRecipeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateContainerRecipeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
