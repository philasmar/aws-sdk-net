...
{
    /// <summary>
    /// Response Unmarshaller for StartImagePipelineExecution operation
    /// </summary>  
    public class StartImagePipelineExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static StartImagePipelineExecutionResponseUnmarshaller _instance = new StartImagePipelineExecutionResponseUnmarshaller();        

        internal static StartImagePipelineExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartImagePipelineExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
