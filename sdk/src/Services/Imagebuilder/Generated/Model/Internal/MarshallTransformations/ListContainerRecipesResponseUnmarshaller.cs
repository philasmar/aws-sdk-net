...
{
    /// <summary>
    /// Response Unmarshaller for ListContainerRecipes operation
    /// </summary>  
    public class ListContainerRecipesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListContainerRecipesResponse response = new ListContainerRecipesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ContainerRecipeSummary, ContainerRecipeSummaryUnmarshaller>(ContainerRecipeSummaryUnmarshaller.Instance);
                    response.ContainerRecipeSummaryList = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListContainerRecipesResponseUnmarshaller _instance = new ListContainerRecipesResponseUnmarshaller();        

        internal static ListContainerRecipesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListContainerRecipesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
