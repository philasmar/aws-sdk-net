...
{
    /// <summary>
    /// Response Unmarshaller for DeleteContainerRecipe operation
    /// </summary>  
    public class DeleteContainerRecipeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteContainerRecipeResponse response = new DeleteContainerRecipeResponse();
        ...
        private static DeleteContainerRecipeResponseUnmarshaller _instance = new DeleteContainerRecipeResponseUnmarshaller();        

        internal static DeleteContainerRecipeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteContainerRecipeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
