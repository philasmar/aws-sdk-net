...
{
    /// <summary>
    /// Response Unmarshaller for GetImageRecipe operation
    /// </summary>  
    public class GetImageRecipeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetImageRecipeResponse response = new GetImageRecipeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("imageRecipe", targetDepth))
                {
                    ...
                    response.ImageRecipe = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetImageRecipeResponseUnmarshaller _instance = new GetImageRecipeResponseUnmarshaller();        

        internal static GetImageRecipeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetImageRecipeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
