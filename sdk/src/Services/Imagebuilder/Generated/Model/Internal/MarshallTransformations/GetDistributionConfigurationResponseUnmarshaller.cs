...
{
    /// <summary>
    /// Response Unmarshaller for GetDistributionConfiguration operation
    /// </summary>  
    public class GetDistributionConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDistributionConfigurationResponse response = new GetDistributionConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("distributionConfiguration", targetDepth))
                {
                    ...
                    response.DistributionConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetDistributionConfigurationResponseUnmarshaller _instance = new GetDistributionConfigurationResponseUnmarshaller();        

        internal static GetDistributionConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDistributionConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
