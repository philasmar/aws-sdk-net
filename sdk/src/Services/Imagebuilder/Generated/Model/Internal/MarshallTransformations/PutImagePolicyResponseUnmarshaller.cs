...
{
    /// <summary>
    /// Response Unmarshaller for PutImagePolicy operation
    /// </summary>  
    public class PutImagePolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutImagePolicyResponse response = new PutImagePolicyResponse();
        ...
        private static PutImagePolicyResponseUnmarshaller _instance = new PutImagePolicyResponseUnmarshaller();        

        internal static PutImagePolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutImagePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
