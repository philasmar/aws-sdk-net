...
{
    /// <summary>
    /// ImportComponent Request Marshaller
    /// </summary>       
    public class ImportComponentRequestMarshaller : IMarshaller<IRequest, ImportComponentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ImportComponentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ImportComponentRequest publicRequest)
        {
            ...
            request.ResourcePath = "/ImportComponent";
        ...
        private static ImportComponentRequestMarshaller _instance = new ImportComponentRequestMarshaller();        

        internal static ImportComponentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportComponentRequestMarshaller Instance
        {
            get
            {
                return _instance;
