...
{
    /// <summary>
    /// Response Unmarshaller for BulkPublish operation
    /// </summary>  
    public class BulkPublishResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("AlreadyStreamed"))
                {
                    return AlreadyStreamedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static BulkPublishResponseUnmarshaller _instance = new BulkPublishResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BulkPublishResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
