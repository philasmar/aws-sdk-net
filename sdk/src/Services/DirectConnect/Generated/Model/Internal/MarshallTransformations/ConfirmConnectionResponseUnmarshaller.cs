...
{
    /// <summary>
    /// Response Unmarshaller for ConfirmConnection operation
    /// </summary>  
    public class ConfirmConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ConfirmConnectionResponse response = new ConfirmConnectionResponse();
        ...
        private static ConfirmConnectionResponseUnmarshaller _instance = new ConfirmConnectionResponseUnmarshaller();        

        internal static ConfirmConnectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ConfirmConnectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
