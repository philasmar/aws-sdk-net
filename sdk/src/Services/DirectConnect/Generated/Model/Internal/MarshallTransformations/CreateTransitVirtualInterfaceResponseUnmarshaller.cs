...
{
    /// <summary>
    /// Response Unmarshaller for CreateTransitVirtualInterface operation
    /// </summary>  
    public class CreateTransitVirtualInterfaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTransitVirtualInterfaceResponse response = new CreateTransitVirtualInterfaceResponse();
        ...
        private static CreateTransitVirtualInterfaceResponseUnmarshaller _instance = new CreateTransitVirtualInterfaceResponseUnmarshaller();        

        internal static CreateTransitVirtualInterfaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTransitVirtualInterfaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
