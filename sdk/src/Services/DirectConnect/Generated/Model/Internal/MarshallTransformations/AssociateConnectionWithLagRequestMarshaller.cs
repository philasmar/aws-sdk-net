...
{
    /// <summary>
    /// AssociateConnectionWithLag Request Marshaller
    /// </summary>       
    public class AssociateConnectionWithLagRequestMarshaller : IMarshaller<IRequest, AssociateConnectionWithLagRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateConnectionWithLagRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateConnectionWithLagRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DirectConnect");
            string target = "OvertureService.AssociateConnectionWithLag";
