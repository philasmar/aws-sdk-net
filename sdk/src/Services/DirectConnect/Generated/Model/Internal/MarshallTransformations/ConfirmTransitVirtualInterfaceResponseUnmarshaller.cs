...
{
    /// <summary>
    /// Response Unmarshaller for ConfirmTransitVirtualInterface operation
    /// </summary>  
    public class ConfirmTransitVirtualInterfaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ConfirmTransitVirtualInterfaceResponse response = new ConfirmTransitVirtualInterfaceResponse();
        ...
        private static ConfirmTransitVirtualInterfaceResponseUnmarshaller _instance = new ConfirmTransitVirtualInterfaceResponseUnmarshaller();        

        internal static ConfirmTransitVirtualInterfaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ConfirmTransitVirtualInterfaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
