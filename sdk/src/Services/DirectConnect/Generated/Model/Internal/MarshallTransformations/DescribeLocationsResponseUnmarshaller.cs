...
namespace Amazon.DirectConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeLocationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeLocationsResponseUnmarshaller _instance = new DescribeLocationsResponseUnmarshaller();        

        internal static DescribeLocationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLocationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
