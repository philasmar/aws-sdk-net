...
namespace Amazon.DirectConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeConnectionsOnInterconnectResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeConnectionsOnInterconnectResponseUnmarshaller _instance = new DescribeConnectionsOnInterconnectResponseUnmarshaller();        

        internal static DescribeConnectionsOnInterconnectResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeConnectionsOnInterconnectResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
