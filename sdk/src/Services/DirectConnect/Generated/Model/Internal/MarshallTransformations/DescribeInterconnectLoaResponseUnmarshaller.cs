...
{
    /// <summary>
    /// Response Unmarshaller for DescribeInterconnectLoa operation
    /// </summary>  
    public class DescribeInterconnectLoaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeInterconnectLoaResponse response = new DescribeInterconnectLoaResponse();
        ...
        private static DescribeInterconnectLoaResponseUnmarshaller _instance = new DescribeInterconnectLoaResponseUnmarshaller();        

        internal static DescribeInterconnectLoaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInterconnectLoaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
