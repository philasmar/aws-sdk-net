...
{
    /// <summary>
    /// Response Unmarshaller for DescribeLoa operation
    /// </summary>  
    public class DescribeLoaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLoaResponse response = new DescribeLoaResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("loaContent", targetDepth))
                {
                    ...
                    response.LoaContent = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("loaContentType", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.LoaContentType = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeLoaResponseUnmarshaller _instance = new DescribeLoaResponseUnmarshaller();        

        internal static DescribeLoaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLoaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
