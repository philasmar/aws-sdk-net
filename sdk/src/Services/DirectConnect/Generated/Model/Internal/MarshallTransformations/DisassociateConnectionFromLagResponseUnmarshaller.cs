...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateConnectionFromLag operation
    /// </summary>  
    public class DisassociateConnectionFromLagResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateConnectionFromLagResponse response = new DisassociateConnectionFromLagResponse();
        ...
        private static DisassociateConnectionFromLagResponseUnmarshaller _instance = new DisassociateConnectionFromLagResponseUnmarshaller();        

        internal static DisassociateConnectionFromLagResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateConnectionFromLagResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
