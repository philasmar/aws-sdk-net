...
{
    /// <summary>
    /// Response Unmarshaller for AllocateTransitVirtualInterface operation
    /// </summary>  
    public class AllocateTransitVirtualInterfaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AllocateTransitVirtualInterfaceResponse response = new AllocateTransitVirtualInterfaceResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("virtualInterface", targetDepth))
                {
                    ...
                    response.VirtualInterface = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static AllocateTransitVirtualInterfaceResponseUnmarshaller _instance = new AllocateTransitVirtualInterfaceResponseUnmarshaller();        

        internal static AllocateTransitVirtualInterfaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AllocateTransitVirtualInterfaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
