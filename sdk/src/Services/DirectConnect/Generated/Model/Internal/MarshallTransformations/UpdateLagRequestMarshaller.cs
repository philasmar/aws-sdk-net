...
{
    /// <summary>
    /// UpdateLag Request Marshaller
    /// </summary>       
    public class UpdateLagRequestMarshaller : IMarshaller<IRequest, UpdateLagRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateLagRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateLagRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DirectConnect");
            string target = "OvertureService.UpdateLag";
        ...
        private static UpdateLagRequestMarshaller _instance = new UpdateLagRequestMarshaller();        

        internal static UpdateLagRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLagRequestMarshaller Instance
        {
            get
            {
                return _instance;
