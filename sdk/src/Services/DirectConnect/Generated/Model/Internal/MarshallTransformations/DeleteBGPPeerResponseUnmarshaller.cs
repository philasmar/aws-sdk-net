...
{
    /// <summary>
    /// Response Unmarshaller for DeleteBGPPeer operation
    /// </summary>  
    public class DeleteBGPPeerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteBGPPeerResponse response = new DeleteBGPPeerResponse();
        ...
        private static DeleteBGPPeerResponseUnmarshaller _instance = new DeleteBGPPeerResponseUnmarshaller();        

        internal static DeleteBGPPeerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBGPPeerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
