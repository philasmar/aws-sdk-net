...
{
    /// <summary>
    /// Response Unmarshaller for CreateBGPPeer operation
    /// </summary>  
    public class CreateBGPPeerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateBGPPeerResponse response = new CreateBGPPeerResponse();
        ...
        private static CreateBGPPeerResponseUnmarshaller _instance = new CreateBGPPeerResponseUnmarshaller();        

        internal static CreateBGPPeerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBGPPeerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
