...
{
    /// <summary>
    /// Response Unmarshaller for AssociateVirtualInterface operation
    /// </summary>  
    public class AssociateVirtualInterfaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateVirtualInterfaceResponse response = new AssociateVirtualInterfaceResponse();
        ...
        private static AssociateVirtualInterfaceResponseUnmarshaller _instance = new AssociateVirtualInterfaceResponseUnmarshaller();        

        internal static AssociateVirtualInterfaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateVirtualInterfaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
