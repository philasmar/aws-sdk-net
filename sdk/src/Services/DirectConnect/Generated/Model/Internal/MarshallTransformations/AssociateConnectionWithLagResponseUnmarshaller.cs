...
{
    /// <summary>
    /// Response Unmarshaller for AssociateConnectionWithLag operation
    /// </summary>  
    public class AssociateConnectionWithLagResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateConnectionWithLagResponse response = new AssociateConnectionWithLagResponse();
        ...
        private static AssociateConnectionWithLagResponseUnmarshaller _instance = new AssociateConnectionWithLagResponseUnmarshaller();        

        internal static AssociateConnectionWithLagResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateConnectionWithLagResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
