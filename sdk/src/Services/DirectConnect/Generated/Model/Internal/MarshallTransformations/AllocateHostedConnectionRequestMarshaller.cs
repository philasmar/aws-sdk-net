...
{
    /// <summary>
    /// AllocateHostedConnection Request Marshaller
    /// </summary>       
    public class AllocateHostedConnectionRequestMarshaller : IMarshaller<IRequest, AllocateHostedConnectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AllocateHostedConnectionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AllocateHostedConnectionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DirectConnect");
            string target = "OvertureService.AllocateHostedConnection";
        ...
        private static AllocateHostedConnectionRequestMarshaller _instance = new AllocateHostedConnectionRequestMarshaller();        

        internal static AllocateHostedConnectionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AllocateHostedConnectionRequestMarshaller Instance
        {
            get
            {
                return _instance;
