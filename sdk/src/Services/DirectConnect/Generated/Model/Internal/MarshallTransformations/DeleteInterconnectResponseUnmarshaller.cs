...
{
    /// <summary>
    /// Response Unmarshaller for DeleteInterconnect operation
    /// </summary>  
    public class DeleteInterconnectResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteInterconnectResponse response = new DeleteInterconnectResponse();
        ...
        private static DeleteInterconnectResponseUnmarshaller _instance = new DeleteInterconnectResponseUnmarshaller();        

        internal static DeleteInterconnectResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteInterconnectResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
