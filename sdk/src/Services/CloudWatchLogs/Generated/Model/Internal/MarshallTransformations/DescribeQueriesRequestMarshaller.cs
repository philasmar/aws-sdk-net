...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeQueriesRequestMarshaller : IMarshaller<IRequest, DescribeQueriesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeQueriesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeQueriesRequest publicRequest)
        {
        ...
        private static DescribeQueriesRequestMarshaller _instance = new DescribeQueriesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeQueriesRequestMarshaller Instance
        {
            get
            {
                return _instance;
