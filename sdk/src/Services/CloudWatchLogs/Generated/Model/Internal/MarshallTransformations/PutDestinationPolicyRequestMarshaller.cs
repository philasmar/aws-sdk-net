...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PutDestinationPolicyRequestMarshaller : IMarshaller<IRequest, PutDestinationPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutDestinationPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutDestinationPolicyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchLogs");
            string target = "Logs_20140328.PutDestinationPolicy";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetAccessPolicy())
                {
                    context.Writer.WritePropertyName("accessPolicy");
                    context.Writer.Write(publicRequest.AccessPolicy);
                }
