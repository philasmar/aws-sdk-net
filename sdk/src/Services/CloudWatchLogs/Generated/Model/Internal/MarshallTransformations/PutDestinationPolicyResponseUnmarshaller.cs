...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutDestinationPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutDestinationPolicyResponse response = new PutDestinationPolicyResponse();
        ...
        private static PutDestinationPolicyResponseUnmarshaller _instance = new PutDestinationPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutDestinationPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
