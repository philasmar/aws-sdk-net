...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetLogGroupFieldsRequestMarshaller : IMarshaller<IRequest, GetLogGroupFieldsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetLogGroupFieldsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetLogGroupFieldsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchLogs");
            string target = "Logs_20140328.GetLogGroupFields";
        ...
        private static GetLogGroupFieldsRequestMarshaller _instance = new GetLogGroupFieldsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLogGroupFieldsRequestMarshaller Instance
        {
            get
            {
                return _instance;
