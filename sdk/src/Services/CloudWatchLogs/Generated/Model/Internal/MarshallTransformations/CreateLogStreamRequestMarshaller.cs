...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateLogStreamRequestMarshaller : IMarshaller<IRequest, CreateLogStreamRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateLogStreamRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateLogStreamRequest publicRequest)
        {
        ...
        private static CreateLogStreamRequestMarshaller _instance = new CreateLogStreamRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLogStreamRequestMarshaller Instance
        {
            get
            {
                return _instance;
