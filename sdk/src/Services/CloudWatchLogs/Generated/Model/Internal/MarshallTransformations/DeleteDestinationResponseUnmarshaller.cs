...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteDestinationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDestinationResponse response = new DeleteDestinationResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDestinationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
