...
namespace Amazon.CloudWatchLogs.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteMetricFilterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMetricFilterResponse response = new DeleteMetricFilterResponse();
        ...
        private static DeleteMetricFilterResponseUnmarshaller _instance = new DeleteMetricFilterResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMetricFilterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
