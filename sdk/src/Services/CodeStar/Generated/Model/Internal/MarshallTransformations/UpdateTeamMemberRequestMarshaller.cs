...
{
    /// <summary>
    /// UpdateTeamMember Request Marshaller
    /// </summary>       
    public class UpdateTeamMemberRequestMarshaller : IMarshaller<IRequest, UpdateTeamMemberRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateTeamMemberRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateTeamMemberRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodeStar");
            string target = "CodeStar_20170419.UpdateTeamMember";
