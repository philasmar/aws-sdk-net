...
{
    /// <summary>
    /// ListTagsForProject Request Marshaller
    /// </summary>       
    public class ListTagsForProjectRequestMarshaller : IMarshaller<IRequest, ListTagsForProjectRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListTagsForProjectRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListTagsForProjectRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodeStar");
            string target = "CodeStar_20170419.ListTagsForProject";
