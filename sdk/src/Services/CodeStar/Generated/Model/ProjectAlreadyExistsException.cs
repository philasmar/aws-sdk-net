...
namespace Amazon.CodeStar.Model
{
    ...
    public partial class ProjectAlreadyExistsException : AmazonCodeStarException
    {
        ...
        /// <summary>
        /// Constructs a new ProjectAlreadyExistsException with the specified error
        /// message.
        /// </summary>
        /// <param name="message">
        ...
        /// <summary>
        /// Construct instance of ProjectAlreadyExistsException
        /// </summary>
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public ProjectAlreadyExistsException(Exception innerException) 
            : base(innerException) {}
        ...
        public ProjectAlreadyExistsException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ProjectAlreadyExistsException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
