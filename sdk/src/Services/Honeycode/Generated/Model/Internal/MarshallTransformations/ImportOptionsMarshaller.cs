...
namespace Amazon.Honeycode.Model.Internal.MarshallTransformations
{
    ...
    public class ImportOptionsMarshaller : IRequestMarshaller<ImportOptions, JsonMarshallerContext> 
    {
        ...
        {
            if(requestObject.IsSetDelimitedTextOptions())
            {
                context.Writer.WritePropertyName("delimitedTextOptions");
                context.Writer.WriteObjectStart();

                var marshaller = DelimitedTextImportOptionsMarshaller.Instance;
                marshaller.Marshall(requestObject.DelimitedTextOptions, context);

                context.Writer.WriteObjectEnd();
            }

            if(requestObject.IsSetDestinationOptions())
            {
                context.Writer.WritePropertyName("destinationOptions");
                context.Writer.WriteObjectStart();

                var marshaller = DestinationOptionsMarshaller.Instance;
                marshaller.Marshall(requestObject.DestinationOptions, context);
