...
namespace Amazon.Honeycode.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ImportDataSourceMarshaller : IRequestMarshaller<ImportDataSource, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(ImportDataSource requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetDataSourceConfig())
            {
                ...
                var marshaller = ImportDataSourceConfigMarshaller.Instance;
        ...
        /// </summary>  
        public readonly static ImportDataSourceMarshaller Instance = new ImportDataSourceMarshaller();
