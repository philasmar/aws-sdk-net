...
namespace Amazon.Honeycode.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StartTableDataImportJobRequestMarshaller : IMarshaller<IRequest, StartTableDataImportJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartTableDataImportJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartTableDataImportJobRequest publicRequest)
        {
            ...
            if (!publicRequest.IsSetDestinationTableId())
                throw new AmazonHoneycodeException("Request object does not have required field DestinationTableId set");
            request.AddPathResource("{tableId}", StringUtils.FromString(publicRequest.DestinationTableId));
            ...
            request.ResourcePath = "/workbooks/{workbookId}/tables/{tableId}/import";
        ...
        private static StartTableDataImportJobRequestMarshaller _instance = new StartTableDataImportJobRequestMarshaller();        

        internal static StartTableDataImportJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartTableDataImportJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
