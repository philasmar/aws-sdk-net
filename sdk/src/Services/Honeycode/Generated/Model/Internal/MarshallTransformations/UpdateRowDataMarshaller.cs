...
namespace Amazon.Honeycode.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateRowDataMarshaller : IRequestMarshaller<UpdateRowData, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        public void Marshall(UpdateRowData requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetRowId())
            {
                context.Writer.WritePropertyName("rowId");
                context.Writer.Write(requestObject.RowId);
            }
        ...
        /// </summary>  
        public readonly static UpdateRowDataMarshaller Instance = new UpdateRowDataMarshaller();
