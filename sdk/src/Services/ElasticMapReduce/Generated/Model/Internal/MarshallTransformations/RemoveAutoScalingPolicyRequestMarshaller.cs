...
{
    /// <summary>
    /// RemoveAutoScalingPolicy Request Marshaller
    /// </summary>       
    public class RemoveAutoScalingPolicyRequestMarshaller : IMarshaller<IRequest, RemoveAutoScalingPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RemoveAutoScalingPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RemoveAutoScalingPolicyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ElasticMapReduce");
            string target = "ElasticMapReduce.RemoveAutoScalingPolicy";
