...
{
    /// <summary>
    /// Response Unmarshaller for PutAutoScalingPolicy operation
    /// </summary>  
    public class PutAutoScalingPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static PutAutoScalingPolicyResponseUnmarshaller _instance = new PutAutoScalingPolicyResponseUnmarshaller();        

        internal static PutAutoScalingPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAutoScalingPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
