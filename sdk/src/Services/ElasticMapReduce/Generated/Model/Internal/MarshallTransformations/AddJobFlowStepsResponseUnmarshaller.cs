...
namespace Amazon.ElasticMapReduce.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AddJobFlowStepsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static AddJobFlowStepsResponseUnmarshaller _instance = new AddJobFlowStepsResponseUnmarshaller();        

        internal static AddJobFlowStepsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddJobFlowStepsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
