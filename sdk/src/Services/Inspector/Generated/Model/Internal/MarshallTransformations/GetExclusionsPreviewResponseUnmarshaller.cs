...
{
    /// <summary>
    /// Response Unmarshaller for GetExclusionsPreview operation
    /// </summary>  
    public class GetExclusionsPreviewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetExclusionsPreviewResponse response = new GetExclusionsPreviewResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ExclusionPreview, ExclusionPreviewUnmarshaller>(ExclusionPreviewUnmarshaller.Instance);
                    response.ExclusionPreviews = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.PreviewStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetExclusionsPreviewResponseUnmarshaller _instance = new GetExclusionsPreviewResponseUnmarshaller();        

        internal static GetExclusionsPreviewResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetExclusionsPreviewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
