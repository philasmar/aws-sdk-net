...
{
    /// <summary>
    /// Response Unmarshaller for GetTelemetryMetadata operation
    /// </summary>  
    public class GetTelemetryMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTelemetryMetadataResponse response = new GetTelemetryMetadataResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("telemetryMetadata", targetDepth))
                {
                    ...
                    response.TelemetryMetadata = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetTelemetryMetadataResponseUnmarshaller _instance = new GetTelemetryMetadataResponseUnmarshaller();        

        internal static GetTelemetryMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTelemetryMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
