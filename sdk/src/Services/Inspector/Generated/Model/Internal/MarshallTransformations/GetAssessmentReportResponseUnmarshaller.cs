...
{
    /// <summary>
    /// Response Unmarshaller for GetAssessmentReport operation
    /// </summary>  
    public class GetAssessmentReportResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAssessmentReportResponse response = new GetAssessmentReportResponse();
        ...
        private static GetAssessmentReportResponseUnmarshaller _instance = new GetAssessmentReportResponseUnmarshaller();        

        internal static GetAssessmentReportResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAssessmentReportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
