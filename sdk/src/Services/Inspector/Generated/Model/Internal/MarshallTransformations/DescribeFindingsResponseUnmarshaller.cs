...
{
    /// <summary>
    /// Response Unmarshaller for DescribeFindings operation
    /// </summary>  
    public class DescribeFindingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeFindingsResponseUnmarshaller _instance = new DescribeFindingsResponseUnmarshaller();        

        internal static DescribeFindingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFindingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
