...
{
    /// <summary>
    /// Response Unmarshaller for ListExclusions operation
    /// </summary>  
    public class ListExclusionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListExclusionsResponse response = new ListExclusionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("exclusionArns", targetDepth))
                {
                    ...
                    response.ExclusionArns = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListExclusionsResponseUnmarshaller _instance = new ListExclusionsResponseUnmarshaller();        

        internal static ListExclusionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListExclusionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
