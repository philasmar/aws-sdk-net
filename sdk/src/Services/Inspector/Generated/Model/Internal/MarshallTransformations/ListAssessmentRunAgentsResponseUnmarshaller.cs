...
{
    /// <summary>
    /// Response Unmarshaller for ListAssessmentRunAgents operation
    /// </summary>  
    public class ListAssessmentRunAgentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAssessmentRunAgentsResponse response = new ListAssessmentRunAgentsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AssessmentRunAgent, AssessmentRunAgentUnmarshaller>(AssessmentRunAgentUnmarshaller.Instance);
                    response.AssessmentRunAgents = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListAssessmentRunAgentsResponseUnmarshaller _instance = new ListAssessmentRunAgentsResponseUnmarshaller();        

        internal static ListAssessmentRunAgentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAssessmentRunAgentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
