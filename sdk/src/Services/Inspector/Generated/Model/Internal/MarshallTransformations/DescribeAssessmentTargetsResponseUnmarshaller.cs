...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAssessmentTargets operation
    /// </summary>  
    public class DescribeAssessmentTargetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAssessmentTargetsResponse response = new DescribeAssessmentTargetsResponse();
        ...
        private static DescribeAssessmentTargetsResponseUnmarshaller _instance = new DescribeAssessmentTargetsResponseUnmarshaller();        

        internal static DescribeAssessmentTargetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAssessmentTargetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
