...
{
    /// <summary>
    /// Response Unmarshaller for RemoveAttributesFromFindings operation
    /// </summary>  
    public class RemoveAttributesFromFindingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveAttributesFromFindingsResponse response = new RemoveAttributesFromFindingsResponse();
        ...
        private static RemoveAttributesFromFindingsResponseUnmarshaller _instance = new RemoveAttributesFromFindingsResponseUnmarshaller();        

        internal static RemoveAttributesFromFindingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveAttributesFromFindingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
