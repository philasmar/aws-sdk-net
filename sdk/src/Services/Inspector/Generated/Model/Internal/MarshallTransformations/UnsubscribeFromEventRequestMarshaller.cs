...
{
    /// <summary>
    /// UnsubscribeFromEvent Request Marshaller
    /// </summary>       
    public class UnsubscribeFromEventRequestMarshaller : IMarshaller<IRequest, UnsubscribeFromEventRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UnsubscribeFromEventRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UnsubscribeFromEventRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Inspector");
            string target = "InspectorService.UnsubscribeFromEvent";
