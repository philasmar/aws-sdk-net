...
{
    /// <summary>
    /// Response Unmarshaller for ListAssessmentTemplates operation
    /// </summary>  
    public class ListAssessmentTemplatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAssessmentTemplatesResponse response = new ListAssessmentTemplatesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("assessmentTemplateArns", targetDepth))
                {
                    ...
                    response.AssessmentTemplateArns = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListAssessmentTemplatesResponseUnmarshaller _instance = new ListAssessmentTemplatesResponseUnmarshaller();        

        internal static ListAssessmentTemplatesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAssessmentTemplatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
