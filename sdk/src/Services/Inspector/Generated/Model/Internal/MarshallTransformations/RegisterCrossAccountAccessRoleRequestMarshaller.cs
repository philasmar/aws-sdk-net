...
{
    /// <summary>
    /// RegisterCrossAccountAccessRole Request Marshaller
    /// </summary>       
    public class RegisterCrossAccountAccessRoleRequestMarshaller : IMarshaller<IRequest, RegisterCrossAccountAccessRoleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RegisterCrossAccountAccessRoleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RegisterCrossAccountAccessRoleRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Inspector");
            string target = "InspectorService.RegisterCrossAccountAccessRole";
