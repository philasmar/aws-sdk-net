...
{
    /// <summary>
    /// Response Unmarshaller for StopAssessmentRun operation
    /// </summary>  
    public class StopAssessmentRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopAssessmentRunResponse response = new StopAssessmentRunResponse();
        ...
        private static StopAssessmentRunResponseUnmarshaller _instance = new StopAssessmentRunResponseUnmarshaller();        

        internal static StopAssessmentRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopAssessmentRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
