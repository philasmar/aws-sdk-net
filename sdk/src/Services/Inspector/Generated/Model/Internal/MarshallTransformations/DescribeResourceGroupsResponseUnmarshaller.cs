...
{
    /// <summary>
    /// Response Unmarshaller for DescribeResourceGroups operation
    /// </summary>  
    public class DescribeResourceGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeResourceGroupsResponseUnmarshaller _instance = new DescribeResourceGroupsResponseUnmarshaller();        

        internal static DescribeResourceGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeResourceGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
