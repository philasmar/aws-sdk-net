...
{
    /// <summary>
    /// DescribeAssessmentTemplates Request Marshaller
    /// </summary>       
    public class DescribeAssessmentTemplatesRequestMarshaller : IMarshaller<IRequest, DescribeAssessmentTemplatesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeAssessmentTemplatesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeAssessmentTemplatesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Inspector");
            string target = "InspectorService.DescribeAssessmentTemplates";
