...
{
    /// <summary>
    /// Response Unmarshaller for ListEventSubscriptions operation
    /// </summary>  
    public class ListEventSubscriptionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListEventSubscriptionsResponse response = new ListEventSubscriptionsResponse();
        ...
        private static ListEventSubscriptionsResponseUnmarshaller _instance = new ListEventSubscriptionsResponseUnmarshaller();        

        internal static ListEventSubscriptionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListEventSubscriptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
