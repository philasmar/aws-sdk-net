...
{
    /// <summary>
    /// Response Unmarshaller for ListAssessmentRuns operation
    /// </summary>  
    public class ListAssessmentRunsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAssessmentRunsResponse response = new ListAssessmentRunsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("assessmentRunArns", targetDepth))
                {
                    ...
                    response.AssessmentRunArns = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListAssessmentRunsResponseUnmarshaller _instance = new ListAssessmentRunsResponseUnmarshaller();        

        internal static ListAssessmentRunsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAssessmentRunsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
