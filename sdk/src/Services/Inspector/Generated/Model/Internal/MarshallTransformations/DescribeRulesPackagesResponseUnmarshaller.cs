...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRulesPackages operation
    /// </summary>  
    public class DescribeRulesPackagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRulesPackagesResponse response = new DescribeRulesPackagesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RulesPackage, RulesPackageUnmarshaller>(RulesPackageUnmarshaller.Instance);
                    response.RulesPackages = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeRulesPackagesResponseUnmarshaller _instance = new DescribeRulesPackagesResponseUnmarshaller();        

        internal static DescribeRulesPackagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRulesPackagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
