...
{
    /// <summary>
    /// AddAttributesToFindings Request Marshaller
    /// </summary>       
    public class AddAttributesToFindingsRequestMarshaller : IMarshaller<IRequest, AddAttributesToFindingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AddAttributesToFindingsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AddAttributesToFindingsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Inspector");
            string target = "InspectorService.AddAttributesToFindings";
