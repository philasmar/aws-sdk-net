...
{
    /// <summary>
    /// Response Unmarshaller for UnsubscribeFromEvent operation
    /// </summary>  
    public class UnsubscribeFromEventResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UnsubscribeFromEventResponse response = new UnsubscribeFromEventResponse();
        ...
        private static UnsubscribeFromEventResponseUnmarshaller _instance = new UnsubscribeFromEventResponseUnmarshaller();        

        internal static UnsubscribeFromEventResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UnsubscribeFromEventResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
