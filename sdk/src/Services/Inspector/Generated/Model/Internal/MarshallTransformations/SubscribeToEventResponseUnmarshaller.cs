...
{
    /// <summary>
    /// Response Unmarshaller for SubscribeToEvent operation
    /// </summary>  
    public class SubscribeToEventResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SubscribeToEventResponse response = new SubscribeToEventResponse();
        ...
        private static SubscribeToEventResponseUnmarshaller _instance = new SubscribeToEventResponseUnmarshaller();        

        internal static SubscribeToEventResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SubscribeToEventResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
