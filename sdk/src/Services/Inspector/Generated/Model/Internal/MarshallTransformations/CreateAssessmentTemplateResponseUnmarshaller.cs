...
{
    /// <summary>
    /// Response Unmarshaller for CreateAssessmentTemplate operation
    /// </summary>  
    public class CreateAssessmentTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAssessmentTemplateResponse response = new CreateAssessmentTemplateResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("assessmentTemplateArn", targetDepth))
                {
                    ...
                    response.AssessmentTemplateArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateAssessmentTemplateResponseUnmarshaller _instance = new CreateAssessmentTemplateResponseUnmarshaller();        

        internal static CreateAssessmentTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAssessmentTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
