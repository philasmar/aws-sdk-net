...
{
    /// <summary>
    /// Response Unmarshaller for DescribeExclusions operation
    /// </summary>  
    public class DescribeExclusionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeExclusionsResponse response = new DescribeExclusionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, Exclusion, StringUnmarshaller, ExclusionUnmarshaller>(StringUnmarshaller.Instance, ExclusionUnmarshaller.Instance);
                    response.Exclusions = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeExclusionsResponseUnmarshaller _instance = new DescribeExclusionsResponseUnmarshaller();        

        internal static DescribeExclusionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeExclusionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
