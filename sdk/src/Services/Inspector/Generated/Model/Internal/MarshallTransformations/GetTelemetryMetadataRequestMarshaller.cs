...
{
    /// <summary>
    /// GetTelemetryMetadata Request Marshaller
    /// </summary>       
    public class GetTelemetryMetadataRequestMarshaller : IMarshaller<IRequest, GetTelemetryMetadataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTelemetryMetadataRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTelemetryMetadataRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Inspector");
            string target = "InspectorService.GetTelemetryMetadata";
