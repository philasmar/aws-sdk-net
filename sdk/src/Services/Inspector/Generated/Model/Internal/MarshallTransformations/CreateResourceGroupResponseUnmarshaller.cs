...
{
    /// <summary>
    /// Response Unmarshaller for CreateResourceGroup operation
    /// </summary>  
    public class CreateResourceGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateResourceGroupResponse response = new CreateResourceGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("resourceGroupArn", targetDepth))
                {
                    ...
                    response.ResourceGroupArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateResourceGroupResponseUnmarshaller _instance = new CreateResourceGroupResponseUnmarshaller();        

        internal static CreateResourceGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateResourceGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
