...
{
    /// <summary>
    /// DeleteAssessmentRun Request Marshaller
    /// </summary>       
    public class DeleteAssessmentRunRequestMarshaller : IMarshaller<IRequest, DeleteAssessmentRunRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAssessmentRunRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteAssessmentRunRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Inspector");
            string target = "InspectorService.DeleteAssessmentRun";
