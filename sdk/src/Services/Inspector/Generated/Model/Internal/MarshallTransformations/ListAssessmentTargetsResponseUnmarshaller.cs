...
{
    /// <summary>
    /// Response Unmarshaller for ListAssessmentTargets operation
    /// </summary>  
    public class ListAssessmentTargetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListAssessmentTargetsResponse response = new ListAssessmentTargetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("assessmentTargetArns", targetDepth))
                {
                    ...
                    response.AssessmentTargetArns = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListAssessmentTargetsResponseUnmarshaller _instance = new ListAssessmentTargetsResponseUnmarshaller();        

        internal static ListAssessmentTargetsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAssessmentTargetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
