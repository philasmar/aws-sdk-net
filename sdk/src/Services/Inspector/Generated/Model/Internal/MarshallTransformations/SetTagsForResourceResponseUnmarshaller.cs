...
{
    /// <summary>
    /// Response Unmarshaller for SetTagsForResource operation
    /// </summary>  
    public class SetTagsForResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetTagsForResourceResponse response = new SetTagsForResourceResponse();
        ...
        private static SetTagsForResourceResponseUnmarshaller _instance = new SetTagsForResourceResponseUnmarshaller();        

        internal static SetTagsForResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetTagsForResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
