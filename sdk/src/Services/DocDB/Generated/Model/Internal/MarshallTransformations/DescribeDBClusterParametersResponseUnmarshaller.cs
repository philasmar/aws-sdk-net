...
namespace Amazon.DocDB.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeDBClusterParametersResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeDBClusterParametersResponseUnmarshaller _instance = new DescribeDBClusterParametersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDBClusterParametersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
