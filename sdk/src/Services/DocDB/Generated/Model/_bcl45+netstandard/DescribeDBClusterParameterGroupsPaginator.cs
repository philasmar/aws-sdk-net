...
namespace Amazon.DocDB.Model
{
    ...
    /// </summary>
    internal sealed partial class DescribeDBClusterParameterGroupsPaginator : IPaginator<DescribeDBClusterParameterGroupsResponse>, IDescribeDBClusterParameterGroupsPaginator
    {
        private readonly IAmazonDocDB _client;
        private readonly DescribeDBClusterParameterGroupsRequest _request;
        private int _isPaginatorInUse = 0;
        
        /// <summary>
        /// Enumerable containing all full responses for the operation
        /// </summary>
        public IPaginatedEnumerable<DescribeDBClusterParameterGroupsResponse> Responses => new PaginatedResponse<DescribeDBClusterParameterGroupsResponse>(this);
...
#if BCL
        IEnumerable<DescribeDBClusterParameterGroupsResponse> IPaginator<DescribeDBClusterParameterGroupsResponse>.Paginate()
        {
            ...
            do
            {
                ...
                response = _client.DescribeDBClusterParameterGroups(_request);
        ...
        async IAsyncEnumerable<DescribeDBClusterParameterGroupsResponse> IPaginator<DescribeDBClusterParameterGroupsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                _request.Marker = marker;
                response = await _client.DescribeDBClusterParameterGroupsAsync(_request, cancellationToken).ConfigureAwait(false);
                marker = response.Marker;
