...
{
    /// <summary>
    /// DescribeScalingPolicies Request Marshaller
    /// </summary>       
    public class DescribeScalingPoliciesRequestMarshaller : IMarshaller<IRequest, DescribeScalingPoliciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeScalingPoliciesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeScalingPoliciesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ApplicationAutoScaling");
            string target = "AnyScaleFrontendService.DescribeScalingPolicies";
        ...
        private static DescribeScalingPoliciesRequestMarshaller _instance = new DescribeScalingPoliciesRequestMarshaller();        

        internal static DescribeScalingPoliciesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeScalingPoliciesRequestMarshaller Instance
        {
            get
            {
                return _instance;
