...
{
    /// <summary>
    /// Response Unmarshaller for DeregisterScalableTarget operation
    /// </summary>  
    public class DeregisterScalableTargetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterScalableTargetResponse response = new DeregisterScalableTargetResponse();
        ...
        private static DeregisterScalableTargetResponseUnmarshaller _instance = new DeregisterScalableTargetResponseUnmarshaller();        

        internal static DeregisterScalableTargetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterScalableTargetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
