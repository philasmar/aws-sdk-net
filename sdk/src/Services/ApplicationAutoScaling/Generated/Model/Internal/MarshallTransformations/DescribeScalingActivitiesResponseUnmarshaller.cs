...
namespace Amazon.ApplicationAutoScaling.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeScalingActivitiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ScalingActivity, ScalingActivityUnmarshaller>(ScalingActivityUnmarshaller.Instance);
                    response.ScalingActivities = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
