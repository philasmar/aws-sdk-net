...
{
    /// <summary>
    /// Response Unmarshaller for PutScheduledAction operation
    /// </summary>  
    public class PutScheduledActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutScheduledActionResponse response = new PutScheduledActionResponse();
        ...
        private static PutScheduledActionResponseUnmarshaller _instance = new PutScheduledActionResponseUnmarshaller();        

        internal static PutScheduledActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutScheduledActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
