...
{
    /// <summary>
    /// DescribeScalableTargets Request Marshaller
    /// </summary>       
    public class DescribeScalableTargetsRequestMarshaller : IMarshaller<IRequest, DescribeScalableTargetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeScalableTargetsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeScalableTargetsRequest publicRequest)
        {
