...
{
    /// <summary>
    /// UpdateVocabularyFilter Request Marshaller
    /// </summary>       
    public class UpdateVocabularyFilterRequestMarshaller : IMarshaller<IRequest, UpdateVocabularyFilterRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateVocabularyFilterRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateVocabularyFilterRequest publicRequest)
        {
        ...
        private static UpdateVocabularyFilterRequestMarshaller _instance = new UpdateVocabularyFilterRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateVocabularyFilterRequestMarshaller Instance
        {
            get
            {
                return _instance;
