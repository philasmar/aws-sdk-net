...
{
    /// <summary>
    /// CreateMedicalVocabulary Request Marshaller
    /// </summary>       
    public class CreateMedicalVocabularyRequestMarshaller : IMarshaller<IRequest, CreateMedicalVocabularyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateMedicalVocabularyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateMedicalVocabularyRequest publicRequest)
        {
        ...
        private static CreateMedicalVocabularyRequestMarshaller _instance = new CreateMedicalVocabularyRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMedicalVocabularyRequestMarshaller Instance
        {
            get
            {
                return _instance;
