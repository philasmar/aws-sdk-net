...
{
    /// <summary>
    /// DeleteEvaluationResults Request Marshaller
    /// </summary>       
    public class DeleteEvaluationResultsRequestMarshaller : IMarshaller<IRequest, DeleteEvaluationResultsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteEvaluationResultsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteEvaluationResultsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ConfigService");
            string target = "StarlingDoveService.DeleteEvaluationResults";
