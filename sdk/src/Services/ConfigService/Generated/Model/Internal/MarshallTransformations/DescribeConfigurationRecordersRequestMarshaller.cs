...
{
    /// <summary>
    /// DescribeConfigurationRecorders Request Marshaller
    /// </summary>       
    public class DescribeConfigurationRecordersRequestMarshaller : IMarshaller<IRequest, DescribeConfigurationRecordersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        private static DescribeConfigurationRecordersRequestMarshaller _instance = new DescribeConfigurationRecordersRequestMarshaller();        

        internal static DescribeConfigurationRecordersRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeConfigurationRecordersRequestMarshaller Instance
        {
            get
            {
                return _instance;
