...
namespace Amazon.ConfigService.Model.Internal.MarshallTransformations
{
    ...
    public class InvalidRecordingGroupExceptionUnmarshaller : IErrorResponseUnmarshaller<InvalidRecordingGroupException, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public InvalidRecordingGroupException Unmarshall(JsonUnmarshallerContext context, ErrorResponse errorResponse)
        {
            context.Read();
        ...
        private static InvalidRecordingGroupExceptionUnmarshaller _instance = new InvalidRecordingGroupExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InvalidRecordingGroupExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
