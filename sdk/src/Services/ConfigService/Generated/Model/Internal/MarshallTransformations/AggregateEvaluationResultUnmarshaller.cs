...
namespace Amazon.ConfigService.Model.Internal.MarshallTransformations
{
    ...
    public class AggregateEvaluationResultUnmarshaller : IUnmarshaller<AggregateEvaluationResult, XmlUnmarshallerContext>, IUnmarshaller<AggregateEvaluationResult, JsonUnmarshallerContext>
    {
        ...
        private static AggregateEvaluationResultUnmarshaller _instance = new AggregateEvaluationResultUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AggregateEvaluationResultUnmarshaller Instance
        {
            get
            {
                return _instance;
