...
{
    /// <summary>
    /// Response Unmarshaller for DeleteEvaluationResults operation
    /// </summary>  
    public class DeleteEvaluationResultsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteEvaluationResultsResponse response = new DeleteEvaluationResultsResponse();
        ...
        private static DeleteEvaluationResultsResponseUnmarshaller _instance = new DeleteEvaluationResultsResponseUnmarshaller();        

        internal static DeleteEvaluationResultsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEvaluationResultsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
