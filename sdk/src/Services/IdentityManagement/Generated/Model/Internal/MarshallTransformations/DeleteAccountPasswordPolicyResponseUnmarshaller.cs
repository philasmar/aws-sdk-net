...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteAccountPasswordPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAccountPasswordPolicyResponse response = new DeleteAccountPasswordPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteAccountPasswordPolicyResult", 2))
                    {
        ...
        private static DeleteAccountPasswordPolicyResponseUnmarshaller _instance = new DeleteAccountPasswordPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAccountPasswordPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
