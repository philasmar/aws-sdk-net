    ...
    public class UpdateAssumeRolePolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateAssumeRolePolicyResult", 2))
                    {
        ...
        private static UpdateAssumeRolePolicyResponseUnmarshaller _instance = new UpdateAssumeRolePolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAssumeRolePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
