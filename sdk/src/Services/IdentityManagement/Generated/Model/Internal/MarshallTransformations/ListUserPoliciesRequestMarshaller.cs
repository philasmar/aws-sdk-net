...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListUserPoliciesRequestMarshaller : IMarshaller<IRequest, ListUserPoliciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListUserPoliciesRequest)input);
        }
        ...
        public IRequest Marshall(ListUserPoliciesRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static ListUserPoliciesRequestMarshaller _instance = new ListUserPoliciesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUserPoliciesRequestMarshaller Instance
        {
            get
            {
                return _instance;
