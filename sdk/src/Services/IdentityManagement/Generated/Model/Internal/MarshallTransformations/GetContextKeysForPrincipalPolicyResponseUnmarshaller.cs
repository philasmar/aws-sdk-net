...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetContextKeysForPrincipalPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetContextKeysForPrincipalPolicyResponse response = new GetContextKeysForPrincipalPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GetContextKeysForPrincipalPolicyResult", 2))
                    {
        ...
        private static GetContextKeysForPrincipalPolicyResponseUnmarshaller _instance = new GetContextKeysForPrincipalPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetContextKeysForPrincipalPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
