...
{
    /// <summary>
    /// Response Unmarshaller for SetSecurityTokenServicePreferences operation
    /// </summary>  
    public class SetSecurityTokenServicePreferencesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetSecurityTokenServicePreferencesResponse response = new SetSecurityTokenServicePreferencesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("SetSecurityTokenServicePreferencesResult", 2))
                    {
        ...
        private static SetSecurityTokenServicePreferencesResponseUnmarshaller _instance = new SetSecurityTokenServicePreferencesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetSecurityTokenServicePreferencesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
