...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DetachRolePolicyRequestMarshaller : IMarshaller<IRequest, DetachRolePolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DetachRolePolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DetachRolePolicyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.IdentityManagement");
            request.Parameters.Add("Action", "DetachRolePolicy");
