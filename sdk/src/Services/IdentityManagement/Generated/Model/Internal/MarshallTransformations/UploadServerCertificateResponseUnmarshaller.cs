...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UploadServerCertificateResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UploadServerCertificateResponse response = new UploadServerCertificateResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UploadServerCertificateResult", 2))
                    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("ServerCertificateMetadata", targetDepth))
                    {
                        ...
                        response.ServerCertificateMetadata = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("KeyPairMismatch"))
                {
                    return KeyPairMismatchExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static UploadServerCertificateResponseUnmarshaller _instance = new UploadServerCertificateResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UploadServerCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
