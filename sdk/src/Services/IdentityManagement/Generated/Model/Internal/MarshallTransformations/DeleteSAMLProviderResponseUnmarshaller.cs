...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteSAMLProviderResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSAMLProviderResponse response = new DeleteSAMLProviderResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteSAMLProviderResult", 2))
                    {
        ...
        private static DeleteSAMLProviderResponseUnmarshaller _instance = new DeleteSAMLProviderResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSAMLProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
