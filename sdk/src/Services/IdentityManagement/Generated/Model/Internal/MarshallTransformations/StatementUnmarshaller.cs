...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    public class StatementUnmarshaller : IUnmarshaller<Statement, XmlUnmarshallerContext>, IUnmarshaller<Statement, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public Statement Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("SourcePolicyId", targetDepth))
                    {
                        ...
                        unmarshalledObject.SourcePolicyId = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    if (context.TestExpression("SourcePolicyType", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.SourcePolicyType = unmarshaller.Unmarshall(context);
                        continue;
                    }
