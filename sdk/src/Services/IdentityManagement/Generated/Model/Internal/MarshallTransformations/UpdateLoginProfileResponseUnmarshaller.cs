...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateLoginProfileResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateLoginProfileResult", 2))
                    {
        ...
        private static UpdateLoginProfileResponseUnmarshaller _instance = new UpdateLoginProfileResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLoginProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
