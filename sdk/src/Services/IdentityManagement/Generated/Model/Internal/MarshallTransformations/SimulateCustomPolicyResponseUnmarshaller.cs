...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SimulateCustomPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SimulateCustomPolicyResponse response = new SimulateCustomPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("SimulateCustomPolicyResult", 2))
                    {
        ...
        private static SimulateCustomPolicyResponseUnmarshaller _instance = new SimulateCustomPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SimulateCustomPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
