...
{
    /// <summary>
    /// Response Unmarshaller for ListRoleTags operation
    /// </summary>  
    public class ListRoleTagsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListRoleTagsResponse response = new ListRoleTagsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListRoleTagsResult", 2))
                    {
        ...
        private static ListRoleTagsResponseUnmarshaller _instance = new ListRoleTagsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRoleTagsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
