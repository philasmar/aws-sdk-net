...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UploadSigningCertificateRequestMarshaller : IMarshaller<IRequest, UploadSigningCertificateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UploadSigningCertificateRequest)input);
        }
        ...
        public IRequest Marshall(UploadSigningCertificateRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static UploadSigningCertificateRequestMarshaller _instance = new UploadSigningCertificateRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UploadSigningCertificateRequestMarshaller Instance
        {
            get
            {
                return _instance;
