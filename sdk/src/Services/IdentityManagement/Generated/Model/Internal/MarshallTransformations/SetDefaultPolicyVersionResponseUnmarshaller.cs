...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SetDefaultPolicyVersionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetDefaultPolicyVersionResponse response = new SetDefaultPolicyVersionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("SetDefaultPolicyVersionResult", 2))
                    {
        ...
        private static SetDefaultPolicyVersionResponseUnmarshaller _instance = new SetDefaultPolicyVersionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetDefaultPolicyVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
