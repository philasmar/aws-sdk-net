...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateOpenIDConnectProviderResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateOpenIDConnectProviderResponse response = new CreateOpenIDConnectProviderResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateOpenIDConnectProviderResult", 2))
                    {
        ...
        private static CreateOpenIDConnectProviderResponseUnmarshaller _instance = new CreateOpenIDConnectProviderResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOpenIDConnectProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
