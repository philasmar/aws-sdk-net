...
{
    /// <summary>
    /// Response Unmarshaller for PutRolePermissionsBoundary operation
    /// </summary>  
    public class PutRolePermissionsBoundaryResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutRolePermissionsBoundaryResponse response = new PutRolePermissionsBoundaryResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("PutRolePermissionsBoundaryResult", 2))
                    {
        ...
        private static PutRolePermissionsBoundaryResponseUnmarshaller _instance = new PutRolePermissionsBoundaryResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutRolePermissionsBoundaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
