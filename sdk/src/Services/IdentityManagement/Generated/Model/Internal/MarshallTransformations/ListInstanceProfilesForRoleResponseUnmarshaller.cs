...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListInstanceProfilesForRoleResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListInstanceProfilesForRoleResponse response = new ListInstanceProfilesForRoleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListInstanceProfilesForRoleResult", 2))
                    {
        ...
        private static ListInstanceProfilesForRoleResponseUnmarshaller _instance = new ListInstanceProfilesForRoleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListInstanceProfilesForRoleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
