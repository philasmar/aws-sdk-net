...
{
    /// <summary>
    /// Response Unmarshaller for UntagRole operation
    /// </summary>  
    public class UntagRoleResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UntagRoleResponse response = new UntagRoleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UntagRoleResult", 2))
                    {
        ...
        private static UntagRoleResponseUnmarshaller _instance = new UntagRoleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagRoleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
