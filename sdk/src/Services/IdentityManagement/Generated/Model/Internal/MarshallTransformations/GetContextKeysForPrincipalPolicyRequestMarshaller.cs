...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetContextKeysForPrincipalPolicyRequestMarshaller : IMarshaller<IRequest, GetContextKeysForPrincipalPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetContextKeysForPrincipalPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetContextKeysForPrincipalPolicyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.IdentityManagement");
            request.Parameters.Add("Action", "GetContextKeysForPrincipalPolicy");
