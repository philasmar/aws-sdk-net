...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AddClientIDToOpenIDConnectProviderResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddClientIDToOpenIDConnectProviderResponse response = new AddClientIDToOpenIDConnectProviderResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("AddClientIDToOpenIDConnectProviderResult", 2))
                    {
        ...
        private static AddClientIDToOpenIDConnectProviderResponseUnmarshaller _instance = new AddClientIDToOpenIDConnectProviderResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddClientIDToOpenIDConnectProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
