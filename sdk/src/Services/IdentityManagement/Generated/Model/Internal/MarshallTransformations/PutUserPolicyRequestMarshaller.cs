...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PutUserPolicyRequestMarshaller : IMarshaller<IRequest, PutUserPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutUserPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutUserPolicyRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static PutUserPolicyRequestMarshaller _instance = new PutUserPolicyRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutUserPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
