...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutGroupPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutGroupPolicyResponse response = new PutGroupPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("PutGroupPolicyResult", 2))
                    {
        ...
        private static PutGroupPolicyResponseUnmarshaller _instance = new PutGroupPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutGroupPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
