...
{
    /// <summary>
    /// Response Unmarshaller for PutUserPermissionsBoundary operation
    /// </summary>  
    public class PutUserPermissionsBoundaryResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutUserPermissionsBoundaryResponse response = new PutUserPermissionsBoundaryResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("PutUserPermissionsBoundaryResult", 2))
                    {
        ...
        private static PutUserPermissionsBoundaryResponseUnmarshaller _instance = new PutUserPermissionsBoundaryResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutUserPermissionsBoundaryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
