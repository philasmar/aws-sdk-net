...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListRolePoliciesRequestMarshaller : IMarshaller<IRequest, ListRolePoliciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListRolePoliciesRequest)input);
        }
        ...
        public IRequest Marshall(ListRolePoliciesRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static ListRolePoliciesRequestMarshaller _instance = new ListRolePoliciesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListRolePoliciesRequestMarshaller Instance
        {
            get
            {
                return _instance;
