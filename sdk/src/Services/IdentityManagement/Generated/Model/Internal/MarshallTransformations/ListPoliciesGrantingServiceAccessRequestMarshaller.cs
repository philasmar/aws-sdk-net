...
{
    /// <summary>
    /// ListPoliciesGrantingServiceAccess Request Marshaller
    /// </summary>       
    public class ListPoliciesGrantingServiceAccessRequestMarshaller : IMarshaller<IRequest, ListPoliciesGrantingServiceAccessRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListPoliciesGrantingServiceAccessRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListPoliciesGrantingServiceAccessRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.IdentityManagement");
            request.Parameters.Add("Action", "ListPoliciesGrantingServiceAccess");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPoliciesGrantingServiceAccessRequestMarshaller Instance
        {
            get
            {
                return _instance;
