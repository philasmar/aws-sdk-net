...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteInstanceProfileResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteInstanceProfileResponse response = new DeleteInstanceProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteInstanceProfileResult", 2))
                    {
        ...
        private static DeleteInstanceProfileResponseUnmarshaller _instance = new DeleteInstanceProfileResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteInstanceProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
