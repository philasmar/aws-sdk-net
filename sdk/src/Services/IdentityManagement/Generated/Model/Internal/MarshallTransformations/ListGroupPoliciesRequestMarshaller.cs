    ...
    public class ListGroupPoliciesRequestMarshaller : IMarshaller<IRequest, ListGroupPoliciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListGroupPoliciesRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static ListGroupPoliciesRequestMarshaller _instance = new ListGroupPoliciesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListGroupPoliciesRequestMarshaller Instance
        {
            get
            {
                return _instance;
