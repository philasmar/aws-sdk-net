...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteSSHPublicKeyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSSHPublicKeyResponse response = new DeleteSSHPublicKeyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteSSHPublicKeyResult", 2))
                    {
        ...
        private static DeleteSSHPublicKeyResponseUnmarshaller _instance = new DeleteSSHPublicKeyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSSHPublicKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
