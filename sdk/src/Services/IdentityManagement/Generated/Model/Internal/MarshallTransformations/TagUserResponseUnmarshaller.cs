...
{
    /// <summary>
    /// Response Unmarshaller for TagUser operation
    /// </summary>  
    public class TagUserResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TagUserResponse response = new TagUserResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("TagUserResult", 2))
                    {
        ...
        private static TagUserResponseUnmarshaller _instance = new TagUserResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
