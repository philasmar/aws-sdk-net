...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetAccountPasswordPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, GetAccountPasswordPolicyResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = PasswordPolicyUnmarshaller.Instance;
                        response.PasswordPolicy = unmarshaller.Unmarshall(context);
                        continue;
                    }
                } 
           }
        ...
        private static GetAccountPasswordPolicyResponseUnmarshaller _instance = new GetAccountPasswordPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccountPasswordPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
