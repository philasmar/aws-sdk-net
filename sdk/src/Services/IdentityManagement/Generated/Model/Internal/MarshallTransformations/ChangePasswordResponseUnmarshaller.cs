    ...
    public class ChangePasswordResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return InvalidUserTypeExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static ChangePasswordResponseUnmarshaller _instance = new ChangePasswordResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ChangePasswordResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
