...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAttachedUserPoliciesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListAttachedUserPoliciesResult", 2))
                    {
        ...
        private static ListAttachedUserPoliciesResponseUnmarshaller _instance = new ListAttachedUserPoliciesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAttachedUserPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
