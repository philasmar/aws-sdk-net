...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListSSHPublicKeysResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSSHPublicKeysResponse response = new ListSSHPublicKeysResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListSSHPublicKeysResult", 2))
                    {
        ...
        private static ListSSHPublicKeysResponseUnmarshaller _instance = new ListSSHPublicKeysResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSSHPublicKeysResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
