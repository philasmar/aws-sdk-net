...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DetachRolePolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetachRolePolicyResponse response = new DetachRolePolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DetachRolePolicyResult", 2))
                    {
        ...
        private static DetachRolePolicyResponseUnmarshaller _instance = new DetachRolePolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachRolePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
