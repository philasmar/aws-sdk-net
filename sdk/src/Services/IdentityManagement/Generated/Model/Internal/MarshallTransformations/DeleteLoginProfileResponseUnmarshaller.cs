...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteLoginProfileResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteLoginProfileResult", 2))
                    {
        ...
        private static DeleteLoginProfileResponseUnmarshaller _instance = new DeleteLoginProfileResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLoginProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
