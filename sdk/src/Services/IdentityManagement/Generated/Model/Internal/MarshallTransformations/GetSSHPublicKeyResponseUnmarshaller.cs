...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSSHPublicKeyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSSHPublicKeyResponse response = new GetSSHPublicKeyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GetSSHPublicKeyResult", 2))
                    {
        ...
        private static GetSSHPublicKeyResponseUnmarshaller _instance = new GetSSHPublicKeyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSSHPublicKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
