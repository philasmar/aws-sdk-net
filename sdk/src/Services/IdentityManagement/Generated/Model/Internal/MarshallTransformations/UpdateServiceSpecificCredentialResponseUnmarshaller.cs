...
{
    /// <summary>
    /// Response Unmarshaller for UpdateServiceSpecificCredential operation
    /// </summary>  
    public class UpdateServiceSpecificCredentialResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateServiceSpecificCredentialResponse response = new UpdateServiceSpecificCredentialResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateServiceSpecificCredentialResult", 2))
                    {
        ...
        private static UpdateServiceSpecificCredentialResponseUnmarshaller _instance = new UpdateServiceSpecificCredentialResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateServiceSpecificCredentialResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
