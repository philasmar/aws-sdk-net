...
{
    /// <summary>
    /// Response Unmarshaller for DeleteServiceSpecificCredential operation
    /// </summary>  
    public class DeleteServiceSpecificCredentialResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteServiceSpecificCredentialResponse response = new DeleteServiceSpecificCredentialResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteServiceSpecificCredentialResult", 2))
                    {
        ...
        private static DeleteServiceSpecificCredentialResponseUnmarshaller _instance = new DeleteServiceSpecificCredentialResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteServiceSpecificCredentialResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
