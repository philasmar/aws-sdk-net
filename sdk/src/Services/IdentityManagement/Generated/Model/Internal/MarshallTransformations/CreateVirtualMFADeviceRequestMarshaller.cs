...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateVirtualMFADeviceRequestMarshaller : IMarshaller<IRequest, CreateVirtualMFADeviceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateVirtualMFADeviceRequest)input);
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVirtualMFADeviceRequestMarshaller Instance
        {
            get
            {
                return _instance;
