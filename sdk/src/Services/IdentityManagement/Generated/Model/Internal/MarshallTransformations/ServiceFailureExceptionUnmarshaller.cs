...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    public class ServiceFailureExceptionUnmarshaller : IErrorResponseUnmarshaller<ServiceFailureException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ServiceFailureException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public ServiceFailureException Unmarshall(XmlUnmarshallerContext context, ErrorResponse errorResponse)
        {
            ServiceFailureException response = new ServiceFailureException(errorResponse.Message, errorResponse.InnerException, 
