...
{
    /// <summary>
    /// Response Unmarshaller for TagRole operation
    /// </summary>  
    public class TagRoleResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TagRoleResponse response = new TagRoleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("TagRoleResult", 2))
                    {
        ...
        private static TagRoleResponseUnmarshaller _instance = new TagRoleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagRoleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
