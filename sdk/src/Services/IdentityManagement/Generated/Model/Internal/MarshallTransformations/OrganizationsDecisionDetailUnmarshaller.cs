...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    public class OrganizationsDecisionDetailUnmarshaller : IUnmarshaller<OrganizationsDecisionDetail, XmlUnmarshallerContext>, IUnmarshaller<OrganizationsDecisionDetail, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public OrganizationsDecisionDetail Unmarshall(XmlUnmarshallerContext context)
        {
            OrganizationsDecisionDetail unmarshalledObject = new OrganizationsDecisionDetail();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("AllowedByOrganizations", targetDepth))
                    {
                        ...
                        unmarshalledObject.AllowedByOrganizations = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static OrganizationsDecisionDetailUnmarshaller Instance
        {
            get
            {
                return _instance;
