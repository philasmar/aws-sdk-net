...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListAttachedGroupPoliciesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListAttachedGroupPoliciesResult", 2))
                    {
        ...
        private static ListAttachedGroupPoliciesResponseUnmarshaller _instance = new ListAttachedGroupPoliciesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAttachedGroupPoliciesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
