    ...
    public class DeleteSigningCertificateRequestMarshaller : IMarshaller<IRequest, DeleteSigningCertificateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DeleteSigningCertificateRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DeleteSigningCertificateRequestMarshaller _instance = new DeleteSigningCertificateRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSigningCertificateRequestMarshaller Instance
        {
            get
            {
                return _instance;
