...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRole operation
    /// </summary>  
    public class UpdateRoleResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateRoleResponseUnmarshaller _instance = new UpdateRoleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRoleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
