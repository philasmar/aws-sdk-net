    ...
    public class DeleteUserPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteUserPolicyResult", 2))
                    {
        ...
        private static DeleteUserPolicyResponseUnmarshaller _instance = new DeleteUserPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteUserPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
