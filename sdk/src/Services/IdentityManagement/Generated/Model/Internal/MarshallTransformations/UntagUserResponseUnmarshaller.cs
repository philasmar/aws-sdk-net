...
{
    /// <summary>
    /// Response Unmarshaller for UntagUser operation
    /// </summary>  
    public class UntagUserResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UntagUserResponse response = new UntagUserResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UntagUserResult", 2))
                    {
        ...
        private static UntagUserResponseUnmarshaller _instance = new UntagUserResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
