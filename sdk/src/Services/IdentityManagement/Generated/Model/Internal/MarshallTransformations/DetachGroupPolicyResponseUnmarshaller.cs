...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DetachGroupPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DetachGroupPolicyResult", 2))
                    {
        ...
        private static DetachGroupPolicyResponseUnmarshaller _instance = new DetachGroupPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachGroupPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
