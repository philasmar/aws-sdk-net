...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PutRolePolicyRequestMarshaller : IMarshaller<IRequest, PutRolePolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutRolePolicyRequest)input);
        }
        ...
        public IRequest Marshall(PutRolePolicyRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static PutRolePolicyRequestMarshaller _instance = new PutRolePolicyRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutRolePolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
