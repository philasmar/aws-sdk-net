...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetOpenIDConnectProviderResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetOpenIDConnectProviderResponse response = new GetOpenIDConnectProviderResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GetOpenIDConnectProviderResult", 2))
                    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("ClientIDList/member", targetDepth))
                    {
                        ...
                        response.ClientIDList.Add(item);
                        continue;
                    }
                    ...
                    if (context.TestExpression("ThumbprintList/member", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        var item = unmarshaller.Unmarshall(context);
                        response.ThumbprintList.Add(item);
                        continue;
                    }
        ...
        private static GetOpenIDConnectProviderResponseUnmarshaller _instance = new GetOpenIDConnectProviderResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOpenIDConnectProviderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
