...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SimulatePrincipalPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SimulatePrincipalPolicyResponse response = new SimulatePrincipalPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("SimulatePrincipalPolicyResult", 2))
                    {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("EvaluationResults/member", targetDepth))
                    {
                        ...
                        response.EvaluationResults.Add(item);
                        continue;
                    }
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("PolicyEvaluation"))
                {
                    return PolicyEvaluationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static SimulatePrincipalPolicyResponseUnmarshaller _instance = new SimulatePrincipalPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SimulatePrincipalPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
