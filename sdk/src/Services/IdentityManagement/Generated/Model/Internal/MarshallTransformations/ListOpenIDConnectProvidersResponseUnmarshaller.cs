...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListOpenIDConnectProvidersResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListOpenIDConnectProvidersResponse response = new ListOpenIDConnectProvidersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListOpenIDConnectProvidersResult", 2))
                    {
        ...
        private static ListOpenIDConnectProvidersResponseUnmarshaller _instance = new ListOpenIDConnectProvidersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListOpenIDConnectProvidersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
