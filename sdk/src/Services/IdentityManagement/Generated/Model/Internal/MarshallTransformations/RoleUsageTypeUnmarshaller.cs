...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    public class RoleUsageTypeUnmarshaller : IUnmarshaller<RoleUsageType, XmlUnmarshallerContext>, IUnmarshaller<RoleUsageType, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public RoleUsageType Unmarshall(XmlUnmarshallerContext context)
        {
            RoleUsageType unmarshalledObject = new RoleUsageType();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("Resources/member", targetDepth))
                    {
                        ...
                        unmarshalledObject.Resources.Add(item);
                        continue;
                    }
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RoleUsageTypeUnmarshaller Instance
        {
            get
            {
                return _instance;
