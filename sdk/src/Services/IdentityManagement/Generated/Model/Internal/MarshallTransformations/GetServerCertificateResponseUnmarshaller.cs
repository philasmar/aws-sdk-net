...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetServerCertificateResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetServerCertificateResponse response = new GetServerCertificateResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GetServerCertificateResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, GetServerCertificateResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = ServerCertificateUnmarshaller.Instance;
        ...
        private static GetServerCertificateResponseUnmarshaller _instance = new GetServerCertificateResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetServerCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
