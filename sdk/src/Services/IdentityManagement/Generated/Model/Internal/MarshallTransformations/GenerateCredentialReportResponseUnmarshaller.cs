...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GenerateCredentialReportResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GenerateCredentialReportResponse response = new GenerateCredentialReportResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("GenerateCredentialReportResult", 2))
                    {
        ...
        private static GenerateCredentialReportResponseUnmarshaller _instance = new GenerateCredentialReportResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateCredentialReportResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
