...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetAccountAuthorizationDetailsRequestMarshaller : IMarshaller<IRequest, GetAccountAuthorizationDetailsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAccountAuthorizationDetailsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAccountAuthorizationDetailsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.IdentityManagement");
            request.Parameters.Add("Action", "GetAccountAuthorizationDetails");
