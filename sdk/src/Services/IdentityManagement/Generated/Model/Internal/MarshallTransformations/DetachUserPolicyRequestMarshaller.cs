...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DetachUserPolicyRequestMarshaller : IMarshaller<IRequest, DetachUserPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DetachUserPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DetachUserPolicyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.IdentityManagement");
            request.Parameters.Add("Action", "DetachUserPolicy");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachUserPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
