...
namespace Amazon.IdentityManagement.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AttachRolePolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AttachRolePolicyResponse response = new AttachRolePolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("AttachRolePolicyResult", 2))
                    {
        ...
        private static AttachRolePolicyResponseUnmarshaller _instance = new AttachRolePolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AttachRolePolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
