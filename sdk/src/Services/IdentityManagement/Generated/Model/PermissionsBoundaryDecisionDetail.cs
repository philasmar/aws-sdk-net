...
namespace Amazon.IdentityManagement.Model
{
    ...
    public partial class PermissionsBoundaryDecisionDetail
    {
        ...
        /// an IAM entity (user or role). A value of <code>true</code> means that the permissions
        /// boundary does not deny the action. This means that the policy includes an <code>Allow</code>
        /// statement that matches the request. In this case, if an identity-based policy also
        /// allows the action, the request is allowed. A value of <code>false</code> means that
        /// either the requested action is not allowed (implicitly denied) or that the action
        /// is explicitly denied by the permissions boundary. In both of these cases, the action
        /// is not allowed, regardless of the identity-based policy.
        /// </para>
        /// </summary>
