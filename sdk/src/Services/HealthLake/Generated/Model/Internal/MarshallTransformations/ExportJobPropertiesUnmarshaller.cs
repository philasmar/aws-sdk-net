...
namespace Amazon.HealthLake.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExportJobPropertiesUnmarshaller : IUnmarshaller<ExportJobProperties, XmlUnmarshallerContext>, IUnmarshaller<ExportJobProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ExportJobProperties IUnmarshaller<ExportJobProperties, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ExportJobProperties Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
