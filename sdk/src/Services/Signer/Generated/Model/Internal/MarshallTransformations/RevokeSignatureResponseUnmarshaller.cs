...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RevokeSignatureResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RevokeSignatureResponse response = new RevokeSignatureResponse();
        ...
        private static RevokeSignatureResponseUnmarshaller _instance = new RevokeSignatureResponseUnmarshaller();        

        internal static RevokeSignatureResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokeSignatureResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
