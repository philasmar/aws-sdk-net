...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartSigningJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartSigningJobResponse response = new StartSigningJobResponse();
        ...
        private static StartSigningJobResponseUnmarshaller _instance = new StartSigningJobResponseUnmarshaller();        

        internal static StartSigningJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSigningJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
