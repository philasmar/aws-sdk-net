...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RevokeSigningProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RevokeSigningProfileResponse response = new RevokeSigningProfileResponse();
        ...
        private static RevokeSigningProfileResponseUnmarshaller _instance = new RevokeSigningProfileResponseUnmarshaller();        

        internal static RevokeSigningProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokeSigningProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
