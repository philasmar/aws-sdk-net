...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetSigningPlatformRequestMarshaller : IMarshaller<IRequest, GetSigningPlatformRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetSigningPlatformRequestMarshaller _instance = new GetSigningPlatformRequestMarshaller();        

        internal static GetSigningPlatformRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSigningPlatformRequestMarshaller Instance
        {
            get
            {
                return _instance;
