...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutSigningProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutSigningProfileResponse response = new PutSigningProfileResponse();
        ...
        private static PutSigningProfileResponseUnmarshaller _instance = new PutSigningProfileResponseUnmarshaller();        

        internal static PutSigningProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutSigningProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
