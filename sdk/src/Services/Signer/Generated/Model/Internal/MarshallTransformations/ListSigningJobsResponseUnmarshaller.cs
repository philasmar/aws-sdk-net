...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListSigningJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSigningJobsResponse response = new ListSigningJobsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SigningJob, SigningJobUnmarshaller>(SigningJobUnmarshaller.Instance);
        ...
        private static ListSigningJobsResponseUnmarshaller _instance = new ListSigningJobsResponseUnmarshaller();        

        internal static ListSigningJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSigningJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
