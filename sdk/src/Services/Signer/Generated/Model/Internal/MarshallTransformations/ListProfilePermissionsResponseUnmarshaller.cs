...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListProfilePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListProfilePermissionsResponse response = new ListProfilePermissionsResponse();
        ...
        internal static ListProfilePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListProfilePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
