...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AddProfilePermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddProfilePermissionResponse response = new AddProfilePermissionResponse();
        ...
        private static AddProfilePermissionResponseUnmarshaller _instance = new AddProfilePermissionResponseUnmarshaller();        

        internal static AddProfilePermissionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddProfilePermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
