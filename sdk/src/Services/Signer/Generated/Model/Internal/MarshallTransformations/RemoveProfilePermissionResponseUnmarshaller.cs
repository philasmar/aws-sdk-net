...
namespace Amazon.Signer.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RemoveProfilePermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveProfilePermissionResponse response = new RemoveProfilePermissionResponse();
        ...
        internal static RemoveProfilePermissionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveProfilePermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
