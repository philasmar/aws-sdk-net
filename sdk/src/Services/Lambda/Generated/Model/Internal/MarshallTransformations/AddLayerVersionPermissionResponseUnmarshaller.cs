...
{
    /// <summary>
    /// Response Unmarshaller for AddLayerVersionPermission operation
    /// </summary>  
    public class AddLayerVersionPermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddLayerVersionPermissionResponse response = new AddLayerVersionPermissionResponse();
        ...
        private static AddLayerVersionPermissionResponseUnmarshaller _instance = new AddLayerVersionPermissionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddLayerVersionPermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
