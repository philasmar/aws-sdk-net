...
namespace Amazon.Lambda.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetAliasRequestMarshaller : IMarshaller<IRequest, GetAliasRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAliasRequest)input);
        }
        ...
        private static GetAliasRequestMarshaller _instance = new GetAliasRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAliasRequestMarshaller Instance
        {
            get
            {
                return _instance;
