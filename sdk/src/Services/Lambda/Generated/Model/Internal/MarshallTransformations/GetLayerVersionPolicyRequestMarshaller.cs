...
{
    /// <summary>
    /// GetLayerVersionPolicy Request Marshaller
    /// </summary>       
    public class GetLayerVersionPolicyRequestMarshaller : IMarshaller<IRequest, GetLayerVersionPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetLayerVersionPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetLayerVersionPolicyRequest publicRequest)
        {
        ...
        private static GetLayerVersionPolicyRequestMarshaller _instance = new GetLayerVersionPolicyRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLayerVersionPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
