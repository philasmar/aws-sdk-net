...
{
    /// <summary>
    /// Response Unmarshaller for GetLayerVersionPolicy operation
    /// </summary>  
    public class GetLayerVersionPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLayerVersionPolicyResponse response = new GetLayerVersionPolicyResponse();
        ...
        private static GetLayerVersionPolicyResponseUnmarshaller _instance = new GetLayerVersionPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLayerVersionPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
