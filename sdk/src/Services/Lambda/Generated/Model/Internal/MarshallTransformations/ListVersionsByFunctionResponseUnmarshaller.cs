...
{
    /// <summary>
    /// Response Unmarshaller for ListVersionsByFunction operation
    /// </summary>  
    public class ListVersionsByFunctionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListVersionsByFunctionResponse response = new ListVersionsByFunctionResponse();
        ...
        private static ListVersionsByFunctionResponseUnmarshaller _instance = new ListVersionsByFunctionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListVersionsByFunctionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
