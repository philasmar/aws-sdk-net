...
{
    /// <summary>
    /// DeleteFunctionConcurrency Request Marshaller
    /// </summary>       
    public class DeleteFunctionConcurrencyRequestMarshaller : IMarshaller<IRequest, DeleteFunctionConcurrencyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteFunctionConcurrencyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteFunctionConcurrencyRequest publicRequest)
        {
