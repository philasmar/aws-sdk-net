...
namespace Amazon.MediaConvert
{
    ...
    public partial class AmazonMediaConvertException : AmazonServiceException
    {
        ...
        public AmazonMediaConvertException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AmazonMediaConvertException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode)
