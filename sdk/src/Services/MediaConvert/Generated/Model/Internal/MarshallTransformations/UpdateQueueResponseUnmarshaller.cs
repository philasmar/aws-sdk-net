...
{
    /// <summary>
    /// Response Unmarshaller for UpdateQueue operation
    /// </summary>  
    public class UpdateQueueResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateQueueResponseUnmarshaller _instance = new UpdateQueueResponseUnmarshaller();        

        internal static UpdateQueueResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateQueueResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
