...
{
    /// <summary>
    /// Response Unmarshaller for ListJobTemplates operation
    /// </summary>  
    public class ListJobTemplatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListJobTemplatesResponseUnmarshaller _instance = new ListJobTemplatesResponseUnmarshaller();        

        internal static ListJobTemplatesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListJobTemplatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
