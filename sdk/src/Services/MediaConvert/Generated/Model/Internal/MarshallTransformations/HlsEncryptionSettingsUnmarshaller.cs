...
{
    /// <summary>
    /// Response Unmarshaller for HlsEncryptionSettings Object
    /// </summary>  
    public class HlsEncryptionSettingsUnmarshaller : IUnmarshaller<HlsEncryptionSettings, XmlUnmarshallerContext>, IUnmarshaller<HlsEncryptionSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        HlsEncryptionSettings IUnmarshaller<HlsEncryptionSettings, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public HlsEncryptionSettings Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            HlsEncryptionSettings unmarshalledObject = new HlsEncryptionSettings();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.OfflineEncrypted = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static HlsEncryptionSettingsUnmarshaller _instance = new HlsEncryptionSettingsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HlsEncryptionSettingsUnmarshaller Instance
        {
            get
            {
                return _instance;
