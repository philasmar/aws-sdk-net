...
{
    /// <summary>
    /// Response Unmarshaller for GetPreset operation
    /// </summary>  
    public class GetPresetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPresetResponse response = new GetPresetResponse();
        ...
        private static GetPresetResponseUnmarshaller _instance = new GetPresetResponseUnmarshaller();        

        internal static GetPresetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPresetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
