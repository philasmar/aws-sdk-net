...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    public class DvbTdtSettingsMarshaller : IRequestMarshaller<DvbTdtSettings, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(DvbTdtSettings requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetTdtInterval())
            {
                context.Writer.WritePropertyName("tdtInterval");
                context.Writer.Write(requestObject.TdtInterval);
            }
