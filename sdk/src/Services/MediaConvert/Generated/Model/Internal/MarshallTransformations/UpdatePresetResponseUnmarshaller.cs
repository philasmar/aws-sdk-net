...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdatePresetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePresetResponse response = new UpdatePresetResponse();
        ...
        internal static UpdatePresetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePresetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
