...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TrackSourceSettingsUnmarshaller : IUnmarshaller<TrackSourceSettings, XmlUnmarshallerContext>, IUnmarshaller<TrackSourceSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TrackSourceSettings IUnmarshaller<TrackSourceSettings, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public TrackSourceSettings Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("trackNumber", targetDepth))
                {
                    ...
                    unmarshalledObject.TrackNumber = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
