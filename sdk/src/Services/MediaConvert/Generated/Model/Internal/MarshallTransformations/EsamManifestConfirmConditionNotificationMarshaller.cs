...
namespace Amazon.MediaConvert.Model.Internal.MarshallTransformations
{
    ...
    public class EsamManifestConfirmConditionNotificationMarshaller : IRequestMarshaller<EsamManifestConfirmConditionNotification, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(EsamManifestConfirmConditionNotification requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetMccXml())
            {
                context.Writer.WritePropertyName("mccXml");
                context.Writer.Write(requestObject.MccXml);
            }
