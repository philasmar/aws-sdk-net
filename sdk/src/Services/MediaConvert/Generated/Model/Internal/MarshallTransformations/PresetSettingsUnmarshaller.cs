...
{
    /// <summary>
    /// Response Unmarshaller for PresetSettings Object
    /// </summary>  
    public class PresetSettingsUnmarshaller : IUnmarshaller<PresetSettings, XmlUnmarshallerContext>, IUnmarshaller<PresetSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PresetSettings IUnmarshaller<PresetSettings, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public PresetSettings Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            PresetSettings unmarshalledObject = new PresetSettings();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CaptionDescriptionPreset, CaptionDescriptionPresetUnmarshaller>(CaptionDescriptionPresetUnmarshaller.Instance);
        ...
        private static PresetSettingsUnmarshaller _instance = new PresetSettingsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PresetSettingsUnmarshaller Instance
        {
            get
            {
                return _instance;
