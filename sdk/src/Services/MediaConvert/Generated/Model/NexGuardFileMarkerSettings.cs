...
namespace Amazon.MediaConvert.Model
{
    ...
    public partial class NexGuardFileMarkerSettings
    {
        ...
        /// workflow. Required when you include Nagra NexGuard File Marker watermarking (NexGuardWatermarkingSettings)
        /// in your job. For PreRelease Content (NGPR/G2), specify an integer from 1 through 4,194,303.
        ...
        /// one output group, set the value of Payload ID (payload) to 0 in every output. For
