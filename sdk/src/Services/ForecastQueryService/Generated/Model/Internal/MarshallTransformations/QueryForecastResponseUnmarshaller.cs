...
{
    /// <summary>
    /// Response Unmarshaller for QueryForecast operation
    /// </summary>  
    public class QueryForecastResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static QueryForecastResponseUnmarshaller _instance = new QueryForecastResponseUnmarshaller();        

        internal static QueryForecastResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static QueryForecastResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
