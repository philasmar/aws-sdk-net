...
{
    /// <summary>
    /// QueryForecast Request Marshaller
    /// </summary>       
    public class QueryForecastRequestMarshaller : IMarshaller<IRequest, QueryForecastRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((QueryForecastRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(QueryForecastRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ForecastQueryService");
            string target = "AmazonForecastRuntime.QueryForecast";
        ...
        private static QueryForecastRequestMarshaller _instance = new QueryForecastRequestMarshaller();        

        internal static QueryForecastRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static QueryForecastRequestMarshaller Instance
        {
            get
            {
                return _instance;
