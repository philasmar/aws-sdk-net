...
namespace Amazon.Textract.Model
{
    ...
    public partial class InvalidS3ObjectException : AmazonTextractException
    {
        ...
        public InvalidS3ObjectException(string message, Exception innerException) 
        ...
        public InvalidS3ObjectException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidS3ObjectException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected InvalidS3ObjectException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
