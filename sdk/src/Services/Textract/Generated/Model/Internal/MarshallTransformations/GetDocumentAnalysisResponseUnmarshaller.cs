...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetDocumentAnalysisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetDocumentAnalysisResponseUnmarshaller _instance = new GetDocumentAnalysisResponseUnmarshaller();        

        internal static GetDocumentAnalysisResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDocumentAnalysisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
