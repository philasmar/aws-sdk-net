...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartDocumentAnalysisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static StartDocumentAnalysisResponseUnmarshaller _instance = new StartDocumentAnalysisResponseUnmarshaller();        

        internal static StartDocumentAnalysisResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDocumentAnalysisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
