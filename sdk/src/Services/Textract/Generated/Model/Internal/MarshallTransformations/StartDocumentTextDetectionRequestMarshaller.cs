...
namespace Amazon.Textract.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class StartDocumentTextDetectionRequestMarshaller : IMarshaller<IRequest, StartDocumentTextDetectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartDocumentTextDetectionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartDocumentTextDetectionRequest publicRequest)
        {
        ...
        private static StartDocumentTextDetectionRequestMarshaller _instance = new StartDocumentTextDetectionRequestMarshaller();        

        internal static StartDocumentTextDetectionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDocumentTextDetectionRequestMarshaller Instance
        {
            get
            {
                return _instance;
