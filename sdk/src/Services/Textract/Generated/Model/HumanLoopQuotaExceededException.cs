...
namespace Amazon.Textract.Model
{
    ...
    public partial class HumanLoopQuotaExceededException : AmazonTextractException
    {
        ...
        public HumanLoopQuotaExceededException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public HumanLoopQuotaExceededException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
