...
{
    /// <summary>
    /// Response Unmarshaller for ExportSchema operation
    /// </summary>  
    public class ExportSchemaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ExportSchemaResponseUnmarshaller _instance = new ExportSchemaResponseUnmarshaller();        

        internal static ExportSchemaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportSchemaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
