...
{
    /// <summary>
    /// Response Unmarshaller for ListDiscoverers operation
    /// </summary>  
    public class ListDiscoverersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDiscoverersResponse response = new ListDiscoverersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("Discoverers", targetDepth))
                {
                    ...
                    response.Discoverers = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListDiscoverersResponseUnmarshaller _instance = new ListDiscoverersResponseUnmarshaller();        

        internal static ListDiscoverersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDiscoverersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
