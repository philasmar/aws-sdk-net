...
{
    /// <summary>
    /// Response Unmarshaller for PutCodeBinding operation
    /// </summary>  
    public class PutCodeBindingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutCodeBindingResponse response = new PutCodeBindingResponse();
        ...
        private static PutCodeBindingResponseUnmarshaller _instance = new PutCodeBindingResponseUnmarshaller();        

        internal static PutCodeBindingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutCodeBindingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
