...
{
    /// <summary>
    /// Response Unmarshaller for DescribeCodeBinding operation
    /// </summary>  
    public class DescribeCodeBindingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeCodeBindingResponse response = new DescribeCodeBindingResponse();
        ...
        private static DescribeCodeBindingResponseUnmarshaller _instance = new DescribeCodeBindingResponseUnmarshaller();        

        internal static DescribeCodeBindingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCodeBindingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
