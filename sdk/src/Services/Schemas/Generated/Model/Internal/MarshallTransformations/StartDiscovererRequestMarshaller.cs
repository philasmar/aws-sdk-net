...
{
    /// <summary>
    /// StartDiscoverer Request Marshaller
    /// </summary>       
    public class StartDiscovererRequestMarshaller : IMarshaller<IRequest, StartDiscovererRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartDiscovererRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartDiscovererRequest publicRequest)
        {
        ...
        private static StartDiscovererRequestMarshaller _instance = new StartDiscovererRequestMarshaller();        

        internal static StartDiscovererRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDiscovererRequestMarshaller Instance
        {
            get
            {
                return _instance;
