...
namespace Amazon.Schemas.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeDiscovererRequestMarshaller : IMarshaller<IRequest, DescribeDiscovererRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DescribeDiscovererRequestMarshaller _instance = new DescribeDiscovererRequestMarshaller();        

        internal static DescribeDiscovererRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDiscovererRequestMarshaller Instance
        {
            get
            {
                return _instance;
