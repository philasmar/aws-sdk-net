...
{
    /// <summary>
    /// GetCodeBindingSource Request Marshaller
    /// </summary>       
    public class GetCodeBindingSourceRequestMarshaller : IMarshaller<IRequest, GetCodeBindingSourceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCodeBindingSourceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCodeBindingSourceRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/registries/name/{registryName}/schemas/name/{schemaName}/language/{language}/source";
            request.MarshallerVersion = 2;
            request.UseQueryString = true;

            return request;
        }
        private static GetCodeBindingSourceRequestMarshaller _instance = new GetCodeBindingSourceRequestMarshaller();        

        internal static GetCodeBindingSourceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCodeBindingSourceRequestMarshaller Instance
        {
            get
            {
                return _instance;
