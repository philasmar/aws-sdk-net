...
{
    /// <summary>
    /// Response Unmarshaller for StopDiscoverer operation
    /// </summary>  
    public class StopDiscovererResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopDiscovererResponse response = new StopDiscovererResponse();
        ...
        private static StopDiscovererResponseUnmarshaller _instance = new StopDiscovererResponseUnmarshaller();        

        internal static StopDiscovererResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopDiscovererResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
