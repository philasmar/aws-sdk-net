...
{
    /// <summary>
    /// Response Unmarshaller for StartDiscoverer operation
    /// </summary>  
    public class StartDiscovererResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartDiscovererResponse response = new StartDiscovererResponse();
        ...
        private static StartDiscovererResponseUnmarshaller _instance = new StartDiscovererResponseUnmarshaller();        

        internal static StartDiscovererResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDiscovererResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
