...
{
    /// <summary>
    /// Response Unmarshaller for GetDiscoveredSchema operation
    /// </summary>  
    public class GetDiscoveredSchemaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDiscoveredSchemaResponse response = new GetDiscoveredSchemaResponse();
        ...
        private static GetDiscoveredSchemaResponseUnmarshaller _instance = new GetDiscoveredSchemaResponseUnmarshaller();        

        internal static GetDiscoveredSchemaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDiscoveredSchemaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
