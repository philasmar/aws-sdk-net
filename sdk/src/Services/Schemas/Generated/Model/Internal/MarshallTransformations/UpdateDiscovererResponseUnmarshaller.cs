...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDiscoverer operation
    /// </summary>  
    public class UpdateDiscovererResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDiscovererResponse response = new UpdateDiscovererResponse();
        ...
        private static UpdateDiscovererResponseUnmarshaller _instance = new UpdateDiscovererResponseUnmarshaller();        

        internal static UpdateDiscovererResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDiscovererResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
