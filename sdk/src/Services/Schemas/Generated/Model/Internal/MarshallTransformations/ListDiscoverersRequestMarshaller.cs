...
namespace Amazon.Schemas.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListDiscoverersRequestMarshaller : IMarshaller<IRequest, ListDiscoverersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListDiscoverersRequestMarshaller _instance = new ListDiscoverersRequestMarshaller();        

        internal static ListDiscoverersRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDiscoverersRequestMarshaller Instance
        {
            get
            {
                return _instance;
