...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSchema operation
    /// </summary>  
    public class DescribeSchemaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSchemaResponse response = new DescribeSchemaResponse();
        ...
        private static DescribeSchemaResponseUnmarshaller _instance = new DescribeSchemaResponseUnmarshaller();        

        internal static DescribeSchemaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSchemaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
