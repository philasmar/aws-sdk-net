...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDeploymentStrategy operation
    /// </summary>  
    public class UpdateDeploymentStrategyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateDeploymentStrategyResponseUnmarshaller _instance = new UpdateDeploymentStrategyResponseUnmarshaller();        

        internal static UpdateDeploymentStrategyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDeploymentStrategyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
