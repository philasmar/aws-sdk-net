...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    public class CreateHostedConfigurationVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        internal static CreateHostedConfigurationVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateHostedConfigurationVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
