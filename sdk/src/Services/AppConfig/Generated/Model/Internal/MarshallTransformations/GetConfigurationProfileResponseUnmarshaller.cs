...
{
    /// <summary>
    /// Response Unmarshaller for GetConfigurationProfile operation
    /// </summary>  
    public class GetConfigurationProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetConfigurationProfileResponseUnmarshaller _instance = new GetConfigurationProfileResponseUnmarshaller();        

        internal static GetConfigurationProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConfigurationProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
