...
{
    /// <summary>
    /// GetConfigurationProfile Request Marshaller
    /// </summary>       
    public class GetConfigurationProfileRequestMarshaller : IMarshaller<IRequest, GetConfigurationProfileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetConfigurationProfileRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetConfigurationProfileRequest publicRequest)
        {
        ...
        private static GetConfigurationProfileRequestMarshaller _instance = new GetConfigurationProfileRequestMarshaller();        

        internal static GetConfigurationProfileRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetConfigurationProfileRequestMarshaller Instance
        {
            get
            {
                return _instance;
