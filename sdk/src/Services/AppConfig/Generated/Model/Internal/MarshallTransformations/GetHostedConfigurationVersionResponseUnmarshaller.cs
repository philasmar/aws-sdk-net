...
{
    /// <summary>
    /// Response Unmarshaller for GetHostedConfigurationVersion operation
    /// </summary>  
    public class GetHostedConfigurationVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetHostedConfigurationVersionResponse response = new GetHostedConfigurationVersionResponse();
        ...
        private static GetHostedConfigurationVersionResponseUnmarshaller _instance = new GetHostedConfigurationVersionResponseUnmarshaller();        

        internal static GetHostedConfigurationVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetHostedConfigurationVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
