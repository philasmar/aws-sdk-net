...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    public class CreateConfigurationProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateConfigurationProfileResponseUnmarshaller _instance = new CreateConfigurationProfileResponseUnmarshaller();        

        internal static CreateConfigurationProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConfigurationProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
