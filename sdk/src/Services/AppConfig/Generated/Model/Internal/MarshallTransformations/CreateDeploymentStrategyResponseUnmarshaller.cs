...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    public class CreateDeploymentStrategyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateDeploymentStrategyResponseUnmarshaller _instance = new CreateDeploymentStrategyResponseUnmarshaller();        

        internal static CreateDeploymentStrategyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDeploymentStrategyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
