...
namespace Amazon.AppConfig.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetHostedConfigurationVersionRequestMarshaller : IMarshaller<IRequest, GetHostedConfigurationVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetHostedConfigurationVersionRequestMarshaller _instance = new GetHostedConfigurationVersionRequestMarshaller();        

        internal static GetHostedConfigurationVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetHostedConfigurationVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
