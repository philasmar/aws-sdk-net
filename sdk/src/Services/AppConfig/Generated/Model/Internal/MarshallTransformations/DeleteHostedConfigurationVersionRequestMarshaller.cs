...
{
    /// <summary>
    /// DeleteHostedConfigurationVersion Request Marshaller
    /// </summary>       
    public class DeleteHostedConfigurationVersionRequestMarshaller : IMarshaller<IRequest, DeleteHostedConfigurationVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteHostedConfigurationVersionRequest)input);
        }
        ...
        private static DeleteHostedConfigurationVersionRequestMarshaller _instance = new DeleteHostedConfigurationVersionRequestMarshaller();        

        internal static DeleteHostedConfigurationVersionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteHostedConfigurationVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
