...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListStorageLensConfigurationEntryUnmarshaller : IUnmarshaller<ListStorageLensConfigurationEntry, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public ListStorageLensConfigurationEntry Unmarshall(XmlUnmarshallerContext context)
        {
            ListStorageLensConfigurationEntry unmarshalledObject = new ListStorageLensConfigurationEntry();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListStorageLensConfigurationEntryUnmarshaller Instance
        {
            get
            {
                return _instance;
