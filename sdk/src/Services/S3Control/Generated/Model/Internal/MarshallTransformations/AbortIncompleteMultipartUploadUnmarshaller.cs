...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AbortIncompleteMultipartUploadUnmarshaller : IUnmarshaller<AbortIncompleteMultipartUpload, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public AbortIncompleteMultipartUpload Unmarshall(XmlUnmarshallerContext context)
        {
            AbortIncompleteMultipartUpload unmarshalledObject = new AbortIncompleteMultipartUpload();
