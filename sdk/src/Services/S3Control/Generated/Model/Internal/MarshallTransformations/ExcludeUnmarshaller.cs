...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ExcludeUnmarshaller : IUnmarshaller<Exclude, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public Exclude Unmarshall(XmlUnmarshallerContext context)
        {
            Exclude unmarshalledObject = new Exclude();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExcludeUnmarshaller Instance
        {
            get
            {
                return _instance;
