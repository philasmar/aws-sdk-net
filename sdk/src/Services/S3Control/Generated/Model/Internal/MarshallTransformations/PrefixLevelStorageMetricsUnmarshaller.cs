...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PrefixLevelStorageMetricsUnmarshaller : IUnmarshaller<PrefixLevelStorageMetrics, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public PrefixLevelStorageMetrics Unmarshall(XmlUnmarshallerContext context)
        {
            PrefixLevelStorageMetrics unmarshalledObject = new PrefixLevelStorageMetrics();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = SelectionCriteriaUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PrefixLevelStorageMetricsUnmarshaller Instance
        {
            get
            {
                return _instance;
