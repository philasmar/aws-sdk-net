...
{
    /// <summary>
    /// GetAccessPointPolicy Request Marshaller
    /// </summary>       
    public class GetAccessPointPolicyRequestMarshaller : IMarshaller<IRequest, GetAccessPointPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetAccessPointPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetAccessPointPolicyRequest publicRequest)
        {
        ...
        private static GetAccessPointPolicyRequestMarshaller _instance = new GetAccessPointPolicyRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAccessPointPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
