...
{
    /// <summary>
    /// DeleteAccessPointPolicy Request Marshaller
    /// </summary>       
    public class DeleteAccessPointPolicyRequestMarshaller : IMarshaller<IRequest, DeleteAccessPointPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteAccessPointPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteAccessPointPolicyRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAccessPointPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
