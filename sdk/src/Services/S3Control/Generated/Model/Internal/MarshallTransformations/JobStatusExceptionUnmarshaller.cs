...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    public class JobStatusExceptionUnmarshaller : IErrorResponseUnmarshaller<JobStatusException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public JobStatusException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static JobStatusExceptionUnmarshaller _instance = new JobStatusExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static JobStatusExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
