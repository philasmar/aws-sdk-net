...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteStorageLensConfigurationRequestMarshaller : IMarshaller<IRequest, DeleteStorageLensConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((DeleteStorageLensConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteStorageLensConfigurationRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteStorageLensConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
