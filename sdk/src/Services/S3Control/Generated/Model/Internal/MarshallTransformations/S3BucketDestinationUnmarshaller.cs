...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    public class S3BucketDestinationUnmarshaller : IUnmarshaller<S3BucketDestination, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public S3BucketDestination Unmarshall(XmlUnmarshallerContext context)
        {
            S3BucketDestination unmarshalledObject = new S3BucketDestination();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static S3BucketDestinationUnmarshaller Instance
        {
            get
            {
                return _instance;
