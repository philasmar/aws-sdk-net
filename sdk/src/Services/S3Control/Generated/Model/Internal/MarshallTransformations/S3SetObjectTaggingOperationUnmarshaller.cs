...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    public class S3SetObjectTaggingOperationUnmarshaller : IUnmarshaller<S3SetObjectTaggingOperation, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public S3SetObjectTaggingOperation Unmarshall(XmlUnmarshallerContext context)
        {
            S3SetObjectTaggingOperation unmarshalledObject = new S3SetObjectTaggingOperation();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static S3SetObjectTaggingOperationUnmarshaller Instance
        {
            get
            {
                return _instance;
