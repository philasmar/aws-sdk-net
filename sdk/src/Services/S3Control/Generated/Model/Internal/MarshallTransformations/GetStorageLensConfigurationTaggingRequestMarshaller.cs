...
{
    /// <summary>
    /// GetStorageLensConfigurationTagging Request Marshaller
    /// </summary>       
    public class GetStorageLensConfigurationTaggingRequestMarshaller : IMarshaller<IRequest, GetStorageLensConfigurationTaggingRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetStorageLensConfigurationTaggingRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetStorageLensConfigurationTaggingRequest publicRequest)
        {
        ...
        private static GetStorageLensConfigurationTaggingRequestMarshaller _instance = new GetStorageLensConfigurationTaggingRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetStorageLensConfigurationTaggingRequestMarshaller Instance
        {
            get
            {
                return _instance;
