...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    public class S3SetObjectRetentionOperationUnmarshaller : IUnmarshaller<S3SetObjectRetentionOperation, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public S3SetObjectRetentionOperation Unmarshall(XmlUnmarshallerContext context)
        {
            S3SetObjectRetentionOperation unmarshalledObject = new S3SetObjectRetentionOperation();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = S3RetentionUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static S3SetObjectRetentionOperationUnmarshaller Instance
        {
            get
            {
                return _instance;
