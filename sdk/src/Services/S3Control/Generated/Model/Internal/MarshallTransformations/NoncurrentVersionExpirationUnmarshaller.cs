...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    public class NoncurrentVersionExpirationUnmarshaller : IUnmarshaller<NoncurrentVersionExpiration, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public NoncurrentVersionExpiration Unmarshall(XmlUnmarshallerContext context)
        {
            NoncurrentVersionExpiration unmarshalledObject = new NoncurrentVersionExpiration();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static NoncurrentVersionExpirationUnmarshaller Instance
        {
            get
            {
                return _instance;
