...
namespace Amazon.S3Control.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RegionalBucketUnmarshaller : IUnmarshaller<RegionalBucket, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public RegionalBucket Unmarshall(XmlUnmarshallerContext context)
        {
            RegionalBucket unmarshalledObject = new RegionalBucket();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegionalBucketUnmarshaller Instance
        {
            get
            {
                return _instance;
