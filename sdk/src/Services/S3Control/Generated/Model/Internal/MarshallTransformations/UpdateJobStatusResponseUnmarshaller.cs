    ...
    public class UpdateJobStatusResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, UpdateJobStatusResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        response.StatusUpdateReason = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("JobStatusException"))
                {
                    return JobStatusExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateJobStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
