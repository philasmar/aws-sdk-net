...
namespace Amazon.TimestreamQuery.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CancelQueryRequestMarshaller : IMarshaller<IRequest, CancelQueryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CancelQueryRequest publicRequest)
        {
            ...
            string target = "Timestream_20181101.CancelQuery";
        ...
        private static CancelQueryRequestMarshaller _instance = new CancelQueryRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelQueryRequestMarshaller Instance
        {
            get
            {
                return _instance;
