...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UntagStreamRequestMarshaller : IMarshaller<IRequest, UntagStreamRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UntagStreamRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UntagStreamRequest publicRequest)
        {
            ...
            request.ResourcePath = "/untagStream";
