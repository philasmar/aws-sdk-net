...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSignalingChannelEndpointResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSignalingChannelEndpointResponse response = new GetSignalingChannelEndpointResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ResourceEndpointListItem, ResourceEndpointListItemUnmarshaller>(ResourceEndpointListItemUnmarshaller.Instance);
                    response.ResourceEndpointList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetSignalingChannelEndpointResponseUnmarshaller _instance = new GetSignalingChannelEndpointResponseUnmarshaller();        

        internal static GetSignalingChannelEndpointResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSignalingChannelEndpointResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
