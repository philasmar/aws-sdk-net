...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UntagStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UntagStreamResponse response = new UntagStreamResponse();
        ...
        private static UntagStreamResponseUnmarshaller _instance = new UntagStreamResponseUnmarshaller();        

        internal static UntagStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
