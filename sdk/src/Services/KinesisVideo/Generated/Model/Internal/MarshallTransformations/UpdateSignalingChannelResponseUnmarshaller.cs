...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateSignalingChannelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSignalingChannelResponse response = new UpdateSignalingChannelResponse();
        ...
        private static UpdateSignalingChannelResponseUnmarshaller _instance = new UpdateSignalingChannelResponseUnmarshaller();        

        internal static UpdateSignalingChannelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSignalingChannelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
