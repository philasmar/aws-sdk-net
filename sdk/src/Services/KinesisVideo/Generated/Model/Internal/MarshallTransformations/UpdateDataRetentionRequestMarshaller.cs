...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateDataRetentionRequestMarshaller : IMarshaller<IRequest, UpdateDataRetentionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(UpdateDataRetentionRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetDataRetentionChangeInHours())
                {
                    ...
                    context.Writer.Write(publicRequest.DataRetentionChangeInHours);
                }
