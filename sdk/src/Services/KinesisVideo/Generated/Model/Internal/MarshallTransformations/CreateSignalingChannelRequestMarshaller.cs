...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateSignalingChannelRequestMarshaller : IMarshaller<IRequest, CreateSignalingChannelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        public IRequest Marshall(CreateSignalingChannelRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetChannelType())
                {
                    ...
                    context.Writer.Write(publicRequest.ChannelType);
                }
        ...
        private static CreateSignalingChannelRequestMarshaller _instance = new CreateSignalingChannelRequestMarshaller();        

        internal static CreateSignalingChannelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSignalingChannelRequestMarshaller Instance
        {
            get
            {
                return _instance;
