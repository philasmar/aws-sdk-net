...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TagStreamResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TagStreamResponse response = new TagStreamResponse();
        ...
        private static TagStreamResponseUnmarshaller _instance = new TagStreamResponseUnmarshaller();        

        internal static TagStreamResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagStreamResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
