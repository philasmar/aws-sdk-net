...
namespace Amazon.KinesisVideo.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateDataRetentionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDataRetentionResponse response = new UpdateDataRetentionResponse();
        ...
        internal static UpdateDataRetentionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDataRetentionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
