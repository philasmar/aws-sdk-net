...
namespace Amazon.KinesisVideo.Model
{
    ...
    public partial class DescribeStreamResponse : AmazonWebServiceResponse
    {
        ...
        {
            get { return this._streamInfo; }
            set { this._streamInfo = value; }
        }

        // Check to see if StreamInfo property is set
        internal bool IsSetStreamInfo()
        {
            return this._streamInfo != null;
        }
