...
namespace Amazon.EC2.Model
{
    ...
    public partial class CopyFpgaImageRequest : AmazonEC2Request
    {
        ...
        /// <summary>
        /// Gets and sets the property SourceFpgaImageId. 
        /// <para>
        ...
        public string SourceFpgaImageId
        {
            ...
            set { this._sourceFpgaImageId = value; }
        }

        // Check to see if SourceFpgaImageId property is set
        internal bool IsSetSourceFpgaImageId()
        {
            return this._sourceFpgaImageId != null;
        }
