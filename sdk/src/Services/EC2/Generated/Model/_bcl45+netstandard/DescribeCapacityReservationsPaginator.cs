...
namespace Amazon.EC2.Model
{
    ...
    internal sealed partial class DescribeCapacityReservationsPaginator : IPaginator<DescribeCapacityReservationsResponse>, IDescribeCapacityReservationsPaginator
    {
        ...
        public IPaginatedEnumerable<CapacityReservation> CapacityReservations => 
            new PaginatedResultKeyResponse<DescribeCapacityReservationsResponse, CapacityReservation>(this, (i) => i.CapacityReservations);
        ...
        async IAsyncEnumerable<DescribeCapacityReservationsResponse> IPaginator<DescribeCapacityReservationsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
