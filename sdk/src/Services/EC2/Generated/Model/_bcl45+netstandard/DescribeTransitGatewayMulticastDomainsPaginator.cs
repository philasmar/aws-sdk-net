...
namespace Amazon.EC2.Model
{
    ...
    internal sealed partial class DescribeTransitGatewayMulticastDomainsPaginator : IPaginator<DescribeTransitGatewayMulticastDomainsResponse>, IDescribeTransitGatewayMulticastDomainsPaginator
    {
        ...
        async IAsyncEnumerable<DescribeTransitGatewayMulticastDomainsResponse> IPaginator<DescribeTransitGatewayMulticastDomainsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
