...
namespace Amazon.EC2.Model
{
    ...
    internal sealed partial class GetTransitGatewayAttachmentPropagationsPaginator : IPaginator<GetTransitGatewayAttachmentPropagationsResponse>, IGetTransitGatewayAttachmentPropagationsPaginator
    {
        ...
        public IPaginatedEnumerable<TransitGatewayAttachmentPropagation> TransitGatewayAttachmentPropagations => 
            new PaginatedResultKeyResponse<GetTransitGatewayAttachmentPropagationsResponse, TransitGatewayAttachmentPropagation>(this, (i) => i.TransitGatewayAttachmentPropagations);
        ...
        async IAsyncEnumerable<GetTransitGatewayAttachmentPropagationsResponse> IPaginator<GetTransitGatewayAttachmentPropagationsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
