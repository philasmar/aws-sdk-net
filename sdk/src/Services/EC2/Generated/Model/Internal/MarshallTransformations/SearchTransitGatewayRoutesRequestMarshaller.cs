...
{
    /// <summary>
    /// SearchTransitGatewayRoutes Request Marshaller
    /// </summary>       
    public class SearchTransitGatewayRoutesRequestMarshaller : IMarshaller<IRequest, SearchTransitGatewayRoutesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SearchTransitGatewayRoutesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SearchTransitGatewayRoutesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "SearchTransitGatewayRoutes");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SearchTransitGatewayRoutesRequestMarshaller Instance
        {
            get
            {
                return _instance;
