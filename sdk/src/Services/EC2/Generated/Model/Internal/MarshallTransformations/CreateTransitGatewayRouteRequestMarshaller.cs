...
{
    /// <summary>
    /// CreateTransitGatewayRoute Request Marshaller
    /// </summary>       
    public class CreateTransitGatewayRouteRequestMarshaller : IMarshaller<IRequest, CreateTransitGatewayRouteRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateTransitGatewayRouteRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateTransitGatewayRouteRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "CreateTransitGatewayRoute");
            ...
            return request;
                    ...
                    private static CreateTransitGatewayRouteRequestMarshaller _instance = new CreateTransitGatewayRouteRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTransitGatewayRouteRequestMarshaller Instance
        {
            get
            {
                return _instance;
