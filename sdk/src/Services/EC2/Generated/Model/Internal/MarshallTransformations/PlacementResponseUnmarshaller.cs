...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class PlacementResponseUnmarshaller : IUnmarshaller<PlacementResponse, XmlUnmarshallerContext>, IUnmarshaller<PlacementResponse, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public PlacementResponse Unmarshall(XmlUnmarshallerContext context)
        {
            PlacementResponse unmarshalledObject = new PlacementResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PlacementResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
