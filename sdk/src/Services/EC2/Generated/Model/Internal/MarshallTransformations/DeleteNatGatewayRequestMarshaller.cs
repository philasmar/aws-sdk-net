    ...
    public class DeleteNatGatewayRequestMarshaller : IMarshaller<IRequest, DeleteNatGatewayRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DeleteNatGatewayRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DeleteNatGatewayRequestMarshaller _instance = new DeleteNatGatewayRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteNatGatewayRequestMarshaller Instance
        {
            get
            {
                return _instance;
