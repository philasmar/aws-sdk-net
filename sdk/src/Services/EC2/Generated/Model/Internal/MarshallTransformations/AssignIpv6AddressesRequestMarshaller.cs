...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AssignIpv6AddressesRequestMarshaller : IMarshaller<IRequest, AssignIpv6AddressesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssignIpv6AddressesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssignIpv6AddressesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "AssignIpv6Addresses");
            ...
            return request;
                    ...
                    private static AssignIpv6AddressesRequestMarshaller _instance = new AssignIpv6AddressesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssignIpv6AddressesRequestMarshaller Instance
        {
            get
            {
                return _instance;
