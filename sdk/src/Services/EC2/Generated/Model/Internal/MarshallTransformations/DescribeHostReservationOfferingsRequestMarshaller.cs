...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeHostReservationOfferingsRequestMarshaller : IMarshaller<IRequest, DescribeHostReservationOfferingsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeHostReservationOfferingsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeHostReservationOfferingsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeHostReservationOfferings");
            ...
            if(publicRequest != null)
            {
                ...
                {
                    request.Parameters.Add("MaxDuration", StringUtils.FromInt(publicRequest.MaxDuration));
                }
                ...
                {
                    request.Parameters.Add("MinDuration", StringUtils.FromInt(publicRequest.MinDuration));
                }
