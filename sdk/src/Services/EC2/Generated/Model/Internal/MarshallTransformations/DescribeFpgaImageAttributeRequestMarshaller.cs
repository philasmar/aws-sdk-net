...
{
    /// <summary>
    /// DescribeFpgaImageAttribute Request Marshaller
    /// </summary>       
    public class DescribeFpgaImageAttributeRequestMarshaller : IMarshaller<IRequest, DescribeFpgaImageAttributeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeFpgaImageAttributeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeFpgaImageAttributeRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeFpgaImageAttribute");
