    ...
    public class ModifyVpcAttributeRequestMarshaller : IMarshaller<IRequest, ModifyVpcAttributeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ModifyVpcAttributeRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static ModifyVpcAttributeRequestMarshaller _instance = new ModifyVpcAttributeRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyVpcAttributeRequestMarshaller Instance
        {
            get
            {
                return _instance;
