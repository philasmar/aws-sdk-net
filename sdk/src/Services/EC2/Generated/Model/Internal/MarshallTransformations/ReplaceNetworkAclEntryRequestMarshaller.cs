    ...
    public class ReplaceNetworkAclEntryRequestMarshaller : IMarshaller<IRequest, ReplaceNetworkAclEntryRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ReplaceNetworkAclEntryRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static ReplaceNetworkAclEntryRequestMarshaller _instance = new ReplaceNetworkAclEntryRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReplaceNetworkAclEntryRequestMarshaller Instance
        {
            get
            {
                return _instance;
