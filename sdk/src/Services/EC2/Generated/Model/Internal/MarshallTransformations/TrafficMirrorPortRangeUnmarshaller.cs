...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class TrafficMirrorPortRangeUnmarshaller : IUnmarshaller<TrafficMirrorPortRange, XmlUnmarshallerContext>, IUnmarshaller<TrafficMirrorPortRange, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public TrafficMirrorPortRange Unmarshall(XmlUnmarshallerContext context)
        {
            TrafficMirrorPortRange unmarshalledObject = new TrafficMirrorPortRange();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TrafficMirrorPortRangeUnmarshaller Instance
        {
            get
            {
                return _instance;
