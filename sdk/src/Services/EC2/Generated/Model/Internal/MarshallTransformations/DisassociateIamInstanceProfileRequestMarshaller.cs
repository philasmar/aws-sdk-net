...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DisassociateIamInstanceProfileRequestMarshaller : IMarshaller<IRequest, DisassociateIamInstanceProfileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateIamInstanceProfileRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateIamInstanceProfileRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DisassociateIamInstanceProfile");
