...
{
    /// <summary>
    /// CreateTransitGatewayMulticastDomain Request Marshaller
    /// </summary>       
    public class CreateTransitGatewayMulticastDomainRequestMarshaller : IMarshaller<IRequest, CreateTransitGatewayMulticastDomainRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateTransitGatewayMulticastDomainRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateTransitGatewayMulticastDomainRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "CreateTransitGatewayMulticastDomain");
            ...
            return request;
                    ...
                    private static CreateTransitGatewayMulticastDomainRequestMarshaller _instance = new CreateTransitGatewayMulticastDomainRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTransitGatewayMulticastDomainRequestMarshaller Instance
        {
            get
            {
                return _instance;
