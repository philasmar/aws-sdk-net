...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class InstanceTypeOfferingUnmarshaller : IUnmarshaller<InstanceTypeOffering, XmlUnmarshallerContext>, IUnmarshaller<InstanceTypeOffering, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public InstanceTypeOffering Unmarshall(XmlUnmarshallerContext context)
        {
            InstanceTypeOffering unmarshalledObject = new InstanceTypeOffering();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InstanceTypeOfferingUnmarshaller Instance
        {
            get
            {
                return _instance;
