...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeSubnetsRequestMarshaller : IMarshaller<IRequest, DescribeSubnetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeSubnetsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeSubnetsRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeSubnetsRequestMarshaller _instance = new DescribeSubnetsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSubnetsRequestMarshaller Instance
        {
            get
            {
                return _instance;
