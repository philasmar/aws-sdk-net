...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class InstanceFamilyCreditSpecificationUnmarshaller : IUnmarshaller<InstanceFamilyCreditSpecification, XmlUnmarshallerContext>, IUnmarshaller<InstanceFamilyCreditSpecification, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public InstanceFamilyCreditSpecification Unmarshall(XmlUnmarshallerContext context)
        {
            InstanceFamilyCreditSpecification unmarshalledObject = new InstanceFamilyCreditSpecification();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InstanceFamilyCreditSpecificationUnmarshaller Instance
        {
            get
            {
                return _instance;
