...
{
    /// <summary>
    /// CreateTransitGatewayRouteTable Request Marshaller
    /// </summary>       
    public class CreateTransitGatewayRouteTableRequestMarshaller : IMarshaller<IRequest, CreateTransitGatewayRouteTableRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateTransitGatewayRouteTableRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateTransitGatewayRouteTableRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "CreateTransitGatewayRouteTable");
            ...
            return request;
                    ...
                    private static CreateTransitGatewayRouteTableRequestMarshaller _instance = new CreateTransitGatewayRouteTableRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTransitGatewayRouteTableRequestMarshaller Instance
        {
            get
            {
                return _instance;
