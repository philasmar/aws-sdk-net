...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociatedTargetNetworkUnmarshaller : IUnmarshaller<AssociatedTargetNetwork, XmlUnmarshallerContext>, IUnmarshaller<AssociatedTargetNetwork, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public AssociatedTargetNetwork Unmarshall(JsonUnmarshallerContext context)
        {
            return null;
        }
