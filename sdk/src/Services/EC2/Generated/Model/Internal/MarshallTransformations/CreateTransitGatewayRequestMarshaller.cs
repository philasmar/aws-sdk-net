...
{
    /// <summary>
    /// CreateTransitGateway Request Marshaller
    /// </summary>       
    public class CreateTransitGatewayRequestMarshaller : IMarshaller<IRequest, CreateTransitGatewayRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateTransitGatewayRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateTransitGatewayRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "CreateTransitGateway");
            ...
            return request;
                    ...
                    private static CreateTransitGatewayRequestMarshaller _instance = new CreateTransitGatewayRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTransitGatewayRequestMarshaller Instance
        {
            get
            {
                return _instance;
