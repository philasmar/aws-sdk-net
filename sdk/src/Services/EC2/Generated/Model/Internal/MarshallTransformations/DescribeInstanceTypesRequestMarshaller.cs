...
{
    /// <summary>
    /// DescribeInstanceTypes Request Marshaller
    /// </summary>       
    public class DescribeInstanceTypesRequestMarshaller : IMarshaller<IRequest, DescribeInstanceTypesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeInstanceTypesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeInstanceTypesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeInstanceTypes");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInstanceTypesRequestMarshaller Instance
        {
            get
            {
                return _instance;
