    ...
    public class CreateSpotDatafeedSubscriptionRequestMarshaller : IMarshaller<IRequest, CreateSpotDatafeedSubscriptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateSpotDatafeedSubscriptionRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static CreateSpotDatafeedSubscriptionRequestMarshaller _instance = new CreateSpotDatafeedSubscriptionRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSpotDatafeedSubscriptionRequestMarshaller Instance
        {
            get
            {
                return _instance;
