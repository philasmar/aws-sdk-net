...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeNatGatewaysRequestMarshaller : IMarshaller<IRequest, DescribeNatGatewaysRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeNatGatewaysRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeNatGatewaysRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeNatGateways");
            ...
            if(publicRequest != null)
            {
                ...
                if(publicRequest.IsSetNatGatewayIds())
                {
                    int publicRequestlistValueIndex = 1;
                    foreach(var publicRequestlistValue in publicRequest.NatGatewayIds)
                    {
                        request.Parameters.Add("NatGatewayId" + "." + publicRequestlistValueIndex, StringUtils.FromString(publicRequestlistValue));
                        publicRequestlistValueIndex++;
                    }
                }
