...
{
    /// <summary>
    /// Response Unmarshaller for LaunchTemplateSpotMarketOptions Object
    /// </summary>  
    public class LaunchTemplateSpotMarketOptionsUnmarshaller : IUnmarshaller<LaunchTemplateSpotMarketOptions, XmlUnmarshallerContext>, IUnmarshaller<LaunchTemplateSpotMarketOptions, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public LaunchTemplateSpotMarketOptions Unmarshall(XmlUnmarshallerContext context)
        {
            LaunchTemplateSpotMarketOptions unmarshalledObject = new LaunchTemplateSpotMarketOptions();
        ...
        private static LaunchTemplateSpotMarketOptionsUnmarshaller _instance = new LaunchTemplateSpotMarketOptionsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static LaunchTemplateSpotMarketOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
