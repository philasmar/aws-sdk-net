...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class LaunchTemplateHibernationOptionsUnmarshaller : IUnmarshaller<LaunchTemplateHibernationOptions, XmlUnmarshallerContext>, IUnmarshaller<LaunchTemplateHibernationOptions, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public LaunchTemplateHibernationOptions Unmarshall(XmlUnmarshallerContext context)
        {
            LaunchTemplateHibernationOptions unmarshalledObject = new LaunchTemplateHibernationOptions();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static LaunchTemplateHibernationOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
