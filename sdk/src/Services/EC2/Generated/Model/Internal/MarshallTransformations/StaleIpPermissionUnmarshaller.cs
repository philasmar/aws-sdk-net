...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class StaleIpPermissionUnmarshaller : IUnmarshaller<StaleIpPermission, XmlUnmarshallerContext>, IUnmarshaller<StaleIpPermission, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public StaleIpPermission Unmarshall(XmlUnmarshallerContext context)
        {
            StaleIpPermission unmarshalledObject = new StaleIpPermission();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StaleIpPermissionUnmarshaller Instance
        {
            get
            {
                return _instance;
