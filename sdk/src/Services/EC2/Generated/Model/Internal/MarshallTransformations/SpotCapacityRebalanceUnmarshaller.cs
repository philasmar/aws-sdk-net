...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SpotCapacityRebalanceUnmarshaller : IUnmarshaller<SpotCapacityRebalance, XmlUnmarshallerContext>, IUnmarshaller<SpotCapacityRebalance, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public SpotCapacityRebalance Unmarshall(JsonUnmarshallerContext context)
        {
            return null;
        }
