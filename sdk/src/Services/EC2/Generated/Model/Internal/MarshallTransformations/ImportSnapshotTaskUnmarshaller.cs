...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class ImportSnapshotTaskUnmarshaller : IUnmarshaller<ImportSnapshotTask, XmlUnmarshallerContext>, IUnmarshaller<ImportSnapshotTask, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ImportSnapshotTask Unmarshall(XmlUnmarshallerContext context)
        {
            ImportSnapshotTask unmarshalledObject = new ImportSnapshotTask();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("snapshotTaskDetail", targetDepth))
                    {
                        ...
                        unmarshalledObject.SnapshotTaskDetail = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportSnapshotTaskUnmarshaller Instance
        {
            get
            {
                return _instance;
