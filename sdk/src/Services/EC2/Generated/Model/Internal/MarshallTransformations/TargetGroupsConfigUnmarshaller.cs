...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class TargetGroupsConfigUnmarshaller : IUnmarshaller<TargetGroupsConfig, XmlUnmarshallerContext>, IUnmarshaller<TargetGroupsConfig, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public TargetGroupsConfig Unmarshall(XmlUnmarshallerContext context)
        {
            TargetGroupsConfig unmarshalledObject = new TargetGroupsConfig();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TargetGroupsConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
