    ...
    public class CancelReservedInstancesListingRequestMarshaller : IMarshaller<IRequest, CancelReservedInstancesListingRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CancelReservedInstancesListingRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static CancelReservedInstancesListingRequestMarshaller _instance = new CancelReservedInstancesListingRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelReservedInstancesListingRequestMarshaller Instance
        {
            get
            {
                return _instance;
