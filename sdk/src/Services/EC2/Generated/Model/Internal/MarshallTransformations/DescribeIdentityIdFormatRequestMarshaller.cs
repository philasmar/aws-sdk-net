...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeIdentityIdFormatRequestMarshaller : IMarshaller<IRequest, DescribeIdentityIdFormatRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeIdentityIdFormatRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeIdentityIdFormatRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeIdentityIdFormat");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeIdentityIdFormatRequestMarshaller Instance
        {
            get
            {
                return _instance;
