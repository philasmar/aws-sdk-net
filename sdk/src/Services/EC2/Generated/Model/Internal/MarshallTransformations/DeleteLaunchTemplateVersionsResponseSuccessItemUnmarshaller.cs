...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteLaunchTemplateVersionsResponseSuccessItemUnmarshaller : IUnmarshaller<DeleteLaunchTemplateVersionsResponseSuccessItem, XmlUnmarshallerContext>, IUnmarshaller<DeleteLaunchTemplateVersionsResponseSuccessItem, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public DeleteLaunchTemplateVersionsResponseSuccessItem Unmarshall(XmlUnmarshallerContext context)
        {
            DeleteLaunchTemplateVersionsResponseSuccessItem unmarshalledObject = new DeleteLaunchTemplateVersionsResponseSuccessItem();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLaunchTemplateVersionsResponseSuccessItemUnmarshaller Instance
        {
            get
            {
                return _instance;
