...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class AllowedPrincipalUnmarshaller : IUnmarshaller<AllowedPrincipal, XmlUnmarshallerContext>, IUnmarshaller<AllowedPrincipal, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public AllowedPrincipal Unmarshall(XmlUnmarshallerContext context)
        {
            AllowedPrincipal unmarshalledObject = new AllowedPrincipal();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AllowedPrincipalUnmarshaller Instance
        {
            get
            {
                return _instance;
