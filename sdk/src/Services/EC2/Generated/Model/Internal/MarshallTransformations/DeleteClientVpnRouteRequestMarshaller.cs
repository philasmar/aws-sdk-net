...
{
    /// <summary>
    /// DeleteClientVpnRoute Request Marshaller
    /// </summary>       
    public class DeleteClientVpnRouteRequestMarshaller : IMarshaller<IRequest, DeleteClientVpnRouteRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteClientVpnRouteRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteClientVpnRouteRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DeleteClientVpnRoute");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteClientVpnRouteRequestMarshaller Instance
        {
            get
            {
                return _instance;
