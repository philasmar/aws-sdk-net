...
{
    /// <summary>
    /// CreateNetworkInterfacePermission Request Marshaller
    /// </summary>       
    public class CreateNetworkInterfacePermissionRequestMarshaller : IMarshaller<IRequest, CreateNetworkInterfacePermissionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateNetworkInterfacePermissionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateNetworkInterfacePermissionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "CreateNetworkInterfacePermission");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateNetworkInterfacePermissionRequestMarshaller Instance
        {
            get
            {
                return _instance;
