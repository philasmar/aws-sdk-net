...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PricingDetailUnmarshaller : IUnmarshaller<PricingDetail, XmlUnmarshallerContext>, IUnmarshaller<PricingDetail, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        {
            PricingDetail unmarshalledObject = new PricingDetail();
        ...
        private static PricingDetailUnmarshaller _instance = new PricingDetailUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static PricingDetailUnmarshaller Instance
        {
            get
            {
                return _instance;
