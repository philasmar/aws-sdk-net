...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class VpcClassicLinkUnmarshaller : IUnmarshaller<VpcClassicLink, XmlUnmarshallerContext>, IUnmarshaller<VpcClassicLink, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public VpcClassicLink Unmarshall(XmlUnmarshallerContext context)
        {
            VpcClassicLink unmarshalledObject = new VpcClassicLink();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("classicLinkEnabled", targetDepth))
                    {
                        ...
                        unmarshalledObject.ClassicLinkEnabled = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VpcClassicLinkUnmarshaller Instance
        {
            get
            {
                return _instance;
