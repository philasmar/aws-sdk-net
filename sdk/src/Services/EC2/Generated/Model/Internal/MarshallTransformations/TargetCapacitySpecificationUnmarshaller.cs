...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TargetCapacitySpecificationUnmarshaller : IUnmarshaller<TargetCapacitySpecification, XmlUnmarshallerContext>, IUnmarshaller<TargetCapacitySpecification, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public TargetCapacitySpecification Unmarshall(JsonUnmarshallerContext context)
        {
            return null;
        }
