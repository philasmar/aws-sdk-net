...
{
    /// <summary>
    /// ExportImage Request Marshaller
    /// </summary>       
    public class ExportImageRequestMarshaller : IMarshaller<IRequest, ExportImageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ExportImageRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ExportImageRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "ExportImage");
            ...
            return request;
                    ...
                    private static ExportImageRequestMarshaller _instance = new ExportImageRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportImageRequestMarshaller Instance
        {
            get
            {
                return _instance;
