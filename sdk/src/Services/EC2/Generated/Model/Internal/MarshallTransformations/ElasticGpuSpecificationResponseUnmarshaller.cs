...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class ElasticGpuSpecificationResponseUnmarshaller : IUnmarshaller<ElasticGpuSpecificationResponse, XmlUnmarshallerContext>, IUnmarshaller<ElasticGpuSpecificationResponse, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ElasticGpuSpecificationResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ElasticGpuSpecificationResponse unmarshalledObject = new ElasticGpuSpecificationResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ElasticGpuSpecificationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
