...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class HibernationOptionsUnmarshaller : IUnmarshaller<HibernationOptions, XmlUnmarshallerContext>, IUnmarshaller<HibernationOptions, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public HibernationOptions Unmarshall(XmlUnmarshallerContext context)
        {
            HibernationOptions unmarshalledObject = new HibernationOptions();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static HibernationOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
