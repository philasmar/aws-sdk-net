...
{
    /// <summary>
    /// ModifyLaunchTemplate Request Marshaller
    /// </summary>       
    public class ModifyLaunchTemplateRequestMarshaller : IMarshaller<IRequest, ModifyLaunchTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyLaunchTemplateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyLaunchTemplateRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "ModifyLaunchTemplate");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyLaunchTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
