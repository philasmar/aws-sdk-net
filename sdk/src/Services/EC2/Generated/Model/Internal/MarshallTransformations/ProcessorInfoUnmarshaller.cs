...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class ProcessorInfoUnmarshaller : IUnmarshaller<ProcessorInfo, XmlUnmarshallerContext>, IUnmarshaller<ProcessorInfo, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ProcessorInfo Unmarshall(XmlUnmarshallerContext context)
        {
            ProcessorInfo unmarshalledObject = new ProcessorInfo();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ProcessorInfoUnmarshaller Instance
        {
            get
            {
                return _instance;
