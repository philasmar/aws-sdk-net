...
{
    /// <summary>
    /// GetCoipPoolUsage Request Marshaller
    /// </summary>       
    public class GetCoipPoolUsageRequestMarshaller : IMarshaller<IRequest, GetCoipPoolUsageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCoipPoolUsageRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCoipPoolUsageRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "GetCoipPoolUsage");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCoipPoolUsageRequestMarshaller Instance
        {
            get
            {
                return _instance;
