...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class GpuDeviceMemoryInfoUnmarshaller : IUnmarshaller<GpuDeviceMemoryInfo, XmlUnmarshallerContext>, IUnmarshaller<GpuDeviceMemoryInfo, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public GpuDeviceMemoryInfo Unmarshall(XmlUnmarshallerContext context)
        {
            GpuDeviceMemoryInfo unmarshalledObject = new GpuDeviceMemoryInfo();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GpuDeviceMemoryInfoUnmarshaller Instance
        {
            get
            {
                return _instance;
