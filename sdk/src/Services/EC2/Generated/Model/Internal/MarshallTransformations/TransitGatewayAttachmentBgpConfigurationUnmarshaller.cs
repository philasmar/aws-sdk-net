...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class TransitGatewayAttachmentBgpConfigurationUnmarshaller : IUnmarshaller<TransitGatewayAttachmentBgpConfiguration, XmlUnmarshallerContext>, IUnmarshaller<TransitGatewayAttachmentBgpConfiguration, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public TransitGatewayAttachmentBgpConfiguration Unmarshall(XmlUnmarshallerContext context)
        {
            TransitGatewayAttachmentBgpConfiguration unmarshalledObject = new TransitGatewayAttachmentBgpConfiguration();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = LongUnmarshaller.Instance;
                        unmarshalledObject.TransitGatewayAsn = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TransitGatewayAttachmentBgpConfigurationUnmarshaller Instance
        {
            get
            {
                return _instance;
