    ...
    public class CreateDhcpOptionsRequestMarshaller : IMarshaller<IRequest, CreateDhcpOptionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateDhcpOptionsRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static CreateDhcpOptionsRequestMarshaller _instance = new CreateDhcpOptionsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDhcpOptionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
