...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class SnapshotTaskDetailUnmarshaller : IUnmarshaller<SnapshotTaskDetail, XmlUnmarshallerContext>, IUnmarshaller<SnapshotTaskDetail, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public SnapshotTaskDetail Unmarshall(XmlUnmarshallerContext context)
        {
            SnapshotTaskDetail unmarshalledObject = new SnapshotTaskDetail();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SnapshotTaskDetailUnmarshaller Instance
        {
            get
            {
                return _instance;
