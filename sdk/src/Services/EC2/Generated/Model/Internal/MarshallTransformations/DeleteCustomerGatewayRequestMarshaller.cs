    ...
    public class DeleteCustomerGatewayRequestMarshaller : IMarshaller<IRequest, DeleteCustomerGatewayRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DeleteCustomerGatewayRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DeleteCustomerGatewayRequestMarshaller _instance = new DeleteCustomerGatewayRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCustomerGatewayRequestMarshaller Instance
        {
            get
            {
                return _instance;
