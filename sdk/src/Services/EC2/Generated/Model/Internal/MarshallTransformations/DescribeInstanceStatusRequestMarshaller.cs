...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeInstanceStatusRequestMarshaller : IMarshaller<IRequest, DescribeInstanceStatusRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeInstanceStatusRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeInstanceStatusRequest publicRequest)
        {
            ...
            if(publicRequest != null)
            {
                ...
                if(publicRequest.IsSetIncludeAllInstances())
                {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInstanceStatusRequestMarshaller Instance
        {
            get
            {
                return _instance;
