...
{
    /// <summary>
    /// RestoreManagedPrefixListVersion Request Marshaller
    /// </summary>       
    public class RestoreManagedPrefixListVersionRequestMarshaller : IMarshaller<IRequest, RestoreManagedPrefixListVersionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RestoreManagedPrefixListVersionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RestoreManagedPrefixListVersionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "RestoreManagedPrefixListVersion");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestoreManagedPrefixListVersionRequestMarshaller Instance
        {
            get
            {
                return _instance;
