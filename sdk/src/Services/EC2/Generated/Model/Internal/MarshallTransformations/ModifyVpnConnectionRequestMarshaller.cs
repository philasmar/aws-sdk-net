...
{
    /// <summary>
    /// ModifyVpnConnection Request Marshaller
    /// </summary>       
    public class ModifyVpnConnectionRequestMarshaller : IMarshaller<IRequest, ModifyVpnConnectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyVpnConnectionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyVpnConnectionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "ModifyVpnConnection");
            ...
            return request;
                    ...
                    private static ModifyVpnConnectionRequestMarshaller _instance = new ModifyVpnConnectionRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyVpnConnectionRequestMarshaller Instance
        {
            get
            {
                return _instance;
