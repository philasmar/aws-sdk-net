...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeVolumesModificationsRequestMarshaller : IMarshaller<IRequest, DescribeVolumesModificationsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeVolumesModificationsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeVolumesModificationsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeVolumesModifications");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeVolumesModificationsRequestMarshaller Instance
        {
            get
            {
                return _instance;
