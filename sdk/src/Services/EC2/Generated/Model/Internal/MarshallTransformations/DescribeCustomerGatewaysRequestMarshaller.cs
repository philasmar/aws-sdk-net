    ...
    public class DescribeCustomerGatewaysRequestMarshaller : IMarshaller<IRequest, DescribeCustomerGatewaysRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeCustomerGatewaysRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeCustomerGatewaysRequestMarshaller _instance = new DescribeCustomerGatewaysRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCustomerGatewaysRequestMarshaller Instance
        {
            get
            {
                return _instance;
