...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class ClientConnectResponseOptionsUnmarshaller : IUnmarshaller<ClientConnectResponseOptions, XmlUnmarshallerContext>, IUnmarshaller<ClientConnectResponseOptions, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ClientConnectResponseOptions Unmarshall(XmlUnmarshallerContext context)
        {
            ClientConnectResponseOptions unmarshalledObject = new ClientConnectResponseOptions();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = ClientVpnEndpointAttributeStatusUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ClientConnectResponseOptionsUnmarshaller Instance
        {
            get
            {
                return _instance;
