    ...
    public class AttachVpnGatewayRequestMarshaller : IMarshaller<IRequest, AttachVpnGatewayRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(AttachVpnGatewayRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static AttachVpnGatewayRequestMarshaller _instance = new AttachVpnGatewayRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AttachVpnGatewayRequestMarshaller Instance
        {
            get
            {
                return _instance;
