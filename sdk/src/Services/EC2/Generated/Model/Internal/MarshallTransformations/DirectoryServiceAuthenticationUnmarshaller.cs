...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class DirectoryServiceAuthenticationUnmarshaller : IUnmarshaller<DirectoryServiceAuthentication, XmlUnmarshallerContext>, IUnmarshaller<DirectoryServiceAuthentication, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public DirectoryServiceAuthentication Unmarshall(XmlUnmarshallerContext context)
        {
            DirectoryServiceAuthentication unmarshalledObject = new DirectoryServiceAuthentication();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DirectoryServiceAuthenticationUnmarshaller Instance
        {
            get
            {
                return _instance;
