...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartInstancesResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        /// <summary>
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("instancesSet/item", targetDepth))
                    {
                        ...
                        response.StartingInstances.Add(item);
                        continue;
                    }
                } 
            }
        ...
        private static StartInstancesResponseUnmarshaller _instance = new StartInstancesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartInstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
