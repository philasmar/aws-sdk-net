...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class TransitGatewayPrefixListReferenceUnmarshaller : IUnmarshaller<TransitGatewayPrefixListReference, XmlUnmarshallerContext>, IUnmarshaller<TransitGatewayPrefixListReference, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public TransitGatewayPrefixListReference Unmarshall(XmlUnmarshallerContext context)
        {
            TransitGatewayPrefixListReference unmarshalledObject = new TransitGatewayPrefixListReference();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("blackhole", targetDepth))
                    {
                        ...
                        unmarshalledObject.Blackhole = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.PrefixListOwnerId = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    ...
                    {
                        var unmarshaller = TransitGatewayPrefixListAttachmentUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TransitGatewayPrefixListReferenceUnmarshaller Instance
        {
            get
            {
                return _instance;
