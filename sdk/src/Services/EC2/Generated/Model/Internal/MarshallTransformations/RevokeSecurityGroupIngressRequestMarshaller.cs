    ...
    public class RevokeSecurityGroupIngressRequestMarshaller : IMarshaller<IRequest, RevokeSecurityGroupIngressRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(RevokeSecurityGroupIngressRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static RevokeSecurityGroupIngressRequestMarshaller _instance = new RevokeSecurityGroupIngressRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokeSecurityGroupIngressRequestMarshaller Instance
        {
            get
            {
                return _instance;
