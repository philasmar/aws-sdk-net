...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AssociateIamInstanceProfileRequestMarshaller : IMarshaller<IRequest, AssociateIamInstanceProfileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateIamInstanceProfileRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateIamInstanceProfileRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "AssociateIamInstanceProfile");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateIamInstanceProfileRequestMarshaller Instance
        {
            get
            {
                return _instance;
