...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class ManagedPrefixListUnmarshaller : IUnmarshaller<ManagedPrefixList, XmlUnmarshallerContext>, IUnmarshaller<ManagedPrefixList, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ManagedPrefixList Unmarshall(XmlUnmarshallerContext context)
        {
            ManagedPrefixList unmarshalledObject = new ManagedPrefixList();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("maxEntries", targetDepth))
                    {
                        ...
                        unmarshalledObject.MaxEntries = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ManagedPrefixListUnmarshaller Instance
        {
            get
            {
                return _instance;
