...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class AssociateSubnetCidrBlockRequestMarshaller : IMarshaller<IRequest, AssociateSubnetCidrBlockRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateSubnetCidrBlockRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateSubnetCidrBlockRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "AssociateSubnetCidrBlock");
