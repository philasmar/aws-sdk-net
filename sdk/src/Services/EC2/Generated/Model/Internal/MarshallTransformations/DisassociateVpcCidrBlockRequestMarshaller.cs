...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DisassociateVpcCidrBlockRequestMarshaller : IMarshaller<IRequest, DisassociateVpcCidrBlockRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateVpcCidrBlockRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateVpcCidrBlockRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DisassociateVpcCidrBlock");
