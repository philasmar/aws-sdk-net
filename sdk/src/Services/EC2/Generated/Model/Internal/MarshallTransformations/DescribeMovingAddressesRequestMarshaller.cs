...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeMovingAddressesRequestMarshaller : IMarshaller<IRequest, DescribeMovingAddressesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeMovingAddressesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeMovingAddressesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "DescribeMovingAddresses");
            ...
            return request;
                    ...
                    private static DescribeMovingAddressesRequestMarshaller _instance = new DescribeMovingAddressesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMovingAddressesRequestMarshaller Instance
        {
            get
            {
                return _instance;
