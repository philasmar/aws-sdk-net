...
{
    /// <summary>
    /// Response Unmarshaller for DeleteQueuedReservedInstances operation
    /// </summary>  
    public class DeleteQueuedReservedInstancesResponseUnmarshaller : EC2ResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteQueuedReservedInstancesResponse response = new DeleteQueuedReservedInstancesResponse();
        ...
        private static DeleteQueuedReservedInstancesResponseUnmarshaller _instance = new DeleteQueuedReservedInstancesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteQueuedReservedInstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
