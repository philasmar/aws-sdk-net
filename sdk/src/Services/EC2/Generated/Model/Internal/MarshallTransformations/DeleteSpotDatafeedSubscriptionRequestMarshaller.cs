...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteSpotDatafeedSubscriptionRequestMarshaller : IMarshaller<IRequest, DeleteSpotDatafeedSubscriptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteSpotDatafeedSubscriptionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteSpotDatafeedSubscriptionRequest publicRequest)
        {
