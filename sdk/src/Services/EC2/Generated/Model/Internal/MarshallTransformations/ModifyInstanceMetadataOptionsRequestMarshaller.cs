...
{
    /// <summary>
    /// ModifyInstanceMetadataOptions Request Marshaller
    /// </summary>       
    public class ModifyInstanceMetadataOptionsRequestMarshaller : IMarshaller<IRequest, ModifyInstanceMetadataOptionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyInstanceMetadataOptionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyInstanceMetadataOptionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "ModifyInstanceMetadataOptions");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyInstanceMetadataOptionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
