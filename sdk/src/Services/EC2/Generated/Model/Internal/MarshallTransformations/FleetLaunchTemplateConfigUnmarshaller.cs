...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class FleetLaunchTemplateConfigUnmarshaller : IUnmarshaller<FleetLaunchTemplateConfig, XmlUnmarshallerContext>, IUnmarshaller<FleetLaunchTemplateConfig, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public FleetLaunchTemplateConfig Unmarshall(XmlUnmarshallerContext context)
        {
            FleetLaunchTemplateConfig unmarshalledObject = new FleetLaunchTemplateConfig();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static FleetLaunchTemplateConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
