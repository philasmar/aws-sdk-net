...
{
    /// <summary>
    /// ExportTransitGatewayRoutes Request Marshaller
    /// </summary>       
    public class ExportTransitGatewayRoutesRequestMarshaller : IMarshaller<IRequest, ExportTransitGatewayRoutesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ExportTransitGatewayRoutesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ExportTransitGatewayRoutesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EC2");
            request.Parameters.Add("Action", "ExportTransitGatewayRoutes");
            ...
            return request;
                    ...
                    private static ExportTransitGatewayRoutesRequestMarshaller _instance = new ExportTransitGatewayRoutesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportTransitGatewayRoutesRequestMarshaller Instance
        {
            get
            {
                return _instance;
