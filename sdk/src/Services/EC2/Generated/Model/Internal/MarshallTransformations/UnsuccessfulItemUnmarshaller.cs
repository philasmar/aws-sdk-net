...
namespace Amazon.EC2.Model.Internal.MarshallTransformations
{
    ...
    public class UnsuccessfulItemUnmarshaller : IUnmarshaller<UnsuccessfulItem, XmlUnmarshallerContext>, IUnmarshaller<UnsuccessfulItem, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public UnsuccessfulItem Unmarshall(XmlUnmarshallerContext context)
        {
            UnsuccessfulItem unmarshalledObject = new UnsuccessfulItem();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = UnsuccessfulItemErrorUnmarshaller.Instance;
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UnsuccessfulItemUnmarshaller Instance
        {
            get
            {
                return _instance;
