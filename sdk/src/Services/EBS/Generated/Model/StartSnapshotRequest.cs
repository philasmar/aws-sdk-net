...
namespace Amazon.EBS.Model
{
    ...
    public partial class StartSnapshotRequest : AmazonEBSRequest
    {
        ...
        ///  
        /// <para>
        /// If you specify <code>true</code>, the snapshot is encrypted using the CMK specified
        /// using the <b>KmsKeyArn</b> parameter. If no value is specified for <b>KmsKeyArn</b>,
        /// the default CMK for your account is used. If no default CMK has been specified for
        /// your account, the AWS managed CMK is used. To set a default CMK for your account,
        /// use <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_ModifyEbsDefaultKmsKeyId.html">
        ...
        /// master key (CMK) to be used to encrypt the snapshot. If you do not specify a CMK,
        /// the default AWS managed CMK is used.
        /// </para>
        ///  
        /// <para>
        /// If you specify a <b>ParentSnapshotId</b>, omit this parameter; the snapshot will be
        /// encrypted using the same CMK that was used to encrypt the parent snapshot.
        /// </para>
        ///  
        /// <para>
