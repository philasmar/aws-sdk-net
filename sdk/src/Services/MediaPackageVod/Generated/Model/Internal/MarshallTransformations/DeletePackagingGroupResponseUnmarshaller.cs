...
{
    /// <summary>
    /// Response Unmarshaller for DeletePackagingGroup operation
    /// </summary>  
    public class DeletePackagingGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeletePackagingGroupResponse response = new DeletePackagingGroupResponse();
        ...
        private static DeletePackagingGroupResponseUnmarshaller _instance = new DeletePackagingGroupResponseUnmarshaller();        

        internal static DeletePackagingGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePackagingGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
