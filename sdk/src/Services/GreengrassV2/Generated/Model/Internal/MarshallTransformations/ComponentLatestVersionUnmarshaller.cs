...
namespace Amazon.GreengrassV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ComponentLatestVersionUnmarshaller : IUnmarshaller<ComponentLatestVersion, XmlUnmarshallerContext>, IUnmarshaller<ComponentLatestVersion, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ComponentLatestVersion IUnmarshaller<ComponentLatestVersion, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ComponentLatestVersion Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
