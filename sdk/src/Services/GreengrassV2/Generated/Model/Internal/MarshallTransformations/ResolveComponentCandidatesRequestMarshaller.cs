...
namespace Amazon.GreengrassV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ResolveComponentCandidatesRequestMarshaller : IMarshaller<IRequest, ResolveComponentCandidatesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ResolveComponentCandidatesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ResolveComponentCandidatesRequest publicRequest)
        {
        ...
        private static ResolveComponentCandidatesRequestMarshaller _instance = new ResolveComponentCandidatesRequestMarshaller();        

        internal static ResolveComponentCandidatesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResolveComponentCandidatesRequestMarshaller Instance
        {
            get
            {
                return _instance;
