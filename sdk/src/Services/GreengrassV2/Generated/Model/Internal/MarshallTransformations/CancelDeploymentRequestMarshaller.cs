...
namespace Amazon.GreengrassV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CancelDeploymentRequestMarshaller : IMarshaller<IRequest, CancelDeploymentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CancelDeploymentRequestMarshaller _instance = new CancelDeploymentRequestMarshaller();        

        internal static CancelDeploymentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelDeploymentRequestMarshaller Instance
        {
            get
            {
                return _instance;
