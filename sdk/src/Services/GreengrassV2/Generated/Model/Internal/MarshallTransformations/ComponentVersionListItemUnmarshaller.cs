...
namespace Amazon.GreengrassV2.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ComponentVersionListItemUnmarshaller : IUnmarshaller<ComponentVersionListItem, XmlUnmarshallerContext>, IUnmarshaller<ComponentVersionListItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ComponentVersionListItem IUnmarshaller<ComponentVersionListItem, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static ComponentVersionListItemUnmarshaller _instance = new ComponentVersionListItemUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ComponentVersionListItemUnmarshaller Instance
        {
            get
            {
                return _instance;
