...
{
    /// <summary>
    /// Response Unmarshaller for UpdateConfigurationSetReputationMetricsEnabled operation
    /// </summary>  
    public class UpdateConfigurationSetReputationMetricsEnabledResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateConfigurationSetReputationMetricsEnabledResponse response = new UpdateConfigurationSetReputationMetricsEnabledResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateConfigurationSetReputationMetricsEnabledResult", 2))
                    {
        ...
        private static UpdateConfigurationSetReputationMetricsEnabledResponseUnmarshaller _instance = new UpdateConfigurationSetReputationMetricsEnabledResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConfigurationSetReputationMetricsEnabledResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
