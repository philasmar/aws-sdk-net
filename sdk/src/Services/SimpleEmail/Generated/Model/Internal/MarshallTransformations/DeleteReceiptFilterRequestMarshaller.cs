...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteReceiptFilterRequestMarshaller : IMarshaller<IRequest, DeleteReceiptFilterRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteReceiptFilterRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteReceiptFilterRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteReceiptFilterRequestMarshaller Instance
        {
            get
            {
                return _instance;
