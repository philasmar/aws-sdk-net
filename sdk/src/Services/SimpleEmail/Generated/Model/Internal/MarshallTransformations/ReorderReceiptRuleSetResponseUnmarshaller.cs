...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReorderReceiptRuleSetResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ReorderReceiptRuleSetResponse response = new ReorderReceiptRuleSetResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ReorderReceiptRuleSetResult", 2))
                    {
        ...
        private static ReorderReceiptRuleSetResponseUnmarshaller _instance = new ReorderReceiptRuleSetResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReorderReceiptRuleSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
