...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SendBounceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendBounceResponse response = new SendBounceResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("SendBounceResult", 2))
                    {
        ...
        private static SendBounceResponseUnmarshaller _instance = new SendBounceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendBounceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
