...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    public class TrackingOptionsDoesNotExistExceptionUnmarshaller : IErrorResponseUnmarshaller<TrackingOptionsDoesNotExistException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public TrackingOptionsDoesNotExistException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static TrackingOptionsDoesNotExistExceptionUnmarshaller _instance = new TrackingOptionsDoesNotExistExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TrackingOptionsDoesNotExistExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
