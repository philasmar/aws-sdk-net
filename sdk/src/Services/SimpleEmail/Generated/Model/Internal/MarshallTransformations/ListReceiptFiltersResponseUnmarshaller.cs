...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListReceiptFiltersResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListReceiptFiltersResponse response = new ListReceiptFiltersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ListReceiptFiltersResult", 2))
                    {
        ...
        private static ListReceiptFiltersResponseUnmarshaller _instance = new ListReceiptFiltersResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListReceiptFiltersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
