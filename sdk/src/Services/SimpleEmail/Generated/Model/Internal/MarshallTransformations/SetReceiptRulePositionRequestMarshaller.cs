...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class SetReceiptRulePositionRequestMarshaller : IMarshaller<IRequest, SetReceiptRulePositionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SetReceiptRulePositionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SetReceiptRulePositionRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetReceiptRulePositionRequestMarshaller Instance
        {
            get
            {
                return _instance;
