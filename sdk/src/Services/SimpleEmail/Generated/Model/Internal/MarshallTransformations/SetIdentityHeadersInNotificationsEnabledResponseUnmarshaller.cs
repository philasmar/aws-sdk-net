...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SetIdentityHeadersInNotificationsEnabledResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetIdentityHeadersInNotificationsEnabledResponse response = new SetIdentityHeadersInNotificationsEnabledResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("SetIdentityHeadersInNotificationsEnabledResult", 2))
                    {
        ...
        private static SetIdentityHeadersInNotificationsEnabledResponseUnmarshaller _instance = new SetIdentityHeadersInNotificationsEnabledResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetIdentityHeadersInNotificationsEnabledResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
