    ...
    public class VerifyDomainDkimRequestMarshaller : IMarshaller<IRequest, VerifyDomainDkimRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(VerifyDomainDkimRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static VerifyDomainDkimRequestMarshaller _instance = new VerifyDomainDkimRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static VerifyDomainDkimRequestMarshaller Instance
        {
            get
            {
                return _instance;
