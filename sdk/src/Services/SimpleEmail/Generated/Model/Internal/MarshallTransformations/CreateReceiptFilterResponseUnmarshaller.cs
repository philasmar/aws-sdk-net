...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateReceiptFilterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateReceiptFilterResponse response = new CreateReceiptFilterResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateReceiptFilterResult", 2))
                    {
        ...
        private static CreateReceiptFilterResponseUnmarshaller _instance = new CreateReceiptFilterResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateReceiptFilterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
