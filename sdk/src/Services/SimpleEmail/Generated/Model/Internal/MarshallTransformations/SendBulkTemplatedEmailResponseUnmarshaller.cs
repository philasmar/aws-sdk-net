...
{
    /// <summary>
    /// Response Unmarshaller for SendBulkTemplatedEmail operation
    /// </summary>  
    public class SendBulkTemplatedEmailResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return AccountSendingPausedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                {
                    return ConfigurationSetSendingPausedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static SendBulkTemplatedEmailResponseUnmarshaller _instance = new SendBulkTemplatedEmailResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendBulkTemplatedEmailResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
