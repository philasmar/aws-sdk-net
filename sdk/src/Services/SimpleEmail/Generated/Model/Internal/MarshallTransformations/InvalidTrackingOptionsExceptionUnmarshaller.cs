...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    public class InvalidTrackingOptionsExceptionUnmarshaller : IErrorResponseUnmarshaller<InvalidTrackingOptionsException, XmlUnmarshallerContext>
    {
        ...
        private static InvalidTrackingOptionsExceptionUnmarshaller _instance = new InvalidTrackingOptionsExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InvalidTrackingOptionsExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
