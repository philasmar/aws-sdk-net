...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateReceiptRuleResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateReceiptRuleResponse response = new UpdateReceiptRuleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateReceiptRuleResult", 2))
                    {
        ...
        private static UpdateReceiptRuleResponseUnmarshaller _instance = new UpdateReceiptRuleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateReceiptRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
