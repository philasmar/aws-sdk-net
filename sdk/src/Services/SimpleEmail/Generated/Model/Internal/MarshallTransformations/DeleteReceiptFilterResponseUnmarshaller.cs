...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteReceiptFilterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteReceiptFilterResponse response = new DeleteReceiptFilterResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteReceiptFilterResult", 2))
                    {
        ...
        private static DeleteReceiptFilterResponseUnmarshaller _instance = new DeleteReceiptFilterResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteReceiptFilterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
