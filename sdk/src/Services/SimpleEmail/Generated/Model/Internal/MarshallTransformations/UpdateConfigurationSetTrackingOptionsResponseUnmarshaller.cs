...
{
    /// <summary>
    /// Response Unmarshaller for UpdateConfigurationSetTrackingOptions operation
    /// </summary>  
    public class UpdateConfigurationSetTrackingOptionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateConfigurationSetTrackingOptionsResponse response = new UpdateConfigurationSetTrackingOptionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("UpdateConfigurationSetTrackingOptionsResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("TrackingOptionsDoesNotExistException"))
                {
                    return TrackingOptionsDoesNotExistExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static UpdateConfigurationSetTrackingOptionsResponseUnmarshaller _instance = new UpdateConfigurationSetTrackingOptionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConfigurationSetTrackingOptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
