...
namespace Amazon.SimpleEmail.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeReceiptRuleResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeReceiptRuleResponse response = new DescribeReceiptRuleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeReceiptRuleResult", 2))
                    {
        ...
        private static DescribeReceiptRuleResponseUnmarshaller _instance = new DescribeReceiptRuleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeReceiptRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
