...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateJobQueueResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateJobQueueResponse response = new CreateJobQueueResponse();
        ...
        private static CreateJobQueueResponseUnmarshaller _instance = new CreateJobQueueResponseUnmarshaller();        

        internal static CreateJobQueueResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateJobQueueResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
