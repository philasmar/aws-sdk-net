...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteJobQueueRequestMarshaller : IMarshaller<IRequest, DeleteJobQueueRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteJobQueueRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteJobQueueRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/deletejobqueue";
