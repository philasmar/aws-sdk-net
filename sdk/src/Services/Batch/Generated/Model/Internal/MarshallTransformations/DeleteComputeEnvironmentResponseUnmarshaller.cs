...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteComputeEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteComputeEnvironmentResponse response = new DeleteComputeEnvironmentResponse();
        ...
        private static DeleteComputeEnvironmentResponseUnmarshaller _instance = new DeleteComputeEnvironmentResponseUnmarshaller();        

        internal static DeleteComputeEnvironmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteComputeEnvironmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
