...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RegisterJobDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterJobDefinitionResponse response = new RegisterJobDefinitionResponse();
        ...
        internal static RegisterJobDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterJobDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
