...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateComputeEnvironmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateComputeEnvironmentResponse response = new CreateComputeEnvironmentResponse();
        ...
        private static CreateComputeEnvironmentResponseUnmarshaller _instance = new CreateComputeEnvironmentResponseUnmarshaller();        

        internal static CreateComputeEnvironmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateComputeEnvironmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
