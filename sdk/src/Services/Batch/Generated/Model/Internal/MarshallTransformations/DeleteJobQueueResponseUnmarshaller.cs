...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteJobQueueResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteJobQueueResponse response = new DeleteJobQueueResponse();
        ...
        internal static DeleteJobQueueResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteJobQueueResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
