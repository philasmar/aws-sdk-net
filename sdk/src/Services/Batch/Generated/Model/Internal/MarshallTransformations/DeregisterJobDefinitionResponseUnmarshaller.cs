...
namespace Amazon.Batch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeregisterJobDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterJobDefinitionResponse response = new DeregisterJobDefinitionResponse();
        ...
        private static DeregisterJobDefinitionResponseUnmarshaller _instance = new DeregisterJobDefinitionResponseUnmarshaller();        

        internal static DeregisterJobDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterJobDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
