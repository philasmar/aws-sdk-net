...
{
    /// <summary>
    /// CreateMultiplex Request Marshaller
    /// </summary>       
    public class CreateMultiplexRequestMarshaller : IMarshaller<IRequest, CreateMultiplexRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateMultiplexRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateMultiplexRequest publicRequest)
        {
        ...
        private static CreateMultiplexRequestMarshaller _instance = new CreateMultiplexRequestMarshaller();        

        internal static CreateMultiplexRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMultiplexRequestMarshaller Instance
        {
            get
            {
                return _instance;
