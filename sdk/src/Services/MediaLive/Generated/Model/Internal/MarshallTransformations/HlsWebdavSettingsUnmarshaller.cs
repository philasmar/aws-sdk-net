...
{
    /// <summary>
    /// Response Unmarshaller for HlsWebdavSettings Object
    /// </summary>  
    public class HlsWebdavSettingsUnmarshaller : IUnmarshaller<HlsWebdavSettings, XmlUnmarshallerContext>, IUnmarshaller<HlsWebdavSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        HlsWebdavSettings IUnmarshaller<HlsWebdavSettings, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public HlsWebdavSettings Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            HlsWebdavSettings unmarshalledObject = new HlsWebdavSettings();
        ...
        private static HlsWebdavSettingsUnmarshaller _instance = new HlsWebdavSettingsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HlsWebdavSettingsUnmarshaller Instance
        {
            get
            {
                return _instance;
