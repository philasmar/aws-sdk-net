...
{
    /// <summary>
    /// DeleteInputSecurityGroup Request Marshaller
    /// </summary>       
    public class DeleteInputSecurityGroupRequestMarshaller : IMarshaller<IRequest, DeleteInputSecurityGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteInputSecurityGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteInputSecurityGroupRequest publicRequest)
        {
