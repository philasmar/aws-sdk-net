...
{
    /// <summary>
    /// Response Unmarshaller for DescribeMultiplexProgram operation
    /// </summary>  
    public class DescribeMultiplexProgramResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeMultiplexProgramResponse response = new DescribeMultiplexProgramResponse();
        ...
        private static DescribeMultiplexProgramResponseUnmarshaller _instance = new DescribeMultiplexProgramResponseUnmarshaller();        

        internal static DescribeMultiplexProgramResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMultiplexProgramResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
