...
{
    /// <summary>
    /// Response Unmarshaller for CreateMultiplexProgram operation
    /// </summary>  
    public class CreateMultiplexProgramResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMultiplexProgramResponse response = new CreateMultiplexProgramResponse();
        ...
        private static CreateMultiplexProgramResponseUnmarshaller _instance = new CreateMultiplexProgramResponseUnmarshaller();        

        internal static CreateMultiplexProgramResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMultiplexProgramResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
