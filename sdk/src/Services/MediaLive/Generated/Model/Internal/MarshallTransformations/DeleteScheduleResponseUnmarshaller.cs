...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSchedule operation
    /// </summary>  
    public class DeleteScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteScheduleResponseUnmarshaller _instance = new DeleteScheduleResponseUnmarshaller();        

        internal static DeleteScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
