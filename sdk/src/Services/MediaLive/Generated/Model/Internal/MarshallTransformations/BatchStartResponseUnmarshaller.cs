...
{
    /// <summary>
    /// Response Unmarshaller for BatchStart operation
    /// </summary>  
    public class BatchStartResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static BatchStartResponseUnmarshaller _instance = new BatchStartResponseUnmarshaller();        

        internal static BatchStartResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchStartResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
