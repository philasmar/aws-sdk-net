...
{
    /// <summary>
    /// Response Unmarshaller for CreateMultiplex operation
    /// </summary>  
    public class CreateMultiplexResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMultiplexResponse response = new CreateMultiplexResponse();
        ...
        private static CreateMultiplexResponseUnmarshaller _instance = new CreateMultiplexResponseUnmarshaller();        

        internal static CreateMultiplexResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMultiplexResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
