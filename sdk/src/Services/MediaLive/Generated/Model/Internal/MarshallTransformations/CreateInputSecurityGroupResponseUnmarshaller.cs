...
{
    /// <summary>
    /// Response Unmarshaller for CreateInputSecurityGroup operation
    /// </summary>  
    public class CreateInputSecurityGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInputSecurityGroupResponse response = new CreateInputSecurityGroupResponse();
        ...
        private static CreateInputSecurityGroupResponseUnmarshaller _instance = new CreateInputSecurityGroupResponseUnmarshaller();        

        internal static CreateInputSecurityGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInputSecurityGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
