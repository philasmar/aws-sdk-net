...
{
    /// <summary>
    /// Response Unmarshaller for StartMultiplex operation
    /// </summary>  
    public class StartMultiplexResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartMultiplexResponse response = new StartMultiplexResponse();
        ...
        private static StartMultiplexResponseUnmarshaller _instance = new StartMultiplexResponseUnmarshaller();        

        internal static StartMultiplexResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMultiplexResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
