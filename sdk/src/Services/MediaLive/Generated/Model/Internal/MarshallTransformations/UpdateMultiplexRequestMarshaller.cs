...
{
    /// <summary>
    /// UpdateMultiplex Request Marshaller
    /// </summary>       
    public class UpdateMultiplexRequestMarshaller : IMarshaller<IRequest, UpdateMultiplexRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateMultiplexRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateMultiplexRequest publicRequest)
        {
        ...
        private static UpdateMultiplexRequestMarshaller _instance = new UpdateMultiplexRequestMarshaller();        

        internal static UpdateMultiplexRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMultiplexRequestMarshaller Instance
        {
            get
            {
                return _instance;
