...
{
    /// <summary>
    /// Response Unmarshaller for DeleteInputSecurityGroup operation
    /// </summary>  
    public class DeleteInputSecurityGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteInputSecurityGroupResponse response = new DeleteInputSecurityGroupResponse();
        ...
        private static DeleteInputSecurityGroupResponseUnmarshaller _instance = new DeleteInputSecurityGroupResponseUnmarshaller();        

        internal static DeleteInputSecurityGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteInputSecurityGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
