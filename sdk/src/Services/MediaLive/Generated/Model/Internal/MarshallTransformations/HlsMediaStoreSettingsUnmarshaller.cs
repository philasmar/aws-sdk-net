...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    public class HlsMediaStoreSettingsUnmarshaller : IUnmarshaller<HlsMediaStoreSettings, XmlUnmarshallerContext>, IUnmarshaller<HlsMediaStoreSettings, JsonUnmarshallerContext>
    {
        ...
        private static HlsMediaStoreSettingsUnmarshaller _instance = new HlsMediaStoreSettingsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static HlsMediaStoreSettingsUnmarshaller Instance
        {
            get
            {
                return _instance;
