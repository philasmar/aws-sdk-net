...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    public class VideoSelectorSettingsUnmarshaller : IUnmarshaller<VideoSelectorSettings, XmlUnmarshallerContext>, IUnmarshaller<VideoSelectorSettings, JsonUnmarshallerContext>
    {
        ...
        private static VideoSelectorSettingsUnmarshaller _instance = new VideoSelectorSettingsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static VideoSelectorSettingsUnmarshaller Instance
        {
            get
            {
                return _instance;
