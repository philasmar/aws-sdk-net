...
{
    /// <summary>
    /// Response Unmarshaller for RejectInputDeviceTransfer operation
    /// </summary>  
    public class RejectInputDeviceTransferResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RejectInputDeviceTransferResponse response = new RejectInputDeviceTransferResponse();
        ...
        private static RejectInputDeviceTransferResponseUnmarshaller _instance = new RejectInputDeviceTransferResponseUnmarshaller();        

        internal static RejectInputDeviceTransferResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RejectInputDeviceTransferResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
