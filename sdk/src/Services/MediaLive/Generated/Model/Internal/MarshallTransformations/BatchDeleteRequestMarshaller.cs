...
{
    /// <summary>
    /// BatchDelete Request Marshaller
    /// </summary>       
    public class BatchDeleteRequestMarshaller : IMarshaller<IRequest, BatchDeleteRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchDeleteRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchDeleteRequest publicRequest)
        {
        ...
        private static BatchDeleteRequestMarshaller _instance = new BatchDeleteRequestMarshaller();        

        internal static BatchDeleteRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteRequestMarshaller Instance
        {
            get
            {
                return _instance;
