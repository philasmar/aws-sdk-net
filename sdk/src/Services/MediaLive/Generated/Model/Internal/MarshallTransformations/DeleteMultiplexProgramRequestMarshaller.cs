...
{
    /// <summary>
    /// DeleteMultiplexProgram Request Marshaller
    /// </summary>       
    public class DeleteMultiplexProgramRequestMarshaller : IMarshaller<IRequest, DeleteMultiplexProgramRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteMultiplexProgramRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteMultiplexProgramRequest publicRequest)
        {
        ...
        private static DeleteMultiplexProgramRequestMarshaller _instance = new DeleteMultiplexProgramRequestMarshaller();        

        internal static DeleteMultiplexProgramRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMultiplexProgramRequestMarshaller Instance
        {
            get
            {
                return _instance;
