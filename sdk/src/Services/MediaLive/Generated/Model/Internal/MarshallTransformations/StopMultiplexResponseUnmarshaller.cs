...
{
    /// <summary>
    /// Response Unmarshaller for StopMultiplex operation
    /// </summary>  
    public class StopMultiplexResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopMultiplexResponse response = new StopMultiplexResponse();
        ...
        private static StopMultiplexResponseUnmarshaller _instance = new StopMultiplexResponseUnmarshaller();        

        internal static StopMultiplexResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopMultiplexResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
