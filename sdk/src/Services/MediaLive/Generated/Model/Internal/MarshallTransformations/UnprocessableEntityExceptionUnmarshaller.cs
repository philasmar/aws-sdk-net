...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    public class UnprocessableEntityExceptionUnmarshaller : IErrorResponseUnmarshaller<UnprocessableEntityException, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public UnprocessableEntityException Unmarshall(JsonUnmarshallerContext context, ErrorResponse errorResponse)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("validationErrors", targetDepth))
                {
                    ...
                    unmarshalledObject.ValidationErrors = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
