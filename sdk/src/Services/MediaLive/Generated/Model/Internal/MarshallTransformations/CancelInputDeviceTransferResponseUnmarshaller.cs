...
{
    /// <summary>
    /// Response Unmarshaller for CancelInputDeviceTransfer operation
    /// </summary>  
    public class CancelInputDeviceTransferResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelInputDeviceTransferResponse response = new CancelInputDeviceTransferResponse();
        ...
        private static CancelInputDeviceTransferResponseUnmarshaller _instance = new CancelInputDeviceTransferResponseUnmarshaller();        

        internal static CancelInputDeviceTransferResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelInputDeviceTransferResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
