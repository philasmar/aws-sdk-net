...
{
    /// <summary>
    /// Response Unmarshaller for BatchUpdateSchedule operation
    /// </summary>  
    public class BatchUpdateScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchUpdateScheduleResponse response = new BatchUpdateScheduleResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("creates", targetDepth))
                {
                    ...
                    response.Creates = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static BatchUpdateScheduleResponseUnmarshaller _instance = new BatchUpdateScheduleResponseUnmarshaller();        

        internal static BatchUpdateScheduleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchUpdateScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
