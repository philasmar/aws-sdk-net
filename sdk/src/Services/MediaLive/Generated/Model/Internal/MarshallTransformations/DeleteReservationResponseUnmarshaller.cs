...
{
    /// <summary>
    /// Response Unmarshaller for DeleteReservation operation
    /// </summary>  
    public class DeleteReservationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteReservationResponseUnmarshaller _instance = new DeleteReservationResponseUnmarshaller();        

        internal static DeleteReservationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteReservationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
