...
{
    /// <summary>
    /// TransferInputDevice Request Marshaller
    /// </summary>       
    public class TransferInputDeviceRequestMarshaller : IMarshaller<IRequest, TransferInputDeviceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((TransferInputDeviceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(TransferInputDeviceRequest publicRequest)
        {
        ...
        private static TransferInputDeviceRequestMarshaller _instance = new TransferInputDeviceRequestMarshaller();        

        internal static TransferInputDeviceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TransferInputDeviceRequestMarshaller Instance
        {
            get
            {
                return _instance;
