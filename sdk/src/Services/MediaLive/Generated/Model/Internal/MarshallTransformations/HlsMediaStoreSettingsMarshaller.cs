...
{
    /// <summary>
    /// HlsMediaStoreSettings Marshaller
    /// </summary>       
    public class HlsMediaStoreSettingsMarshaller : IRequestMarshaller<HlsMediaStoreSettings, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(HlsMediaStoreSettings requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetMediaStoreStorageClass())
            {
                context.Writer.WritePropertyName("mediaStoreStorageClass");
                context.Writer.Write(requestObject.MediaStoreStorageClass);
            }
        ...
        /// </summary>  
        public readonly static HlsMediaStoreSettingsMarshaller Instance = new HlsMediaStoreSettingsMarshaller();
