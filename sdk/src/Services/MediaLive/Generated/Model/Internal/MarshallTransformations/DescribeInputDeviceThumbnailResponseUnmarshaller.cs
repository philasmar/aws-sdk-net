...
{
    /// <summary>
    /// Response Unmarshaller for DescribeInputDeviceThumbnail operation
    /// </summary>  
    public class DescribeInputDeviceThumbnailResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeInputDeviceThumbnailResponse response = new DescribeInputDeviceThumbnailResponse();
        ...
        private static DescribeInputDeviceThumbnailResponseUnmarshaller _instance = new DescribeInputDeviceThumbnailResponseUnmarshaller();        

        internal static DescribeInputDeviceThumbnailResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeInputDeviceThumbnailResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
