...
{
    /// <summary>
    /// Response Unmarshaller for BatchDelete operation
    /// </summary>  
    public class BatchDeleteResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static BatchDeleteResponseUnmarshaller _instance = new BatchDeleteResponseUnmarshaller();        

        internal static BatchDeleteResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
