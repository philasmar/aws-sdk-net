...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMultiplexProgram operation
    /// </summary>  
    public class UpdateMultiplexProgramResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMultiplexProgramResponse response = new UpdateMultiplexProgramResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("multiplexProgram", targetDepth))
                {
                    ...
                    response.MultiplexProgram = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static UpdateMultiplexProgramResponseUnmarshaller _instance = new UpdateMultiplexProgramResponseUnmarshaller();        

        internal static UpdateMultiplexProgramResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMultiplexProgramResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
