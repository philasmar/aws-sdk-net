...
namespace Amazon.MediaLive.Model.Internal.MarshallTransformations
{
    ...
    public class MultiplexProgramPipelineDetailUnmarshaller : IUnmarshaller<MultiplexProgramPipelineDetail, XmlUnmarshallerContext>, IUnmarshaller<MultiplexProgramPipelineDetail, JsonUnmarshallerContext>
    {
        ...
        private static MultiplexProgramPipelineDetailUnmarshaller _instance = new MultiplexProgramPipelineDetailUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static MultiplexProgramPipelineDetailUnmarshaller Instance
        {
            get
            {
                return _instance;
