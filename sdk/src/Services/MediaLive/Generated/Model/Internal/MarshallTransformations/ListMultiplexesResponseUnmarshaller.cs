...
{
    /// <summary>
    /// Response Unmarshaller for ListMultiplexes operation
    /// </summary>  
    public class ListMultiplexesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMultiplexesResponse response = new ListMultiplexesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<MultiplexSummary, MultiplexSummaryUnmarshaller>(MultiplexSummaryUnmarshaller.Instance);
                    response.Multiplexes = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListMultiplexesResponseUnmarshaller _instance = new ListMultiplexesResponseUnmarshaller();        

        internal static ListMultiplexesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMultiplexesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
