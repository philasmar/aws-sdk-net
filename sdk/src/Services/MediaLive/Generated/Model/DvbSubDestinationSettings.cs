...
namespace Amazon.MediaLive.Model
{
    ...
    {
        private DvbSubDestinationAlignment _alignment;
        private DvbSubDestinationBackgroundColor _backgroundColor;
        private int? _backgroundOpacity;
        private InputLocation _font;
        private DvbSubDestinationFontColor _fontColor;
        private int? _fontOpacity;
        private int? _fontResolution;
        private string _fontSize;
        private DvbSubDestinationOutlineColor _outlineColor;
        private int? _outlineSize;
        private DvbSubDestinationShadowColor _shadowColor;
        ...
        /// pre-recorded subtitles.  This option is not valid for source captions that are STL
        /// or 608/embedded.  These source settings are already pre-defined by the caption stream.
