...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchAssociateScramSecretResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchAssociateScramSecretResponse response = new BatchAssociateScramSecretResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchAssociateScramSecretResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
