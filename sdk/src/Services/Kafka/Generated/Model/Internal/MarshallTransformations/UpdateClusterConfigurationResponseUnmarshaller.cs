...
namespace Amazon.Kafka.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateClusterConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateClusterConfigurationResponse response = new UpdateClusterConfigurationResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateClusterConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
