...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBrokerStorage operation
    /// </summary>  
    public class UpdateBrokerStorageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBrokerStorageResponse response = new UpdateBrokerStorageResponse();
        ...
        private static UpdateBrokerStorageResponseUnmarshaller _instance = new UpdateBrokerStorageResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBrokerStorageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
