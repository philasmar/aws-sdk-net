...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMonitoring operation
    /// </summary>  
    public class UpdateMonitoringResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMonitoringResponse response = new UpdateMonitoringResponse();
        ...
        private static UpdateMonitoringResponseUnmarshaller _instance = new UpdateMonitoringResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMonitoringResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
