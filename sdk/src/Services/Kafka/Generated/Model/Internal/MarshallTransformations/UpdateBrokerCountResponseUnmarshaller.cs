...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBrokerCount operation
    /// </summary>  
    public class UpdateBrokerCountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBrokerCountResponse response = new UpdateBrokerCountResponse();
        ...
        private static UpdateBrokerCountResponseUnmarshaller _instance = new UpdateBrokerCountResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBrokerCountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
