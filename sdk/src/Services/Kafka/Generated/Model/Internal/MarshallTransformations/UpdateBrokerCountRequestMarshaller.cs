...
{
    /// <summary>
    /// UpdateBrokerCount Request Marshaller
    /// </summary>       
    public class UpdateBrokerCountRequestMarshaller : IMarshaller<IRequest, UpdateBrokerCountRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateBrokerCountRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateBrokerCountRequest publicRequest)
        {
        ...
        private static UpdateBrokerCountRequestMarshaller _instance = new UpdateBrokerCountRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBrokerCountRequestMarshaller Instance
        {
            get
            {
                return _instance;
