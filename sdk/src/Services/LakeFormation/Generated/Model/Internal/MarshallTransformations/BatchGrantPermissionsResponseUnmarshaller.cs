...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchGrantPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchGrantPermissionsResponse response = new BatchGrantPermissionsResponse();
        ...
        private static BatchGrantPermissionsResponseUnmarshaller _instance = new BatchGrantPermissionsResponseUnmarshaller();        

        internal static BatchGrantPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchGrantPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
