...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class BatchRevokePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchRevokePermissionsResponse response = new BatchRevokePermissionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BatchPermissionsFailureEntry, BatchPermissionsFailureEntryUnmarshaller>(BatchPermissionsFailureEntryUnmarshaller.Instance);
        ...
        private static BatchRevokePermissionsResponseUnmarshaller _instance = new BatchRevokePermissionsResponseUnmarshaller();        

        internal static BatchRevokePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchRevokePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
