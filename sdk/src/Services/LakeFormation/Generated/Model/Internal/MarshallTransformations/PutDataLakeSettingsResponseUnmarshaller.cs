...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutDataLakeSettingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutDataLakeSettingsResponse response = new PutDataLakeSettingsResponse();
        ...
        private static PutDataLakeSettingsResponseUnmarshaller _instance = new PutDataLakeSettingsResponseUnmarshaller();        

        internal static PutDataLakeSettingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutDataLakeSettingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
