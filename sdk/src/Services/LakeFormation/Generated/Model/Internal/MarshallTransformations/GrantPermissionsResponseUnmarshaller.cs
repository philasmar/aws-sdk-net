...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GrantPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GrantPermissionsResponseUnmarshaller _instance = new GrantPermissionsResponseUnmarshaller();        

        internal static GrantPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GrantPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
