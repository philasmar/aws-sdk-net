...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetEffectivePermissionsForPathResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEffectivePermissionsForPathResponse response = new GetEffectivePermissionsForPathResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PrincipalResourcePermissions, PrincipalResourcePermissionsUnmarshaller>(PrincipalResourcePermissionsUnmarshaller.Instance);
        ...
        private static GetEffectivePermissionsForPathResponseUnmarshaller _instance = new GetEffectivePermissionsForPathResponseUnmarshaller();        

        internal static GetEffectivePermissionsForPathResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEffectivePermissionsForPathResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
