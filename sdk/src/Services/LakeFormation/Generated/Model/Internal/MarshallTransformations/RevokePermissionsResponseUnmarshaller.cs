...
namespace Amazon.LakeFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RevokePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RevokePermissionsResponse response = new RevokePermissionsResponse();
        ...
        private static RevokePermissionsResponseUnmarshaller _instance = new RevokePermissionsResponseUnmarshaller();        

        internal static RevokePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
