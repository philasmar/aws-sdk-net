...
{
    /// <summary>
    /// Response Unmarshaller for ListHsms operation
    /// </summary>  
    public class ListHsmsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListHsmsResponseUnmarshaller _instance = new ListHsmsResponseUnmarshaller();        

        internal static ListHsmsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListHsmsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
