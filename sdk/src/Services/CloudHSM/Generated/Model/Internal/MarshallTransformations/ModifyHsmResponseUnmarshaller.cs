...
{
    /// <summary>
    /// Response Unmarshaller for ModifyHsm operation
    /// </summary>  
    public class ModifyHsmResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static ModifyHsmResponseUnmarshaller _instance = new ModifyHsmResponseUnmarshaller();        

        internal static ModifyHsmResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
