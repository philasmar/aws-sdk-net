...
{
    /// <summary>
    /// ModifyHapg Request Marshaller
    /// </summary>       
    public class ModifyHapgRequestMarshaller : IMarshaller<IRequest, ModifyHapgRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ModifyHapgRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ModifyHapgRequest publicRequest)
        {
        ...
        private static ModifyHapgRequestMarshaller _instance = new ModifyHapgRequestMarshaller();        

        internal static ModifyHapgRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyHapgRequestMarshaller Instance
        {
            get
            {
                return _instance;
