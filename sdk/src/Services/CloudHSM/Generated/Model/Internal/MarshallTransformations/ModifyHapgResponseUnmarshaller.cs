...
{
    /// <summary>
    /// Response Unmarshaller for ModifyHapg operation
    /// </summary>  
    public class ModifyHapgResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyHapgResponse response = new ModifyHapgResponse();
        ...
        private static ModifyHapgResponseUnmarshaller _instance = new ModifyHapgResponseUnmarshaller();        

        internal static ModifyHapgResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyHapgResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
