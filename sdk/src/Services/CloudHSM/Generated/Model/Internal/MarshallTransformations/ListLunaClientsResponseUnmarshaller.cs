...
{
    /// <summary>
    /// Response Unmarshaller for ListLunaClients operation
    /// </summary>  
    public class ListLunaClientsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLunaClientsResponse response = new ListLunaClientsResponse();
        ...
        private static ListLunaClientsResponseUnmarshaller _instance = new ListLunaClientsResponseUnmarshaller();        

        internal static ListLunaClientsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLunaClientsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
