...
{
    /// <summary>
    /// Response Unmarshaller for ModifyLunaClient operation
    /// </summary>  
    public class ModifyLunaClientResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ModifyLunaClientResponseUnmarshaller _instance = new ModifyLunaClientResponseUnmarshaller();        

        internal static ModifyLunaClientResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyLunaClientResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
