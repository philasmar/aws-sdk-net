...
{
    /// <summary>
    /// OpenTunnel Request Marshaller
    /// </summary>       
    public class OpenTunnelRequestMarshaller : IMarshaller<IRequest, OpenTunnelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((OpenTunnelRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(OpenTunnelRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.IoTSecureTunneling");
            string target = "IoTSecuredTunneling.OpenTunnel";
        ...
        private static OpenTunnelRequestMarshaller _instance = new OpenTunnelRequestMarshaller();        

        internal static OpenTunnelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static OpenTunnelRequestMarshaller Instance
        {
            get
            {
                return _instance;
