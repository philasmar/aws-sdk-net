...
namespace Amazon.IoTSecureTunneling.Model
{
    ...
    /// </summary>
    public partial class DescribeTunnelResponse : AmazonWebServiceResponse
    {
        private Tunnel _tunnel;

        /// <summary>
        /// Gets and sets the property Tunnel. 
        /// <para>
        ...
        {
            get { return this._tunnel; }
            set { this._tunnel = value; }
        }

        // Check to see if Tunnel property is set
        internal bool IsSetTunnel()
        {
