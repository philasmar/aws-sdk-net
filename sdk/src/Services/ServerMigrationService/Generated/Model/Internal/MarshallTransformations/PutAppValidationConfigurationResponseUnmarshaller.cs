...
{
    /// <summary>
    /// Response Unmarshaller for PutAppValidationConfiguration operation
    /// </summary>  
    public class PutAppValidationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAppValidationConfigurationResponse response = new PutAppValidationConfigurationResponse();
        ...
        private static PutAppValidationConfigurationResponseUnmarshaller _instance = new PutAppValidationConfigurationResponseUnmarshaller();        

        internal static PutAppValidationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAppValidationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
