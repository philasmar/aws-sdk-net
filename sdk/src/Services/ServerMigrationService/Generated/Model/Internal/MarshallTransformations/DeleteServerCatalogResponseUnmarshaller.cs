...
namespace Amazon.ServerMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteServerCatalogResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteServerCatalogResponse response = new DeleteServerCatalogResponse();
        ...
        private static DeleteServerCatalogResponseUnmarshaller _instance = new DeleteServerCatalogResponseUnmarshaller();        

        internal static DeleteServerCatalogResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteServerCatalogResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
