...
namespace Amazon.ServerMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetReplicationJobsRequestMarshaller : IMarshaller<IRequest, GetReplicationJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetReplicationJobsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetReplicationJobsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ServerMigrationService");
            string target = "AWSServerMigrationService_V2016_10_24.GetReplicationJobs";
