...
{
    /// <summary>
    /// Response Unmarshaller for ImportAppCatalog operation
    /// </summary>  
    public class ImportAppCatalogResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportAppCatalogResponse response = new ImportAppCatalogResponse();
        ...
        private static ImportAppCatalogResponseUnmarshaller _instance = new ImportAppCatalogResponseUnmarshaller();        

        internal static ImportAppCatalogResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportAppCatalogResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
