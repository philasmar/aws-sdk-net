...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAppValidationConfiguration operation
    /// </summary>  
    public class DeleteAppValidationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAppValidationConfigurationResponse response = new DeleteAppValidationConfigurationResponse();
        ...
        private static DeleteAppValidationConfigurationResponseUnmarshaller _instance = new DeleteAppValidationConfigurationResponseUnmarshaller();        

        internal static DeleteAppValidationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAppValidationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
