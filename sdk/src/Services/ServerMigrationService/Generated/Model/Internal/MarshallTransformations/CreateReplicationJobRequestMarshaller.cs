...
namespace Amazon.ServerMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateReplicationJobRequestMarshaller : IMarshaller<IRequest, CreateReplicationJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateReplicationJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateReplicationJobRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ServerMigrationService");
            string target = "AWSServerMigrationService_V2016_10_24.CreateReplicationJob";
        ...
        private static CreateReplicationJobRequestMarshaller _instance = new CreateReplicationJobRequestMarshaller();        

        internal static CreateReplicationJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateReplicationJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
