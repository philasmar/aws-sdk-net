...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAppReplicationConfiguration operation
    /// </summary>  
    public class DeleteAppReplicationConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAppReplicationConfigurationResponse response = new DeleteAppReplicationConfigurationResponse();
        ...
        private static DeleteAppReplicationConfigurationResponseUnmarshaller _instance = new DeleteAppReplicationConfigurationResponseUnmarshaller();        

        internal static DeleteAppReplicationConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAppReplicationConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
