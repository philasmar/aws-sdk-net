...
{
    /// <summary>
    /// Response Unmarshaller for StopAppReplication operation
    /// </summary>  
    public class StopAppReplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopAppReplicationResponse response = new StopAppReplicationResponse();
        ...
        private static StopAppReplicationResponseUnmarshaller _instance = new StopAppReplicationResponseUnmarshaller();        

        internal static StopAppReplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopAppReplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
