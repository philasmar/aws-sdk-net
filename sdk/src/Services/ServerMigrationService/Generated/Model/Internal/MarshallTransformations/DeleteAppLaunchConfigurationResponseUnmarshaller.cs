...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAppLaunchConfiguration operation
    /// </summary>  
    public class DeleteAppLaunchConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAppLaunchConfigurationResponse response = new DeleteAppLaunchConfigurationResponse();
        ...
        private static DeleteAppLaunchConfigurationResponseUnmarshaller _instance = new DeleteAppLaunchConfigurationResponseUnmarshaller();        

        internal static DeleteAppLaunchConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAppLaunchConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
