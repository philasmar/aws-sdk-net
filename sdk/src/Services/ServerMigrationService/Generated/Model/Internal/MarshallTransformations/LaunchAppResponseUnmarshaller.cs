...
{
    /// <summary>
    /// Response Unmarshaller for LaunchApp operation
    /// </summary>  
    public class LaunchAppResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            LaunchAppResponse response = new LaunchAppResponse();
        ...
        private static LaunchAppResponseUnmarshaller _instance = new LaunchAppResponseUnmarshaller();        

        internal static LaunchAppResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static LaunchAppResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
