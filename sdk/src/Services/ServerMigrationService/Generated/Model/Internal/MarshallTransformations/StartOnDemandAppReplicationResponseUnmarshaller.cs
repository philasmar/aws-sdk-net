...
{
    /// <summary>
    /// Response Unmarshaller for StartOnDemandAppReplication operation
    /// </summary>  
    public class StartOnDemandAppReplicationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartOnDemandAppReplicationResponse response = new StartOnDemandAppReplicationResponse();
        ...
        private static StartOnDemandAppReplicationResponseUnmarshaller _instance = new StartOnDemandAppReplicationResponseUnmarshaller();        

        internal static StartOnDemandAppReplicationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartOnDemandAppReplicationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
