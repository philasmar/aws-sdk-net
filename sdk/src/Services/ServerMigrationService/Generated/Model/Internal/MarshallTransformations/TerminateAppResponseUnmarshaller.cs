...
{
    /// <summary>
    /// Response Unmarshaller for TerminateApp operation
    /// </summary>  
    public class TerminateAppResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TerminateAppResponse response = new TerminateAppResponse();
        ...
        private static TerminateAppResponseUnmarshaller _instance = new TerminateAppResponseUnmarshaller();        

        internal static TerminateAppResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TerminateAppResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
