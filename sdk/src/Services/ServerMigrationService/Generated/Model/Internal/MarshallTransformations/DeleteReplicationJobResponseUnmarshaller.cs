...
namespace Amazon.ServerMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteReplicationJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteReplicationJobResponseUnmarshaller _instance = new DeleteReplicationJobResponseUnmarshaller();        

        internal static DeleteReplicationJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteReplicationJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
