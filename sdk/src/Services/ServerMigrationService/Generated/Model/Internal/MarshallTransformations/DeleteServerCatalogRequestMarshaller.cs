...
namespace Amazon.ServerMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteServerCatalogRequestMarshaller : IMarshaller<IRequest, DeleteServerCatalogRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteServerCatalogRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteServerCatalogRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ServerMigrationService");
            string target = "AWSServerMigrationService_V2016_10_24.DeleteServerCatalog";
