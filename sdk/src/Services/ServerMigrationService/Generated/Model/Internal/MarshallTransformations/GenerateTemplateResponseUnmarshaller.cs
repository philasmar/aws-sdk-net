...
{
    /// <summary>
    /// Response Unmarshaller for GenerateTemplate operation
    /// </summary>  
    public class GenerateTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GenerateTemplateResponseUnmarshaller _instance = new GenerateTemplateResponseUnmarshaller();        

        internal static GenerateTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
