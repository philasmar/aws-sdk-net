...
{
    /// <summary>
    /// Response Unmarshaller for GetApp operation
    /// </summary>  
    public class GetAppResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetAppResponseUnmarshaller _instance = new GetAppResponseUnmarshaller();        

        internal static GetAppResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAppResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
