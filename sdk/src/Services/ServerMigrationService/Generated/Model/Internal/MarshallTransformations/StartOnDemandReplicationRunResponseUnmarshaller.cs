...
namespace Amazon.ServerMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StartOnDemandReplicationRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartOnDemandReplicationRunResponse response = new StartOnDemandReplicationRunResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("replicationRunId", targetDepth))
                {
                    ...
                    response.ReplicationRunId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ReplicationRunLimitExceededException"))
                {
                    return ReplicationRunLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static StartOnDemandReplicationRunResponseUnmarshaller _instance = new StartOnDemandReplicationRunResponseUnmarshaller();        

        internal static StartOnDemandReplicationRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartOnDemandReplicationRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
