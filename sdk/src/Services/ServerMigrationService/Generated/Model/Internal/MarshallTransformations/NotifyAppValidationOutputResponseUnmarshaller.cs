...
{
    /// <summary>
    /// Response Unmarshaller for NotifyAppValidationOutput operation
    /// </summary>  
    public class NotifyAppValidationOutputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            NotifyAppValidationOutputResponse response = new NotifyAppValidationOutputResponse();
        ...
        private static NotifyAppValidationOutputResponseUnmarshaller _instance = new NotifyAppValidationOutputResponseUnmarshaller();        

        internal static NotifyAppValidationOutputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static NotifyAppValidationOutputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
