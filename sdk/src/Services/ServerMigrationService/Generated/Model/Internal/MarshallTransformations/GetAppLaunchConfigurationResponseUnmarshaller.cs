...
{
    /// <summary>
    /// Response Unmarshaller for GetAppLaunchConfiguration operation
    /// </summary>  
    public class GetAppLaunchConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAppLaunchConfigurationResponse response = new GetAppLaunchConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ServerGroupLaunchConfiguration, ServerGroupLaunchConfigurationUnmarshaller>(ServerGroupLaunchConfigurationUnmarshaller.Instance);
                    response.ServerGroupLaunchConfigurations = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetAppLaunchConfigurationResponseUnmarshaller _instance = new GetAppLaunchConfigurationResponseUnmarshaller();        

        internal static GetAppLaunchConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAppLaunchConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
