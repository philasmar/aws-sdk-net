...
{
    /// <summary>
    /// ListQueueTags Request Marshaller
    /// </summary>       
    public class ListQueueTagsRequestMarshaller : IMarshaller<IRequest, ListQueueTagsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListQueueTagsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListQueueTagsRequest publicRequest)
        {
