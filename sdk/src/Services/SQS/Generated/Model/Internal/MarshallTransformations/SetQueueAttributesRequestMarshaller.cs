    ...
    public class SetQueueAttributesRequestMarshaller : IMarshaller<IRequest, SetQueueAttributesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(SetQueueAttributesRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static SetQueueAttributesRequestMarshaller _instance = new SetQueueAttributesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetQueueAttributesRequestMarshaller Instance
        {
            get
            {
                return _instance;
