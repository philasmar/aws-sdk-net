...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAutoSnapshot operation
    /// </summary>  
    public class DeleteAutoSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAutoSnapshotResponse response = new DeleteAutoSnapshotResponse();
        ...
        private static DeleteAutoSnapshotResponseUnmarshaller _instance = new DeleteAutoSnapshotResponseUnmarshaller();        

        internal static DeleteAutoSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAutoSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
