...
{
    /// <summary>
    /// CreateDisk Request Marshaller
    /// </summary>       
    public class CreateDiskRequestMarshaller : IMarshaller<IRequest, CreateDiskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateDiskRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateDiskRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Lightsail");
            string target = "Lightsail_20161128.CreateDisk";
        ...
        private static CreateDiskRequestMarshaller _instance = new CreateDiskRequestMarshaller();        

        internal static CreateDiskRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDiskRequestMarshaller Instance
        {
            get
            {
                return _instance;
