...
{
    /// <summary>
    /// Response Unmarshaller for DetachStaticIp operation
    /// </summary>  
    public class DetachStaticIpResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetachStaticIpResponse response = new DetachStaticIpResponse();
        ...
        private static DetachStaticIpResponseUnmarshaller _instance = new DetachStaticIpResponseUnmarshaller();        

        internal static DetachStaticIpResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachStaticIpResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
