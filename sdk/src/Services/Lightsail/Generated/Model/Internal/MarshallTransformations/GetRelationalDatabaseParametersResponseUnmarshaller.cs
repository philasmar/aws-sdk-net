...
{
    /// <summary>
    /// Response Unmarshaller for GetRelationalDatabaseParameters operation
    /// </summary>  
    public class GetRelationalDatabaseParametersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRelationalDatabaseParametersResponse response = new GetRelationalDatabaseParametersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RelationalDatabaseParameter, RelationalDatabaseParameterUnmarshaller>(RelationalDatabaseParameterUnmarshaller.Instance);
        ...
        private static GetRelationalDatabaseParametersResponseUnmarshaller _instance = new GetRelationalDatabaseParametersResponseUnmarshaller();        

        internal static GetRelationalDatabaseParametersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRelationalDatabaseParametersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
