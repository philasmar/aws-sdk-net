...
{
    /// <summary>
    /// Response Unmarshaller for GetExportSnapshotRecords operation
    /// </summary>  
    public class GetExportSnapshotRecordsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetExportSnapshotRecordsResponse response = new GetExportSnapshotRecordsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ExportSnapshotRecord, ExportSnapshotRecordUnmarshaller>(ExportSnapshotRecordUnmarshaller.Instance);
                    response.ExportSnapshotRecords = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetExportSnapshotRecordsResponseUnmarshaller _instance = new GetExportSnapshotRecordsResponseUnmarshaller();        

        internal static GetExportSnapshotRecordsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetExportSnapshotRecordsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
