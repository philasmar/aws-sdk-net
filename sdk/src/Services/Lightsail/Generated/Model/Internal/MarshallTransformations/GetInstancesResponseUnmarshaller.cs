...
{
    /// <summary>
    /// Response Unmarshaller for GetInstances operation
    /// </summary>  
    public class GetInstancesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetInstancesResponseUnmarshaller _instance = new GetInstancesResponseUnmarshaller();        

        internal static GetInstancesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInstancesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
