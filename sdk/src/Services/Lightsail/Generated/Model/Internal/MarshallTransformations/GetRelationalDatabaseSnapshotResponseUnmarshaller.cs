...
{
    /// <summary>
    /// Response Unmarshaller for GetRelationalDatabaseSnapshot operation
    /// </summary>  
    public class GetRelationalDatabaseSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRelationalDatabaseSnapshotResponse response = new GetRelationalDatabaseSnapshotResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("relationalDatabaseSnapshot", targetDepth))
                {
                    ...
                    response.RelationalDatabaseSnapshot = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetRelationalDatabaseSnapshotResponseUnmarshaller _instance = new GetRelationalDatabaseSnapshotResponseUnmarshaller();        

        internal static GetRelationalDatabaseSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRelationalDatabaseSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
