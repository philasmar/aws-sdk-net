...
{
    /// <summary>
    /// Response Unmarshaller for GetCloudFormationStackRecords operation
    /// </summary>  
    public class GetCloudFormationStackRecordsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCloudFormationStackRecordsResponse response = new GetCloudFormationStackRecordsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CloudFormationStackRecord, CloudFormationStackRecordUnmarshaller>(CloudFormationStackRecordUnmarshaller.Instance);
                    response.CloudFormationStackRecords = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetCloudFormationStackRecordsResponseUnmarshaller _instance = new GetCloudFormationStackRecordsResponseUnmarshaller();        

        internal static GetCloudFormationStackRecordsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCloudFormationStackRecordsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
