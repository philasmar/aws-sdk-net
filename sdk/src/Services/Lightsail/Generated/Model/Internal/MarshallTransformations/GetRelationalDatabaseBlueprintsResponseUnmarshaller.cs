...
{
    /// <summary>
    /// Response Unmarshaller for GetRelationalDatabaseBlueprints operation
    /// </summary>  
    public class GetRelationalDatabaseBlueprintsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRelationalDatabaseBlueprintsResponse response = new GetRelationalDatabaseBlueprintsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RelationalDatabaseBlueprint, RelationalDatabaseBlueprintUnmarshaller>(RelationalDatabaseBlueprintUnmarshaller.Instance);
                    response.Blueprints = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetRelationalDatabaseBlueprintsResponseUnmarshaller _instance = new GetRelationalDatabaseBlueprintsResponseUnmarshaller();        

        internal static GetRelationalDatabaseBlueprintsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRelationalDatabaseBlueprintsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
