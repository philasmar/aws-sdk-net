...
{
    /// <summary>
    /// Response Unmarshaller for GetStaticIp operation
    /// </summary>  
    public class GetStaticIpResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetStaticIpResponse response = new GetStaticIpResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("staticIp", targetDepth))
                {
                    ...
                    response.StaticIp = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetStaticIpResponseUnmarshaller _instance = new GetStaticIpResponseUnmarshaller();        

        internal static GetStaticIpResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetStaticIpResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
