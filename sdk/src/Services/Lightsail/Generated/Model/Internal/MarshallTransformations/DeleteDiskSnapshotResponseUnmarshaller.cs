...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDiskSnapshot operation
    /// </summary>  
    public class DeleteDiskSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDiskSnapshotResponse response = new DeleteDiskSnapshotResponse();
        ...
        private static DeleteDiskSnapshotResponseUnmarshaller _instance = new DeleteDiskSnapshotResponseUnmarshaller();        

        internal static DeleteDiskSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDiskSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
