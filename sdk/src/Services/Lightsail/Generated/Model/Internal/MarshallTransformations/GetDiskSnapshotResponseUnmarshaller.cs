...
{
    /// <summary>
    /// Response Unmarshaller for GetDiskSnapshot operation
    /// </summary>  
    public class GetDiskSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDiskSnapshotResponse response = new GetDiskSnapshotResponse();

            context.Read();
            int targetDepth = context.CurrentDepth;
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("diskSnapshot", targetDepth))
                {
                    var unmarshaller = DiskSnapshotUnmarshaller.Instance;
                    response.DiskSnapshot = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetDiskSnapshotResponseUnmarshaller _instance = new GetDiskSnapshotResponseUnmarshaller();        

        internal static GetDiskSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDiskSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
