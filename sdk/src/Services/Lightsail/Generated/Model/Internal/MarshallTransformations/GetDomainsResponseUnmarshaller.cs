...
{
    /// <summary>
    /// Response Unmarshaller for GetDomains operation
    /// </summary>  
    public class GetDomainsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetDomainsResponseUnmarshaller _instance = new GetDomainsResponseUnmarshaller();        

        internal static GetDomainsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDomainsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
