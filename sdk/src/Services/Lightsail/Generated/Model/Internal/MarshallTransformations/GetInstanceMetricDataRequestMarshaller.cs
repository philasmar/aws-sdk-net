...
{
    /// <summary>
    /// GetInstanceMetricData Request Marshaller
    /// </summary>       
    public class GetInstanceMetricDataRequestMarshaller : IMarshaller<IRequest, GetInstanceMetricDataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetInstanceMetricDataRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetInstanceMetricDataRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Lightsail");
            string target = "Lightsail_20161128.GetInstanceMetricData";
        ...
        private static GetInstanceMetricDataRequestMarshaller _instance = new GetInstanceMetricDataRequestMarshaller();        

        internal static GetInstanceMetricDataRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInstanceMetricDataRequestMarshaller Instance
        {
            get
            {
                return _instance;
