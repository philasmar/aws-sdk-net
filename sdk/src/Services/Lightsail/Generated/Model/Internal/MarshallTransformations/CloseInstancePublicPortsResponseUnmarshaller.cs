...
{
    /// <summary>
    /// Response Unmarshaller for CloseInstancePublicPorts operation
    /// </summary>  
    public class CloseInstancePublicPortsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CloseInstancePublicPortsResponse response = new CloseInstancePublicPortsResponse();
        ...
        private static CloseInstancePublicPortsResponseUnmarshaller _instance = new CloseInstancePublicPortsResponseUnmarshaller();        

        internal static CloseInstancePublicPortsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CloseInstancePublicPortsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
