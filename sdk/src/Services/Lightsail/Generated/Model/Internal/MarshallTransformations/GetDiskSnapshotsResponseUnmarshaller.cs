...
{
    /// <summary>
    /// Response Unmarshaller for GetDiskSnapshots operation
    /// </summary>  
    public class GetDiskSnapshotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDiskSnapshotsResponse response = new GetDiskSnapshotsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DiskSnapshot, DiskSnapshotUnmarshaller>(DiskSnapshotUnmarshaller.Instance);
                    response.DiskSnapshots = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetDiskSnapshotsResponseUnmarshaller _instance = new GetDiskSnapshotsResponseUnmarshaller();        

        internal static GetDiskSnapshotsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDiskSnapshotsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
