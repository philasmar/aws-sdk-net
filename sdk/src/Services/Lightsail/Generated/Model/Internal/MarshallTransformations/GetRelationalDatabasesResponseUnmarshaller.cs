...
{
    /// <summary>
    /// Response Unmarshaller for GetRelationalDatabases operation
    /// </summary>  
    public class GetRelationalDatabasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRelationalDatabasesResponse response = new GetRelationalDatabasesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RelationalDatabase, RelationalDatabaseUnmarshaller>(RelationalDatabaseUnmarshaller.Instance);
                    response.RelationalDatabases = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetRelationalDatabasesResponseUnmarshaller _instance = new GetRelationalDatabasesResponseUnmarshaller();        

        internal static GetRelationalDatabasesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRelationalDatabasesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
