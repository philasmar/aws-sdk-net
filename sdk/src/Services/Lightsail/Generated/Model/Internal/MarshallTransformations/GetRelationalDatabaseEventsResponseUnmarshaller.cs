...
{
    /// <summary>
    /// Response Unmarshaller for GetRelationalDatabaseEvents operation
    /// </summary>  
    public class GetRelationalDatabaseEventsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRelationalDatabaseEventsResponse response = new GetRelationalDatabaseEventsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RelationalDatabaseEvent, RelationalDatabaseEventUnmarshaller>(RelationalDatabaseEventUnmarshaller.Instance);
                    response.RelationalDatabaseEvents = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetRelationalDatabaseEventsResponseUnmarshaller _instance = new GetRelationalDatabaseEventsResponseUnmarshaller();        

        internal static GetRelationalDatabaseEventsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRelationalDatabaseEventsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
