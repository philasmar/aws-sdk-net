...
{
    /// <summary>
    /// Response Unmarshaller for Bundle Object
    /// </summary>  
    public class BundleUnmarshaller : IUnmarshaller<Bundle, XmlUnmarshallerContext>, IUnmarshaller<Bundle, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Bundle IUnmarshaller<Bundle, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static BundleUnmarshaller _instance = new BundleUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static BundleUnmarshaller Instance
        {
            get
            {
                return _instance;
