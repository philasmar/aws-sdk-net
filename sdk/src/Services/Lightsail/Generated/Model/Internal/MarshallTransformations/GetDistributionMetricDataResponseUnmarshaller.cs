...
{
    /// <summary>
    /// Response Unmarshaller for GetDistributionMetricData operation
    /// </summary>  
    public class GetDistributionMetricDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDistributionMetricDataResponse response = new GetDistributionMetricDataResponse();
        ...
        private static GetDistributionMetricDataResponseUnmarshaller _instance = new GetDistributionMetricDataResponseUnmarshaller();        

        internal static GetDistributionMetricDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDistributionMetricDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
