...
{
    /// <summary>
    /// Response Unmarshaller for GetLoadBalancers operation
    /// </summary>  
    public class GetLoadBalancersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("loadBalancers", targetDepth))
                {
                    ...
                    response.LoadBalancers = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetLoadBalancersResponseUnmarshaller _instance = new GetLoadBalancersResponseUnmarshaller();        

        internal static GetLoadBalancersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLoadBalancersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
