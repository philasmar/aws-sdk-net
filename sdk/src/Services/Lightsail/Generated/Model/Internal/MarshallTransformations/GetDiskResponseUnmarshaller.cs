...
{
    /// <summary>
    /// Response Unmarshaller for GetDisk operation
    /// </summary>  
    public class GetDiskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDiskResponse response = new GetDiskResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("disk", targetDepth))
                {
                    ...
                    response.Disk = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetDiskResponseUnmarshaller _instance = new GetDiskResponseUnmarshaller();        

        internal static GetDiskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDiskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
