...
{
    /// <summary>
    /// Response Unmarshaller for GetStaticIps operation
    /// </summary>  
    public class GetStaticIpsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetStaticIpsResponse response = new GetStaticIpsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<StaticIp, StaticIpUnmarshaller>(StaticIpUnmarshaller.Instance);
                    response.StaticIps = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetStaticIpsResponseUnmarshaller _instance = new GetStaticIpsResponseUnmarshaller();        

        internal static GetStaticIpsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetStaticIpsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
