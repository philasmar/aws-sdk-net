...
{
    /// <summary>
    /// Response Unmarshaller for AttachCertificateToDistribution operation
    /// </summary>  
    public class AttachCertificateToDistributionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AttachCertificateToDistributionResponse response = new AttachCertificateToDistributionResponse();
        ...
        private static AttachCertificateToDistributionResponseUnmarshaller _instance = new AttachCertificateToDistributionResponseUnmarshaller();        

        internal static AttachCertificateToDistributionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AttachCertificateToDistributionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
