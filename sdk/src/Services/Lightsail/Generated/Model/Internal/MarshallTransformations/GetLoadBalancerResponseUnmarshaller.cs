...
{
    /// <summary>
    /// Response Unmarshaller for GetLoadBalancer operation
    /// </summary>  
    public class GetLoadBalancerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLoadBalancerResponse response = new GetLoadBalancerResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("loadBalancer", targetDepth))
                {
                    ...
                    response.LoadBalancer = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetLoadBalancerResponseUnmarshaller _instance = new GetLoadBalancerResponseUnmarshaller();        

        internal static GetLoadBalancerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLoadBalancerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
