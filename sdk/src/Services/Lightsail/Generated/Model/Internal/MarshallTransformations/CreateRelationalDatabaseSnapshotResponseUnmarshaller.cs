...
{
    /// <summary>
    /// Response Unmarshaller for CreateRelationalDatabaseSnapshot operation
    /// </summary>  
    public class CreateRelationalDatabaseSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRelationalDatabaseSnapshotResponse response = new CreateRelationalDatabaseSnapshotResponse();
        ...
        private static CreateRelationalDatabaseSnapshotResponseUnmarshaller _instance = new CreateRelationalDatabaseSnapshotResponseUnmarshaller();        

        internal static CreateRelationalDatabaseSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRelationalDatabaseSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
