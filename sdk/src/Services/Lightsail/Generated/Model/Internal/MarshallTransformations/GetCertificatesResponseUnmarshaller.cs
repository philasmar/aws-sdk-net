...
{
    /// <summary>
    /// Response Unmarshaller for GetCertificates operation
    /// </summary>  
    public class GetCertificatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetCertificatesResponseUnmarshaller _instance = new GetCertificatesResponseUnmarshaller();        

        internal static GetCertificatesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCertificatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
