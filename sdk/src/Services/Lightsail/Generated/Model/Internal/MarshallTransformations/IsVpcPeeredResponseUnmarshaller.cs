...
{
    /// <summary>
    /// Response Unmarshaller for IsVpcPeered operation
    /// </summary>  
    public class IsVpcPeeredResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            IsVpcPeeredResponse response = new IsVpcPeeredResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("isPeered", targetDepth))
                {
                    ...
                    response.IsPeered = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static IsVpcPeeredResponseUnmarshaller _instance = new IsVpcPeeredResponseUnmarshaller();        

        internal static IsVpcPeeredResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IsVpcPeeredResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
