...
{
    /// <summary>
    /// Response Unmarshaller for StopRelationalDatabase operation
    /// </summary>  
    public class StopRelationalDatabaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopRelationalDatabaseResponse response = new StopRelationalDatabaseResponse();
        ...
        private static StopRelationalDatabaseResponseUnmarshaller _instance = new StopRelationalDatabaseResponseUnmarshaller();        

        internal static StopRelationalDatabaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopRelationalDatabaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
