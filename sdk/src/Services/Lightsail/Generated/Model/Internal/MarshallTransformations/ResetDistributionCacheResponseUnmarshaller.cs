...
{
    /// <summary>
    /// Response Unmarshaller for ResetDistributionCache operation
    /// </summary>  
    public class ResetDistributionCacheResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ResetDistributionCacheResponse response = new ResetDistributionCacheResponse();
        ...
        private static ResetDistributionCacheResponseUnmarshaller _instance = new ResetDistributionCacheResponseUnmarshaller();        

        internal static ResetDistributionCacheResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResetDistributionCacheResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
