...
{
    /// <summary>
    /// Response Unmarshaller for CreateDiskFromSnapshot operation
    /// </summary>  
    public class CreateDiskFromSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDiskFromSnapshotResponse response = new CreateDiskFromSnapshotResponse();
        ...
        private static CreateDiskFromSnapshotResponseUnmarshaller _instance = new CreateDiskFromSnapshotResponseUnmarshaller();        

        internal static CreateDiskFromSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDiskFromSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
