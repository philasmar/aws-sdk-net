...
{
    /// <summary>
    /// Response Unmarshaller for GetContainerAPIMetadata operation
    /// </summary>  
    public class GetContainerAPIMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetContainerAPIMetadataResponse response = new GetContainerAPIMetadataResponse();
        ...
        private static GetContainerAPIMetadataResponseUnmarshaller _instance = new GetContainerAPIMetadataResponseUnmarshaller();        

        internal static GetContainerAPIMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetContainerAPIMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
