...
{
    /// <summary>
    /// Response Unmarshaller for CreateContactMethod operation
    /// </summary>  
    public class CreateContactMethodResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateContactMethodResponse response = new CreateContactMethodResponse();
        ...
        private static CreateContactMethodResponseUnmarshaller _instance = new CreateContactMethodResponseUnmarshaller();        

        internal static CreateContactMethodResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateContactMethodResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
