...
{
    /// <summary>
    /// Response Unmarshaller for CreateDiskSnapshot operation
    /// </summary>  
    public class CreateDiskSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDiskSnapshotResponse response = new CreateDiskSnapshotResponse();
        ...
        private static CreateDiskSnapshotResponseUnmarshaller _instance = new CreateDiskSnapshotResponseUnmarshaller();        

        internal static CreateDiskSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDiskSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
