...
{
    /// <summary>
    /// Response Unmarshaller for GetRelationalDatabaseBundles operation
    /// </summary>  
    public class GetRelationalDatabaseBundlesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRelationalDatabaseBundlesResponse response = new GetRelationalDatabaseBundlesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RelationalDatabaseBundle, RelationalDatabaseBundleUnmarshaller>(RelationalDatabaseBundleUnmarshaller.Instance);
        ...
        private static GetRelationalDatabaseBundlesResponseUnmarshaller _instance = new GetRelationalDatabaseBundlesResponseUnmarshaller();        

        internal static GetRelationalDatabaseBundlesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRelationalDatabaseBundlesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
