...
{
    /// <summary>
    /// GetRelationalDatabaseLogEvents Request Marshaller
    /// </summary>       
    public class GetRelationalDatabaseLogEventsRequestMarshaller : IMarshaller<IRequest, GetRelationalDatabaseLogEventsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRelationalDatabaseLogEventsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRelationalDatabaseLogEventsRequest publicRequest)
        {
        ...
        private static GetRelationalDatabaseLogEventsRequestMarshaller _instance = new GetRelationalDatabaseLogEventsRequestMarshaller();        

        internal static GetRelationalDatabaseLogEventsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRelationalDatabaseLogEventsRequestMarshaller Instance
        {
            get
            {
                return _instance;
