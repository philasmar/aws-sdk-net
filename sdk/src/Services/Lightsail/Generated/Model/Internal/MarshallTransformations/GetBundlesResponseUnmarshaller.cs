...
{
    /// <summary>
    /// Response Unmarshaller for GetBundles operation
    /// </summary>  
    public class GetBundlesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Bundle, BundleUnmarshaller>(BundleUnmarshaller.Instance);
        ...
        private static GetBundlesResponseUnmarshaller _instance = new GetBundlesResponseUnmarshaller();        

        internal static GetBundlesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBundlesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
