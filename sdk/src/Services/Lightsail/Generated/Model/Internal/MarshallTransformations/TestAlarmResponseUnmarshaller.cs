...
{
    /// <summary>
    /// Response Unmarshaller for TestAlarm operation
    /// </summary>  
    public class TestAlarmResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            TestAlarmResponse response = new TestAlarmResponse();
        ...
        private static TestAlarmResponseUnmarshaller _instance = new TestAlarmResponseUnmarshaller();        

        internal static TestAlarmResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TestAlarmResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
