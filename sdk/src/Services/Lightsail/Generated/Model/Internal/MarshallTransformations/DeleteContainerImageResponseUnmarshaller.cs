...
{
    /// <summary>
    /// Response Unmarshaller for DeleteContainerImage operation
    /// </summary>  
    public class DeleteContainerImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteContainerImageResponse response = new DeleteContainerImageResponse();
        ...
        private static DeleteContainerImageResponseUnmarshaller _instance = new DeleteContainerImageResponseUnmarshaller();        

        internal static DeleteContainerImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteContainerImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
