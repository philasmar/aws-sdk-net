...
{
    /// <summary>
    /// GetRegions Request Marshaller
    /// </summary>       
    public class GetRegionsRequestMarshaller : IMarshaller<IRequest, GetRegionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetRegionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetRegionsRequest publicRequest)
        {
        ...
        private static GetRegionsRequestMarshaller _instance = new GetRegionsRequestMarshaller();        

        internal static GetRegionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRegionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
