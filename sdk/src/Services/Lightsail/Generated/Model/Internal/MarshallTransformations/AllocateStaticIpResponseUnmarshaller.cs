...
{
    /// <summary>
    /// Response Unmarshaller for AllocateStaticIp operation
    /// </summary>  
    public class AllocateStaticIpResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AllocateStaticIpResponse response = new AllocateStaticIpResponse();
        ...
        private static AllocateStaticIpResponseUnmarshaller _instance = new AllocateStaticIpResponseUnmarshaller();        

        internal static AllocateStaticIpResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AllocateStaticIpResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
