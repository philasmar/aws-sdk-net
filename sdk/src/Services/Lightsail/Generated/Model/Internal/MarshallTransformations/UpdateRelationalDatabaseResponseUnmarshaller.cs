...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRelationalDatabase operation
    /// </summary>  
    public class UpdateRelationalDatabaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRelationalDatabaseResponse response = new UpdateRelationalDatabaseResponse();
        ...
        private static UpdateRelationalDatabaseResponseUnmarshaller _instance = new UpdateRelationalDatabaseResponseUnmarshaller();        

        internal static UpdateRelationalDatabaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRelationalDatabaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
