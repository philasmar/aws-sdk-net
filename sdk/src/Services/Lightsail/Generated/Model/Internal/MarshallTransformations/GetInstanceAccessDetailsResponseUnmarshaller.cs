...
{
    /// <summary>
    /// Response Unmarshaller for GetInstanceAccessDetails operation
    /// </summary>  
    public class GetInstanceAccessDetailsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetInstanceAccessDetailsResponse response = new GetInstanceAccessDetailsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = InstanceAccessDetailsUnmarshaller.Instance;
                    response.AccessDetails = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetInstanceAccessDetailsResponseUnmarshaller _instance = new GetInstanceAccessDetailsResponseUnmarshaller();        

        internal static GetInstanceAccessDetailsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInstanceAccessDetailsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
