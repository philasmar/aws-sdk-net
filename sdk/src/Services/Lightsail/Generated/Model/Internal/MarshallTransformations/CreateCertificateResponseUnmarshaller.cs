...
{
    /// <summary>
    /// Response Unmarshaller for CreateCertificate operation
    /// </summary>  
    public class CreateCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = CertificateSummaryUnmarshaller.Instance;
        ...
        private static CreateCertificateResponseUnmarshaller _instance = new CreateCertificateResponseUnmarshaller();        

        internal static CreateCertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
