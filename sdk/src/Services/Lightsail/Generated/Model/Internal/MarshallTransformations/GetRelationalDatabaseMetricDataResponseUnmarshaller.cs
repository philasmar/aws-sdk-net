...
{
    /// <summary>
    /// Response Unmarshaller for GetRelationalDatabaseMetricData operation
    /// </summary>  
    public class GetRelationalDatabaseMetricDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRelationalDatabaseMetricDataResponse response = new GetRelationalDatabaseMetricDataResponse();
        ...
        private static GetRelationalDatabaseMetricDataResponseUnmarshaller _instance = new GetRelationalDatabaseMetricDataResponseUnmarshaller();        

        internal static GetRelationalDatabaseMetricDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRelationalDatabaseMetricDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
