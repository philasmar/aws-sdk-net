...
{
    /// <summary>
    /// Response Unmarshaller for OpenInstancePublicPorts operation
    /// </summary>  
    public class OpenInstancePublicPortsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            OpenInstancePublicPortsResponse response = new OpenInstancePublicPortsResponse();
        ...
        private static OpenInstancePublicPortsResponseUnmarshaller _instance = new OpenInstancePublicPortsResponseUnmarshaller();        

        internal static OpenInstancePublicPortsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static OpenInstancePublicPortsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
