    ...
    public class DomainUnmarshaller : IUnmarshaller<Domain, XmlUnmarshallerContext>, IUnmarshaller<Domain, JsonUnmarshallerContext>
    {
        ...
        public Domain Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DomainEntry, DomainEntryUnmarshaller>(DomainEntryUnmarshaller.Instance);
                    unmarshalledObject.DomainEntries = unmarshaller.Unmarshall(context);
                    continue;
                }
