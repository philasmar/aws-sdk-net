...
{
    /// <summary>
    /// GetDistributionMetricData Request Marshaller
    /// </summary>       
    public class GetDistributionMetricDataRequestMarshaller : IMarshaller<IRequest, GetDistributionMetricDataRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetDistributionMetricDataRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetDistributionMetricDataRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Lightsail");
            string target = "Lightsail_20161128.GetDistributionMetricData";
        ...
        private static GetDistributionMetricDataRequestMarshaller _instance = new GetDistributionMetricDataRequestMarshaller();        

        internal static GetDistributionMetricDataRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDistributionMetricDataRequestMarshaller Instance
        {
            get
            {
                return _instance;
