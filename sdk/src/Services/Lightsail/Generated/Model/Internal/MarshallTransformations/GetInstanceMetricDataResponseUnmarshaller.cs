...
{
    /// <summary>
    /// Response Unmarshaller for GetInstanceMetricData operation
    /// </summary>  
    public class GetInstanceMetricDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetInstanceMetricDataResponse response = new GetInstanceMetricDataResponse();
        ...
        private static GetInstanceMetricDataResponseUnmarshaller _instance = new GetInstanceMetricDataResponseUnmarshaller();        

        internal static GetInstanceMetricDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInstanceMetricDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
