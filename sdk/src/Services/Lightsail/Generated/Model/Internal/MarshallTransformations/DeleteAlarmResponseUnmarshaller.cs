...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAlarm operation
    /// </summary>  
    public class DeleteAlarmResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAlarmResponse response = new DeleteAlarmResponse();
        ...
        private static DeleteAlarmResponseUnmarshaller _instance = new DeleteAlarmResponseUnmarshaller();        

        internal static DeleteAlarmResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAlarmResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
