...
namespace Amazon.Lightsail.Model.Internal.MarshallTransformations
{
    ...
    public class RebootInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static RebootInstanceResponseUnmarshaller _instance = new RebootInstanceResponseUnmarshaller();        

        internal static RebootInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RebootInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
