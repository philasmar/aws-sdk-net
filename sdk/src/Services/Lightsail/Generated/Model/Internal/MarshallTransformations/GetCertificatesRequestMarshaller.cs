...
{
    /// <summary>
    /// GetCertificates Request Marshaller
    /// </summary>       
    public class GetCertificatesRequestMarshaller : IMarshaller<IRequest, GetCertificatesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCertificatesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCertificatesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Lightsail");
            string target = "Lightsail_20161128.GetCertificates";
        ...
        private static GetCertificatesRequestMarshaller _instance = new GetCertificatesRequestMarshaller();        

        internal static GetCertificatesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCertificatesRequestMarshaller Instance
        {
            get
            {
                return _instance;
