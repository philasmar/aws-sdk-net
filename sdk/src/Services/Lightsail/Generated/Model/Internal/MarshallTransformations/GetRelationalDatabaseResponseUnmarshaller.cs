...
{
    /// <summary>
    /// Response Unmarshaller for GetRelationalDatabase operation
    /// </summary>  
    public class GetRelationalDatabaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRelationalDatabaseResponse response = new GetRelationalDatabaseResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = RelationalDatabaseUnmarshaller.Instance;
                    response.RelationalDatabase = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetRelationalDatabaseResponseUnmarshaller _instance = new GetRelationalDatabaseResponseUnmarshaller();        

        internal static GetRelationalDatabaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRelationalDatabaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
