...
{
    /// <summary>
    /// Response Unmarshaller for DownloadDefaultKeyPair operation
    /// </summary>  
    public class DownloadDefaultKeyPairResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DownloadDefaultKeyPairResponse response = new DownloadDefaultKeyPairResponse();
        ...
        private static DownloadDefaultKeyPairResponseUnmarshaller _instance = new DownloadDefaultKeyPairResponseUnmarshaller();        

        internal static DownloadDefaultKeyPairResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DownloadDefaultKeyPairResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
