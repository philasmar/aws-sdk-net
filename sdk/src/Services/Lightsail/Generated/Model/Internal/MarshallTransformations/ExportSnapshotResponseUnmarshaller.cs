...
{
    /// <summary>
    /// Response Unmarshaller for ExportSnapshot operation
    /// </summary>  
    public class ExportSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ExportSnapshotResponse response = new ExportSnapshotResponse();
        ...
        private static ExportSnapshotResponseUnmarshaller _instance = new ExportSnapshotResponseUnmarshaller();        

        internal static ExportSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
