...
{
    /// <summary>
    /// Response Unmarshaller for CreateInstanceSnapshot operation
    /// </summary>  
    public class CreateInstanceSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInstanceSnapshotResponse response = new CreateInstanceSnapshotResponse();
        ...
        private static CreateInstanceSnapshotResponseUnmarshaller _instance = new CreateInstanceSnapshotResponseUnmarshaller();        

        internal static CreateInstanceSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInstanceSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
