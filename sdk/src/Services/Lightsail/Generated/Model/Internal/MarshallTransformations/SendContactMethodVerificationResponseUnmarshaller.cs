...
{
    /// <summary>
    /// Response Unmarshaller for SendContactMethodVerification operation
    /// </summary>  
    public class SendContactMethodVerificationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendContactMethodVerificationResponse response = new SendContactMethodVerificationResponse();
        ...
        private static SendContactMethodVerificationResponseUnmarshaller _instance = new SendContactMethodVerificationResponseUnmarshaller();        

        internal static SendContactMethodVerificationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendContactMethodVerificationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
