...
{
    /// <summary>
    /// Response Unmarshaller for GetRelationalDatabaseSnapshots operation
    /// </summary>  
    public class GetRelationalDatabaseSnapshotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRelationalDatabaseSnapshotsResponse response = new GetRelationalDatabaseSnapshotsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RelationalDatabaseSnapshot, RelationalDatabaseSnapshotUnmarshaller>(RelationalDatabaseSnapshotUnmarshaller.Instance);
                    response.RelationalDatabaseSnapshots = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetRelationalDatabaseSnapshotsResponseUnmarshaller _instance = new GetRelationalDatabaseSnapshotsResponseUnmarshaller();        

        internal static GetRelationalDatabaseSnapshotsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRelationalDatabaseSnapshotsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
