...
{
    /// <summary>
    /// Response Unmarshaller for UpdateLoadBalancerAttribute operation
    /// </summary>  
    public class UpdateLoadBalancerAttributeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateLoadBalancerAttributeResponse response = new UpdateLoadBalancerAttributeResponse();
        ...
        private static UpdateLoadBalancerAttributeResponseUnmarshaller _instance = new UpdateLoadBalancerAttributeResponseUnmarshaller();        

        internal static UpdateLoadBalancerAttributeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateLoadBalancerAttributeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
