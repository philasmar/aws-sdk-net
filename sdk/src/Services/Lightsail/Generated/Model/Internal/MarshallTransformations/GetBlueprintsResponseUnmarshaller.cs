...
{
    /// <summary>
    /// Response Unmarshaller for GetBlueprints operation
    /// </summary>  
    public class GetBlueprintsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBlueprintsResponse response = new GetBlueprintsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Blueprint, BlueprintUnmarshaller>(BlueprintUnmarshaller.Instance);
        ...
        private static GetBlueprintsResponseUnmarshaller _instance = new GetBlueprintsResponseUnmarshaller();        

        internal static GetBlueprintsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBlueprintsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
