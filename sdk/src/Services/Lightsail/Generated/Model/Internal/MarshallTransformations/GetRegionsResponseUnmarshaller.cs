...
{
    /// <summary>
    /// Response Unmarshaller for GetRegions operation
    /// </summary>  
    public class GetRegionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetRegionsResponseUnmarshaller _instance = new GetRegionsResponseUnmarshaller();        

        internal static GetRegionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRegionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
