...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRelationalDatabaseSnapshot operation
    /// </summary>  
    public class DeleteRelationalDatabaseSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRelationalDatabaseSnapshotResponse response = new DeleteRelationalDatabaseSnapshotResponse();
        ...
        private static DeleteRelationalDatabaseSnapshotResponseUnmarshaller _instance = new DeleteRelationalDatabaseSnapshotResponseUnmarshaller();        

        internal static DeleteRelationalDatabaseSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRelationalDatabaseSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
