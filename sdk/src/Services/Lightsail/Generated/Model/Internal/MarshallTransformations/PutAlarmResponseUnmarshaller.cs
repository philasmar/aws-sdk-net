...
{
    /// <summary>
    /// Response Unmarshaller for PutAlarm operation
    /// </summary>  
    public class PutAlarmResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAlarmResponse response = new PutAlarmResponse();
        ...
        private static PutAlarmResponseUnmarshaller _instance = new PutAlarmResponseUnmarshaller();        

        internal static PutAlarmResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAlarmResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
