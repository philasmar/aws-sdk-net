...
{
    /// <summary>
    /// Response Unmarshaller for DeleteLoadBalancerTlsCertificate operation
    /// </summary>  
    public class DeleteLoadBalancerTlsCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteLoadBalancerTlsCertificateResponse response = new DeleteLoadBalancerTlsCertificateResponse();
        ...
        private static DeleteLoadBalancerTlsCertificateResponseUnmarshaller _instance = new DeleteLoadBalancerTlsCertificateResponseUnmarshaller();        

        internal static DeleteLoadBalancerTlsCertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLoadBalancerTlsCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
