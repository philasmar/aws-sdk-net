...
{
    /// <summary>
    /// Response Unmarshaller for GetContainerLog operation
    /// </summary>  
    public class GetContainerLogResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetContainerLogResponse response = new GetContainerLogResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ContainerServiceLogEvent, ContainerServiceLogEventUnmarshaller>(ContainerServiceLogEventUnmarshaller.Instance);
                    response.LogEvents = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetContainerLogResponseUnmarshaller _instance = new GetContainerLogResponseUnmarshaller();        

        internal static GetContainerLogResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetContainerLogResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
