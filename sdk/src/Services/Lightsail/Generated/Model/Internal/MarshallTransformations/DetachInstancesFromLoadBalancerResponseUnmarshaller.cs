...
{
    /// <summary>
    /// Response Unmarshaller for DetachInstancesFromLoadBalancer operation
    /// </summary>  
    public class DetachInstancesFromLoadBalancerResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetachInstancesFromLoadBalancerResponse response = new DetachInstancesFromLoadBalancerResponse();
        ...
        private static DetachInstancesFromLoadBalancerResponseUnmarshaller _instance = new DetachInstancesFromLoadBalancerResponseUnmarshaller();        

        internal static DetachInstancesFromLoadBalancerResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachInstancesFromLoadBalancerResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
