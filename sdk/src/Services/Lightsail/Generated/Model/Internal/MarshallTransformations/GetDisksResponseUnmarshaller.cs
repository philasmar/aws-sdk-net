...
{
    /// <summary>
    /// Response Unmarshaller for GetDisks operation
    /// </summary>  
    public class GetDisksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDisksResponse response = new GetDisksResponse();
        ...
        private static GetDisksResponseUnmarshaller _instance = new GetDisksResponseUnmarshaller();        

        internal static GetDisksResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDisksResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
