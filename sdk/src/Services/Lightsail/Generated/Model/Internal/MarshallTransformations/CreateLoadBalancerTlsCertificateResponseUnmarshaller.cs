...
{
    /// <summary>
    /// Response Unmarshaller for CreateLoadBalancerTlsCertificate operation
    /// </summary>  
    public class CreateLoadBalancerTlsCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLoadBalancerTlsCertificateResponse response = new CreateLoadBalancerTlsCertificateResponse();
        ...
        private static CreateLoadBalancerTlsCertificateResponseUnmarshaller _instance = new CreateLoadBalancerTlsCertificateResponseUnmarshaller();        

        internal static CreateLoadBalancerTlsCertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLoadBalancerTlsCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
