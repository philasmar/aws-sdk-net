...
{
    /// <summary>
    /// Response Unmarshaller for GetDistributions operation
    /// </summary>  
    public class GetDistributionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDistributionsResponse response = new GetDistributionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<LightsailDistribution, LightsailDistributionUnmarshaller>(LightsailDistributionUnmarshaller.Instance);
                    response.Distributions = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetDistributionsResponseUnmarshaller _instance = new GetDistributionsResponseUnmarshaller();        

        internal static GetDistributionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDistributionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
