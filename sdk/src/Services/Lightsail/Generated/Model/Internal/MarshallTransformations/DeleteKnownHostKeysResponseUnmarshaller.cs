...
{
    /// <summary>
    /// Response Unmarshaller for DeleteKnownHostKeys operation
    /// </summary>  
    public class DeleteKnownHostKeysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteKnownHostKeysResponse response = new DeleteKnownHostKeysResponse();
        ...
        private static DeleteKnownHostKeysResponseUnmarshaller _instance = new DeleteKnownHostKeysResponseUnmarshaller();        

        internal static DeleteKnownHostKeysResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteKnownHostKeysResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
