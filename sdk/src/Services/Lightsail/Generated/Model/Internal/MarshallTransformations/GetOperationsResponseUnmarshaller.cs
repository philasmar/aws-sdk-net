...
{
    /// <summary>
    /// Response Unmarshaller for GetOperations operation
    /// </summary>  
    public class GetOperationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetOperationsResponseUnmarshaller _instance = new GetOperationsResponseUnmarshaller();        

        internal static GetOperationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetOperationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
