...
{
    /// <summary>
    /// Response Unmarshaller for GetInstanceSnapshot operation
    /// </summary>  
    public class GetInstanceSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetInstanceSnapshotResponse response = new GetInstanceSnapshotResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = InstanceSnapshotUnmarshaller.Instance;
                    response.InstanceSnapshot = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetInstanceSnapshotResponseUnmarshaller _instance = new GetInstanceSnapshotResponseUnmarshaller();        

        internal static GetInstanceSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetInstanceSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
