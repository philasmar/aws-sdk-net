...
{
    /// <summary>
    /// Response Unmarshaller for DeleteContactMethod operation
    /// </summary>  
    public class DeleteContactMethodResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteContactMethodResponse response = new DeleteContactMethodResponse();
        ...
        private static DeleteContactMethodResponseUnmarshaller _instance = new DeleteContactMethodResponseUnmarshaller();        

        internal static DeleteContactMethodResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteContactMethodResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
