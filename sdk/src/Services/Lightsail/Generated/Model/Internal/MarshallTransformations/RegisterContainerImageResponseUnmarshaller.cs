...
{
    /// <summary>
    /// Response Unmarshaller for RegisterContainerImage operation
    /// </summary>  
    public class RegisterContainerImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterContainerImageResponse response = new RegisterContainerImageResponse();
        ...
        private static RegisterContainerImageResponseUnmarshaller _instance = new RegisterContainerImageResponseUnmarshaller();        

        internal static RegisterContainerImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterContainerImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
