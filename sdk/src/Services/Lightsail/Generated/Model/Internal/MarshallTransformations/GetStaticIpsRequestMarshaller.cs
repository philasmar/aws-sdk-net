...
{
    /// <summary>
    /// GetStaticIps Request Marshaller
    /// </summary>       
    public class GetStaticIpsRequestMarshaller : IMarshaller<IRequest, GetStaticIpsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetStaticIpsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetStaticIpsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Lightsail");
            string target = "Lightsail_20161128.GetStaticIps";
