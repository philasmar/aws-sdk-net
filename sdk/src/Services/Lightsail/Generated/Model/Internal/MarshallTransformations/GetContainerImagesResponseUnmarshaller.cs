...
{
    /// <summary>
    /// Response Unmarshaller for GetContainerImages operation
    /// </summary>  
    public class GetContainerImagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetContainerImagesResponse response = new GetContainerImagesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("containerImages", targetDepth))
                {
                    ...
                    response.ContainerImages = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetContainerImagesResponseUnmarshaller _instance = new GetContainerImagesResponseUnmarshaller();        

        internal static GetContainerImagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetContainerImagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
