...
{
    /// <summary>
    /// Response Unmarshaller for GetAutoSnapshots operation
    /// </summary>  
    public class GetAutoSnapshotsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetAutoSnapshotsResponse response = new GetAutoSnapshotsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AutoSnapshotDetails, AutoSnapshotDetailsUnmarshaller>(AutoSnapshotDetailsUnmarshaller.Instance);
                    response.AutoSnapshots = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetAutoSnapshotsResponseUnmarshaller _instance = new GetAutoSnapshotsResponseUnmarshaller();        

        internal static GetAutoSnapshotsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetAutoSnapshotsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
