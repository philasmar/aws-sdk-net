...
{
    /// <summary>
    /// Response Unmarshaller for CreateRelationalDatabase operation
    /// </summary>  
    public class CreateRelationalDatabaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRelationalDatabaseResponse response = new CreateRelationalDatabaseResponse();
        ...
        private static CreateRelationalDatabaseResponseUnmarshaller _instance = new CreateRelationalDatabaseResponseUnmarshaller();        

        internal static CreateRelationalDatabaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRelationalDatabaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
