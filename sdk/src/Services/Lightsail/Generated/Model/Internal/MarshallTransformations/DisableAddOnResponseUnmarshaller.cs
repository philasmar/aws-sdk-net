...
{
    /// <summary>
    /// Response Unmarshaller for DisableAddOn operation
    /// </summary>  
    public class DisableAddOnResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisableAddOnResponse response = new DisableAddOnResponse();
        ...
        private static DisableAddOnResponseUnmarshaller _instance = new DisableAddOnResponseUnmarshaller();        

        internal static DisableAddOnResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableAddOnResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
