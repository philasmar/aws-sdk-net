...
{
    /// <summary>
    /// Response Unmarshaller for CreateInstancesFromSnapshot operation
    /// </summary>  
    public class CreateInstancesFromSnapshotResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateInstancesFromSnapshotResponse response = new CreateInstancesFromSnapshotResponse();
        ...
        private static CreateInstancesFromSnapshotResponseUnmarshaller _instance = new CreateInstancesFromSnapshotResponseUnmarshaller();        

        internal static CreateInstancesFromSnapshotResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateInstancesFromSnapshotResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
