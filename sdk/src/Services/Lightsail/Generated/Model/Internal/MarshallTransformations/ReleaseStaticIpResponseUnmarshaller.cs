...
{
    /// <summary>
    /// Response Unmarshaller for ReleaseStaticIp operation
    /// </summary>  
    public class ReleaseStaticIpResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ReleaseStaticIpResponse response = new ReleaseStaticIpResponse();
        ...
        private static ReleaseStaticIpResponseUnmarshaller _instance = new ReleaseStaticIpResponseUnmarshaller();        

        internal static ReleaseStaticIpResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReleaseStaticIpResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
