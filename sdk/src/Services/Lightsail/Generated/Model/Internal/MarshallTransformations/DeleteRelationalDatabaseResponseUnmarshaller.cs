...
{
    /// <summary>
    /// Response Unmarshaller for DeleteRelationalDatabase operation
    /// </summary>  
    public class DeleteRelationalDatabaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteRelationalDatabaseResponse response = new DeleteRelationalDatabaseResponse();
        ...
        private static DeleteRelationalDatabaseResponseUnmarshaller _instance = new DeleteRelationalDatabaseResponseUnmarshaller();        

        internal static DeleteRelationalDatabaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRelationalDatabaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
