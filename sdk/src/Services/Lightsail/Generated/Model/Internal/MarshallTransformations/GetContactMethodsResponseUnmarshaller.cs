...
{
    /// <summary>
    /// Response Unmarshaller for GetContactMethods operation
    /// </summary>  
    public class GetContactMethodsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetContactMethodsResponse response = new GetContactMethodsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ContactMethod, ContactMethodUnmarshaller>(ContactMethodUnmarshaller.Instance);
                    response.ContactMethods = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetContactMethodsResponseUnmarshaller _instance = new GetContactMethodsResponseUnmarshaller();        

        internal static GetContactMethodsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetContactMethodsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
