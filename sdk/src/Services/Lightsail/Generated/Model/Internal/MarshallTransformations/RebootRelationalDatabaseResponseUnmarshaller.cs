...
{
    /// <summary>
    /// Response Unmarshaller for RebootRelationalDatabase operation
    /// </summary>  
    public class RebootRelationalDatabaseResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RebootRelationalDatabaseResponse response = new RebootRelationalDatabaseResponse();
        ...
        private static RebootRelationalDatabaseResponseUnmarshaller _instance = new RebootRelationalDatabaseResponseUnmarshaller();        

        internal static RebootRelationalDatabaseResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RebootRelationalDatabaseResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
