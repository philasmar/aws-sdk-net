...
{
    /// <summary>
    /// Response Unmarshaller for GetLoadBalancerMetricData operation
    /// </summary>  
    public class GetLoadBalancerMetricDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLoadBalancerMetricDataResponse response = new GetLoadBalancerMetricDataResponse();
        ...
        private static GetLoadBalancerMetricDataResponseUnmarshaller _instance = new GetLoadBalancerMetricDataResponseUnmarshaller();        

        internal static GetLoadBalancerMetricDataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLoadBalancerMetricDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
