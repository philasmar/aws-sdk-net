...
{
    /// <summary>
    /// Response Unmarshaller for CreateDomainEntry operation
    /// </summary>  
    public class CreateDomainEntryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDomainEntryResponse response = new CreateDomainEntryResponse();
        ...
        private static CreateDomainEntryResponseUnmarshaller _instance = new CreateDomainEntryResponseUnmarshaller();        

        internal static CreateDomainEntryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDomainEntryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
