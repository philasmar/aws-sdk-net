...
{
    /// <summary>
    /// Response Unmarshaller for DetachDisk operation
    /// </summary>  
    public class DetachDiskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetachDiskResponse response = new DetachDiskResponse();
        ...
        private static DetachDiskResponseUnmarshaller _instance = new DetachDiskResponseUnmarshaller();        

        internal static DetachDiskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachDiskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
