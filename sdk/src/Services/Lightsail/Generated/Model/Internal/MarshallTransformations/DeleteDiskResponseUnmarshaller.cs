...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDisk operation
    /// </summary>  
    public class DeleteDiskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDiskResponse response = new DeleteDiskResponse();
        ...
        private static DeleteDiskResponseUnmarshaller _instance = new DeleteDiskResponseUnmarshaller();        

        internal static DeleteDiskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDiskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
