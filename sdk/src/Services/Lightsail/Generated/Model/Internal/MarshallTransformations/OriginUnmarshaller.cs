...
namespace Amazon.Lightsail.Model.Internal.MarshallTransformations
{
    ...
    public class OriginUnmarshaller : IUnmarshaller<Origin, XmlUnmarshallerContext>, IUnmarshaller<Origin, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        Origin IUnmarshaller<Origin, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public Origin Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ProtocolPolicy = unmarshaller.Unmarshall(context);
                    continue;
                }
