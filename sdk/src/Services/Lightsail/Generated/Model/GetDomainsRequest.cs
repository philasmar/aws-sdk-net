...
{
    /// <summary>
    /// Container for the parameters to the GetDomains operation.
    /// Returns a list of all domains in the user's account.
    /// </summary>
    public partial class GetDomainsRequest : AmazonLightsailRequest
    {
        ...
        ///  
        /// <para>
        /// To get a page token, perform an initial <code>GetDomains</code> request. If your results
