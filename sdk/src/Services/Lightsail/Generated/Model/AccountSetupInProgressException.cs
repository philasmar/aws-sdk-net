...
namespace Amazon.Lightsail.Model
{
    ...
    public partial class AccountSetupInProgressException : AmazonLightsailException
    {
        ...
        /// <summary>
        /// Construct instance of AccountSetupInProgressException
        /// </summary>
        /// <param name="message"></param>
        /// <param name="innerException"></param>
        public AccountSetupInProgressException(string message, Exception innerException) 
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public AccountSetupInProgressException(Exception innerException) 
            : base(innerException) {}
        ...
        public AccountSetupInProgressException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public AccountSetupInProgressException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected AccountSetupInProgressException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
