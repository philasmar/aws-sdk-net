...
{
    /// <summary>
    /// Response Unmarshaller for CreateElasticsearchDomain operation
    /// </summary>  
    public class CreateElasticsearchDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateElasticsearchDomainResponse response = new CreateElasticsearchDomainResponse();
        ...
        private static CreateElasticsearchDomainResponseUnmarshaller _instance = new CreateElasticsearchDomainResponseUnmarshaller();        

        internal static CreateElasticsearchDomainResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateElasticsearchDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
