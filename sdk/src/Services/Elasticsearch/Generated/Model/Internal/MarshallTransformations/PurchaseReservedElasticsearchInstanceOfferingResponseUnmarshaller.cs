...
{
    /// <summary>
    /// Response Unmarshaller for PurchaseReservedElasticsearchInstanceOffering operation
    /// </summary>  
    public class PurchaseReservedElasticsearchInstanceOfferingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PurchaseReservedElasticsearchInstanceOfferingResponse response = new PurchaseReservedElasticsearchInstanceOfferingResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ReservationName", targetDepth))
                {
                    ...
                    response.ReservationName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("ReservedElasticsearchInstanceId", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ReservedElasticsearchInstanceId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static PurchaseReservedElasticsearchInstanceOfferingResponseUnmarshaller _instance = new PurchaseReservedElasticsearchInstanceOfferingResponseUnmarshaller();        

        internal static PurchaseReservedElasticsearchInstanceOfferingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PurchaseReservedElasticsearchInstanceOfferingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
