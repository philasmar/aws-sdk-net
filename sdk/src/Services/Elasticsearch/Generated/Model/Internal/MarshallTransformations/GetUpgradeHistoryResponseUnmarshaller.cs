...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetUpgradeHistoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetUpgradeHistoryResponse response = new GetUpgradeHistoryResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<UpgradeHistory, UpgradeHistoryUnmarshaller>(UpgradeHistoryUnmarshaller.Instance);
                    response.UpgradeHistories = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        internal static GetUpgradeHistoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUpgradeHistoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
