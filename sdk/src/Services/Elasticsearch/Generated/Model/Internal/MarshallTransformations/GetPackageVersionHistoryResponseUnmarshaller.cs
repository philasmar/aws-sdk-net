...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetPackageVersionHistoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetPackageVersionHistoryResponse response = new GetPackageVersionHistoryResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PackageVersionHistory, PackageVersionHistoryUnmarshaller>(PackageVersionHistoryUnmarshaller.Instance);
                    response.PackageVersionHistoryList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        internal static GetPackageVersionHistoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPackageVersionHistoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
