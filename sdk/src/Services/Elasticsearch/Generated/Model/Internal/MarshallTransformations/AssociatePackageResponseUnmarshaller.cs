...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AssociatePackageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociatePackageResponse response = new AssociatePackageResponse();
        ...
        internal static AssociatePackageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociatePackageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
