...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetUpgradeStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("StepStatus", targetDepth))
                {
                    ...
                    response.StepStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("UpgradeName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.UpgradeName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("UpgradeStep", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.UpgradeStep = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        internal static GetUpgradeStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetUpgradeStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
