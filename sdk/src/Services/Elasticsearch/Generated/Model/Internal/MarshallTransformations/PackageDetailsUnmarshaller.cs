...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PackageDetailsUnmarshaller : IUnmarshaller<PackageDetails, XmlUnmarshallerContext>, IUnmarshaller<PackageDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PackageDetails IUnmarshaller<PackageDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public PackageDetails Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PackageStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
