...
{
    /// <summary>
    /// DeleteElasticsearchDomain Request Marshaller
    /// </summary>       
    public class DeleteElasticsearchDomainRequestMarshaller : IMarshaller<IRequest, DeleteElasticsearchDomainRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteElasticsearchDomainRequest)input);
        }
