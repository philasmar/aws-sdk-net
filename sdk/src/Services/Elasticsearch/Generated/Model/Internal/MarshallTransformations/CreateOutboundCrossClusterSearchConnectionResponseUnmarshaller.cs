...
{
    /// <summary>
    /// Response Unmarshaller for CreateOutboundCrossClusterSearchConnection operation
    /// </summary>  
    public class CreateOutboundCrossClusterSearchConnectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateOutboundCrossClusterSearchConnectionResponse response = new CreateOutboundCrossClusterSearchConnectionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.CrossClusterSearchConnectionId = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("DestinationDomainInfo", targetDepth))
                {
                    var unmarshaller = DomainInformationUnmarshaller.Instance;
                    response.DestinationDomainInfo = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SourceDomainInfo", targetDepth))
                {
                    var unmarshaller = DomainInformationUnmarshaller.Instance;
                    response.SourceDomainInfo = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateOutboundCrossClusterSearchConnectionResponseUnmarshaller _instance = new CreateOutboundCrossClusterSearchConnectionResponseUnmarshaller();        

        internal static CreateOutboundCrossClusterSearchConnectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateOutboundCrossClusterSearchConnectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
