...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePackage operation
    /// </summary>  
    public class UpdatePackageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdatePackageResponseUnmarshaller _instance = new UpdatePackageResponseUnmarshaller();        

        internal static UpdatePackageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePackageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
