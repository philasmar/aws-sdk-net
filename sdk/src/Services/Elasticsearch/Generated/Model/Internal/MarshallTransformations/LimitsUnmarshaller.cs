...
namespace Amazon.Elasticsearch.Model.Internal.MarshallTransformations
{
    ...
    public class LimitsUnmarshaller : IUnmarshaller<Limits, XmlUnmarshallerContext>, IUnmarshaller<Limits, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        Limits IUnmarshaller<Limits, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public Limits Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AdditionalLimit, AdditionalLimitUnmarshaller>(AdditionalLimitUnmarshaller.Instance);
                    unmarshalledObject.AdditionalLimits = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("InstanceLimits", targetDepth))
                {
                    var unmarshaller = InstanceLimitsUnmarshaller.Instance;
                    unmarshalledObject.InstanceLimits = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("StorageTypes", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<StorageType, StorageTypeUnmarshaller>(StorageTypeUnmarshaller.Instance);
                    unmarshalledObject.StorageTypes = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
