...
{
    /// <summary>
    /// Response Unmarshaller for DescribePackages operation
    /// </summary>  
    public class DescribePackagesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribePackagesResponse response = new DescribePackagesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PackageDetails, PackageDetailsUnmarshaller>(PackageDetailsUnmarshaller.Instance);
                    response.PackageDetailsList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribePackagesResponseUnmarshaller _instance = new DescribePackagesResponseUnmarshaller();        

        internal static DescribePackagesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribePackagesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
