...
{
    /// <summary>
    /// Response Unmarshaller for GetCompatibleElasticsearchVersions operation
    /// </summary>  
    public class GetCompatibleElasticsearchVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetCompatibleElasticsearchVersionsResponse response = new GetCompatibleElasticsearchVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<CompatibleVersionsMap, CompatibleVersionsMapUnmarshaller>(CompatibleVersionsMapUnmarshaller.Instance);
                    response.CompatibleElasticsearchVersions = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetCompatibleElasticsearchVersionsResponseUnmarshaller _instance = new GetCompatibleElasticsearchVersionsResponseUnmarshaller();        

        internal static GetCompatibleElasticsearchVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCompatibleElasticsearchVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
