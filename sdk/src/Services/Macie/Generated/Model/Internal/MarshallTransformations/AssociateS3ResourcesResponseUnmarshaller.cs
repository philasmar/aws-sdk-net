...
{
    /// <summary>
    /// Response Unmarshaller for AssociateS3Resources operation
    /// </summary>  
    public class AssociateS3ResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateS3ResourcesResponse response = new AssociateS3ResourcesResponse();
        ...
        private static AssociateS3ResourcesResponseUnmarshaller _instance = new AssociateS3ResourcesResponseUnmarshaller();        

        internal static AssociateS3ResourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateS3ResourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
