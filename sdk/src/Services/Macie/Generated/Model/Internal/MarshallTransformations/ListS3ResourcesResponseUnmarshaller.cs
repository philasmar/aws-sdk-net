...
{
    /// <summary>
    /// Response Unmarshaller for ListS3Resources operation
    /// </summary>  
    public class ListS3ResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListS3ResourcesResponseUnmarshaller _instance = new ListS3ResourcesResponseUnmarshaller();        

        internal static ListS3ResourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListS3ResourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
