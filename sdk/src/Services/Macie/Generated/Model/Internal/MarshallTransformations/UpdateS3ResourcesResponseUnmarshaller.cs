...
{
    /// <summary>
    /// Response Unmarshaller for UpdateS3Resources operation
    /// </summary>  
    public class UpdateS3ResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateS3ResourcesResponse response = new UpdateS3ResourcesResponse();
        ...
        private static UpdateS3ResourcesResponseUnmarshaller _instance = new UpdateS3ResourcesResponseUnmarshaller();        

        internal static UpdateS3ResourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateS3ResourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
