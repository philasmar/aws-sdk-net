...
{
    /// <summary>
    /// Response Unmarshaller for GetEventSelectors operation
    /// </summary>  
    public class GetEventSelectorsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetEventSelectorsResponse response = new GetEventSelectorsResponse();
        ...
        private static GetEventSelectorsResponseUnmarshaller _instance = new GetEventSelectorsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEventSelectorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
