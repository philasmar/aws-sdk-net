...
namespace Amazon.CloudTrail.Model.Internal.MarshallTransformations
{
    ...
    public class ListTagsRequestMarshaller : IMarshaller<IRequest, ListTagsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListTagsRequest publicRequest)
        {
            ...
            string target = "com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.ListTags";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetResourceIdList())
                {
                    context.Writer.WritePropertyName("ResourceIdList");
                    context.Writer.WriteArrayStart();
                    foreach(var publicRequestResourceIdListListValue in publicRequest.ResourceIdList)
                    {
                            context.Writer.Write(publicRequestResourceIdListListValue);
                    }
