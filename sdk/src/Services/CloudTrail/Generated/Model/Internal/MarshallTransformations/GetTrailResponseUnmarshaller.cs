...
{
    /// <summary>
    /// Response Unmarshaller for GetTrail operation
    /// </summary>  
    public class GetTrailResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTrailResponse response = new GetTrailResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = TrailUnmarshaller.Instance;
                    response.Trail = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetTrailResponseUnmarshaller _instance = new GetTrailResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTrailResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
