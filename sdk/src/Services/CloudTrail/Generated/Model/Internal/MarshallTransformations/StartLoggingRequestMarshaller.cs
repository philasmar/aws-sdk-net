...
{
    /// <summary>
    /// StartLogging Request Marshaller
    /// </summary>       
    public class StartLoggingRequestMarshaller : IMarshaller<IRequest, StartLoggingRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        private static StartLoggingRequestMarshaller _instance = new StartLoggingRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartLoggingRequestMarshaller Instance
        {
            get
            {
                return _instance;
