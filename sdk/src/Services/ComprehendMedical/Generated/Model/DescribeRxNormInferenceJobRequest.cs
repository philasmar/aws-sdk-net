...
{
    /// <summary>
    /// Container for the parameters to the DescribeRxNormInferenceJob operation.
    /// Gets the properties associated with an InferRxNorm job. Use this operation to get
    /// the status of an inference job.
    /// </summary>
    public partial class DescribeRxNormInferenceJobRequest : AmazonComprehendMedicalRequest
    {
