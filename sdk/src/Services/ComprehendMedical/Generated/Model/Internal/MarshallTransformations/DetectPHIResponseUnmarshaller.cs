...
{
    /// <summary>
    /// Response Unmarshaller for DetectPHI operation
    /// </summary>  
    public class DetectPHIResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetectPHIResponse response = new DetectPHIResponse();
        ...
        private static DetectPHIResponseUnmarshaller _instance = new DetectPHIResponseUnmarshaller();        

        internal static DetectPHIResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectPHIResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
