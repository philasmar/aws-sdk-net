...
{
    /// <summary>
    /// Response Unmarshaller for InferRxNorm operation
    /// </summary>  
    public class InferRxNormResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            InferRxNormResponse response = new InferRxNormResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RxNormEntity, RxNormEntityUnmarshaller>(RxNormEntityUnmarshaller.Instance);
        ...
        private static InferRxNormResponseUnmarshaller _instance = new InferRxNormResponseUnmarshaller();        

        internal static InferRxNormResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InferRxNormResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
