...
{
    /// <summary>
    /// StartRxNormInferenceJob Request Marshaller
    /// </summary>       
    public class StartRxNormInferenceJobRequestMarshaller : IMarshaller<IRequest, StartRxNormInferenceJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartRxNormInferenceJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartRxNormInferenceJobRequest publicRequest)
        {
        ...
        private static StartRxNormInferenceJobRequestMarshaller _instance = new StartRxNormInferenceJobRequestMarshaller();        

        internal static StartRxNormInferenceJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartRxNormInferenceJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
