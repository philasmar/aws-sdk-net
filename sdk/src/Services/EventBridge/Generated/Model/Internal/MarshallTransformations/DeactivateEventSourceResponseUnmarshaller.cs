...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeactivateEventSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeactivateEventSourceResponse response = new DeactivateEventSourceResponse();
        ...
        private static DeactivateEventSourceResponseUnmarshaller _instance = new DeactivateEventSourceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeactivateEventSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
