...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EnableRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnableRuleResponse response = new EnableRuleResponse();
        ...
        private static EnableRuleResponseUnmarshaller _instance = new EnableRuleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
