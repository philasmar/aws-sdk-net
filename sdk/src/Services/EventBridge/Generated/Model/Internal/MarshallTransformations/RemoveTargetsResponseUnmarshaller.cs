...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RemoveTargetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveTargetsResponse response = new RemoveTargetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<RemoveTargetsResultEntry, RemoveTargetsResultEntryUnmarshaller>(RemoveTargetsResultEntryUnmarshaller.Instance);
        ...
        private static RemoveTargetsResponseUnmarshaller _instance = new RemoveTargetsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveTargetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
