...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListReplaysResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListReplaysResponse response = new ListReplaysResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Replay, ReplayUnmarshaller>(ReplayUnmarshaller.Instance);
                    response.Replays = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListReplaysResponseUnmarshaller _instance = new ListReplaysResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListReplaysResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
