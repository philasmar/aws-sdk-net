...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListPartnerEventSourceAccountsRequestMarshaller : IMarshaller<IRequest, ListPartnerEventSourceAccountsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListPartnerEventSourceAccountsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListPartnerEventSourceAccountsRequest publicRequest)
        {
        ...
        private static ListPartnerEventSourceAccountsRequestMarshaller _instance = new ListPartnerEventSourceAccountsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPartnerEventSourceAccountsRequestMarshaller Instance
        {
            get
            {
                return _instance;
