...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutTargetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutTargetsResponse response = new PutTargetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<PutTargetsResultEntry, PutTargetsResultEntryUnmarshaller>(PutTargetsResultEntryUnmarshaller.Instance);
        ...
        private static PutTargetsResponseUnmarshaller _instance = new PutTargetsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutTargetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
