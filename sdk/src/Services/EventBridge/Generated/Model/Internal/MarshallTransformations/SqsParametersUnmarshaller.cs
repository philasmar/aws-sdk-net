...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SqsParametersUnmarshaller : IUnmarshaller<SqsParameters, XmlUnmarshallerContext>, IUnmarshaller<SqsParameters, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        SqsParameters IUnmarshaller<SqsParameters, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
