...
namespace Amazon.EventBridge.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class EnableRuleRequestMarshaller : IMarshaller<IRequest, EnableRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((EnableRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(EnableRuleRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.EventBridge");
            string target = "AWSEvents.EnableRule";
