...
namespace Amazon.Backup.Model
{
    ...
    public partial class ListBackupSelectionsResponse : AmazonWebServiceResponse
    {
        ...
        /// <summary>
        /// Gets and sets the property BackupSelectionsList. 
        /// <para>
        /// An array of backup selection list items containing metadata about each resource in
        /// the list.
        /// </para>
        /// </summary>
        public List<BackupSelectionsListMember> BackupSelectionsList
        {
            get { return this._backupSelectionsList; }
            set { this._backupSelectionsList = value; }
        }
