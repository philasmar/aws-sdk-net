...
{
    /// <summary>
    /// DeleteRecoveryPoint Request Marshaller
    /// </summary>       
    public class DeleteRecoveryPointRequestMarshaller : IMarshaller<IRequest, DeleteRecoveryPointRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteRecoveryPointRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteRecoveryPointRequest publicRequest)
        {
        ...
        private static DeleteRecoveryPointRequestMarshaller _instance = new DeleteRecoveryPointRequestMarshaller();        

        internal static DeleteRecoveryPointRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteRecoveryPointRequestMarshaller Instance
        {
            get
            {
                return _instance;
