...
{
    /// <summary>
    /// Response Unmarshaller for GetBackupVaultNotifications operation
    /// </summary>  
    public class GetBackupVaultNotificationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBackupVaultNotificationsResponse response = new GetBackupVaultNotificationsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("BackupVaultEvents", targetDepth))
                {
                    ...
                    response.BackupVaultEvents = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetBackupVaultNotificationsResponseUnmarshaller _instance = new GetBackupVaultNotificationsResponseUnmarshaller();        

        internal static GetBackupVaultNotificationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBackupVaultNotificationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
