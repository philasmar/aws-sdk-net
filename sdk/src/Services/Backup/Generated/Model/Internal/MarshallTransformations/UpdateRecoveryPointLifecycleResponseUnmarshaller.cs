...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRecoveryPointLifecycle operation
    /// </summary>  
    public class UpdateRecoveryPointLifecycleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRecoveryPointLifecycleResponse response = new UpdateRecoveryPointLifecycleResponse();
        ...
        private static UpdateRecoveryPointLifecycleResponseUnmarshaller _instance = new UpdateRecoveryPointLifecycleResponseUnmarshaller();        

        internal static UpdateRecoveryPointLifecycleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRecoveryPointLifecycleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
