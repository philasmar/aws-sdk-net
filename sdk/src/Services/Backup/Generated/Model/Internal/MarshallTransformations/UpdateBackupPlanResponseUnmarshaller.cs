...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBackupPlan operation
    /// </summary>  
    public class UpdateBackupPlanResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBackupPlanResponse response = new UpdateBackupPlanResponse();
        ...
        private static UpdateBackupPlanResponseUnmarshaller _instance = new UpdateBackupPlanResponseUnmarshaller();        

        internal static UpdateBackupPlanResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBackupPlanResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
