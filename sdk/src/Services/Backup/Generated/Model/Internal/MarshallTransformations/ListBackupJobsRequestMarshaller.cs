...
{
    /// <summary>
    /// ListBackupJobs Request Marshaller
    /// </summary>       
    public class ListBackupJobsRequestMarshaller : IMarshaller<IRequest, ListBackupJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListBackupJobsRequest)input);
        }
        ...
        private static ListBackupJobsRequestMarshaller _instance = new ListBackupJobsRequestMarshaller();        

        internal static ListBackupJobsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBackupJobsRequestMarshaller Instance
        {
            get
            {
                return _instance;
