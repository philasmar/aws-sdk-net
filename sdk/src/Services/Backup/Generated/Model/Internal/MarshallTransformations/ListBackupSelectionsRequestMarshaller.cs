...
namespace Amazon.Backup.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListBackupSelectionsRequestMarshaller : IMarshaller<IRequest, ListBackupSelectionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListBackupSelectionsRequestMarshaller _instance = new ListBackupSelectionsRequestMarshaller();        

        internal static ListBackupSelectionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBackupSelectionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
