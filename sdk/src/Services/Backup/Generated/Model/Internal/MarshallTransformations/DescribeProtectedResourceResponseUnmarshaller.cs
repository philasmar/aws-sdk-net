...
{
    /// <summary>
    /// Response Unmarshaller for DescribeProtectedResource operation
    /// </summary>  
    public class DescribeProtectedResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeProtectedResourceResponse response = new DescribeProtectedResourceResponse();
        ...
        private static DescribeProtectedResourceResponseUnmarshaller _instance = new DescribeProtectedResourceResponseUnmarshaller();        

        internal static DescribeProtectedResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeProtectedResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
