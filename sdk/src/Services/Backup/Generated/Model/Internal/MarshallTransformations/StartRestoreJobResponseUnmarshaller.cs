...
{
    /// <summary>
    /// Response Unmarshaller for StartRestoreJob operation
    /// </summary>  
    public class StartRestoreJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartRestoreJobResponse response = new StartRestoreJobResponse();
        ...
        private static StartRestoreJobResponseUnmarshaller _instance = new StartRestoreJobResponseUnmarshaller();        

        internal static StartRestoreJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartRestoreJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
