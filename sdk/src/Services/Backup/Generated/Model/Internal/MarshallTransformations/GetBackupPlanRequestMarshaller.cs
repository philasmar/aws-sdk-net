...
namespace Amazon.Backup.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetBackupPlanRequestMarshaller : IMarshaller<IRequest, GetBackupPlanRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetBackupPlanRequestMarshaller _instance = new GetBackupPlanRequestMarshaller();        

        internal static GetBackupPlanRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBackupPlanRequestMarshaller Instance
        {
            get
            {
                return _instance;
