...
namespace Amazon.WorkMail.Model
{
    ...
    [Serializable]
    #endif
    public partial class DirectoryUnavailableException : AmazonWorkMailException
    {
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public DirectoryUnavailableException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
