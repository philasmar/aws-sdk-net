...
{
    /// <summary>
    /// DeregisterFromWorkMail Request Marshaller
    /// </summary>       
    public class DeregisterFromWorkMailRequestMarshaller : IMarshaller<IRequest, DeregisterFromWorkMailRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeregisterFromWorkMailRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeregisterFromWorkMailRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WorkMail");
            string target = "WorkMailService.DeregisterFromWorkMail";
