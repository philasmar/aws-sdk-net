...
{
    /// <summary>
    /// Response Unmarshaller for DeleteMailboxPermissions operation
    /// </summary>  
    public class DeleteMailboxPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMailboxPermissionsResponse response = new DeleteMailboxPermissionsResponse();
        ...
        private static DeleteMailboxPermissionsResponseUnmarshaller _instance = new DeleteMailboxPermissionsResponseUnmarshaller();        

        internal static DeleteMailboxPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMailboxPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
