...
{
    /// <summary>
    /// RegisterToWorkMail Request Marshaller
    /// </summary>       
    public class RegisterToWorkMailRequestMarshaller : IMarshaller<IRequest, RegisterToWorkMailRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RegisterToWorkMailRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RegisterToWorkMailRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WorkMail");
            string target = "WorkMailService.RegisterToWorkMail";
