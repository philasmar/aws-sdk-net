...
{
    /// <summary>
    /// Response Unmarshaller for ListResourceDelegates operation
    /// </summary>  
    public class ListResourceDelegatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListResourceDelegatesResponse response = new ListResourceDelegatesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Delegate, DelegateUnmarshaller>(DelegateUnmarshaller.Instance);
                    response.Delegates = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListResourceDelegatesResponseUnmarshaller _instance = new ListResourceDelegatesResponseUnmarshaller();        

        internal static ListResourceDelegatesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListResourceDelegatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
