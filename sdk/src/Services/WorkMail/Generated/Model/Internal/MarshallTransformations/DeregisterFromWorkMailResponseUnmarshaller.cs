...
{
    /// <summary>
    /// Response Unmarshaller for DeregisterFromWorkMail operation
    /// </summary>  
    public class DeregisterFromWorkMailResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterFromWorkMailResponse response = new DeregisterFromWorkMailResponse();
        ...
        private static DeregisterFromWorkMailResponseUnmarshaller _instance = new DeregisterFromWorkMailResponseUnmarshaller();        

        internal static DeregisterFromWorkMailResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterFromWorkMailResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
