...
{
    /// <summary>
    /// Response Unmarshaller for AssociateDelegateToResource operation
    /// </summary>  
    public class AssociateDelegateToResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateDelegateToResourceResponse response = new AssociateDelegateToResourceResponse();
        ...
        private static AssociateDelegateToResourceResponseUnmarshaller _instance = new AssociateDelegateToResourceResponseUnmarshaller();        

        internal static AssociateDelegateToResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateDelegateToResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
