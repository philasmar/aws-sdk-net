...
{
    /// <summary>
    /// Response Unmarshaller for AssociateMemberToGroup operation
    /// </summary>  
    public class AssociateMemberToGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateMemberToGroupResponse response = new AssociateMemberToGroupResponse();
        ...
        private static AssociateMemberToGroupResponseUnmarshaller _instance = new AssociateMemberToGroupResponseUnmarshaller();        

        internal static AssociateMemberToGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateMemberToGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
