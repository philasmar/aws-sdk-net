...
{
    /// <summary>
    /// Response Unmarshaller for UpdateMailboxQuota operation
    /// </summary>  
    public class UpdateMailboxQuotaResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMailboxQuotaResponse response = new UpdateMailboxQuotaResponse();
        ...
        private static UpdateMailboxQuotaResponseUnmarshaller _instance = new UpdateMailboxQuotaResponseUnmarshaller();        

        internal static UpdateMailboxQuotaResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMailboxQuotaResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
