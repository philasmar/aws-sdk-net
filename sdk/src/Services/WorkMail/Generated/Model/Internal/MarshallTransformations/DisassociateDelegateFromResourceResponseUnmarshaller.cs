...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateDelegateFromResource operation
    /// </summary>  
    public class DisassociateDelegateFromResourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateDelegateFromResourceResponse response = new DisassociateDelegateFromResourceResponse();
        ...
        private static DisassociateDelegateFromResourceResponseUnmarshaller _instance = new DisassociateDelegateFromResourceResponseUnmarshaller();        

        internal static DisassociateDelegateFromResourceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateDelegateFromResourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
