...
{
    /// <summary>
    /// Response Unmarshaller for ListMailboxExportJobs operation
    /// </summary>  
    public class ListMailboxExportJobsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMailboxExportJobsResponse response = new ListMailboxExportJobsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<MailboxExportJob, MailboxExportJobUnmarshaller>(MailboxExportJobUnmarshaller.Instance);
        ...
        private static ListMailboxExportJobsResponseUnmarshaller _instance = new ListMailboxExportJobsResponseUnmarshaller();        

        internal static ListMailboxExportJobsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMailboxExportJobsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
