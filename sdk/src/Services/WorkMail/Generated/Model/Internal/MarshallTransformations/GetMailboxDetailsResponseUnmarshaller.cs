...
{
    /// <summary>
    /// Response Unmarshaller for GetMailboxDetails operation
    /// </summary>  
    public class GetMailboxDetailsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetMailboxDetailsResponse response = new GetMailboxDetailsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("MailboxQuota", targetDepth))
                {
                    ...
                    response.MailboxQuota = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("MailboxSize", targetDepth))
                {
                    var unmarshaller = DoubleUnmarshaller.Instance;
                    response.MailboxSize = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetMailboxDetailsResponseUnmarshaller _instance = new GetMailboxDetailsResponseUnmarshaller();        

        internal static GetMailboxDetailsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMailboxDetailsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
