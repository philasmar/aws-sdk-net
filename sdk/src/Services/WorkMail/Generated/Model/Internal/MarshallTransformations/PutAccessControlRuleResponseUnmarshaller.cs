...
{
    /// <summary>
    /// Response Unmarshaller for PutAccessControlRule operation
    /// </summary>  
    public class PutAccessControlRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutAccessControlRuleResponse response = new PutAccessControlRuleResponse();
        ...
        private static PutAccessControlRuleResponseUnmarshaller _instance = new PutAccessControlRuleResponseUnmarshaller();        

        internal static PutAccessControlRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutAccessControlRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
