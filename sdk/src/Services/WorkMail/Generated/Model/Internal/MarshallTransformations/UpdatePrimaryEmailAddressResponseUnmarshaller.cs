...
{
    /// <summary>
    /// Response Unmarshaller for UpdatePrimaryEmailAddress operation
    /// </summary>  
    public class UpdatePrimaryEmailAddressResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdatePrimaryEmailAddressResponse response = new UpdatePrimaryEmailAddressResponse();
        ...
        private static UpdatePrimaryEmailAddressResponseUnmarshaller _instance = new UpdatePrimaryEmailAddressResponseUnmarshaller();        

        internal static UpdatePrimaryEmailAddressResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePrimaryEmailAddressResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
