...
{
    /// <summary>
    /// Response Unmarshaller for ListMailboxPermissions operation
    /// </summary>  
    public class ListMailboxPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListMailboxPermissionsResponse response = new ListMailboxPermissionsResponse();
        ...
        private static ListMailboxPermissionsResponseUnmarshaller _instance = new ListMailboxPermissionsResponseUnmarshaller();        

        internal static ListMailboxPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListMailboxPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
