...
{
    /// <summary>
    /// Response Unmarshaller for PutMailboxPermissions operation
    /// </summary>  
    public class PutMailboxPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutMailboxPermissionsResponse response = new PutMailboxPermissionsResponse();
        ...
        private static PutMailboxPermissionsResponseUnmarshaller _instance = new PutMailboxPermissionsResponseUnmarshaller();        

        internal static PutMailboxPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutMailboxPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
