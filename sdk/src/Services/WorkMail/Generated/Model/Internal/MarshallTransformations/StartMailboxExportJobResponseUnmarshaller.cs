...
{
    /// <summary>
    /// Response Unmarshaller for StartMailboxExportJob operation
    /// </summary>  
    public class StartMailboxExportJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartMailboxExportJobResponse response = new StartMailboxExportJobResponse();
        ...
        private static StartMailboxExportJobResponseUnmarshaller _instance = new StartMailboxExportJobResponseUnmarshaller();        

        internal static StartMailboxExportJobResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMailboxExportJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
