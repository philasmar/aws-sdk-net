...
{
    /// <summary>
    /// Response Unmarshaller for GetDefaultRetentionPolicy operation
    /// </summary>  
    public class GetDefaultRetentionPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDefaultRetentionPolicyResponse response = new GetDefaultRetentionPolicyResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<FolderConfiguration, FolderConfigurationUnmarshaller>(FolderConfigurationUnmarshaller.Instance);
                    response.FolderConfigurations = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GetDefaultRetentionPolicyResponseUnmarshaller _instance = new GetDefaultRetentionPolicyResponseUnmarshaller();        

        internal static GetDefaultRetentionPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDefaultRetentionPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
