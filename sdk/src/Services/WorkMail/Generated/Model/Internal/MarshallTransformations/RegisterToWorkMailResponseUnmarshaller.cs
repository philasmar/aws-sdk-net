...
{
    /// <summary>
    /// Response Unmarshaller for RegisterToWorkMail operation
    /// </summary>  
    public class RegisterToWorkMailResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterToWorkMailResponse response = new RegisterToWorkMailResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("EmailAddressInUseException"))
                {
                    return EmailAddressInUseExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("EntityAlreadyRegisteredException"))
                {
                    return EntityAlreadyRegisteredExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("MailDomainStateException"))
                {
                    return MailDomainStateExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static RegisterToWorkMailResponseUnmarshaller _instance = new RegisterToWorkMailResponseUnmarshaller();        

        internal static RegisterToWorkMailResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterToWorkMailResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
