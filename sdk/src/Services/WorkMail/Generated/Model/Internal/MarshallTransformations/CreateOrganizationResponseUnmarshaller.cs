...
namespace Amazon.WorkMail.Model.Internal.MarshallTransformations
{
    ...
    public class CreateOrganizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("DirectoryInUseException"))
                {
                    return DirectoryInUseExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
