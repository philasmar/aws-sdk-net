...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAccessControlRule operation
    /// </summary>  
    public class DeleteAccessControlRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAccessControlRuleResponse response = new DeleteAccessControlRuleResponse();
        ...
        private static DeleteAccessControlRuleResponseUnmarshaller _instance = new DeleteAccessControlRuleResponseUnmarshaller();        

        internal static DeleteAccessControlRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAccessControlRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
