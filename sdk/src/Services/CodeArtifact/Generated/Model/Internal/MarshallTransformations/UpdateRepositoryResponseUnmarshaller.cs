...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRepository operation
    /// </summary>  
    public class UpdateRepositoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateRepositoryResponseUnmarshaller _instance = new UpdateRepositoryResponseUnmarshaller();        

        internal static UpdateRepositoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRepositoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
