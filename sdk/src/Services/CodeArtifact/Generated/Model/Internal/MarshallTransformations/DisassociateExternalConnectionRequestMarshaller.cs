...
{
    /// <summary>
    /// DisassociateExternalConnection Request Marshaller
    /// </summary>       
    public class DisassociateExternalConnectionRequestMarshaller : IMarshaller<IRequest, DisassociateExternalConnectionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisassociateExternalConnectionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisassociateExternalConnectionRequest publicRequest)
        {
        ...
        private static DisassociateExternalConnectionRequestMarshaller _instance = new DisassociateExternalConnectionRequestMarshaller();        

        internal static DisassociateExternalConnectionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateExternalConnectionRequestMarshaller Instance
        {
            get
            {
                return _instance;
