...
{
    /// <summary>
    /// DisposePackageVersions Request Marshaller
    /// </summary>       
    public class DisposePackageVersionsRequestMarshaller : IMarshaller<IRequest, DisposePackageVersionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisposePackageVersionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisposePackageVersionsRequest publicRequest)
        {
            ...
            request.ResourcePath = "/v1/package/versions/dispose";
        ...
        private static DisposePackageVersionsRequestMarshaller _instance = new DisposePackageVersionsRequestMarshaller();        

        internal static DisposePackageVersionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisposePackageVersionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
