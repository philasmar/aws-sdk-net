...
namespace Amazon.Synthetics.Model
{
    ...
    internal sealed partial class DescribeRuntimeVersionsPaginator : IPaginator<DescribeRuntimeVersionsResponse>, IDescribeRuntimeVersionsPaginator
    {
        ...
        async IAsyncEnumerable<DescribeRuntimeVersionsResponse> IPaginator<DescribeRuntimeVersionsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
