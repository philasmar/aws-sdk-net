...
namespace Amazon.KinesisVideoSignalingChannels.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SendAlexaOfferToMasterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendAlexaOfferToMasterResponse response = new SendAlexaOfferToMasterResponse();
        ...
        private static SendAlexaOfferToMasterResponseUnmarshaller _instance = new SendAlexaOfferToMasterResponseUnmarshaller();        

        internal static SendAlexaOfferToMasterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendAlexaOfferToMasterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
