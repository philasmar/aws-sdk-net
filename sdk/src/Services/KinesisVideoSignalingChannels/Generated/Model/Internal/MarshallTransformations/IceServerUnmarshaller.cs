...
namespace Amazon.KinesisVideoSignalingChannels.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IceServerUnmarshaller : IUnmarshaller<IceServer, XmlUnmarshallerContext>, IUnmarshaller<IceServer, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        IceServer IUnmarshaller<IceServer, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
