...
namespace Amazon.KinesisVideoSignalingChannels.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetIceServerConfigRequestMarshaller : IMarshaller<IRequest, GetIceServerConfigRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetIceServerConfigRequestMarshaller _instance = new GetIceServerConfigRequestMarshaller();        

        internal static GetIceServerConfigRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIceServerConfigRequestMarshaller Instance
        {
            get
            {
                return _instance;
