...
{
    /// <summary>
    /// DeleteTarget Request Marshaller
    /// </summary>       
    public class DeleteTargetRequestMarshaller : IMarshaller<IRequest, DeleteTargetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteTargetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteTargetRequest publicRequest)
        {
            ...
            request.ResourcePath = "/deleteTarget";
        ...
        private static DeleteTargetRequestMarshaller _instance = new DeleteTargetRequestMarshaller();        

        internal static DeleteTargetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTargetRequestMarshaller Instance
        {
            get
            {
                return _instance;
