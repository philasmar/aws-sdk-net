...
{
    /// <summary>
    /// Response Unmarshaller for TargetSummary Object
    /// </summary>  
    public class TargetSummaryUnmarshaller : IUnmarshaller<TargetSummary, XmlUnmarshallerContext>, IUnmarshaller<TargetSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        TargetSummary IUnmarshaller<TargetSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public TargetSummary Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("TargetAddress", targetDepth))
                {
                    ...
                    unmarshalledObject.TargetAddress = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static TargetSummaryUnmarshaller _instance = new TargetSummaryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static TargetSummaryUnmarshaller Instance
        {
            get
            {
                return _instance;
