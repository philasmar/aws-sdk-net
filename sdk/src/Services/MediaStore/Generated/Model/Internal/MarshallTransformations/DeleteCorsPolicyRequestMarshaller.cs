...
namespace Amazon.MediaStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteCorsPolicyRequestMarshaller : IMarshaller<IRequest, DeleteCorsPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteCorsPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteCorsPolicyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MediaStore");
            string target = "MediaStore_20170901.DeleteCorsPolicy";
