...
namespace Amazon.MediaStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListContainersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListContainersResponseUnmarshaller _instance = new ListContainersResponseUnmarshaller();        

        internal static ListContainersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListContainersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
