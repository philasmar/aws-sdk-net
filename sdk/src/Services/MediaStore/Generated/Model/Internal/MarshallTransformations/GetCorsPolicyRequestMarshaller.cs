...
namespace Amazon.MediaStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetCorsPolicyRequestMarshaller : IMarshaller<IRequest, GetCorsPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetCorsPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetCorsPolicyRequest publicRequest)
        {
        ...
        private static GetCorsPolicyRequestMarshaller _instance = new GetCorsPolicyRequestMarshaller();        

        internal static GetCorsPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetCorsPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
