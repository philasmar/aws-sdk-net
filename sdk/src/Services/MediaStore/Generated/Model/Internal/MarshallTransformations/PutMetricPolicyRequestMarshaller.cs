...
namespace Amazon.MediaStore.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class PutMetricPolicyRequestMarshaller : IMarshaller<IRequest, PutMetricPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutMetricPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutMetricPolicyRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MediaStore");
            string target = "MediaStore_20170901.PutMetricPolicy";
        ...
        private static PutMetricPolicyRequestMarshaller _instance = new PutMetricPolicyRequestMarshaller();        

        internal static PutMetricPolicyRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutMetricPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
