...
namespace Amazon.Comprehend.Model
{
    ...
    public partial class UnsupportedLanguageException : AmazonComprehendException
    {
        ...
        /// <summary>
        /// Construct instance of UnsupportedLanguageException
        /// </summary>
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public UnsupportedLanguageException(Exception innerException) 
            : base(innerException) {}
        ...
        public UnsupportedLanguageException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public UnsupportedLanguageException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected UnsupportedLanguageException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
