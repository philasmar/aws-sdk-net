...
namespace Amazon.Comprehend.Model
{
    ...
    internal sealed partial class ListEntitiesDetectionJobsPaginator : IPaginator<ListEntitiesDetectionJobsResponse>, IListEntitiesDetectionJobsPaginator
    {
        ...
        async IAsyncEnumerable<ListEntitiesDetectionJobsResponse> IPaginator<ListEntitiesDetectionJobsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
