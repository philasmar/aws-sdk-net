...
{
    /// <summary>
    /// Response Unmarshaller for DominantLanguageDetectionJobProperties Object
    /// </summary>  
    public class DominantLanguageDetectionJobPropertiesUnmarshaller : IUnmarshaller<DominantLanguageDetectionJobProperties, XmlUnmarshallerContext>, IUnmarshaller<DominantLanguageDetectionJobProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DominantLanguageDetectionJobProperties IUnmarshaller<DominantLanguageDetectionJobProperties, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DominantLanguageDetectionJobProperties Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            DominantLanguageDetectionJobProperties unmarshalledObject = new DominantLanguageDetectionJobProperties();
        ...
        private static DominantLanguageDetectionJobPropertiesUnmarshaller _instance = new DominantLanguageDetectionJobPropertiesUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DominantLanguageDetectionJobPropertiesUnmarshaller Instance
        {
            get
            {
                return _instance;
