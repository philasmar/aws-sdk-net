...
{
    /// <summary>
    /// Response Unmarshaller for DetectKeyPhrases operation
    /// </summary>  
    public class DetectKeyPhrasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DetectKeyPhrasesResponseUnmarshaller _instance = new DetectKeyPhrasesResponseUnmarshaller();        

        internal static DetectKeyPhrasesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectKeyPhrasesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
