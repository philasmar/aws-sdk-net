...
{
    /// <summary>
    /// Response Unmarshaller for DetectDominantLanguage operation
    /// </summary>  
    public class DetectDominantLanguageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DetectDominantLanguageResponseUnmarshaller _instance = new DetectDominantLanguageResponseUnmarshaller();        

        internal static DetectDominantLanguageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectDominantLanguageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
