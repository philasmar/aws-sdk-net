...
{
    /// <summary>
    /// StartKeyPhrasesDetectionJob Request Marshaller
    /// </summary>       
    public class StartKeyPhrasesDetectionJobRequestMarshaller : IMarshaller<IRequest, StartKeyPhrasesDetectionJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartKeyPhrasesDetectionJobRequest)input);
        }
        ...
        private static StartKeyPhrasesDetectionJobRequestMarshaller _instance = new StartKeyPhrasesDetectionJobRequestMarshaller();        

        internal static StartKeyPhrasesDetectionJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartKeyPhrasesDetectionJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
