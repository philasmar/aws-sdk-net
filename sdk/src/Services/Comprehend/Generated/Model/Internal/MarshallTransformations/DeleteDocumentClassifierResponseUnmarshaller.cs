...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDocumentClassifier operation
    /// </summary>  
    public class DeleteDocumentClassifierResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDocumentClassifierResponse response = new DeleteDocumentClassifierResponse();
        ...
        private static DeleteDocumentClassifierResponseUnmarshaller _instance = new DeleteDocumentClassifierResponseUnmarshaller();        

        internal static DeleteDocumentClassifierResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDocumentClassifierResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
