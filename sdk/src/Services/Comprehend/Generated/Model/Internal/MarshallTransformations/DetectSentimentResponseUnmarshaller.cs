...
{
    /// <summary>
    /// Response Unmarshaller for DetectSentiment operation
    /// </summary>  
    public class DetectSentimentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DetectSentimentResponseUnmarshaller _instance = new DetectSentimentResponseUnmarshaller();        

        internal static DetectSentimentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectSentimentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
