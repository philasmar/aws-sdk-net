...
{
    /// <summary>
    /// Response Unmarshaller for BatchDetectSentiment operation
    /// </summary>  
    public class BatchDetectSentimentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static BatchDetectSentimentResponseUnmarshaller _instance = new BatchDetectSentimentResponseUnmarshaller();        

        internal static BatchDetectSentimentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDetectSentimentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
