...
{
    /// <summary>
    /// StartTopicsDetectionJob Request Marshaller
    /// </summary>       
    public class StartTopicsDetectionJobRequestMarshaller : IMarshaller<IRequest, StartTopicsDetectionJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartTopicsDetectionJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartTopicsDetectionJobRequest publicRequest)
        {
