...
{
    /// <summary>
    /// DetectDominantLanguage Request Marshaller
    /// </summary>       
    public class DetectDominantLanguageRequestMarshaller : IMarshaller<IRequest, DetectDominantLanguageRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DetectDominantLanguageRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DetectDominantLanguageRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Comprehend");
            string target = "Comprehend_20171127.DetectDominantLanguage";
