...
{
    /// <summary>
    /// StartDominantLanguageDetectionJob Request Marshaller
    /// </summary>       
    public class StartDominantLanguageDetectionJobRequestMarshaller : IMarshaller<IRequest, StartDominantLanguageDetectionJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartDominantLanguageDetectionJobRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartDominantLanguageDetectionJobRequest publicRequest)
        {
        ...
        private static StartDominantLanguageDetectionJobRequestMarshaller _instance = new StartDominantLanguageDetectionJobRequestMarshaller();        

        internal static StartDominantLanguageDetectionJobRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDominantLanguageDetectionJobRequestMarshaller Instance
        {
            get
            {
                return _instance;
