...
namespace Amazon.Comprehend.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PiiEntitiesDetectionJobPropertiesUnmarshaller : IUnmarshaller<PiiEntitiesDetectionJobProperties, XmlUnmarshallerContext>, IUnmarshaller<PiiEntitiesDetectionJobProperties, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PiiEntitiesDetectionJobProperties IUnmarshaller<PiiEntitiesDetectionJobProperties, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public PiiEntitiesDetectionJobProperties Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("RedactionConfig", targetDepth))
                {
                    ...
                    unmarshalledObject.RedactionConfig = unmarshaller.Unmarshall(context);
                    continue;
                }
