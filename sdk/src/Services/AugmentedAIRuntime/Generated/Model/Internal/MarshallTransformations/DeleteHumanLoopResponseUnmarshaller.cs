...
{
    /// <summary>
    /// Response Unmarshaller for DeleteHumanLoop operation
    /// </summary>  
    public class DeleteHumanLoopResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteHumanLoopResponse response = new DeleteHumanLoopResponse();
        ...
        private static DeleteHumanLoopResponseUnmarshaller _instance = new DeleteHumanLoopResponseUnmarshaller();        

        internal static DeleteHumanLoopResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteHumanLoopResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
