...
namespace Amazon.AugmentedAIRuntime.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class StopHumanLoopResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopHumanLoopResponse response = new StopHumanLoopResponse();
        ...
        internal static StopHumanLoopResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopHumanLoopResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
