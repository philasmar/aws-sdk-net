...
{
    /// <summary>
    /// GetDetector Request Marshaller
    /// </summary>       
    public class GetDetectorRequestMarshaller : IMarshaller<IRequest, GetDetectorRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetDetectorRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetDetectorRequest publicRequest)
        {
