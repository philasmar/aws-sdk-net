...
{
    /// <summary>
    /// CreateThreatIntelSet Request Marshaller
    /// </summary>       
    public class CreateThreatIntelSetRequestMarshaller : IMarshaller<IRequest, CreateThreatIntelSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateThreatIntelSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateThreatIntelSetRequest publicRequest)
        {
