...
{
    /// <summary>
    /// Response Unmarshaller for GetDetector operation
    /// </summary>  
    public class GetDetectorResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDetectorResponse response = new GetDetectorResponse();
        ...
        private static GetDetectorResponseUnmarshaller _instance = new GetDetectorResponseUnmarshaller();        

        internal static GetDetectorResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDetectorResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
