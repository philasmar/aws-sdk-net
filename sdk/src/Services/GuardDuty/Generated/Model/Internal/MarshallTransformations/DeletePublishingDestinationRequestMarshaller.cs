...
{
    /// <summary>
    /// DeletePublishingDestination Request Marshaller
    /// </summary>       
    public class DeletePublishingDestinationRequestMarshaller : IMarshaller<IRequest, DeletePublishingDestinationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeletePublishingDestinationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeletePublishingDestinationRequest publicRequest)
        {
        ...
        private static DeletePublishingDestinationRequestMarshaller _instance = new DeletePublishingDestinationRequestMarshaller();        

        internal static DeletePublishingDestinationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeletePublishingDestinationRequestMarshaller Instance
        {
            get
            {
                return _instance;
