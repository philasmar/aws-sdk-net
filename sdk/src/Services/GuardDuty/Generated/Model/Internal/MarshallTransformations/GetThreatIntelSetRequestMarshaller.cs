...
{
    /// <summary>
    /// GetThreatIntelSet Request Marshaller
    /// </summary>       
    public class GetThreatIntelSetRequestMarshaller : IMarshaller<IRequest, GetThreatIntelSetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetThreatIntelSetRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetThreatIntelSetRequest publicRequest)
        {
        ...
        private static GetThreatIntelSetRequestMarshaller _instance = new GetThreatIntelSetRequestMarshaller();        

        internal static GetThreatIntelSetRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetThreatIntelSetRequestMarshaller Instance
        {
            get
            {
                return _instance;
