...
{
    /// <summary>
    /// Response Unmarshaller for RemoteIpDetails Object
    /// </summary>  
    public class RemoteIpDetailsUnmarshaller : IUnmarshaller<RemoteIpDetails, XmlUnmarshallerContext>, IUnmarshaller<RemoteIpDetails, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        RemoteIpDetails IUnmarshaller<RemoteIpDetails, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static RemoteIpDetailsUnmarshaller _instance = new RemoteIpDetailsUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RemoteIpDetailsUnmarshaller Instance
        {
            get
            {
                return _instance;
