...
namespace Amazon.GuardDuty.Model.Internal.MarshallTransformations
{
    ...
    public class NetworkConnectionActionUnmarshaller : IUnmarshaller<NetworkConnectionAction, XmlUnmarshallerContext>, IUnmarshaller<NetworkConnectionAction, JsonUnmarshallerContext>
    {
        ...
        private static NetworkConnectionActionUnmarshaller _instance = new NetworkConnectionActionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static NetworkConnectionActionUnmarshaller Instance
        {
            get
            {
                return _instance;
