...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetSuiteRunRequestMarshaller : IMarshaller<IRequest, GetSuiteRunRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static GetSuiteRunRequestMarshaller _instance = new GetSuiteRunRequestMarshaller();        

        internal static GetSuiteRunRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSuiteRunRequestMarshaller Instance
        {
            get
            {
                return _instance;
