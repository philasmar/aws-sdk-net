...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeviceUnderTestUnmarshaller : IUnmarshaller<DeviceUnderTest, XmlUnmarshallerContext>, IUnmarshaller<DeviceUnderTest, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DeviceUnderTest IUnmarshaller<DeviceUnderTest, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public DeviceUnderTest Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
