...
{
    /// <summary>
    /// Response Unmarshaller for StartSuiteRun operation
    /// </summary>  
    public class StartSuiteRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartSuiteRunResponse response = new StartSuiteRunResponse();
        ...
        private static StartSuiteRunResponseUnmarshaller _instance = new StartSuiteRunResponseUnmarshaller();        

        internal static StartSuiteRunResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSuiteRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
