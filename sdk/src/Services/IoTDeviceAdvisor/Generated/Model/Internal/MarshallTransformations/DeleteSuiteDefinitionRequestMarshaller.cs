...
namespace Amazon.IoTDeviceAdvisor.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteSuiteDefinitionRequestMarshaller : IMarshaller<IRequest, DeleteSuiteDefinitionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteSuiteDefinitionRequestMarshaller _instance = new DeleteSuiteDefinitionRequestMarshaller();        

        internal static DeleteSuiteDefinitionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSuiteDefinitionRequestMarshaller Instance
        {
            get
            {
                return _instance;
