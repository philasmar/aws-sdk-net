...
{
    /// <summary>
    /// Response Unmarshaller for CreateSuiteDefinition operation
    /// </summary>  
    public class CreateSuiteDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSuiteDefinitionResponse response = new CreateSuiteDefinitionResponse();
        ...
        private static CreateSuiteDefinitionResponseUnmarshaller _instance = new CreateSuiteDefinitionResponseUnmarshaller();        

        internal static CreateSuiteDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSuiteDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
