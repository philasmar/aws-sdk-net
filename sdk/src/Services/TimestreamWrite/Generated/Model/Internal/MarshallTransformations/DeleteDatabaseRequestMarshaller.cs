...
{
    /// <summary>
    /// DeleteDatabase Request Marshaller
    /// </summary>       
    public class DeleteDatabaseRequestMarshaller : IMarshaller<IRequest, DeleteDatabaseRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteDatabaseRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.TimestreamWrite");
            string target = "Timestream_20181101.DeleteDatabase";
