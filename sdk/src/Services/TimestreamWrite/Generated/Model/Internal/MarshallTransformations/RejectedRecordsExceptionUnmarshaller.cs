...
namespace Amazon.TimestreamWrite.Model.Internal.MarshallTransformations
{
    ...
    public class RejectedRecordsExceptionUnmarshaller : IErrorResponseUnmarshaller<RejectedRecordsException, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public RejectedRecordsException Unmarshall(JsonUnmarshallerContext context, ErrorResponse errorResponse)
        {
            context.Read();
        ...
        private static RejectedRecordsExceptionUnmarshaller _instance = new RejectedRecordsExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static RejectedRecordsExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
