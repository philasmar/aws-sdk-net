...
namespace Amazon.TimestreamWrite
{
    ...
    public partial interface IAmazonTimestreamWrite : IAmazonService, IDisposable
    {
        ...
        Task<DescribeDatabaseResponse> DescribeDatabaseAsync(DescribeDatabaseRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<WriteRecordsResponse> WriteRecordsAsync(WriteRecordsRequest request, System.Threading.CancellationToken cancellationToken = default(CancellationToken));
