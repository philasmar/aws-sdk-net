...
{
    /// <summary>
    /// Response Unmarshaller for InvokeDeviceMethod operation
    /// </summary>  
    public class InvokeDeviceMethodResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            InvokeDeviceMethodResponse response = new InvokeDeviceMethodResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("deviceMethodResponse", targetDepth))
                {
                    ...
                    response.DeviceMethodResponse = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static InvokeDeviceMethodResponseUnmarshaller _instance = new InvokeDeviceMethodResponseUnmarshaller();        

        internal static InvokeDeviceMethodResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InvokeDeviceMethodResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
