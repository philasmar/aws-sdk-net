...
{
    /// <summary>
    /// GetDeviceMethods Request Marshaller
    /// </summary>       
    public class GetDeviceMethodsRequestMarshaller : IMarshaller<IRequest, GetDeviceMethodsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetDeviceMethodsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetDeviceMethodsRequest publicRequest)
        {
        ...
        private static GetDeviceMethodsRequestMarshaller _instance = new GetDeviceMethodsRequestMarshaller();        

        internal static GetDeviceMethodsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDeviceMethodsRequestMarshaller Instance
        {
            get
            {
                return _instance;
