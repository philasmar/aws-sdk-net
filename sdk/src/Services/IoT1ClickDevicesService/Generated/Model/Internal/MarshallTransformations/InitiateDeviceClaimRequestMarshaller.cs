...
{
    /// <summary>
    /// InitiateDeviceClaim Request Marshaller
    /// </summary>       
    public class InitiateDeviceClaimRequestMarshaller : IMarshaller<IRequest, InitiateDeviceClaimRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((InitiateDeviceClaimRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(InitiateDeviceClaimRequest publicRequest)
        {
            ...
            request.ResourcePath = "/devices/{deviceId}/initiate-claim";
            request.MarshallerVersion = 2;

            return request;
        }
        private static InitiateDeviceClaimRequestMarshaller _instance = new InitiateDeviceClaimRequestMarshaller();        

        internal static InitiateDeviceClaimRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static InitiateDeviceClaimRequestMarshaller Instance
        {
            get
            {
                return _instance;
