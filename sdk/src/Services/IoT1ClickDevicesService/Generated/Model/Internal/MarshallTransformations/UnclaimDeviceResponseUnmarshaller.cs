...
{
    /// <summary>
    /// Response Unmarshaller for UnclaimDevice operation
    /// </summary>  
    public class UnclaimDeviceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UnclaimDeviceResponse response = new UnclaimDeviceResponse();
        ...
        private static UnclaimDeviceResponseUnmarshaller _instance = new UnclaimDeviceResponseUnmarshaller();        

        internal static UnclaimDeviceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UnclaimDeviceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
