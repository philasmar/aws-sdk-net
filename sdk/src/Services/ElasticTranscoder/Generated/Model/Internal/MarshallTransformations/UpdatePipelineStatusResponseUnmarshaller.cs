...
namespace Amazon.ElasticTranscoder.Model.Internal.MarshallTransformations
{
    ...
    public class UpdatePipelineStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static UpdatePipelineStatusResponseUnmarshaller _instance = new UpdatePipelineStatusResponseUnmarshaller();        

        internal static UpdatePipelineStatusResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePipelineStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
