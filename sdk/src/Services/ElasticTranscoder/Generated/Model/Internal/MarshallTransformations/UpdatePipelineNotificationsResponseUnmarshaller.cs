...
namespace Amazon.ElasticTranscoder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdatePipelineNotificationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdatePipelineNotificationsResponseUnmarshaller _instance = new UpdatePipelineNotificationsResponseUnmarshaller();        

        internal static UpdatePipelineNotificationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdatePipelineNotificationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
