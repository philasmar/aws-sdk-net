...
namespace Amazon.ElasticTranscoder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class TestRoleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static TestRoleResponseUnmarshaller _instance = new TestRoleResponseUnmarshaller();        

        internal static TestRoleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TestRoleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
