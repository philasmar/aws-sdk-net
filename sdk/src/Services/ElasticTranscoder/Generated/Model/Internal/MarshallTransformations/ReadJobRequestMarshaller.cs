...
namespace Amazon.ElasticTranscoder.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ReadJobRequestMarshaller : IMarshaller<IRequest, ReadJobRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ReadJobRequest)input);
        }
        ...
        public IRequest Marshall(ReadJobRequest publicRequest)
        {
            ...
            request.ResourcePath = "/2012-09-25/jobs/{Id}";
