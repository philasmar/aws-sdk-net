...
namespace Amazon.ElasticTranscoder.Model
{
    ...
    internal sealed partial class ListJobsByPipelinePaginator : IPaginator<ListJobsByPipelineResponse>, IListJobsByPipelinePaginator
    {
        ...
        public IPaginatedEnumerable<Job> Jobs => 
            new PaginatedResultKeyResponse<ListJobsByPipelineResponse, Job>(this, (i) => i.Jobs);
        ...
        async IAsyncEnumerable<ListJobsByPipelineResponse> IPaginator<ListJobsByPipelineResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
