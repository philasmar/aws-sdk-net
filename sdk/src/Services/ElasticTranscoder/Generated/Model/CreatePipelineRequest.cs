...
namespace Amazon.ElasticTranscoder.Model
{
    ...
    public partial class CreatePipelineRequest : AmazonElasticTranscoderRequest
    {
        ...
        ///  <important> 
        /// <para>
        /// When Elastic Transcoder saves files in <code>OutputBucket</code>, it grants full control
        /// over the files only to the AWS account that owns the role that is specified by <code>Role</code>.
        /// </para>
        ///  </important> </li> <li> 
        /// <para>
