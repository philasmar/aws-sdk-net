...
namespace Amazon.CloudFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EstimateTemplateCostResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static EstimateTemplateCostResponseUnmarshaller _instance = new EstimateTemplateCostResponseUnmarshaller();        

        internal static EstimateTemplateCostResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EstimateTemplateCostResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
