...
{
    /// <summary>
    /// Response Unmarshaller for DetectStackResourceDrift operation
    /// </summary>  
    public class DetectStackResourceDriftResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DetectStackResourceDriftResponseUnmarshaller _instance = new DetectStackResourceDriftResponseUnmarshaller();        

        internal static DetectStackResourceDriftResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectStackResourceDriftResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
