    ...
    public class ValidateTemplateRequestMarshaller : IMarshaller<IRequest, ValidateTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ValidateTemplateRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static ValidateTemplateRequestMarshaller _instance = new ValidateTemplateRequestMarshaller();        

        internal static ValidateTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ValidateTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
