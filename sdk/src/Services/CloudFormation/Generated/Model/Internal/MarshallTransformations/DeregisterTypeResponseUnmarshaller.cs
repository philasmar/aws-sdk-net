...
{
    /// <summary>
    /// Response Unmarshaller for DeregisterType operation
    /// </summary>  
    public class DeregisterTypeResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterTypeResponse response = new DeregisterTypeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeregisterTypeResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DeregisterTypeResponse response)
        {
        ...
        private static DeregisterTypeResponseUnmarshaller _instance = new DeregisterTypeResponseUnmarshaller();        

        internal static DeregisterTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
