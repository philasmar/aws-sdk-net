    ...
    public class DescribeStackEventsRequestMarshaller : IMarshaller<IRequest, DescribeStackEventsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeStackEventsRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeStackEventsRequestMarshaller _instance = new DescribeStackEventsRequestMarshaller();        

        internal static DescribeStackEventsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeStackEventsRequestMarshaller Instance
        {
            get
            {
                return _instance;
