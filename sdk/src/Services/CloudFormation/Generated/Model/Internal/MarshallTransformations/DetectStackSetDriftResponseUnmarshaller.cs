...
{
    /// <summary>
    /// Response Unmarshaller for DetectStackSetDrift operation
    /// </summary>  
    public class DetectStackSetDriftResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetectStackSetDriftResponse response = new DetectStackSetDriftResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DetectStackSetDriftResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DetectStackSetDriftResponse response)
        {
        ...
        private static DetectStackSetDriftResponseUnmarshaller _instance = new DetectStackSetDriftResponseUnmarshaller();        

        internal static DetectStackSetDriftResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetectStackSetDriftResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
