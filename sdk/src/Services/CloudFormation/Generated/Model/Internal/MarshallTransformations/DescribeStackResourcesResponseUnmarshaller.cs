...
namespace Amazon.CloudFormation.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeStackResourcesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeStackResourcesResponseUnmarshaller _instance = new DescribeStackResourcesResponseUnmarshaller();        

        internal static DescribeStackResourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeStackResourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
