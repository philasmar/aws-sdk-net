...
{
    /// <summary>
    /// ResendContactReachabilityEmail Request Marshaller
    /// </summary>       
    public class ResendContactReachabilityEmailRequestMarshaller : IMarshaller<IRequest, ResendContactReachabilityEmailRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ResendContactReachabilityEmailRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ResendContactReachabilityEmailRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Route53Domains");
            string target = "Route53Domains_v20140515.ResendContactReachabilityEmail";
