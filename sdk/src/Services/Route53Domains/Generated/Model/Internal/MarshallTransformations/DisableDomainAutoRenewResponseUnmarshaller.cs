...
{
    /// <summary>
    /// Response Unmarshaller for DisableDomainAutoRenew operation
    /// </summary>  
    public class DisableDomainAutoRenewResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisableDomainAutoRenewResponse response = new DisableDomainAutoRenewResponse();
        ...
        private static DisableDomainAutoRenewResponseUnmarshaller _instance = new DisableDomainAutoRenewResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableDomainAutoRenewResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
