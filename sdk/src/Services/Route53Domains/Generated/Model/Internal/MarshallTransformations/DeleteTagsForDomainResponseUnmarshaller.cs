...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTagsForDomain operation
    /// </summary>  
    public class DeleteTagsForDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTagsForDomainResponse response = new DeleteTagsForDomainResponse();
        ...
        private static DeleteTagsForDomainResponseUnmarshaller _instance = new DeleteTagsForDomainResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTagsForDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
