...
{
    /// <summary>
    /// Response Unmarshaller for CheckDomainTransferability operation
    /// </summary>  
    public class CheckDomainTransferabilityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CheckDomainTransferabilityResponse response = new CheckDomainTransferabilityResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("Transferability", targetDepth))
                {
                    ...
                    response.Transferability = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CheckDomainTransferabilityResponseUnmarshaller _instance = new CheckDomainTransferabilityResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CheckDomainTransferabilityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
