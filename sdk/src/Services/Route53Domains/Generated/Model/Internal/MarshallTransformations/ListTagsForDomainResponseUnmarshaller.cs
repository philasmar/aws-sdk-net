...
{
    /// <summary>
    /// Response Unmarshaller for ListTagsForDomain operation
    /// </summary>  
    public class ListTagsForDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTagsForDomainResponse response = new ListTagsForDomainResponse();
        ...
        private static ListTagsForDomainResponseUnmarshaller _instance = new ListTagsForDomainResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTagsForDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
