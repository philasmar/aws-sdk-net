...
{
    /// <summary>
    /// Response Unmarshaller for EnableDomainTransferLock operation
    /// </summary>  
    public class EnableDomainTransferLockResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnableDomainTransferLockResponse response = new EnableDomainTransferLockResponse();
        ...
        private static EnableDomainTransferLockResponseUnmarshaller _instance = new EnableDomainTransferLockResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableDomainTransferLockResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
