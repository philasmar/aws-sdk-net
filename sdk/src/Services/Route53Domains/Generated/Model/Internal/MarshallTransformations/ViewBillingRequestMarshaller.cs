...
{
    /// <summary>
    /// ViewBilling Request Marshaller
    /// </summary>       
    public class ViewBillingRequestMarshaller : IMarshaller<IRequest, ViewBillingRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ViewBillingRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ViewBillingRequest publicRequest)
        {
        ...
        private static ViewBillingRequestMarshaller _instance = new ViewBillingRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ViewBillingRequestMarshaller Instance
        {
            get
            {
                return _instance;
