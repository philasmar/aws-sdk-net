...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTagsForDomain operation
    /// </summary>  
    public class UpdateTagsForDomainResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTagsForDomainResponse response = new UpdateTagsForDomainResponse();
        ...
        private static UpdateTagsForDomainResponseUnmarshaller _instance = new UpdateTagsForDomainResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTagsForDomainResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
