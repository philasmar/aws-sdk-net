...
{
    /// <summary>
    /// Response Unmarshaller for AcceptDomainTransferFromAnotherAwsAccount operation
    /// </summary>  
    public class AcceptDomainTransferFromAnotherAwsAccountResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AcceptDomainTransferFromAnotherAwsAccountResponse response = new AcceptDomainTransferFromAnotherAwsAccountResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return DomainLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static AcceptDomainTransferFromAnotherAwsAccountResponseUnmarshaller _instance = new AcceptDomainTransferFromAnotherAwsAccountResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AcceptDomainTransferFromAnotherAwsAccountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
