...
{
    /// <summary>
    /// Response Unmarshaller for DisableDomainTransferLock operation
    /// </summary>  
    public class DisableDomainTransferLockResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisableDomainTransferLockResponse response = new DisableDomainTransferLockResponse();
        ...
        private static DisableDomainTransferLockResponseUnmarshaller _instance = new DisableDomainTransferLockResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableDomainTransferLockResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
