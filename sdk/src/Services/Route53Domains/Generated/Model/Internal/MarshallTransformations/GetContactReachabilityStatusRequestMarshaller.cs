...
{
    /// <summary>
    /// GetContactReachabilityStatus Request Marshaller
    /// </summary>       
    public class GetContactReachabilityStatusRequestMarshaller : IMarshaller<IRequest, GetContactReachabilityStatusRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetContactReachabilityStatusRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetContactReachabilityStatusRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Route53Domains");
            string target = "Route53Domains_v20140515.GetContactReachabilityStatus";
