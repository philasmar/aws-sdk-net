...
{
    /// <summary>
    /// Response Unmarshaller for StopWorkspaces operation
    /// </summary>  
    public class StopWorkspacesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopWorkspacesResponse response = new StopWorkspacesResponse();
        ...
        private static StopWorkspacesResponseUnmarshaller _instance = new StopWorkspacesResponseUnmarshaller();        

        internal static StopWorkspacesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopWorkspacesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
