...
{
    /// <summary>
    /// Response Unmarshaller for AuthorizeIpRules operation
    /// </summary>  
    public class AuthorizeIpRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AuthorizeIpRulesResponse response = new AuthorizeIpRulesResponse();
        ...
        private static AuthorizeIpRulesResponseUnmarshaller _instance = new AuthorizeIpRulesResponseUnmarshaller();        

        internal static AuthorizeIpRulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AuthorizeIpRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
