...
{
    /// <summary>
    /// Response Unmarshaller for ModifyWorkspaceProperties operation
    /// </summary>  
    public class ModifyWorkspacePropertiesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyWorkspacePropertiesResponse response = new ModifyWorkspacePropertiesResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("UnsupportedWorkspaceConfigurationException"))
                {
                    return UnsupportedWorkspaceConfigurationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static ModifyWorkspacePropertiesResponseUnmarshaller _instance = new ModifyWorkspacePropertiesResponseUnmarshaller();        

        internal static ModifyWorkspacePropertiesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyWorkspacePropertiesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
