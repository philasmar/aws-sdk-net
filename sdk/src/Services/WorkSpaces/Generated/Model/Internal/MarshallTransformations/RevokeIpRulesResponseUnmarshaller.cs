...
{
    /// <summary>
    /// Response Unmarshaller for RevokeIpRules operation
    /// </summary>  
    public class RevokeIpRulesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RevokeIpRulesResponse response = new RevokeIpRulesResponse();
        ...
        private static RevokeIpRulesResponseUnmarshaller _instance = new RevokeIpRulesResponseUnmarshaller();        

        internal static RevokeIpRulesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokeIpRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
