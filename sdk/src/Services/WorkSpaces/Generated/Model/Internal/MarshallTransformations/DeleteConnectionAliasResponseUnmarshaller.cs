...
{
    /// <summary>
    /// Response Unmarshaller for DeleteConnectionAlias operation
    /// </summary>  
    public class DeleteConnectionAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteConnectionAliasResponse response = new DeleteConnectionAliasResponse();
        ...
        private static DeleteConnectionAliasResponseUnmarshaller _instance = new DeleteConnectionAliasResponseUnmarshaller();        

        internal static DeleteConnectionAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteConnectionAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
