...
{
    /// <summary>
    /// Response Unmarshaller for UpdateConnectionAliasPermission operation
    /// </summary>  
    public class UpdateConnectionAliasPermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateConnectionAliasPermissionResponse response = new UpdateConnectionAliasPermissionResponse();
        ...
        private static UpdateConnectionAliasPermissionResponseUnmarshaller _instance = new UpdateConnectionAliasPermissionResponseUnmarshaller();        

        internal static UpdateConnectionAliasPermissionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConnectionAliasPermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
