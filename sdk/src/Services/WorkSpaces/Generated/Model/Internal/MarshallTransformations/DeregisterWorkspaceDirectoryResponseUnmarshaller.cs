...
{
    /// <summary>
    /// Response Unmarshaller for DeregisterWorkspaceDirectory operation
    /// </summary>  
    public class DeregisterWorkspaceDirectoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterWorkspaceDirectoryResponse response = new DeregisterWorkspaceDirectoryResponse();
        ...
        private static DeregisterWorkspaceDirectoryResponseUnmarshaller _instance = new DeregisterWorkspaceDirectoryResponseUnmarshaller();        

        internal static DeregisterWorkspaceDirectoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterWorkspaceDirectoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
