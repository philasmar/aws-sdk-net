...
{
    /// <summary>
    /// Response Unmarshaller for UpdateRulesOfIpGroup operation
    /// </summary>  
    public class UpdateRulesOfIpGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateRulesOfIpGroupResponse response = new UpdateRulesOfIpGroupResponse();
        ...
        private static UpdateRulesOfIpGroupResponseUnmarshaller _instance = new UpdateRulesOfIpGroupResponseUnmarshaller();        

        internal static UpdateRulesOfIpGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateRulesOfIpGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
