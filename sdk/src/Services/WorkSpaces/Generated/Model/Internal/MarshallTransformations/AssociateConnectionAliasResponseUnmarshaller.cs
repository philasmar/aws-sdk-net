...
{
    /// <summary>
    /// Response Unmarshaller for AssociateConnectionAlias operation
    /// </summary>  
    public class AssociateConnectionAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AssociateConnectionAliasResponse response = new AssociateConnectionAliasResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ConnectionIdentifier", targetDepth))
                {
                    ...
                    response.ConnectionIdentifier = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ResourceAssociatedException"))
                {
                    return ResourceAssociatedExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static AssociateConnectionAliasResponseUnmarshaller _instance = new AssociateConnectionAliasResponseUnmarshaller();        

        internal static AssociateConnectionAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateConnectionAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
