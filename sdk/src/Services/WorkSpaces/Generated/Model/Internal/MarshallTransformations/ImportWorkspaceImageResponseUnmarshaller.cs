...
{
    /// <summary>
    /// Response Unmarshaller for ImportWorkspaceImage operation
    /// </summary>  
    public class ImportWorkspaceImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ImportWorkspaceImageResponse response = new ImportWorkspaceImageResponse();
        ...
        private static ImportWorkspaceImageResponseUnmarshaller _instance = new ImportWorkspaceImageResponseUnmarshaller();        

        internal static ImportWorkspaceImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ImportWorkspaceImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
