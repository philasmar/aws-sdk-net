...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateIpGroups operation
    /// </summary>  
    public class DisassociateIpGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateIpGroupsResponse response = new DisassociateIpGroupsResponse();
        ...
        private static DisassociateIpGroupsResponseUnmarshaller _instance = new DisassociateIpGroupsResponseUnmarshaller();        

        internal static DisassociateIpGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateIpGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
