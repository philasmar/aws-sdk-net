...
{
    /// <summary>
    /// Response Unmarshaller for RebuildWorkspaces operation
    /// </summary>  
    public class RebuildWorkspacesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RebuildWorkspacesResponse response = new RebuildWorkspacesResponse();
        ...
        private static RebuildWorkspacesResponseUnmarshaller _instance = new RebuildWorkspacesResponseUnmarshaller();        

        internal static RebuildWorkspacesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RebuildWorkspacesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
