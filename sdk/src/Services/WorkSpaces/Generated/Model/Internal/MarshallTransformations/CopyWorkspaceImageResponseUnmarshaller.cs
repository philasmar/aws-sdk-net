...
{
    /// <summary>
    /// Response Unmarshaller for CopyWorkspaceImage operation
    /// </summary>  
    public class CopyWorkspaceImageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CopyWorkspaceImageResponse response = new CopyWorkspaceImageResponse();
        ...
        private static CopyWorkspaceImageResponseUnmarshaller _instance = new CopyWorkspaceImageResponseUnmarshaller();        

        internal static CopyWorkspaceImageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CopyWorkspaceImageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
