...
{
    /// <summary>
    /// Response Unmarshaller for RebootWorkspaces operation
    /// </summary>  
    public class RebootWorkspacesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RebootWorkspacesResponse response = new RebootWorkspacesResponse();
        ...
        private static RebootWorkspacesResponseUnmarshaller _instance = new RebootWorkspacesResponseUnmarshaller();        

        internal static RebootWorkspacesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RebootWorkspacesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
