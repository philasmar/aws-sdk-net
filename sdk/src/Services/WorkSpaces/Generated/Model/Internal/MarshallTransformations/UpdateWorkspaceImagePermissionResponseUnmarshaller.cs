...
{
    /// <summary>
    /// Response Unmarshaller for UpdateWorkspaceImagePermission operation
    /// </summary>  
    public class UpdateWorkspaceImagePermissionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateWorkspaceImagePermissionResponse response = new UpdateWorkspaceImagePermissionResponse();
        ...
        private static UpdateWorkspaceImagePermissionResponseUnmarshaller _instance = new UpdateWorkspaceImagePermissionResponseUnmarshaller();        

        internal static UpdateWorkspaceImagePermissionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateWorkspaceImagePermissionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
