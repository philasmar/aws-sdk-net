...
{
    /// <summary>
    /// Response Unmarshaller for RegisterWorkspaceDirectory operation
    /// </summary>  
    public class RegisterWorkspaceDirectoryResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterWorkspaceDirectoryResponse response = new RegisterWorkspaceDirectoryResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("UnsupportedNetworkConfigurationException"))
                {
                    return UnsupportedNetworkConfigurationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("WorkspacesDefaultRoleNotFoundException"))
                {
                    return WorkspacesDefaultRoleNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static RegisterWorkspaceDirectoryResponseUnmarshaller _instance = new RegisterWorkspaceDirectoryResponseUnmarshaller();        

        internal static RegisterWorkspaceDirectoryResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterWorkspaceDirectoryResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
