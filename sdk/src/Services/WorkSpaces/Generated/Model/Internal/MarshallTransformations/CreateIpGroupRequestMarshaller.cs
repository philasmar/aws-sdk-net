...
{
    /// <summary>
    /// CreateIpGroup Request Marshaller
    /// </summary>       
    public class CreateIpGroupRequestMarshaller : IMarshaller<IRequest, CreateIpGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateIpGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateIpGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.WorkSpaces");
            string target = "WorkspacesService.CreateIpGroup";
        ...
        private static CreateIpGroupRequestMarshaller _instance = new CreateIpGroupRequestMarshaller();        

        internal static CreateIpGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateIpGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
