...
{
    /// <summary>
    /// StopModel Request Marshaller
    /// </summary>       
    public class StopModelRequestMarshaller : IMarshaller<IRequest, StopModelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StopModelRequest)input);
        }
        ...
        private static StopModelRequestMarshaller _instance = new StopModelRequestMarshaller();        

        internal static StopModelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopModelRequestMarshaller Instance
        {
            get
            {
                return _instance;
