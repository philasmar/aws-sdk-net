...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutRuleResponse response = new PutRuleResponse();
        ...
        private static PutRuleResponseUnmarshaller _instance = new PutRuleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
