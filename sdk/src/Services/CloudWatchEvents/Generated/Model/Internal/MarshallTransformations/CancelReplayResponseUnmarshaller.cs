...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CancelReplayResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelReplayResponse response = new CancelReplayResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("IllegalStatusException"))
                {
                    return IllegalStatusExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CancelReplayResponseUnmarshaller _instance = new CancelReplayResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelReplayResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
