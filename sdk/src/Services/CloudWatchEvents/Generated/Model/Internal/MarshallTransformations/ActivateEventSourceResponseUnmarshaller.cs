...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ActivateEventSourceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ActivateEventSourceResponse response = new ActivateEventSourceResponse();
        ...
        private static ActivateEventSourceResponseUnmarshaller _instance = new ActivateEventSourceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ActivateEventSourceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
