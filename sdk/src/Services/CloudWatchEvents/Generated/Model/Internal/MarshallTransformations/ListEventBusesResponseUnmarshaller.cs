...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListEventBusesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListEventBusesResponse response = new ListEventBusesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<EventBus, EventBusUnmarshaller>(EventBusUnmarshaller.Instance);
        ...
        private static ListEventBusesResponseUnmarshaller _instance = new ListEventBusesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListEventBusesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
