...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeArchiveRequestMarshaller : IMarshaller<IRequest, DescribeArchiveRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeArchiveRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeArchiveRequest publicRequest)
        {
        ...
        private static DescribeArchiveRequestMarshaller _instance = new DescribeArchiveRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeArchiveRequestMarshaller Instance
        {
            get
            {
                return _instance;
