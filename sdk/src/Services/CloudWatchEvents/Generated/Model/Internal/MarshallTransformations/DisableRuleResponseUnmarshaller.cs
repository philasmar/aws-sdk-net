...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisableRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DisableRuleResponseUnmarshaller _instance = new DisableRuleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
