...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DisableRuleRequestMarshaller : IMarshaller<IRequest, DisableRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisableRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisableRuleRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatchEvents");
            string target = "AWSEvents.DisableRule";
        ...
        private static DisableRuleRequestMarshaller _instance = new DisableRuleRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
