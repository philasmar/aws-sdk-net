...
namespace Amazon.CloudWatchEvents.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateArchiveResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateArchiveResponse response = new CreateArchiveResponse();
        ...
        private static CreateArchiveResponseUnmarshaller _instance = new CreateArchiveResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateArchiveResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
