...
{
    /// <summary>
    /// DeleteVirtualService Request Marshaller
    /// </summary>       
    public class DeleteVirtualServiceRequestMarshaller : IMarshaller<IRequest, DeleteVirtualServiceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteVirtualServiceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteVirtualServiceRequest publicRequest)
        {
        ...
        private static DeleteVirtualServiceRequestMarshaller _instance = new DeleteVirtualServiceRequestMarshaller();        

        internal static DeleteVirtualServiceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVirtualServiceRequestMarshaller Instance
        {
            get
            {
                return _instance;
