...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    public class CreateMeshRequestMarshaller : IMarshaller<IRequest, CreateMeshRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateMeshRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                {
                    context.Writer.WritePropertyName("meshName");
        ...
        private static CreateMeshRequestMarshaller _instance = new CreateMeshRequestMarshaller();        

        internal static CreateMeshRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMeshRequestMarshaller Instance
        {
            get
            {
                return _instance;
