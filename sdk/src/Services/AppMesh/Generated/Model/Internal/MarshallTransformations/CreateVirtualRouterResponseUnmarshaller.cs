...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    public class CreateVirtualRouterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateVirtualRouterResponseUnmarshaller _instance = new CreateVirtualRouterResponseUnmarshaller();        

        internal static CreateVirtualRouterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVirtualRouterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
