...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    public class CreateGatewayRouteResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateGatewayRouteResponseUnmarshaller _instance = new CreateGatewayRouteResponseUnmarshaller();        

        internal static CreateGatewayRouteResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGatewayRouteResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
