    ...
    public class CreateVirtualGatewayRequestMarshaller : IMarshaller<IRequest, CreateVirtualGatewayRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateVirtualGatewayRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                {
                    context.Writer.WritePropertyName("virtualGatewayName");
                    context.Writer.Write(publicRequest.VirtualGatewayName);
                }
        ...
        private static CreateVirtualGatewayRequestMarshaller _instance = new CreateVirtualGatewayRequestMarshaller();        

        internal static CreateVirtualGatewayRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVirtualGatewayRequestMarshaller Instance
        {
            get
            {
                return _instance;
