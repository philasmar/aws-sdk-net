...
{
    /// <summary>
    /// Response Unmarshaller for DeleteGatewayRoute operation
    /// </summary>  
    public class DeleteGatewayRouteResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteGatewayRouteResponseUnmarshaller _instance = new DeleteGatewayRouteResponseUnmarshaller();        

        internal static DeleteGatewayRouteResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGatewayRouteResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
