...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    public class VirtualNodeDataUnmarshaller : IUnmarshaller<VirtualNodeData, XmlUnmarshallerContext>, IUnmarshaller<VirtualNodeData, JsonUnmarshallerContext>
    {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public VirtualNodeData Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            VirtualNodeData unmarshalledObject = new VirtualNodeData();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = VirtualNodeSpecUnmarshaller.Instance;
                    unmarshalledObject.Spec = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("status", targetDepth))
                {
                    var unmarshaller = VirtualNodeStatusUnmarshaller.Instance;
        ...
        private static VirtualNodeDataUnmarshaller _instance = new VirtualNodeDataUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static VirtualNodeDataUnmarshaller Instance
        {
            get
            {
                return _instance;
