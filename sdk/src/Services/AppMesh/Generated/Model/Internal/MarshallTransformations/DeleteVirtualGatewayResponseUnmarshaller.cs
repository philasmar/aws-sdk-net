...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVirtualGateway operation
    /// </summary>  
    public class DeleteVirtualGatewayResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteVirtualGatewayResponseUnmarshaller _instance = new DeleteVirtualGatewayResponseUnmarshaller();        

        internal static DeleteVirtualGatewayResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVirtualGatewayResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
