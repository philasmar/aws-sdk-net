...
{
    /// <summary>
    /// DescribeVirtualService Request Marshaller
    /// </summary>       
    public class DescribeVirtualServiceRequestMarshaller : IMarshaller<IRequest, DescribeVirtualServiceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeVirtualServiceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeVirtualServiceRequest publicRequest)
        {
        ...
        private static DescribeVirtualServiceRequestMarshaller _instance = new DescribeVirtualServiceRequestMarshaller();        

        internal static DescribeVirtualServiceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeVirtualServiceRequestMarshaller Instance
        {
            get
            {
                return _instance;
