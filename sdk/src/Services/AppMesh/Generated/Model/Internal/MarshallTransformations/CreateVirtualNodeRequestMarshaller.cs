...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    public class CreateVirtualNodeRequestMarshaller : IMarshaller<IRequest, CreateVirtualNodeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateVirtualNodeRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetVirtualNodeName())
                {
                    ...
                    context.Writer.Write(publicRequest.VirtualNodeName);
                }
        ...
        private static CreateVirtualNodeRequestMarshaller _instance = new CreateVirtualNodeRequestMarshaller();        

        internal static CreateVirtualNodeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVirtualNodeRequestMarshaller Instance
        {
            get
            {
                return _instance;
