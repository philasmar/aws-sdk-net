...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    public class CreateVirtualServiceRequestMarshaller : IMarshaller<IRequest, CreateVirtualServiceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(CreateVirtualServiceRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetVirtualServiceName())
                {
                    ...
                    context.Writer.Write(publicRequest.VirtualServiceName);
                }
        ...
        private static CreateVirtualServiceRequestMarshaller _instance = new CreateVirtualServiceRequestMarshaller();        

        internal static CreateVirtualServiceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVirtualServiceRequestMarshaller Instance
        {
            get
            {
                return _instance;
