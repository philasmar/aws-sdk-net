...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    public class CreateVirtualNodeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateVirtualNodeResponseUnmarshaller _instance = new CreateVirtualNodeResponseUnmarshaller();        

        internal static CreateVirtualNodeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVirtualNodeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
