...
{
    /// <summary>
    /// Response Unmarshaller for DescribeVirtualRouter operation
    /// </summary>  
    public class DescribeVirtualRouterResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeVirtualRouterResponseUnmarshaller _instance = new DescribeVirtualRouterResponseUnmarshaller();        

        internal static DescribeVirtualRouterResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeVirtualRouterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
