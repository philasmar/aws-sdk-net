...
{
    /// <summary>
    /// Response Unmarshaller for DeleteMesh operation
    /// </summary>  
    public class DeleteMeshResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMeshResponse response = new DeleteMeshResponse();
        ...
        private static DeleteMeshResponseUnmarshaller _instance = new DeleteMeshResponseUnmarshaller();        

        internal static DeleteMeshResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMeshResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
