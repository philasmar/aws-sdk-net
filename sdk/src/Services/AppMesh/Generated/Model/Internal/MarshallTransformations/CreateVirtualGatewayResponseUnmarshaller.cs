...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    public class CreateVirtualGatewayResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        private static CreateVirtualGatewayResponseUnmarshaller _instance = new CreateVirtualGatewayResponseUnmarshaller();        

        internal static CreateVirtualGatewayResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateVirtualGatewayResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
