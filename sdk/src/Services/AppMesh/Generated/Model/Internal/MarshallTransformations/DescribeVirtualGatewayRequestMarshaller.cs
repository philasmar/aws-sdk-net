...
{
    /// <summary>
    /// DescribeVirtualGateway Request Marshaller
    /// </summary>       
    public class DescribeVirtualGatewayRequestMarshaller : IMarshaller<IRequest, DescribeVirtualGatewayRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeVirtualGatewayRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeVirtualGatewayRequest publicRequest)
        {
        ...
        private static DescribeVirtualGatewayRequestMarshaller _instance = new DescribeVirtualGatewayRequestMarshaller();        

        internal static DescribeVirtualGatewayRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeVirtualGatewayRequestMarshaller Instance
        {
            get
            {
                return _instance;
