...
{
    /// <summary>
    /// Response Unmarshaller for DescribeMesh operation
    /// </summary>  
    public class DescribeMeshResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeMeshResponseUnmarshaller _instance = new DescribeMeshResponseUnmarshaller();        

        internal static DescribeMeshResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMeshResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
