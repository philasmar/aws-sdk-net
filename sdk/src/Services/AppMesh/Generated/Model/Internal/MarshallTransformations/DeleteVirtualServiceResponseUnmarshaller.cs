...
{
    /// <summary>
    /// Response Unmarshaller for DeleteVirtualService operation
    /// </summary>  
    public class DeleteVirtualServiceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteVirtualServiceResponse response = new DeleteVirtualServiceResponse();
        ...
        private static DeleteVirtualServiceResponseUnmarshaller _instance = new DeleteVirtualServiceResponseUnmarshaller();        

        internal static DeleteVirtualServiceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVirtualServiceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
