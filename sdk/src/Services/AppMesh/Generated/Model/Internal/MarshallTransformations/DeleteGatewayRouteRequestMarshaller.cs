...
{
    /// <summary>
    /// DeleteGatewayRoute Request Marshaller
    /// </summary>       
    public class DeleteGatewayRouteRequestMarshaller : IMarshaller<IRequest, DeleteGatewayRouteRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteGatewayRouteRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteGatewayRouteRequest publicRequest)
        {
        ...
        private static DeleteGatewayRouteRequestMarshaller _instance = new DeleteGatewayRouteRequestMarshaller();        

        internal static DeleteGatewayRouteRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGatewayRouteRequestMarshaller Instance
        {
            get
            {
                return _instance;
