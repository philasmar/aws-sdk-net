...
namespace Amazon.AppMesh.Model.Internal.MarshallTransformations
{
    ...
    public class VirtualNodeRefUnmarshaller : IUnmarshaller<VirtualNodeRef, XmlUnmarshallerContext>, IUnmarshaller<VirtualNodeRef, JsonUnmarshallerContext>
    {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public VirtualNodeRef Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            VirtualNodeRef unmarshalledObject = new VirtualNodeRef();
        ...
        private static VirtualNodeRefUnmarshaller _instance = new VirtualNodeRefUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static VirtualNodeRefUnmarshaller Instance
        {
            get
            {
                return _instance;
