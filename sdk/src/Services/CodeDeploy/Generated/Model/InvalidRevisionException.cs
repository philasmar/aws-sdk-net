...
namespace Amazon.CodeDeploy.Model
{
    ...
    [Serializable]
    #endif
    public partial class InvalidRevisionException : AmazonCodeDeployException
    {
        ...
        public InvalidRevisionException(string message, Exception innerException) 
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public InvalidRevisionException(Exception innerException) 
            : base(innerException) {}
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidRevisionException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
