...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDeploymentConfig operation
    /// </summary>  
    public class DeleteDeploymentConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDeploymentConfigResponse response = new DeleteDeploymentConfigResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("DeploymentConfigInUseException"))
                {
                    return DeploymentConfigInUseExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static DeleteDeploymentConfigResponseUnmarshaller _instance = new DeleteDeploymentConfigResponseUnmarshaller();        

        internal static DeleteDeploymentConfigResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDeploymentConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
