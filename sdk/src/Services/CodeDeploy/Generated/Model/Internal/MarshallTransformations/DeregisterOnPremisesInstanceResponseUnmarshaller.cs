...
{
    /// <summary>
    /// Response Unmarshaller for DeregisterOnPremisesInstance operation
    /// </summary>  
    public class DeregisterOnPremisesInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterOnPremisesInstanceResponse response = new DeregisterOnPremisesInstanceResponse();
        ...
        private static DeregisterOnPremisesInstanceResponseUnmarshaller _instance = new DeregisterOnPremisesInstanceResponseUnmarshaller();        

        internal static DeregisterOnPremisesInstanceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterOnPremisesInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
