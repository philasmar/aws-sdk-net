...
{
    /// <summary>
    /// SkipWaitTimeForInstanceTermination Request Marshaller
    /// </summary>       
    public class SkipWaitTimeForInstanceTerminationRequestMarshaller : IMarshaller<IRequest, SkipWaitTimeForInstanceTerminationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SkipWaitTimeForInstanceTerminationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SkipWaitTimeForInstanceTerminationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodeDeploy");
            string target = "CodeDeploy_20141006.SkipWaitTimeForInstanceTermination";
