...
{
    /// <summary>
    /// Response Unmarshaller for DeleteDeploymentGroup operation
    /// </summary>  
    public class DeleteDeploymentGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDeploymentGroupResponse response = new DeleteDeploymentGroupResponse();
        ...
        private static DeleteDeploymentGroupResponseUnmarshaller _instance = new DeleteDeploymentGroupResponseUnmarshaller();        

        internal static DeleteDeploymentGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDeploymentGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
