...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListUpdatesRequestMarshaller : IMarshaller<IRequest, ListUpdatesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListUpdatesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListUpdatesRequest publicRequest)
        {
        ...
        private static ListUpdatesRequestMarshaller _instance = new ListUpdatesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListUpdatesRequestMarshaller Instance
        {
            get
            {
                return _instance;
