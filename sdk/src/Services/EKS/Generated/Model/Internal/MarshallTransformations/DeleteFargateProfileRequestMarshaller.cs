...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteFargateProfileRequestMarshaller : IMarshaller<IRequest, DeleteFargateProfileRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteFargateProfileRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteFargateProfileRequest publicRequest)
        {
        ...
        private static DeleteFargateProfileRequestMarshaller _instance = new DeleteFargateProfileRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteFargateProfileRequestMarshaller Instance
        {
            get
            {
                return _instance;
