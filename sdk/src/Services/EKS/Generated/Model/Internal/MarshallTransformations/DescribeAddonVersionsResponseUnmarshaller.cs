...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeAddonVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAddonVersionsResponse response = new DescribeAddonVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<AddonInfo, AddonInfoUnmarshaller>(AddonInfoUnmarshaller.Instance);
                    response.Addons = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeAddonVersionsResponseUnmarshaller _instance = new DescribeAddonVersionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAddonVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
