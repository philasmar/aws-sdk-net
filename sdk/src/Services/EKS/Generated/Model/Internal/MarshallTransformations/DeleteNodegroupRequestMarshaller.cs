...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteNodegroupRequestMarshaller : IMarshaller<IRequest, DeleteNodegroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteNodegroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteNodegroupRequest publicRequest)
        {
        ...
        private static DeleteNodegroupRequestMarshaller _instance = new DeleteNodegroupRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteNodegroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
