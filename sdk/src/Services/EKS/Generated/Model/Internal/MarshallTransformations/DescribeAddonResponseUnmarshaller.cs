...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeAddonResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAddonResponse response = new DescribeAddonResponse();
        ...
        private static DescribeAddonResponseUnmarshaller _instance = new DescribeAddonResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAddonResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
