...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeFargateProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeFargateProfileResponse response = new DescribeFargateProfileResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("fargateProfile", targetDepth))
                {
                    ...
                    response.FargateProfile = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeFargateProfileResponseUnmarshaller _instance = new DescribeFargateProfileResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeFargateProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
