...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateAddonResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAddonResponse response = new UpdateAddonResponse();
        ...
        private static UpdateAddonResponseUnmarshaller _instance = new UpdateAddonResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAddonResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
