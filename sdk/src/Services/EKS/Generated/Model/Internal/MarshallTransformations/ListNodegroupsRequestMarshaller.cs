...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListNodegroupsRequestMarshaller : IMarshaller<IRequest, ListNodegroupsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListNodegroupsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListNodegroupsRequest publicRequest)
        {
        ...
        private static ListNodegroupsRequestMarshaller _instance = new ListNodegroupsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListNodegroupsRequestMarshaller Instance
        {
            get
            {
                return _instance;
