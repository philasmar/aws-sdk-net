...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListFargateProfilesRequestMarshaller : IMarshaller<IRequest, ListFargateProfilesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListFargateProfilesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListFargateProfilesRequest publicRequest)
        {
        ...
        private static ListFargateProfilesRequestMarshaller _instance = new ListFargateProfilesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFargateProfilesRequestMarshaller Instance
        {
            get
            {
                return _instance;
