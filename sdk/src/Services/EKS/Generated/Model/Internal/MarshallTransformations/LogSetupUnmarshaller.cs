...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class LogSetupUnmarshaller : IUnmarshaller<LogSetup, XmlUnmarshallerContext>, IUnmarshaller<LogSetup, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        LogSetup IUnmarshaller<LogSetup, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public LogSetup Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
