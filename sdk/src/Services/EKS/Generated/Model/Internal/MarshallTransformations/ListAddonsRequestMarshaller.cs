...
namespace Amazon.EKS.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListAddonsRequestMarshaller : IMarshaller<IRequest, ListAddonsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAddonsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAddonsRequest publicRequest)
        {
        ...
        private static ListAddonsRequestMarshaller _instance = new ListAddonsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAddonsRequestMarshaller Instance
        {
            get
            {
                return _instance;
