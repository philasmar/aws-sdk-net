...
{
    /// <summary>
    /// DeleteVPCAssociationAuthorization Request Marshaller
    /// </summary>       
    public class DeleteVPCAssociationAuthorizationRequestMarshaller : IMarshaller<IRequest, DeleteVPCAssociationAuthorizationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteVPCAssociationAuthorizationRequest)input);
        }
        ...
        public IRequest Marshall(DeleteVPCAssociationAuthorizationRequest publicRequest)
        {
            ...
            request.ResourcePath = "/2013-04-01/hostedzone/{Id}/deauthorizevpcassociation";
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteVPCAssociationAuthorizationRequestMarshaller Instance
        {
            get
            {
                return _instance;
