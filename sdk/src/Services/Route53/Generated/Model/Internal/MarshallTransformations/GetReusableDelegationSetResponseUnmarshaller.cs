...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetReusableDelegationSetResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetReusableDelegationSetResponse response = new GetReusableDelegationSetResponse();
        ...
        private static GetReusableDelegationSetResponseUnmarshaller _instance = new GetReusableDelegationSetResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetReusableDelegationSetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
