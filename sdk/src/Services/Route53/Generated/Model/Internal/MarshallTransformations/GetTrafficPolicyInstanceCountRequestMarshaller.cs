...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    public class GetTrafficPolicyInstanceCountRequestMarshaller : IMarshaller<IRequest, GetTrafficPolicyInstanceCountRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((GetTrafficPolicyInstanceCountRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTrafficPolicyInstanceCountRequest publicRequest)
        {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTrafficPolicyInstanceCountRequestMarshaller Instance
        {
            get
            {
                return _instance;
