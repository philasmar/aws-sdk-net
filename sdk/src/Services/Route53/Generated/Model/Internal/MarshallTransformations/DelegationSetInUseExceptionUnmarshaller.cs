...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    public class DelegationSetInUseExceptionUnmarshaller : IErrorResponseUnmarshaller<DelegationSetInUseException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public DelegationSetInUseException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static DelegationSetInUseExceptionUnmarshaller _instance = new DelegationSetInUseExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static DelegationSetInUseExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
