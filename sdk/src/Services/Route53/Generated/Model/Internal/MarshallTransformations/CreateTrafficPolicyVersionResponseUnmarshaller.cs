...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    public class CreateTrafficPolicyVersionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        {
            CreateTrafficPolicyVersionResponse response = new CreateTrafficPolicyVersionResponse();
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return InvalidTrafficPolicyDocumentExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                {
                    return TooManyTrafficPolicyVersionsForCurrentPolicyExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTrafficPolicyVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
