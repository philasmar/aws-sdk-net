...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetChangeResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return NoSuchChangeExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static GetChangeResponseUnmarshaller _instance = new GetChangeResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetChangeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
