...
{
    /// <summary>
    /// Response Unmarshaller for CreateKeySigningKey operation
    /// </summary>  
    public class CreateKeySigningKeyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateKeySigningKeyResponse response = new CreateKeySigningKeyResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, CreateKeySigningKeyResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    if (context.TestExpression("KeySigningKey", targetDepth))
                    {
                        var unmarshaller = KeySigningKeyUnmarshaller.Instance;
                        response.KeySigningKey = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidKeySigningKeyName"))
                {
                    return InvalidKeySigningKeyNameExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidSigningStatus"))
                {
                    return InvalidSigningStatusExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("KeySigningKeyAlreadyExists"))
                {
                    return KeySigningKeyAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("TooManyKeySigningKeys"))
                {
                    return TooManyKeySigningKeysExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static CreateKeySigningKeyResponseUnmarshaller _instance = new CreateKeySigningKeyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateKeySigningKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
