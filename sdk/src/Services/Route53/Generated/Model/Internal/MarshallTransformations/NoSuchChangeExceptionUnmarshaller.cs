...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    public class NoSuchChangeExceptionUnmarshaller : IErrorResponseUnmarshaller<NoSuchChangeException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public NoSuchChangeException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static NoSuchChangeExceptionUnmarshaller _instance = new NoSuchChangeExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static NoSuchChangeExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
