...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListTrafficPolicyInstancesByPolicyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTrafficPolicyInstancesByPolicyResponse response = new ListTrafficPolicyInstancesByPolicyResponse();
        ...
        private static ListTrafficPolicyInstancesByPolicyResponseUnmarshaller _instance = new ListTrafficPolicyInstancesByPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTrafficPolicyInstancesByPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
