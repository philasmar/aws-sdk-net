...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    public class AlarmIdentifierUnmarshaller : IUnmarshaller<AlarmIdentifier, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public AlarmIdentifier Unmarshall(XmlUnmarshallerContext context)
        {
            AlarmIdentifier unmarshalledObject = new AlarmIdentifier();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AlarmIdentifierUnmarshaller Instance
        {
            get
            {
                return _instance;
