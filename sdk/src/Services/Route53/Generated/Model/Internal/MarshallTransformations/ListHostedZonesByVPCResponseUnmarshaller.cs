...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    public class ListHostedZonesByVPCResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, ListHostedZonesByVPCResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = HostedZoneSummaryUnmarshaller.Instance;
                        response.HostedZoneSummaries.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListHostedZonesByVPCResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
