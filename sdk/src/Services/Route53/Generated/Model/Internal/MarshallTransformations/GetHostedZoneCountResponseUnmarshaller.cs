...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetHostedZoneCountResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetHostedZoneCountResponse response = new GetHostedZoneCountResponse();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("HostedZoneCount", targetDepth))
                    {
                        ...
                        response.HostedZoneCount = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        private static GetHostedZoneCountResponseUnmarshaller _instance = new GetHostedZoneCountResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetHostedZoneCountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
