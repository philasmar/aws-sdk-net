    ...
    public class DeactivateKeySigningKeyResponseUnmarshaller : XmlResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("KeySigningKeyInParentDSRecord"))
                {
                    return KeySigningKeyInParentDSRecordExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("KeySigningKeyInUse"))
                {
                    return KeySigningKeyInUseExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("NoSuchKeySigningKey"))
                {
                    return NoSuchKeySigningKeyExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeactivateKeySigningKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
