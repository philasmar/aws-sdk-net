...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class QueryLoggingConfigUnmarshaller : IUnmarshaller<QueryLoggingConfig, XmlUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public QueryLoggingConfig Unmarshall(XmlUnmarshallerContext context)
        {
            QueryLoggingConfig unmarshalledObject = new QueryLoggingConfig();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static QueryLoggingConfigUnmarshaller Instance
        {
            get
            {
                return _instance;
