...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    public class HostedZoneOwnerUnmarshaller : IUnmarshaller<HostedZoneOwner, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public HostedZoneOwner Unmarshall(XmlUnmarshallerContext context)
        {
            HostedZoneOwner unmarshalledObject = new HostedZoneOwner();
            ...
            while (context.Read())
            {
                ...
                {
                    if (context.TestExpression("OwningAccount", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.OwningAccount = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static HostedZoneOwnerUnmarshaller Instance
        {
            get
            {
                return _instance;
