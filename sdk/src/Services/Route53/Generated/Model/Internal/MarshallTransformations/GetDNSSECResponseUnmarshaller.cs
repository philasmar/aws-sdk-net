...
{
    /// <summary>
    /// Response Unmarshaller for GetDNSSEC operation
    /// </summary>  
    public class GetDNSSECResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetDNSSECResponse response = new GetDNSSECResponse();
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, GetDNSSECResponse response)
        {
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = DNSSECStatusUnmarshaller.Instance;
        ...
        private static GetDNSSECResponseUnmarshaller _instance = new GetDNSSECResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetDNSSECResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
