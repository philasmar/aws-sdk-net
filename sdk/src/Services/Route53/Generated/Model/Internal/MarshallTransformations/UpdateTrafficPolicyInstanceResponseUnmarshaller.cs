...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateTrafficPolicyInstanceResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTrafficPolicyInstanceResponse response = new UpdateTrafficPolicyInstanceResponse();
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("ConflictingTypes"))
                {
                    return ConflictingTypesExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static UpdateTrafficPolicyInstanceResponseUnmarshaller _instance = new UpdateTrafficPolicyInstanceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTrafficPolicyInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
