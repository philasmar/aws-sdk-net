...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetTrafficPolicyInstanceCountResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTrafficPolicyInstanceCountResponse response = new GetTrafficPolicyInstanceCountResponse();
        ...
        private static GetTrafficPolicyInstanceCountResponseUnmarshaller _instance = new GetTrafficPolicyInstanceCountResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTrafficPolicyInstanceCountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
