...
{
    /// <summary>
    /// GetHostedZoneLimit Request Marshaller
    /// </summary>       
    public class GetHostedZoneLimitRequestMarshaller : IMarshaller<IRequest, GetHostedZoneLimitRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetHostedZoneLimitRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetHostedZoneLimitRequest publicRequest)
        {
