...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListTrafficPolicyVersionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTrafficPolicyVersionsResponse response = new ListTrafficPolicyVersionsResponse();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("TrafficPolicies/TrafficPolicy", targetDepth))
                    {
                        ...
                        response.TrafficPolicies.Add(unmarshaller.Unmarshall(context));
                        continue;
                    }
                    ...
                    if (context.TestExpression("TrafficPolicyVersionMarker", targetDepth))
                    {
                        ...
                        response.TrafficPolicyVersionMarker = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        private static ListTrafficPolicyVersionsResponseUnmarshaller _instance = new ListTrafficPolicyVersionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTrafficPolicyVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
