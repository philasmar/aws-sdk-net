...
namespace Amazon.Route53.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetGeoLocationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetGeoLocationResponse response = new GetGeoLocationResponse();
            ...
            while (context.Read())
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("GeoLocationDetails", targetDepth))
                    {
                        ...
                        response.GeoLocationDetails = unmarshaller.Unmarshall(context);
                        continue;
                    }
                }
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("NoSuchGeoLocation"))
                {
                    return NoSuchGeoLocationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static GetGeoLocationResponseUnmarshaller _instance = new GetGeoLocationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetGeoLocationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
