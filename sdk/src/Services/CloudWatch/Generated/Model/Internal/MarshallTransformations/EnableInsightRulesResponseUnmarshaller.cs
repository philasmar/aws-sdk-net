...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class EnableInsightRulesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            EnableInsightRulesResponse response = new EnableInsightRulesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("EnableInsightRulesResult", 2))
                    {
        ...
        private static EnableInsightRulesResponseUnmarshaller _instance = new EnableInsightRulesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableInsightRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
