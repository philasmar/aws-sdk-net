...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeAnomalyDetectorsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAnomalyDetectorsResponse response = new DescribeAnomalyDetectorsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeAnomalyDetectorsResult", 2))
                    {
        ...
        private static DescribeAnomalyDetectorsResponseUnmarshaller _instance = new DescribeAnomalyDetectorsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAnomalyDetectorsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
