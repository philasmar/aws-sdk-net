...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisableAlarmActionsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(XmlUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DisableAlarmActionsResult", 2))
                    {
        ...
        private static DisableAlarmActionsResponseUnmarshaller _instance = new DisableAlarmActionsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableAlarmActionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
