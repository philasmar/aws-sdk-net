...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeAnomalyDetectorsRequestMarshaller : IMarshaller<IRequest, DescribeAnomalyDetectorsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeAnomalyDetectorsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeAnomalyDetectorsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CloudWatch");
            request.Parameters.Add("Action", "DescribeAnomalyDetectors");
            ...
            return request;
                    ...
                    private static DescribeAnomalyDetectorsRequestMarshaller _instance = new DescribeAnomalyDetectorsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAnomalyDetectorsRequestMarshaller Instance
        {
            get
            {
                return _instance;
