...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutDashboardResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutDashboardResponse response = new PutDashboardResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("PutDashboardResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, PutDashboardResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = DashboardValidationMessageUnmarshaller.Instance;
        ...
        private static PutDashboardResponseUnmarshaller _instance = new PutDashboardResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutDashboardResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
