...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteInsightRulesResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteInsightRulesResponse response = new DeleteInsightRulesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteInsightRulesResult", 2))
                    {
        ...
        private static DeleteInsightRulesResponseUnmarshaller _instance = new DeleteInsightRulesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteInsightRulesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
