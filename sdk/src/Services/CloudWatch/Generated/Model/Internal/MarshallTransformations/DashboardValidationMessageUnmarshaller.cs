...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    public class DashboardValidationMessageUnmarshaller : IUnmarshaller<DashboardValidationMessage, XmlUnmarshallerContext>, IUnmarshaller<DashboardValidationMessage, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public DashboardValidationMessage Unmarshall(XmlUnmarshallerContext context)
        {
            DashboardValidationMessage unmarshalledObject = new DashboardValidationMessage();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("DataPath", targetDepth))
                    {
                        ...
                        unmarshalledObject.DataPath = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DashboardValidationMessageUnmarshaller Instance
        {
            get
            {
                return _instance;
