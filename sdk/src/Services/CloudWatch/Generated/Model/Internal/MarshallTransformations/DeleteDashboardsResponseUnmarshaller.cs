...
namespace Amazon.CloudWatch.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteDashboardsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteDashboardsResponse response = new DeleteDashboardsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteDashboardsResult", 2))
                    {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteDashboardsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
