    ...
    public class EnableAlarmActionsRequestMarshaller : IMarshaller<IRequest, EnableAlarmActionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(EnableAlarmActionsRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static EnableAlarmActionsRequestMarshaller _instance = new EnableAlarmActionsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static EnableAlarmActionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
