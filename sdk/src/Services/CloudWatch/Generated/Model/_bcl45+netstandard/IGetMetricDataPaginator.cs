...
namespace Amazon.CloudWatch.Model
{
    ...
    public interface IGetMetricDataPaginator
    {
        ...
        /// </summary>
        IPaginatedEnumerable<GetMetricDataResponse> Responses { get; }

        /// <summary>
        /// Enumerable containing all of the MetricDataResults
        /// </summary>
        IPaginatedEnumerable<MetricDataResult> MetricDataResults { get; }

        /// <summary>
        /// Enumerable containing all of the Messages
        /// </summary>
        IPaginatedEnumerable<MessageData> Messages { get; }
    }
}
#endif