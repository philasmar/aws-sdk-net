...
namespace Amazon.CodePipeline.Model
{
    ...
    [Serializable]
    #endif
    public partial class InvalidJobStateException : AmazonCodePipelineException
    {
        ...
        public InvalidJobStateException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public InvalidJobStateException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
