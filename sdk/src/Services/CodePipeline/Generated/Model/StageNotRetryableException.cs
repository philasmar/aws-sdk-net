...
namespace Amazon.CodePipeline.Model
{
    ...
    public partial class StageNotRetryableException : AmazonCodePipelineException
    {
        ...
        public StageNotRetryableException(string message, Exception innerException) 
        ...
        public StageNotRetryableException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected StageNotRetryableException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
