...
namespace Amazon.CodePipeline.Model
{
    ...
    public partial class PipelineExecutionNotFoundException : AmazonCodePipelineException
    {
        ...
        public PipelineExecutionNotFoundException(string message, Exception innerException) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public PipelineExecutionNotFoundException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected PipelineExecutionNotFoundException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
