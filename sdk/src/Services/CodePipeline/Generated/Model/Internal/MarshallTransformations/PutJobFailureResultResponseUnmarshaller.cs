...
{
    /// <summary>
    /// Response Unmarshaller for PutJobFailureResult operation
    /// </summary>  
    public class PutJobFailureResultResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutJobFailureResultResponse response = new PutJobFailureResultResponse();
        ...
        private static PutJobFailureResultResponseUnmarshaller _instance = new PutJobFailureResultResponseUnmarshaller();        

        internal static PutJobFailureResultResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutJobFailureResultResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
