...
{
    /// <summary>
    /// EnableStageTransition Request Marshaller
    /// </summary>       
    public class EnableStageTransitionRequestMarshaller : IMarshaller<IRequest, EnableStageTransitionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((EnableStageTransitionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(EnableStageTransitionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodePipeline");
            string target = "CodePipeline_20150709.EnableStageTransition";
