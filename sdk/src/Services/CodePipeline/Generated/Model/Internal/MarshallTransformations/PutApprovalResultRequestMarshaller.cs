...
{
    /// <summary>
    /// PutApprovalResult Request Marshaller
    /// </summary>       
    public class PutApprovalResultRequestMarshaller : IMarshaller<IRequest, PutApprovalResultRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutApprovalResultRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutApprovalResultRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodePipeline");
            string target = "CodePipeline_20150709.PutApprovalResult";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetResult())
                {
                    ...
                    var marshaller = ApprovalResultMarshaller.Instance;
        ...
        private static PutApprovalResultRequestMarshaller _instance = new PutApprovalResultRequestMarshaller();        

        internal static PutApprovalResultRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutApprovalResultRequestMarshaller Instance
        {
            get
            {
                return _instance;
