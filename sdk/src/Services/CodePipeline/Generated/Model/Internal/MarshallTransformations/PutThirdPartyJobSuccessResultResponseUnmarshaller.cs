...
{
    /// <summary>
    /// Response Unmarshaller for PutThirdPartyJobSuccessResult operation
    /// </summary>  
    public class PutThirdPartyJobSuccessResultResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutThirdPartyJobSuccessResultResponse response = new PutThirdPartyJobSuccessResultResponse();
        ...
        private static PutThirdPartyJobSuccessResultResponseUnmarshaller _instance = new PutThirdPartyJobSuccessResultResponseUnmarshaller();        

        internal static PutThirdPartyJobSuccessResultResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutThirdPartyJobSuccessResultResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
