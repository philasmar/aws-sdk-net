...
namespace Amazon.CodePipeline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PipelineNotFoundExceptionUnmarshaller : IErrorResponseUnmarshaller<PipelineNotFoundException, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public PipelineNotFoundException Unmarshall(JsonUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public PipelineNotFoundException Unmarshall(JsonUnmarshallerContext context, ErrorResponse errorResponse)
        {
            context.Read();
