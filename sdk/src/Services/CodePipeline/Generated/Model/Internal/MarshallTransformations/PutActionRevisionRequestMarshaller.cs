...
{
    /// <summary>
    /// PutActionRevision Request Marshaller
    /// </summary>       
    public class PutActionRevisionRequestMarshaller : IMarshaller<IRequest, PutActionRevisionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((PutActionRevisionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(PutActionRevisionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodePipeline");
            string target = "CodePipeline_20150709.PutActionRevision";
        ...
        private static PutActionRevisionRequestMarshaller _instance = new PutActionRevisionRequestMarshaller();        

        internal static PutActionRevisionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutActionRevisionRequestMarshaller Instance
        {
            get
            {
                return _instance;
