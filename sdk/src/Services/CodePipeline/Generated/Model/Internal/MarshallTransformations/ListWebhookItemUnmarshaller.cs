...
namespace Amazon.CodePipeline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListWebhookItemUnmarshaller : IUnmarshaller<ListWebhookItem, XmlUnmarshallerContext>, IUnmarshaller<ListWebhookItem, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ListWebhookItem IUnmarshaller<ListWebhookItem, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public ListWebhookItem Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("lastTriggered", targetDepth))
                {
                    ...
                    unmarshalledObject.LastTriggered = unmarshaller.Unmarshall(context);
                    continue;
                }
