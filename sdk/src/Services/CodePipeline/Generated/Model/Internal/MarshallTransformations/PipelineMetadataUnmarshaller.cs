...
namespace Amazon.CodePipeline.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PipelineMetadataUnmarshaller : IUnmarshaller<PipelineMetadata, XmlUnmarshallerContext>, IUnmarshaller<PipelineMetadata, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PipelineMetadata IUnmarshaller<PipelineMetadata, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public PipelineMetadata Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
