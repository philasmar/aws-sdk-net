...
{
    /// <summary>
    /// Response Unmarshaller for GetJobDetails operation
    /// </summary>  
    public class GetJobDetailsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetJobDetailsResponseUnmarshaller _instance = new GetJobDetailsResponseUnmarshaller();        

        internal static GetJobDetailsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetJobDetailsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
