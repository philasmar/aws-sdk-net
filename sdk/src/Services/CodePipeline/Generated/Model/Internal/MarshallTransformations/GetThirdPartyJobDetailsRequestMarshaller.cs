...
{
    /// <summary>
    /// GetThirdPartyJobDetails Request Marshaller
    /// </summary>       
    public class GetThirdPartyJobDetailsRequestMarshaller : IMarshaller<IRequest, GetThirdPartyJobDetailsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetThirdPartyJobDetailsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetThirdPartyJobDetailsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CodePipeline");
            string target = "CodePipeline_20150709.GetThirdPartyJobDetails";
