    ...
    public class PutWebhookResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return InvalidWebhookAuthenticationParametersExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidWebhookFilterPatternException"))
                {
                    return InvalidWebhookFilterPatternExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
