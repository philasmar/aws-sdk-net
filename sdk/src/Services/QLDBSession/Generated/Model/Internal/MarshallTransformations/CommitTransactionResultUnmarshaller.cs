...
{
    /// <summary>
    /// Response Unmarshaller for CommitTransactionResult Object
    /// </summary>  
    public class CommitTransactionResultUnmarshaller : IUnmarshaller<CommitTransactionResult, XmlUnmarshallerContext>, IUnmarshaller<CommitTransactionResult, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        CommitTransactionResult IUnmarshaller<CommitTransactionResult, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public CommitTransactionResult Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            CommitTransactionResult unmarshalledObject = new CommitTransactionResult();
        ...
        private static CommitTransactionResultUnmarshaller _instance = new CommitTransactionResultUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CommitTransactionResultUnmarshaller Instance
        {
            get
            {
                return _instance;
