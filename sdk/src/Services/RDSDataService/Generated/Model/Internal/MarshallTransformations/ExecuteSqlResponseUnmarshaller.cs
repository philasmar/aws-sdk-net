...
{
    /// <summary>
    /// Response Unmarshaller for ExecuteSql operation
    /// </summary>  
    public class ExecuteSqlResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SqlStatementResult, SqlStatementResultUnmarshaller>(SqlStatementResultUnmarshaller.Instance);
                    response.SqlStatementResults = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ExecuteSqlResponseUnmarshaller _instance = new ExecuteSqlResponseUnmarshaller();        

        internal static ExecuteSqlResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExecuteSqlResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
