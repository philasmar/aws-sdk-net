...
namespace Amazon.RDSDataService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CommitTransactionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CommitTransactionResponseUnmarshaller _instance = new CommitTransactionResponseUnmarshaller();        

        internal static CommitTransactionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CommitTransactionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
