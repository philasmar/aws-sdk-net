...
{
    /// <summary>
    /// Response Unmarshaller for BeginTransaction operation
    /// </summary>  
    public class BeginTransactionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static BeginTransactionResponseUnmarshaller _instance = new BeginTransactionResponseUnmarshaller();        

        internal static BeginTransactionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BeginTransactionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
