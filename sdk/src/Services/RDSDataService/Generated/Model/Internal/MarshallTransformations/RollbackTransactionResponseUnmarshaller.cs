...
{
    /// <summary>
    /// Response Unmarshaller for RollbackTransaction operation
    /// </summary>  
    public class RollbackTransactionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("transactionStatus", targetDepth))
                {
                    ...
                    response.TransactionStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static RollbackTransactionResponseUnmarshaller _instance = new RollbackTransactionResponseUnmarshaller();        

        internal static RollbackTransactionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RollbackTransactionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
