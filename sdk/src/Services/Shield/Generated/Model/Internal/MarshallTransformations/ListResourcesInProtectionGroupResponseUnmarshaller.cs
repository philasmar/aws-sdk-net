...
{
    /// <summary>
    /// Response Unmarshaller for ListResourcesInProtectionGroup operation
    /// </summary>  
    public class ListResourcesInProtectionGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListResourcesInProtectionGroupResponse response = new ListResourcesInProtectionGroupResponse();
        ...
        private static ListResourcesInProtectionGroupResponseUnmarshaller _instance = new ListResourcesInProtectionGroupResponseUnmarshaller();        

        internal static ListResourcesInProtectionGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListResourcesInProtectionGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
