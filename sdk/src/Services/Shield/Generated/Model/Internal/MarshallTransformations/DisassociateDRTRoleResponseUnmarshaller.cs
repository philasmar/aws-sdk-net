...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateDRTRole operation
    /// </summary>  
    public class DisassociateDRTRoleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateDRTRoleResponse response = new DisassociateDRTRoleResponse();
        ...
        private static DisassociateDRTRoleResponseUnmarshaller _instance = new DisassociateDRTRoleResponseUnmarshaller();        

        internal static DisassociateDRTRoleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateDRTRoleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
