...
{
    /// <summary>
    /// Response Unmarshaller for ProtectionGroup Object
    /// </summary>  
    public class ProtectionGroupUnmarshaller : IUnmarshaller<ProtectionGroup, XmlUnmarshallerContext>, IUnmarshaller<ProtectionGroup, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ProtectionGroup IUnmarshaller<ProtectionGroup, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ProtectionGroup Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.ProtectionGroupId = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ProtectionGroupUnmarshaller _instance = new ProtectionGroupUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ProtectionGroupUnmarshaller Instance
        {
            get
            {
                return _instance;
