...
{
    /// <summary>
    /// Response Unmarshaller for DeleteSubscription operation
    /// </summary>  
    public class DeleteSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteSubscriptionResponseUnmarshaller _instance = new DeleteSubscriptionResponseUnmarshaller();        

        internal static DeleteSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
