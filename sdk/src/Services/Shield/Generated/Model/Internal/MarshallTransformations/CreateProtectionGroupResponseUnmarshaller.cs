...
{
    /// <summary>
    /// Response Unmarshaller for CreateProtectionGroup operation
    /// </summary>  
    public class CreateProtectionGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateProtectionGroupResponse response = new CreateProtectionGroupResponse();
        ...
        private static CreateProtectionGroupResponseUnmarshaller _instance = new CreateProtectionGroupResponseUnmarshaller();        

        internal static CreateProtectionGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProtectionGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
