...
{
    /// <summary>
    /// Response Unmarshaller for CreateProtection operation
    /// </summary>  
    public class CreateProtectionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateProtectionResponse response = new CreateProtectionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ProtectionId", targetDepth))
                {
                    ...
                    response.ProtectionId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateProtectionResponseUnmarshaller _instance = new CreateProtectionResponseUnmarshaller();        

        internal static CreateProtectionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProtectionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
