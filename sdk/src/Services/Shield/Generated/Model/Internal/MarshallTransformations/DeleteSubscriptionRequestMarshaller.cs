...
{
    /// <summary>
    /// DeleteSubscription Request Marshaller
    /// </summary>       
    public class DeleteSubscriptionRequestMarshaller : IMarshaller<IRequest, DeleteSubscriptionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteSubscriptionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteSubscriptionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Shield");
            string target = "AWSShield_20160616.DeleteSubscription";
