...
{
    /// <summary>
    /// Response Unmarshaller for ModifyReportDefinition operation
    /// </summary>  
    public class ModifyReportDefinitionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyReportDefinitionResponse response = new ModifyReportDefinitionResponse();
        ...
        private static ModifyReportDefinitionResponseUnmarshaller _instance = new ModifyReportDefinitionResponseUnmarshaller();        

        internal static ModifyReportDefinitionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyReportDefinitionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
