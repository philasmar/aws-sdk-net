...
{
    /// <summary>
    /// DescribeReportDefinitions Request Marshaller
    /// </summary>       
    public class DescribeReportDefinitionsRequestMarshaller : IMarshaller<IRequest, DescribeReportDefinitionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeReportDefinitionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeReportDefinitionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.CostAndUsageReport");
            string target = "AWSOrigamiServiceGatewayService.DescribeReportDefinitions";
