...
{
    /// <summary>
    /// Response Unmarshaller for DescribeReportDefinitions operation
    /// </summary>  
    public class DescribeReportDefinitionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeReportDefinitionsResponse response = new DescribeReportDefinitionsResponse();
        ...
        private static DescribeReportDefinitionsResponseUnmarshaller _instance = new DescribeReportDefinitionsResponseUnmarshaller();        

        internal static DescribeReportDefinitionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeReportDefinitionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
