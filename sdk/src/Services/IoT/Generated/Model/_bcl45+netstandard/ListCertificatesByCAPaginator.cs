...
namespace Amazon.IoT.Model
{
    ...
    internal sealed partial class ListCertificatesByCAPaginator : IPaginator<ListCertificatesByCAResponse>, IListCertificatesByCAPaginator
    {
        ...
        public IPaginatedEnumerable<Certificate> Certificates => 
            new PaginatedResultKeyResponse<ListCertificatesByCAResponse, Certificate>(this, (i) => i.Certificates);
        ...
        async IAsyncEnumerable<ListCertificatesByCAResponse> IPaginator<ListCertificatesByCAResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
