...
{
    /// <summary>
    /// Response Unmarshaller for DeleteThingGroup operation
    /// </summary>  
    public class DeleteThingGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteThingGroupResponse response = new DeleteThingGroupResponse();
        ...
        private static DeleteThingGroupResponseUnmarshaller _instance = new DeleteThingGroupResponseUnmarshaller();        

        internal static DeleteThingGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteThingGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
