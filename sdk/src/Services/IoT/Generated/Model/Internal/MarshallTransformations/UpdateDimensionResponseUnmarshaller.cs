...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDimension operation
    /// </summary>  
    public class UpdateDimensionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDimensionResponse response = new UpdateDimensionResponse();
        ...
        private static UpdateDimensionResponseUnmarshaller _instance = new UpdateDimensionResponseUnmarshaller();        

        internal static UpdateDimensionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDimensionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
