...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteThingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteThingResponse response = new DeleteThingResponse();
        ...
        private static DeleteThingResponseUnmarshaller _instance = new DeleteThingResponseUnmarshaller();        

        internal static DeleteThingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteThingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
