...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListThingPrincipalsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListThingPrincipalsResponse response = new ListThingPrincipalsResponse();
        ...
        private static ListThingPrincipalsResponseUnmarshaller _instance = new ListThingPrincipalsResponseUnmarshaller();        

        internal static ListThingPrincipalsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListThingPrincipalsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
