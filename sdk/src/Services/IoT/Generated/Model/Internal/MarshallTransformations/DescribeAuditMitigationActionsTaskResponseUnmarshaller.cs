...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAuditMitigationActionsTask operation
    /// </summary>  
    public class DescribeAuditMitigationActionsTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAuditMitigationActionsTaskResponse response = new DescribeAuditMitigationActionsTaskResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("actionsDefinition", targetDepth))
                {
                    ...
                    response.ActionsDefinition = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("auditCheckToActionsMapping", targetDepth))
                {
                    ...
                    response.AuditCheckToActionsMapping = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, TaskStatisticsForAuditCheck, StringUnmarshaller, TaskStatisticsForAuditCheckUnmarshaller>(StringUnmarshaller.Instance, TaskStatisticsForAuditCheckUnmarshaller.Instance);
        ...
        private static DescribeAuditMitigationActionsTaskResponseUnmarshaller _instance = new DescribeAuditMitigationActionsTaskResponseUnmarshaller();        

        internal static DescribeAuditMitigationActionsTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAuditMitigationActionsTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
