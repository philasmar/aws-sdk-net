...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ReplaceTopicRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ReplaceTopicRuleResponse response = new ReplaceTopicRuleResponse();
        ...
        private static ReplaceTopicRuleResponseUnmarshaller _instance = new ReplaceTopicRuleResponseUnmarshaller();        

        internal static ReplaceTopicRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReplaceTopicRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
