...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListPrincipalThingsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListPrincipalThingsResponse response = new ListPrincipalThingsResponse();
        ...
        private static ListPrincipalThingsResponseUnmarshaller _instance = new ListPrincipalThingsResponseUnmarshaller();        

        internal static ListPrincipalThingsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListPrincipalThingsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
