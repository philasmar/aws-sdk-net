...
{
    /// <summary>
    /// Response Unmarshaller for DescribeProvisioningTemplateVersion operation
    /// </summary>  
    public class DescribeProvisioningTemplateVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeProvisioningTemplateVersionResponse response = new DescribeProvisioningTemplateVersionResponse();
        ...
        private static DescribeProvisioningTemplateVersionResponseUnmarshaller _instance = new DescribeProvisioningTemplateVersionResponseUnmarshaller();        

        internal static DescribeProvisioningTemplateVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeProvisioningTemplateVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
