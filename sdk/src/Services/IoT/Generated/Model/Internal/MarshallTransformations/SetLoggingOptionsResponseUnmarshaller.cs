...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SetLoggingOptionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetLoggingOptionsResponse response = new SetLoggingOptionsResponse();
        ...
        private static SetLoggingOptionsResponseUnmarshaller _instance = new SetLoggingOptionsResponseUnmarshaller();        

        internal static SetLoggingOptionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetLoggingOptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
