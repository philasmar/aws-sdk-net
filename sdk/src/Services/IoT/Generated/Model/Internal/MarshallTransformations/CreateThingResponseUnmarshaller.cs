...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateThingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateThingResponseUnmarshaller _instance = new CreateThingResponseUnmarshaller();        

        internal static CreateThingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateThingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
