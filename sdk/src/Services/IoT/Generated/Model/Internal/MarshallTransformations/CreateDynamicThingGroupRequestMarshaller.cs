...
{
    /// <summary>
    /// CreateDynamicThingGroup Request Marshaller
    /// </summary>       
    public class CreateDynamicThingGroupRequestMarshaller : IMarshaller<IRequest, CreateDynamicThingGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateDynamicThingGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateDynamicThingGroupRequest publicRequest)
        {
        ...
        private static CreateDynamicThingGroupRequestMarshaller _instance = new CreateDynamicThingGroupRequestMarshaller();        

        internal static CreateDynamicThingGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDynamicThingGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
