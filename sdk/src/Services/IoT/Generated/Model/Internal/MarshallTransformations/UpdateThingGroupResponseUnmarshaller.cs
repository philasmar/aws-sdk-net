...
{
    /// <summary>
    /// Response Unmarshaller for UpdateThingGroup operation
    /// </summary>  
    public class UpdateThingGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateThingGroupResponse response = new UpdateThingGroupResponse();
        ...
        private static UpdateThingGroupResponseUnmarshaller _instance = new UpdateThingGroupResponseUnmarshaller();        

        internal static UpdateThingGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateThingGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
