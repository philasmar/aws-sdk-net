...
{
    /// <summary>
    /// Response Unmarshaller for CreateThingType operation
    /// </summary>  
    public class CreateThingTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateThingTypeResponse response = new CreateThingTypeResponse();
        ...
        private static CreateThingTypeResponseUnmarshaller _instance = new CreateThingTypeResponseUnmarshaller();        

        internal static CreateThingTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateThingTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
