...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateKeysAndCertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateKeysAndCertificateResponse response = new CreateKeysAndCertificateResponse();
        ...
        private static CreateKeysAndCertificateResponseUnmarshaller _instance = new CreateKeysAndCertificateResponseUnmarshaller();        

        internal static CreateKeysAndCertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateKeysAndCertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
