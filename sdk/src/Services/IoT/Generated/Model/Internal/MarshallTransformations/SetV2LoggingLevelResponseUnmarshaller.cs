...
{
    /// <summary>
    /// Response Unmarshaller for SetV2LoggingLevel operation
    /// </summary>  
    public class SetV2LoggingLevelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SetV2LoggingLevelResponse response = new SetV2LoggingLevelResponse();
        ...
        private static SetV2LoggingLevelResponseUnmarshaller _instance = new SetV2LoggingLevelResponseUnmarshaller();        

        internal static SetV2LoggingLevelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SetV2LoggingLevelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
