...
{
    /// <summary>
    /// Response Unmarshaller for DescribeThingType operation
    /// </summary>  
    public class DescribeThingTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeThingTypeResponse response = new DescribeThingTypeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("thingTypeMetadata", targetDepth))
                {
                    ...
                    response.ThingTypeMetadata = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("thingTypeName", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ThingTypeName = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("thingTypeProperties", targetDepth))
                {
                    var unmarshaller = ThingTypePropertiesUnmarshaller.Instance;
                    response.ThingTypeProperties = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeThingTypeResponseUnmarshaller _instance = new DescribeThingTypeResponseUnmarshaller();        

        internal static DescribeThingTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeThingTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
