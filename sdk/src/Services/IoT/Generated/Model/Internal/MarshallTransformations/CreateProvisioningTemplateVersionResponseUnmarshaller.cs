...
{
    /// <summary>
    /// Response Unmarshaller for CreateProvisioningTemplateVersion operation
    /// </summary>  
    public class CreateProvisioningTemplateVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateProvisioningTemplateVersionResponse response = new CreateProvisioningTemplateVersionResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return VersionsLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static CreateProvisioningTemplateVersionResponseUnmarshaller _instance = new CreateProvisioningTemplateVersionResponseUnmarshaller();        

        internal static CreateProvisioningTemplateVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProvisioningTemplateVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
