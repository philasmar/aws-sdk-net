...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    public class DynamoDBv2ActionMarshaller : IRequestMarshaller<DynamoDBv2Action, JsonMarshallerContext> 
    {
        ...
        {
            if(requestObject.IsSetPutItem())
            {
                context.Writer.WritePropertyName("putItem");
                context.Writer.WriteObjectStart();

                var marshaller = PutItemInputMarshaller.Instance;
                marshaller.Marshall(requestObject.PutItem, context);
