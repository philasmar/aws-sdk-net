...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DetachThingPrincipalResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetachThingPrincipalResponse response = new DetachThingPrincipalResponse();
        ...
        private static DetachThingPrincipalResponseUnmarshaller _instance = new DetachThingPrincipalResponseUnmarshaller();        

        internal static DetachThingPrincipalResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachThingPrincipalResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
