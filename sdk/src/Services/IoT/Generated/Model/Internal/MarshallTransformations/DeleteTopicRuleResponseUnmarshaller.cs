...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteTopicRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTopicRuleResponse response = new DeleteTopicRuleResponse();
        ...
        private static DeleteTopicRuleResponseUnmarshaller _instance = new DeleteTopicRuleResponseUnmarshaller();        

        internal static DeleteTopicRuleResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTopicRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
