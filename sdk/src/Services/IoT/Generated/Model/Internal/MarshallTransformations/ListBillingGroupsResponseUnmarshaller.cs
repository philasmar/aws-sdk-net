...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    public class ListBillingGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("billingGroups", targetDepth))
                {
                    ...
                    response.BillingGroups = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListBillingGroupsResponseUnmarshaller _instance = new ListBillingGroupsResponseUnmarshaller();        

        internal static ListBillingGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListBillingGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
