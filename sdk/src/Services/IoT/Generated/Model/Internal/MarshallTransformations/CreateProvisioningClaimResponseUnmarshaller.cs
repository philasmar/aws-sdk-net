...
{
    /// <summary>
    /// Response Unmarshaller for CreateProvisioningClaim operation
    /// </summary>  
    public class CreateProvisioningClaimResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateProvisioningClaimResponse response = new CreateProvisioningClaimResponse();
        ...
        private static CreateProvisioningClaimResponseUnmarshaller _instance = new CreateProvisioningClaimResponseUnmarshaller();        

        internal static CreateProvisioningClaimResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProvisioningClaimResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
