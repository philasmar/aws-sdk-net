...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDomainConfiguration operation
    /// </summary>  
    public class UpdateDomainConfigurationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDomainConfigurationResponse response = new UpdateDomainConfigurationResponse();
        ...
        private static UpdateDomainConfigurationResponseUnmarshaller _instance = new UpdateDomainConfigurationResponseUnmarshaller();        

        internal static UpdateDomainConfigurationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDomainConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
