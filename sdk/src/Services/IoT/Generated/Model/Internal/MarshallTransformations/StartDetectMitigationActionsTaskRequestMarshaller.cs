...
{
    /// <summary>
    /// StartDetectMitigationActionsTask Request Marshaller
    /// </summary>       
    public class StartDetectMitigationActionsTaskRequestMarshaller : IMarshaller<IRequest, StartDetectMitigationActionsTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartDetectMitigationActionsTaskRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartDetectMitigationActionsTaskRequest publicRequest)
        {
        ...
        private static StartDetectMitigationActionsTaskRequestMarshaller _instance = new StartDetectMitigationActionsTaskRequestMarshaller();        

        internal static StartDetectMitigationActionsTaskRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartDetectMitigationActionsTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
