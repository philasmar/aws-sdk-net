...
{
    /// <summary>
    /// Response Unmarshaller for CreateSecurityProfile operation
    /// </summary>  
    public class CreateSecurityProfileResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSecurityProfileResponse response = new CreateSecurityProfileResponse();
        ...
        private static CreateSecurityProfileResponseUnmarshaller _instance = new CreateSecurityProfileResponseUnmarshaller();        

        internal static CreateSecurityProfileResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSecurityProfileResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
