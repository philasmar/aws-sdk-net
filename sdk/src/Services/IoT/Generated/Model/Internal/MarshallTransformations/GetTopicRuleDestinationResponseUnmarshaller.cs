...
{
    /// <summary>
    /// Response Unmarshaller for GetTopicRuleDestination operation
    /// </summary>  
    public class GetTopicRuleDestinationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTopicRuleDestinationResponse response = new GetTopicRuleDestinationResponse();
        ...
        private static GetTopicRuleDestinationResponseUnmarshaller _instance = new GetTopicRuleDestinationResponseUnmarshaller();        

        internal static GetTopicRuleDestinationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTopicRuleDestinationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
