...
{
    /// <summary>
    /// Response Unmarshaller for DescribeMitigationAction operation
    /// </summary>  
    public class DescribeMitigationActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeMitigationActionResponse response = new DescribeMitigationActionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("actionParams", targetDepth))
                {
                    ...
                    response.ActionParams = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeMitigationActionResponseUnmarshaller _instance = new DescribeMitigationActionResponseUnmarshaller();        

        internal static DescribeMitigationActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeMitigationActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
