...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DetectMitigationActionsTaskTargetUnmarshaller : IUnmarshaller<DetectMitigationActionsTaskTarget, XmlUnmarshallerContext>, IUnmarshaller<DetectMitigationActionsTaskTarget, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        DetectMitigationActionsTaskTarget IUnmarshaller<DetectMitigationActionsTaskTarget, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public DetectMitigationActionsTaskTarget Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("violationIds", targetDepth))
                {
                    ...
                    unmarshalledObject.ViolationIds = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
