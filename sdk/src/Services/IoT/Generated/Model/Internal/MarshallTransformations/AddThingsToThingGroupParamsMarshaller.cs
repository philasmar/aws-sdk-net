...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    public class AddThingsToThingGroupParamsMarshaller : IRequestMarshaller<AddThingsToThingGroupParams, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(AddThingsToThingGroupParams requestObject, JsonMarshallerContext context)
        {
            ...
            {
                context.Writer.WritePropertyName("thingGroupNames");
                context.Writer.WriteArrayStart();
                foreach(var requestObjectThingGroupNamesListValue in requestObject.ThingGroupNames)
                {
                        context.Writer.Write(requestObjectThingGroupNamesListValue);
                }
