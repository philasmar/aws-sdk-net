...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateCertificateFromCsrResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateCertificateFromCsrResponse response = new CreateCertificateFromCsrResponse();
        ...
        private static CreateCertificateFromCsrResponseUnmarshaller _instance = new CreateCertificateFromCsrResponseUnmarshaller();        

        internal static CreateCertificateFromCsrResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCertificateFromCsrResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
