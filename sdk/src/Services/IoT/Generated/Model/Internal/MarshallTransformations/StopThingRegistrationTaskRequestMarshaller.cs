...
{
    /// <summary>
    /// StopThingRegistrationTask Request Marshaller
    /// </summary>       
    public class StopThingRegistrationTaskRequestMarshaller : IMarshaller<IRequest, StopThingRegistrationTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StopThingRegistrationTaskRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StopThingRegistrationTaskRequest publicRequest)
        {
            ...
            request.ResourcePath = "/thing-registration-tasks/{taskId}/cancel";
