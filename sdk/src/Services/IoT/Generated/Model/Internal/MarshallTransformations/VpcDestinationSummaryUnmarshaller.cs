...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class VpcDestinationSummaryUnmarshaller : IUnmarshaller<VpcDestinationSummary, XmlUnmarshallerContext>, IUnmarshaller<VpcDestinationSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        VpcDestinationSummary IUnmarshaller<VpcDestinationSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public VpcDestinationSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
