...
{
    /// <summary>
    /// Response Unmarshaller for ListThingGroups operation
    /// </summary>  
    public class ListThingGroupsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListThingGroupsResponse response = new ListThingGroupsResponse();
        ...
        private static ListThingGroupsResponseUnmarshaller _instance = new ListThingGroupsResponseUnmarshaller();        

        internal static ListThingGroupsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListThingGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
