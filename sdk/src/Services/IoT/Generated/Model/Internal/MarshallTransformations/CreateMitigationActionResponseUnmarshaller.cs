...
{
    /// <summary>
    /// Response Unmarshaller for CreateMitigationAction operation
    /// </summary>  
    public class CreateMitigationActionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMitigationActionResponse response = new CreateMitigationActionResponse();
        ...
        private static CreateMitigationActionResponseUnmarshaller _instance = new CreateMitigationActionResponseUnmarshaller();        

        internal static CreateMitigationActionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMitigationActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
