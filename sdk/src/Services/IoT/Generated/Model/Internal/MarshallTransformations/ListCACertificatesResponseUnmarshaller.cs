...
{
    /// <summary>
    /// Response Unmarshaller for ListCACertificates operation
    /// </summary>  
    public class ListCACertificatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListCACertificatesResponseUnmarshaller _instance = new ListCACertificatesResponseUnmarshaller();        

        internal static ListCACertificatesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListCACertificatesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
