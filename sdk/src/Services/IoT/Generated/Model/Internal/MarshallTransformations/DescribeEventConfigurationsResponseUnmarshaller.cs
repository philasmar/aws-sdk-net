...
{
    /// <summary>
    /// Response Unmarshaller for DescribeEventConfigurations operation
    /// </summary>  
    public class DescribeEventConfigurationsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeEventConfigurationsResponse response = new DescribeEventConfigurationsResponse();
        ...
        private static DescribeEventConfigurationsResponseUnmarshaller _instance = new DescribeEventConfigurationsResponseUnmarshaller();        

        internal static DescribeEventConfigurationsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeEventConfigurationsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
