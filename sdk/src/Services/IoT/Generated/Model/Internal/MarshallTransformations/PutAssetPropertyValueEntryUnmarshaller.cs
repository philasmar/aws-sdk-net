...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutAssetPropertyValueEntryUnmarshaller : IUnmarshaller<PutAssetPropertyValueEntry, XmlUnmarshallerContext>, IUnmarshaller<PutAssetPropertyValueEntry, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        PutAssetPropertyValueEntry IUnmarshaller<PutAssetPropertyValueEntry, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public PutAssetPropertyValueEntry Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.PropertyAlias = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("propertyValues", targetDepth))
                {
                    ...
                    unmarshalledObject.PropertyValues = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
