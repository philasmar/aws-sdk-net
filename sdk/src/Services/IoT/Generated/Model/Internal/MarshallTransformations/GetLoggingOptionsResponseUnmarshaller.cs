...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetLoggingOptionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetLoggingOptionsResponse response = new GetLoggingOptionsResponse();
        ...
        private static GetLoggingOptionsResponseUnmarshaller _instance = new GetLoggingOptionsResponseUnmarshaller();        

        internal static GetLoggingOptionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetLoggingOptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
