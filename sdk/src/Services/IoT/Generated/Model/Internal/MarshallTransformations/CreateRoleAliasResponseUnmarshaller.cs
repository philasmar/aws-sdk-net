...
{
    /// <summary>
    /// Response Unmarshaller for CreateRoleAlias operation
    /// </summary>  
    public class CreateRoleAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateRoleAliasResponse response = new CreateRoleAliasResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("roleAlias", targetDepth))
                {
                    ...
                    response.RoleAlias = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("roleAliasArn", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.RoleAliasArn = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CreateRoleAliasResponseUnmarshaller _instance = new CreateRoleAliasResponseUnmarshaller();        

        internal static CreateRoleAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateRoleAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
