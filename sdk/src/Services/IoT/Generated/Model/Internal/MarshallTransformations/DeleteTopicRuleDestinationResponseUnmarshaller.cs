...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTopicRuleDestination operation
    /// </summary>  
    public class DeleteTopicRuleDestinationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTopicRuleDestinationResponse response = new DeleteTopicRuleDestinationResponse();
        ...
        private static DeleteTopicRuleDestinationResponseUnmarshaller _instance = new DeleteTopicRuleDestinationResponseUnmarshaller();        

        internal static DeleteTopicRuleDestinationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTopicRuleDestinationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
