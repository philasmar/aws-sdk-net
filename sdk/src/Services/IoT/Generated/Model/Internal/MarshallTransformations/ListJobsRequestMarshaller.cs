    ...
    public class ListJobsRequestMarshaller : IMarshaller<IRequest, ListJobsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListJobsRequest publicRequest)
        {
            ...
            if (publicRequest.IsSetTargetSelection())
                request.Parameters.Add("targetSelection", StringUtils.FromString(publicRequest.TargetSelection));
            
            if (publicRequest.IsSetThingGroupId())
                request.Parameters.Add("thingGroupId", StringUtils.FromString(publicRequest.ThingGroupId));
