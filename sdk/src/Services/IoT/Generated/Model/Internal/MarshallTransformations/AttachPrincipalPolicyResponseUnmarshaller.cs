...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class AttachPrincipalPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AttachPrincipalPolicyResponse response = new AttachPrincipalPolicyResponse();
        ...
        private static AttachPrincipalPolicyResponseUnmarshaller _instance = new AttachPrincipalPolicyResponseUnmarshaller();        

        internal static AttachPrincipalPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AttachPrincipalPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
