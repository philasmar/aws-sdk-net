...
{
    /// <summary>
    /// Response Unmarshaller for RegisterThing operation
    /// </summary>  
    public class RegisterThingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterThingResponse response = new RegisterThingResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("certificatePem", targetDepth))
                {
                    ...
                    response.CertificatePem = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ResourceRegistrationFailureException"))
                {
                    return ResourceRegistrationFailureExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static RegisterThingResponseUnmarshaller _instance = new RegisterThingResponseUnmarshaller();        

        internal static RegisterThingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterThingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
