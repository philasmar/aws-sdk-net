...
{
    /// <summary>
    /// Response Unmarshaller for CancelJobExecution operation
    /// </summary>  
    public class CancelJobExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelJobExecutionResponse response = new CancelJobExecutionResponse();
        ...
        private static CancelJobExecutionResponseUnmarshaller _instance = new CancelJobExecutionResponseUnmarshaller();        

        internal static CancelJobExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelJobExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
