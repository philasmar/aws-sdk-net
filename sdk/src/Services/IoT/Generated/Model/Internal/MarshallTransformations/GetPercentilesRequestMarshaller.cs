...
{
    /// <summary>
    /// GetPercentiles Request Marshaller
    /// </summary>       
    public class GetPercentilesRequestMarshaller : IMarshaller<IRequest, GetPercentilesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetPercentilesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetPercentilesRequest publicRequest)
        {
        ...
        private static GetPercentilesRequestMarshaller _instance = new GetPercentilesRequestMarshaller();        

        internal static GetPercentilesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetPercentilesRequestMarshaller Instance
        {
            get
            {
                return _instance;
