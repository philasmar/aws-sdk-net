...
{
    /// <summary>
    /// Response Unmarshaller for DeleteProvisioningTemplate operation
    /// </summary>  
    public class DeleteProvisioningTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteProvisioningTemplateResponse response = new DeleteProvisioningTemplateResponse();
        ...
        private static DeleteProvisioningTemplateResponseUnmarshaller _instance = new DeleteProvisioningTemplateResponseUnmarshaller();        

        internal static DeleteProvisioningTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteProvisioningTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
