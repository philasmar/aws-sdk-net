...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DetachPrincipalPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DetachPrincipalPolicyResponse response = new DetachPrincipalPolicyResponse();
        ...
        private static DetachPrincipalPolicyResponseUnmarshaller _instance = new DetachPrincipalPolicyResponseUnmarshaller();        

        internal static DetachPrincipalPolicyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DetachPrincipalPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
