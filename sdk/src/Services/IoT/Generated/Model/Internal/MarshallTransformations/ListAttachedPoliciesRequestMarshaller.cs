...
{
    /// <summary>
    /// ListAttachedPolicies Request Marshaller
    /// </summary>       
    public class ListAttachedPoliciesRequestMarshaller : IMarshaller<IRequest, ListAttachedPoliciesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAttachedPoliciesRequest)input);
        }
        ...
        private static ListAttachedPoliciesRequestMarshaller _instance = new ListAttachedPoliciesRequestMarshaller();        

        internal static ListAttachedPoliciesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAttachedPoliciesRequestMarshaller Instance
        {
            get
            {
                return _instance;
