...
{
    /// <summary>
    /// Response Unmarshaller for DescribeCACertificate operation
    /// </summary>  
    public class DescribeCACertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeCACertificateResponse response = new DescribeCACertificateResponse();
        ...
        private static DescribeCACertificateResponseUnmarshaller _instance = new DescribeCACertificateResponseUnmarshaller();        

        internal static DescribeCACertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCACertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
