...
{
    /// <summary>
    /// Response Unmarshaller for RegisterCACertificate operation
    /// </summary>  
    public class RegisterCACertificateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RegisterCACertificateResponse response = new RegisterCACertificateResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("RegistrationCodeValidationException"))
                {
                    return RegistrationCodeValidationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static RegisterCACertificateResponseUnmarshaller _instance = new RegisterCACertificateResponseUnmarshaller();        

        internal static RegisterCACertificateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RegisterCACertificateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
