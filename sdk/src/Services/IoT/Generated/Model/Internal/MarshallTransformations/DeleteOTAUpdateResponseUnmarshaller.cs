...
{
    /// <summary>
    /// Response Unmarshaller for DeleteOTAUpdate operation
    /// </summary>  
    public class DeleteOTAUpdateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteOTAUpdateResponse response = new DeleteOTAUpdateResponse();
        ...
        private static DeleteOTAUpdateResponseUnmarshaller _instance = new DeleteOTAUpdateResponseUnmarshaller();        

        internal static DeleteOTAUpdateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteOTAUpdateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
