...
{
    /// <summary>
    /// Response Unmarshaller for CreateThingGroup operation
    /// </summary>  
    public class CreateThingGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateThingGroupResponse response = new CreateThingGroupResponse();
        ...
        private static CreateThingGroupResponseUnmarshaller _instance = new CreateThingGroupResponseUnmarshaller();        

        internal static CreateThingGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateThingGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
