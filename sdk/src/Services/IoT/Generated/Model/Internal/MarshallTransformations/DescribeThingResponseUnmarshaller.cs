...
namespace Amazon.IoT.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeThingResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ThingId = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeThingResponseUnmarshaller _instance = new DescribeThingResponseUnmarshaller();        

        internal static DescribeThingResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeThingResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
