...
{
    /// <summary>
    /// Response Unmarshaller for CreateProvisioningTemplate operation
    /// </summary>  
    public class CreateProvisioningTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateProvisioningTemplateResponse response = new CreateProvisioningTemplateResponse();
        ...
        private static CreateProvisioningTemplateResponseUnmarshaller _instance = new CreateProvisioningTemplateResponseUnmarshaller();        

        internal static CreateProvisioningTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateProvisioningTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
