...
{
    /// <summary>
    /// Response Unmarshaller for DeleteProvisioningTemplateVersion operation
    /// </summary>  
    public class DeleteProvisioningTemplateVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteProvisioningTemplateVersionResponse response = new DeleteProvisioningTemplateVersionResponse();
        ...
        private static DeleteProvisioningTemplateVersionResponseUnmarshaller _instance = new DeleteProvisioningTemplateVersionResponseUnmarshaller();        

        internal static DeleteProvisioningTemplateVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteProvisioningTemplateVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
