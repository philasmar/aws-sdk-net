...
{
    /// <summary>
    /// Response Unmarshaller for DescribeThingGroup operation
    /// </summary>  
    public class DescribeThingGroupResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeThingGroupResponse response = new DescribeThingGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = ThingGroupMetadataUnmarshaller.Instance;
                    response.ThingGroupMetadata = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = ThingGroupPropertiesUnmarshaller.Instance;
                    response.ThingGroupProperties = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeThingGroupResponseUnmarshaller _instance = new DescribeThingGroupResponseUnmarshaller();        

        internal static DescribeThingGroupResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeThingGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
