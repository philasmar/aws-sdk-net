...
{
    /// <summary>
    /// Response Unmarshaller for CancelArchival operation
    /// </summary>  
    public class CancelArchivalResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelArchivalResponse response = new CancelArchivalResponse();
        ...
        private static CancelArchivalResponseUnmarshaller _instance = new CancelArchivalResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelArchivalResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
