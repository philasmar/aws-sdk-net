...
{
    /// <summary>
    /// CancelRetrieval Request Marshaller
    /// </summary>       
    public class CancelRetrievalRequestMarshaller : IMarshaller<IRequest, CancelRetrievalRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CancelRetrievalRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CancelRetrievalRequest publicRequest)
        {
        ...
        private static CancelRetrievalRequestMarshaller _instance = new CancelRetrievalRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelRetrievalRequestMarshaller Instance
        {
            get
            {
                return _instance;
