...
namespace Amazon.StorageGateway.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeStorediSCSIVolumesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<StorediSCSIVolume, StorediSCSIVolumeUnmarshaller>(StorediSCSIVolumeUnmarshaller.Instance);
        ...
        private static DescribeStorediSCSIVolumesResponseUnmarshaller _instance = new DescribeStorediSCSIVolumesResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeStorediSCSIVolumesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
