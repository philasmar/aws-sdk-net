...
{
    /// <summary>
    /// Response Unmarshaller for CreateTapePool operation
    /// </summary>  
    public class CreateTapePoolResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTapePoolResponse response = new CreateTapePoolResponse();
        ...
        private static CreateTapePoolResponseUnmarshaller _instance = new CreateTapePoolResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTapePoolResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
