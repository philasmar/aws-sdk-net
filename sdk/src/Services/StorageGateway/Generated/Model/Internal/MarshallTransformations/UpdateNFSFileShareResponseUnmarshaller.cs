...
{
    /// <summary>
    /// Response Unmarshaller for UpdateNFSFileShare operation
    /// </summary>  
    public class UpdateNFSFileShareResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateNFSFileShareResponse response = new UpdateNFSFileShareResponse();
        ...
        private static UpdateNFSFileShareResponseUnmarshaller _instance = new UpdateNFSFileShareResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateNFSFileShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
