...
{
    /// <summary>
    /// ListLocalDisks Request Marshaller
    /// </summary>       
    public class ListLocalDisksRequestMarshaller : IMarshaller<IRequest, ListLocalDisksRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListLocalDisksRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListLocalDisksRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.StorageGateway");
            string target = "StorageGateway_20130630.ListLocalDisks";
