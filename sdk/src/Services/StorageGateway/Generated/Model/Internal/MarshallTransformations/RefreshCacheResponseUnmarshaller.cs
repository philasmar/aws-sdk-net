...
{
    /// <summary>
    /// Response Unmarshaller for RefreshCache operation
    /// </summary>  
    public class RefreshCacheResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RefreshCacheResponse response = new RefreshCacheResponse();
        ...
        private static RefreshCacheResponseUnmarshaller _instance = new RefreshCacheResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RefreshCacheResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
