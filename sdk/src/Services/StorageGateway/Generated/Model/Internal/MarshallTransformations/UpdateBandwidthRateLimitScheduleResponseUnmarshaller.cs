...
{
    /// <summary>
    /// Response Unmarshaller for UpdateBandwidthRateLimitSchedule operation
    /// </summary>  
    public class UpdateBandwidthRateLimitScheduleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateBandwidthRateLimitScheduleResponse response = new UpdateBandwidthRateLimitScheduleResponse();
        ...
        private static UpdateBandwidthRateLimitScheduleResponseUnmarshaller _instance = new UpdateBandwidthRateLimitScheduleResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateBandwidthRateLimitScheduleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
