...
{
    /// <summary>
    /// ListTapes Request Marshaller
    /// </summary>       
    public class ListTapesRequestMarshaller : IMarshaller<IRequest, ListTapesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListTapesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListTapesRequest publicRequest)
        {
        ...
        private static ListTapesRequestMarshaller _instance = new ListTapesRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTapesRequestMarshaller Instance
        {
            get
            {
                return _instance;
