...
{
    /// <summary>
    /// Response Unmarshaller for CreateTapeWithBarcode operation
    /// </summary>  
    public class CreateTapeWithBarcodeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTapeWithBarcodeResponse response = new CreateTapeWithBarcodeResponse();
        ...
        private static CreateTapeWithBarcodeResponseUnmarshaller _instance = new CreateTapeWithBarcodeResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTapeWithBarcodeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
