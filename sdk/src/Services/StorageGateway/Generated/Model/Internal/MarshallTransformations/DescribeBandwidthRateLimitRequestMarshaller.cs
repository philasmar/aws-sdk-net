...
{
    /// <summary>
    /// DescribeBandwidthRateLimit Request Marshaller
    /// </summary>       
    public class DescribeBandwidthRateLimitRequestMarshaller : IMarshaller<IRequest, DescribeBandwidthRateLimitRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeBandwidthRateLimitRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeBandwidthRateLimitRequest publicRequest)
        {
