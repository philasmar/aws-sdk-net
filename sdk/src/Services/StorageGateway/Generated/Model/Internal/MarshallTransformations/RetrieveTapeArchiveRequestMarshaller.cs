...
{
    /// <summary>
    /// RetrieveTapeArchive Request Marshaller
    /// </summary>       
    public class RetrieveTapeArchiveRequestMarshaller : IMarshaller<IRequest, RetrieveTapeArchiveRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RetrieveTapeArchiveRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RetrieveTapeArchiveRequest publicRequest)
        {
