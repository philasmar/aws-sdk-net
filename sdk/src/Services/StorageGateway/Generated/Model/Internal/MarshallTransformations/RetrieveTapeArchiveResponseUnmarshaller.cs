...
{
    /// <summary>
    /// Response Unmarshaller for RetrieveTapeArchive operation
    /// </summary>  
    public class RetrieveTapeArchiveResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RetrieveTapeArchiveResponse response = new RetrieveTapeArchiveResponse();
        ...
        private static RetrieveTapeArchiveResponseUnmarshaller _instance = new RetrieveTapeArchiveResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RetrieveTapeArchiveResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
