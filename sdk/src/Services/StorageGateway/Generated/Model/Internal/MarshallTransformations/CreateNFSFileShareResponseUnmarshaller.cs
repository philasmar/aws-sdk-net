...
{
    /// <summary>
    /// Response Unmarshaller for CreateNFSFileShare operation
    /// </summary>  
    public class CreateNFSFileShareResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateNFSFileShareResponse response = new CreateNFSFileShareResponse();
        ...
        private static CreateNFSFileShareResponseUnmarshaller _instance = new CreateNFSFileShareResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateNFSFileShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
