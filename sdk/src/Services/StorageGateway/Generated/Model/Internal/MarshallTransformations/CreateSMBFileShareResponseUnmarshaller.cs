...
{
    /// <summary>
    /// Response Unmarshaller for CreateSMBFileShare operation
    /// </summary>  
    public class CreateSMBFileShareResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSMBFileShareResponse response = new CreateSMBFileShareResponse();
        ...
        private static CreateSMBFileShareResponseUnmarshaller _instance = new CreateSMBFileShareResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSMBFileShareResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
