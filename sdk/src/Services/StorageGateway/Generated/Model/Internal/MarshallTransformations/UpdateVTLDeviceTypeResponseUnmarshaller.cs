...
{
    /// <summary>
    /// Response Unmarshaller for UpdateVTLDeviceType operation
    /// </summary>  
    public class UpdateVTLDeviceTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateVTLDeviceTypeResponse response = new UpdateVTLDeviceTypeResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("VTLDeviceARN", targetDepth))
                {
                    ...
                    response.VTLDeviceARN = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static UpdateVTLDeviceTypeResponseUnmarshaller _instance = new UpdateVTLDeviceTypeResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateVTLDeviceTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
