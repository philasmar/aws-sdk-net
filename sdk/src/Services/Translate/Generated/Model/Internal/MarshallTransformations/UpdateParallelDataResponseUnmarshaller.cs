...
{
    /// <summary>
    /// Response Unmarshaller for UpdateParallelData operation
    /// </summary>  
    public class UpdateParallelDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateParallelDataResponse response = new UpdateParallelDataResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("LatestUpdateAttemptStatus", targetDepth))
                {
                    ...
                    response.LatestUpdateAttemptStatus = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static UpdateParallelDataResponseUnmarshaller _instance = new UpdateParallelDataResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateParallelDataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
