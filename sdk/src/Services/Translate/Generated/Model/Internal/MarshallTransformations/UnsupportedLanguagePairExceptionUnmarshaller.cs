...
namespace Amazon.Translate.Model.Internal.MarshallTransformations
{
    ...
    public class UnsupportedLanguagePairExceptionUnmarshaller : IErrorResponseUnmarshaller<UnsupportedLanguagePairException, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public UnsupportedLanguagePairException Unmarshall(JsonUnmarshallerContext context, ErrorResponse errorResponse)
        {
            context.Read();
        ...
        private static UnsupportedLanguagePairExceptionUnmarshaller _instance = new UnsupportedLanguagePairExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static UnsupportedLanguagePairExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
