...
{
    /// <summary>
    /// Response Unmarshaller for StartTextTranslationJob operation
    /// </summary>  
    public class StartTextTranslationJobResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartTextTranslationJobResponse response = new StartTextTranslationJobResponse();
        ...
        private static StartTextTranslationJobResponseUnmarshaller _instance = new StartTextTranslationJobResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartTextTranslationJobResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
