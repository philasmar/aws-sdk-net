...
namespace Amazon.Kendra.Model.Internal.MarshallTransformations
{
    ...
    public class AccessControlListConfigurationMarshaller : IRequestMarshaller<AccessControlListConfiguration, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(AccessControlListConfiguration requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetKeyPath())
            {
                context.Writer.WritePropertyName("KeyPath");
                context.Writer.Write(requestObject.KeyPath);
            }
