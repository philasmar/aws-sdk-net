...
namespace Amazon.Kendra.Model.Internal.MarshallTransformations
{
    ...
    public class AdditionalResultAttributeValueUnmarshaller : IUnmarshaller<AdditionalResultAttributeValue, XmlUnmarshallerContext>, IUnmarshaller<AdditionalResultAttributeValue, JsonUnmarshallerContext>
    {
        ...
        private static AdditionalResultAttributeValueUnmarshaller _instance = new AdditionalResultAttributeValueUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static AdditionalResultAttributeValueUnmarshaller Instance
        {
            get
            {
                return _instance;
