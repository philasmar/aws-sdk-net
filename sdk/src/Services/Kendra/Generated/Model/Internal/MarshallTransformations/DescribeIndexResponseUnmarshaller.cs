...
{
    /// <summary>
    /// Response Unmarshaller for DescribeIndex operation
    /// </summary>  
    public class DescribeIndexResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeIndexResponse response = new DescribeIndexResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("ServerSideEncryptionConfiguration", targetDepth))
                {
                    ...
                    response.ServerSideEncryptionConfiguration = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeIndexResponseUnmarshaller _instance = new DescribeIndexResponseUnmarshaller();        

        internal static DescribeIndexResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeIndexResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
