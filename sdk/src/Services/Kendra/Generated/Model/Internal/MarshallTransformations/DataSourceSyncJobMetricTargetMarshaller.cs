...
namespace Amazon.Kendra.Model.Internal.MarshallTransformations
{
    ...
    public class DataSourceSyncJobMetricTargetMarshaller : IRequestMarshaller<DataSourceSyncJobMetricTarget, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(DataSourceSyncJobMetricTarget requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetDataSourceSyncJobId())
            {
                context.Writer.WritePropertyName("DataSourceSyncJobId");
                context.Writer.Write(requestObject.DataSourceSyncJobId);
            }
