...
{
    /// <summary>
    /// BatchDeleteDocument Request Marshaller
    /// </summary>       
    public class BatchDeleteDocumentRequestMarshaller : IMarshaller<IRequest, BatchDeleteDocumentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchDeleteDocumentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchDeleteDocumentRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.Kendra");
            string target = "AWSKendraFrontendService.BatchDeleteDocument";
        ...
        private static BatchDeleteDocumentRequestMarshaller _instance = new BatchDeleteDocumentRequestMarshaller();        

        internal static BatchDeleteDocumentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchDeleteDocumentRequestMarshaller Instance
        {
            get
            {
                return _instance;
