...
namespace Amazon.EC2InstanceConnect.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class SendSSHPublicKeyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SendSSHPublicKeyResponse response = new SendSSHPublicKeyResponse();
        ...
        private static SendSSHPublicKeyResponseUnmarshaller _instance = new SendSSHPublicKeyResponseUnmarshaller();        

        internal static SendSSHPublicKeyResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SendSSHPublicKeyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
