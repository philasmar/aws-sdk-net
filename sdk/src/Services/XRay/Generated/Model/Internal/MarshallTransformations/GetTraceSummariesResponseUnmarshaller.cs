...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetTraceSummariesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTraceSummariesResponse response = new GetTraceSummariesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("ApproximateTime", targetDepth))
                {
                    ...
                    response.ApproximateTime = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("TracesProcessedCount", targetDepth))
                {
                    ...
                    response.TracesProcessedCount = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("TraceSummaries", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<TraceSummary, TraceSummaryUnmarshaller>(TraceSummaryUnmarshaller.Instance);
                    response.TraceSummaries = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTraceSummariesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
