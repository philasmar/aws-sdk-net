...
{
    /// <summary>
    /// DeleteSamplingRule Request Marshaller
    /// </summary>       
    public class DeleteSamplingRuleRequestMarshaller : IMarshaller<IRequest, DeleteSamplingRuleRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteSamplingRuleRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteSamplingRuleRequest publicRequest)
        {
        ...
        private static DeleteSamplingRuleRequestMarshaller _instance = new DeleteSamplingRuleRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSamplingRuleRequestMarshaller Instance
        {
            get
            {
                return _instance;
