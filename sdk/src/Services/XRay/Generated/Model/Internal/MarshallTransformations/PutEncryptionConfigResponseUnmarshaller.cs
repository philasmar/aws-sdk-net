...
{
    /// <summary>
    /// Response Unmarshaller for PutEncryptionConfig operation
    /// </summary>  
    public class PutEncryptionConfigResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutEncryptionConfigResponse response = new PutEncryptionConfigResponse();
        ...
        private static PutEncryptionConfigResponseUnmarshaller _instance = new PutEncryptionConfigResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutEncryptionConfigResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
