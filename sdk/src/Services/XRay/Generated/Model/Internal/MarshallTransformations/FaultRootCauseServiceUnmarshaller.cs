...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class FaultRootCauseServiceUnmarshaller : IUnmarshaller<FaultRootCauseService, XmlUnmarshallerContext>, IUnmarshaller<FaultRootCauseService, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        FaultRootCauseService IUnmarshaller<FaultRootCauseService, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public FaultRootCauseService Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<FaultRootCauseEntity, FaultRootCauseEntityUnmarshaller>(FaultRootCauseEntityUnmarshaller.Instance);
