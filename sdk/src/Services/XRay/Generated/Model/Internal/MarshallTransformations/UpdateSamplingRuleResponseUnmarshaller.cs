...
namespace Amazon.XRay.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateSamplingRuleResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateSamplingRuleResponse response = new UpdateSamplingRuleResponse();
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSamplingRuleResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
