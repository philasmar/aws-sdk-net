...
{
    /// <summary>
    /// Response Unmarshaller for GetSamplingTargets operation
    /// </summary>  
    public class GetSamplingTargetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSamplingTargetsResponse response = new GetSamplingTargetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("LastRuleModification", targetDepth))
                {
                    ...
                    response.LastRuleModification = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SamplingTargetDocuments", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<SamplingTargetDocument, SamplingTargetDocumentUnmarshaller>(SamplingTargetDocumentUnmarshaller.Instance);
                ...
                if (context.TestExpression("UnprocessedStatistics", targetDepth))
                {
                    ...
                    response.UnprocessedStatistics = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetSamplingTargetsResponseUnmarshaller _instance = new GetSamplingTargetsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSamplingTargetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
