...
{
    /// <summary>
    /// Response Unmarshaller for GetTraceGraph operation
    /// </summary>  
    public class GetTraceGraphResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetTraceGraphResponse response = new GetTraceGraphResponse();
        ...
        private static GetTraceGraphResponseUnmarshaller _instance = new GetTraceGraphResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetTraceGraphResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
