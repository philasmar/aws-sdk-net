...
{
    /// <summary>
    /// Response Unmarshaller for TagResources operation
    /// </summary>  
    public class TagResourcesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static TagResourcesResponseUnmarshaller _instance = new TagResourcesResponseUnmarshaller();        

        internal static TagResourcesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static TagResourcesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
