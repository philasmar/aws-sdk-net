...
{
    /// <summary>
    /// Response Unmarshaller for StartReportCreation operation
    /// </summary>  
    public class StartReportCreationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartReportCreationResponse response = new StartReportCreationResponse();
        ...
        private static StartReportCreationResponseUnmarshaller _instance = new StartReportCreationResponseUnmarshaller();        

        internal static StartReportCreationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartReportCreationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
