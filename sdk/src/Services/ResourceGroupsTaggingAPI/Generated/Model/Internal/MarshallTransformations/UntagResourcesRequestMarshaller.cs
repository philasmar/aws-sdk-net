...
{
    /// <summary>
    /// UntagResources Request Marshaller
    /// </summary>       
    public class UntagResourcesRequestMarshaller : IMarshaller<IRequest, UntagResourcesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UntagResourcesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UntagResourcesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ResourceGroupsTaggingAPI");
            string target = "ResourceGroupsTaggingAPI_20170126.UntagResources";
        ...
        private static UntagResourcesRequestMarshaller _instance = new UntagResourcesRequestMarshaller();        

        internal static UntagResourcesRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UntagResourcesRequestMarshaller Instance
        {
            get
            {
                return _instance;
