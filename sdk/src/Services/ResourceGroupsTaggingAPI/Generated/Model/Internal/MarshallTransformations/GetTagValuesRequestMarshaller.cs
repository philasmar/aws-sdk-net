...
{
    /// <summary>
    /// GetTagValues Request Marshaller
    /// </summary>       
    public class GetTagValuesRequestMarshaller : IMarshaller<IRequest, GetTagValuesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetTagValuesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetTagValuesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ResourceGroupsTaggingAPI");
            string target = "ResourceGroupsTaggingAPI_20170126.GetTagValues";
