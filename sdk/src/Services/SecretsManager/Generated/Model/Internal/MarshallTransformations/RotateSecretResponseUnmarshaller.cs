...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RotateSecretResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RotateSecretResponse response = new RotateSecretResponse();
        ...
        private static RotateSecretResponseUnmarshaller _instance = new RotateSecretResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RotateSecretResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
