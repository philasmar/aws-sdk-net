...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class PutSecretValueResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            PutSecretValueResponse response = new PutSecretValueResponse();
        ...
        private static PutSecretValueResponseUnmarshaller _instance = new PutSecretValueResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static PutSecretValueResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
