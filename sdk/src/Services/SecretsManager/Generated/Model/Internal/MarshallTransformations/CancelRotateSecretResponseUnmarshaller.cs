...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CancelRotateSecretResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelRotateSecretResponse response = new CancelRotateSecretResponse();
        ...
        private static CancelRotateSecretResponseUnmarshaller _instance = new CancelRotateSecretResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelRotateSecretResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
