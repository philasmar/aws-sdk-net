...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    public class CancelRotateSecretRequestMarshaller : IMarshaller<IRequest, CancelRotateSecretRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((CancelRotateSecretRequest)input);
        }
        ...
        public IRequest Marshall(CancelRotateSecretRequest publicRequest)
        {
            ...
            string target = "secretsmanager.CancelRotateSecret";
        ...
        private static CancelRotateSecretRequestMarshaller _instance = new CancelRotateSecretRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelRotateSecretRequestMarshaller Instance
        {
            get
            {
                return _instance;
