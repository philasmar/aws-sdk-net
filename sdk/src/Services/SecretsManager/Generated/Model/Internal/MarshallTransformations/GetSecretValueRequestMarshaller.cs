...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetSecretValueRequestMarshaller : IMarshaller<IRequest, GetSecretValueRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetSecretValueRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetSecretValueRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SecretsManager");
            string target = "secretsmanager.GetSecretValue";
        ...
        private static GetSecretValueRequestMarshaller _instance = new GetSecretValueRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSecretValueRequestMarshaller Instance
        {
            get
            {
                return _instance;
