...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    public class RotateSecretRequestMarshaller : IMarshaller<IRequest, RotateSecretRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        {
            return this.Marshall((RotateSecretRequest)input);
        }
        ...
        private static RotateSecretRequestMarshaller _instance = new RotateSecretRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RotateSecretRequestMarshaller Instance
        {
            get
            {
                return _instance;
