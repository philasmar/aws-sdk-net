...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetRandomPasswordResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetRandomPasswordResponse response = new GetRandomPasswordResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("RandomPassword", targetDepth))
                {
                    ...
                    response.RandomPassword = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetRandomPasswordResponseUnmarshaller _instance = new GetRandomPasswordResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetRandomPasswordResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
