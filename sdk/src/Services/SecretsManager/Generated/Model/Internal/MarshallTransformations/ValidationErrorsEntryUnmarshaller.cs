...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    public class ValidationErrorsEntryUnmarshaller : IUnmarshaller<ValidationErrorsEntry, XmlUnmarshallerContext>, IUnmarshaller<ValidationErrorsEntry, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        ValidationErrorsEntry IUnmarshaller<ValidationErrorsEntry, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        private static ValidationErrorsEntryUnmarshaller _instance = new ValidationErrorsEntryUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ValidationErrorsEntryUnmarshaller Instance
        {
            get
            {
                return _instance;
