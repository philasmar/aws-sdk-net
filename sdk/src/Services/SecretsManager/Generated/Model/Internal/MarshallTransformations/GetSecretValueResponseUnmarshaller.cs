...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSecretValueResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("SecretBinary", targetDepth))
                {
                    ...
                    response.SecretBinary = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("SecretString", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.SecretString = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("VersionStages", targetDepth))
                {
                    ...
                    response.VersionStages = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetSecretValueResponseUnmarshaller _instance = new GetSecretValueResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSecretValueResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
