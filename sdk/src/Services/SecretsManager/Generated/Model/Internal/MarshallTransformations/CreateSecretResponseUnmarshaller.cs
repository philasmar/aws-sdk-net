...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateSecretResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateSecretResponseUnmarshaller _instance = new CreateSecretResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSecretResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
