...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class RestoreSecretResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RestoreSecretResponse response = new RestoreSecretResponse();
        ...
        private static RestoreSecretResponseUnmarshaller _instance = new RestoreSecretResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestoreSecretResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
