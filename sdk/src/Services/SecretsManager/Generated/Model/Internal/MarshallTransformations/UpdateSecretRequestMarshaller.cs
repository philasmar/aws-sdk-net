...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class UpdateSecretRequestMarshaller : IMarshaller<IRequest, UpdateSecretRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateSecretRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateSecretRequest publicRequest)
        {
        ...
        private static UpdateSecretRequestMarshaller _instance = new UpdateSecretRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateSecretRequestMarshaller Instance
        {
            get
            {
                return _instance;
