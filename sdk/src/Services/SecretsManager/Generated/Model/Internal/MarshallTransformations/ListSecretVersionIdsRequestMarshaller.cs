...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListSecretVersionIdsRequestMarshaller : IMarshaller<IRequest, ListSecretVersionIdsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListSecretVersionIdsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListSecretVersionIdsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.SecretsManager");
            string target = "secretsmanager.ListSecretVersionIds";
        ...
        private static ListSecretVersionIdsRequestMarshaller _instance = new ListSecretVersionIdsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSecretVersionIdsRequestMarshaller Instance
        {
            get
            {
                return _instance;
