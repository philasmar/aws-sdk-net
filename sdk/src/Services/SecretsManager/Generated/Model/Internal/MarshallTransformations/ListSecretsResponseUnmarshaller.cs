...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListSecretsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListSecretsResponseUnmarshaller _instance = new ListSecretsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSecretsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
