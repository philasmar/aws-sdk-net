...
namespace Amazon.SecretsManager.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteSecretResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteSecretResponseUnmarshaller _instance = new DeleteSecretResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSecretResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
