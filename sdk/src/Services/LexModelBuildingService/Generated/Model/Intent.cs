...
namespace Amazon.LexModelBuildingService.Model
{
    ...
    public partial class Intent
    {
        ...
        public string IntentVersion
        {
            ...
            set { this._intentVersion = value; }
        }

        // Check to see if IntentVersion property is set
        internal bool IsSetIntentVersion()
        {
            return this._intentVersion != null;
        }
