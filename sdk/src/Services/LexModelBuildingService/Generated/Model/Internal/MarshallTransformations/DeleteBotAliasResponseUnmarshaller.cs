...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteBotAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteBotAliasResponse response = new DeleteBotAliasResponse();
        ...
        private static DeleteBotAliasResponseUnmarshaller _instance = new DeleteBotAliasResponseUnmarshaller();        

        internal static DeleteBotAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBotAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
