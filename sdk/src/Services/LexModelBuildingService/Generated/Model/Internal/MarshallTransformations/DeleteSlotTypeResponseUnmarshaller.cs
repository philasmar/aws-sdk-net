...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteSlotTypeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteSlotTypeResponse response = new DeleteSlotTypeResponse();
        ...
        private static DeleteSlotTypeResponseUnmarshaller _instance = new DeleteSlotTypeResponseUnmarshaller();        

        internal static DeleteSlotTypeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteSlotTypeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
