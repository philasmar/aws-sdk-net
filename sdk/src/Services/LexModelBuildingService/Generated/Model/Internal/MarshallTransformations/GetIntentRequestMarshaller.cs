...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetIntentRequestMarshaller : IMarshaller<IRequest, GetIntentRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetIntentRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetIntentRequest publicRequest)
        {
        ...
        private static GetIntentRequestMarshaller _instance = new GetIntentRequestMarshaller();        

        internal static GetIntentRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetIntentRequestMarshaller Instance
        {
            get
            {
                return _instance;
