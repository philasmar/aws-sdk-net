...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetBuiltinIntentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBuiltinIntentResponse response = new GetBuiltinIntentResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<BuiltinIntentSlot, BuiltinIntentSlotUnmarshaller>(BuiltinIntentSlotUnmarshaller.Instance);
                ...
                if (context.TestExpression("supportedLocales", targetDepth))
                {
                    ...
                    response.SupportedLocales = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        internal static GetBuiltinIntentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBuiltinIntentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
