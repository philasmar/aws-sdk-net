...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetBotAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetBotAliasResponse response = new GetBotAliasResponse();
        ...
        private static GetBotAliasResponseUnmarshaller _instance = new GetBotAliasResponseUnmarshaller();        

        internal static GetBotAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetBotAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
