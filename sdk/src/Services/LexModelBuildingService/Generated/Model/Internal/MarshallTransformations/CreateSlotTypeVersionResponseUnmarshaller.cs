...
namespace Amazon.LexModelBuildingService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateSlotTypeVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateSlotTypeVersionResponse response = new CreateSlotTypeVersionResponse();
        ...
        private static CreateSlotTypeVersionResponseUnmarshaller _instance = new CreateSlotTypeVersionResponseUnmarshaller();        

        internal static CreateSlotTypeVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateSlotTypeVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
