...
{
    /// <summary>
    /// ExportServerEngineAttribute Request Marshaller
    /// </summary>       
    public class ExportServerEngineAttributeRequestMarshaller : IMarshaller<IRequest, ExportServerEngineAttributeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ExportServerEngineAttributeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ExportServerEngineAttributeRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.OpsWorksCM");
            string target = "OpsWorksCM_V2016_11_01.ExportServerEngineAttribute";
        ...
        private static ExportServerEngineAttributeRequestMarshaller _instance = new ExportServerEngineAttributeRequestMarshaller();        

        internal static ExportServerEngineAttributeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ExportServerEngineAttributeRequestMarshaller Instance
        {
            get
            {
                return _instance;
