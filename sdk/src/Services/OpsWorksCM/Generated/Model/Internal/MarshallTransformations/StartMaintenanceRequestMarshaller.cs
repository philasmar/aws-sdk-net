...
{
    /// <summary>
    /// StartMaintenance Request Marshaller
    /// </summary>       
    public class StartMaintenanceRequestMarshaller : IMarshaller<IRequest, StartMaintenanceRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartMaintenanceRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartMaintenanceRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.OpsWorksCM");
            string target = "OpsWorksCM_V2016_11_01.StartMaintenance";
        ...
        private static StartMaintenanceRequestMarshaller _instance = new StartMaintenanceRequestMarshaller();        

        internal static StartMaintenanceRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartMaintenanceRequestMarshaller Instance
        {
            get
            {
                return _instance;
