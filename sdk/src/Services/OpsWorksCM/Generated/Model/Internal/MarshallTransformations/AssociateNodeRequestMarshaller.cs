...
{
    /// <summary>
    /// AssociateNode Request Marshaller
    /// </summary>       
    public class AssociateNodeRequestMarshaller : IMarshaller<IRequest, AssociateNodeRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AssociateNodeRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AssociateNodeRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.OpsWorksCM");
            string target = "OpsWorksCM_V2016_11_01.AssociateNode";
        ...
        private static AssociateNodeRequestMarshaller _instance = new AssociateNodeRequestMarshaller();        

        internal static AssociateNodeRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AssociateNodeRequestMarshaller Instance
        {
            get
            {
                return _instance;
