    ...
    public class DescribeEventsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ServerEvent, ServerEventUnmarshaller>(ServerEventUnmarshaller.Instance);
                    response.ServerEvents = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
