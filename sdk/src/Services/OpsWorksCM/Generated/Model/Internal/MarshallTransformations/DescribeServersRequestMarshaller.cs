...
{
    /// <summary>
    /// DescribeServers Request Marshaller
    /// </summary>       
    public class DescribeServersRequestMarshaller : IMarshaller<IRequest, DescribeServersRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeServersRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeServersRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.OpsWorksCM");
            string target = "OpsWorksCM_V2016_11_01.DescribeServers";
