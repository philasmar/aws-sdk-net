...
{
    /// <summary>
    /// UpdateServerEngineAttributes Request Marshaller
    /// </summary>       
    public class UpdateServerEngineAttributesRequestMarshaller : IMarshaller<IRequest, UpdateServerEngineAttributesRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateServerEngineAttributesRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateServerEngineAttributesRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.OpsWorksCM");
            string target = "OpsWorksCM_V2016_11_01.UpdateServerEngineAttributes";
