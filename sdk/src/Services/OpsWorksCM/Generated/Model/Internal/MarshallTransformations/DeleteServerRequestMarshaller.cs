...
namespace Amazon.OpsWorksCM.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteServerRequestMarshaller : IMarshaller<IRequest, DeleteServerRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteServerRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteServerRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.OpsWorksCM");
            string target = "OpsWorksCM_V2016_11_01.DeleteServer";
