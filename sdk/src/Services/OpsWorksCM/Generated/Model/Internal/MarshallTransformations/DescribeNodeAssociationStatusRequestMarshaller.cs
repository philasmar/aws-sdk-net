...
{
    /// <summary>
    /// DescribeNodeAssociationStatus Request Marshaller
    /// </summary>       
    public class DescribeNodeAssociationStatusRequestMarshaller : IMarshaller<IRequest, DescribeNodeAssociationStatusRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeNodeAssociationStatusRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeNodeAssociationStatusRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.OpsWorksCM");
            string target = "OpsWorksCM_V2016_11_01.DescribeNodeAssociationStatus";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetNodeAssociationStatusToken())
                {
                    context.Writer.WritePropertyName("NodeAssociationStatusToken");
                    context.Writer.Write(publicRequest.NodeAssociationStatusToken);
                }
