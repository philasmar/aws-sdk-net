...
{
    /// <summary>
    /// Response Unmarshaller for RestoreDomainAccess operation
    /// </summary>  
    public class RestoreDomainAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RestoreDomainAccessResponse response = new RestoreDomainAccessResponse();
        ...
        private static RestoreDomainAccessResponseUnmarshaller _instance = new RestoreDomainAccessResponseUnmarshaller();        

        internal static RestoreDomainAccessResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RestoreDomainAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
