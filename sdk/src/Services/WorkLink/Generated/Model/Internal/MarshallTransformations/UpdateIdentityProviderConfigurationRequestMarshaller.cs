...
{
    /// <summary>
    /// UpdateIdentityProviderConfiguration Request Marshaller
    /// </summary>       
    public class UpdateIdentityProviderConfigurationRequestMarshaller : IMarshaller<IRequest, UpdateIdentityProviderConfigurationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateIdentityProviderConfigurationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateIdentityProviderConfigurationRequest publicRequest)
        {
        ...
        private static UpdateIdentityProviderConfigurationRequestMarshaller _instance = new UpdateIdentityProviderConfigurationRequestMarshaller();        

        internal static UpdateIdentityProviderConfigurationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIdentityProviderConfigurationRequestMarshaller Instance
        {
            get
            {
                return _instance;
