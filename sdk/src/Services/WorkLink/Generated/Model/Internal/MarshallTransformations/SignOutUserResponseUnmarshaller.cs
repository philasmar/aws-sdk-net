...
{
    /// <summary>
    /// Response Unmarshaller for SignOutUser operation
    /// </summary>  
    public class SignOutUserResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            SignOutUserResponse response = new SignOutUserResponse();
        ...
        private static SignOutUserResponseUnmarshaller _instance = new SignOutUserResponseUnmarshaller();        

        internal static SignOutUserResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SignOutUserResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
