...
{
    /// <summary>
    /// SignOutUser Request Marshaller
    /// </summary>       
    public class SignOutUserRequestMarshaller : IMarshaller<IRequest, SignOutUserRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((SignOutUserRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(SignOutUserRequest publicRequest)
        {
        ...
        private static SignOutUserRequestMarshaller _instance = new SignOutUserRequestMarshaller();        

        internal static SignOutUserRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static SignOutUserRequestMarshaller Instance
        {
            get
            {
                return _instance;
