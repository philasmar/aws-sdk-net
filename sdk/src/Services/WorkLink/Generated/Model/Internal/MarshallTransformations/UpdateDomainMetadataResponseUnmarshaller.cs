...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDomainMetadata operation
    /// </summary>  
    public class UpdateDomainMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDomainMetadataResponse response = new UpdateDomainMetadataResponse();
        ...
        private static UpdateDomainMetadataResponseUnmarshaller _instance = new UpdateDomainMetadataResponseUnmarshaller();        

        internal static UpdateDomainMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDomainMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
