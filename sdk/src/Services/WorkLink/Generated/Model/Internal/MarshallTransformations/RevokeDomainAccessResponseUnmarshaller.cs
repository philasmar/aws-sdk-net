...
{
    /// <summary>
    /// Response Unmarshaller for RevokeDomainAccess operation
    /// </summary>  
    public class RevokeDomainAccessResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RevokeDomainAccessResponse response = new RevokeDomainAccessResponse();
        ...
        private static RevokeDomainAccessResponseUnmarshaller _instance = new RevokeDomainAccessResponseUnmarshaller();        

        internal static RevokeDomainAccessResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RevokeDomainAccessResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
