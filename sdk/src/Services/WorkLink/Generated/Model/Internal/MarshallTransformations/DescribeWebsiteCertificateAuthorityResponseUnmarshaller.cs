...
{
    /// <summary>
    /// Response Unmarshaller for DescribeWebsiteCertificateAuthority operation
    /// </summary>  
    public class DescribeWebsiteCertificateAuthorityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeWebsiteCertificateAuthorityResponse response = new DescribeWebsiteCertificateAuthorityResponse();
        ...
        private static DescribeWebsiteCertificateAuthorityResponseUnmarshaller _instance = new DescribeWebsiteCertificateAuthorityResponseUnmarshaller();        

        internal static DescribeWebsiteCertificateAuthorityResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeWebsiteCertificateAuthorityResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
