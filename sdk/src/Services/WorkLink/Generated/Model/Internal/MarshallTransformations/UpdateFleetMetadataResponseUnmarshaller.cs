...
{
    /// <summary>
    /// Response Unmarshaller for UpdateFleetMetadata operation
    /// </summary>  
    public class UpdateFleetMetadataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateFleetMetadataResponse response = new UpdateFleetMetadataResponse();
        ...
        private static UpdateFleetMetadataResponseUnmarshaller _instance = new UpdateFleetMetadataResponseUnmarshaller();        

        internal static UpdateFleetMetadataResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateFleetMetadataResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
