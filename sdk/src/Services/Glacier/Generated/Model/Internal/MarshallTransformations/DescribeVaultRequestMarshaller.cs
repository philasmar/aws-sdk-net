...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeVaultRequestMarshaller : IMarshaller<IRequest, DescribeVaultRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeVaultRequest)input);
        }
        ...
        private static DescribeVaultRequestMarshaller _instance = new DescribeVaultRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeVaultRequestMarshaller Instance
        {
            get
            {
                return _instance;
