...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteVaultAccessPolicyRequestMarshaller : IMarshaller<IRequest, DeleteVaultAccessPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteVaultAccessPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteVaultAccessPolicyRequest publicRequest)
        {
