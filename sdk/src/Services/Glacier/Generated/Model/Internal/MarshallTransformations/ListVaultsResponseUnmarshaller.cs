...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListVaultsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListVaultsResponse response = new ListVaultsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DescribeVaultOutput, DescribeVaultOutputUnmarshaller>(DescribeVaultOutputUnmarshaller.Instance);
                    response.VaultList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListVaultsResponseUnmarshaller _instance = new ListVaultsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListVaultsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
