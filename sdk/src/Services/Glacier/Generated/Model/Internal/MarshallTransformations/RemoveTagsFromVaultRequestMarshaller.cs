...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class RemoveTagsFromVaultRequestMarshaller : IMarshaller<IRequest, RemoveTagsFromVaultRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RemoveTagsFromVaultRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RemoveTagsFromVaultRequest publicRequest)
        {
            ...
            request.AddSubResource("operation", "remove");
        ...
        private static RemoveTagsFromVaultRequestMarshaller _instance = new RemoveTagsFromVaultRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveTagsFromVaultRequestMarshaller Instance
        {
            get
            {
                return _instance;
