...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class InitiateVaultLockRequestMarshaller : IMarshaller<IRequest, InitiateVaultLockRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((InitiateVaultLockRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(InitiateVaultLockRequest publicRequest)
        {
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                var marshaller = VaultLockPolicyMarshaller.Instance;
