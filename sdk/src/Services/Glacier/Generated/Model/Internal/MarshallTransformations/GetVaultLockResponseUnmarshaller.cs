...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetVaultLockResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetVaultLockResponse response = new GetVaultLockResponse();
        ...
        private static GetVaultLockResponseUnmarshaller _instance = new GetVaultLockResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVaultLockResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
