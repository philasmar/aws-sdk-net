...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CompleteVaultLockResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CompleteVaultLockResponse response = new CompleteVaultLockResponse();
        ...
        private static CompleteVaultLockResponseUnmarshaller _instance = new CompleteVaultLockResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CompleteVaultLockResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
