...
namespace Amazon.Glacier.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetVaultAccessPolicyRequestMarshaller : IMarshaller<IRequest, GetVaultAccessPolicyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetVaultAccessPolicyRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetVaultAccessPolicyRequest publicRequest)
        {
            ...
            request.ResourcePath = "/{accountId}/vaults/{vaultName}/access-policy";
            request.MarshallerVersion = 2;

            return request;
        }
        private static GetVaultAccessPolicyRequestMarshaller _instance = new GetVaultAccessPolicyRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetVaultAccessPolicyRequestMarshaller Instance
        {
            get
            {
                return _instance;
