...
{
    /// <summary>
    /// UpdateAnalysis Request Marshaller
    /// </summary>       
    public class UpdateAnalysisRequestMarshaller : IMarshaller<IRequest, UpdateAnalysisRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateAnalysisRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateAnalysisRequest publicRequest)
        {
        ...
        private static UpdateAnalysisRequestMarshaller _instance = new UpdateAnalysisRequestMarshaller();        

        internal static UpdateAnalysisRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAnalysisRequestMarshaller Instance
        {
            get
            {
                return _instance;
