...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAccountCustomization operation
    /// </summary>  
    public class DescribeAccountCustomizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAccountCustomizationResponse response = new DescribeAccountCustomizationResponse();
        ...
        private static DescribeAccountCustomizationResponseUnmarshaller _instance = new DescribeAccountCustomizationResponseUnmarshaller();        

        internal static DescribeAccountCustomizationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAccountCustomizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
