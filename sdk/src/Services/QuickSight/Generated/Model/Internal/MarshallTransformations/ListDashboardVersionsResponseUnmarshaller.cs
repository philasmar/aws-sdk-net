...
{
    /// <summary>
    /// Response Unmarshaller for ListDashboardVersions operation
    /// </summary>  
    public class ListDashboardVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListDashboardVersionsResponse response = new ListDashboardVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DashboardVersionSummary, DashboardVersionSummaryUnmarshaller>(DashboardVersionSummaryUnmarshaller.Instance);
                    response.DashboardVersionSummaryList = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListDashboardVersionsResponseUnmarshaller _instance = new ListDashboardVersionsResponseUnmarshaller();        

        internal static ListDashboardVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListDashboardVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
