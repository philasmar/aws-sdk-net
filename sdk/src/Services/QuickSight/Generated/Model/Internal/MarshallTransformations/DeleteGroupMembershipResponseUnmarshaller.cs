...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteGroupMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteGroupMembershipResponse response = new DeleteGroupMembershipResponse();
        ...
        private static DeleteGroupMembershipResponseUnmarshaller _instance = new DeleteGroupMembershipResponseUnmarshaller();        

        internal static DeleteGroupMembershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteGroupMembershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
