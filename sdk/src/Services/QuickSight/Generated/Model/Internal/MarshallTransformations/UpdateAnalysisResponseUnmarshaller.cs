...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAnalysis operation
    /// </summary>  
    public class UpdateAnalysisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAnalysisResponse response = new UpdateAnalysisResponse();
        ...
        private static UpdateAnalysisResponseUnmarshaller _instance = new UpdateAnalysisResponseUnmarshaller();        

        internal static UpdateAnalysisResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAnalysisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
