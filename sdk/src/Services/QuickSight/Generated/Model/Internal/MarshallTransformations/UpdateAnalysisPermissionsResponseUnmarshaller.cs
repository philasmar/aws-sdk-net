...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAnalysisPermissions operation
    /// </summary>  
    public class UpdateAnalysisPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateAnalysisPermissionsResponse response = new UpdateAnalysisPermissionsResponse();
        ...
        private static UpdateAnalysisPermissionsResponseUnmarshaller _instance = new UpdateAnalysisPermissionsResponseUnmarshaller();        

        internal static UpdateAnalysisPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAnalysisPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
