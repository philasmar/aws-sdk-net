...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateGroupMembershipResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateGroupMembershipResponse response = new CreateGroupMembershipResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = GroupMemberUnmarshaller.Instance;
                    response.GroupMember = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static CreateGroupMembershipResponseUnmarshaller _instance = new CreateGroupMembershipResponseUnmarshaller();        

        internal static CreateGroupMembershipResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGroupMembershipResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
