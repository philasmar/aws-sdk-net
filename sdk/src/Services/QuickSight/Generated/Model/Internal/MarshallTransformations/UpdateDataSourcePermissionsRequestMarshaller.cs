...
{
    /// <summary>
    /// UpdateDataSourcePermissions Request Marshaller
    /// </summary>       
    public class UpdateDataSourcePermissionsRequestMarshaller : IMarshaller<IRequest, UpdateDataSourcePermissionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateDataSourcePermissionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateDataSourcePermissionsRequest publicRequest)
        {
        ...
        private static UpdateDataSourcePermissionsRequestMarshaller _instance = new UpdateDataSourcePermissionsRequestMarshaller();        

        internal static UpdateDataSourcePermissionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDataSourcePermissionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
