...
{
    /// <summary>
    /// Response Unmarshaller for ListThemeVersions operation
    /// </summary>  
    public class ListThemeVersionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListThemeVersionsResponse response = new ListThemeVersionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ThemeVersionSummary, ThemeVersionSummaryUnmarshaller>(ThemeVersionSummaryUnmarshaller.Instance);
                    response.ThemeVersionSummaryList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListThemeVersionsResponseUnmarshaller _instance = new ListThemeVersionsResponseUnmarshaller();        

        internal static ListThemeVersionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListThemeVersionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
