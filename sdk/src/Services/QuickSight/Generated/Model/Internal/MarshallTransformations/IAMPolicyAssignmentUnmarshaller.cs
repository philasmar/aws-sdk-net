...
{
    /// <summary>
    /// Response Unmarshaller for IAMPolicyAssignment Object
    /// </summary>  
    public class IAMPolicyAssignmentUnmarshaller : IUnmarshaller<IAMPolicyAssignment, XmlUnmarshallerContext>, IUnmarshaller<IAMPolicyAssignment, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        IAMPolicyAssignment IUnmarshaller<IAMPolicyAssignment, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public IAMPolicyAssignment Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
            if (context.CurrentTokenType == JsonToken.Null) 
                return null;

            IAMPolicyAssignment unmarshalledObject = new IAMPolicyAssignment();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("Identities", targetDepth))
                {
                    ...
                    unmarshalledObject.Identities = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static IAMPolicyAssignmentUnmarshaller _instance = new IAMPolicyAssignmentUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static IAMPolicyAssignmentUnmarshaller Instance
        {
            get
            {
                return _instance;
