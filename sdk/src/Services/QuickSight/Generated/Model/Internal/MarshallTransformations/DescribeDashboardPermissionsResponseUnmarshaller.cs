...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDashboardPermissions operation
    /// </summary>  
    public class DescribeDashboardPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDashboardPermissionsResponse response = new DescribeDashboardPermissionsResponse();
        ...
        private static DescribeDashboardPermissionsResponseUnmarshaller _instance = new DescribeDashboardPermissionsResponseUnmarshaller();        

        internal static DescribeDashboardPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDashboardPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
