...
{
    /// <summary>
    /// UpdateThemePermissions Request Marshaller
    /// </summary>       
    public class UpdateThemePermissionsRequestMarshaller : IMarshaller<IRequest, UpdateThemePermissionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((UpdateThemePermissionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(UpdateThemePermissionsRequest publicRequest)
        {
        ...
        private static UpdateThemePermissionsRequestMarshaller _instance = new UpdateThemePermissionsRequestMarshaller();        

        internal static UpdateThemePermissionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateThemePermissionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
