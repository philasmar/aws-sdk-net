...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class NamespaceInfoV2Unmarshaller : IUnmarshaller<NamespaceInfoV2, XmlUnmarshallerContext>, IUnmarshaller<NamespaceInfoV2, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        NamespaceInfoV2 IUnmarshaller<NamespaceInfoV2, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public NamespaceInfoV2 Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.CapacityRegion = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    unmarshalledObject.IdentityStore = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                if (context.TestExpression("NamespaceError", targetDepth))
                {
                    ...
                    unmarshalledObject.NamespaceError = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
