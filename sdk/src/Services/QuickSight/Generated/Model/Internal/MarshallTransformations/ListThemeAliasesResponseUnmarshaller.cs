...
{
    /// <summary>
    /// Response Unmarshaller for ListThemeAliases operation
    /// </summary>  
    public class ListThemeAliasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListThemeAliasesResponse response = new ListThemeAliasesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ThemeAlias, ThemeAliasUnmarshaller>(ThemeAliasUnmarshaller.Instance);
                    response.ThemeAliasList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListThemeAliasesResponseUnmarshaller _instance = new ListThemeAliasesResponseUnmarshaller();        

        internal static ListThemeAliasesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListThemeAliasesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
