...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTemplatePermissions operation
    /// </summary>  
    public class UpdateTemplatePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateTemplatePermissionsResponseUnmarshaller _instance = new UpdateTemplatePermissionsResponseUnmarshaller();        

        internal static UpdateTemplatePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTemplatePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
