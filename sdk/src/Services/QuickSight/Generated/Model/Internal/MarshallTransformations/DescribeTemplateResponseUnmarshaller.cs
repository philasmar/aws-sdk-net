...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTemplate operation
    /// </summary>  
    public class DescribeTemplateResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeTemplateResponseUnmarshaller _instance = new DescribeTemplateResponseUnmarshaller();        

        internal static DescribeTemplateResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTemplateResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
