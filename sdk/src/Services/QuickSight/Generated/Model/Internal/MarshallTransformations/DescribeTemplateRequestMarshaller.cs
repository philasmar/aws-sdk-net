...
{
    /// <summary>
    /// DescribeTemplate Request Marshaller
    /// </summary>       
    public class DescribeTemplateRequestMarshaller : IMarshaller<IRequest, DescribeTemplateRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeTemplateRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeTemplateRequest publicRequest)
        {
        ...
        private static DescribeTemplateRequestMarshaller _instance = new DescribeTemplateRequestMarshaller();        

        internal static DescribeTemplateRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTemplateRequestMarshaller Instance
        {
            get
            {
                return _instance;
