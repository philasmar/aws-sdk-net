...
{
    /// <summary>
    /// Response Unmarshaller for DeleteThemeAlias operation
    /// </summary>  
    public class DeleteThemeAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteThemeAliasResponse response = new DeleteThemeAliasResponse();
        ...
        private static DeleteThemeAliasResponseUnmarshaller _instance = new DeleteThemeAliasResponseUnmarshaller();        

        internal static DeleteThemeAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteThemeAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
