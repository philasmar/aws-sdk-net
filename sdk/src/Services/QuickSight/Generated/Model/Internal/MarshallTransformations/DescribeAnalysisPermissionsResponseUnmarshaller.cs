...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAnalysisPermissions operation
    /// </summary>  
    public class DescribeAnalysisPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAnalysisPermissionsResponse response = new DescribeAnalysisPermissionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AnalysisArn", targetDepth))
                {
                    ...
                    response.AnalysisArn = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeAnalysisPermissionsResponseUnmarshaller _instance = new DescribeAnalysisPermissionsResponseUnmarshaller();        

        internal static DescribeAnalysisPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAnalysisPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
