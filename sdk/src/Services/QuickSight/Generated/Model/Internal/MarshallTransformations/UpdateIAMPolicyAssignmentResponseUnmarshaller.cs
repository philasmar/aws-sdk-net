...
{
    /// <summary>
    /// Response Unmarshaller for UpdateIAMPolicyAssignment operation
    /// </summary>  
    public class UpdateIAMPolicyAssignmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateIAMPolicyAssignmentResponse response = new UpdateIAMPolicyAssignmentResponse();
        ...
        private static UpdateIAMPolicyAssignmentResponseUnmarshaller _instance = new UpdateIAMPolicyAssignmentResponseUnmarshaller();        

        internal static UpdateIAMPolicyAssignmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateIAMPolicyAssignmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
