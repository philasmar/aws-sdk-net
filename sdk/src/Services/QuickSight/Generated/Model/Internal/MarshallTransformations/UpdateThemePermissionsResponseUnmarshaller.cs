...
{
    /// <summary>
    /// Response Unmarshaller for UpdateThemePermissions operation
    /// </summary>  
    public class UpdateThemePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateThemePermissionsResponse response = new UpdateThemePermissionsResponse();
        ...
        private static UpdateThemePermissionsResponseUnmarshaller _instance = new UpdateThemePermissionsResponseUnmarshaller();        

        internal static UpdateThemePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateThemePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
