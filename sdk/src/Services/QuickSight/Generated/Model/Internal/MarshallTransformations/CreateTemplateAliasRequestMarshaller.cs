...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateTemplateAliasRequestMarshaller : IMarshaller<IRequest, CreateTemplateAliasRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static CreateTemplateAliasRequestMarshaller _instance = new CreateTemplateAliasRequestMarshaller();        

        internal static CreateTemplateAliasRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTemplateAliasRequestMarshaller Instance
        {
            get
            {
                return _instance;
