...
{
    /// <summary>
    /// Response Unmarshaller for CreateAccountCustomization operation
    /// </summary>  
    public class CreateAccountCustomizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateAccountCustomizationResponse response = new CreateAccountCustomizationResponse();
        ...
        private static CreateAccountCustomizationResponseUnmarshaller _instance = new CreateAccountCustomizationResponseUnmarshaller();        

        internal static CreateAccountCustomizationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateAccountCustomizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
