...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDashboardPublishedVersion operation
    /// </summary>  
    public class UpdateDashboardPublishedVersionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDashboardPublishedVersionResponse response = new UpdateDashboardPublishedVersionResponse();
        ...
        private static UpdateDashboardPublishedVersionResponseUnmarshaller _instance = new UpdateDashboardPublishedVersionResponseUnmarshaller();        

        internal static UpdateDashboardPublishedVersionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDashboardPublishedVersionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
