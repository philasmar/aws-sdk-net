...
{
    /// <summary>
    /// Response Unmarshaller for CancelIngestion operation
    /// </summary>  
    public class CancelIngestionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelIngestionResponse response = new CancelIngestionResponse();
        ...
        private static CancelIngestionResponseUnmarshaller _instance = new CancelIngestionResponseUnmarshaller();        

        internal static CancelIngestionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelIngestionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
