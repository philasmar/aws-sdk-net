...
{
    /// <summary>
    /// Response Unmarshaller for DeleteIAMPolicyAssignment operation
    /// </summary>  
    public class DeleteIAMPolicyAssignmentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteIAMPolicyAssignmentResponse response = new DeleteIAMPolicyAssignmentResponse();
        ...
        private static DeleteIAMPolicyAssignmentResponseUnmarshaller _instance = new DeleteIAMPolicyAssignmentResponseUnmarshaller();        

        internal static DeleteIAMPolicyAssignmentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteIAMPolicyAssignmentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
