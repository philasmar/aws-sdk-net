...
{
    /// <summary>
    /// Response Unmarshaller for UpdateThemeAlias operation
    /// </summary>  
    public class UpdateThemeAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateThemeAliasResponse response = new UpdateThemeAliasResponse();
        ...
        private static UpdateThemeAliasResponseUnmarshaller _instance = new UpdateThemeAliasResponseUnmarshaller();        

        internal static UpdateThemeAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateThemeAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
