...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTemplateAlias operation
    /// </summary>  
    public class DescribeTemplateAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTemplateAliasResponse response = new DescribeTemplateAliasResponse();
        ...
        private static DescribeTemplateAliasResponseUnmarshaller _instance = new DescribeTemplateAliasResponseUnmarshaller();        

        internal static DescribeTemplateAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTemplateAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
