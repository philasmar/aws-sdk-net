...
{
    /// <summary>
    /// CreateThemeAlias Request Marshaller
    /// </summary>       
    public class CreateThemeAliasRequestMarshaller : IMarshaller<IRequest, CreateThemeAliasRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateThemeAliasRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateThemeAliasRequest publicRequest)
        {
        ...
        private static CreateThemeAliasRequestMarshaller _instance = new CreateThemeAliasRequestMarshaller();        

        internal static CreateThemeAliasRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateThemeAliasRequestMarshaller Instance
        {
            get
            {
                return _instance;
