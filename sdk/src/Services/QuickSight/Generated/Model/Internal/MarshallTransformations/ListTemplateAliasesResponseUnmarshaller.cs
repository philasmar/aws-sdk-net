...
{
    /// <summary>
    /// Response Unmarshaller for ListTemplateAliases operation
    /// </summary>  
    public class ListTemplateAliasesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListTemplateAliasesResponse response = new ListTemplateAliasesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TemplateAlias, TemplateAliasUnmarshaller>(TemplateAliasUnmarshaller.Instance);
                    response.TemplateAliasList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListTemplateAliasesResponseUnmarshaller _instance = new ListTemplateAliasesResponseUnmarshaller();        

        internal static ListTemplateAliasesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTemplateAliasesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
