...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ListGroupMembershipsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListGroupMembershipsResponse response = new ListGroupMembershipsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<GroupMember, GroupMemberUnmarshaller>(GroupMemberUnmarshaller.Instance);
                    response.GroupMemberList = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListGroupMembershipsResponseUnmarshaller _instance = new ListGroupMembershipsResponseUnmarshaller();        

        internal static ListGroupMembershipsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListGroupMembershipsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
