...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTheme operation
    /// </summary>  
    public class DescribeThemeResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeThemeResponse response = new DescribeThemeResponse();
        ...
        private static DescribeThemeResponseUnmarshaller _instance = new DescribeThemeResponseUnmarshaller();        

        internal static DescribeThemeResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeThemeResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
