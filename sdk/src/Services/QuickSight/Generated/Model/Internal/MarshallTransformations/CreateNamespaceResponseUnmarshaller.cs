...
{
    /// <summary>
    /// Response Unmarshaller for CreateNamespace operation
    /// </summary>  
    public class CreateNamespaceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static CreateNamespaceResponseUnmarshaller _instance = new CreateNamespaceResponseUnmarshaller();        

        internal static CreateNamespaceResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateNamespaceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
