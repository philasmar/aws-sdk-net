...
{
    /// <summary>
    /// Response Unmarshaller for DeleteAccountCustomization operation
    /// </summary>  
    public class DeleteAccountCustomizationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteAccountCustomizationResponse response = new DeleteAccountCustomizationResponse();
        ...
        private static DeleteAccountCustomizationResponseUnmarshaller _instance = new DeleteAccountCustomizationResponseUnmarshaller();        

        internal static DeleteAccountCustomizationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteAccountCustomizationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
