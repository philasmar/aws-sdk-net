...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    public class VpcConnectionPropertiesMarshaller : IRequestMarshaller<VpcConnectionProperties, JsonMarshallerContext> 
    {
        ...
        /// <returns></returns>
        public void Marshall(VpcConnectionProperties requestObject, JsonMarshallerContext context)
        {
            if(requestObject.IsSetVpcConnectionArn())
            {
                context.Writer.WritePropertyName("VpcConnectionArn");
                context.Writer.Write(requestObject.VpcConnectionArn);
            }
