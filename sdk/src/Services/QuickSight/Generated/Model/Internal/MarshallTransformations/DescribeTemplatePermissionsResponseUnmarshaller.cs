...
{
    /// <summary>
    /// Response Unmarshaller for DescribeTemplatePermissions operation
    /// </summary>  
    public class DescribeTemplatePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeTemplatePermissionsResponse response = new DescribeTemplatePermissionsResponse();
        ...
        private static DescribeTemplatePermissionsResponseUnmarshaller _instance = new DescribeTemplatePermissionsResponseUnmarshaller();        

        internal static DescribeTemplatePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeTemplatePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
