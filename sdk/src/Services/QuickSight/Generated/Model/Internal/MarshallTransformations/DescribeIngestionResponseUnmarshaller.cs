...
{
    /// <summary>
    /// Response Unmarshaller for DescribeIngestion operation
    /// </summary>  
    public class DescribeIngestionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeIngestionResponse response = new DescribeIngestionResponse();
        ...
        private static DescribeIngestionResponseUnmarshaller _instance = new DescribeIngestionResponseUnmarshaller();        

        internal static DescribeIngestionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeIngestionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
