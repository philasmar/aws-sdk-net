...
{
    /// <summary>
    /// Response Unmarshaller for DescribeAnalysis operation
    /// </summary>  
    public class DescribeAnalysisResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeAnalysisResponse response = new DescribeAnalysisResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("Analysis", targetDepth))
                {
                    ...
                    response.Analysis = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeAnalysisResponseUnmarshaller _instance = new DescribeAnalysisResponseUnmarshaller();        

        internal static DescribeAnalysisResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeAnalysisResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
