...
{
    /// <summary>
    /// Response Unmarshaller for UpdateDashboardPermissions operation
    /// </summary>  
    public class UpdateDashboardPermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateDashboardPermissionsResponse response = new UpdateDashboardPermissionsResponse();
        ...
        private static UpdateDashboardPermissionsResponseUnmarshaller _instance = new UpdateDashboardPermissionsResponseUnmarshaller();        

        internal static UpdateDashboardPermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateDashboardPermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
