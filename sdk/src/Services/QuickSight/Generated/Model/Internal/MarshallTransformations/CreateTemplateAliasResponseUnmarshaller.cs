...
{
    /// <summary>
    /// Response Unmarshaller for CreateTemplateAlias operation
    /// </summary>  
    public class CreateTemplateAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateTemplateAliasResponse response = new CreateTemplateAliasResponse();
        ...
        private static CreateTemplateAliasResponseUnmarshaller _instance = new CreateTemplateAliasResponseUnmarshaller();        

        internal static CreateTemplateAliasResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateTemplateAliasResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
