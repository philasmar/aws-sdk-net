...
namespace Amazon.QuickSight.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class IAMPolicyAssignmentSummaryUnmarshaller : IUnmarshaller<IAMPolicyAssignmentSummary, XmlUnmarshallerContext>, IUnmarshaller<IAMPolicyAssignmentSummary, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        IAMPolicyAssignmentSummary IUnmarshaller<IAMPolicyAssignmentSummary, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public IAMPolicyAssignmentSummary Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
