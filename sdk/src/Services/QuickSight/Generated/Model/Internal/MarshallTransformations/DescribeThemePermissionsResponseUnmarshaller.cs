...
{
    /// <summary>
    /// Response Unmarshaller for DescribeThemePermissions operation
    /// </summary>  
    public class DescribeThemePermissionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeThemePermissionsResponse response = new DescribeThemePermissionsResponse();
        ...
        private static DescribeThemePermissionsResponseUnmarshaller _instance = new DescribeThemePermissionsResponseUnmarshaller();        

        internal static DescribeThemePermissionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeThemePermissionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
