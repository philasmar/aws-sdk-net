...
{
    /// <summary>
    /// Container for the parameters to the DescribeAnalysis operation.
    /// Provides a summary of the metadata for an analysis.
    /// </summary>
    public partial class DescribeAnalysisRequest : AmazonQuickSightRequest
    {
        ...
        /// <para>
        /// The ID of the AWS account that contains the analysis. You must be using the AWS account
