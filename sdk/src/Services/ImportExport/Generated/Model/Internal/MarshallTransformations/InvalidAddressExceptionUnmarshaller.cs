...
namespace Amazon.ImportExport.Model.Internal.MarshallTransformations
{
    ...
    public class InvalidAddressExceptionUnmarshaller : IErrorResponseUnmarshaller<InvalidAddressException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public InvalidAddressException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public InvalidAddressException Unmarshall(XmlUnmarshallerContext context, ErrorResponse errorResponse)
        {
            InvalidAddressException response = new InvalidAddressException(errorResponse.Message, errorResponse.InnerException, 
