...
namespace Amazon.ImportExport.Model
{
    ...
    public partial class MissingCustomsException : AmazonImportExportException
    {
        ...
        public MissingCustomsException(string message, Exception innerException) 
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public MissingCustomsException(Exception innerException) 
            : base(innerException) {}
        ...
        public MissingCustomsException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected MissingCustomsException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
