...
namespace Amazon.ImportExport.Model
{
    ...
    public partial class MultipleRegionsException : AmazonImportExportException
    {
        ...
        public MultipleRegionsException(string message, Exception innerException) 
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public MultipleRegionsException(Exception innerException) 
            : base(innerException) {}
        ...
        public MultipleRegionsException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        protected MultipleRegionsException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
