...
namespace Amazon.Budgets.Model.Internal.MarshallTransformations
{
    ...
    public class UpdateBudgetRequestMarshaller : IMarshaller<IRequest, UpdateBudgetRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(UpdateBudgetRequest publicRequest)
        {
            ...
            string target = "AWSBudgetServiceGateway.UpdateBudget";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetNewBudget())
                {
                    context.Writer.WritePropertyName("NewBudget");
                    context.Writer.WriteObjectStart();

                    var marshaller = BudgetMarshaller.Instance;
                    marshaller.Marshall(publicRequest.NewBudget, context);
