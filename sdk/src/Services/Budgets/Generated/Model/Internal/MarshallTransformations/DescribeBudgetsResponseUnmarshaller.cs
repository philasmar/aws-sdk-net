...
{
    /// <summary>
    /// Response Unmarshaller for DescribeBudgets operation
    /// </summary>  
    public class DescribeBudgetsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeBudgetsResponse response = new DescribeBudgetsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<Budget, BudgetUnmarshaller>(BudgetUnmarshaller.Instance);
        ...
        private static DescribeBudgetsResponseUnmarshaller _instance = new DescribeBudgetsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBudgetsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
