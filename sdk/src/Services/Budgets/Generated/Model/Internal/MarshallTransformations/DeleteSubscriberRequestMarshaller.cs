...
namespace Amazon.Budgets.Model.Internal.MarshallTransformations
{
    ...
    public class DeleteSubscriberRequestMarshaller : IMarshaller<IRequest, DeleteSubscriberRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DeleteSubscriberRequest publicRequest)
        {
            ...
            string target = "AWSBudgetServiceGateway.DeleteSubscriber";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetSubscriber())
                {
                    context.Writer.WritePropertyName("Subscriber");
                    context.Writer.WriteObjectStart();

                    var marshaller = SubscriberMarshaller.Instance;
                    marshaller.Marshall(publicRequest.Subscriber, context);
