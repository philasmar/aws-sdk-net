...
{
    /// <summary>
    /// CreateBudgetAction Request Marshaller
    /// </summary>       
    public class CreateBudgetActionRequestMarshaller : IMarshaller<IRequest, CreateBudgetActionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateBudgetActionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateBudgetActionRequest publicRequest)
        {
        ...
        private static CreateBudgetActionRequestMarshaller _instance = new CreateBudgetActionRequestMarshaller();        

        internal static CreateBudgetActionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateBudgetActionRequestMarshaller Instance
        {
            get
            {
                return _instance;
