...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GenerateDataKeyPairResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GenerateDataKeyPairResponse response = new GenerateDataKeyPairResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = MemoryStreamUnmarshaller.Instance;
                    response.PrivateKeyPlaintext = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GenerateDataKeyPairResponseUnmarshaller _instance = new GenerateDataKeyPairResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateDataKeyPairResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
