...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteImportedKeyMaterialRequestMarshaller : IMarshaller<IRequest, DeleteImportedKeyMaterialRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteImportedKeyMaterialRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteImportedKeyMaterialRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.KeyManagementService");
            string target = "TrentService.DeleteImportedKeyMaterial";
