...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    public class InvalidCiphertextExceptionUnmarshaller : IErrorResponseUnmarshaller<InvalidCiphertextException, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public InvalidCiphertextException Unmarshall(JsonUnmarshallerContext context, ErrorResponse errorResponse)
        {
            context.Read();
        ...
        private static InvalidCiphertextExceptionUnmarshaller _instance = new InvalidCiphertextExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static InvalidCiphertextExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
