...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListGrantsRequestMarshaller : IMarshaller<IRequest, ListGrantsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListGrantsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListGrantsRequest publicRequest)
        {
        ...
        private static ListGrantsRequestMarshaller _instance = new ListGrantsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListGrantsRequestMarshaller Instance
        {
            get
            {
                return _instance;
