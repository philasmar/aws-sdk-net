...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    public class CustomKeyStoreInvalidStateExceptionUnmarshaller : IErrorResponseUnmarshaller<CustomKeyStoreInvalidStateException, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public CustomKeyStoreInvalidStateException Unmarshall(JsonUnmarshallerContext context, ErrorResponse errorResponse)
        {
            context.Read();
        ...
        private static CustomKeyStoreInvalidStateExceptionUnmarshaller _instance = new CustomKeyStoreInvalidStateExceptionUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static CustomKeyStoreInvalidStateExceptionUnmarshaller Instance
        {
            get
            {
                return _instance;
