    ...
    public class CreateAliasResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidAliasNameException"))
                {
                    return InvalidAliasNameExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
