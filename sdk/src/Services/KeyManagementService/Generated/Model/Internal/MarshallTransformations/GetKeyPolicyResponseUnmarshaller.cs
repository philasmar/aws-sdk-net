...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetKeyPolicyResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetKeyPolicyResponse response = new GetKeyPolicyResponse();
        ...
        private static GetKeyPolicyResponseUnmarshaller _instance = new GetKeyPolicyResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetKeyPolicyResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
