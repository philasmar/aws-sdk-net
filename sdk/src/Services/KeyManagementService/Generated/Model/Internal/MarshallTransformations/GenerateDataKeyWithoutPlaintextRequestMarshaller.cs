...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GenerateDataKeyWithoutPlaintextRequestMarshaller : IMarshaller<IRequest, GenerateDataKeyWithoutPlaintextRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GenerateDataKeyWithoutPlaintextRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GenerateDataKeyWithoutPlaintextRequest publicRequest)
        {
