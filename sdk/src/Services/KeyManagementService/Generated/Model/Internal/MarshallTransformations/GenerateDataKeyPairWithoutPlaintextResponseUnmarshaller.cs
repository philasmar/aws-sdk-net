...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GenerateDataKeyPairWithoutPlaintextResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GenerateDataKeyPairWithoutPlaintextResponse response = new GenerateDataKeyPairWithoutPlaintextResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.KeyPairSpec = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("PrivateKeyCiphertextBlob", targetDepth))
                {
                    var unmarshaller = MemoryStreamUnmarshaller.Instance;
                    response.PrivateKeyCiphertextBlob = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static GenerateDataKeyPairWithoutPlaintextResponseUnmarshaller _instance = new GenerateDataKeyPairWithoutPlaintextResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateDataKeyPairWithoutPlaintextResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
