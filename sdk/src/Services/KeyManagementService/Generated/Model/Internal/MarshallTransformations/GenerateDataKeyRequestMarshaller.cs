...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GenerateDataKeyRequestMarshaller : IMarshaller<IRequest, GenerateDataKeyRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GenerateDataKeyRequest)input);
        }
        ...
        private static GenerateDataKeyRequestMarshaller _instance = new GenerateDataKeyRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateDataKeyRequestMarshaller Instance
        {
            get
            {
                return _instance;
