...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ConnectCustomKeyStoreResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ConnectCustomKeyStoreResponse response = new ConnectCustomKeyStoreResponse();
        ...
        private static ConnectCustomKeyStoreResponseUnmarshaller _instance = new ConnectCustomKeyStoreResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ConnectCustomKeyStoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
