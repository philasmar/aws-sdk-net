...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GenerateDataKeyPairWithoutPlaintextRequestMarshaller : IMarshaller<IRequest, GenerateDataKeyPairWithoutPlaintextRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GenerateDataKeyPairWithoutPlaintextRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GenerateDataKeyPairWithoutPlaintextRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.KeyManagementService");
            string target = "TrentService.GenerateDataKeyPairWithoutPlaintext";
        ...
        private static GenerateDataKeyPairWithoutPlaintextRequestMarshaller _instance = new GenerateDataKeyPairWithoutPlaintextRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GenerateDataKeyPairWithoutPlaintextRequestMarshaller Instance
        {
            get
            {
                return _instance;
