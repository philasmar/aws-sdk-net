...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeCustomKeyStoresRequestMarshaller : IMarshaller<IRequest, DescribeCustomKeyStoresRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeCustomKeyStoresRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeCustomKeyStoresRequest publicRequest)
        {
        ...
        private static DescribeCustomKeyStoresRequestMarshaller _instance = new DescribeCustomKeyStoresRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeCustomKeyStoresRequestMarshaller Instance
        {
            get
            {
                return _instance;
