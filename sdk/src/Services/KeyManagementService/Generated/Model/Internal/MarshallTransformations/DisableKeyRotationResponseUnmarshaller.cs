...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisableKeyRotationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisableKeyRotationResponse response = new DisableKeyRotationResponse();
        ...
        private static DisableKeyRotationResponseUnmarshaller _instance = new DisableKeyRotationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableKeyRotationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
