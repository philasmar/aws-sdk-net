...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DisconnectCustomKeyStoreResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisconnectCustomKeyStoreResponse response = new DisconnectCustomKeyStoreResponse();
        ...
        private static DisconnectCustomKeyStoreResponseUnmarshaller _instance = new DisconnectCustomKeyStoreResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisconnectCustomKeyStoreResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
