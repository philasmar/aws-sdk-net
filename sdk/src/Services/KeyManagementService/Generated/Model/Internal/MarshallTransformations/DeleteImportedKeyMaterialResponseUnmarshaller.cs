...
namespace Amazon.KeyManagementService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteImportedKeyMaterialResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteImportedKeyMaterialResponse response = new DeleteImportedKeyMaterialResponse();
        ...
        private static DeleteImportedKeyMaterialResponseUnmarshaller _instance = new DeleteImportedKeyMaterialResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteImportedKeyMaterialResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
