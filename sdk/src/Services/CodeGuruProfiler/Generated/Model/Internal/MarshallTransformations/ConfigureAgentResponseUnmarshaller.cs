...
{
    /// <summary>
    /// Response Unmarshaller for ConfigureAgent operation
    /// </summary>  
    public class ConfigureAgentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ConfigureAgentResponseUnmarshaller _instance = new ConfigureAgentResponseUnmarshaller();        

        internal static ConfigureAgentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ConfigureAgentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
