...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class ListFindingsReportsRequestMarshaller : IMarshaller<IRequest, ListFindingsReportsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static ListFindingsReportsRequestMarshaller _instance = new ListFindingsReportsRequestMarshaller();        

        internal static ListFindingsReportsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListFindingsReportsRequestMarshaller Instance
        {
            get
            {
                return _instance;
