    ...
    public class BatchGetFrameMetricDataResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<TimestampStructure, TimestampStructureUnmarshaller>(TimestampStructureUnmarshaller.Instance);
                    response.EndTimes = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("frameMetricData", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<FrameMetricDatum, FrameMetricDatumUnmarshaller>(FrameMetricDatumUnmarshaller.Instance);
                    response.FrameMetricData = unmarshaller.Unmarshall(context);
                    continue;
                }
                if (context.TestExpression("resolution", targetDepth))
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.Resolution = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = new DictionaryUnmarshaller<string, List<TimestampStructure>, StringUnmarshaller, ListUnmarshaller<TimestampStructure, TimestampStructureUnmarshaller>>(StringUnmarshaller.Instance, new ListUnmarshaller<TimestampStructure, TimestampStructureUnmarshaller>(TimestampStructureUnmarshaller.Instance));
                    response.UnprocessedEndTimes = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
