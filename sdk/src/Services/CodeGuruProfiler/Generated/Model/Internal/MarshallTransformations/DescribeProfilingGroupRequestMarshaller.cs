...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeProfilingGroupRequestMarshaller : IMarshaller<IRequest, DescribeProfilingGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DescribeProfilingGroupRequestMarshaller _instance = new DescribeProfilingGroupRequestMarshaller();        

        internal static DescribeProfilingGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeProfilingGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
