...
namespace Amazon.CodeGuruProfiler.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteProfilingGroupRequestMarshaller : IMarshaller<IRequest, DeleteProfilingGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        private static DeleteProfilingGroupRequestMarshaller _instance = new DeleteProfilingGroupRequestMarshaller();        

        internal static DeleteProfilingGroupRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteProfilingGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
