...
{
    /// <summary>
    /// Response Unmarshaller for StopReplicationTask operation
    /// </summary>  
    public class StopReplicationTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StopReplicationTaskResponse response = new StopReplicationTaskResponse();
        ...
        private static StopReplicationTaskResponseUnmarshaller _instance = new StopReplicationTaskResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StopReplicationTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
