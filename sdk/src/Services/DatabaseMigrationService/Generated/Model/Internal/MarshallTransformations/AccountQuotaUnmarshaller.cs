...
namespace Amazon.DatabaseMigrationService.Model.Internal.MarshallTransformations
{
    ...
    public class AccountQuotaUnmarshaller : IUnmarshaller<AccountQuota, XmlUnmarshallerContext>, IUnmarshaller<AccountQuota, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        AccountQuota IUnmarshaller<AccountQuota, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public AccountQuota Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("AccountQuotaName", targetDepth))
                {
                    ...
                    unmarshalledObject.AccountQuotaName = unmarshaller.Unmarshall(context);
                    continue;
                }
