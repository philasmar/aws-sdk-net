...
{
    /// <summary>
    /// CreateReplicationSubnetGroup Request Marshaller
    /// </summary>       
    public class CreateReplicationSubnetGroupRequestMarshaller : IMarshaller<IRequest, CreateReplicationSubnetGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateReplicationSubnetGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateReplicationSubnetGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DatabaseMigrationService");
            string target = "AmazonDMSv20160101.CreateReplicationSubnetGroup";
