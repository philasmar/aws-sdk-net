...
{
    /// <summary>
    /// Response Unmarshaller for DeleteReplicationTask operation
    /// </summary>  
    public class DeleteReplicationTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteReplicationTaskResponse response = new DeleteReplicationTaskResponse();
        ...
        private static DeleteReplicationTaskResponseUnmarshaller _instance = new DeleteReplicationTaskResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteReplicationTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
