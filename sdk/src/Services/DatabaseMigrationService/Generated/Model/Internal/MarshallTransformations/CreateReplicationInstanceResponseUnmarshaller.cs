...
{
    /// <summary>
    /// Response Unmarshaller for CreateReplicationInstance operation
    /// </summary>  
    public class CreateReplicationInstanceResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateReplicationInstanceResponse response = new CreateReplicationInstanceResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return InsufficientResourceCapacityExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CreateReplicationInstanceResponseUnmarshaller _instance = new CreateReplicationInstanceResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateReplicationInstanceResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
