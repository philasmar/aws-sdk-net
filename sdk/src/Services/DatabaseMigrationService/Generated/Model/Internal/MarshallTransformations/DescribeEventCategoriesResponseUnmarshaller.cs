...
namespace Amazon.DatabaseMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeEventCategoriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<EventCategoryGroup, EventCategoryGroupUnmarshaller>(EventCategoryGroupUnmarshaller.Instance);
                    response.EventCategoryGroupList = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
