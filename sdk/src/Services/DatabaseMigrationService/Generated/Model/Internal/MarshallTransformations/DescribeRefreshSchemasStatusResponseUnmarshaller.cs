...
{
    /// <summary>
    /// Response Unmarshaller for DescribeRefreshSchemasStatus operation
    /// </summary>  
    public class DescribeRefreshSchemasStatusResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeRefreshSchemasStatusResponse response = new DescribeRefreshSchemasStatusResponse();
        ...
        private static DescribeRefreshSchemasStatusResponseUnmarshaller _instance = new DescribeRefreshSchemasStatusResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRefreshSchemasStatusResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
