...
{
    /// <summary>
    /// Response Unmarshaller for CreateReplicationTask operation
    /// </summary>  
    public class CreateReplicationTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateReplicationTaskResponse response = new CreateReplicationTaskResponse();
        ...
        private static CreateReplicationTaskResponseUnmarshaller _instance = new CreateReplicationTaskResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateReplicationTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
