...
namespace Amazon.DatabaseMigrationService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ElasticsearchSettingsUnmarshaller : IUnmarshaller<ElasticsearchSettings, XmlUnmarshallerContext>, IUnmarshaller<ElasticsearchSettings, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        ElasticsearchSettings IUnmarshaller<ElasticsearchSettings, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public ElasticsearchSettings Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("EndpointUri", targetDepth))
                {
                    ...
                    unmarshalledObject.EndpointUri = unmarshaller.Unmarshall(context);
                    continue;
                }
                ...
                {
                    var unmarshaller = IntUnmarshaller.Instance;
                    unmarshalledObject.FullLoadErrorPercentage = unmarshaller.Unmarshall(context);
                    continue;
                }
