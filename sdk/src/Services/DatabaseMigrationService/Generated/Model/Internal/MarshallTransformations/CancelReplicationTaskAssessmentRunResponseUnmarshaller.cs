...
{
    /// <summary>
    /// Response Unmarshaller for CancelReplicationTaskAssessmentRun operation
    /// </summary>  
    public class CancelReplicationTaskAssessmentRunResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelReplicationTaskAssessmentRunResponse response = new CancelReplicationTaskAssessmentRunResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = ReplicationTaskAssessmentRunUnmarshaller.Instance;
                    response.ReplicationTaskAssessmentRun = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static CancelReplicationTaskAssessmentRunResponseUnmarshaller _instance = new CancelReplicationTaskAssessmentRunResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelReplicationTaskAssessmentRunResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
