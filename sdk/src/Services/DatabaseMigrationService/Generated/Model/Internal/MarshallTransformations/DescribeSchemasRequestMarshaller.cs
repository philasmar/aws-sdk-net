...
{
    /// <summary>
    /// DescribeSchemas Request Marshaller
    /// </summary>       
    public class DescribeSchemasRequestMarshaller : IMarshaller<IRequest, DescribeSchemasRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeSchemasRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeSchemasRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DatabaseMigrationService");
            string target = "AmazonDMSv20160101.DescribeSchemas";
        ...
        private static DescribeSchemasRequestMarshaller _instance = new DescribeSchemasRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSchemasRequestMarshaller Instance
        {
            get
            {
                return _instance;
