...
{
    /// <summary>
    /// DeleteReplicationSubnetGroup Request Marshaller
    /// </summary>       
    public class DeleteReplicationSubnetGroupRequestMarshaller : IMarshaller<IRequest, DeleteReplicationSubnetGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteReplicationSubnetGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteReplicationSubnetGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DatabaseMigrationService");
            string target = "AmazonDMSv20160101.DeleteReplicationSubnetGroup";
