...
{
    /// <summary>
    /// StartReplicationTask Request Marshaller
    /// </summary>       
    public class StartReplicationTaskRequestMarshaller : IMarshaller<IRequest, StartReplicationTaskRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((StartReplicationTaskRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(StartReplicationTaskRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DatabaseMigrationService");
            string target = "AmazonDMSv20160101.StartReplicationTask";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetStartReplicationTaskType())
                {
                    context.Writer.WritePropertyName("StartReplicationTaskType");
                    context.Writer.Write(publicRequest.StartReplicationTaskType);
                }
        ...
        private static StartReplicationTaskRequestMarshaller _instance = new StartReplicationTaskRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartReplicationTaskRequestMarshaller Instance
        {
            get
            {
                return _instance;
