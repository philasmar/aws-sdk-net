...
namespace Amazon.DatabaseMigrationService.Model
{
    ...
    internal sealed partial class DescribeTableStatisticsPaginator : IPaginator<DescribeTableStatisticsResponse>, IDescribeTableStatisticsPaginator
    {
        ...
        async IAsyncEnumerable<DescribeTableStatisticsResponse> IPaginator<DescribeTableStatisticsResponse>.PaginateAsync(CancellationToken cancellationToken = default)
        {
            if (Interlocked.Exchange(ref _isPaginatorInUse, 1) != 0)
            {
                throw new System.InvalidOperationException("Paginator has already been consumed and cannot be reused. Please create a new instance.");
