...
{
    /// <summary>
    /// CreateLocationFsxWindows Request Marshaller
    /// </summary>       
    public class CreateLocationFsxWindowsRequestMarshaller : IMarshaller<IRequest, CreateLocationFsxWindowsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateLocationFsxWindowsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateLocationFsxWindowsRequest publicRequest)
        {
        ...
        private static CreateLocationFsxWindowsRequestMarshaller _instance = new CreateLocationFsxWindowsRequestMarshaller();        

        internal static CreateLocationFsxWindowsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLocationFsxWindowsRequestMarshaller Instance
        {
            get
            {
                return _instance;
