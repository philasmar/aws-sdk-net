...
{
    /// <summary>
    /// Response Unmarshaller for ListTaskExecutions operation
    /// </summary>  
    public class ListTaskExecutionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListTaskExecutionsResponseUnmarshaller _instance = new ListTaskExecutionsResponseUnmarshaller();        

        internal static ListTaskExecutionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListTaskExecutionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
