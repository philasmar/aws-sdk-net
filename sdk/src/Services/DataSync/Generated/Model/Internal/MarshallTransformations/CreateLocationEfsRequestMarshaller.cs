...
{
    /// <summary>
    /// CreateLocationEfs Request Marshaller
    /// </summary>       
    public class CreateLocationEfsRequestMarshaller : IMarshaller<IRequest, CreateLocationEfsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateLocationEfsRequest)input);
        }
        ...
        private static CreateLocationEfsRequestMarshaller _instance = new CreateLocationEfsRequestMarshaller();        

        internal static CreateLocationEfsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLocationEfsRequestMarshaller Instance
        {
            get
            {
                return _instance;
