...
{
    /// <summary>
    /// Response Unmarshaller for DeleteLocation operation
    /// </summary>  
    public class DeleteLocationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteLocationResponseUnmarshaller _instance = new DeleteLocationResponseUnmarshaller();        

        internal static DeleteLocationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLocationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
