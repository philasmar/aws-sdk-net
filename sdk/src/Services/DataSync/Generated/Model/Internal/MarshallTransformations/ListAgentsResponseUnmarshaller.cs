...
{
    /// <summary>
    /// Response Unmarshaller for ListAgents operation
    /// </summary>  
    public class ListAgentsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static ListAgentsResponseUnmarshaller _instance = new ListAgentsResponseUnmarshaller();        

        internal static ListAgentsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListAgentsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
