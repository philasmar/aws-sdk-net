...
{
    /// <summary>
    /// Response Unmarshaller for CreateLocationNfs operation
    /// </summary>  
    public class CreateLocationNfsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLocationNfsResponse response = new CreateLocationNfsResponse();
        ...
        private static CreateLocationNfsResponseUnmarshaller _instance = new CreateLocationNfsResponseUnmarshaller();        

        internal static CreateLocationNfsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLocationNfsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
