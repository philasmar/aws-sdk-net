...
{
    /// <summary>
    /// Response Unmarshaller for StartTaskExecution operation
    /// </summary>  
    public class StartTaskExecutionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartTaskExecutionResponse response = new StartTaskExecutionResponse();
        ...
        private static StartTaskExecutionResponseUnmarshaller _instance = new StartTaskExecutionResponseUnmarshaller();        

        internal static StartTaskExecutionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartTaskExecutionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
