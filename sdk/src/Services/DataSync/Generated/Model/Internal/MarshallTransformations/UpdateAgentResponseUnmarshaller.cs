...
{
    /// <summary>
    /// Response Unmarshaller for UpdateAgent operation
    /// </summary>  
    public class UpdateAgentResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static UpdateAgentResponseUnmarshaller _instance = new UpdateAgentResponseUnmarshaller();        

        internal static UpdateAgentResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateAgentResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
