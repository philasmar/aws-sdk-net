...
{
    /// <summary>
    /// Response Unmarshaller for DescribeLocationFsxWindows operation
    /// </summary>  
    public class DescribeLocationFsxWindowsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLocationFsxWindowsResponse response = new DescribeLocationFsxWindowsResponse();
        ...
        private static DescribeLocationFsxWindowsResponseUnmarshaller _instance = new DescribeLocationFsxWindowsResponseUnmarshaller();        

        internal static DescribeLocationFsxWindowsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLocationFsxWindowsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
