...
{
    /// <summary>
    /// CreateLocationNfs Request Marshaller
    /// </summary>       
    public class CreateLocationNfsRequestMarshaller : IMarshaller<IRequest, CreateLocationNfsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateLocationNfsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateLocationNfsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DataSync");
            string target = "FmrsService.CreateLocationNfs";
        ...
        private static CreateLocationNfsRequestMarshaller _instance = new CreateLocationNfsRequestMarshaller();        

        internal static CreateLocationNfsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLocationNfsRequestMarshaller Instance
        {
            get
            {
                return _instance;
