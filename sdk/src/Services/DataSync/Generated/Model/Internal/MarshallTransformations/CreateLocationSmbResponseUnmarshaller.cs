...
{
    /// <summary>
    /// Response Unmarshaller for CreateLocationSmb operation
    /// </summary>  
    public class CreateLocationSmbResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLocationSmbResponse response = new CreateLocationSmbResponse();
        ...
        private static CreateLocationSmbResponseUnmarshaller _instance = new CreateLocationSmbResponseUnmarshaller();        

        internal static CreateLocationSmbResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLocationSmbResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
