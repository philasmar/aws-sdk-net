...
{
    /// <summary>
    /// Response Unmarshaller for CreateLocationS3 operation
    /// </summary>  
    public class CreateLocationS3ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLocationS3Response response = new CreateLocationS3Response();
        ...
        private static CreateLocationS3ResponseUnmarshaller _instance = new CreateLocationS3ResponseUnmarshaller();        

        internal static CreateLocationS3ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLocationS3ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
