...
{
    /// <summary>
    /// Response Unmarshaller for DescribeLocationEfs operation
    /// </summary>  
    public class DescribeLocationEfsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLocationEfsResponse response = new DescribeLocationEfsResponse();
        ...
        private static DescribeLocationEfsResponseUnmarshaller _instance = new DescribeLocationEfsResponseUnmarshaller();        

        internal static DescribeLocationEfsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLocationEfsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
