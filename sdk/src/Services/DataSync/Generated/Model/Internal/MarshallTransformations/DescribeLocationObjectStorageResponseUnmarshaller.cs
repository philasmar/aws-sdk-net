...
{
    /// <summary>
    /// Response Unmarshaller for DescribeLocationObjectStorage operation
    /// </summary>  
    public class DescribeLocationObjectStorageResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeLocationObjectStorageResponse response = new DescribeLocationObjectStorageResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = StringUnmarshaller.Instance;
                    response.ServerProtocol = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeLocationObjectStorageResponseUnmarshaller _instance = new DescribeLocationObjectStorageResponseUnmarshaller();        

        internal static DescribeLocationObjectStorageResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeLocationObjectStorageResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
