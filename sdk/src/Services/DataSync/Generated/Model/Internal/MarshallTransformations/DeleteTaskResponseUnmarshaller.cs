...
{
    /// <summary>
    /// Response Unmarshaller for DeleteTask operation
    /// </summary>  
    public class DeleteTaskResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DeleteTaskResponseUnmarshaller _instance = new DeleteTaskResponseUnmarshaller();        

        internal static DeleteTaskResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTaskResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
