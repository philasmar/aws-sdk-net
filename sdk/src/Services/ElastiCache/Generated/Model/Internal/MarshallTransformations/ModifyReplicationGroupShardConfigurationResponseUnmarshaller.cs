...
{
    /// <summary>
    /// Response Unmarshaller for ModifyReplicationGroupShardConfiguration operation
    /// </summary>  
    public class ModifyReplicationGroupShardConfigurationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ModifyReplicationGroupShardConfigurationResponse response = new ModifyReplicationGroupShardConfigurationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ModifyReplicationGroupShardConfigurationResult", 2))
                    {
        ...
        private static ModifyReplicationGroupShardConfigurationResponseUnmarshaller _instance = new ModifyReplicationGroupShardConfigurationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ModifyReplicationGroupShardConfigurationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
