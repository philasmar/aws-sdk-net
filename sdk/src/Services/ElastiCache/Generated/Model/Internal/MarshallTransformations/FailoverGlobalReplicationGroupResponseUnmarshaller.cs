...
{
    /// <summary>
    /// Response Unmarshaller for FailoverGlobalReplicationGroup operation
    /// </summary>  
    public class FailoverGlobalReplicationGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            FailoverGlobalReplicationGroupResponse response = new FailoverGlobalReplicationGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("FailoverGlobalReplicationGroupResult", 2))
                    {
        ...
        private static FailoverGlobalReplicationGroupResponseUnmarshaller _instance = new FailoverGlobalReplicationGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static FailoverGlobalReplicationGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
