...
{
    /// <summary>
    /// Response Unmarshaller for IncreaseReplicaCount operation
    /// </summary>  
    public class IncreaseReplicaCountResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            IncreaseReplicaCountResponse response = new IncreaseReplicaCountResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("IncreaseReplicaCountResult", 2))
                    {
        ...
        private static IncreaseReplicaCountResponseUnmarshaller _instance = new IncreaseReplicaCountResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static IncreaseReplicaCountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
