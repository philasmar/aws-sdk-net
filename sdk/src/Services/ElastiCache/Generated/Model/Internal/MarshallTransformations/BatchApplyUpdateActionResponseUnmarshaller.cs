...
{
    /// <summary>
    /// Response Unmarshaller for BatchApplyUpdateAction operation
    /// </summary>  
    public class BatchApplyUpdateActionResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            BatchApplyUpdateActionResponse response = new BatchApplyUpdateActionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("BatchApplyUpdateActionResult", 2))
                    {
        ...
        private static BatchApplyUpdateActionResponseUnmarshaller _instance = new BatchApplyUpdateActionResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchApplyUpdateActionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
