...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    public class ReservedCacheNodeUnmarshaller : IUnmarshaller<ReservedCacheNode, XmlUnmarshallerContext>, IUnmarshaller<ReservedCacheNode, JsonUnmarshallerContext>
    {
        ...
        {
            ReservedCacheNode unmarshalledObject = new ReservedCacheNode();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    if (context.TestExpression("CacheNodeCount", targetDepth))
                    {
                        ...
                        unmarshalledObject.CacheNodeCount = unmarshaller.Unmarshall(context);
                        continue;
                    }
                    ...
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.ReservedCacheNodeId = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ReservedCacheNodeUnmarshaller Instance
        {
            get
            {
                return _instance;
