...
{
    /// <summary>
    /// Response Unmarshaller for DecreaseReplicaCount operation
    /// </summary>  
    public class DecreaseReplicaCountResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DecreaseReplicaCountResponse response = new DecreaseReplicaCountResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DecreaseReplicaCountResult", 2))
                    {
        ...
        private static DecreaseReplicaCountResponseUnmarshaller _instance = new DecreaseReplicaCountResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DecreaseReplicaCountResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
