...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    public class InvalidARNExceptionUnmarshaller : IErrorResponseUnmarshaller<InvalidARNException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public InvalidARNException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public InvalidARNException Unmarshall(XmlUnmarshallerContext context, ErrorResponse errorResponse)
        {
            InvalidARNException response = new InvalidARNException(errorResponse.Message, errorResponse.InnerException, 
