...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateGlobalReplicationGroup operation
    /// </summary>  
    public class DisassociateGlobalReplicationGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateGlobalReplicationGroupResponse response = new DisassociateGlobalReplicationGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DisassociateGlobalReplicationGroupResult", 2))
                    {
        ...
        private static DisassociateGlobalReplicationGroupResponseUnmarshaller _instance = new DisassociateGlobalReplicationGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateGlobalReplicationGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
