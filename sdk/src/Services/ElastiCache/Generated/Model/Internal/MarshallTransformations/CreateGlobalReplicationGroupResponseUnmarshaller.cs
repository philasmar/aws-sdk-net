...
{
    /// <summary>
    /// Response Unmarshaller for CreateGlobalReplicationGroup operation
    /// </summary>  
    public class CreateGlobalReplicationGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateGlobalReplicationGroupResponse response = new CreateGlobalReplicationGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CreateGlobalReplicationGroupResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            {
                if (errorResponse.Code != null && errorResponse.Code.Equals("GlobalReplicationGroupAlreadyExistsFault"))
                {
                    return GlobalReplicationGroupAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CreateGlobalReplicationGroupResponseUnmarshaller _instance = new CreateGlobalReplicationGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateGlobalReplicationGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
