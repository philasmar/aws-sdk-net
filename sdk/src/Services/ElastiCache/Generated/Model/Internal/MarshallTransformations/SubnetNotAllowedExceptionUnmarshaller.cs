...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    public class SubnetNotAllowedExceptionUnmarshaller : IErrorResponseUnmarshaller<SubnetNotAllowedException, XmlUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public SubnetNotAllowedException Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <returns></returns>
        public SubnetNotAllowedException Unmarshall(XmlUnmarshallerContext context, ErrorResponse errorResponse)
        {
            SubnetNotAllowedException response = new SubnetNotAllowedException(errorResponse.Message, errorResponse.InnerException, 
