...
{
    /// <summary>
    /// BatchApplyUpdateAction Request Marshaller
    /// </summary>       
    public class BatchApplyUpdateActionRequestMarshaller : IMarshaller<IRequest, BatchApplyUpdateActionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((BatchApplyUpdateActionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(BatchApplyUpdateActionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ElastiCache");
            request.Parameters.Add("Action", "BatchApplyUpdateAction");
            ...
            return request;
                    ...
                    private static BatchApplyUpdateActionRequestMarshaller _instance = new BatchApplyUpdateActionRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static BatchApplyUpdateActionRequestMarshaller Instance
        {
            get
            {
                return _instance;
