...
{
    /// <summary>
    /// Response Unmarshaller for DeleteCacheCluster operation
    /// </summary>  
    public class DeleteCacheClusterResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteCacheClusterResponse response = new DeleteCacheClusterResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DeleteCacheClusterResult", 2))
                    {
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteCacheClusterResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
