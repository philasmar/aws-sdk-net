...
{
    /// <summary>
    /// Response Unmarshaller for DescribeUserGroups operation
    /// </summary>  
    public class DescribeUserGroupsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeUserGroupsResponse response = new DescribeUserGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeUserGroupsResult", 2))
                    {
        ...
        private static void UnmarshallResult(XmlUnmarshallerContext context, DescribeUserGroupsResponse response)
        {
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                if (context.IsStartElement || context.IsAttribute)
                {
                    ...
                    {
                        var unmarshaller = UserGroupUnmarshaller.Instance;
                        var item = unmarshaller.Unmarshall(context);
                        response.UserGroups.Add(item);
                        continue;
                    }
                } 
           }
        ...
        private static DescribeUserGroupsResponseUnmarshaller _instance = new DescribeUserGroupsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeUserGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
