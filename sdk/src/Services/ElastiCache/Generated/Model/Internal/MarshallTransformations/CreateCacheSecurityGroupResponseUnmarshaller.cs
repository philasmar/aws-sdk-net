...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateCacheSecurityGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return CacheSecurityGroupAlreadyExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("QuotaExceeded.CacheSecurityGroup"))
                {
                    return CacheSecurityGroupQuotaExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static CreateCacheSecurityGroupResponseUnmarshaller _instance = new CreateCacheSecurityGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateCacheSecurityGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
