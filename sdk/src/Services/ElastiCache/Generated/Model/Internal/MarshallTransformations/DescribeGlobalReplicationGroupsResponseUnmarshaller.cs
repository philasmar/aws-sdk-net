...
{
    /// <summary>
    /// Response Unmarshaller for DescribeGlobalReplicationGroups operation
    /// </summary>  
    public class DescribeGlobalReplicationGroupsResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeGlobalReplicationGroupsResponse response = new DescribeGlobalReplicationGroupsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DescribeGlobalReplicationGroupsResult", 2))
                    {
        ...
        private static DescribeGlobalReplicationGroupsResponseUnmarshaller _instance = new DescribeGlobalReplicationGroupsResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeGlobalReplicationGroupsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
