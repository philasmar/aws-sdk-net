...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    public class GlobalNodeGroupUnmarshaller : IUnmarshaller<GlobalNodeGroup, XmlUnmarshallerContext>, IUnmarshaller<GlobalNodeGroup, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public GlobalNodeGroup Unmarshall(XmlUnmarshallerContext context)
        {
            GlobalNodeGroup unmarshalledObject = new GlobalNodeGroup();
            ...
            while (context.ReadAtDepth(originalDepth))
            {
                ...
                {
                    if (context.TestExpression("GlobalNodeGroupId", targetDepth))
                    {
                        var unmarshaller = StringUnmarshaller.Instance;
                        unmarshalledObject.GlobalNodeGroupId = unmarshaller.Unmarshall(context);
                        continue;
                    }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GlobalNodeGroupUnmarshaller Instance
        {
            get
            {
                return _instance;
