...
namespace Amazon.ElastiCache.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ResetCacheParameterGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ResetCacheParameterGroupResponse response = new ResetCacheParameterGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("ResetCacheParameterGroupResult", 2))
                    {
        ...
        private static ResetCacheParameterGroupResponseUnmarshaller _instance = new ResetCacheParameterGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResetCacheParameterGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
