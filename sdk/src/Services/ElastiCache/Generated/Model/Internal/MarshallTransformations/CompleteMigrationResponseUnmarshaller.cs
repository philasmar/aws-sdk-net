...
{
    /// <summary>
    /// Response Unmarshaller for CompleteMigration operation
    /// </summary>  
    public class CompleteMigrationResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CompleteMigrationResponse response = new CompleteMigrationResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("CompleteMigrationResult", 2))
                    {
        ...
        public override AmazonServiceException UnmarshallException(XmlUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new XmlUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("ReplicationGroupNotUnderMigrationFault"))
                {
                    return ReplicationGroupNotUnderMigrationExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static CompleteMigrationResponseUnmarshaller _instance = new CompleteMigrationResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CompleteMigrationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
