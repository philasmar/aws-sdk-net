...
{
    /// <summary>
    /// Response Unmarshaller for DecreaseNodeGroupsInGlobalReplicationGroup operation
    /// </summary>  
    public class DecreaseNodeGroupsInGlobalReplicationGroupResponseUnmarshaller : XmlResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DecreaseNodeGroupsInGlobalReplicationGroupResponse response = new DecreaseNodeGroupsInGlobalReplicationGroupResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {                    
                    if(context.TestExpression("DecreaseNodeGroupsInGlobalReplicationGroupResult", 2))
                    {
        ...
        private static DecreaseNodeGroupsInGlobalReplicationGroupResponseUnmarshaller _instance = new DecreaseNodeGroupsInGlobalReplicationGroupResponseUnmarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DecreaseNodeGroupsInGlobalReplicationGroupResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
