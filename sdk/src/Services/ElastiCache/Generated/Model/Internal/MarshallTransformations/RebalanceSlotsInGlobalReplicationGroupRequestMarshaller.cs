...
{
    /// <summary>
    /// RebalanceSlotsInGlobalReplicationGroup Request Marshaller
    /// </summary>       
    public class RebalanceSlotsInGlobalReplicationGroupRequestMarshaller : IMarshaller<IRequest, RebalanceSlotsInGlobalReplicationGroupRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((RebalanceSlotsInGlobalReplicationGroupRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(RebalanceSlotsInGlobalReplicationGroupRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.ElastiCache");
            request.Parameters.Add("Action", "RebalanceSlotsInGlobalReplicationGroup");
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RebalanceSlotsInGlobalReplicationGroupRequestMarshaller Instance
        {
            get
            {
                return _instance;
