    ...
    public class DescribeReplicationGroupsRequestMarshaller : IMarshaller<IRequest, DescribeReplicationGroupsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(DescribeReplicationGroupsRequest publicRequest)
        {
            ...
            return request;
                    ...
                    private static DescribeReplicationGroupsRequestMarshaller _instance = new DescribeReplicationGroupsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeReplicationGroupsRequestMarshaller Instance
        {
            get
            {
                return _instance;
