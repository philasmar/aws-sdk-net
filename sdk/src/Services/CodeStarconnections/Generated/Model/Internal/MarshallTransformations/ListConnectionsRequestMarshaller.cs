...
namespace Amazon.CodeStarconnections.Model.Internal.MarshallTransformations
{
    ...
    public class ListConnectionsRequestMarshaller : IMarshaller<IRequest, ListConnectionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(ListConnectionsRequest publicRequest)
        {
            ...
            string target = "com.amazonaws.codestar.connections.CodeStar_connections_20191201.ListConnections";
            ...
            using (StringWriter stringWriter = new StringWriter(CultureInfo.InvariantCulture))
            {
                ...
                if(publicRequest.IsSetProviderTypeFilter())
                {
                    context.Writer.WritePropertyName("ProviderTypeFilter");
                    context.Writer.Write(publicRequest.ProviderTypeFilter);
                }
