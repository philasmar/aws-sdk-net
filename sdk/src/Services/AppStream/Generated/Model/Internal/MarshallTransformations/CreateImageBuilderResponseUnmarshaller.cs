...
{
    /// <summary>
    /// Response Unmarshaller for CreateImageBuilder operation
    /// </summary>  
    public class CreateImageBuilderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateImageBuilderResponse response = new CreateImageBuilderResponse();
        ...
        private static CreateImageBuilderResponseUnmarshaller _instance = new CreateImageBuilderResponseUnmarshaller();        

        internal static CreateImageBuilderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateImageBuilderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
