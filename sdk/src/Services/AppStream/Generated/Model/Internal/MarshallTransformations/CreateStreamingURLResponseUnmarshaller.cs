...
{
    /// <summary>
    /// Response Unmarshaller for CreateStreamingURL operation
    /// </summary>  
    public class CreateStreamingURLResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateStreamingURLResponse response = new CreateStreamingURLResponse();
        ...
        private static CreateStreamingURLResponseUnmarshaller _instance = new CreateStreamingURLResponseUnmarshaller();        

        internal static CreateStreamingURLResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateStreamingURLResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
