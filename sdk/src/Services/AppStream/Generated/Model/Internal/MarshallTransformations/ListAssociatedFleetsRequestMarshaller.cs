...
{
    /// <summary>
    /// ListAssociatedFleets Request Marshaller
    /// </summary>       
    public class ListAssociatedFleetsRequestMarshaller : IMarshaller<IRequest, ListAssociatedFleetsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListAssociatedFleetsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListAssociatedFleetsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.AppStream");
            string target = "PhotonAdminProxyService.ListAssociatedFleets";
