...
{
    /// <summary>
    /// Response Unmarshaller for DisassociateFleet operation
    /// </summary>  
    public class DisassociateFleetResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisassociateFleetResponse response = new DisassociateFleetResponse();
        ...
        private static DisassociateFleetResponseUnmarshaller _instance = new DisassociateFleetResponseUnmarshaller();        

        internal static DisassociateFleetResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisassociateFleetResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
