...
namespace Amazon.AppStream.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UserStackAssociationUnmarshaller : IUnmarshaller<UserStackAssociation, XmlUnmarshallerContext>, IUnmarshaller<UserStackAssociation, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        UserStackAssociation IUnmarshaller<UserStackAssociation, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public UserStackAssociation Unmarshall(JsonUnmarshallerContext context)
        {
            context.Read();
