...
{
    /// <summary>
    /// CreateImageBuilderStreamingURL Request Marshaller
    /// </summary>       
    public class CreateImageBuilderStreamingURLRequestMarshaller : IMarshaller<IRequest, CreateImageBuilderStreamingURLRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateImageBuilderStreamingURLRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateImageBuilderStreamingURLRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.AppStream");
            string target = "PhotonAdminProxyService.CreateImageBuilderStreamingURL";
