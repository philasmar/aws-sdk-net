...
{
    /// <summary>
    /// Response Unmarshaller for DeleteImageBuilder operation
    /// </summary>  
    public class DeleteImageBuilderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteImageBuilderResponse response = new DeleteImageBuilderResponse();
        ...
        private static DeleteImageBuilderResponseUnmarshaller _instance = new DeleteImageBuilderResponseUnmarshaller();        

        internal static DeleteImageBuilderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteImageBuilderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
