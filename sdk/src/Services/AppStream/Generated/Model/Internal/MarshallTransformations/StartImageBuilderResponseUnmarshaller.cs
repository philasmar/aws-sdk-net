...
{
    /// <summary>
    /// Response Unmarshaller for StartImageBuilder operation
    /// </summary>  
    public class StartImageBuilderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartImageBuilderResponse response = new StartImageBuilderResponse();
        ...
        private static StartImageBuilderResponseUnmarshaller _instance = new StartImageBuilderResponseUnmarshaller();        

        internal static StartImageBuilderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartImageBuilderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
