...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DeleteBatchPredictionRequestMarshaller : IMarshaller<IRequest, DeleteBatchPredictionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DeleteBatchPredictionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DeleteBatchPredictionRequest publicRequest)
        {
