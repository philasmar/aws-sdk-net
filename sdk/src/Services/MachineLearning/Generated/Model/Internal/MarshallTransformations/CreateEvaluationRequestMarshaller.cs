...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class CreateEvaluationRequestMarshaller : IMarshaller<IRequest, CreateEvaluationRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((CreateEvaluationRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(CreateEvaluationRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.MachineLearning");
            string target = "AmazonML_20141212.CreateEvaluation";
        ...
        private static CreateEvaluationRequestMarshaller _instance = new CreateEvaluationRequestMarshaller();        

        internal static CreateEvaluationRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateEvaluationRequestMarshaller Instance
        {
            get
            {
                return _instance;
