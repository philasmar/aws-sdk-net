...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateEvaluationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateEvaluationResponse response = new UpdateEvaluationResponse();
        ...
        private static UpdateEvaluationResponseUnmarshaller _instance = new UpdateEvaluationResponseUnmarshaller();        

        internal static UpdateEvaluationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateEvaluationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
