...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetEvaluationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static GetEvaluationResponseUnmarshaller _instance = new GetEvaluationResponseUnmarshaller();        

        internal static GetEvaluationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetEvaluationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
