...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UpdateMLModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateMLModelResponse response = new UpdateMLModelResponse();
        ...
        private static UpdateMLModelResponseUnmarshaller _instance = new UpdateMLModelResponseUnmarshaller();        

        internal static UpdateMLModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateMLModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
