...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeBatchPredictionsRequestMarshaller : IMarshaller<IRequest, DescribeBatchPredictionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeBatchPredictionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeBatchPredictionsRequest publicRequest)
        {
        ...
        private static DescribeBatchPredictionsRequestMarshaller _instance = new DescribeBatchPredictionsRequestMarshaller();        

        internal static DescribeBatchPredictionsRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeBatchPredictionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
