...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteMLModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteMLModelResponse response = new DeleteMLModelResponse();
        ...
        private static DeleteMLModelResponseUnmarshaller _instance = new DeleteMLModelResponseUnmarshaller();        

        internal static DeleteMLModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteMLModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
