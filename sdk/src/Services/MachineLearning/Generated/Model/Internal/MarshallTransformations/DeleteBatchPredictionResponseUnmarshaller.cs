...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteBatchPredictionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteBatchPredictionResponse response = new DeleteBatchPredictionResponse();
        ...
        private static DeleteBatchPredictionResponseUnmarshaller _instance = new DeleteBatchPredictionResponseUnmarshaller();        

        internal static DeleteBatchPredictionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteBatchPredictionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
