...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateMLModelResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateMLModelResponse response = new CreateMLModelResponse();
        ...
        private static CreateMLModelResponseUnmarshaller _instance = new CreateMLModelResponseUnmarshaller();        

        internal static CreateMLModelResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateMLModelResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
