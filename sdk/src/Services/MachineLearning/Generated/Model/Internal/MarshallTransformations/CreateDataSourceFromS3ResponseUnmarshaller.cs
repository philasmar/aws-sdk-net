...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class CreateDataSourceFromS3ResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateDataSourceFromS3Response response = new CreateDataSourceFromS3Response();
        ...
        private static CreateDataSourceFromS3ResponseUnmarshaller _instance = new CreateDataSourceFromS3ResponseUnmarshaller();        

        internal static CreateDataSourceFromS3ResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateDataSourceFromS3ResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
