...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteEvaluationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteEvaluationResponse response = new DeleteEvaluationResponse();
        ...
        private static DeleteEvaluationResponseUnmarshaller _instance = new DeleteEvaluationResponseUnmarshaller();        

        internal static DeleteEvaluationResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteEvaluationResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
