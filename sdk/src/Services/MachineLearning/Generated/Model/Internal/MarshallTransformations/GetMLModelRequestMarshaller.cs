...
namespace Amazon.MachineLearning.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class GetMLModelRequestMarshaller : IMarshaller<IRequest, GetMLModelRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((GetMLModelRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(GetMLModelRequest publicRequest)
        {
        ...
        private static GetMLModelRequestMarshaller _instance = new GetMLModelRequestMarshaller();        

        internal static GetMLModelRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetMLModelRequestMarshaller Instance
        {
            get
            {
                return _instance;
