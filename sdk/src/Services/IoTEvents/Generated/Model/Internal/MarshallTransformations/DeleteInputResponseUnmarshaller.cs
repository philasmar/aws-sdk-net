...
{
    /// <summary>
    /// Response Unmarshaller for DeleteInput operation
    /// </summary>  
    public class DeleteInputResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteInputResponse response = new DeleteInputResponse();
        ...
        private static DeleteInputResponseUnmarshaller _instance = new DeleteInputResponseUnmarshaller();        

        internal static DeleteInputResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteInputResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
