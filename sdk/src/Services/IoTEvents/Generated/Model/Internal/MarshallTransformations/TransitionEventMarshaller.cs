...
{
    /// <summary>
    /// TransitionEvent Marshaller
    /// </summary>       
    public class TransitionEventMarshaller : IRequestMarshaller<TransitionEvent, JsonMarshallerContext> 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public void Marshall(TransitionEvent requestObject, JsonMarshallerContext context)
        {
            ...
            if(requestObject.IsSetNextState())
            {
                context.Writer.WritePropertyName("nextState");
                context.Writer.Write(requestObject.NextState);
            }
        ...
        /// </summary>  
        public readonly static TransitionEventMarshaller Instance = new TransitionEventMarshaller();
