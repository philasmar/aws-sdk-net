    ...
    public class InputUnmarshaller : IUnmarshaller<Input, XmlUnmarshallerContext>, IUnmarshaller<Input, JsonUnmarshallerContext>
    {
        ...
        public Input Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("inputDefinition", targetDepth))
                {
                    var unmarshaller = InputDefinitionUnmarshaller.Instance;
                    unmarshalledObject.InputDefinition = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
