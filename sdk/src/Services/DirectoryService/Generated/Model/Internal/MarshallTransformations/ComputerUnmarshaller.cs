...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class ComputerUnmarshaller : IUnmarshaller<Computer, XmlUnmarshallerContext>, IUnmarshaller<Computer, JsonUnmarshallerContext>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Computer IUnmarshaller<Computer, XmlUnmarshallerContext>.Unmarshall(XmlUnmarshallerContext context)
        {
        ...
        public Computer Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            Computer unmarshalledObject = new Computer();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                if (context.TestExpression("ComputerId", targetDepth))
                {
                    ...
                    unmarshalledObject.ComputerId = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ComputerUnmarshaller _instance = new ComputerUnmarshaller();        

        /// <summary>
        /// Gets the singleton.
        /// </summary>  
        public static ComputerUnmarshaller Instance
        {
            get
            {
                return _instance;
