...
{
    /// <summary>
    /// Response Unmarshaller for DeleteConditionalForwarder operation
    /// </summary>  
    public class DeleteConditionalForwarderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteConditionalForwarderResponse response = new DeleteConditionalForwarderResponse();
        ...
        private static DeleteConditionalForwarderResponseUnmarshaller _instance = new DeleteConditionalForwarderResponseUnmarshaller();        

        internal static DeleteConditionalForwarderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteConditionalForwarderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
