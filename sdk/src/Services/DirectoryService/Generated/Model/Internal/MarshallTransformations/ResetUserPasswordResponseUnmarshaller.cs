...
{
    /// <summary>
    /// Response Unmarshaller for ResetUserPassword operation
    /// </summary>  
    public class ResetUserPasswordResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("UserDoesNotExistException"))
                {
                    return UserDoesNotExistExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static ResetUserPasswordResponseUnmarshaller _instance = new ResetUserPasswordResponseUnmarshaller();        

        internal static ResetUserPasswordResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ResetUserPasswordResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
