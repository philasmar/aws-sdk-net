...
{
    /// <summary>
    /// Response Unmarshaller for DeleteLogSubscription operation
    /// </summary>  
    public class DeleteLogSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteLogSubscriptionResponse response = new DeleteLogSubscriptionResponse();
        ...
        private static DeleteLogSubscriptionResponseUnmarshaller _instance = new DeleteLogSubscriptionResponseUnmarshaller();        

        internal static DeleteLogSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteLogSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
