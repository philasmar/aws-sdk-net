...
{
    /// <summary>
    /// Response Unmarshaller for UpdateTrust operation
    /// </summary>  
    public class UpdateTrustResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateTrustResponse response = new UpdateTrustResponse();
        ...
        private static UpdateTrustResponseUnmarshaller _instance = new UpdateTrustResponseUnmarshaller();        

        internal static UpdateTrustResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateTrustResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
