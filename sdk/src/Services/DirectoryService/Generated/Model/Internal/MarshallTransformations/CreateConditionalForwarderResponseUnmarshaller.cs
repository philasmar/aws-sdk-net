...
{
    /// <summary>
    /// Response Unmarshaller for CreateConditionalForwarder operation
    /// </summary>  
    public class CreateConditionalForwarderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateConditionalForwarderResponse response = new CreateConditionalForwarderResponse();
        ...
        private static CreateConditionalForwarderResponseUnmarshaller _instance = new CreateConditionalForwarderResponseUnmarshaller();        

        internal static CreateConditionalForwarderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateConditionalForwarderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
