...
{
    /// <summary>
    /// Response Unmarshaller for DescribeConditionalForwarders operation
    /// </summary>  
    public class DescribeConditionalForwardersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeConditionalForwardersResponse response = new DescribeConditionalForwardersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ConditionalForwarder, ConditionalForwarderUnmarshaller>(ConditionalForwarderUnmarshaller.Instance);
                    response.ConditionalForwarders = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeConditionalForwardersResponseUnmarshaller _instance = new DescribeConditionalForwardersResponseUnmarshaller();        

        internal static DescribeConditionalForwardersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeConditionalForwardersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
