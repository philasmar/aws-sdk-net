...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DescribeRegionsRequestMarshaller : IMarshaller<IRequest, DescribeRegionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DescribeRegionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DescribeRegionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DirectoryService");
            string target = "DirectoryService_20150416.DescribeRegions";
        ...
        private static DescribeRegionsRequestMarshaller _instance = new DescribeRegionsRequestMarshaller();        
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeRegionsRequestMarshaller Instance
        {
            get
            {
                return _instance;
