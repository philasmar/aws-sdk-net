...
{
    /// <summary>
    /// Response Unmarshaller for ListIpRoutes operation
    /// </summary>  
    public class ListIpRoutesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListIpRoutesResponse response = new ListIpRoutesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<IpRouteInfo, IpRouteInfoUnmarshaller>(IpRouteInfoUnmarshaller.Instance);
                    response.IpRoutesInfo = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListIpRoutesResponseUnmarshaller _instance = new ListIpRoutesResponseUnmarshaller();        

        internal static ListIpRoutesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListIpRoutesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
