...
{
    /// <summary>
    /// ListSchemaExtensions Request Marshaller
    /// </summary>       
    public class ListSchemaExtensionsRequestMarshaller : IMarshaller<IRequest, ListSchemaExtensionsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((ListSchemaExtensionsRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(ListSchemaExtensionsRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DirectoryService");
            string target = "DirectoryService_20150416.ListSchemaExtensions";
