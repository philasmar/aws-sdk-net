...
{
    /// <summary>
    /// Response Unmarshaller for DisableLDAPS operation
    /// </summary>  
    public class DisableLDAPSResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DisableLDAPSResponse response = new DisableLDAPSResponse();
        ...
        private static DisableLDAPSResponseUnmarshaller _instance = new DisableLDAPSResponseUnmarshaller();        

        internal static DisableLDAPSResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DisableLDAPSResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
