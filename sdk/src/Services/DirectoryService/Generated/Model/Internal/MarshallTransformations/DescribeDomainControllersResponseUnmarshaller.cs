...
{
    /// <summary>
    /// Response Unmarshaller for DescribeDomainControllers operation
    /// </summary>  
    public class DescribeDomainControllersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeDomainControllersResponse response = new DescribeDomainControllersResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<DomainController, DomainControllerUnmarshaller>(DomainControllerUnmarshaller.Instance);
                    response.DomainControllers = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static DescribeDomainControllersResponseUnmarshaller _instance = new DescribeDomainControllersResponseUnmarshaller();        

        internal static DescribeDomainControllersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDomainControllersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
