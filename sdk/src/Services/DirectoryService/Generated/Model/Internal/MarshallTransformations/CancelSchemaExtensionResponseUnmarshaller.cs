...
{
    /// <summary>
    /// Response Unmarshaller for CancelSchemaExtension operation
    /// </summary>  
    public class CancelSchemaExtensionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CancelSchemaExtensionResponse response = new CancelSchemaExtensionResponse();
        ...
        private static CancelSchemaExtensionResponseUnmarshaller _instance = new CancelSchemaExtensionResponseUnmarshaller();        

        internal static CancelSchemaExtensionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CancelSchemaExtensionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
