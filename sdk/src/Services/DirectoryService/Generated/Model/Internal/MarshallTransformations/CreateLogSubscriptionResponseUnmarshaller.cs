...
{
    /// <summary>
    /// Response Unmarshaller for CreateLogSubscription operation
    /// </summary>  
    public class CreateLogSubscriptionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            CreateLogSubscriptionResponse response = new CreateLogSubscriptionResponse();
        ...
        private static CreateLogSubscriptionResponseUnmarshaller _instance = new CreateLogSubscriptionResponseUnmarshaller();        

        internal static CreateLogSubscriptionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static CreateLogSubscriptionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
