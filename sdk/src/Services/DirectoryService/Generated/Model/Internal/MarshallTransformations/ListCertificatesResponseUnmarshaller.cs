...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    public class ListCertificatesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            {
                if (context.TestExpression("CertificatesInfo", targetDepth))
                {
                    var unmarshaller = new ListUnmarshaller<CertificateInfo, CertificateInfoUnmarshaller>(CertificateInfoUnmarshaller.Instance);
                    response.CertificatesInfo = unmarshaller.Unmarshall(context);
                    continue;
                }
