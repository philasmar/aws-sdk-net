...
{
    /// <summary>
    /// Response Unmarshaller for ListSchemaExtensions operation
    /// </summary>  
    public class ListSchemaExtensionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListSchemaExtensionsResponse response = new ListSchemaExtensionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SchemaExtensionInfo, SchemaExtensionInfoUnmarshaller>(SchemaExtensionInfoUnmarshaller.Instance);
                    response.SchemaExtensionsInfo = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static ListSchemaExtensionsResponseUnmarshaller _instance = new ListSchemaExtensionsResponseUnmarshaller();        

        internal static ListSchemaExtensionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListSchemaExtensionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
