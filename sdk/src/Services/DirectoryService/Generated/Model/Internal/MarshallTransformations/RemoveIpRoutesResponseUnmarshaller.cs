...
{
    /// <summary>
    /// Response Unmarshaller for RemoveIpRoutes operation
    /// </summary>  
    public class RemoveIpRoutesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            RemoveIpRoutesResponse response = new RemoveIpRoutesResponse();
        ...
        private static RemoveIpRoutesResponseUnmarshaller _instance = new RemoveIpRoutesResponseUnmarshaller();        

        internal static RemoveIpRoutesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static RemoveIpRoutesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
