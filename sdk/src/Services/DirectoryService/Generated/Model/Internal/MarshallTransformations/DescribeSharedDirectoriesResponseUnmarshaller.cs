...
{
    /// <summary>
    /// Response Unmarshaller for DescribeSharedDirectories operation
    /// </summary>  
    public class DescribeSharedDirectoriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DescribeSharedDirectoriesResponse response = new DescribeSharedDirectoriesResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<SharedDirectory, SharedDirectoryUnmarshaller>(SharedDirectoryUnmarshaller.Instance);
                    response.SharedDirectories = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static DescribeSharedDirectoriesResponseUnmarshaller _instance = new DescribeSharedDirectoriesResponseUnmarshaller();        

        internal static DescribeSharedDirectoriesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeSharedDirectoriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
