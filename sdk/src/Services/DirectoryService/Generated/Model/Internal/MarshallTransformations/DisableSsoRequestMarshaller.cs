...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>       
    public class DisableSsoRequestMarshaller : IMarshaller<IRequest, DisableSsoRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((DisableSsoRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(DisableSsoRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DirectoryService");
            string target = "DirectoryService_20150416.DisableSso";
