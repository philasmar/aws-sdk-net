...
{
    /// <summary>
    /// Response Unmarshaller for StartSchemaExtension operation
    /// </summary>  
    public class StartSchemaExtensionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            StartSchemaExtensionResponse response = new StartSchemaExtensionResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("SchemaExtensionId", targetDepth))
                {
                    ...
                    response.SchemaExtensionId = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return SnapshotLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
            }
        ...
        private static StartSchemaExtensionResponseUnmarshaller _instance = new StartSchemaExtensionResponseUnmarshaller();        

        internal static StartSchemaExtensionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static StartSchemaExtensionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
