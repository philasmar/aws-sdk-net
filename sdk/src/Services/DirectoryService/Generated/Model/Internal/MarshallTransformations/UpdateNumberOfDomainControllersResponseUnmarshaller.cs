...
{
    /// <summary>
    /// Response Unmarshaller for UpdateNumberOfDomainControllers operation
    /// </summary>  
    public class UpdateNumberOfDomainControllersResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateNumberOfDomainControllersResponse response = new UpdateNumberOfDomainControllersResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("DomainControllerLimitExceededException"))
                {
                    return DomainControllerLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static UpdateNumberOfDomainControllersResponseUnmarshaller _instance = new UpdateNumberOfDomainControllersResponseUnmarshaller();        

        internal static UpdateNumberOfDomainControllersResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateNumberOfDomainControllersResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
