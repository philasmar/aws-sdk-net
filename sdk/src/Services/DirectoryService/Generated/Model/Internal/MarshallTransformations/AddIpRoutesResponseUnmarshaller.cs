...
{
    /// <summary>
    /// Response Unmarshaller for AddIpRoutes operation
    /// </summary>  
    public class AddIpRoutesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            AddIpRoutesResponse response = new AddIpRoutesResponse();
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("IpRouteLimitExceededException"))
                {
                    return IpRouteLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static AddIpRoutesResponseUnmarshaller _instance = new AddIpRoutesResponseUnmarshaller();        

        internal static AddIpRoutesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddIpRoutesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
