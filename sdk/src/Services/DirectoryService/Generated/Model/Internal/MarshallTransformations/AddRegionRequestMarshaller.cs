...
{
    /// <summary>
    /// AddRegion Request Marshaller
    /// </summary>       
    public class AddRegionRequestMarshaller : IMarshaller<IRequest, AddRegionRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        /// <summary>
        ...
        {
            return this.Marshall((AddRegionRequest)input);
        }
        ...
        /// <returns></returns>
        public IRequest Marshall(AddRegionRequest publicRequest)
        {
            IRequest request = new DefaultRequest(publicRequest, "Amazon.DirectoryService");
            string target = "DirectoryService_20150416.AddRegion";
        ...
        private static AddRegionRequestMarshaller _instance = new AddRegionRequestMarshaller();        

        internal static AddRegionRequestMarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddRegionRequestMarshaller Instance
        {
            get
            {
                return _instance;
