...
{
    /// <summary>
    /// Response Unmarshaller for AddRegion operation
    /// </summary>  
    public class AddRegionResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("DirectoryAlreadyInRegionException"))
                {
                    return DirectoryAlreadyInRegionExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
                ...
                if (errorResponse.Code != null && errorResponse.Code.Equals("RegionLimitExceededException"))
                {
                    return RegionLimitExceededExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse);
                }
        ...
        private static AddRegionResponseUnmarshaller _instance = new AddRegionResponseUnmarshaller();        

        internal static AddRegionResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static AddRegionResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
