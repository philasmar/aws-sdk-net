...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DescribeDirectoriesResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        private static DescribeDirectoriesResponseUnmarshaller _instance = new DescribeDirectoriesResponseUnmarshaller();        

        internal static DescribeDirectoriesResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DescribeDirectoriesResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
