...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeleteTrustResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeleteTrustResponse response = new DeleteTrustResponse();
        ...
        private static DeleteTrustResponseUnmarshaller _instance = new DeleteTrustResponseUnmarshaller();        

        internal static DeleteTrustResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeleteTrustResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
