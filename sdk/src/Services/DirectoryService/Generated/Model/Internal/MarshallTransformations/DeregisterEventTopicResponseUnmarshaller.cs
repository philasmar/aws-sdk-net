...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class DeregisterEventTopicResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            DeregisterEventTopicResponse response = new DeregisterEventTopicResponse();
        ...
        private static DeregisterEventTopicResponseUnmarshaller _instance = new DeregisterEventTopicResponseUnmarshaller();        

        internal static DeregisterEventTopicResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static DeregisterEventTopicResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
