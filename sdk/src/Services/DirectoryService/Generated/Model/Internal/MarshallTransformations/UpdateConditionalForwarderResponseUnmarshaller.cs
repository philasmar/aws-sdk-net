...
{
    /// <summary>
    /// Response Unmarshaller for UpdateConditionalForwarder operation
    /// </summary>  
    public class UpdateConditionalForwarderResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            UpdateConditionalForwarderResponse response = new UpdateConditionalForwarderResponse();
        ...
        private static UpdateConditionalForwarderResponseUnmarshaller _instance = new UpdateConditionalForwarderResponseUnmarshaller();        

        internal static UpdateConditionalForwarderResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static UpdateConditionalForwarderResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
