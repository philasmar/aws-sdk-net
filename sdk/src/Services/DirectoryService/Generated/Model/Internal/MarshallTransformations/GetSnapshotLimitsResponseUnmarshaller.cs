...
namespace Amazon.DirectoryService.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class GetSnapshotLimitsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            GetSnapshotLimitsResponse response = new GetSnapshotLimitsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                if (context.TestExpression("SnapshotLimits", targetDepth))
                {
                    ...
                    response.SnapshotLimits = unmarshaller.Unmarshall(context);
                    continue;
                }
            }
        ...
        private static GetSnapshotLimitsResponseUnmarshaller _instance = new GetSnapshotLimitsResponseUnmarshaller();        

        internal static GetSnapshotLimitsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static GetSnapshotLimitsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
