...
{
    /// <summary>
    /// Response Unmarshaller for ListLogSubscriptions operation
    /// </summary>  
    public class ListLogSubscriptionsResponseUnmarshaller : JsonResponseUnmarshaller
    {
        /// <summary>
        ...
        {
            ListLogSubscriptionsResponse response = new ListLogSubscriptionsResponse();
            ...
            while (context.ReadAtDepth(targetDepth))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<LogSubscription, LogSubscriptionUnmarshaller>(LogSubscriptionUnmarshaller.Instance);
                    response.LogSubscriptions = unmarshaller.Unmarshall(context);
                    continue;
                }
        ...
        private static ListLogSubscriptionsResponseUnmarshaller _instance = new ListLogSubscriptionsResponseUnmarshaller();        

        internal static ListLogSubscriptionsResponseUnmarshaller GetInstance()
        {
            return _instance;
        }
        ...
        /// Gets the singleton.
        /// </summary>  
        public static ListLogSubscriptionsResponseUnmarshaller Instance
        {
            get
            {
                return _instance;
