...
namespace Amazon.DirectoryService.Model
{
    ...
    [Serializable]
    #endif
    public partial class AuthenticationFailedException : AmazonDirectoryServiceException
    {
        ...
        public AuthenticationFailedException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
