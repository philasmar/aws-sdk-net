...
namespace Amazon.DirectoryService.Model
{
    ...
    public partial class ShareLimitExceededException : AmazonDirectoryServiceException
    {
        ...
        /// <summary>
        /// Construct instance of ShareLimitExceededException
        /// </summary>
        /// <param name="message"></param>
        /// <param name="innerException"></param>
        public ShareLimitExceededException(string message, Exception innerException) 
        ...
        /// </summary>
        /// <param name="innerException"></param>
        public ShareLimitExceededException(Exception innerException) 
            : base(innerException) {}
        ...
        public ShareLimitExceededException(string message, Exception innerException, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
        ...
        /// <param name="requestId"></param>
        /// <param name="statusCode"></param>
        public ShareLimitExceededException(string message, ErrorType errorType, string errorCode, string requestId, HttpStatusCode statusCode) 
