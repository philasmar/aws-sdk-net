...
{
    [TestClass]
    public partial class MWAAMarshallingTests
    {
        static readonly ServiceModel service_model = Utils.LoadServiceModel("mwaa");
        
        [TestMethod]
        [TestCategory("UnitTest")]
        [TestCategory("Rest_Json")]
        [TestCategory("MWAA")]
        public void CreateCliTokenMarshallTest()
        {
            var operation = service_model.FindOperation("CreateCliToken");

            var request = InstantiateClassGenerator.Execute<CreateCliTokenRequest>();
            var marshaller = new CreateCliTokenRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("CreateCliToken", request, internalRequest, service_model);            
            ...
            ResponseUnmarshaller unmarshaller = CreateCliTokenResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context)
                as CreateCliTokenResponse;   
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MWAA")]
        public void CreateCliToken_ResourceNotFoundExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateCliToken");
            ...
            var response = CreateCliTokenResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MWAA")]
        public void CreateWebLoginTokenMarshallTest()
        {
            var operation = service_model.FindOperation("CreateWebLoginToken");

            var request = InstantiateClassGenerator.Execute<CreateWebLoginTokenRequest>();
            var marshaller = new CreateWebLoginTokenRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("CreateWebLoginToken", request, internalRequest, service_model);            
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = CreateWebLoginTokenResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context)
                as CreateWebLoginTokenResponse;   
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);               
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MWAA")]
        public void CreateWebLoginToken_AccessDeniedExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateWebLoginToken");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = CreateWebLoginTokenResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MWAA")]
        public void CreateWebLoginToken_InternalServerExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateWebLoginToken");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MWAA")]
        public void CreateWebLoginToken_ResourceNotFoundExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateWebLoginToken");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MWAA")]
        public void CreateWebLoginToken_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateWebLoginToken");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MWAA")]
        public void PublishMetricsMarshallTest()
        {
            var operation = service_model.FindOperation("PublishMetrics");

            var request = InstantiateClassGenerator.Execute<PublishMetricsRequest>();
            var marshaller = new PublishMetricsRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("PublishMetrics", request, internalRequest, service_model);            
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = PublishMetricsResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context)
                as PublishMetricsResponse;   
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);               
        }
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MWAA")]
        public void PublishMetrics_InternalServerExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PublishMetrics");
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), true, webResponse, true);
            var response = PublishMetricsResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("MWAA")]
        public void PublishMetrics_ValidationExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("PublishMetrics");
