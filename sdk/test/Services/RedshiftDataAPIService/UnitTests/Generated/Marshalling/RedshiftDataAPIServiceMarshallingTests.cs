...
{
    [TestClass]
    public class RedshiftDataAPIServiceMarshallingTests
    {
        static readonly ServiceModel service_model = Utils.LoadServiceModel("redshift-data");
        ...
        {
            var request = InstantiateClassGenerator.Execute<CancelStatementRequest>();
            ...
            var jsonResponse = new JsonSampleGenerator(service_model, service_model.FindOperation("CancelStatement").ResponseStructure).Execute();
            webResponse.Headers.Add("Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString());
            UnmarshallerContext context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), false, webResponse);
            var response = CancelStatementResponseUnmarshaller.Instance.Unmarshall(context)
                as CancelStatementResponse;
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void CancelStatement_InternalServerExceptionMarshallTest()
        {
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void CancelStatement_ResourceNotFoundExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("CancelStatement");
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void DescribeStatementMarshallTest()
        {
            var request = InstantiateClassGenerator.Execute<DescribeStatementRequest>();
            var marshaller = new DescribeStatementRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            var jsonRequest = UTF8Encoding.UTF8.GetString(internalRequest.Content);                        
            Comparer.CompareObjectToJson<DescribeStatementRequest>(request,jsonRequest);
            ...
            var jsonResponse = new JsonSampleGenerator(service_model, service_model.FindOperation("DescribeStatement").ResponseStructure).Execute();
            webResponse.Headers.Add("Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString());
            UnmarshallerContext context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), false, webResponse);
            var response = DescribeStatementResponseUnmarshaller.Instance.Unmarshall(context)
                as DescribeStatementResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void DescribeStatement_InternalServerExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("DescribeStatement");
            ...
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), true, webResponse, true);
            var response = DescribeStatementResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void DescribeStatement_ResourceNotFoundExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("DescribeStatement");
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void DescribeStatement_ValidationExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("DescribeStatement");
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void ExecuteStatement_ExecuteStatementExceptionMarshallTest()
        {
            ...
            var exception = operation.Exceptions.First(e => e.Name.Equals("ExecuteStatementException"));
            var jsonResponse = new JsonSampleGenerator(service_model, exception).Execute();
            var webResponse = new WebResponseData
            {
                Headers = {
                    {"x-amzn-RequestId", Guid.NewGuid().ToString()},
                    {"x-amz-crc32","0"},
                    {"x-amzn-ErrorType","ExecuteStatementException"},
                    {"Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString()}
                }
            };
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), true, webResponse, true);
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void ExecuteStatement_ValidationExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("ExecuteStatement");
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void GetStatementResultMarshallTest()
        {
            var request = InstantiateClassGenerator.Execute<GetStatementResultRequest>();
            var marshaller = new GetStatementResultRequestMarshaller();

            var internalRequest = marshaller.Marshall(request);
            var jsonRequest = UTF8Encoding.UTF8.GetString(internalRequest.Content);                        
            Comparer.CompareObjectToJson<GetStatementResultRequest>(request,jsonRequest);
            ...
            var jsonResponse = new JsonSampleGenerator(service_model, service_model.FindOperation("GetStatementResult").ResponseStructure).Execute();
            webResponse.Headers.Add("Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString());
            UnmarshallerContext context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), false, webResponse);
            var response = GetStatementResultResponseUnmarshaller.Instance.Unmarshall(context)
                as GetStatementResultResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void GetStatementResult_InternalServerExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("GetStatementResult");
            ...
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), true, webResponse, true);
            var response = GetStatementResultResponseUnmarshaller.Instance.UnmarshallException(context, null, System.Net.HttpStatusCode.OK);
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void GetStatementResult_ResourceNotFoundExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("GetStatementResult");
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void GetStatementResult_ValidationExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("GetStatementResult");
        ...
        public void ListStatementsMarshallTest()
        {
            ...
            var jsonResponse = new JsonSampleGenerator(service_model, service_model.FindOperation("ListStatements").ResponseStructure).Execute();
            webResponse.Headers.Add("Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString());
            UnmarshallerContext context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), false, webResponse);
            var response = ListStatementsResponseUnmarshaller.Instance.Unmarshall(context)
                as ListStatementsResponse;
            InstantiateClassGenerator.ValidateObjectFullyInstantiated(response);
        }
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void ListStatements_InternalServerExceptionMarshallTest()
        {
        ...
        [TestCategory("Json")]
        [TestCategory("RedshiftDataAPIService")]
        public void ListStatements_ValidationExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("ListStatements");
