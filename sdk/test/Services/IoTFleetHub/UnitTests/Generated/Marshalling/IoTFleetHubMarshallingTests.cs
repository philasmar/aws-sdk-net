...
{
    [TestClass]
    public partial class IoTFleetHubMarshallingTests
    {
        static readonly ServiceModel service_model = Utils.LoadServiceModel("iotfleethub");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("IoTFleetHub")]
        public void CreateApplication_InternalFailureExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("CreateApplication");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("IoTFleetHub")]
        public void DeleteApplication_InternalFailureExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DeleteApplication");
        ...
        public void DescribeApplicationMarshallTest()
        {
            ...
            var internalRequest = marshaller.Marshall(request);
            TestTools.RequestValidator.Validate("DescribeApplication", request, internalRequest, service_model);            
            ...
            webResponse.Headers["Content-Length"] = UTF8Encoding.UTF8.GetBytes(payloadResponse).Length.ToString();
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(payloadResponse), false, webResponse);
            ResponseUnmarshaller unmarshaller = DescribeApplicationResponseUnmarshaller.Instance;
            var response = unmarshaller.Unmarshall(context)
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("IoTFleetHub")]
        public void DescribeApplication_InternalFailureExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("DescribeApplication");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("IoTFleetHub")]
        public void ListApplications_InternalFailureExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("ListApplications");
        ...
        [TestCategory("Rest_Json")]
        [TestCategory("IoTFleetHub")]
        public void UpdateApplication_InternalFailureExceptionMarshallTest()
        {
            var operation = service_model.FindOperation("UpdateApplication");
