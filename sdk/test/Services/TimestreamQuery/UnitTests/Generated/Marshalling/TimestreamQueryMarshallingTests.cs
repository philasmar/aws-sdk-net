...
{
    [TestClass]
    public class TimestreamQueryMarshallingTests
    {
        ...
        [TestCategory("Json")]
        [TestCategory("TimestreamQuery")]
        public void CancelQuery_AccessDeniedExceptionMarshallTest()
        {
        ...
        [TestCategory("Json")]
        [TestCategory("TimestreamQuery")]
        public void CancelQuery_InternalServerExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("CancelQuery");
        ...
        [TestCategory("Json")]
        [TestCategory("TimestreamQuery")]
        public void CancelQuery_InvalidEndpointExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("CancelQuery");
        ...
        [TestCategory("Json")]
        [TestCategory("TimestreamQuery")]
        public void CancelQuery_ThrottlingExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("CancelQuery");
        ...
        [TestCategory("Json")]
        [TestCategory("TimestreamQuery")]
        public void CancelQuery_ValidationExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("CancelQuery");
        ...
        [TestCategory("Json")]
        [TestCategory("TimestreamQuery")]
        public void Query_InvalidEndpointExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("Query");
        ...
        [TestCategory("Json")]
        [TestCategory("TimestreamQuery")]
        public void Query_QueryExecutionExceptionMarshallTest()
        {
            var operation =  service_model.FindOperation("Query");
            ...
            var exception = operation.Exceptions.First(e => e.Name.Equals("QueryExecutionException"));
            var jsonResponse = new JsonSampleGenerator(service_model, exception).Execute();
            var webResponse = new WebResponseData
            {
                Headers = {
                    {"x-amzn-RequestId", Guid.NewGuid().ToString()},
                    {"x-amz-crc32","0"},
                    {"x-amzn-ErrorType","QueryExecutionException"},
                    {"Content-Length", UTF8Encoding.UTF8.GetBytes(jsonResponse).Length.ToString()}
                }
            };
            var context = new JsonUnmarshallerContext(Utils.CreateStreamFromString(jsonResponse), true, webResponse, true);
