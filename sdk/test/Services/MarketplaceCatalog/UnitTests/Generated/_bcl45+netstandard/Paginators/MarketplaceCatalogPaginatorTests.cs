...
{
    [TestClass]
    public class MarketplaceCatalogPaginatorTests
    {
        private static Mock<AmazonMarketplaceCatalogClient> _mockClient;

        [ClassInitialize()]
        public static void ClassInitialize(TestContext a)
        {
            _mockClient = new Mock<AmazonMarketplaceCatalogClient>("access key", "secret", Amazon.RegionEndpoint.USEast1);
        }
